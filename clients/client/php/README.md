...
*ElementsApi* | [**getConfiguration**](docs/Api/ElementsApi.md#getconfiguration) | **GET** /elements/configuration | Get Ory Elements configuration
...
*FrontendApi* | [**getSamlMetadata**](docs/Api/FrontendApi.md#getsamlmetadata) | **GET** /self-service/methods/saml/metadata | Get SAML SP Metadata
*FrontendApi* | [**getSamlProviderMetadata**](docs/Api/FrontendApi.md#getsamlprovidermetadata) | **GET** /self-service/methods/saml/metadata/{provider} | Get Per-Connection SAML SP Metadata
...
*FrontendApi* | [**initSamlLogin**](docs/Api/FrontendApi.md#initsamllogin) | **GET** /self-service/methods/saml/init/{provider} | Initiate Native SAML Sign-In
*FrontendApi* | [**initSamlLoginRequest**](docs/Api/FrontendApi.md#initsamlloginrequest) | **POST** /self-service/methods/saml/init/{provider} | Initiate Native SAML Sign-In (Direct POST)
...
*FrontendApi* | [**submitSamlAssertion**](docs/Api/FrontendApi.md#submitsamlassertion) | **POST** /self-service/methods/saml/acs/{provider} | Native SAML Assertion Consumer Service (ACS)
...
*IdentityApi* | [**getIdentityByExternalID**](docs/Api/IdentityApi.md#getidentitybyexternalid) | **GET** /admin/identities/by/external/{externalID} | Get an Identity by its External ID
...
- [ContinueWithDeviceAuthnPinEntryUi](docs/Model/ContinueWithDeviceAuthnPinEntryUi.md)
- [ContinueWithDeviceAuthnPinEntryUiData](docs/Model/ContinueWithDeviceAuthnPinEntryUiData.md)
...
- [CreateProjectApiKeyBody](docs/Model/CreateProjectApiKeyBody.md)
...
- [CreateTestLoginFlowFromOnboardingPortalLinkBody](docs/Model/CreateTestLoginFlowFromOnboardingPortalLinkBody.md)
...
- [GetJWKSResponseJwks](docs/Model/GetJWKSResponseJwks.md)
- [GetJWKSResponseJwksKeysInner](docs/Model/GetJWKSResponseJwksKeysInner.md)
...
- [GetSessionActivity](docs/Model/GetSessionActivity.md)
...
- [ProjectServiceAccountExperience](docs/Model/ProjectServiceAccountExperience.md)
...
- [UpdateLoginFlowWithDeviceAuthnMethod](docs/Model/UpdateLoginFlowWithDeviceAuthnMethod.md)
