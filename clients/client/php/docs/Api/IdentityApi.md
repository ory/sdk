...
```php
listIdentities($perPage, $page, $pageSize, $pageToken, $credentialsIdentifier): \Ory\Client\Model\Identity[]
```
...
try {
    $result = $apiInstance->listIdentities($perPage, $page, $pageSize, $pageToken, $credentialsIdentifier);
    print_r($result);
} catch (Exception $e) {
