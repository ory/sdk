...
```php
listIdentities($perPage, $page, $pageSize, $pageToken, $consistency, $credentialsIdentifier, $previewCredentialsIdentifierSimilar): \Ory\Client\Model\Identity[]
```
...
try {
    $result = $apiInstance->listIdentities($perPage, $page, $pageSize, $pageToken, $consistency, $credentialsIdentifier, $previewCredentialsIdentifierSimilar);
    print_r($result);
} catch (Exception $e) {
