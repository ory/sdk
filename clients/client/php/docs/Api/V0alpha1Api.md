...
```php
initializeSelfServiceLoginFlowForBrowsers($refresh): \Ory\Client\Model\SelfServiceLoginFlow
```
...
```php
initializeSelfServiceLoginFlowWithoutBrowser($refresh): \Ory\Client\Model\SelfServiceLoginFlow
```
...
```php
submitSelfServiceLoginFlow($flow, $submitSelfServiceLoginFlowBody): \Ory\Client\Model\SuccessfulSelfServiceLoginWithoutBrowser
```
...
```php
submitSelfServiceSettingsFlow($flow, $xSessionToken, $submitSelfServiceSettingsFlowBody): \Ory\Client\Model\SuccessfulSelfServiceSettingsWithoutBrowser
```
...
[**\Ory\Client\Model\SuccessfulSelfServiceSettingsWithoutBrowser**](../Model/SuccessfulSelfServiceSettingsWithoutBrowser.md)
