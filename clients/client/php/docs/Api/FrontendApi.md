...
```php
createBrowserRecoveryFlow($returnTo, $skipSettings): \Ory\Client\Model\RecoveryFlow
```
...
$returnTo = 'returnTo_example'; // string | The URL to return the browser to after the flow was completed.
$skipSettings = 'skipSettings_example'; // string | Skip redirection to the settings UI after the recovery flow was completed. Instead, the user will be redirected to the URL specified in `return_to` query parameter or the default return URL if `return_to` is not set.

try {
    $result = $apiInstance->createBrowserRecoveryFlow($returnTo, $skipSettings);
    print_r($result);
} catch (Exception $e) {
...
```php
createIdPInitiatedSamlBrowserLoginFlow($provider, $code): \Ory\Client\Model\ErrorGeneric
```
...
try {
    $result = $apiInstance->createIdPInitiatedSamlBrowserLoginFlow($provider, $code);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FrontendApi->createIdPInitiatedSamlBrowserLoginFlow: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getSamlMetadata();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FrontendApi->getSamlMetadata: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getSamlProviderMetadata($provider): string
```
...
try {
    $result = $apiInstance->getSamlProviderMetadata($provider);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FrontendApi->getSamlProviderMetadata: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getWebAuthnRelatedOrigins(): \Ory\Client\Model\WebAuthnRelatedOrigins
```
...
try {
    $result = $apiInstance->getWebAuthnRelatedOrigins();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FrontendApi->getWebAuthnRelatedOrigins: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\Ory\Client\Model\WebAuthnRelatedOrigins**](../Model/WebAuthnRelatedOrigins.md)
...
```php
initSamlLogin($provider, $flow, $purpose): string
```
...
try {
    $result = $apiInstance->initSamlLogin($provider, $flow, $purpose);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FrontendApi->initSamlLogin: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
initSamlLoginRequest($provider, $flow, $purpose): string
```
...
try {
    $result = $apiInstance->initSamlLoginRequest($provider, $flow, $purpose);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FrontendApi->initSamlLoginRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
submitSamlAssertion($provider, $relayState, $sAMLResponse): \Ory\Client\Model\ErrorGeneric
```
...
try {
    $result = $apiInstance->submitSamlAssertion($provider, $relayState, $sAMLResponse);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FrontendApi->submitSamlAssertion: ', $e->getMessage(), PHP_EOL;
}
```
