...
$apiInstance = new Ory\Client\Api\PublicApi(
...
```php
discoverOpenIDConfiguration(): \Ory\Client\Model\WellKnown
```
...
[**\Ory\Client\Model\WellKnown**](../Model/WellKnown.md)
...
```php
oauth2Token($grantType, $clientId, $code, $redirectUri, $refreshToken): \Ory\Client\Model\Oauth2TokenResponse
```
...
```php
userinfo(): \Ory\Client\Model\UserinfoResponse
```
...
[**\Ory\Client\Model\UserinfoResponse**](../Model/UserinfoResponse.md)
...
```php
wellKnown(): \Ory\Client\Model\JSONWebKeySet
```
