...
class ContainerWaitOKBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error' => '\Ory\Client\Client\Model\ContainerWaitOKBodyError',
        'statusCode' => 'int'
    ];
     ...
     * Gets error
     *
     * @return \Ory\Client\Client\Model\ContainerWaitOKBodyError
     */
     ...
     * Sets error
     *
     * @param \Ory\Client\Client\Model\ContainerWaitOKBodyError $error error
     *
     * @return self
     */
