...
class ContainerWaitOKBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error' => '\Ory\Client\Model\ContainerWaitOKBodyError',
        'statusCode' => 'int'
    ];
     ...
     * Gets error
     *
     * @return \Ory\Client\Model\ContainerWaitOKBodyError
     */
     ...
     * Sets error
     *
     * @param \Ory\Client\Model\ContainerWaitOKBodyError $error error
     *
     * @return self
     */
