...
/**
 * GenericErrorContent Class Doc Comment
 *
 * @category Class
 ...
 */
class GenericErrorContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'genericErrorContent';
    ...
    public const ID_FEATURE_NOT_AVAILABLE = 'feature_not_available';
    public const ID_QUOTA_EXCEEDED = 'quota_exceeded';
    public const ID_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    {
        return [
            self::ID_FEATURE_NOT_AVAILABLE,
            self::ID_QUOTA_EXCEEDED,
            self::ID_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID is a unique error ID. feature_not_available ErrFeatureNotAvailable quota_exceeded ErrQuotaExceeded
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (!in_array($id, $allowedValues, true)) {
            $id = self::ID_UNKNOWN_DEFAULT_OPEN_API;
        }
     ...
     * Sets message
     *
     * @param string|null $message Message contains the error message.
     *
     * @return self
     */
