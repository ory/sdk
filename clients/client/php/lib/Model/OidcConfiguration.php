...
class OidcConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['deviceAuthorizationEndpoint'] === null) {
            $invalidProperties[] = "'deviceAuthorizationEndpoint' can't be null";
        }
     ...
     *
     * @param string $deviceAuthorizationEndpoint OAuth 2.0 Device Authorization Endpoint URL
     *
     * @return self
     */
