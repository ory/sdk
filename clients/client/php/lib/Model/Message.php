...
class Message implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TEMPLATE_TYPE_VERIFIABLE_ADDRESS_CHANGED = 'verifiable_address_changed';
    public const TEMPLATE_TYPE_AUTHENTICATOR_KEY_ADDED = 'authenticator_key_added';
    public const TEMPLATE_TYPE_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getTemplateTypeAllowableValues()
    {
        return [
            ...
            self::TEMPLATE_TYPE_VERIFIABLE_ADDRESS_CHANGED,
            self::TEMPLATE_TYPE_AUTHENTICATOR_KEY_ADDED,
            self::TEMPLATE_TYPE_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    */
    ...
    public function setTemplateType($templateType)
    {
        ...
        if (!in_array($templateType, $allowedValues, true)) {
            $templateType = self::TEMPLATE_TYPE_UNKNOWN_DEFAULT_OPEN_API;
        }
