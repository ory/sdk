...
class NormalizedProjectRevisionThirdPartyProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'aal2AcrValues' => 'string[]',
        'aal2AmrValues' => 'string[]',
    ...
    protected static $attributeMap = [
        'aal2AcrValues' => 'aal2_acr_values',
        'aal2AmrValues' => 'aal2_amr_values',
        'accountLinkingMode' => 'account_linking_mode',
        ...
        'tokenUrl' => 'token_url',
        'updateIdentityOnLogin' => 'update_identity_on_login',
    ...
    protected static $setters = [
        'aal2AcrValues' => 'setAal2AcrValues',
        'aal2AmrValues' => 'setAal2AmrValues',
        'accountLinkingMode' => 'setAccountLinkingMode',
        ...
        'frontChannelLogout' => 'setFrontChannelLogout',
        'id' => 'setId',
        ...
        'updateIdentityOnLogin' => 'setUpdateIdentityOnLogin',
    ...
    protected static $getters = [
        'aal2AcrValues' => 'getAal2AcrValues',
        'aal2AmrValues' => 'getAal2AmrValues',
        'accountLinkingMode' => 'getAccountLinkingMode',
        ...
        'frontChannelLogout' => 'getFrontChannelLogout',
        'id' => 'getId',
        ...
        'updateIdentityOnLogin' => 'getUpdateIdentityOnLogin',
    ...
    public const ACCOUNT_LINKING_MODE_AUTOMATIC = 'automatic';
    public const ACCOUNT_LINKING_MODE_CONFIRM_WITH_EXISTING_CREDENTIAL = 'confirm_with_existing_credential';
    public const ACCOUNT_LINKING_MODE_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    public const PKCE_AUTO = 'auto';
    public const PKCE_NEVER = 'never';
    public const PKCE_FORCE = 'force';
    public const PKCE_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    public const STATE_ENABLED = 'enabled';
    public const STATE_DISABLED = 'disabled';
    public const STATE_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    public const UPDATE_IDENTITY_ON_LOGIN_NEVER = 'never';
    public const UPDATE_IDENTITY_ON_LOGIN_AUTOMATIC = 'automatic';
    public const UPDATE_IDENTITY_ON_LOGIN_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
     ...
     * @return string[]
     */
    public function getAccountLinkingModeAllowableValues()
    {
        return [
            self::ACCOUNT_LINKING_MODE_AUTOMATIC,
            self::ACCOUNT_LINKING_MODE_CONFIRM_WITH_EXISTING_CREDENTIAL,
            self::ACCOUNT_LINKING_MODE_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    public function getPkceAllowableValues()
    {
        return [
            ...
            self::PKCE_NEVER,
            self::PKCE_FORCE,
            self::PKCE_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
     ...
     * @return string[]
     */
    public function getUpdateIdentityOnLoginAllowableValues()
    {
        return [
            self::UPDATE_IDENTITY_ON_LOGIN_NEVER,
            self::UPDATE_IDENTITY_ON_LOGIN_AUTOMATIC,
            self::UPDATE_IDENTITY_ON_LOGIN_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    {
        $this->setIfExists('aal2AcrValues', $data ?? [], null);
        $this->setIfExists('aal2AmrValues', $data ?? [], null);
        $this->setIfExists('accountLinkingMode', $data ?? [], null);
        ...
        $this->setIfExists('frontChannelLogout', $data ?? [], null);
        ...
        $this->setIfExists('updateIdentityOnLogin', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAccountLinkingModeAllowableValues();
        if (!is_null($this->container['accountLinkingMode']) && !in_array($this->container['accountLinkingMode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'accountLinkingMode', must be one of '%s'",
                $this->container['accountLinkingMode'],
        ...
        $allowedValues = $this->getUpdateIdentityOnLoginAllowableValues();
        if (!is_null($this->container['updateIdentityOnLogin']) && !in_array($this->container['updateIdentityOnLogin'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'updateIdentityOnLogin', must be one of '%s'",
                $this->container['updateIdentityOnLogin'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * @return string[]|null
     */
    public function getAal2AcrValues()
    {
        return $this->container['aal2AcrValues'];
    }

    /**
     * Sets aal2AcrValues
     *
     * @param string[]|null $aal2AcrValues AAL2ACRValues lists upstream OIDC `acr` claim values that should elevate the resulting Kratos session to AAL2. Empty means the upstream `acr` claim is ignored when deciding session AAL.
     *
     * @return self
     */
    public function setAal2AcrValues($aal2AcrValues)
    {
        if (is_null($aal2AcrValues)) {
            throw new \InvalidArgumentException('non-nullable aal2AcrValues cannot be null');
        }
        $this->container['aal2AcrValues'] = $aal2AcrValues;
     ...
     * @return string[]|null
     */
    public function getAal2AmrValues()
    {
        return $this->container['aal2AmrValues'];
    }

    /**
     * Sets aal2AmrValues
     *
     * @param string[]|null $aal2AmrValues AAL2AMRValues lists upstream OIDC `amr` claim values that should elevate the resulting Kratos session to AAL2 when any of them appears in the upstream `amr` array. Empty means the upstream `amr` claim is ignored when deciding session AAL.
     *
     * @return self
     */
    public function setAal2AmrValues($aal2AmrValues)
    {
        if (is_null($aal2AmrValues)) {
            throw new \InvalidArgumentException('non-nullable aal2AmrValues cannot be null');
        }
        $this->container['aal2AmrValues'] = $aal2AmrValues;

        return $this;
    }

    /**
     * Gets accountLinkingMode
     *
     * @return string|null
     */
    public function getAccountLinkingMode()
    {
        return $this->container['accountLinkingMode'];
    }

    /**
     * Sets accountLinkingMode
     *
     * @param string|null $accountLinkingMode AccountLinkingMode controls how account conflicts are resolved for this provider.  Possible values are `confirm_with_existing_credential` (default) and `automatic`. `automatic` silently links accounts when the provider verifies email ownership. Only supported for `apple` and `google` providers. automatic AccountLinkingModeAutomatic silently links accounts if the provider verifies email ownership. confirm_with_existing_credential AccountLinkingModeConfirmWithExistingCredential requires the user to confirm the account linking by providing an existing credential.
     *
     * @return self
     */
    public function setAccountLinkingMode($accountLinkingMode)
    {
        if (is_null($accountLinkingMode)) {
            throw new \InvalidArgumentException('non-nullable accountLinkingMode cannot be null');
        }
        $allowedValues = $this->getAccountLinkingModeAllowableValues();
        if (!in_array($accountLinkingMode, $allowedValues, true)) {
            $accountLinkingMode = self::ACCOUNT_LINKING_MODE_UNKNOWN_DEFAULT_OPEN_API;
        }
        $this->container['accountLinkingMode'] = $accountLinkingMode;
     ...
     *
     * @param string[]|null $additionalIdTokenAudiences AdditionalIDTokenAudiences is a list of additional audiences allowed in the ID Token.  This is only relevant in OIDC flows that submit an IDToken instead of using the callback from the OIDC provider.
     *
     * @return self
     */
    ...
    /**
     * Gets frontChannelLogout
     *
     * @return bool|null
     */
    public function getFrontChannelLogout()
    {
        return $this->container['frontChannelLogout'];
    }

    /**
     * Sets frontChannelLogout
     *
     * @param bool|null $frontChannelLogout FrontChannelLogout enables OpenID Connect Front-Channel Logout for this provider: a login issues a companion cookie that lets the provider end the resulting Ory session from its own sign-out page.  Requires the provider to return the `sid` claim in the ID token.
     *
     * @return self
     */
    public function setFrontChannelLogout($frontChannelLogout)
    {
        if (is_null($frontChannelLogout)) {
            throw new \InvalidArgumentException('non-nullable frontChannelLogout cannot be null');
        }
        $this->container['frontChannelLogout'] = $frontChannelLogout;
    ...
    public function setPkce($pkce)
    {
        ...
        if (!is_null($pkce) && !in_array($pkce, $allowedValues, true)) {
            $pkce = self::PKCE_UNKNOWN_DEFAULT_OPEN_API;
        }
     ...
     *
     * @param string|null $projectRevisionId The Revision's ID this provider belongs to
     *
     * @return self
     */
    ...
    /**
     * Gets updateIdentityOnLogin
     *
     * @return string|null
     */
    public function getUpdateIdentityOnLogin()
    {
        return $this->container['updateIdentityOnLogin'];
    }

    /**
     * Sets updateIdentityOnLogin
     *
     * @param string|null $updateIdentityOnLogin UpdateIdentityOnLogin controls whether the identity is updated from OIDC claims on each login.  Possible values are \"never\" (default) and \"automatic\". never UpdateIdentityOnLoginNever disables identity updates on login (default). automatic UpdateIdentityOnLoginAutomatic re-runs the Jsonnet claims mapper on every login and updates the identity's traits and metadata automatically.
     *
     * @return self
     */
    public function setUpdateIdentityOnLogin($updateIdentityOnLogin)
    {
        if (is_null($updateIdentityOnLogin)) {
            throw new \InvalidArgumentException('non-nullable updateIdentityOnLogin cannot be null');
        }
        $allowedValues = $this->getUpdateIdentityOnLoginAllowableValues();
        if (!in_array($updateIdentityOnLogin, $allowedValues, true)) {
            $updateIdentityOnLogin = self::UPDATE_IDENTITY_ON_LOGIN_UNKNOWN_DEFAULT_OPEN_API;
        }
        $this->container['updateIdentityOnLogin'] = $updateIdentityOnLogin;
