...
class RevocationReason
{
     ...
     */
    public const REVOCATION_REASON_UNSPECIFIED = 'REVOCATION_REASON_UNSPECIFIED';

    public const REVOCATION_REASON_KEY_COMPROMISE = 'REVOCATION_REASON_KEY_COMPROMISE';

    public const REVOCATION_REASON_AFFILIATION_CHANGED = 'REVOCATION_REASON_AFFILIATION_CHANGED';

    public const REVOCATION_REASON_SUPERSEDED = 'REVOCATION_REASON_SUPERSEDED';

    public const REVOCATION_REASON_PRIVILEGE_WITHDRAWN = 'REVOCATION_REASON_PRIVILEGE_WITHDRAWN';
