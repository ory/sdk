 ...
 */
class RelationshipPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'relationshipPatch';
    ...
    protected static $openAPITypes = [
        'action' => 'string',
        'relationTuple' => '\Ory\Client\Model\Relationship'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('relationTuple', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets relationTuple
     *
     * @param \Ory\Client\Model\Relationship|null $relationTuple relationTuple
     *
     * @return self
     */
    public function setRelationTuple($relationTuple)
    {
        if (is_null($relationTuple)) {
            throw new \InvalidArgumentException('non-nullable relationTuple cannot be null');
        }
