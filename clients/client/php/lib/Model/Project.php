...
class Project implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets homeRegion
     *
     * @param string $homeRegion The project home region.  This is used to set where the project data is stored and where the project's endpoints are located. eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest eu EU asia Asia us US global Global
     *
     * @return self
     */
     ...
     * Sets organizations
     *
     * @param \Ory\Client\Model\BasicOrganization[] $organizations The organizations of the project.  Organizations are used to group users and enforce certain restrictions like usage of SSO.
     *
     * @return self
     */
