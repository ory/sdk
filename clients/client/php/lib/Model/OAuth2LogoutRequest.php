...
class OAuth2LogoutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rpInitiated', $data ?? [], null);
    ...
    */
     ...
     * Sets challenge
     *
     * @param string|null $challenge Challenge is used to retrieve/accept/deny the logout request.
     *
     * @return self
     */
    ...
    public function setRequestedAt($requestedAt)
    {
        if (is_null($requestedAt)) {
            throw new \InvalidArgumentException('non-nullable requestedAt cannot be null');
        }
    ...
    {
        if (is_null($rpInitiated)) {
            throw new \InvalidArgumentException('non-nullable rpInitiated cannot be null');
        }
     ...
     * Sets subject
     *
     * @param string|null $subject Subject is the user for whom the logout was requested.
     *
     * @return self
     */
