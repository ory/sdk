...
class OAuth2ConsentSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string[]|null $grantAccessTokenAudience Audience Granted  GrantedAudience sets the audience the user authorized the client to use. Should be a subset of `requested_access_token_audience`.
     *
     * @return self
     */
     ...
     * Sets grantScope
     *
     * @param string[]|null $grantScope Scope Granted  GrantScope sets the scope the user authorized the client to use. Should be a subset of `requested_scope`.
     *
     * @return self
     */
