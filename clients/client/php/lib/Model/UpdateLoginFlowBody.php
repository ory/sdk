...
class UpdateLoginFlowBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets clientKeyId
     *
     * @param string|null $clientKeyId Login with a DeviceAuthn Security Key.  This must contain the client ID of the DeviceAuthN key, a.k.a 'key alias' on Android and 'key id' on iOS.
     *
     * @return self
     */
