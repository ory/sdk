...
class UpdateLoginFlowBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets clientKeyId
     *
     * @param string|null $clientKeyId ClientKeyID identifies the DeviceAuthn key to authenticate with.  It is the key's deterministic fingerprint — the lowercase-hex SHA-256 of the device public key in PKIX, ASN.1 DER (SubjectPublicKeyInfo) form — which the device recomputes locally after enrollment. Keys enrolled before the server derived the id use their original client-chosen value.
     *
     * @return self
     */
     ...
     * Sets signature
     *
     * @param string|null $signature Signature is a ES256 signature of the server-provided challenge.
     *
     * @return self
     */
