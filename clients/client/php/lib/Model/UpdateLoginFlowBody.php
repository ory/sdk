...
class UpdateLoginFlowBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pinProof', $data ?? [], null);
    ...
    */
     ...
     * Sets clientKeyId
     *
     * @param string $clientKeyId The client_key_id of the enrolled key to authenticate with.  It is the key's deterministic fingerprint: the lowercase-hex SHA-256 of the device public key in PKIX, ASN.1 DER (SubjectPublicKeyInfo) form, which the device can recompute locally after enrollment. Keys enrolled before the server derived the id use their original client-chosen value.
     *
     * @return self
     */
