...
class NormalizedProjectRevisionHook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'hook' => 'string',
        'id' => 'string',
        'notifyPreviousAddressesConfigRecipients' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'hook' => null,
        'id' => 'uuid',
        'notifyPreviousAddressesConfigRecipients' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'hook' => false,
        'id' => false,
        'notifyPreviousAddressesConfigRecipients' => false,
    ...
    protected static $attributeMap = [
        ...
        'hook' => 'hook',
        'id' => 'id',
        'notifyPreviousAddressesConfigRecipients' => 'notify_previous_addresses_config_recipients',
    ...
    protected static $setters = [
        ...
        'hook' => 'setHook',
        'id' => 'setId',
        'notifyPreviousAddressesConfigRecipients' => 'setNotifyPreviousAddressesConfigRecipients',
    ...
    protected static $getters = [
        ...
        'hook' => 'getHook',
        'id' => 'getId',
        'notifyPreviousAddressesConfigRecipients' => 'getNotifyPreviousAddressesConfigRecipients',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('notifyPreviousAddressesConfigRecipients', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets notifyPreviousAddressesConfigRecipients
     *
     * @return string|null
     */
    public function getNotifyPreviousAddressesConfigRecipients()
    {
        return $this->container['notifyPreviousAddressesConfigRecipients'];
    }

    /**
     * Sets notifyPreviousAddressesConfigRecipients
     *
     * @param string|null $notifyPreviousAddressesConfigRecipients The recipients to be notified in case of a change of the users verified email addresses. Possible values are: \"all\", \"all_verified\", \"removed\" (only notify about removed email addresses)
     *
     * @return self
     */
    public function setNotifyPreviousAddressesConfigRecipients($notifyPreviousAddressesConfigRecipients)
    {
        if (is_null($notifyPreviousAddressesConfigRecipients)) {
            throw new \InvalidArgumentException('non-nullable notifyPreviousAddressesConfigRecipients cannot be null');
        }
        $this->container['notifyPreviousAddressesConfigRecipients'] = $notifyPreviousAddressesConfigRecipients;
