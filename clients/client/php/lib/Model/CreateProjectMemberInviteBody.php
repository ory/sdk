...
/**
 * CreateProjectMemberInviteBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateProjectMemberInviteBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateProjectMemberInviteBody';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('role', $data ?? [], 'developer');
    }
    ...
    */
     ...
     * Sets inviteeEmail
     *
     * @param string $inviteeEmail The email address to invite.
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string|null $role The role the invited member will hold. Defaults to developer if omitted. Only developer and viewer are valid; project ownership cannot be assigned via invite. developer ProjectMemberRoleDeveloper viewer ProjectMemberRoleViewer
     *
     * @return self
     */
