...
class Session implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets tokenized
     *
     * @param string|null $tokenized Tokenized is the tokenized (e.g. JWT) version of the session.  It is only set when the `tokenize_as` query parameter was set to a valid tokenize template during calls to `/session/whoami`.
     *
     * @return self
     */
