...
/**
 * UpdateSettingsFlowWithPasswordMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateSettingsFlowWithPasswordMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateSettingsFlowWithPasswordMethod';
    ...
    */
     ...
     * Sets method
     *
     * @param string $method Method  Should be set to password when trying to update a password.
     *
     * @return self
     */
