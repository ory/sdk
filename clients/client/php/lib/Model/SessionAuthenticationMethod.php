...
class SessionAuthenticationMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'upstreamAcr' => 'setUpstreamAcr',
        'upstreamAmr' => 'setUpstreamAmr'
    ];
    ...
    protected static $getters = [
        ...
        'upstreamAcr' => 'getUpstreamAcr',
        'upstreamAmr' => 'getUpstreamAmr'
    ];
    ...
    public const METHOD_PROFILE = 'profile';
    public const METHOD_SAML = 'saml';
    public const METHOD_DEVICEAUTHN = 'deviceauthn';
    public const METHOD_IDENTIFIER_FIRST = 'identifier_first';
    ...
    public function getMethodAllowableValues()
    {
        return [
            ...
            self::METHOD_PROFILE,
            self::METHOD_SAML,
            self::METHOD_DEVICEAUTHN,
            self::METHOD_IDENTIFIER_FIRST,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('upstreamAcr', $data ?? [], null);
        $this->setIfExists('upstreamAmr', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getUpstreamAcr()
    {
        return $this->container['upstreamAcr'];
    }

    /**
     * Sets upstreamAcr
     *
     * @param string|null $upstreamAcr UpstreamACR is the `acr` claim reported by the upstream OIDC provider, if any. Populated only for OIDC login methods when the upstream ID token contained an `acr` claim.
     *
     * @return self
     */
    public function setUpstreamAcr($upstreamAcr)
    {
        if (is_null($upstreamAcr)) {
            throw new \InvalidArgumentException('non-nullable upstreamAcr cannot be null');
        }
        $this->container['upstreamAcr'] = $upstreamAcr;
     ...
     * @return string[]|null
     */
    public function getUpstreamAmr()
    {
        return $this->container['upstreamAmr'];
    }

    /**
     * Sets upstreamAmr
     *
     * @param string[]|null $upstreamAmr UpstreamAMR is the `amr` claim reported by the upstream OIDC provider, if any. Populated only for OIDC login methods when the upstream ID token contained an `amr` claim.
     *
     * @return self
     */
    public function setUpstreamAmr($upstreamAmr)
    {
        if (is_null($upstreamAmr)) {
            throw new \InvalidArgumentException('non-nullable upstreamAmr cannot be null');
        }
        $this->container['upstreamAmr'] = $upstreamAmr;
