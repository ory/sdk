...
class SessionAuthenticationMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const METHOD_LINK_RECOVERY = 'link_recovery';
    const METHOD_CODE_RECOVERY = 'code_recovery';
    const METHOD_PASSWORD = 'password';
    const METHOD_CODE = 'code';
    const METHOD_TOTP = 'totp';
    const METHOD_OIDC = 'oidc';
    const METHOD_WEBAUTHN = 'webauthn';
    const METHOD_LOOKUP_SECRET = 'lookup_secret';
    const METHOD_V0_6_LEGACY_SESSION = 'v0.6_legacy_session';
    ...
    {
        $this->container['aal'] = $data['aal'] ?? null;
