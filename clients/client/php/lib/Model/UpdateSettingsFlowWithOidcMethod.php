...
class UpdateSettingsFlowWithOidcMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets flow
     *
     * @param string|null $flow Flow ID is the flow's ID.
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link Link this provider  Either this or `unlink` must be set.  type: string
     *
     * @return self
     */
     ...
     * Sets unlink
     *
     * @param string|null $unlink Unlink this provider  Either this or `link` must be set.  type: string
     *
     * @return self
     */
