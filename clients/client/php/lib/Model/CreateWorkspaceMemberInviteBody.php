...
/**
 * CreateWorkspaceMemberInviteBody Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateWorkspaceMemberInviteBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateWorkspaceMemberInviteBody';
    ...
    */
     ...
     * Sets inviteeEmail
     *
     * @param string $inviteeEmail A email to invite
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string $role The role the user will have in the workspace owner WorkspaceMemberRoleOwner developer WorkspaceMemberRoleDeveloper viewer WorkspaceMemberRoleViewer
     *
     * @return self
     */
