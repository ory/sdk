...
class NormalizedProjectRevisionCourierChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const REQUEST_CONFIG_AUTH_TYPE_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getRequestConfigAuthTypeAllowableValues()
    {
        return [
            ...
            self::REQUEST_CONFIG_AUTH_TYPE_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    */
     ...
     *
     * @param string|null $requestConfigAuthConfigApiKeyIn API key location  Can either be \"header\" or \"query\"  Only used if the auth type is api_key
     *
     * @return self
     */
    ...
    public function setRequestConfigAuthType($requestConfigAuthType)
    {
        ...
        if (!in_array($requestConfigAuthType, $allowedValues, true)) {
            $requestConfigAuthType = self::REQUEST_CONFIG_AUTH_TYPE_UNKNOWN_DEFAULT_OPEN_API;
        }
