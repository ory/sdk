...
/**
 * ProjectRevisionThirdPartyLoginProvider Class Doc Comment
 *
 * @category Class
 * @package  Ory\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectRevisionThirdPartyLoginProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'projectRevisionThirdPartyLoginProvider';
    ...
    protected static $openAPITypes = [
        'applePrivateKey' => '\Ory\Client\Model\SQLNullString',
        'applePrivateKeyId' => 'string',
        'appleTeamId' => 'string',
        'authUrl' => 'string',
        'azureTenant' => 'string',
        'clientId' => 'string',
        'clientSecret' => '\Ory\Client\Model\SQLNullString',
        'createdAt' => '\DateTime',
        'id' => 'string',
        'issuerUrl' => 'string',
        'label' => 'string',
     ...
     *
     * @return \Ory\Client\Model\SQLNullString|null
     */
     ...
     *
     * @param \Ory\Client\Model\SQLNullString|null $applePrivateKey applePrivateKey
     *
     * @return self
     */
     ...
     * Sets clientSecret
     *
     * @param \Ory\Client\Model\SQLNullString|null $clientSecret clientSecret
     *
     * @return self
     */
