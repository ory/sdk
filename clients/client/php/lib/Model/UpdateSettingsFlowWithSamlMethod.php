...
/**
 * UpdateSettingsFlowWithSamlMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateSettingsFlowWithSamlMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateSettingsFlowWithSamlMethod';
    ...
    */
     ...
     * Sets method
     *
     * @param string $method Method  Should be set to saml when trying to update a profile.
     *
     * @return self
     */
