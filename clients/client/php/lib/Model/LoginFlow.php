...
class LoginFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const ACTIVE_PASSWORD = 'password';
    const ACTIVE_OIDC = 'oidc';
    const ACTIVE_TOTP = 'totp';
    const ACTIVE_LOOKUP_SECRET = 'lookup_secret';
    const ACTIVE_WEBAUTHN = 'webauthn';
    const ACTIVE_CODE = 'code';
    const ACTIVE_LINK_RECOVERY = 'link_recovery';
    const ACTIVE_CODE_RECOVERY = 'code_recovery';
