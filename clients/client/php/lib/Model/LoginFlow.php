...
class LoginFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'state' => '\Ory\Client\Model\LoginFlowState',
        'testContext' => '\Ory\Client\Model\LoginFlowTestContext',
    ...
    public const ACTIVE_DEVICEAUTHN = 'deviceauthn';
    public const ACTIVE_IDENTIFIER_FIRST = 'identifier_first';
    ...
    public function getActiveAllowableValues()
    {
        return [
            ...
            self::ACTIVE_PROFILE,
            self::ACTIVE_SAML,
            self::ACTIVE_DEVICEAUTHN,
            self::ACTIVE_IDENTIFIER_FIRST,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('testContext', $data ?? [], null);
    ...
    */
     ...
     * Sets identitySchema
     *
     * @param string|null $identitySchema IdentitySchema optionally holds the ID of the identity schema that is used for this flow. This value can be set by the user when creating the flow and should be retained when the flow is saved or converted to another flow.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Ory\Client\Model\LoginFlowState
     */
     ...
     * Sets state
     *
     * @param \Ory\Client\Model\LoginFlowState $state state
     *
     * @return self
     */
     ...
     * Gets testContext
     *
     * @return \Ory\Client\Model\LoginFlowTestContext|null
     */
    public function getTestContext()
    {
        return $this->container['testContext'];
    }

    /**
     * Sets testContext
     *
     * @param \Ory\Client\Model\LoginFlowTestContext|null $testContext testContext
     *
     * @return self
     */
    public function setTestContext($testContext)
    {
        if (is_null($testContext)) {
            throw new \InvalidArgumentException('non-nullable testContext cannot be null');
        }
        $this->container['testContext'] = $testContext;
