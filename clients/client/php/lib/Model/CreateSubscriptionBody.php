...
class CreateSubscriptionBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('provisionFirstProject', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($provisionFirstProject)) {
            throw new \InvalidArgumentException('non-nullable provisionFirstProject cannot be null');
        }
