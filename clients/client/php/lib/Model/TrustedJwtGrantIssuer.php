...
class TrustedJwtGrantIssuer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'issuer' => 'string',
        'publicKey' => '\Ory\Client\Model\TrustedJsonWebKey',
        'scope' => 'string[]',
        'subject' => 'string'
    ];
     ...
     * Gets publicKey
     *
     * @return \Ory\Client\Model\TrustedJsonWebKey|null
     */
     ...
     * Sets publicKey
     *
     * @param \Ory\Client\Model\TrustedJsonWebKey|null $publicKey publicKey
     *
     * @return self
     */
