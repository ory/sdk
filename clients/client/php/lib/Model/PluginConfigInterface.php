...
class PluginConfigInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'socket' => 'string',
        'types' => '\Ory\Client\Client\Model\PluginInterfaceType[]'
    ];
     ...
     * Gets types
     *
     * @return \Ory\Client\Client\Model\PluginInterfaceType[]
     */
     ...
     * Sets types
     *
     * @param \Ory\Client\Client\Model\PluginInterfaceType[] $types types
     *
     * @return self
     */
