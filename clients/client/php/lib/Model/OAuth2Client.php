...
class OAuth2Client implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets clientId
     *
     * @param string|null $clientId ID is the id for this client.  The ID is autogenerated and immutable.
     *
     * @return self
     */
    ...
    public function setPasswordGrantAccessTokenLifespan($passwordGrantAccessTokenLifespan)
    {
        ...
        if (!is_null($passwordGrantAccessTokenLifespan) && (!preg_match("/^[0-9]+(ns|us|ms|s|m|h)$/", $passwordGrantAccessTokenLifespan))) {
            throw new \InvalidArgumentException("invalid value for $passwordGrantAccessTokenLifespan when calling OAuth2Client., must conform to the pattern /^[0-9]+(ns|us|ms|s|m|h)$/.");
        }
    ...
    public function setPasswordGrantRefreshTokenLifespan($passwordGrantRefreshTokenLifespan)
    {
        ...
        if (!is_null($passwordGrantRefreshTokenLifespan) && (!preg_match("/^[0-9]+(ns|us|ms|s|m|h)$/", $passwordGrantRefreshTokenLifespan))) {
            throw new \InvalidArgumentException("invalid value for $passwordGrantRefreshTokenLifespan when calling OAuth2Client., must conform to the pattern /^[0-9]+(ns|us|ms|s|m|h)$/.");
        }
