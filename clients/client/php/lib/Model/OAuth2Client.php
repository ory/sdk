...
class OAuth2Client implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets audience
     *
     * @param string[]|null $audience OAuth 2.0 Client Audience  An allow-list defining the audiences this client is allowed to request tokens for. An audience limits the applicability of an OAuth 2.0 Access Token to, for example, certain API endpoints. The value is a list of URLs. URLs MUST NOT contain whitespaces.
     *
     * @return self
     */
    ...
    public function setAuthorizationCodeGrantAccessTokenLifespan($authorizationCodeGrantAccessTokenLifespan)
    {
        ...
        if (!is_null($authorizationCodeGrantAccessTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($authorizationCodeGrantAccessTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$authorizationCodeGrantAccessTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setAuthorizationCodeGrantIdTokenLifespan($authorizationCodeGrantIdTokenLifespan)
    {
        ...
        if (!is_null($authorizationCodeGrantIdTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($authorizationCodeGrantIdTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$authorizationCodeGrantIdTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setAuthorizationCodeGrantRefreshTokenLifespan($authorizationCodeGrantRefreshTokenLifespan)
    {
        ...
        if (!is_null($authorizationCodeGrantRefreshTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($authorizationCodeGrantRefreshTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$authorizationCodeGrantRefreshTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setClientCredentialsGrantAccessTokenLifespan($clientCredentialsGrantAccessTokenLifespan)
    {
        ...
        if (!is_null($clientCredentialsGrantAccessTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($clientCredentialsGrantAccessTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$clientCredentialsGrantAccessTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
     ...
     * Sets contacts
     *
     * @param string[]|null $contacts OAuth 2.0 Client Contact  An array of strings representing ways to contact people responsible for this client, typically email addresses.
     *
     * @return self
     */
    ...
    public function setDeviceAuthorizationGrantAccessTokenLifespan($deviceAuthorizationGrantAccessTokenLifespan)
    {
        ...
        if (!is_null($deviceAuthorizationGrantAccessTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($deviceAuthorizationGrantAccessTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$deviceAuthorizationGrantAccessTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setDeviceAuthorizationGrantIdTokenLifespan($deviceAuthorizationGrantIdTokenLifespan)
    {
        ...
        if (!is_null($deviceAuthorizationGrantIdTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($deviceAuthorizationGrantIdTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$deviceAuthorizationGrantIdTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setDeviceAuthorizationGrantRefreshTokenLifespan($deviceAuthorizationGrantRefreshTokenLifespan)
    {
        ...
        if (!is_null($deviceAuthorizationGrantRefreshTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($deviceAuthorizationGrantRefreshTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$deviceAuthorizationGrantRefreshTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setImplicitGrantAccessTokenLifespan($implicitGrantAccessTokenLifespan)
    {
        ...
        if (!is_null($implicitGrantAccessTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($implicitGrantAccessTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$implicitGrantAccessTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setImplicitGrantIdTokenLifespan($implicitGrantIdTokenLifespan)
    {
        ...
        if (!is_null($implicitGrantIdTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($implicitGrantIdTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$implicitGrantIdTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setJwtBearerGrantAccessTokenLifespan($jwtBearerGrantAccessTokenLifespan)
    {
        ...
        if (!is_null($jwtBearerGrantAccessTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($jwtBearerGrantAccessTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$jwtBearerGrantAccessTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
     ...
     *
     * @param string[]|null $postLogoutRedirectUris Allowed Post-Redirect Logout URIs  Array of URLs supplied by the RP to which it MAY request that the End-User's User Agent be redirected using the post_logout_redirect_uri parameter after a logout has been performed.
     *
     * @return self
     */
     ...
     * Sets redirectUris
     *
     * @param string[]|null $redirectUris OAuth 2.0 Client Redirect URIs  RedirectURIs is an array of allowed redirect urls for the client.
     *
     * @return self
     */
    ...
    public function setRefreshTokenGrantAccessTokenLifespan($refreshTokenGrantAccessTokenLifespan)
    {
        ...
        if (!is_null($refreshTokenGrantAccessTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($refreshTokenGrantAccessTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$refreshTokenGrantAccessTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setRefreshTokenGrantIdTokenLifespan($refreshTokenGrantIdTokenLifespan)
    {
        ...
        if (!is_null($refreshTokenGrantIdTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($refreshTokenGrantIdTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$refreshTokenGrantIdTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
    ...
    public function setRefreshTokenGrantRefreshTokenLifespan($refreshTokenGrantRefreshTokenLifespan)
    {
        ...
        if (!is_null($refreshTokenGrantRefreshTokenLifespan) && (!preg_match("/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/", ObjectSerializer::toString($refreshTokenGrantRefreshTokenLifespan)))) {
            throw new \InvalidArgumentException("invalid value for \$refreshTokenGrantRefreshTokenLifespan when calling OAuth2Client., must conform to the pattern /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/.");
        }
     ...
     * Sets requestUris
     *
     * @param string[]|null $requestUris OpenID Connect Request URIs  Array of request_uri values that are pre-registered by the RP for use at the OP. Servers MAY cache the contents of the files referenced by these URIs and not retrieve them at the time they are used in a request. OPs can require that request_uri values used be pre-registered with the require_request_uri_registration discovery parameter.
     *
     * @return self
     */
