...
/**
 * DeriveTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  Ory\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeriveTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeriveTokenRequest';
    ...
    protected static $openAPITypes = [
        'algorithm' => '\Ory\Client\Model\TokenAlgorithm',
        'credential' => 'string',
        'customClaims' => 'object',
        'scopes' => 'string[]',
        'ttl' => 'string'
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('customClaims', $data ?? [], null);
    ...
    */
     ...
     * Gets algorithm
     *
     * @return \Ory\Client\Model\TokenAlgorithm|null
     */
     ...
     * Sets algorithm
     *
     * @param \Ory\Client\Model\TokenAlgorithm|null $algorithm algorithm
     *
     * @return self
     */
     ...
     * Sets customClaims
     *
     * @param object|null $customClaims custom_claims is a JSON object whose entries are merged into the JWT payload (or macaroon caveats) at signing time. Reserved JWT claims (iss, sub, aud, exp, nbf, iat, jti) are rejected. Total serialized size is capped at 4KB.
     *
     * @return self
     */
    public function setCustomClaims($customClaims)
    {
        if (is_null($customClaims)) {
            throw new \InvalidArgumentException('non-nullable customClaims cannot be null');
        }
