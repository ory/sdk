...
class ProjectBrandingTheme implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'accountExperienceVariables' => '\Ory\Client\Model\AccountExperienceThemeVariables[]',
        'accountExperienceVariablesStylesheet' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'accountExperienceVariables' => null,
        'accountExperienceVariablesStylesheet' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'accountExperienceVariables' => false,
        'accountExperienceVariablesStylesheet' => false,
    ...
    protected static $attributeMap = [
        ...
        'accountExperienceVariables' => 'account_experience_variables',
        'accountExperienceVariablesStylesheet' => 'account_experience_variables_stylesheet',
    ...
    protected static $setters = [
        ...
        'accountExperienceVariables' => 'setAccountExperienceVariables',
        'accountExperienceVariablesStylesheet' => 'setAccountExperienceVariablesStylesheet',
    ...
    protected static $getters = [
        ...
        'accountExperienceVariables' => 'getAccountExperienceVariables',
        'accountExperienceVariablesStylesheet' => 'getAccountExperienceVariablesStylesheet',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('accountExperienceVariables', $data ?? [], null);
        $this->setIfExists('accountExperienceVariablesStylesheet', $data ?? [], null);
        ...
        $this->setIfExists('logoType', $data ?? [], null);
        $this->setIfExists('logoUrl', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('primaryColor', $data ?? [], null);
        $this->setIfExists('projectBrandingId', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets accountExperienceVariables
     *
     * @return \Ory\Client\Model\AccountExperienceThemeVariables[]|null
     */
    public function getAccountExperienceVariables()
    {
        return $this->container['accountExperienceVariables'];
    }

    /**
     * Sets accountExperienceVariables
     *
     * @param \Ory\Client\Model\AccountExperienceThemeVariables[]|null $accountExperienceVariables The Account Experience Theme Variables.
     *
     * @return self
     */
    public function setAccountExperienceVariables($accountExperienceVariables)
    {
        if (is_null($accountExperienceVariables)) {
            throw new \InvalidArgumentException('non-nullable accountExperienceVariables cannot be null');
        }
        $this->container['accountExperienceVariables'] = $accountExperienceVariables;

        return $this;
    }

    /**
     * Gets accountExperienceVariablesStylesheet
     *
     * @return string|null
     */
    public function getAccountExperienceVariablesStylesheet()
    {
        return $this->container['accountExperienceVariablesStylesheet'];
    }

    /**
     * Sets accountExperienceVariablesStylesheet
     *
     * @param string|null $accountExperienceVariablesStylesheet AccountExperienceVariableStylesheet holds a reference to the current stylesheet that can be used in the AX
     *
     * @return self
     */
    public function setAccountExperienceVariablesStylesheet($accountExperienceVariablesStylesheet)
    {
        if (is_null($accountExperienceVariablesStylesheet)) {
            throw new \InvalidArgumentException('non-nullable accountExperienceVariablesStylesheet cannot be null');
        }
        $this->container['accountExperienceVariablesStylesheet'] = $accountExperienceVariablesStylesheet;
     ...
     * Sets faviconType
     *
     * @param string|null $faviconType Favicon Type The Favicon mime type.
     *
     * @return self
     */
     ...
     * Sets faviconUrl
     *
     * @param string|null $faviconUrl Favicon URL Favicon can be an https:// or base64:// URL. If the URL is not allowed, the favicon will be stored inside the Ory Network storage bucket.
     *
     * @return self
     */
    ...
    {
        if (is_null($logoType)) {
            throw new \InvalidArgumentException('non-nullable logoType cannot be null');
        }
    ...
    {
        if (is_null($projectBrandingId)) {
            throw new \InvalidArgumentException('non-nullable projectBrandingId cannot be null');
        }
