...
class NormalizedProject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const HOME_REGION_EU = 'eu';
    public const HOME_REGION_ASIA = 'asia';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['hosts']) < 1)) {
            $invalidProperties[] = "invalid value for 'hosts', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets homeRegion
     *
     * @param string $homeRegion The project's data home region. eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest eu EU asia Asia us US global Global
     *
     * @return self
     */
     ...
     * Sets hosts
     *
     * @param string[] $hosts The FQDN hostnames this project listens on
     *
     * @return self
     */
    public function setHosts($hosts)
    {
        ...
        if ((count($hosts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hosts when calling NormalizedProject., number of items must be greater than or equal to 1.');
        }
