...
class AddProjectToWorkspaceBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const PROJECT_SUBSCRIPTION_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getProjectSubscriptionAllowableValues()
    {
        return [
            ...
            self::PROJECT_SUBSCRIPTION_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    */
     ...
     *
     * @param string $projectSubscription The action to take with the project subscription. Can be one of \"migrate\", and \"ignore\". \"migrate\" will migrate the project subscription to the workspace. \"ignore\" will ignore the project subscription. migrate ProjectSubscriptionActionMigrate will migrate the project subscription to the  workspace. ignore ProjectSubscriptionActionIgnore will ignore the project subscription.
     *
     * @return self
     */
    public function setProjectSubscription($projectSubscription)
    {
        ...
        if (!in_array($projectSubscription, $allowedValues, true)) {
            $projectSubscription = self::PROJECT_SUBSCRIPTION_UNKNOWN_DEFAULT_OPEN_API;
        }
