...
class ConsistencyRequestParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CONSISTENCY_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getConsistencyAllowableValues()
    {
        return [
            ...
            self::CONSISTENCY_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    */
    ...
    public function setConsistency($consistency)
    {
        ...
        if (!in_array($consistency, $allowedValues, true)) {
            $consistency = self::CONSISTENCY_UNKNOWN_DEFAULT_OPEN_API;
        }
