...
class AttributeFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CONDITION_REGEX = 'regex';
    public const CONDITION_NOT_REGEX = 'not_regex';
    public const CONDITION_SET = 'set';
    public const CONDITION_NOT_SET = 'not_set';
    ...
    public function getConditionAllowableValues()
    {
        return [
            ...
            self::CONDITION_REGEX,
            self::CONDITION_NOT_REGEX,
            self::CONDITION_SET,
            self::CONDITION_NOT_SET,
    ...
    */
     ...
     * Sets condition
     *
     * @param string|null $condition equals ConditionEquals not_equals ConditionNotEquals contains ConditionContains not_contains ConditionNotContains regex ConditionRegex not_regex ConditionNotRegex set ConditionSet not_set ConditionNotSet
     *
     * @return self
     */
