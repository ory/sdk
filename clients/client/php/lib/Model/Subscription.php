...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const CURRENT_INTERVAL_MONTHLY = 'monthly';
    const CURRENT_INTERVAL_YEARLY = 'yearly';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['currentInterval'] = $data['currentInterval'] ?? null;
        $this->container['currentPlan'] = $data['currentPlan'] ?? null;
        $this->container['currentPlanDetails'] = $data['currentPlanDetails'] ?? null;
        $this->container['customerId'] = $data['customerId'] ?? null;
        $this->container['id'] = $data['id'] ?? null;
        $this->container['intervalChangesTo'] = $data['intervalChangesTo'] ?? null;
        ...
        $this->container['stripeCheckoutExpiresAt'] = $data['stripeCheckoutExpiresAt'] ?? null;
