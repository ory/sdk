...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CURRENT_INTERVAL_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getCurrentIntervalAllowableValues()
    {
        return [
            ...
            self::CURRENT_INTERVAL_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    */
    ...
    public function setCurrentInterval($currentInterval)
    {
        ...
        if (!in_array($currentInterval, $allowedValues, true)) {
            $currentInterval = self::CURRENT_INTERVAL_UNKNOWN_DEFAULT_OPEN_API;
        }
    ...
    public function setPlanChangesAt($planChangesAt)
    {
        if (is_null($planChangesAt)) {
            array_push($this->openAPINullablesSetToNull, 'planChangesAt');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('planChangesAt', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setStripeCheckoutExpiresAt($stripeCheckoutExpiresAt)
    {
        if (is_null($stripeCheckoutExpiresAt)) {
            array_push($this->openAPINullablesSetToNull, 'stripeCheckoutExpiresAt');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('stripeCheckoutExpiresAt', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
