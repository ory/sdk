...
class ProjectApi
{
    ...
    * if needed, use the 'variables' parameter to pass variables to the host.
     ...
     * URL: https://api.console.ory.sh
     *
     * @param  string $projectId The project&#39;s ID. (required)
     * @param  string|null $body body (optional)
     * @param  null|int $hostIndex Host index. Defaults to null. If null, then the library will use $this->hostIndex instead
     * @param  array $variables Associative array of variables to pass to the host. Defaults to empty array.
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['validateOpl'] to see the possible values for this operation
     *
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\OplValidateResult|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric
     */
    public function validateOpl($projectId, $body = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['validateOpl'][0])
    {
        list($response) = $this->validateOplWithHttpInfo($projectId, $body, $hostIndex, $variables, $contentType);
        return $response;
    }

    /**
     * Operation validateOplWithHttpInfo
     *
     * Validate an Ory Permission Language document
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @throws \Ory\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\OplValidateResult|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric|\Ory\Client\Model\ErrorGeneric, HTTP status code, HTTP response headers (array of strings)
     */
    public function validateOplWithHttpInfo($projectId, $body = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['validateOpl'][0])
    {
        $request = $this->validateOplRequest($projectId, $body, $hostIndex, $variables, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Ory\Client\Model\OplValidateResult',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateOplAsync($projectId, $body = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['validateOpl'][0])
    {
        return $this->validateOplAsyncWithHttpInfo($projectId, $body, $hostIndex, $variables, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation validateOplAsyncWithHttpInfo
     *
     * Validate an Ory Permission Language document
     *
     * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateOplAsyncWithHttpInfo($projectId, $body = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['validateOpl'][0])
    {
        $returnType = '\Ory\Client\Model\OplValidateResult';
        $request = $this->validateOplRequest($projectId, $body, $hostIndex, $variables, $contentType);
    ...
    /**
     * Create request for operation 'validateOpl'
     *
    * This operation contains host(s) defined in the OpenAPI spec. Use 'hostIndex' to select the host.
    * if needed, use the 'variables' parameter to pass variables to the host.
     * URL: https://api.console.ory.sh
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function validateOplRequest($projectId, $body = null, ?int $hostIndex = null, array $variables = [], string $contentType = self::contentTypes['validateOpl'][0])
    {

        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $projectId when calling validateOpl'
            );
        }



        $resourcePath = '/projects/{project_id}/opl/validate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $hostSettings = $this->getHostSettingsForvalidateOpl();
    ...
    /**
     * Returns an array of host settings for Operation validateOpl
     *
     * @return array an array of host settings
     */
    protected function getHostSettingsForvalidateOpl(): array
    {
        return [
            [
                "url" => "https://api.console.ory.sh",
