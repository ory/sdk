...
class V0alpha1Api
{
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\SelfServiceLoginFlow|\Ory\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\SelfServiceLoginFlow|\Ory\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\SuccessfulSelfServiceLoginWithoutBrowser|\Ory\Client\Model\SelfServiceLoginFlow|\Ory\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\SuccessfulSelfServiceLoginWithoutBrowser|\Ory\Client\Model\SelfServiceLoginFlow|\Ory\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\SuccessfulSelfServiceRegistrationWithoutBrowser|\Ory\Client\Model\SelfServiceRegistrationFlow|\Ory\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\SuccessfulSelfServiceRegistrationWithoutBrowser|\Ory\Client\Model\SelfServiceRegistrationFlow|\Ory\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\SuccessfulSelfServiceSettingsWithoutBrowser|\Ory\Client\Model\SelfServiceSettingsFlow|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Client\Model\SuccessfulSelfServiceSettingsWithoutBrowser|\Ory\Client\Model\SelfServiceSettingsFlow|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError|\Ory\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitSelfServiceSettingsFlowWithHttpInfo($flow, $xSessionToken = null, $submitSelfServiceSettingsFlowBody = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Client\Model\SuccessfulSelfServiceSettingsWithoutBrowser' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Client\Model\SuccessfulSelfServiceSettingsWithoutBrowser', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Ory\Client\Model\SuccessfulSelfServiceSettingsWithoutBrowser';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ory\Client\Model\SuccessfulSelfServiceSettingsWithoutBrowser',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
