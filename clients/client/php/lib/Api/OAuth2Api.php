...
class OAuth2Api
{
     ...
     */
    public function listOAuth2ConsentSessions($subject, $pageSize = 250, $pageToken = '1')
    {
        list($response) = $this->listOAuth2ConsentSessionsWithHttpInfo($subject, $pageSize, $pageToken);
        return $response;
    }
     ...
     */
    public function listOAuth2ConsentSessionsWithHttpInfo($subject, $pageSize = 250, $pageToken = '1')
    {
        $request = $this->listOAuth2ConsentSessionsRequest($subject, $pageSize, $pageToken);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listOAuth2ConsentSessionsAsync($subject, $pageSize = 250, $pageToken = '1')
    {
        return $this->listOAuth2ConsentSessionsAsyncWithHttpInfo($subject, $pageSize, $pageToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listOAuth2ConsentSessionsAsyncWithHttpInfo($subject, $pageSize = 250, $pageToken = '1')
    {
        $returnType = '\Ory\Client\Model\OAuth2ConsentSession[]';
        $request = $this->listOAuth2ConsentSessionsRequest($subject, $pageSize, $pageToken);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listOAuth2ConsentSessionsRequest($subject, $pageSize = 250, $pageToken = '1')
    {
     ...
     *
     * @param  string $subject OAuth 2.0 Subject  The subject to revoke authentication sessions for. (required)
     *
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function revokeOAuth2LoginSessions($subject)
    {
        $this->revokeOAuth2LoginSessionsWithHttpInfo($subject);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function revokeOAuth2LoginSessionsWithHttpInfo($subject)
    {
        $request = $this->revokeOAuth2LoginSessionsRequest($subject);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revokeOAuth2LoginSessionsAsync($subject)
    {
        return $this->revokeOAuth2LoginSessionsAsyncWithHttpInfo($subject)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revokeOAuth2LoginSessionsAsyncWithHttpInfo($subject)
    {
        $returnType = '';
        $request = $this->revokeOAuth2LoginSessionsRequest($subject);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function revokeOAuth2LoginSessionsRequest($subject)
    {
        // verify the required parameter 'subject' is set
        if ($subject === null || (is_array($subject) && count($subject) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $subject when calling revokeOAuth2LoginSessions'
            );
        }
