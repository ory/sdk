...
class V0alpha0Api
{
     ...
     * Create a Project
     *
     * @param  \Ory\Client\Model\ProjectPatch $projectPatch projectPatch (optional)
     *
     ...
     */
    public function createProject($projectPatch = null)
    {
        list($response) = $this->createProjectWithHttpInfo($projectPatch);
        return $response;
    }
     ...
     * Create a Project
     *
     * @param  \Ory\Client\Model\ProjectPatch $projectPatch (optional)
     *
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createProjectWithHttpInfo($projectPatch = null)
    {
        $request = $this->createProjectRequest($projectPatch);
     ...
     */
    public function createProjectAsync($projectPatch = null)
    {
        return $this->createProjectAsyncWithHttpInfo($projectPatch)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createProjectAsyncWithHttpInfo($projectPatch = null)
    {
        $returnType = '\Ory\Client\Model\Project';
        $request = $this->createProjectRequest($projectPatch);
     ...
     */
    public function createProjectRequest($projectPatch = null)
    {
        ...
        if (isset($projectPatch)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($projectPatch));
            } else {
     ...
     * @return \Ory\Client\Model\Project|\Ory\Client\Model\GenericError|\Ory\Client\Model\GenericError|\Ory\Client\Model\GenericError|\Ory\Client\Model\GenericError
     */
    public function updateProject($projectId, $projectPatch = null)
    {
        list($response) = $this->updateProjectWithHttpInfo($projectId, $projectPatch);
        return $response;
    }
     ...
     * @return array of \Ory\Client\Model\Project|\Ory\Client\Model\GenericError|\Ory\Client\Model\GenericError|\Ory\Client\Model\GenericError|\Ory\Client\Model\GenericError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateProjectWithHttpInfo($projectId, $projectPatch = null)
    {
        $request = $this->updateProjectRequest($projectId, $projectPatch);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProjectAsync($projectId, $projectPatch = null)
    {
        return $this->updateProjectAsyncWithHttpInfo($projectId, $projectPatch)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProjectAsyncWithHttpInfo($projectId, $projectPatch = null)
    {
        $returnType = '\Ory\Client\Model\Project';
        $request = $this->updateProjectRequest($projectId, $projectPatch);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateProjectRequest($projectId, $projectPatch = null)
    {
        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
