...
class IdentityApi
{
     ...
     */
    public function listIdentities($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null)
    {
        list($response) = $this->listIdentitiesWithHttpInfo($perPage, $page, $pageSize, $pageToken, $consistency, $credentialsIdentifier, $previewCredentialsIdentifierSimilar);
        return $response;
    }
     ...
     */
    public function listIdentitiesWithHttpInfo($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null)
    {
        $request = $this->listIdentitiesRequest($perPage, $page, $pageSize, $pageToken, $consistency, $credentialsIdentifier, $previewCredentialsIdentifierSimilar);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsync($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null)
    {
        return $this->listIdentitiesAsyncWithHttpInfo($perPage, $page, $pageSize, $pageToken, $consistency, $credentialsIdentifier, $previewCredentialsIdentifierSimilar)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsyncWithHttpInfo($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null)
    {
        $returnType = '\Ory\Client\Model\Identity[]';
        $request = $this->listIdentitiesRequest($perPage, $page, $pageSize, $pageToken, $consistency, $credentialsIdentifier, $previewCredentialsIdentifierSimilar);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIdentitiesRequest($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null)
    {
