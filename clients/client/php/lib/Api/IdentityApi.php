...
class IdentityApi
{
     ...
     * @param  string $identifier Identifier  This query parameter can be used to lookup an identity using its identifier. For example - an email address (optional)
     *
     * @throws \Ory\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Client\Model\Identity[]|\Ory\Client\Model\ErrorGeneric
     */
    public function listIdentities($perPage = 250, $page = 1, $identifier = null)
    {
        list($response) = $this->listIdentitiesWithHttpInfo($perPage, $page, $identifier);
        return $response;
    }
     ...
     */
    public function listIdentitiesWithHttpInfo($perPage = 250, $page = 1, $identifier = null)
    {
        $request = $this->listIdentitiesRequest($perPage, $page, $identifier);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsync($perPage = 250, $page = 1, $identifier = null)
    {
        return $this->listIdentitiesAsyncWithHttpInfo($perPage, $page, $identifier)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsyncWithHttpInfo($perPage = 250, $page = 1, $identifier = null)
    {
        $returnType = '\Ory\Client\Model\Identity[]';
        $request = $this->listIdentitiesRequest($perPage, $page, $identifier);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIdentitiesRequest($perPage = 250, $page = 1, $identifier = null)
    {
