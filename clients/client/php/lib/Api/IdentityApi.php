...
class IdentityApi
{
     ...
     */
    public function listIdentities($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $ids = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null, $includeCredential = null, $organizationId = null, string $contentType = self::contentTypes['listIdentities'][0])
    {
     ...
     */
    public function listIdentitiesWithHttpInfo($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $ids = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null, $includeCredential = null, $organizationId = null, string $contentType = self::contentTypes['listIdentities'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsync($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $ids = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null, $includeCredential = null, $organizationId = null, string $contentType = self::contentTypes['listIdentities'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsyncWithHttpInfo($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $ids = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null, $includeCredential = null, $organizationId = null, string $contentType = self::contentTypes['listIdentities'][0])
    {
        $returnType = '\Ory\Client\Model\Identity[]';
        $request = $this->listIdentitiesRequest($perPage, $page, $pageSize, $pageToken, $consistency, $ids, $credentialsIdentifier, $previewCredentialsIdentifierSimilar, $includeCredential, $organizationId, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIdentitiesRequest($perPage = 250, $page = null, $pageSize = 250, $pageToken = '1', $consistency = null, $ids = null, $credentialsIdentifier = null, $previewCredentialsIdentifierSimilar = null, $includeCredential = null, $organizationId = null, string $contentType = self::contentTypes['listIdentities'][0])
    {
