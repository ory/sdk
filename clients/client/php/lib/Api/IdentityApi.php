...
class IdentityApi
{
     ...
     */
    public function listIdentities($perPage = 250, $page = 1)
    {
     ...
     */
    public function listIdentitiesWithHttpInfo($perPage = 250, $page = 1)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsync($perPage = 250, $page = 1)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentitiesAsyncWithHttpInfo($perPage = 250, $page = 1)
    {
        $returnType = '\Ory\Client\Model\Identity[]';
        $request = $this->listIdentitiesRequest($perPage, $page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIdentitiesRequest($perPage = 250, $page = 1)
    {
