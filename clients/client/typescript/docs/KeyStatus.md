...
* `KeyStatusUnspecified` (value: `'KEY_STATUS_UNSPECIFIED'`)

* `KeyStatusActive` (value: `'KEY_STATUS_ACTIVE'`)

* `KeyStatusRevoked` (value: `'KEY_STATUS_REVOKED'`)

* `KeyStatusExpired` (value: `'KEY_STATUS_EXPIRED'`)
