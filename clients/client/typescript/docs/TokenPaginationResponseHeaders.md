...
**x_total_count** | **number** | The X-Total-Count HTTP Header  The &#x60;X-Total-Count&#x60; header contains the total number of items in the collection. | [optional] [default to undefined]

## Example

```typescript
import { TokenPaginationResponseHeaders } from '@ory/client';

const instance: TokenPaginationResponseHeaders = {
    link,
    x_total_count,
};
```
