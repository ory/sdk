...
* `RevocationReasonUnspecified` (value: `'REVOCATION_REASON_UNSPECIFIED'`)

* `RevocationReasonKeyCompromise` (value: `'REVOCATION_REASON_KEY_COMPROMISE'`)

* `RevocationReasonAffiliationChanged` (value: `'REVOCATION_REASON_AFFILIATION_CHANGED'`)

* `RevocationReasonSuperseded` (value: `'REVOCATION_REASON_SUPERSEDED'`)

* `RevocationReasonPrivilegeWithdrawn` (value: `'REVOCATION_REASON_PRIVILEGE_WITHDRAWN'`)
