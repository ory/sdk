...
------------ | ------------- | ------------- | -------------
**allowed_cidrs** | **Array&lt;string&gt;** | allowed_cidrs is a list of CIDR ranges that are allowed to use this key. Supports both IPv4 (e.g., \&quot;10.0.0.0/8\&quot;) and IPv6 (e.g., \&quot;2001:db8::/32\&quot;). If empty, all IPs are allowed (no restriction). | [optional] [default to undefined]

## Example

```typescript
import { IPRestriction } from '@ory/client';
