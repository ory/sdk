...
export interface ProjectRevision {
    ...
    /**
     * 
     * @type {Array<ProjectRevisionIdentitySchema>}
     * @memberof ProjectRevision
     */
    ...
    /**
     * 
     * @type {Array<ProjectRevisionHook>}
     * @memberof ProjectRevision
     */
    ...
    /**
     * 
     * @type {Array<ProjectRevisionThirdPartyLoginProvider>}
     * @memberof ProjectRevision
     */
 ...
 * 
 * @export
 * @interface ProjectRevisionHook
 */
export interface ProjectRevisionHook {
    /**
     * The Hooks Config Key
     * @type {string}
     * @memberof ProjectRevisionHook
     */
    'config_key': string;
    /**
     * The Project\'s Revision Creation Date
 ...
 * 
 * @export
 * @interface ProjectRevisionIdentitySchema
 */
export interface ProjectRevisionIdentitySchema {
    /**
     * The Project\'s Revision Creation Date
     * @type {string}
     * @memberof ProjectRevisionIdentitySchema
     */
    'created_at'?: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface ProjectRevisionThirdPartyLoginProvider
 */
export interface ProjectRevisionThirdPartyLoginProvider {
    /**
     * Apple Private Key  Sign In with Apple Private Key needed for generating a JWT token for client secret
     * @type {string}
     * @memberof ProjectRevisionThirdPartyLoginProvider
     */
 ...
 * 
 * @export
 * @interface SuccessfulProjectConfigUpdate
 */
export interface SuccessfulProjectConfigUpdate {
    /**
     * 
     * @type {Project}
     * @memberof SuccessfulProjectConfigUpdate
     */
    'project'?: Project;
    /**
 ...
 * 
 * @export
 * @interface UpdateProjectConfigConfig
 */
export interface UpdateProjectConfigConfig {
    /**
     * The Ory Kratos config to import
     * @type {object}
     * @memberof UpdateProjectConfigConfig
     */
    'identity': object;
}
/**
...
export const V0alpha0ApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createProject: async (projectRevision?: ProjectRevision, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(projectRevision, localVarRequestOptions, configuration)
         ...
         * @summary Returns Your Active Ory Cloud Project
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getActiveProject: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/backoffice/public/console/projects/active`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        getProjectMembers: async (projectId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/backoffice/public/projects/{project_id}/members`
                .replace(`{${"project_id"}}`, encodeURIComponent(String(projectId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        removeProjectMember: async (projectId: string, memberId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/backoffice/public/projects/{project_id}/members/{member_id}`
                .replace(`{${"project_id"}}`, encodeURIComponent(String(projectId)))
         ...
         * @summary Sets Your Active Project
         * @param {InlineObject} [inlineObject] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        setActiveProject: async (inlineObject?: InlineObject, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/backoffice/public/console/projects/active`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        updateProject: async (projectId: string, projectRevision?: ProjectRevision, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'projectId' is not null or undefined
         ...
         * @param {string} projectId Project ID  The project\&#39;s ID.
         * @param {UpdateProjectConfigConfig} [updateProjectConfigConfig] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateProjectConfig: async (projectId: string, updateProjectConfigConfig?: UpdateProjectConfigConfig, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'projectId' is not null or undefined
            assertParamExists('updateProjectConfig', 'projectId', projectId)
            const localVarPath = `/backoffice/public/projects/{project_id}/configs`
                .replace(`{${"project_id"}}`, encodeURIComponent(String(projectId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(updateProjectConfigConfig, localVarRequestOptions, configuration)
...
export const V0alpha0ApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createProject(projectRevision?: ProjectRevision, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Project>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createProject(projectRevision, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Use this API to get your active project in the Ory Cloud Console UI.
         ...
         * @throws {RequiredError}
         */
        async getActiveProject(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActiveProject>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getActiveProject(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a projects you have access to by its ID.
         ...
         * @throws {RequiredError}
         */
        async setActiveProject(inlineObject?: InlineObject, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.setActiveProject(inlineObject, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Creates a new configuration revision for a project.
         ...
         * @throws {RequiredError}
         */
        async updateProject(projectId: string, projectRevision?: ProjectRevision, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Project>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateProject(projectId, projectRevision, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This endpoints allows you to update the Ory Cloud Project configuration for individual services (identity, permission, ...). The configuration is fully compatible with the open source projects for the respective services (e.g. Ory Kratos for Identity, Ory Keto for Permissions).  This endpoint expects the `version` key to be set in the payload. If it is unset, it will try to import the config as if it is from the most recent version.  If you have an older version of a configuration, you should set the version key in the payload!  While this endpoint is able to process all configuration items related to features (e.g. password reset), it does not support operational configuration items (e.g. port, tracing, logging) otherwise available in the open source.  For configuration items that can not be translated to Ory Cloud, this endpoint will return a list of warnings to help you understand which parts of your config could not be processed.  Be aware that updating any service\'s configuration will completely override your current configuration for that service!
         ...
         * @throws {RequiredError}
         */
        async updateProjectConfig(projectId: string, updateProjectConfigConfig?: UpdateProjectConfigConfig, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SuccessfulProjectConfigUpdate>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateProjectConfig(projectId, updateProjectConfigConfig, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const V0alpha0ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createProject(projectRevision?: ProjectRevision, options?: any): AxiosPromise<Project> {
            return localVarFp.createProject(projectRevision, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this API to get your active project in the Ory Cloud Console UI.
         * @summary Returns Your Active Ory Cloud Project
         ...
         * @throws {RequiredError}
         */
        getActiveProject(options?: any): AxiosPromise<ActiveProject> {
            return localVarFp.getActiveProject(options).then((request) => request(axios, basePath));
        },
        /**
         * Get a projects you have access to by its ID.
         * @summary Get a Project
         ...
         * @throws {RequiredError}
         */
        setActiveProject(inlineObject?: InlineObject, options?: any): AxiosPromise<void> {
            return localVarFp.setActiveProject(inlineObject, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates a new configuration revision for a project.
         * @summary Update a Project
         ...
         * @throws {RequiredError}
         */
        updateProject(projectId: string, projectRevision?: ProjectRevision, options?: any): AxiosPromise<Project> {
            return localVarFp.updateProject(projectId, projectRevision, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoints allows you to update the Ory Cloud Project configuration for individual services (identity, permission, ...). The configuration is fully compatible with the open source projects for the respective services (e.g. Ory Kratos for Identity, Ory Keto for Permissions).  This endpoint expects the `version` key to be set in the payload. If it is unset, it will try to import the config as if it is from the most recent version.  If you have an older version of a configuration, you should set the version key in the payload!  While this endpoint is able to process all configuration items related to features (e.g. password reset), it does not support operational configuration items (e.g. port, tracing, logging) otherwise available in the open source.  For configuration items that can not be translated to Ory Cloud, this endpoint will return a list of warnings to help you understand which parts of your config could not be processed.  Be aware that updating any service\'s configuration will completely override your current configuration for that service!
         * @summary Update an Ory Cloud Project Configuration
         ...
         * @throws {RequiredError}
         */
        updateProjectConfig(projectId: string, updateProjectConfigConfig?: UpdateProjectConfigConfig, options?: any): AxiosPromise<SuccessfulProjectConfigUpdate> {
            return localVarFp.updateProjectConfig(projectId, updateProjectConfigConfig, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface V0alpha0ApiInterface {
     ...
     */
    createProject(projectRevision?: ProjectRevision, options?: AxiosRequestConfig): AxiosPromise<Project>;
     ...
     * @memberof V0alpha0ApiInterface
     */
    getActiveProject(options?: AxiosRequestConfig): AxiosPromise<ActiveProject>;
     ...
     * @memberof V0alpha0ApiInterface
     */
    listProjects(options?: AxiosRequestConfig): AxiosPromise<Array<Project>>;
     ...
     * @memberof V0alpha0ApiInterface
     */
    setActiveProject(inlineObject?: InlineObject, options?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof V0alpha0ApiInterface
     */
    updateProject(projectId: string, projectRevision?: ProjectRevision, options?: AxiosRequestConfig): AxiosPromise<Project>;
     ...
     * @memberof V0alpha0ApiInterface
     */
    updateProjectConfig(projectId: string, updateProjectConfigConfig?: UpdateProjectConfigConfig, options?: AxiosRequestConfig): AxiosPromise<SuccessfulProjectConfigUpdate>;
...
export class V0alpha0Api extends BaseAPI implements V0alpha0ApiInterface {
     ...
     */
    public createProject(projectRevision?: ProjectRevision, options?: AxiosRequestConfig) {
        return V0alpha0ApiFp(this.configuration).createProject(projectRevision, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof V0alpha0Api
     */
    public getActiveProject(options?: AxiosRequestConfig) {
        return V0alpha0ApiFp(this.configuration).getActiveProject(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getProjectMembers(projectId: string, options?: AxiosRequestConfig) {
        return V0alpha0ApiFp(this.configuration).getProjectMembers(projectId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public purgeProject(projectId: string, options?: AxiosRequestConfig) {
        return V0alpha0ApiFp(this.configuration).purgeProject(projectId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public removeProjectMember(projectId: string, memberId: string, options?: AxiosRequestConfig) {
        return V0alpha0ApiFp(this.configuration).removeProjectMember(projectId, memberId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof V0alpha0Api
     */
    public setActiveProject(inlineObject?: InlineObject, options?: AxiosRequestConfig) {
        return V0alpha0ApiFp(this.configuration).setActiveProject(inlineObject, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof V0alpha0Api
     */
    public updateProject(projectId: string, projectRevision?: ProjectRevision, options?: AxiosRequestConfig) {
        return V0alpha0ApiFp(this.configuration).updateProject(projectId, projectRevision, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof V0alpha0Api
     */
    public updateProjectConfig(projectId: string, updateProjectConfigConfig?: UpdateProjectConfigConfig, options?: AxiosRequestConfig) {
        return V0alpha0ApiFp(this.configuration).updateProjectConfig(projectId, updateProjectConfigConfig, options).then((request) => request(this.axios, this.basePath));
    }
}
