...
export interface SubmitSelfServiceLoginFlowWithPasswordMethodBody {
     ...
     * @memberof SubmitSelfServiceLoginFlowWithPasswordMethodBody
     */
    method: SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum;
    /**
     * The user\'s password.
     * @type {string}
     * @memberof SubmitSelfServiceLoginFlowWithPasswordMethodBody
...
/**
    ...
    * @enum {string}
    */
export enum SubmitSelfServiceLoginFlowWithPasswordMethodBodyMethodEnum {
    Password = 'password',
    Oidc = 'oidc',
    Totp = 'totp'
}
...
export interface SubmitSelfServiceRecoveryFlowWithLinkMethodBody {
     ...
     * @memberof SubmitSelfServiceRecoveryFlowWithLinkMethodBody
     */
    method: SubmitSelfServiceRecoveryFlowWithLinkMethodBodyMethodEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum SubmitSelfServiceRecoveryFlowWithLinkMethodBodyMethodEnum {
    Link = 'link'
}
 ...
 * @export
 */
export type SubmitSelfServiceRegistrationFlowBody = SubmitSelfServiceRegistrationFlowWithPasswordMethodBody;
...
export interface SubmitSelfServiceRegistrationFlowWithPasswordMethodBody {
     ...
     * @memberof SubmitSelfServiceRegistrationFlowWithPasswordMethodBody
     */
    method: SubmitSelfServiceRegistrationFlowWithPasswordMethodBodyMethodEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum SubmitSelfServiceRegistrationFlowWithPasswordMethodBodyMethodEnum {
    Password = 'password',
    Oidc = 'oidc'
}
...
export interface SubmitSelfServiceSettingsFlowWithPasswordMethodBody {
     ...
     * @memberof SubmitSelfServiceSettingsFlowWithPasswordMethodBody
     */
    method: SubmitSelfServiceSettingsFlowWithPasswordMethodBodyMethodEnum;
    /**
...
/**
    ...
    * @enum {string}
    */
export enum SubmitSelfServiceSettingsFlowWithPasswordMethodBodyMethodEnum {
    Password = 'password',
    Profile = 'profile',
    Oidc = 'oidc',
    Totp = 'totp'
...
export interface SubmitSelfServiceVerificationFlowWithLinkMethodBody {
     ...
     * @memberof SubmitSelfServiceVerificationFlowWithLinkMethodBody
     */
    method: SubmitSelfServiceVerificationFlowWithLinkMethodBodyMethodEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum SubmitSelfServiceVerificationFlowWithLinkMethodBodyMethodEnum {
    Link = 'link'
}
...
export const V0alpha2ApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        initializeSelfServiceLoginFlowForBrowsers: async (refresh?: boolean, aal?: string, xSessionToken?: string, options: any = {}): Promise<RequestArgs> => {
...
export const V0alpha2ApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async initializeSelfServiceLoginFlowForBrowsers(refresh?: boolean, aal?: string, xSessionToken?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SelfServiceLoginFlow>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.initializeSelfServiceLoginFlowForBrowsers(refresh, aal, xSessionToken, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This endpoint initiates a login flow for API clients that do not use a browser, such as mobile devices, smart TVs, and so on.  If a valid provided session cookie or session token is provided, a 400 Bad Request error will be returned unless the URL query parameter `?refresh=true` is set.  To fetch an existing login flow call `/self-service/login/flows?flow=<flow_id>`.  You MUST NOT use this endpoint in client-side (Single Page Apps, ReactJS, AngularJS) nor server-side (Java Server Pages, NodeJS, PHP, Golang, ...) browser applications. Using this endpoint in these applications will make you vulnerable to a variety of CSRF attacks, including CSRF login attacks.  This endpoint MUST ONLY be used in scenarios such as native mobile apps (React Native, Objective C, Swift, Java, ...).  More information can be found at [Ory Kratos User Login and User Registration Documentation](https://www.ory.sh/docs/next/kratos/self-service/flows/user-login-user-registration).
...
export const V0alpha2ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        initializeSelfServiceLoginFlowForBrowsers(refresh?: boolean, aal?: string, xSessionToken?: string, options?: any): AxiosPromise<SelfServiceLoginFlow> {
            return localVarFp.initializeSelfServiceLoginFlowForBrowsers(refresh, aal, xSessionToken, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint initiates a login flow for API clients that do not use a browser, such as mobile devices, smart TVs, and so on.  If a valid provided session cookie or session token is provided, a 400 Bad Request error will be returned unless the URL query parameter `?refresh=true` is set.  To fetch an existing login flow call `/self-service/login/flows?flow=<flow_id>`.  You MUST NOT use this endpoint in client-side (Single Page Apps, ReactJS, AngularJS) nor server-side (Java Server Pages, NodeJS, PHP, Golang, ...) browser applications. Using this endpoint in these applications will make you vulnerable to a variety of CSRF attacks, including CSRF login attacks.  This endpoint MUST ONLY be used in scenarios such as native mobile apps (React Native, Objective C, Swift, Java, ...).  More information can be found at [Ory Kratos User Login and User Registration Documentation](https://www.ory.sh/docs/next/kratos/self-service/flows/user-login-user-registration).
         * @summary Initialize Login Flow for APIs, Services, Apps, ...
...
export class V0alpha2Api extends BaseAPI {
    ...
    public adminGetIdentity(id: string, options?: any) {
        return V0alpha2ApiFp(this.configuration).adminGetIdentity(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof V0alpha2Api
     */
    public initializeSelfServiceLoginFlowForBrowsers(refresh?: boolean, aal?: string, xSessionToken?: string, options?: any) {
        return V0alpha2ApiFp(this.configuration).initializeSelfServiceLoginFlowForBrowsers(refresh, aal, xSessionToken, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public initializeSelfServiceRecoveryFlowForBrowsers(options?: any) {
        return V0alpha2ApiFp(this.configuration).initializeSelfServiceRecoveryFlowForBrowsers(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public initializeSelfServiceRegistrationFlowForBrowsers(options?: any) {
        return V0alpha2ApiFp(this.configuration).initializeSelfServiceRegistrationFlowForBrowsers(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public initializeSelfServiceSettingsFlowForBrowsers(cookie?: string, options?: any) {
        return V0alpha2ApiFp(this.configuration).initializeSelfServiceSettingsFlowForBrowsers(cookie, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public initializeSelfServiceVerificationFlowForBrowsers(options?: any) {
        return V0alpha2ApiFp(this.configuration).initializeSelfServiceVerificationFlowForBrowsers(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public submitSelfServiceLogoutFlow(token?: string, options?: any) {
        return V0alpha2ApiFp(this.configuration).submitSelfServiceLogoutFlow(token, options).then((request) => request(this.axios, this.basePath));
    }
