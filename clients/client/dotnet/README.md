# Ory.Client.Client - the C# library for the Ory APIs
...
```
nuget pack -Build -OutputDirectory out Ory.Client.Client.csproj
```
...
## Documentation for Models
 ...
 - [Model.ClientErrorContainer](docs/ClientErrorContainer.md)
