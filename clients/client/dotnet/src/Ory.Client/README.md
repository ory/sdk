...
inputSpec: spec/client/v1.22.46.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{96E4084B-C62A-48C4-8B0F-8D6C466EA2AE}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IAdminBatchImportAPIKeysApiResponse apiResponse = await api.AdminBatchImportAPIKeysAsync("todo");
            ClientBatchImportAPIKeysResponse? model = apiResponse.Ok();
        }
