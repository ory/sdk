...
inputSpec: spec/client/v1.22.51.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{945414F4-57B4-4898-A4AD-56EE9DEEAA70}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IAdminBatchCreateImportedApiKeysApiResponse apiResponse = await api.AdminBatchCreateImportedApiKeysAsync("todo");
            ClientBatchCreateImportedApiKeysResponse? model = apiResponse.Ok();
        }
