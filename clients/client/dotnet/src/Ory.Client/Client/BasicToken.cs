...
namespace Ory.Client.Client
{
    ...
    public class BasicToken : TokenBase
    {
        ...
        {
            request.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Basic", Ory.Client.Client.ClientUtils.Base64Encode(_username + ":" + _password));
        }
    }
}
