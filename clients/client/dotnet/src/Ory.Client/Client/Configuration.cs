...
namespace Ory.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.0.0-alpha.0";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/1.0.0-alpha.0/csharp";
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v1.0.0-alpha.0\n";
            report += "    SDK Package Version: 1.0.0-alpha.0\n";
