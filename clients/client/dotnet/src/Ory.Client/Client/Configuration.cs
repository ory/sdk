...
namespace Ory.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.0.1-alpha.117";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.0.1-alpha.117/csharp";
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v0.0.1-alpha.117\n";
            report += "    SDK Package Version: 0.0.1-alpha.117\n";
