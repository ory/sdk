...
namespace Ory.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.20.6";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.20.6/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v1.20.6\n";
            report += "    SDK Package Version: 1.20.6\n";
