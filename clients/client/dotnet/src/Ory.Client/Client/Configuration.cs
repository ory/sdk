...
namespace Ory.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.2.0-alpha.60";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.2.0-alpha.60/csharp";
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v0.2.0-alpha.60\n";
            report += "    SDK Package Version: 0.2.0-alpha.60\n";
