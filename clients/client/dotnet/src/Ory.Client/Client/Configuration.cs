...
namespace Ory.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.1.0-alpha.6";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.1.0-alpha.6/csharp";
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v0.1.0-alpha.6\n";
            report += "    SDK Package Version: 0.1.0-alpha.6\n";
