...
namespace Ory.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.2.0-alpha.47";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.2.0-alpha.47/csharp";
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v0.2.0-alpha.47\n";
            report += "    SDK Package Version: 0.2.0-alpha.47\n";
