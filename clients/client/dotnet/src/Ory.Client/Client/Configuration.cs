...
namespace Ory.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.15.4/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://.projects.oryapis.com") : this()
        {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v1.15.4\n";
            report += "    SDK Package Version: 1.15.4\n";
