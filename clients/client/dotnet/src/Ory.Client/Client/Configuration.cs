...
namespace Ory.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.15.14";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.15.14/csharp");
                    ...
                    new Dictionary<string, object> {
                        ...
                        {"description", "No description provided"},
                        {
                            "variables", new Dictionary<string, object> {
                                {
                                    "project_slug", new Dictionary<string, object> {
            ...
            {
                {
                    "EventsApi.CreateEventStream", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "EventsApi.DeleteEventStream", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "EventsApi.ListEventStreams", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "EventsApi.SetEventStream", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.CreateOrganization", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.CreateProject", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.CreateProjectApiKey", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.DeleteOrganization", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.DeleteProjectApiKey", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.GetOrganization", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.GetProject", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.GetProjectMembers", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.ListOrganizations", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.ListProjectApiKeys", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.ListProjects", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.PatchProject", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.PatchProjectWithRevision", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.PurgeProject", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.RemoveProjectMember", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.SetProject", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProjectApi.UpdateOrganization", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "WorkspaceApi.CreateWorkspace", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "WorkspaceApi.CreateWorkspaceApiKey", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "WorkspaceApi.DeleteWorkspaceApiKey", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "WorkspaceApi.GetWorkspace", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "WorkspaceApi.ListWorkspaceApiKeys", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "WorkspaceApi.ListWorkspaceProjects", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "WorkspaceApi.ListWorkspaces", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "WorkspaceApi.UpdateWorkspace", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v1.15.14\n";
            report += "    SDK Package Version: 1.15.14\n";
