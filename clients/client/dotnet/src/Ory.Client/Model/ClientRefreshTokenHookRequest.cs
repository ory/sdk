...
namespace Ory.Client.Model
{
    ...
    public partial class ClientRefreshTokenHookRequest : IEquatable<ClientRefreshTokenHookRequest>, IValidatableObject
    {
        ...
        public ClientRefreshTokenHookRequest(string clientId = default(string), List<string> grantedAudience = default(List<string>), List<string> grantedScopes = default(List<string>), ClientOAuth2AccessRequest requester = default(ClientOAuth2AccessRequest), ClientOAuth2ConsentSession session = default(ClientOAuth2ConsentSession), string subject = default(string))
        {
        ...
        public ClientOAuth2AccessRequest Requester { get; set; }

        /// <summary>
        /// Gets or Sets Session
        /// </summary>
        [DataMember(Name = "session", EmitDefaultValue = false)]
        public ClientOAuth2ConsentSession Session { get; set; }
