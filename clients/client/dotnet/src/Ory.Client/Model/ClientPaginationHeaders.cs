...
namespace Ory.Client.Model
{
    ...
    public partial class ClientPaginationHeaders : IEquatable<ClientPaginationHeaders>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientPaginationHeaders);
        }

        /// <summary>
        /// Returns true if ClientPaginationHeaders instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientPaginationHeaders to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientPaginationHeaders input)
        {
            if (input == null)
            {
                return false;
