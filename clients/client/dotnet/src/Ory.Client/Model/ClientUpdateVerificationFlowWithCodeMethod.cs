...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateVerificationFlowWithCodeMethod : IEquatable<ClientUpdateVerificationFlowWithCodeMethod>, IValidatableObject
    {
        ...
        public ClientUpdateVerificationFlowWithCodeMethod(string code = default(string), string csrfToken = default(string), string email = default(string), string flow = default(string), string method = default(string))
        {
            this.Code = code;
