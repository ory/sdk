...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateEventStreamBody : IEquatable<ClientCreateEventStreamBody>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientCreateEventStreamBody);
        }

        /// <summary>
        /// Returns true if ClientCreateEventStreamBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCreateEventStreamBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCreateEventStreamBody input)
        {
            if (input == null)
            {
                return false;
