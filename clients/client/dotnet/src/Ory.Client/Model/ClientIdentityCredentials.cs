...
namespace Ory.Client.Model
{
    ...
    public partial class ClientIdentityCredentials : IEquatable<ClientIdentityCredentials>, IValidatableObject
    {
        ...
        public ClientIdentityCredentials(Object config = default(Object), DateTime createdAt = default(DateTime), List<string> identifiers = default(List<string>), TypeEnum? type = default(TypeEnum?), DateTime updatedAt = default(DateTime), long version = default(long))
        {
            this.Config = config;
