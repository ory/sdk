...
namespace Ory.Client.Model
{
    ...
    public partial class ClientIdentityCredentials : IEquatable<ClientIdentityCredentials>, IValidatableObject
    {
        ...
        public ClientIdentityCredentials(Object config = default(Object), DateTime createdAt = default(DateTime), List<string> identifiers = default(List<string>), string type = default(string), DateTime updatedAt = default(DateTime))
        {
            this.Config = config;
