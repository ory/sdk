...
namespace Ory.Client.Model
{
    ...
    public partial class ClientRecoveryLink : IEquatable<ClientRecoveryLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientRecoveryLink" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientRecoveryLink()
        {
        ...
        public ClientRecoveryLink(DateTime expiresAt = default(DateTime), string recoveryLink = default(string))
        {
            // to ensure "recoveryLink" is required (not null)
            this.RecoveryLink = recoveryLink ?? throw new ArgumentNullException("recoveryLink is a required property for ClientRecoveryLink and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientRecoveryLink {\n");
        ...
        {
            return this.Equals(input as ClientRecoveryLink);
        }

        /// <summary>
        /// Returns true if ClientRecoveryLink instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientRecoveryLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientRecoveryLink input)
        {
            if (input == null)
                return false;
