...
namespace Ory.Client.Model
{
    ...
    public partial class ClientAccountExperienceConfiguration : IValidatableObject
    {
        ...
        public enum LocaleBehaviorEnum
        {
            ...
            /// </summary>
            [EnumMember(Value = "force_default")]
            ForceDefault = 1,

            /// <summary>
            /// Enum RespectAcceptLanguage for value: respect_accept_language
            /// </summary>
            [EnumMember(Value = "respect_accept_language")]
        ...
        /// </summary>
        /// <value> force_default AccountExperienceLocaleBehaviorForceDefault respect_accept_language AccountExperienceLocaleBehaviorRespectAcceptLanguage</value>
        [DataMember(Name = "locale_behavior", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <param name="localeBehavior"> force_default AccountExperienceLocaleBehaviorForceDefault respect_accept_language AccountExperienceLocaleBehaviorRespectAcceptLanguage (required).</param>
        ...
        public ClientAccountExperienceConfiguration(string defaultLocale = default(string), string defaultRedirectUrl = default(string), string errorUiUrl = default(string), string faviconDarkUrl = default(string), string faviconLightUrl = default(string), LocaleBehaviorEnum localeBehavior = default(LocaleBehaviorEnum), string loginUiUrl = default(string), string logoDarkUrl = default(string), string logoLightUrl = default(string), string name = default(string), bool recoveryEnabled = default(bool), string recoveryUiUrl = default(string), bool registrationEnabled = default(bool), string registrationUiUrl = default(string), string settingsUiUrl = default(string), string stylesheet = default(string), bool verificationEnabled = default(bool), string verificationUiUrl = default(string))
        {
            // to ensure "defaultLocale" is required (not null)
            if (defaultLocale == null)
            {
                throw new ArgumentNullException("defaultLocale is a required property for ClientAccountExperienceConfiguration and cannot be null");
            }
