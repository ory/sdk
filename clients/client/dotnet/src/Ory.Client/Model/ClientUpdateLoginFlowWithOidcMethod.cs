...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateLoginFlowWithOidcMethod : IEquatable<ClientUpdateLoginFlowWithOidcMethod>, IValidatableObject
    {
        ...
        public ClientUpdateLoginFlowWithOidcMethod(string csrfToken = default(string), string method = default(string), string provider = default(string), Object traits = default(Object))
        {
