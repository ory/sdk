...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceRegistrationFlowBody : AbstractOpenAPISchema, IEquatable<ClientSubmitSelfServiceRegistrationFlowBody>, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ClientSubmitSelfServiceRegistrationFlowWithPasswordMethodBody))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ClientSubmitSelfServiceRegistrationFlowWithPasswordMethodBody");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `ClientSubmitSelfServiceRegistrationFlowWithPasswordMethodBody`. If the actual instanct is not `ClientSubmitSelfServiceRegistrationFlowWithPasswordMethodBody`,
