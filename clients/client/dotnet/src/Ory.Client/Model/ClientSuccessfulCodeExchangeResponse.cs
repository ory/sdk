...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSuccessfulCodeExchangeResponse : IEquatable<ClientSuccessfulCodeExchangeResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientSuccessfulCodeExchangeResponse);
        }

        /// <summary>
        /// Returns true if ClientSuccessfulCodeExchangeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSuccessfulCodeExchangeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSuccessfulCodeExchangeResponse input)
        {
            if (input == null)
            {
                return false;
