...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateRegistrationFlowWithWebAuthnMethod : IEquatable<ClientUpdateRegistrationFlowWithWebAuthnMethod>, IValidatableObject
    {
        ...
        public ClientUpdateRegistrationFlowWithWebAuthnMethod(string csrfToken = default(string), string method = default(string), Object traits = default(Object), string webauthnRegister = default(string), string webauthnRegisterDisplayname = default(string))
        {
