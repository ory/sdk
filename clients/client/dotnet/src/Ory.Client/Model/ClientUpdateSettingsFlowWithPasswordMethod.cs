...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowWithPasswordMethod : IEquatable<ClientUpdateSettingsFlowWithPasswordMethod>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientUpdateSettingsFlowWithPasswordMethod);
        }

        /// <summary>
        /// Returns true if ClientUpdateSettingsFlowWithPasswordMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateSettingsFlowWithPasswordMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateSettingsFlowWithPasswordMethod input)
        {
            if (input == null)
            {
                return false;
