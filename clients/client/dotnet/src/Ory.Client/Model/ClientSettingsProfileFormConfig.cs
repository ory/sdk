...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSettingsProfileFormConfig : IEquatable<ClientSettingsProfileFormConfig>, IValidatableObject
    {
        ...
        public ClientSettingsProfileFormConfig(string action = default(string), List<ClientUiText> messages = default(List<ClientUiText>), string method = default(string), List<ClientUiNode> nodes = default(List<ClientUiNode>))
        {
            ...
            this.Action = action ?? throw new ArgumentNullException("action is a required property for ClientSettingsProfileFormConfig and cannot be null");
            // to ensure "method" is required (not null)
            this.Method = method ?? throw new ArgumentNullException("method is a required property for ClientSettingsProfileFormConfig and cannot be null");
            // to ensure "nodes" is required (not null)
            this.Nodes = nodes ?? throw new ArgumentNullException("nodes is a required property for ClientSettingsProfileFormConfig and cannot be null");
