    ...
    public partial class ClientOidcConfiguration : IEquatable<ClientOidcConfiguration>, IValidatableObject
    {
        ...
        public bool Equals(ClientOidcConfiguration input)
        {
            ...
            return 
                ...
                (
                    this.CredentialsEndpointDraft00 == input.CredentialsEndpointDraft00 ||
                    (this.CredentialsEndpointDraft00 != null &&
                    this.CredentialsEndpointDraft00.Equals(input.CredentialsEndpointDraft00))
                ) && 
                (
                    this.CredentialsSupportedDraft00 == input.CredentialsSupportedDraft00 ||
                    this.CredentialsSupportedDraft00 != null &&
                    input.CredentialsSupportedDraft00 != null &&
                    this.CredentialsSupportedDraft00.SequenceEqual(input.CredentialsSupportedDraft00)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.CredentialsEndpointDraft00.GetHashCode();
                }
                if (this.CredentialsSupportedDraft00 != null)
                {
                    hashCode = (hashCode * 59) + this.CredentialsSupportedDraft00.GetHashCode();
                }
