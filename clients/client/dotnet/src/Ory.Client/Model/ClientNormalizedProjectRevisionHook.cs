    ...
    public partial class ClientNormalizedProjectRevisionHook : IEquatable<ClientNormalizedProjectRevisionHook>, IValidatableObject
    {
        ...
        public bool Equals(ClientNormalizedProjectRevisionHook input)
        {
            ...
            return 
                ...
                (
                    this.WebHookConfigResponseParse == input.WebHookConfigResponseParse ||
                    this.WebHookConfigResponseParse.Equals(input.WebHookConfigResponseParse)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.WebHookConfigResponseParse.GetHashCode();
