...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateInviteResponse : IEquatable<ClientCreateInviteResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name = "created_invite", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as ClientCreateInviteResponse);
        }

        /// <summary>
        /// Returns true if ClientCreateInviteResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCreateInviteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCreateInviteResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CreatedInvite == input.CreatedInvite ||
                    (this.CreatedInvite != null &&
                    this.CreatedInvite.Equals(input.CreatedInvite))
                )
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CreatedInvite != null)
                {
                    hashCode = (hashCode * 59) + this.CreatedInvite.GetHashCode();
                }
