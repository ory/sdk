...
namespace Ory.Client.Model
{
    ...
    public partial class ClientGenericUsage : IEquatable<ClientGenericUsage>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ClientGenericUsage" /> class.
        /// </summary>
        /// <param name="additionalPrice">AdditionalPrice is the price per-unit in cent exceeding IncludedUsage. A price of 0 means that no other items can be consumed. (required).</param>
        ...
        /// </summary>
        /// <value>AdditionalPrice is the price per-unit in cent exceeding IncludedUsage. A price of 0 means that no other items can be consumed.</value>
