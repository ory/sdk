...
namespace Ory.Client.Model
{
    ...
    public partial class ClientOAuth2ConsentRequestOpenIDConnectContext : IEquatable<ClientOAuth2ConsentRequestOpenIDConnectContext>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientOAuth2ConsentRequestOpenIDConnectContext);
        }

        /// <summary>
        /// Returns true if ClientOAuth2ConsentRequestOpenIDConnectContext instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientOAuth2ConsentRequestOpenIDConnectContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientOAuth2ConsentRequestOpenIDConnectContext input)
        {
            if (input == null)
            {
                return false;
