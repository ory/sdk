...
namespace Ory.Client.Model
{
    ...
    public partial class ClientOAuth2TokenIntrospection : IEquatable<ClientOAuth2TokenIntrospection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientOAuth2TokenIntrospection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientOAuth2TokenIntrospection()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientOAuth2TokenIntrospection {\n");
        ...
        {
            return this.Equals(input as ClientOAuth2TokenIntrospection);
        }

        /// <summary>
        /// Returns true if ClientOAuth2TokenIntrospection instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientOAuth2TokenIntrospection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientOAuth2TokenIntrospection input)
        {
            if (input == null)
            {
                return false;
