...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProjectInvite : IEquatable<ClientProjectInvite>, IValidatableObject
    {
        ...
        public ClientProjectInvite(string id = default(string), string inviteeEmail = default(string), string inviteeId = default(string), string ownerEmail = default(string), string ownerId = default(string), string projectId = default(string), StatusEnum status = default(StatusEnum))
        {
