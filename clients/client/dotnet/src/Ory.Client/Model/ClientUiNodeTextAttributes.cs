...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUiNodeTextAttributes : IEquatable<ClientUiNodeTextAttributes>, IValidatableObject
    {
        ...
        public ClientUiNodeTextAttributes(string id = default(string), ClientUiText text = default(ClientUiText))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ClientUiNodeTextAttributes and cannot be null");
            // to ensure "text" is required (not null)
            this.Text = text ?? throw new ArgumentNullException("text is a required property for ClientUiNodeTextAttributes and cannot be null");
            this.AdditionalProperties = new Dictionary<string, object>();
        }
