...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowWithWebAuthnMethod : IEquatable<ClientUpdateSettingsFlowWithWebAuthnMethod>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientUpdateSettingsFlowWithWebAuthnMethod);
        }

        /// <summary>
        /// Returns true if ClientUpdateSettingsFlowWithWebAuthnMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateSettingsFlowWithWebAuthnMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateSettingsFlowWithWebAuthnMethod input)
        {
            if (input == null)
            {
                return false;
