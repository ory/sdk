...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowWithWebAuthnMethod : IEquatable<ClientUpdateSettingsFlowWithWebAuthnMethod>, IValidatableObject
    {
        ...
        public ClientUpdateSettingsFlowWithWebAuthnMethod(string csrfToken = default(string), string method = default(string), string webauthnRegister = default(string), string webauthnRegisterDisplayname = default(string), string webauthnRemove = default(string))
        {
