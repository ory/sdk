...
namespace Ory.Client.Model
{
    ...
    public partial class ClientManagedIdentitySchema : IEquatable<ClientManagedIdentitySchema>, IValidatableObject
    {
        ...
        public ClientManagedIdentitySchema(string blobName = default(string), string blobUrl = default(string), string contentHash = default(string), string id = default(string), string name = default(string))
        {
            ...
            if (id == null) {
                throw new ArgumentNullException("id is a required property for ClientManagedIdentitySchema and cannot be null");
            }
            this.Id = id;
