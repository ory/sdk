...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateCustomDomainBody : IEquatable<ClientCreateCustomDomainBody>, IValidatableObject
    {
        ...
        public ClientCreateCustomDomainBody(string cookieDomain = default(string), List<string> corsAllowedOrigins = default(List<string>), bool corsEnabled = default(bool), string hostname = default(string))
        {
