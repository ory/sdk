...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateRegistrationFlowWithPasswordMethod : IEquatable<ClientUpdateRegistrationFlowWithPasswordMethod>, IValidatableObject
    {
        ...
        public ClientUpdateRegistrationFlowWithPasswordMethod(string csrfToken = default(string), string method = default(string), string password = default(string), Object traits = default(Object))
        {
