...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProjectRevisionThirdPartyLoginProvider : IEquatable<ClientProjectRevisionThirdPartyLoginProvider>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="applePrivateKey">Apple Private Key  Sign In with Apple Private Key needed for generating a JWT token for client secret.</param>
        ...
        /// </summary>
        /// <value>Apple Private Key  Sign In with Apple Private Key needed for generating a JWT token for client secret</value>
