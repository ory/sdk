...
{
    /// <summary>
    /// ClientProjectRevisionThirdPartyLoginProvider
    /// </summary>
    [DataContract(Name = "projectRevisionThirdPartyLoginProvider")]
    public partial class ClientProjectRevisionThirdPartyLoginProvider : IEquatable<ClientProjectRevisionThirdPartyLoginProvider>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientProjectRevisionThirdPartyLoginProvider" /> class.
        /// </summary>
        ...
        public ClientProjectRevisionThirdPartyLoginProvider(ClientSQLNullString applePrivateKey = default(ClientSQLNullString), string applePrivateKeyId = default(string), string appleTeamId = default(string), string authUrl = default(string), string azureTenant = default(string), string clientId = default(string), ClientSQLNullString clientSecret = default(ClientSQLNullString), string id = default(string), string issuerUrl = default(string), string label = default(string), string mapperUrl = default(string), string projectRevisionId = default(string), string provider = default(string), string providerId = default(string), Object requestedClaims = default(Object), List<string> scope = default(List<string>), string tokenUrl = default(string))
        {
        ...
        public ClientSQLNullString ApplePrivateKey { get; set; }
        ...
        public ClientSQLNullString ClientSecret { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientProjectRevisionThirdPartyLoginProvider {\n");
        ...
        {
            return this.Equals(input as ClientProjectRevisionThirdPartyLoginProvider);
        }

        /// <summary>
        /// Returns true if ClientProjectRevisionThirdPartyLoginProvider instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientProjectRevisionThirdPartyLoginProvider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientProjectRevisionThirdPartyLoginProvider input)
        {
            if (input == null)
            {
                return false;
