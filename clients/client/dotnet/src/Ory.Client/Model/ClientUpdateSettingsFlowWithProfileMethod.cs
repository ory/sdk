...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowWithProfileMethod : IEquatable<ClientUpdateSettingsFlowWithProfileMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientUpdateSettingsFlowWithProfileMethod(string csrfToken = default(string), string method = default(string), Object traits = default(Object))
        {
        ...
        {
            return this.Equals(input as ClientUpdateSettingsFlowWithProfileMethod);
        }

        /// <summary>
        /// Returns true if ClientUpdateSettingsFlowWithProfileMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateSettingsFlowWithProfileMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateSettingsFlowWithProfileMethod input)
        {
            if (input == null)
            {
                return false;
