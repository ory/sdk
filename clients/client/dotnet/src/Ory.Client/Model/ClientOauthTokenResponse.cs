...
namespace Ory.Client.Model
{
    ...
    public partial class ClientOauthTokenResponse : IEquatable<ClientOauthTokenResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientOauthTokenResponse" /> class.
        /// </summary>
        ...
        public ClientOauthTokenResponse(string accessToken = default(string), long expiresIn = default(long), long idToken = default(long), string refreshToken = default(string), long scope = default(long), string tokenType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientOauthTokenResponse {\n");
        ...
        {
            return this.Equals(input as ClientOauthTokenResponse);
        }

        /// <summary>
        /// Returns true if ClientOauthTokenResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientOauthTokenResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientOauthTokenResponse input)
        {
            if (input == null)
            {
                return false;
