...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProject : IEquatable<ClientProject>, IValidatableObject
    {
        ...
        public ClientProject(ClientProjectRevision currentRevision = default(ClientProjectRevision), string id = default(string), List<ClientProjectRevision> revisions = default(List<ClientProjectRevision>), string subscriptionId = default(string))
        {
