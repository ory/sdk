...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProject : IEquatable<ClientProject>, IValidatableObject
    {
        ...
        public ClientProject(ClientCORS corsAdmin = default(ClientCORS), ClientCORS corsPublic = default(ClientCORS), string name = default(string), ClientProjectServices services = default(ClientProjectServices))
        {
