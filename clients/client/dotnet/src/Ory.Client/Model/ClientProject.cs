...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProject : IEquatable<ClientProject>, IValidatableObject
    {
        ...
        public ClientProject(ClientProjectCors corsAdmin = default(ClientProjectCors), ClientProjectCors corsPublic = default(ClientProjectCors), string name = default(string), ClientProjectServices services = default(ClientProjectServices), string workspaceId = default(string))
        {
