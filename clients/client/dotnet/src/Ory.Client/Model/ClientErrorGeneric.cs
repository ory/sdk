...
namespace Ory.Client.Model
{
    ...
    public partial class ClientErrorGeneric : IEquatable<ClientErrorGeneric>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientErrorGeneric);
        }

        /// <summary>
        /// Returns true if ClientErrorGeneric instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientErrorGeneric to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientErrorGeneric input)
        {
            if (input == null)
            {
                return false;
