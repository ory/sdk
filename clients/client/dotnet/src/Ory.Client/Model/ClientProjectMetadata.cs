...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProjectMetadata : IEquatable<ClientProjectMetadata>, IValidatableObject
    {
        ...
        public ClientProjectMetadata(DateTime createdAt = default(DateTime), EnvironmentEnum environment = default(EnvironmentEnum), List<string> hosts = default(List<string>), string name = default(string), StateEnum state = default(StateEnum), string subscriptionId = default(string), string subscriptionPlan = default(string), DateTime updatedAt = default(DateTime), string workspaceId = default(string))
        {
