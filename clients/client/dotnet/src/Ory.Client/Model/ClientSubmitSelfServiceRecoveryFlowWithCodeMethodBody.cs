...
{
    /// <summary>
    /// ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody
    /// </summary>
    [DataContract(Name = "submitSelfServiceRecoveryFlowWithCodeMethodBody")]
    public partial class ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody : IEquatable<ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody()
        {
        ...
        public ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody(string code = default(string), string csrfToken = default(string), string email = default(string), string method = default(string))
        {
            // to ensure "method" is required (not null)
            if (method == null) {
                throw new ArgumentNullException("method is a required property for ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody and cannot be null");
            }
            this.Method = method;
            this.Code = code;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody {\n");
        ...
        {
            return this.Equals(input as ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody);
        }

        /// <summary>
        /// Returns true if ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSubmitSelfServiceRecoveryFlowWithCodeMethodBody input)
        {
            if (input == null)
            {
                return false;
