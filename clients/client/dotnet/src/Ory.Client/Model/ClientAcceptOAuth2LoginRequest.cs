...
namespace Ory.Client.Model
{
    ...
    public partial class ClientAcceptOAuth2LoginRequest : IEquatable<ClientAcceptOAuth2LoginRequest>, IValidatableObject
    {
        ...
        public ClientAcceptOAuth2LoginRequest(string acr = default(string), List<string> amr = default(List<string>), Object context = default(Object), string forceSubjectIdentifier = default(string), bool remember = default(bool), long rememberFor = default(long), string subject = default(string))
        {
