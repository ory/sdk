...
namespace Ory.Client.Model
{
    ...
    public partial class ClientErrorBrowserLocationChangeRequired : IEquatable<ClientErrorBrowserLocationChangeRequired>, IValidatableObject
    {
        ...
        protected ClientErrorBrowserLocationChangeRequired()
        {
        ...
        public ClientErrorBrowserLocationChangeRequired(long code = default(long), string debug = default(string), Dictionary<string, Object> details = default(Dictionary<string, Object>), string id = default(string), string message = default(string), string reason = default(string), string redirectBrowserTo = default(string), string request = default(string), string status = default(string))
        {
            // to ensure "message" is required (not null)
            if (message == null) {
                throw new ArgumentNullException("message is a required property for ClientErrorBrowserLocationChangeRequired and cannot be null");
            }
