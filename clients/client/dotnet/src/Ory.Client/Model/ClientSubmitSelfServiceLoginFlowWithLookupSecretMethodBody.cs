...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceLoginFlowWithLookupSecretMethodBody : IEquatable<ClientSubmitSelfServiceLoginFlowWithLookupSecretMethodBody>, IValidatableObject
    {
        ...
        public ClientSubmitSelfServiceLoginFlowWithLookupSecretMethodBody(string csrfToken = default(string), string lookupSecret = default(string), string method = default(string))
        {
            ...
            this.LookupSecret = lookupSecret ?? throw new ArgumentNullException("lookupSecret is a required property for ClientSubmitSelfServiceLoginFlowWithLookupSecretMethodBody and cannot be null");
            // to ensure "method" is required (not null)
            this.Method = method ?? throw new ArgumentNullException("method is a required property for ClientSubmitSelfServiceLoginFlowWithLookupSecretMethodBody and cannot be null");
