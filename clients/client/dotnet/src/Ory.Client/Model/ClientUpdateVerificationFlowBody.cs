...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateVerificationFlowBody : AbstractOpenAPISchema, IEquatable<ClientUpdateVerificationFlowBody>, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ClientUpdateVerificationFlowWithLinkMethod))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ClientUpdateVerificationFlowWithLinkMethod");
                }
            }
        }
