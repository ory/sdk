...
namespace Ory.Client.Model
{
    ...
    public partial class ClientAcceptOAuth2ConsentRequest : IEquatable<ClientAcceptOAuth2ConsentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientAcceptOAuth2ConsentRequest);
        }

        /// <summary>
        /// Returns true if ClientAcceptOAuth2ConsentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientAcceptOAuth2ConsentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientAcceptOAuth2ConsentRequest input)
        {
            if (input == null)
            {
                return false;
