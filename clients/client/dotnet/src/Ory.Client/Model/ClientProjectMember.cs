...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProjectMember : IEquatable<ClientProjectMember>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientProjectMember(string email = default(string), string id = default(string), string name = default(string), string role = default(string))
        {
        ...
        {
            return this.Equals(input as ClientProjectMember);
        }

        /// <summary>
        /// Returns true if ClientProjectMember instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientProjectMember to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientProjectMember input)
        {
            if (input == null)
            {
                return false;
