...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateProjectMemberInviteBody : IEquatable<ClientCreateProjectMemberInviteBody>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientCreateProjectMemberInviteBody);
        }

        /// <summary>
        /// Returns true if ClientCreateProjectMemberInviteBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCreateProjectMemberInviteBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCreateProjectMemberInviteBody input)
        {
            if (input == null)
            {
                return false;
