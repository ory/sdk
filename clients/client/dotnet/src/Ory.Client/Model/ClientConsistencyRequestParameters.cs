...
namespace Ory.Client.Model
{
    ...
    public partial class ClientConsistencyRequestParameters : IEquatable<ClientConsistencyRequestParameters>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientConsistencyRequestParameters);
        }

        /// <summary>
        /// Returns true if ClientConsistencyRequestParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientConsistencyRequestParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientConsistencyRequestParameters input)
        {
            if (input == null)
            {
                return false;
