...
namespace Ory.Client.Model
{
    ...
    public partial class ClientMemberInvite : IEquatable<ClientMemberInvite>, IValidatableObject
    {
        ...
        public ClientMemberInvite(string inviteeEmail = default(string), string inviteeId = default(string), string ownerEmail = default(string), string ownerId = default(string), string projectId = default(string), StatusEnum status = default(StatusEnum), string workspaceId = default(string))
        {
