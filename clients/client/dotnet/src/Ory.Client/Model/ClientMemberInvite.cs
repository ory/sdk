...
namespace Ory.Client.Model
{
    ...
    public partial class ClientMemberInvite : IEquatable<ClientMemberInvite>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientMemberInvite(string inviteeEmail = default(string), string inviteeId = default(string), string ownerEmail = default(string), string ownerId = default(string), string projectId = default(string), StatusEnum status = default(StatusEnum))
        {
            ...
            if (projectId == null) {
                throw new ArgumentNullException("projectId is a required property for ClientMemberInvite and cannot be null");
            }
        ...
        {
            return this.Equals(input as ClientMemberInvite);
        }

        /// <summary>
        /// Returns true if ClientMemberInvite instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientMemberInvite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientMemberInvite input)
        {
            if (input == null)
            {
                return false;
