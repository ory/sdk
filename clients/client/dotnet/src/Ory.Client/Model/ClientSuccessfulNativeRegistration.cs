...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSuccessfulNativeRegistration : IEquatable<ClientSuccessfulNativeRegistration>, IValidatableObject
    {
        ...
        public ClientSuccessfulNativeRegistration(ClientIdentity identity = default(ClientIdentity), ClientSession session = default(ClientSession), string sessionToken = default(string))
        {
