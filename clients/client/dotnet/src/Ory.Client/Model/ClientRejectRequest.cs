...
namespace Ory.Client.Model
{
    ...
    public partial class ClientRejectRequest : IEquatable<ClientRejectRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientRejectRequest" /> class.
        /// </summary>
        ...
        public ClientRejectRequest(string error = default(string), string errorDebug = default(string), string errorDescription = default(string), string errorHint = default(string), long statusCode = default(long))
        {
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientRejectRequest {\n");
        ...
        {
            return this.Equals(input as ClientRejectRequest);
        }

        /// <summary>
        /// Returns true if ClientRejectRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientRejectRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientRejectRequest input)
        {
            if (input == null)
            {
                return false;
