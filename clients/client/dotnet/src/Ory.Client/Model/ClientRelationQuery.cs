...
namespace Ory.Client.Model
{
    ...
    public partial class ClientRelationQuery : IValidatableObject
    {
        ...
        public ClientRelationQuery(string varNamespace = default(string), string varObject = default(string), string relation = default(string), string subjectId = default(string), ClientSubjectSet subjectSet = default(ClientSubjectSet))
        {
