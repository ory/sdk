...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateRegistrationFlowWithOidcMethod : IEquatable<ClientUpdateRegistrationFlowWithOidcMethod>, IValidatableObject
    {
        ...
        public ClientUpdateRegistrationFlowWithOidcMethod(string csrfToken = default(string), string method = default(string), string provider = default(string), Object traits = default(Object))
        {
