...
namespace Ory.Client.Model
{
    ...
    public partial class ClientIdentitySchema : IEquatable<ClientIdentitySchema>, IValidatableObject
    {
        ...
        public ClientIdentitySchema(string blobName = default(string), string blobUrl = default(string), string contentHash = default(string), string id = default(string), string name = default(string))
        {
