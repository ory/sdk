...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowBody : AbstractOpenAPISchema, IEquatable<ClientUpdateSettingsFlowBody>, IValidatableObject
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ClientUpdateSettingsFlowWithLookupMethod))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateSettingsFlowWithOidcMethod))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateSettingsFlowWithPasswordMethod))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateSettingsFlowWithProfileMethod))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateSettingsFlowWithTotpMethod))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ClientUpdateSettingsFlowWithWebAuthnMethod))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ClientUpdateSettingsFlowWithLookupMethod, ClientUpdateSettingsFlowWithOidcMethod, ClientUpdateSettingsFlowWithPasswordMethod, ClientUpdateSettingsFlowWithProfileMethod, ClientUpdateSettingsFlowWithTotpMethod, ClientUpdateSettingsFlowWithWebAuthnMethod");
                }
            }
        }
        ...
        {
            return this.Equals(input as ClientUpdateSettingsFlowBody);
        }

        /// <summary>
        /// Returns true if ClientUpdateSettingsFlowBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateSettingsFlowBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateSettingsFlowBody input)
        {
            if (input == null)
                return false;
