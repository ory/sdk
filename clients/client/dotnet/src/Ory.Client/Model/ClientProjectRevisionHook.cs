...
{
    /// <summary>
    /// ClientProjectRevisionHook
    /// </summary>
    [DataContract(Name = "projectRevisionHook")]
    public partial class ClientProjectRevisionHook : IEquatable<ClientProjectRevisionHook>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientProjectRevisionHook" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientProjectRevisionHook()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientProjectRevisionHook {\n");
        ...
        {
            return this.Equals(input as ClientProjectRevisionHook);
        }

        /// <summary>
        /// Returns true if ClientProjectRevisionHook instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientProjectRevisionHook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientProjectRevisionHook input)
        {
            if (input == null)
            {
                return false;
