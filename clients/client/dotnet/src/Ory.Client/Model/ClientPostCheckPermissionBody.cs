...
namespace Ory.Client.Model
{
    ...
    public partial class ClientPostCheckPermissionBody : IEquatable<ClientPostCheckPermissionBody>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientPostCheckPermissionBody(string _namespace = default(string), string _object = default(string), string relation = default(string), string subjectId = default(string), ClientSubjectSet subjectSet = default(ClientSubjectSet))
        {
        ...
        {
            return this.Equals(input as ClientPostCheckPermissionBody);
        }

        /// <summary>
        /// Returns true if ClientPostCheckPermissionBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientPostCheckPermissionBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientPostCheckPermissionBody input)
        {
            if (input == null)
            {
                return false;
