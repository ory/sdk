...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSelfServiceVerificationFlow : IEquatable<ClientSelfServiceVerificationFlow>, IValidatableObject
    {
        ...
        public ClientSelfServiceVerificationFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), ClientSelfServiceVerificationFlowState state = default(ClientSelfServiceVerificationFlowState), string type = default(string), ClientUiContainer ui = default(ClientUiContainer))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ClientSelfServiceVerificationFlow and cannot be null");
            // to ensure "state" is required (not null)
            this.State = state ?? throw new ArgumentNullException("state is a required property for ClientSelfServiceVerificationFlow and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ClientSelfServiceVerificationFlow and cannot be null");
            // to ensure "ui" is required (not null)
            this.Ui = ui ?? throw new ArgumentNullException("ui is a required property for ClientSelfServiceVerificationFlow and cannot be null");
            this.Active = active;
