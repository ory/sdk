...
namespace Ory.Client.Model
{
    ...
    public partial class ClientErrorFlowReplaced : IEquatable<ClientErrorFlowReplaced>, IValidatableObject
    {
        ...
        protected ClientErrorFlowReplaced()
        {
        ...
        public ClientErrorFlowReplaced(long code = default(long), string debug = default(string), Dictionary<string, Object> details = default(Dictionary<string, Object>), string id = default(string), string message = default(string), string reason = default(string), string request = default(string), string status = default(string), string useFlowId = default(string))
        {
            // to ensure "message" is required (not null)
            if (message == null) {
                throw new ArgumentNullException("message is a required property for ClientErrorFlowReplaced and cannot be null");
            }
