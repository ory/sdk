...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUiNodeImageAttributes : IEquatable<ClientUiNodeImageAttributes>, IValidatableObject
    {
        ...
        public ClientUiNodeImageAttributes(long height = default(long), string id = default(string), string src = default(string), long width = default(long))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ClientUiNodeImageAttributes and cannot be null");
