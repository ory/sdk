...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSetProject : IEquatable<ClientSetProject>, IValidatableObject
    {
        ...
        public ClientSetProject(ClientCORS corsAdmin = default(ClientCORS), ClientCORS corsPublic = default(ClientCORS), string name = default(string), ClientProjectServices services = default(ClientProjectServices))
        {
