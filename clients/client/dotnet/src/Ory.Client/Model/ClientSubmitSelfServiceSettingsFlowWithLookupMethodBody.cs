...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceSettingsFlowWithLookupMethodBody : IEquatable<ClientSubmitSelfServiceSettingsFlowWithLookupMethodBody>, IValidatableObject
    {
        ...
        public ClientSubmitSelfServiceSettingsFlowWithLookupMethodBody(string csrfToken = default(string), bool lookupSecretConfirm = default(bool), bool lookupSecretRegenerate = default(bool), bool lookupSecretReveal = default(bool), string method = default(string))
        {
            // to ensure "method" is required (not null)
            this.Method = method ?? throw new ArgumentNullException("method is a required property for ClientSubmitSelfServiceSettingsFlowWithLookupMethodBody and cannot be null");
