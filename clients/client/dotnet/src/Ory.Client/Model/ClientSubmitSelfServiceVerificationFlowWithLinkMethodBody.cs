...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceVerificationFlowWithLinkMethodBody : IEquatable<ClientSubmitSelfServiceVerificationFlowWithLinkMethodBody>, IValidatableObject
    {
        ...
        public ClientSubmitSelfServiceVerificationFlowWithLinkMethodBody(string csrfToken = default(string), string email = default(string), MethodEnum method = default(MethodEnum))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for ClientSubmitSelfServiceVerificationFlowWithLinkMethodBody and cannot be null");
            this.Method = method;
