...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateSubscriptionBody : IEquatable<ClientCreateSubscriptionBody>, IValidatableObject
    {
        ...
        public ClientCreateSubscriptionBody(string planOrPrice = default(string), string provisionFirstProject = default(string), string returnTo = default(string))
        {
            // to ensure "planOrPrice" is required (not null)
            if (planOrPrice == null) {
                throw new ArgumentNullException("planOrPrice is a required property for ClientCreateSubscriptionBody and cannot be null");
            }
