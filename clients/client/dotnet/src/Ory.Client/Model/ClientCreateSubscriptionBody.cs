...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateSubscriptionBody : IEquatable<ClientCreateSubscriptionBody>, IValidatableObject
    {
        ...
        public ClientCreateSubscriptionBody(CurrencyEnum? currency = default(CurrencyEnum?), IntervalEnum interval = default(IntervalEnum), string plan = default(string), string provisionFirstProject = default(string), string returnTo = default(string), string workspace = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "provision_first_project", EmitDefaultValue = true)]
