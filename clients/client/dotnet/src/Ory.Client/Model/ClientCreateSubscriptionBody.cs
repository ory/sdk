...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateSubscriptionBody : IEquatable<ClientCreateSubscriptionBody>, IValidatableObject
    {
        ...
        public ClientCreateSubscriptionBody(IntervalEnum interval = default(IntervalEnum), string plan = default(string), string provisionFirstProject = default(string), string returnTo = default(string))
        {
