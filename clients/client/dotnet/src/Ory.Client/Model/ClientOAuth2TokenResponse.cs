...
namespace Ory.Client.Model
{
    ...
    public partial class ClientOAuth2TokenResponse : IEquatable<ClientOAuth2TokenResponse>, IValidatableObject
    {
        ...
        public ClientOAuth2TokenResponse(string accessToken = default(string), long expiresIn = default(long), long idToken = default(long), string refreshToken = default(string), long scope = default(long), string tokenType = default(string))
        {
