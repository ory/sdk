...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSelfServiceRecoveryFlow : IEquatable<ClientSelfServiceRecoveryFlow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSelfServiceRecoveryFlow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientSelfServiceRecoveryFlow()
        {
        ...
        public ClientSelfServiceRecoveryFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), string returnTo = default(string), ClientSelfServiceRecoveryFlowState state = default(ClientSelfServiceRecoveryFlowState), string type = default(string), ClientUiContainer ui = default(ClientUiContainer))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for ClientSelfServiceRecoveryFlow and cannot be null");
            }
            this.Id = id;
            this.IssuedAt = issuedAt;
            // to ensure "requestUrl" is required (not null)
            if (requestUrl == null) {
                throw new ArgumentNullException("requestUrl is a required property for ClientSelfServiceRecoveryFlow and cannot be null");
            }
            this.RequestUrl = requestUrl;
            // to ensure "state" is required (not null)
            if (state == null) {
                throw new ArgumentNullException("state is a required property for ClientSelfServiceRecoveryFlow and cannot be null");
            }
            this.State = state;
            // to ensure "type" is required (not null)
            if (type == null) {
                throw new ArgumentNullException("type is a required property for ClientSelfServiceRecoveryFlow and cannot be null");
            }
            this.Type = type;
            // to ensure "ui" is required (not null)
            if (ui == null) {
                throw new ArgumentNullException("ui is a required property for ClientSelfServiceRecoveryFlow and cannot be null");
            }
            this.Ui = ui;
            this.Active = active;
        ...
        public ClientSelfServiceRecoveryFlowState State { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientSelfServiceRecoveryFlow {\n");
        ...
        {
            return this.Equals(input as ClientSelfServiceRecoveryFlow);
        }

        /// <summary>
        /// Returns true if ClientSelfServiceRecoveryFlow instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSelfServiceRecoveryFlow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSelfServiceRecoveryFlow input)
        {
            if (input == null)
            {
                return false;
