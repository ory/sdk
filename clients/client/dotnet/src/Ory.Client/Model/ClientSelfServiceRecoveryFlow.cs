...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSelfServiceRecoveryFlow : IEquatable<ClientSelfServiceRecoveryFlow>, IValidatableObject
    {
        ...
        public ClientSelfServiceRecoveryFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), ClientSelfServiceRecoveryFlowState state = default(ClientSelfServiceRecoveryFlowState), string type = default(string), ClientUiContainer ui = default(ClientUiContainer))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ClientSelfServiceRecoveryFlow and cannot be null");
            this.IssuedAt = issuedAt;
            // to ensure "requestUrl" is required (not null)
            this.RequestUrl = requestUrl ?? throw new ArgumentNullException("requestUrl is a required property for ClientSelfServiceRecoveryFlow and cannot be null");
            // to ensure "state" is required (not null)
            this.State = state ?? throw new ArgumentNullException("state is a required property for ClientSelfServiceRecoveryFlow and cannot be null");
            // to ensure "ui" is required (not null)
            this.Ui = ui ?? throw new ArgumentNullException("ui is a required property for ClientSelfServiceRecoveryFlow and cannot be null");
            this.Active = active;
            this.Type = type;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
