...
namespace Ory.Client.Model
{
    ...
    public partial class ClientLogoutRequest : IEquatable<ClientLogoutRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientLogoutRequest" /> class.
        /// </summary>
        ...
        public ClientLogoutRequest(string challenge = default(string), ClientOAuth2Client _client = default(ClientOAuth2Client), string requestUrl = default(string), bool rpInitiated = default(bool), string sid = default(string), string subject = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientLogoutRequest {\n");
        ...
        {
            return this.Equals(input as ClientLogoutRequest);
        }

        /// <summary>
        /// Returns true if ClientLogoutRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientLogoutRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientLogoutRequest input)
        {
            if (input == null)
            {
                return false;
