...
{
    /// <summary>
    /// ClientUpdateIdentity
    /// </summary>
    [DataContract(Name = "updateIdentity")]
    public partial class ClientUpdateIdentity : IEquatable<ClientUpdateIdentity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientUpdateIdentity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientUpdateIdentity()
        {
        ...
        public ClientUpdateIdentity(string schemaId = default(string), Object traits = default(Object))
        {
            // to ensure "traits" is required (not null)
            this.Traits = traits ?? throw new ArgumentNullException("traits is a required property for ClientUpdateIdentity and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientUpdateIdentity {\n");
        ...
        {
            return this.Equals(input as ClientUpdateIdentity);
        }

        /// <summary>
        /// Returns true if ClientUpdateIdentity instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateIdentity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateIdentity input)
        {
            if (input == null)
                return false;
