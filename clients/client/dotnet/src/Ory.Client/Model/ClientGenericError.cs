...
namespace Ory.Client.Model
{
    ...
    public partial class ClientGenericError : IEquatable<ClientGenericError>, IValidatableObject
    {
        ...
        public ClientGenericError(long code = default(long), string debug = default(string), List<Dictionary<string, Object>> details = default(List<Dictionary<string, Object>>), ClientGenericErrorContent error = default(ClientGenericErrorContent), string id = default(string), string message = default(string), string reason = default(string), string request = default(string), string status = default(string))
        {
