...
namespace Ory.Client.Model
{
    ...
    public partial class ClientGenericError : IEquatable<ClientGenericError>, IValidatableObject
    {
        ...
        public ClientGenericError(long code = default(long), string debug = default(string), Object details = default(Object), string id = default(string), string message = default(string), string reason = default(string), string request = default(string), string status = default(string))
        {
