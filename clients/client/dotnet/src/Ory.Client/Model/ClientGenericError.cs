...
namespace Ory.Client.Model
{
    ...
    public partial class ClientGenericError : IEquatable<ClientGenericError>, IValidatableObject
    {
        ...
        /// <param name="message">Message contains the error message. (required).</param>
        ...
        public ClientGenericError(long code = default(long), string debug = default(string), Object details = default(Object), string error = default(string), string errorDescription = default(string), string id = default(string), string message = default(string), string reason = default(string), string request = default(string), string status = default(string), long statusCode = default(long))
        {
