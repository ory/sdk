...
namespace Ory.Client.Model
{
    ...
    public partial class ClientEventStream : IEquatable<ClientEventStream>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientEventStream);
        }

        /// <summary>
        /// Returns true if ClientEventStream instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientEventStream to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientEventStream input)
        {
            if (input == null)
            {
                return false;
