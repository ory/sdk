...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceSettingsFlowWithPasswordMethodBody : IEquatable<ClientSubmitSelfServiceSettingsFlowWithPasswordMethodBody>, IValidatableObject
    {
        ...
        public ClientSubmitSelfServiceSettingsFlowWithPasswordMethodBody(string csrfToken = default(string), MethodEnum method = default(MethodEnum), string password = default(string))
        {
            this.Method = method;
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for ClientSubmitSelfServiceSettingsFlowWithPasswordMethodBody and cannot be null");
