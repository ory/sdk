...
namespace Ory.Client.Model
{
    ...
    public partial class ClientIdentityWithCredentialsOidcConfigProvider : IEquatable<ClientIdentityWithCredentialsOidcConfigProvider>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientIdentityWithCredentialsOidcConfigProvider);
        }

        /// <summary>
        /// Returns true if ClientIdentityWithCredentialsOidcConfigProvider instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientIdentityWithCredentialsOidcConfigProvider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientIdentityWithCredentialsOidcConfigProvider input)
        {
            if (input == null)
            {
                return false;
