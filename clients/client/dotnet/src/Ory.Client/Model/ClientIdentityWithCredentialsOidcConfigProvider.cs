...
namespace Ory.Client.Model
{
    ...
    public partial class ClientIdentityWithCredentialsOidcConfigProvider : IValidatableObject
    {
        ...
        public ClientIdentityWithCredentialsOidcConfigProvider(string organization = default(string), string provider = default(string), string subject = default(string), bool useAutoLink = default(bool))
        {
