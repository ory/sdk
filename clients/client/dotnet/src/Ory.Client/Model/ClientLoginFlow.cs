...
namespace Ory.Client.Model
{
    ...
    public partial class ClientLoginFlow : IEquatable<ClientLoginFlow>, IValidatableObject
    {
        ...
        public ClientLoginFlow(string active = default(string), DateTime createdAt = default(DateTime), DateTime expiresAt = default(DateTime), bool forced = default(bool), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), string type = default(string), ClientUiContainer ui = default(ClientUiContainer), DateTime updatedAt = default(DateTime))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ClientLoginFlow and cannot be null");
            this.IssuedAt = issuedAt;
            // to ensure "requestUrl" is required (not null)
            this.RequestUrl = requestUrl ?? throw new ArgumentNullException("requestUrl is a required property for ClientLoginFlow and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ClientLoginFlow and cannot be null");
            // to ensure "ui" is required (not null)
            this.Ui = ui ?? throw new ArgumentNullException("ui is a required property for ClientLoginFlow and cannot be null");
            this.Active = active;
