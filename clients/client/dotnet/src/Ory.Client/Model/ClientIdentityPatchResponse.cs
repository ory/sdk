...
namespace Ory.Client.Model
{
    ...
    public partial class ClientIdentityPatchResponse : IValidatableObject
    {
        ...
        public ClientIdentityPatchResponse(ActionEnum? action = default(ActionEnum?), Object error = default(Object), string identity = default(string), string patchId = default(string))
        {
            this.Action = action;
            this.Error = error;
