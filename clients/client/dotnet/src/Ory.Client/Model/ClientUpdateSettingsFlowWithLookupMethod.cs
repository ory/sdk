...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowWithLookupMethod : IEquatable<ClientUpdateSettingsFlowWithLookupMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientUpdateSettingsFlowWithLookupMethod(string csrfToken = default(string), bool lookupSecretConfirm = default(bool), bool lookupSecretDisable = default(bool), bool lookupSecretRegenerate = default(bool), bool lookupSecretReveal = default(bool), string method = default(string))
        {
        ...
        {
            return this.Equals(input as ClientUpdateSettingsFlowWithLookupMethod);
        }

        /// <summary>
        /// Returns true if ClientUpdateSettingsFlowWithLookupMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateSettingsFlowWithLookupMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateSettingsFlowWithLookupMethod input)
        {
            if (input == null)
            {
                return false;
