...
namespace Ory.Client.Model
{
    ...
    public partial class ClientRelationship : IEquatable<ClientRelationship>, IValidatableObject
    {
        ...
        public ClientRelationship(string _namespace = default(string), string _object = default(string), string relation = default(string), string subjectId = default(string), ClientSubjectSet subjectSet = default(ClientSubjectSet))
        {
            // to ensure "_namespace" is required (not null)
            if (_namespace == null) {
                throw new ArgumentNullException("_namespace is a required property for ClientRelationship and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "_object" is required (not null)
            if (_object == null) {
                throw new ArgumentNullException("_object is a required property for ClientRelationship and cannot be null");
            }
            this.Object = _object;
