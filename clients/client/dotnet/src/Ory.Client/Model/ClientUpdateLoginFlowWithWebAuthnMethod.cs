...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateLoginFlowWithWebAuthnMethod : IEquatable<ClientUpdateLoginFlowWithWebAuthnMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientUpdateLoginFlowWithWebAuthnMethod(string csrfToken = default(string), string identifier = default(string), string method = default(string), string webauthnLogin = default(string))
        {
        ...
        {
            return this.Equals(input as ClientUpdateLoginFlowWithWebAuthnMethod);
        }

        /// <summary>
        /// Returns true if ClientUpdateLoginFlowWithWebAuthnMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateLoginFlowWithWebAuthnMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateLoginFlowWithWebAuthnMethod input)
        {
            if (input == null)
            {
                return false;
