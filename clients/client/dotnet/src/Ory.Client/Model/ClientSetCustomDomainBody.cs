...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSetCustomDomainBody : IEquatable<ClientSetCustomDomainBody>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientSetCustomDomainBody(string cookieDomain = default(string), List<string> corsAllowedOrigins = default(List<string>), bool corsEnabled = default(bool), string hostname = default(string))
        {
        ...
        {
            return this.Equals(input as ClientSetCustomDomainBody);
        }

        /// <summary>
        /// Returns true if ClientSetCustomDomainBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSetCustomDomainBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSetCustomDomainBody input)
        {
            if (input == null)
            {
                return false;
