...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUiNodeAnchorAttributes : IEquatable<ClientUiNodeAnchorAttributes>, IValidatableObject
    {
        ...
        public ClientUiNodeAnchorAttributes(string href = default(string), string id = default(string), ClientUiText title = default(ClientUiText))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ClientUiNodeAnchorAttributes and cannot be null");
