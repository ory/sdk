...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowWithSamlMethod : IValidatableObject
    {
        ...
        public ClientUpdateSettingsFlowWithSamlMethod(string flow = default(string), string link = default(string), string method = default(string), Object traits = default(Object), Object transientPayload = default(Object), string unlink = default(string))
        {
