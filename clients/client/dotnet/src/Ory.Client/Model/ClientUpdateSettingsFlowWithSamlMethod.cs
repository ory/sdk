...
namespace Ory.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateSettingsFlowWithSamlMethod")]
    public partial class ClientUpdateSettingsFlowWithSamlMethod : IValidatableObject
    {
        ...
        protected ClientUpdateSettingsFlowWithSamlMethod()
        {
        ...
        /// <param name="method">Method  Should be set to saml when trying to update a profile. (required).</param>
        ...
        public ClientUpdateSettingsFlowWithSamlMethod(string csrfToken = default(string), string flow = default(string), string link = default(string), string method = default(string), Object traits = default(Object), Object transientPayload = default(Object), string unlink = default(string))
        {
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for ClientUpdateSettingsFlowWithSamlMethod and cannot be null");
            }
            this.Method = method;
