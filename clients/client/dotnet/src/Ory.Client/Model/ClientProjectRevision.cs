...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProjectRevision : IEquatable<ClientProjectRevision>, IValidatableObject
    {
        ...
        public ClientNullUUID KratosCustomSchemaId { get; set; }
