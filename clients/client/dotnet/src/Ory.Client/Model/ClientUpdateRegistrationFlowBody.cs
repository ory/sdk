...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateRegistrationFlowBody : AbstractOpenAPISchema, IEquatable<ClientUpdateRegistrationFlowBody>, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ClientUpdateRegistrationFlowWithOidcMethod))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ClientUpdateRegistrationFlowWithOidcMethod, ClientUpdateRegistrationFlowWithPasswordMethod, ClientUpdateRegistrationFlowWithWebAuthnMethod");
                }
            }
        }
