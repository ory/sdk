...
namespace Ory.Client.Model
{
    ...
    public partial class ClientLogoutFlow : IEquatable<ClientLogoutFlow>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientLogoutFlow);
        }

        /// <summary>
        /// Returns true if ClientLogoutFlow instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientLogoutFlow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientLogoutFlow input)
        {
            if (input == null)
            {
                return false;
