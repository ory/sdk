...
namespace Ory.Client.Model
{
    ...
    public partial class ClientIdentityWithCredentials : IEquatable<ClientIdentityWithCredentials>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientIdentityWithCredentials);
        }

        /// <summary>
        /// Returns true if ClientIdentityWithCredentials instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientIdentityWithCredentials to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientIdentityWithCredentials input)
        {
            if (input == null)
            {
                return false;
