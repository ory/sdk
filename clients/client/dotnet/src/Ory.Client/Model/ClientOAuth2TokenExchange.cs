...
namespace Ory.Client.Model
{
    ...
    public partial class ClientOAuth2TokenExchange : IEquatable<ClientOAuth2TokenExchange>, IValidatableObject
    {
        ...
        public ClientOAuth2TokenExchange(string accessToken = default(string), long expiresIn = default(long), long idToken = default(long), string refreshToken = default(string), long scope = default(long), string tokenType = default(string))
        {
