...
namespace Ory.Client.Model
{
    ...
    public partial class ClientNormalizedProjectRevisionThirdPartyProvider : IEquatable<ClientNormalizedProjectRevisionThirdPartyProvider>, IValidatableObject
    {
        ...
        public ClientNormalizedProjectRevisionThirdPartyProvider(string applePrivateKey = default(string), string applePrivateKeyId = default(string), string appleTeamId = default(string), string authUrl = default(string), string azureTenant = default(string), string clientId = default(string), string clientSecret = default(string), string id = default(string), string issuerUrl = default(string), string label = default(string), string mapperUrl = default(string), string projectRevisionId = default(string), string provider = default(string), string providerId = default(string), Object requestedClaims = default(Object), List<string> scope = default(List<string>), string subjectSource = default(string), string tokenUrl = default(string))
        {
