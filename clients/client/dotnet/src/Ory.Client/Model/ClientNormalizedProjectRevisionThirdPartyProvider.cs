...
namespace Ory.Client.Model
{
    ...
    public partial class ClientNormalizedProjectRevisionThirdPartyProvider : IValidatableObject
    {
        ...
        public ClientNormalizedProjectRevisionThirdPartyProvider(List<string> additionalIdTokenAudiences = default(List<string>), string applePrivateKey = default(string), string applePrivateKeyId = default(string), string appleTeamId = default(string), string authUrl = default(string), string azureTenant = default(string), string claimsSource = default(string), string clientId = default(string), string clientSecret = default(string), string id = default(string), string issuerUrl = default(string), string label = default(string), string mapperUrl = default(string), string organizationId = default(string), PkceEnum? pkce = default(PkceEnum?), string projectRevisionId = default(string), string provider = default(string), string providerId = default(string), Object requestedClaims = default(Object), List<string> scope = default(List<string>), StateEnum? state = default(StateEnum?), string subjectSource = default(string), string tokenUrl = default(string))
        {
