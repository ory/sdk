...
{
    /// <summary>
    /// ClientAcceptConsentRequest
    /// </summary>
    [DataContract(Name = "acceptConsentRequest")]
    public partial class ClientAcceptConsentRequest : IEquatable<ClientAcceptConsentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientAcceptConsentRequest" /> class.
        /// </summary>
        ...
        public ClientAcceptConsentRequest(List<string> grantAccessTokenAudience = default(List<string>), List<string> grantScope = default(List<string>), DateTime handledAt = default(DateTime), bool remember = default(bool), long rememberFor = default(long), ClientConsentRequestSession session = default(ClientConsentRequestSession))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientAcceptConsentRequest {\n");
        ...
        {
            return this.Equals(input as ClientAcceptConsentRequest);
        }

        /// <summary>
        /// Returns true if ClientAcceptConsentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientAcceptConsentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientAcceptConsentRequest input)
        {
            if (input == null)
            {
                return false;
