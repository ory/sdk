...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceLoginFlowWithOidcMethodBody : IEquatable<ClientSubmitSelfServiceLoginFlowWithOidcMethodBody>, IValidatableObject
    {
        ...
        public ClientSubmitSelfServiceLoginFlowWithOidcMethodBody(string csrfToken = default(string), string method = default(string), string traits = default(string))
        {
            // to ensure "method" is required (not null)
            this.Method = method ?? throw new ArgumentNullException("method is a required property for ClientSubmitSelfServiceLoginFlowWithOidcMethodBody and cannot be null");
            // to ensure "traits" is required (not null)
            this.Traits = traits ?? throw new ArgumentNullException("traits is a required property for ClientSubmitSelfServiceLoginFlowWithOidcMethodBody and cannot be null");
