...
{
    /// <summary>
    /// ClientConsentRequest
    /// </summary>
    [DataContract(Name = "consentRequest")]
    public partial class ClientConsentRequest : IEquatable<ClientConsentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientConsentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientConsentRequest()
        {
        ...
        public ClientConsentRequest(string acr = default(string), List<string> amr = default(List<string>), string challenge = default(string), ClientOAuth2Client _client = default(ClientOAuth2Client), Object context = default(Object), string loginChallenge = default(string), string loginSessionId = default(string), ClientOpenIDConnectContext oidcContext = default(ClientOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), bool skip = default(bool), string subject = default(string))
        {
            // to ensure "challenge" is required (not null)
            if (challenge == null) {
                throw new ArgumentNullException("challenge is a required property for ClientConsentRequest and cannot be null");
            }
        ...
        public ClientOpenIDConnectContext OidcContext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientConsentRequest {\n");
        ...
        {
            return this.Equals(input as ClientConsentRequest);
        }

        /// <summary>
        /// Returns true if ClientConsentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientConsentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientConsentRequest input)
        {
            if (input == null)
            {
                return false;
