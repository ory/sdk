...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubscription : IEquatable<ClientSubscription>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The currently active interval of the subscription monthly Monthly yearly Yearly</value>
        [DataMember(Name = "current_interval", IsRequired = true, EmitDefaultValue = false)]
        ...
        public bool Equals(ClientSubscription input)
        {
            ...
            return 
                ...
                (
                    this.CurrentInterval == input.CurrentInterval ||
                    this.CurrentInterval.Equals(input.CurrentInterval)
                ) && 
                (
                ...
                (
                    this.CurrentPlanDetails == input.CurrentPlanDetails ||
                    (this.CurrentPlanDetails != null &&
                    this.CurrentPlanDetails.Equals(input.CurrentPlanDetails))
                ) && 
                (
                ...
                (
                    this.IntervalChangesTo == input.IntervalChangesTo ||
                    (this.IntervalChangesTo != null &&
                    this.IntervalChangesTo.Equals(input.IntervalChangesTo))
                ) && 
                (
                ...
                (
                    this.StripeCheckoutExpiresAt == input.StripeCheckoutExpiresAt ||
                    (this.StripeCheckoutExpiresAt != null &&
                    this.StripeCheckoutExpiresAt.Equals(input.StripeCheckoutExpiresAt))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CurrentInterval.GetHashCode();
                if (this.CurrentPlan != null)
                {
                    hashCode = (hashCode * 59) + this.CurrentPlan.GetHashCode();
                }
                if (this.CurrentPlanDetails != null)
                {
                    hashCode = (hashCode * 59) + this.CurrentPlanDetails.GetHashCode();
                }
                ...
                if (this.IntervalChangesTo != null)
                {
                    hashCode = (hashCode * 59) + this.IntervalChangesTo.GetHashCode();
                }
                ...
                if (this.StripeCheckoutExpiresAt != null)
                {
                    hashCode = (hashCode * 59) + this.StripeCheckoutExpiresAt.GetHashCode();
                }
