...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubscription : IEquatable<ClientSubscription>, IValidatableObject
    {
        ...
        public ClientSubscription(string intervalChangesTo = default(string), string ongoingStripeCheckoutId = default(string), DateTime planChangesAt = default(DateTime), string planChangesTo = default(string), string status = default(string))
        {
