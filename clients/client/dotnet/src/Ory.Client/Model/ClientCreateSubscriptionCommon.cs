...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateSubscriptionCommon : IEquatable<ClientCreateSubscriptionCommon>, IValidatableObject
    {
        /// <summary>
        ///  usd USD eur Euro
        /// </summary>
        ...
        {
            return this.Equals(input as ClientCreateSubscriptionCommon);
        }

        /// <summary>
        /// Returns true if ClientCreateSubscriptionCommon instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCreateSubscriptionCommon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCreateSubscriptionCommon input)
        {
            if (input == null)
            {
                return false;
