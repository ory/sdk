...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateFedcmFlowBody : IValidatableObject
    {
        ...
        public ClientUpdateFedcmFlowBody(string csrfToken = default(string), string nonce = default(string), string token = default(string), Object transientPayload = default(Object))
        {
