...
namespace Ory.Client.Model
{
    ...
    public partial class ClientProjectServices : IEquatable<ClientProjectServices>, IValidatableObject
    {
        ...
        public ClientProjectServices(ClientProjectServiceIdentity identity = default(ClientProjectServiceIdentity), ClientProjectServicePermission permission = default(ClientProjectServicePermission))
        {
