...
{
    /// <summary>
    /// ClientProjectRevisionIdentitySchema
    /// </summary>
    [DataContract(Name = "projectRevisionIdentitySchema")]
    public partial class ClientProjectRevisionIdentitySchema : IEquatable<ClientProjectRevisionIdentitySchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientProjectRevisionIdentitySchema" /> class.
        /// </summary>
        ...
        public ClientProjectRevisionIdentitySchema(string id = default(string), ClientIdentitySchema identitySchema = default(ClientIdentitySchema), string identitySchemaId = default(string), string importId = default(string), string importUrl = default(string), bool isDefault = default(bool), string preset = default(string), string projectRevisionId = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientProjectRevisionIdentitySchema {\n");
        ...
        {
            return this.Equals(input as ClientProjectRevisionIdentitySchema);
        }

        /// <summary>
        /// Returns true if ClientProjectRevisionIdentitySchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientProjectRevisionIdentitySchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientProjectRevisionIdentitySchema input)
        {
            if (input == null)
            {
                return false;
