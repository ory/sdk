...
namespace Ory.Client.Model
{
    ...
    public partial class ClientOAuth2Client : IEquatable<ClientOAuth2Client>, IValidatableObject
    {
        ...
        /// <param name="clientId">ID is the id for this client.  The ID is autogenerated and immutable..</param>
        ...
        public ClientOAuth2Client(List<string> allowedCorsOrigins = default(List<string>), List<string> audience = default(List<string>), string authorizationCodeGrantAccessTokenLifespan = default(string), string authorizationCodeGrantIdTokenLifespan = default(string), string authorizationCodeGrantRefreshTokenLifespan = default(string), bool backchannelLogoutSessionRequired = default(bool), string backchannelLogoutUri = default(string), string clientCredentialsGrantAccessTokenLifespan = default(string), string clientId = default(string), string clientName = default(string), string clientSecret = default(string), long clientSecretExpiresAt = default(long), string clientUri = default(string), List<string> contacts = default(List<string>), DateTime createdAt = default(DateTime), bool frontchannelLogoutSessionRequired = default(bool), string frontchannelLogoutUri = default(string), List<string> grantTypes = default(List<string>), string implicitGrantAccessTokenLifespan = default(string), string implicitGrantIdTokenLifespan = default(string), Object jwks = default(Object), string jwksUri = default(string), string jwtBearerGrantAccessTokenLifespan = default(string), string logoUri = default(string), Object metadata = default(Object), string owner = default(string), string passwordGrantAccessTokenLifespan = default(string), string passwordGrantRefreshTokenLifespan = default(string), string policyUri = default(string), List<string> postLogoutRedirectUris = default(List<string>), List<string> redirectUris = default(List<string>), string refreshTokenGrantAccessTokenLifespan = default(string), string refreshTokenGrantIdTokenLifespan = default(string), string refreshTokenGrantRefreshTokenLifespan = default(string), string registrationAccessToken = default(string), string registrationClientUri = default(string), string requestObjectSigningAlg = default(string), List<string> requestUris = default(List<string>), List<string> responseTypes = default(List<string>), string scope = default(string), string sectorIdentifierUri = default(string), string subjectType = default(string), string tokenEndpointAuthMethod = default(string), string tokenEndpointAuthSigningAlg = default(string), string tosUri = default(string), DateTime updatedAt = default(DateTime), string userinfoSignedResponseAlg = default(string))
        {
        ...
        /// </summary>
        /// <value>ID is the id for this client.  The ID is autogenerated and immutable.</value>
