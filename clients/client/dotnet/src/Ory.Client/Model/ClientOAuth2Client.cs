...
namespace Ory.Client.Model
{
    ...
    public partial class ClientOAuth2Client : IValidatableObject
    {
        ...
        /// <param name="allowedCorsOrigins">OAuth 2.0 Client Allowed CORS Origins  One or more URLs (scheme://host[:port]) which are allowed to make CORS requests to the /oauth/token endpoint. If this array is empty, the server&#39;s CORS origin configuration (&#x60;CORS_ALLOWED_ORIGINS&#x60;) will be used instead. If this array is set, the allowed origins are appended to the server&#39;s CORS origin configuration. Be aware that environment variable &#x60;CORS_ENABLED&#x60; MUST be set to &#x60;true&#x60; for this to work.</param>
        /// <param name="audience">OAuth 2.0 Client Audience  An allow-list defining the audiences this client is allowed to request tokens for. An audience limits the applicability of an OAuth 2.0 Access Token to, for example, certain API endpoints. The value is a list of URLs. URLs MUST NOT contain whitespaces.</param>
        ...
        /// <param name="contacts">OAuth 2.0 Client Contact  An array of strings representing ways to contact people responsible for this client, typically email addresses.</param>
        ...
        /// <param name="grantTypes">OAuth 2.0 Client Grant Types  An array of OAuth 2.0 grant types the client is allowed to use. Can be one of:  Client Credentials Grant: &#x60;client_credentials&#x60; Authorization Code Grant: &#x60;authorization_code&#x60; OpenID Connect Implicit Grant (deprecated!): &#x60;implicit&#x60; Refresh Token Grant: &#x60;refresh_token&#x60; OAuth 2.0 Token Exchange: &#x60;urn:ietf:params:oauth:grant-type:jwt-bearer&#x60; OAuth 2.0 Device Code Grant: &#x60;urn:ietf:params:oauth:grant-type:device_code&#x60;</param>
        ...
        /// <param name="postLogoutRedirectUris">Allowed Post-Redirect Logout URIs  Array of URLs supplied by the RP to which it MAY request that the End-User&#39;s User Agent be redirected using the post_logout_redirect_uri parameter after a logout has been performed.</param>
        /// <param name="redirectUris">OAuth 2.0 Client Redirect URIs  RedirectURIs is an array of allowed redirect urls for the client.</param>
        ...
        /// <param name="requestUris">OpenID Connect Request URIs  Array of request_uri values that are pre-registered by the RP for use at the OP. Servers MAY cache the contents of the files referenced by these URIs and not retrieve them at the time they are used in a request. OPs can require that request_uri values used be pre-registered with the require_request_uri_registration discovery parameter.</param>
        /// <param name="responseTypes">OAuth 2.0 Client Response Types  An array of the OAuth 2.0 response type strings that the client can use at the authorization endpoint. Can be one of:  Needed for OpenID Connect Implicit Grant: Returns ID Token to redirect URI: &#x60;id_token&#x60; Returns Access token redirect URI: &#x60;token&#x60; Needed for Authorization Code Grant: &#x60;code&#x60;</param>
        ...
        /// </summary>
        /// <value>OAuth 2.0 Access Token Strategy  AccessTokenStrategy is the strategy used to generate access tokens. Valid options are &#x60;jwt&#x60; and &#x60;opaque&#x60;. &#x60;jwt&#x60; is a bad idea, see https://www.ory.com/docs/oauth2-oidc/jwt-access-token Setting the strategy here overrides the global setting in &#x60;strategies.access_token&#x60;.</value>
        [JsonPropertyName("access_token_strategy")]
        public string? AccessTokenStrategy { get { return this.AccessTokenStrategyOption.Value; } set { this.AccessTokenStrategyOption = new(value); } }
        ...
        /// </summary>
        /// <value>OAuth 2.0 Client Allowed CORS Origins  One or more URLs (scheme://host[:port]) which are allowed to make CORS requests to the /oauth/token endpoint. If this array is empty, the server&#39;s CORS origin configuration (&#x60;CORS_ALLOWED_ORIGINS&#x60;) will be used instead. If this array is set, the allowed origins are appended to the server&#39;s CORS origin configuration. Be aware that environment variable &#x60;CORS_ENABLED&#x60; MUST be set to &#x60;true&#x60; for this to work.</value>
        [JsonPropertyName("allowed_cors_origins")]
        public List<string>? AllowedCorsOrigins { get { return this.AllowedCorsOriginsOption.Value; } set { this.AllowedCorsOriginsOption = new(value); } }
        ...
        /// </summary>
        /// <value>OAuth 2.0 Client Audience  An allow-list defining the audiences this client is allowed to request tokens for. An audience limits the applicability of an OAuth 2.0 Access Token to, for example, certain API endpoints. The value is a list of URLs. URLs MUST NOT contain whitespaces.</value>
        /* <example>https://mydomain.com/api/users, https://mydomain.com/api/posts</example> */
        [JsonPropertyName("audience")]
        public List<string>? Audience { get { return this.AudienceOption.Value; } set { this.AudienceOption = new(value); } }
        ...
        public bool? BackchannelLogoutSessionRequired { get { return this.BackchannelLogoutSessionRequiredOption.Value; } set { this.BackchannelLogoutSessionRequiredOption = new(value); } }
        ...
        public string? BackchannelLogoutUri { get { return this.BackchannelLogoutUriOption.Value; } set { this.BackchannelLogoutUriOption = new(value); } }
        ...
        public long? ClientSecretExpiresAt { get { return this.ClientSecretExpiresAtOption.Value; } set { this.ClientSecretExpiresAtOption = new(value); } }
        ...
        /// </summary>
        /// <value>OAuth 2.0 Client Contact  An array of strings representing ways to contact people responsible for this client, typically email addresses.</value>
        /* <example>help@example.org</example> */
        [JsonPropertyName("contacts")]
        public List<string>? Contacts { get { return this.ContactsOption.Value; } set { this.ContactsOption = new(value); } }
        ...
        public bool? FrontchannelLogoutSessionRequired { get { return this.FrontchannelLogoutSessionRequiredOption.Value; } set { this.FrontchannelLogoutSessionRequiredOption = new(value); } }
        ...
        public string? FrontchannelLogoutUri { get { return this.FrontchannelLogoutUriOption.Value; } set { this.FrontchannelLogoutUriOption = new(value); } }
        ...
        /// </summary>
        /// <value>OAuth 2.0 Client Grant Types  An array of OAuth 2.0 grant types the client is allowed to use. Can be one of:  Client Credentials Grant: &#x60;client_credentials&#x60; Authorization Code Grant: &#x60;authorization_code&#x60; OpenID Connect Implicit Grant (deprecated!): &#x60;implicit&#x60; Refresh Token Grant: &#x60;refresh_token&#x60; OAuth 2.0 Token Exchange: &#x60;urn:ietf:params:oauth:grant-type:jwt-bearer&#x60; OAuth 2.0 Device Code Grant: &#x60;urn:ietf:params:oauth:grant-type:device_code&#x60;</value>
        ...
        public ClientJsonWebKeySet? Jwks { get { return this.JwksOption.Value; } set { this.JwksOption = new(value); } }
        ...
        public string? PolicyUri { get { return this.PolicyUriOption.Value; } set { this.PolicyUriOption = new(value); } }
        ...
        /// </summary>
        /// <value>Allowed Post-Redirect Logout URIs  Array of URLs supplied by the RP to which it MAY request that the End-User&#39;s User Agent be redirected using the post_logout_redirect_uri parameter after a logout has been performed.</value>
        [JsonPropertyName("post_logout_redirect_uris")]
        public List<string>? PostLogoutRedirectUris { get { return this.PostLogoutRedirectUrisOption.Value; } set { this.PostLogoutRedirectUrisOption = new(value); } }
        ...
        /// </summary>
        /// <value>OAuth 2.0 Client Redirect URIs  RedirectURIs is an array of allowed redirect urls for the client.</value>
        /* <example>http://mydomain/oauth/callback</example> */
        ...
        public string? RegistrationAccessToken { get { return this.RegistrationAccessTokenOption.Value; } set { this.RegistrationAccessTokenOption = new(value); } }
        ...
        public string? RegistrationClientUri { get { return this.RegistrationClientUriOption.Value; } set { this.RegistrationClientUriOption = new(value); } }
        ...
        public string? RequestObjectSigningAlg { get { return this.RequestObjectSigningAlgOption.Value; } set { this.RequestObjectSigningAlgOption = new(value); } }
        ...
        /// </summary>
        /// <value>OpenID Connect Request URIs  Array of request_uri values that are pre-registered by the RP for use at the OP. Servers MAY cache the contents of the files referenced by these URIs and not retrieve them at the time they are used in a request. OPs can require that request_uri values used be pre-registered with the require_request_uri_registration discovery parameter.</value>
        [JsonPropertyName("request_uris")]
        public List<string>? RequestUris { get { return this.RequestUrisOption.Value; } set { this.RequestUrisOption = new(value); } }
        ...
        /// </summary>
        /// <value>OAuth 2.0 Client Response Types  An array of the OAuth 2.0 response type strings that the client can use at the authorization endpoint. Can be one of:  Needed for OpenID Connect Implicit Grant: Returns ID Token to redirect URI: &#x60;id_token&#x60; Returns Access token redirect URI: &#x60;token&#x60; Needed for Authorization Code Grant: &#x60;code&#x60;</value>
        ...
        public string? SectorIdentifierUri { get { return this.SectorIdentifierUriOption.Value; } set { this.SectorIdentifierUriOption = new(value); } }
        ...
        public bool? SkipConsent { get { return this.SkipConsentOption.Value; } set { this.SkipConsentOption = new(value); } }
        ...
        public bool? SkipLogoutConsent { get { return this.SkipLogoutConsentOption.Value; } set { this.SkipLogoutConsentOption = new(value); } }
        ...
        public string? SubjectType { get { return this.SubjectTypeOption.Value; } set { this.SubjectTypeOption = new(value); } }
        ...
        public string? TokenEndpointAuthSigningAlg { get { return this.TokenEndpointAuthSigningAlgOption.Value; } set { this.TokenEndpointAuthSigningAlgOption = new(value); } }
        ...
        public string? TosUri { get { return this.TosUriOption.Value; } set { this.TosUriOption = new(value); } }
        ...
        public string? UserinfoSignedResponseAlg { get { return this.UserinfoSignedResponseAlgOption.Value; } set { this.UserinfoSignedResponseAlgOption = new(value); } }
