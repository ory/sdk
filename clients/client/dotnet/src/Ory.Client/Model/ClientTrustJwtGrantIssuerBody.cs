...
{
    /// <summary>
    /// ClientTrustJwtGrantIssuerBody
    /// </summary>
    [DataContract(Name = "trustJwtGrantIssuerBody")]
    public partial class ClientTrustJwtGrantIssuerBody : IEquatable<ClientTrustJwtGrantIssuerBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientTrustJwtGrantIssuerBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientTrustJwtGrantIssuerBody()
        {
        ...
        public ClientTrustJwtGrantIssuerBody(bool allowAnySubject = default(bool), DateTime expiresAt = default(DateTime), string issuer = default(string), ClientJSONWebKey jwk = default(ClientJSONWebKey), List<string> scope = default(List<string>), string subject = default(string))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "issuer" is required (not null)
            if (issuer == null) {
                throw new ArgumentNullException("issuer is a required property for ClientTrustJwtGrantIssuerBody and cannot be null");
            }
            this.Issuer = issuer;
            // to ensure "jwk" is required (not null)
            if (jwk == null) {
                throw new ArgumentNullException("jwk is a required property for ClientTrustJwtGrantIssuerBody and cannot be null");
            }
            this.Jwk = jwk;
            // to ensure "scope" is required (not null)
            if (scope == null) {
                throw new ArgumentNullException("scope is a required property for ClientTrustJwtGrantIssuerBody and cannot be null");
            }
            this.Scope = scope;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientTrustJwtGrantIssuerBody {\n");
        ...
        {
            return this.Equals(input as ClientTrustJwtGrantIssuerBody);
        }

        /// <summary>
        /// Returns true if ClientTrustJwtGrantIssuerBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientTrustJwtGrantIssuerBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientTrustJwtGrantIssuerBody input)
        {
            if (input == null)
            {
                return false;
