...
namespace Ory.Client.Model
{
    ...
    public partial class ClientContinueWithSettingsUiFlow : IEquatable<ClientContinueWithSettingsUiFlow>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientContinueWithSettingsUiFlow);
        }

        /// <summary>
        /// Returns true if ClientContinueWithSettingsUiFlow instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientContinueWithSettingsUiFlow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientContinueWithSettingsUiFlow input)
        {
            if (input == null)
            {
                return false;
