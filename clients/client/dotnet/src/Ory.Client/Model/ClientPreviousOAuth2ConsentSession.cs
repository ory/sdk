...
namespace Ory.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "previousOAuth2ConsentSession")]
    public partial class ClientPreviousOAuth2ConsentSession : IEquatable<ClientPreviousOAuth2ConsentSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientPreviousOAuth2ConsentSession" /> class.
        /// </summary>
        ...
        public ClientPreviousOAuth2ConsentSession(ClientOAuth2ConsentRequest consentRequest = default(ClientOAuth2ConsentRequest), List<string> grantAccessTokenAudience = default(List<string>), List<string> grantScope = default(List<string>), DateTime handledAt = default(DateTime), bool remember = default(bool), long rememberFor = default(long), ClientAcceptOAuth2ConsentRequestSession session = default(ClientAcceptOAuth2ConsentRequestSession))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientPreviousOAuth2ConsentSession {\n");
        ...
        {
            return this.Equals(input as ClientPreviousOAuth2ConsentSession);
        }

        /// <summary>
        /// Returns true if ClientPreviousOAuth2ConsentSession instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientPreviousOAuth2ConsentSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientPreviousOAuth2ConsentSession input)
        {
            if (input == null)
            {
                return false;
