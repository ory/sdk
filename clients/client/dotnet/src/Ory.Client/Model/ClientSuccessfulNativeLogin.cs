...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSuccessfulNativeLogin : IEquatable<ClientSuccessfulNativeLogin>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientSuccessfulNativeLogin(ClientSession session = default(ClientSession), string sessionToken = default(string))
        {
        ...
        {
            return this.Equals(input as ClientSuccessfulNativeLogin);
        }

        /// <summary>
        /// Returns true if ClientSuccessfulNativeLogin instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSuccessfulNativeLogin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSuccessfulNativeLogin input)
        {
            if (input == null)
            {
                return false;
