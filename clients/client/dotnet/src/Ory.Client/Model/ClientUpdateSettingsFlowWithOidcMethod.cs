...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowWithOidcMethod : IEquatable<ClientUpdateSettingsFlowWithOidcMethod>, IValidatableObject
    {
        ...
        public ClientUpdateSettingsFlowWithOidcMethod(string flow = default(string), string link = default(string), string method = default(string), Object traits = default(Object), string unlink = default(string))
        {
