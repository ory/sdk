...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowWithOidcMethod : IEquatable<ClientUpdateSettingsFlowWithOidcMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientUpdateSettingsFlowWithOidcMethod(string flow = default(string), string link = default(string), string method = default(string), Object traits = default(Object), string unlink = default(string), Object upstreamParameters = default(Object))
        {
        ...
        {
            return this.Equals(input as ClientUpdateSettingsFlowWithOidcMethod);
        }

        /// <summary>
        /// Returns true if ClientUpdateSettingsFlowWithOidcMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateSettingsFlowWithOidcMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateSettingsFlowWithOidcMethod input)
        {
            if (input == null)
            {
                return false;
