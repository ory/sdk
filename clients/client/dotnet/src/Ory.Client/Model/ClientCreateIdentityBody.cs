...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateIdentityBody : IEquatable<ClientCreateIdentityBody>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientCreateIdentityBody(ClientIdentityWithCredentials credentials = default(ClientIdentityWithCredentials), Object metadataAdmin = default(Object), Object metadataPublic = default(Object), List<ClientRecoveryIdentityAddress> recoveryAddresses = default(List<ClientRecoveryIdentityAddress>), string schemaId = default(string), ClientIdentityState state = default(ClientIdentityState), Object traits = default(Object), List<ClientVerifiableIdentityAddress> verifiableAddresses = default(List<ClientVerifiableIdentityAddress>))
        {
        ...
        {
            return this.Equals(input as ClientCreateIdentityBody);
        }

        /// <summary>
        /// Returns true if ClientCreateIdentityBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCreateIdentityBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCreateIdentityBody input)
        {
            if (input == null)
            {
                return false;
