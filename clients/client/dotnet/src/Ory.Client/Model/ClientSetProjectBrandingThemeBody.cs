...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSetProjectBrandingThemeBody : IEquatable<ClientSetProjectBrandingThemeBody>, IValidatableObject
    {
        ...
        public ClientSetProjectBrandingThemeBody(string logoType = default(string), string logoUrl = default(string), string name = default(string), ClientProjectBrandingColors theme = default(ClientProjectBrandingColors))
        {
