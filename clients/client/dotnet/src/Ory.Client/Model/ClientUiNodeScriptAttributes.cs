...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUiNodeScriptAttributes : IEquatable<ClientUiNodeScriptAttributes>, IValidatableObject
    {
        ...
        public ClientUiNodeScriptAttributes(bool async = default(bool), string crossorigin = default(string), string id = default(string), string integrity = default(string), string nodeType = default(string), string referrerpolicy = default(string), string src = default(string), string type = default(string))
        {
            this.Async = async;
