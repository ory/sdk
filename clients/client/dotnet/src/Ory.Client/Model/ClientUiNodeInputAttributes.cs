...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUiNodeInputAttributes : IEquatable<ClientUiNodeInputAttributes>, IValidatableObject
    {
        ...
        public ClientUiNodeInputAttributes(string autocomplete = default(string), bool disabled = default(bool), ClientUiText label = default(ClientUiText), string name = default(string), string nodeType = default(string), string onclick = default(string), string pattern = default(string), bool required = default(bool), TypeEnum type = default(TypeEnum), Object value = default(Object))
        {
