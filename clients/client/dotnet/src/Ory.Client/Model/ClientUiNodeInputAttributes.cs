...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUiNodeInputAttributes : IEquatable<ClientUiNodeInputAttributes>, IValidatableObject
    {
        ...
        public ClientUiNodeInputAttributes(bool disabled = default(bool), ClientUiText label = default(ClientUiText), string name = default(string), string onclick = default(string), string pattern = default(string), bool required = default(bool), string type = default(string), Object value = default(Object))
        {
