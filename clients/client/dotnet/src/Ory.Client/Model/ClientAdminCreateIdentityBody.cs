...
namespace Ory.Client.Model
{
    ...
    public partial class ClientAdminCreateIdentityBody : IEquatable<ClientAdminCreateIdentityBody>, IValidatableObject
    {
        ...
        public ClientAdminCreateIdentityBody(string schemaId = default(string), ClientIdentityState state = default(ClientIdentityState), Object traits = default(Object))
        {
