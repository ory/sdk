...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceLoginFlowWithPasswordMethodBody : IEquatable<ClientSubmitSelfServiceLoginFlowWithPasswordMethodBody>, IValidatableObject
    {
        ...
        /// <param name="passwordIdentifier">Identifier is the email or username of the user trying to log in. (required).</param>
        public ClientSubmitSelfServiceLoginFlowWithPasswordMethodBody(string csrfToken = default(string), MethodEnum method = default(MethodEnum), string password = default(string), string passwordIdentifier = default(string))
        {
            this.Method = method;
            // to ensure "password" is required (not null)
            this.Password = password ?? throw new ArgumentNullException("password is a required property for ClientSubmitSelfServiceLoginFlowWithPasswordMethodBody and cannot be null");
            // to ensure "passwordIdentifier" is required (not null)
            this.PasswordIdentifier = passwordIdentifier ?? throw new ArgumentNullException("passwordIdentifier is a required property for ClientSubmitSelfServiceLoginFlowWithPasswordMethodBody and cannot be null");
