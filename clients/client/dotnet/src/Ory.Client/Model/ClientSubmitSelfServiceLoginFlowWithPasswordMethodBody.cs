...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceLoginFlowWithPasswordMethodBody : IEquatable<ClientSubmitSelfServiceLoginFlowWithPasswordMethodBody>, IValidatableObject
    {
        ...
        public ClientSubmitSelfServiceLoginFlowWithPasswordMethodBody(string csrfToken = default(string), string method = default(string), string password = default(string), string passwordIdentifier = default(string))
        {
