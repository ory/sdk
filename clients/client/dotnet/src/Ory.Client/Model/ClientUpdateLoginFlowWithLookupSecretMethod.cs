...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateLoginFlowWithLookupSecretMethod : IEquatable<ClientUpdateLoginFlowWithLookupSecretMethod>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientUpdateLoginFlowWithLookupSecretMethod);
        }

        /// <summary>
        /// Returns true if ClientUpdateLoginFlowWithLookupSecretMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateLoginFlowWithLookupSecretMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateLoginFlowWithLookupSecretMethod input)
        {
            if (input == null)
            {
                return false;
