...
{
    /// <summary>
    /// ClientCreateRecoveryLink
    /// </summary>
    [DataContract(Name = "CreateRecoveryLink")]
    public partial class ClientCreateRecoveryLink : IEquatable<ClientCreateRecoveryLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCreateRecoveryLink" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientCreateRecoveryLink()
        {
        ...
        public ClientCreateRecoveryLink(string expiresIn = default(string), string identityId = default(string))
        {
            // to ensure "identityId" is required (not null)
            this.IdentityId = identityId ?? throw new ArgumentNullException("identityId is a required property for ClientCreateRecoveryLink and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientCreateRecoveryLink {\n");
        ...
        {
            return this.Equals(input as ClientCreateRecoveryLink);
        }

        /// <summary>
        /// Returns true if ClientCreateRecoveryLink instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCreateRecoveryLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCreateRecoveryLink input)
        {
            if (input == null)
                return false;
