...
namespace Ory.Client.Model
{
    ...
    public partial class ClientMessage : IEquatable<ClientMessage>, IValidatableObject
    {
        ...
        public ClientMessage(string body = default(string), DateTime createdAt = default(DateTime), string id = default(string), string recipient = default(string), long sendCount = default(long), ClientCourierMessageStatus status = default(ClientCourierMessageStatus), string subject = default(string), string templateType = default(string), ClientCourierMessageType type = default(ClientCourierMessageType), DateTime updatedAt = default(DateTime))
        {
            this.Body = body;
