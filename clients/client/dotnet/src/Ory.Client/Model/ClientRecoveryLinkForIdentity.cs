...
namespace Ory.Client.Model
{
    ...
    public partial class ClientRecoveryLinkForIdentity : IEquatable<ClientRecoveryLinkForIdentity>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientRecoveryLinkForIdentity);
        }

        /// <summary>
        /// Returns true if ClientRecoveryLinkForIdentity instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientRecoveryLinkForIdentity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientRecoveryLinkForIdentity input)
        {
            if (input == null)
            {
                return false;
