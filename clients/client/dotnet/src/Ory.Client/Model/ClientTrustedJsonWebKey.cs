...
{
    /// <summary>
    /// ClientTrustedJsonWebKey
    /// </summary>
    [DataContract(Name = "trustedJsonWebKey")]
    public partial class ClientTrustedJsonWebKey : IEquatable<ClientTrustedJsonWebKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientTrustedJsonWebKey" /> class.
        /// </summary>
        ...
        public ClientTrustedJsonWebKey(string kid = default(string), string set = default(string))
        {
            this.Kid = kid;
            this.Set = set;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientTrustedJsonWebKey {\n");
        ...
        {
            return this.Equals(input as ClientTrustedJsonWebKey);
        }

        /// <summary>
        /// Returns true if ClientTrustedJsonWebKey instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientTrustedJsonWebKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientTrustedJsonWebKey input)
        {
            if (input == null)
            {
                return false;
