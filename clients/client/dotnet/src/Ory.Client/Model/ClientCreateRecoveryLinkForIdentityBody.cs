...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCreateRecoveryLinkForIdentityBody : IEquatable<ClientCreateRecoveryLinkForIdentityBody>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientCreateRecoveryLinkForIdentityBody);
        }

        /// <summary>
        /// Returns true if ClientCreateRecoveryLinkForIdentityBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCreateRecoveryLinkForIdentityBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCreateRecoveryLinkForIdentityBody input)
        {
            if (input == null)
            {
                return false;
