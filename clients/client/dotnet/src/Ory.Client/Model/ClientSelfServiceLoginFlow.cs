...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSelfServiceLoginFlow : IEquatable<ClientSelfServiceLoginFlow>, IValidatableObject
    {
        ...
        /// <param name="forced">Refresh stores whether this login flow should enforce re-authentication..</param>
        ...
        public ClientSelfServiceLoginFlow(ClientIdentityCredentialsType active = default(ClientIdentityCredentialsType), DateTime createdAt = default(DateTime), DateTime expiresAt = default(DateTime), bool forced = default(bool), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), ClientAuthenticatorAssuranceLevel requestedAal = default(ClientAuthenticatorAssuranceLevel), string type = default(string), ClientUiContainer ui = default(ClientUiContainer), DateTime updatedAt = default(DateTime))
        {
