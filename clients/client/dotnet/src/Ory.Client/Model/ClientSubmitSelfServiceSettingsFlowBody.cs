...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceSettingsFlowBody : AbstractOpenAPISchema, IEquatable<ClientSubmitSelfServiceSettingsFlowBody>, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(ClientSubmitSelfServiceSettingsFlowWithPasswordMethodBody))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: ClientSubmitSelfServiceSettingsFlowWithPasswordMethodBody, ClientSubmitSelfServiceSettingsFlowWithProfileMethodBody");
                }
            }
        }
