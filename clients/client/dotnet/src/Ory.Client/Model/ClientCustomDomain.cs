...
namespace Ory.Client.Model
{
    ...
    public partial class ClientCustomDomain : IEquatable<ClientCustomDomain>, IValidatableObject
    {
        ...
        public ClientCustomDomain(string cookieDomain = default(string), List<string> corsAllowedOrigins = default(List<string>), bool corsEnabled = default(bool), DateTime createdAt = default(DateTime), string hostname = default(string), string id = default(string), DateTime updatedAt = default(DateTime), List<string> verificationErrors = default(List<string>), string verificationStatus = default(string))
        {
