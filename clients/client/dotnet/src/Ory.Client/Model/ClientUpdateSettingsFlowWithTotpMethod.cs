...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateSettingsFlowWithTotpMethod : IEquatable<ClientUpdateSettingsFlowWithTotpMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientUpdateSettingsFlowWithTotpMethod(string csrfToken = default(string), string method = default(string), string totpCode = default(string), bool totpUnlink = default(bool))
        {
        ...
        {
            return this.Equals(input as ClientUpdateSettingsFlowWithTotpMethod);
        }

        /// <summary>
        /// Returns true if ClientUpdateSettingsFlowWithTotpMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateSettingsFlowWithTotpMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateSettingsFlowWithTotpMethod input)
        {
            if (input == null)
            {
                return false;
