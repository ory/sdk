...
namespace Ory.Client.Model
{
    ...
    public partial class ClientSubmitSelfServiceSettingsFlowWithOidcMethodBody : IEquatable<ClientSubmitSelfServiceSettingsFlowWithOidcMethodBody>, IValidatableObject
    {
        ...
        public ClientSubmitSelfServiceSettingsFlowWithOidcMethodBody(string flow = default(string), string link = default(string), string method = default(string), string unlink = default(string))
        {
            // to ensure "method" is required (not null)
            this.Method = method ?? throw new ArgumentNullException("method is a required property for ClientSubmitSelfServiceSettingsFlowWithOidcMethodBody and cannot be null");
            this.Flow = flow;
            this.Link = link;
            this.Unlink = unlink;
            this.AdditionalProperties = new Dictionary<string, object>();
