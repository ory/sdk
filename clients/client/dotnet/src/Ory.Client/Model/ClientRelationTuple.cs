...
namespace Ory.Client.Model
{
    ...
    public partial class ClientRelationTuple : IEquatable<ClientRelationTuple>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientRelationTuple" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientRelationTuple()
        {
        ...
        public ClientRelationTuple(string _namespace = default(string), string _object = default(string), string relation = default(string), string subjectId = default(string), ClientSubjectSet subjectSet = default(ClientSubjectSet))
        {
            // to ensure "_namespace" is required (not null)
            if (_namespace == null) {
                throw new ArgumentNullException("_namespace is a required property for ClientRelationTuple and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "_object" is required (not null)
            if (_object == null) {
                throw new ArgumentNullException("_object is a required property for ClientRelationTuple and cannot be null");
            }
            this.Object = _object;
            // to ensure "relation" is required (not null)
            if (relation == null) {
                throw new ArgumentNullException("relation is a required property for ClientRelationTuple and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientRelationTuple {\n");
        ...
        {
            return this.Equals(input as ClientRelationTuple);
        }

        /// <summary>
        /// Returns true if ClientRelationTuple instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientRelationTuple to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientRelationTuple input)
        {
            if (input == null)
            {
                return false;
