...
namespace Ory.Client.Model
{
    ...
    public partial class ClientUpdateRecoveryFlowWithLinkMethod : IEquatable<ClientUpdateRecoveryFlowWithLinkMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientUpdateRecoveryFlowWithLinkMethod(string csrfToken = default(string), string email = default(string), string method = default(string))
        {
            ...
            if (method == null) {
                throw new ArgumentNullException("method is a required property for ClientUpdateRecoveryFlowWithLinkMethod and cannot be null");
            }
            this.Method = method;
        ...
        {
            return this.Equals(input as ClientUpdateRecoveryFlowWithLinkMethod);
        }

        /// <summary>
        /// Returns true if ClientUpdateRecoveryFlowWithLinkMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientUpdateRecoveryFlowWithLinkMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientUpdateRecoveryFlowWithLinkMethod input)
        {
            if (input == null)
            {
                return false;
