...
namespace Ory.Client.Api
{
    ...
    public interface IV0alpha0ApiSync : IApiAccessor
    {
        ...
        ClientProject CreateProject(ClientProjectPatch clientProjectPatch = default(ClientProjectPatch));
        ...
        ApiResponse<ClientProject> CreateProjectWithHttpInfo(ClientProjectPatch clientProjectPatch = default(ClientProjectPatch));
        /// <summary>
        /// Get a Project
        /// </summary>
        /// <remarks>
        ...
        /// <param name="clientProjectPatch"> (optional)</param>
        /// <returns>ClientProject</returns>
        ClientProject UpdateProject(string projectId, ClientProjectPatch clientProjectPatch = default(ClientProjectPatch));
        ...
        /// <param name="clientProjectPatch"> (optional)</param>
        /// <returns>ApiResponse of ClientProject</returns>
        ApiResponse<ClientProject> UpdateProjectWithHttpInfo(string projectId, ClientProjectPatch clientProjectPatch = default(ClientProjectPatch));
    ...
    public interface IV0alpha0ApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ClientProject> CreateProjectAsync(ClientProjectPatch clientProjectPatch = default(ClientProjectPatch), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ClientProject>> CreateProjectWithHttpInfoAsync(ClientProjectPatch clientProjectPatch = default(ClientProjectPatch), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get a Project
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ClientProject</returns>
        System.Threading.Tasks.Task<ClientProject> UpdateProjectAsync(string projectId, ClientProjectPatch clientProjectPatch = default(ClientProjectPatch), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ClientProject)</returns>
        System.Threading.Tasks.Task<ApiResponse<ClientProject>> UpdateProjectWithHttpInfoAsync(string projectId, ClientProjectPatch clientProjectPatch = default(ClientProjectPatch), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class V0alpha0Api : IV0alpha0Api
    {
        ...
        /// <param name="clientProjectPatch"> (optional)</param>
        /// <returns>ApiResponse of ClientProject</returns>
        public Ory.Client.Client.ApiResponse<ClientProject> CreateProjectWithHttpInfo(ClientProjectPatch clientProjectPatch = default(ClientProjectPatch))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ClientProject</returns>
        public async System.Threading.Tasks.Task<ClientProject> CreateProjectAsync(ClientProjectPatch clientProjectPatch = default(ClientProjectPatch), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Ory.Client.Client.ApiResponse<ClientProject> localVarResponse = await CreateProjectWithHttpInfoAsync(clientProjectPatch, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="clientProjectPatch"> (optional)</param>
        /// <returns>ApiResponse of ClientProject</returns>
        public Ory.Client.Client.ApiResponse<ClientProject> UpdateProjectWithHttpInfo(string projectId, ClientProjectPatch clientProjectPatch = default(ClientProjectPatch))
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
