...
namespace Ory.Client.Api
{
    ...
    public interface IIdentityApiSync : IApiAccessor
    {
        ...
        /// <param name="identifier">Identifier  This query parameter can be used to lookup an identity using its identifier. For example - an email address (optional)</param>
        /// <returns>List&lt;ClientIdentity&gt;</returns>
        List<ClientIdentity> ListIdentities(long? perPage = default(long?), long? page = default(long?), string identifier = default(string));
        ...
        ApiResponse<List<ClientIdentity>> ListIdentitiesWithHttpInfo(long? perPage = default(long?), long? page = default(long?), string identifier = default(string));
        /// <summary>
    ...
    public interface IIdentityApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<ClientIdentity>> ListIdentitiesAsync(long? perPage = default(long?), long? page = default(long?), string identifier = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<ClientIdentity>>> ListIdentitiesWithHttpInfoAsync(long? perPage = default(long?), long? page = default(long?), string identifier = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get all Identity Schemas
        /// </summary>
        /// <remarks>
    ...
    public partial class IdentityApi : IIdentityApi
    {
        ...
        /// <param name="identifier">Identifier  This query parameter can be used to lookup an identity using its identifier. For example - an email address (optional)</param>
        /// <returns>List&lt;ClientIdentity&gt;</returns>
        public List<ClientIdentity> ListIdentities(long? perPage = default(long?), long? page = default(long?), string identifier = default(string))
        {
            Ory.Client.Client.ApiResponse<List<ClientIdentity>> localVarResponse = ListIdentitiesWithHttpInfo(perPage, page, identifier);
            return localVarResponse.Data;
        }
        ...
        /// <param name="identifier">Identifier  This query parameter can be used to lookup an identity using its identifier. For example - an email address (optional)</param>
        /// <returns>ApiResponse of List&lt;ClientIdentity&gt;</returns>
        public Ory.Client.Client.ApiResponse<List<ClientIdentity>> ListIdentitiesWithHttpInfo(long? perPage = default(long?), long? page = default(long?), string identifier = default(string))
        {
            Ory.Client.Client.RequestOptions localVarRequestOptions = new Ory.Client.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ClientIdentity&gt;</returns>
        public async System.Threading.Tasks.Task<List<ClientIdentity>> ListIdentitiesAsync(long? perPage = default(long?), long? page = default(long?), string identifier = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Ory.Client.Client.ApiResponse<List<ClientIdentity>> localVarResponse = await ListIdentitiesWithHttpInfoAsync(perPage, page, identifier, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ClientIdentity&gt;)</returns>
        public async System.Threading.Tasks.Task<Ory.Client.Client.ApiResponse<List<ClientIdentity>>> ListIdentitiesWithHttpInfoAsync(long? perPage = default(long?), long? page = default(long?), string identifier = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
