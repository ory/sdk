...
namespace Ory.Client.Api
{
    ...
    public partial class IdentityApi : IIdentityApi
    {
        ...
        {
            Ory.Client.Client.ApiResponse<List<ClientIdentity>> localVarResponse = await ListIdentitiesWithHttpInfoAsync(perPage, page, pageSize, pageToken, consistency, ids, credentialsIdentifier, previewCredentialsIdentifierSimilar, includeCredential, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
