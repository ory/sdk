...
namespace Ory.Client.Api
{
    ...
    public interface IIdentityApiSync : IApiAccessor
    {
        ...
        List<ClientIdentity> ListIdentities(long? perPage = default(long?), long? page = default(long?), long? pageSize = default(long?), string pageToken = default(string), string consistency = default(string), string credentialsIdentifier = default(string), string previewCredentialsIdentifierSimilar = default(string));
        ...
        ApiResponse<List<ClientIdentity>> ListIdentitiesWithHttpInfo(long? perPage = default(long?), long? page = default(long?), long? pageSize = default(long?), string pageToken = default(string), string consistency = default(string), string credentialsIdentifier = default(string), string previewCredentialsIdentifierSimilar = default(string));
        /// <summary>
    ...
    public interface IIdentityApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<ClientIdentity>> ListIdentitiesAsync(long? perPage = default(long?), long? page = default(long?), long? pageSize = default(long?), string pageToken = default(string), string consistency = default(string), string credentialsIdentifier = default(string), string previewCredentialsIdentifierSimilar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<ClientIdentity>>> ListIdentitiesWithHttpInfoAsync(long? perPage = default(long?), long? page = default(long?), long? pageSize = default(long?), string pageToken = default(string), string consistency = default(string), string credentialsIdentifier = default(string), string previewCredentialsIdentifierSimilar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get all Identity Schemas
        /// </summary>
        /// <remarks>
    ...
    public partial class IdentityApi : IIdentityApi
    {
        ...
        /// <param name="previewCredentialsIdentifierSimilar">This is an EXPERIMENTAL parameter that WILL CHANGE. Do NOT rely on consistent, deterministic behavior. THIS PARAMETER WILL BE REMOVED IN AN UPCOMING RELEASE WITHOUT ANY MIGRATION PATH.  CredentialsIdentifierSimilar is the (partial) identifier (username, email) of the credentials to look up using similarity search. Only one of CredentialsIdentifier and CredentialsIdentifierSimilar can be used. (optional)</param>
        /// <returns>List&lt;ClientIdentity&gt;</returns>
        public List<ClientIdentity> ListIdentities(long? perPage = default(long?), long? page = default(long?), long? pageSize = default(long?), string pageToken = default(string), string consistency = default(string), string credentialsIdentifier = default(string), string previewCredentialsIdentifierSimilar = default(string))
        {
            Ory.Client.Client.ApiResponse<List<ClientIdentity>> localVarResponse = ListIdentitiesWithHttpInfo(perPage, page, pageSize, pageToken, consistency, credentialsIdentifier, previewCredentialsIdentifierSimilar);
            return localVarResponse.Data;
        }
        ...
        /// <param name="previewCredentialsIdentifierSimilar">This is an EXPERIMENTAL parameter that WILL CHANGE. Do NOT rely on consistent, deterministic behavior. THIS PARAMETER WILL BE REMOVED IN AN UPCOMING RELEASE WITHOUT ANY MIGRATION PATH.  CredentialsIdentifierSimilar is the (partial) identifier (username, email) of the credentials to look up using similarity search. Only one of CredentialsIdentifier and CredentialsIdentifierSimilar can be used. (optional)</param>
        /// <returns>ApiResponse of List&lt;ClientIdentity&gt;</returns>
        public Ory.Client.Client.ApiResponse<List<ClientIdentity>> ListIdentitiesWithHttpInfo(long? perPage = default(long?), long? page = default(long?), long? pageSize = default(long?), string pageToken = default(string), string consistency = default(string), string credentialsIdentifier = default(string), string previewCredentialsIdentifierSimilar = default(string))
        {
            Ory.Client.Client.RequestOptions localVarRequestOptions = new Ory.Client.Client.RequestOptions();
        ...
        {
            Ory.Client.Client.ApiResponse<List<ClientIdentity>> localVarResponse = await ListIdentitiesWithHttpInfoAsync(perPage, page, pageSize, pageToken, consistency, credentialsIdentifier, previewCredentialsIdentifierSimilar, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ClientIdentity&gt;)</returns>
        public async System.Threading.Tasks.Task<Ory.Client.Client.ApiResponse<List<ClientIdentity>>> ListIdentitiesWithHttpInfoAsync(long? perPage = default(long?), long? page = default(long?), long? pageSize = default(long?), string pageToken = default(string), string consistency = default(string), string credentialsIdentifier = default(string), string previewCredentialsIdentifierSimilar = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
