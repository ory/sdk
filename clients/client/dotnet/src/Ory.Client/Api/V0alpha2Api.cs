...
namespace Ory.Client.Api
{
    ...
    public partial class V0alpha2Api : IV0alpha2Api
    {
        ...
        public Ory.Client.Client.ApiResponse<ClientProjectApiKey> CreateProjectApiKeyWithHttpInfo(string project, ClientInlineObject3 clientInlineObject3 = default(ClientInlineObject3))
        {
            ...
            if (project == null)
            {
                throw new Ory.Client.Client.ApiException(400, "Missing required parameter 'project' when calling V0alpha2Api->CreateProjectApiKey");
            }
        ...
        public Ory.Client.Client.ApiResponse<Object> DeleteProjectApiKeyWithHttpInfo(string project, string tokenId)
        {
            ...
            if (project == null)
            {
                throw new Ory.Client.Client.ApiException(400, "Missing required parameter 'project' when calling V0alpha2Api->DeleteProjectApiKey");
            }

            // verify the required parameter 'tokenId' is set
            if (tokenId == null)
            {
                throw new Ory.Client.Client.ApiException(400, "Missing required parameter 'tokenId' when calling V0alpha2Api->DeleteProjectApiKey");
            }
        ...
        public Ory.Client.Client.ApiResponse<List<ClientProjectApiKey>> ListProjectApiKeysWithHttpInfo(string project)
        {
            ...
            if (project == null)
            {
                throw new Ory.Client.Client.ApiException(400, "Missing required parameter 'project' when calling V0alpha2Api->ListProjectApiKeys");
            }
