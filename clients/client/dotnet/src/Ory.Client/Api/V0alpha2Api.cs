...
namespace Ory.Client.Api
{
    ...
    public interface IV0alpha2ApiSync : IApiAccessor
    {
        ...
        /// <returns>ClientIdentitySchema</returns>
        ...
        /// <exception cref="Ory.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">ID must be set to the ID of schema you want to get</param>
        /// <returns>ApiResponse of ClientIdentitySchema</returns>
        ApiResponse<ClientIdentitySchema> GetIdentitySchemaWithHttpInfo(string id);
        /// <summary>
        /// Get a Project
        /// </summary>
        /// <remarks>
    ...
    public interface IV0alpha2ApiAsync : IApiAccessor
    {
        ...
        /// <param name="id">ID must be set to the ID of schema you want to get</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ClientIdentitySchema</returns>
        System.Threading.Tasks.Task<ClientIdentitySchema> GetIdentitySchemaAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="id">ID must be set to the ID of schema you want to get</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ClientIdentitySchema)</returns>
        System.Threading.Tasks.Task<ApiResponse<ClientIdentitySchema>> GetIdentitySchemaWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get a Project
        /// </summary>
        /// <remarks>
    ...
    public partial class V0alpha2Api : IV0alpha2Api
    {
        ...
        /// <param name="id">ID must be set to the ID of schema you want to get</param>
        /// <returns>ClientIdentitySchema</returns>
        public ClientIdentitySchema GetIdentitySchema(string id)
        {
            Ory.Client.Client.ApiResponse<ClientIdentitySchema> localVarResponse = GetIdentitySchemaWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">ID must be set to the ID of schema you want to get</param>
        /// <returns>ApiResponse of ClientIdentitySchema</returns>
        public Ory.Client.Client.ApiResponse<ClientIdentitySchema> GetIdentitySchemaWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ClientIdentitySchema>("/schemas/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ClientIdentitySchema</returns>
        public async System.Threading.Tasks.Task<ClientIdentitySchema> GetIdentitySchemaAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Ory.Client.Client.ApiResponse<ClientIdentitySchema> localVarResponse = await GetIdentitySchemaWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ClientIdentitySchema)</returns>
        public async System.Threading.Tasks.Task<Ory.Client.Client.ApiResponse<ClientIdentitySchema>> GetIdentitySchemaWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ClientIdentitySchema>("/schemas/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
