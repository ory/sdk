...
namespace Ory.Client.Api
{
    ...
    public partial class MetadataApi : IMetadataApi
    {
        ...
        public Ory.Client.Client.ApiResponse<ClientInlineResponse2001> GetVersionWithHttpInfo()
        {
            ...
            var localVarResponse = this.Client.Get<ClientInlineResponse2001>("/api/kratos/public/version", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Ory.Client.Client.ApiResponse<ClientInlineResponse2001>> GetVersionWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ClientInlineResponse2001>("/api/kratos/public/version", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Ory.Client.Client.ApiResponse<ClientInlineResponse200> IsAliveWithHttpInfo()
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ClientInlineResponse200>("/api/kratos/public/health/alive", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Ory.Client.Client.ApiResponse<ClientInlineResponse200>> IsAliveWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ClientInlineResponse200>("/api/kratos/public/health/alive", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Ory.Client.Client.ApiResponse<ClientInlineResponse200> IsReadyWithHttpInfo()
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ClientInlineResponse200>("/api/kratos/public/health/ready", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<Ory.Client.Client.ApiResponse<ClientInlineResponse200>> IsReadyWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ClientInlineResponse200>("/api/kratos/public/health/ready", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="Ory.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object(void)</returns>
        public Ory.Client.Client.ApiResponse<Object> PrometheusWithHttpInfo()
        {
            Ory.Client.Client.RequestOptions localVarRequestOptions = new Ory.Client.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/api/kratos/public/metrics/prometheus", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Ory.Client.Client.ApiResponse<Object>> PrometheusWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/api/kratos/public/metrics/prometheus", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
