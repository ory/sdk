...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientVolume : IEquatable<ClientVolume>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientVolume" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientVolume()
        {
        ...
        public ClientVolume(string createdAt = default(string), string driver = default(string), Dictionary<string, string> labels = default(Dictionary<string, string>), string mountpoint = default(string), string name = default(string), Dictionary<string, string> options = default(Dictionary<string, string>), string scope = default(string), Dictionary<string, Object> status = default(Dictionary<string, Object>), ClientVolumeUsageData usageData = default(ClientVolumeUsageData))
        {
            // to ensure "driver" is required (not null)
            this.Driver = driver ?? throw new ArgumentNullException("driver is a required property for ClientVolume and cannot be null");
            // to ensure "labels" is required (not null)
            this.Labels = labels ?? throw new ArgumentNullException("labels is a required property for ClientVolume and cannot be null");
            // to ensure "mountpoint" is required (not null)
            this.Mountpoint = mountpoint ?? throw new ArgumentNullException("mountpoint is a required property for ClientVolume and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ClientVolume and cannot be null");
            // to ensure "options" is required (not null)
            this.Options = options ?? throw new ArgumentNullException("options is a required property for ClientVolume and cannot be null");
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for ClientVolume and cannot be null");
        ...
        public ClientVolumeUsageData UsageData { get; set; }
        ...
        {
            return this.Equals(input as ClientVolume);
        }

        /// <summary>
        /// Returns true if ClientVolume instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientVolume input)
        {
            if (input == null)
                return false;
