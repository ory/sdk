...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientErrorResponse : IEquatable<ClientErrorResponse>, IValidatableObject
    {
        ...
        public ClientErrorResponse(string message = default(string))
        {
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for ClientErrorResponse and cannot be null");
            this.AdditionalProperties = new Dictionary<string, object>();
        }
