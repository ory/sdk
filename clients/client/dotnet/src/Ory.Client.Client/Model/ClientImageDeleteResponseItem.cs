...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientImageDeleteResponseItem : IEquatable<ClientImageDeleteResponseItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientImageDeleteResponseItem" /> class.
        /// </summary>
        ...
        public ClientImageDeleteResponseItem(string deleted = default(string), string untagged = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientImageDeleteResponseItem {\n");
        ...
        {
            return this.Equals(input as ClientImageDeleteResponseItem);
        }

        /// <summary>
        /// Returns true if ClientImageDeleteResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientImageDeleteResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientImageDeleteResponseItem input)
        {
            if (input == null)
                return false;
