...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientUiNodeAnchorAttributes : IEquatable<ClientUiNodeAnchorAttributes>, IValidatableObject
    {
        ...
        public ClientUiNodeAnchorAttributes(string href = default(string), ClientUiText title = default(ClientUiText))
        {
            // to ensure "href" is required (not null)
            this.Href = href ?? throw new ArgumentNullException("href is a required property for ClientUiNodeAnchorAttributes and cannot be null");
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for ClientUiNodeAnchorAttributes and cannot be null");
            this.AdditionalProperties = new Dictionary<string, object>();
        }
