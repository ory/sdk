...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientRegistrationViaApiResponse : IEquatable<ClientRegistrationViaApiResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientRegistrationViaApiResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientRegistrationViaApiResponse()
        {
        ...
        public ClientRegistrationViaApiResponse(ClientIdentity identity = default(ClientIdentity), ClientSession session = default(ClientSession), string sessionToken = default(string))
        {
            // to ensure "identity" is required (not null)
            this.Identity = identity ?? throw new ArgumentNullException("identity is a required property for ClientRegistrationViaApiResponse and cannot be null");
            // to ensure "sessionToken" is required (not null)
            this.SessionToken = sessionToken ?? throw new ArgumentNullException("sessionToken is a required property for ClientRegistrationViaApiResponse and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientRegistrationViaApiResponse {\n");
        ...
        {
            return this.Equals(input as ClientRegistrationViaApiResponse);
        }

        /// <summary>
        /// Returns true if ClientRegistrationViaApiResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientRegistrationViaApiResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientRegistrationViaApiResponse input)
        {
            if (input == null)
                return false;
