...
namespace Ory.Client.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "loginViaApiResponse")]
    public partial class ClientLoginViaApiResponse : IEquatable<ClientLoginViaApiResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientLoginViaApiResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientLoginViaApiResponse()
        {
        ...
        public ClientLoginViaApiResponse(ClientSession session = default(ClientSession), string sessionToken = default(string))
        {
            // to ensure "session" is required (not null)
            this.Session = session ?? throw new ArgumentNullException("session is a required property for ClientLoginViaApiResponse and cannot be null");
            // to ensure "sessionToken" is required (not null)
            this.SessionToken = sessionToken ?? throw new ArgumentNullException("sessionToken is a required property for ClientLoginViaApiResponse and cannot be null");
            this.AdditionalProperties = new Dictionary<string, object>();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientLoginViaApiResponse {\n");
        ...
        {
            return this.Equals(input as ClientLoginViaApiResponse);
        }

        /// <summary>
        /// Returns true if ClientLoginViaApiResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientLoginViaApiResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientLoginViaApiResponse input)
        {
            if (input == null)
                return false;
