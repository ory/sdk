...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientIdentity : IEquatable<ClientIdentity>, IValidatableObject
    {
        ...
        public ClientIdentity(string id = default(string), List<ClientRecoveryAddress> recoveryAddresses = default(List<ClientRecoveryAddress>), string schemaId = default(string), string schemaUrl = default(string), Object traits = default(Object), List<ClientVerifiableIdentityAddress> verifiableAddresses = default(List<ClientVerifiableIdentityAddress>))
        {
