...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientCreateIdentity : IEquatable<ClientCreateIdentity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientCreateIdentity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientCreateIdentity()
        {
        ...
        public ClientCreateIdentity(string schemaId = default(string), Object traits = default(Object))
        {
            // to ensure "schemaId" is required (not null)
            this.SchemaId = schemaId ?? throw new ArgumentNullException("schemaId is a required property for ClientCreateIdentity and cannot be null");
            // to ensure "traits" is required (not null)
            this.Traits = traits ?? throw new ArgumentNullException("traits is a required property for ClientCreateIdentity and cannot be null");
            this.AdditionalProperties = new Dictionary<string, object>();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientCreateIdentity {\n");
        ...
        {
            return this.Equals(input as ClientCreateIdentity);
        }

        /// <summary>
        /// Returns true if ClientCreateIdentity instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientCreateIdentity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientCreateIdentity input)
        {
            if (input == null)
                return false;
