...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientSettingsFlow : IEquatable<ClientSettingsFlow>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ClientSettingsFlow);
        }

        /// <summary>
        /// Returns true if ClientSettingsFlow instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSettingsFlow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSettingsFlow input)
        {
            if (input == null)
                return false;
