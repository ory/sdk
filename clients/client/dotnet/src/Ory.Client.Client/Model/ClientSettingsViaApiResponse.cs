...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientSettingsViaApiResponse : IEquatable<ClientSettingsViaApiResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientSettingsViaApiResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientSettingsViaApiResponse()
        {
        ...
        public ClientSettingsFlow Flow { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ClientSettingsViaApiResponse {\n");
        ...
        {
            return this.Equals(input as ClientSettingsViaApiResponse);
        }

        /// <summary>
        /// Returns true if ClientSettingsViaApiResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientSettingsViaApiResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientSettingsViaApiResponse input)
        {
            if (input == null)
                return false;
