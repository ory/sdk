...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientRecoveryAddress : IEquatable<ClientRecoveryAddress>, IValidatableObject
    {
        ...
        public ClientRecoveryAddress(string id = default(string), string value = default(string), string via = default(string))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ClientRecoveryAddress and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ClientRecoveryAddress and cannot be null");
            // to ensure "via" is required (not null)
            this.Via = via ?? throw new ArgumentNullException("via is a required property for ClientRecoveryAddress and cannot be null");
            this.AdditionalProperties = new Dictionary<string, object>();
        }
