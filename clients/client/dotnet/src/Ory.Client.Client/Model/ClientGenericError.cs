...
namespace Ory.Client.Client.Model
{
    ...
    public partial class ClientGenericError : IEquatable<ClientGenericError>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientGenericError(long code = default(long), string debug = default(string), Dictionary<string, Object> details = default(Dictionary<string, Object>), string message = default(string), string reason = default(string), string request = default(string), string status = default(string))
        {
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for ClientGenericError and cannot be null");
            this.Code = code;
            this.Debug = debug;
        ...
        {
            return this.Equals(input as ClientGenericError);
        }

        /// <summary>
        /// Returns true if ClientGenericError instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientGenericError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientGenericError input)
        {
            if (input == null)
                return false;
