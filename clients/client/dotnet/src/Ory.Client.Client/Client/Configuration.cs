...
namespace Ory.Client.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.0.1-alpha.1/csharp";
        ...
        {
            String report = "C# SDK (Ory.Client.Client) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: v0.0.1-alpha.1\n";
            report += "    SDK Package Version: 0.0.1-alpha.1\n";
