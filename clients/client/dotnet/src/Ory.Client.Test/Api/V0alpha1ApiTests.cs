...
namespace Ory.Client.Test.Api
{
    ...
    public class V0alpha1ApiTests : IDisposable
    {
        ...
        public void SubmitSelfServiceLoginFlowTest()
        {
            ...
            //var response = instance.SubmitSelfServiceLoginFlow(flow, clientSubmitSelfServiceLoginFlowBody);
        ...
        public void SubmitSelfServiceSettingsFlowTest()
        {
            ...
            //Assert.IsType<ClientSuccessfulSelfServiceSettingsWithoutBrowser>(response);
        }
