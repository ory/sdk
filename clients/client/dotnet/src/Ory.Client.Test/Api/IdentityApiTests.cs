...
namespace Ory.Client.Test.Api
{
    ...
    public sealed class IdentityApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test CreateTestLoginFlow
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateTestLoginFlowAsyncTest()
        {
            ClientCreateTestLoginFlowBody clientCreateTestLoginFlowBody = default!;
            var response = await _instance.CreateTestLoginFlowAsync(clientCreateTestLoginFlowBody);
            var model = response.Created();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ManageSessionsAsyncTest()
        {
            ClientManageSessionsBody clientManageSessionsBody = default!;
            var response = await _instance.ManageSessionsAsync(clientManageSessionsBody);
            var model = response.Ok();
            Assert.IsType<ClientManageSessionsResponse>(model);
        }
