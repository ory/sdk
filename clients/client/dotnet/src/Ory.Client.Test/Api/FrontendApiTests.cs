...
namespace Ory.Client.Test.Api
{
    ...
    public class FrontendApiTests : IDisposable
    {
        ...
        public void CreateFedcmFlowTest()
        {
            ...
            //Assert.IsType<ClientCreateFedcmFlowResponse>(response);
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //ClientUpdateFedcmFlowBody clientUpdateFedcmFlowBody = null;
            //var response = instance.UpdateFedcmFlow(clientUpdateFedcmFlowBody);
            //Assert.IsType<ClientSuccessfulNativeLogin>(response);
        }
