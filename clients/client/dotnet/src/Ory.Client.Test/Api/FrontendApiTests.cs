...
namespace Ory.Client.Test.Api
{
    ...
    public class FrontendApiTests : IDisposable
    {
        ...
        public void CreateBrowserLoginFlowTest()
        {
            ...
            //var response = instance.CreateBrowserLoginFlow(refresh, aal, returnTo, cookie, loginChallenge, organization);
        ...
        public void CreateNativeLoginFlowTest()
        {
            ...
            //string returnTo = null;
            //string via = null;
            //var response = instance.CreateNativeLoginFlow(refresh, aal, xSessionToken, returnSessionTokenExchangeCode, returnTo, via);
            //Assert.IsType<ClientLoginFlow>(response);
        }
