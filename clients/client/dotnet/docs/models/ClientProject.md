...
**Organizations** | [**List&lt;ClientBasicOrganization&gt;**](ClientBasicOrganization.md) | The organizations of the project.  Organizations are used to group users and enforce certain restrictions like usage of SSO. | 
