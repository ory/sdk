...
namespace Example
{
    public class AdminGetIdentityExample
    {
        public static void Main()
        {
            ...
            {
                // Get an Identity
                ClientIdentity result = apiInstance.AdminGetIdentity(id);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> ClientSelfServiceLoginFlow InitializeSelfServiceLoginFlowForBrowsers (bool? refresh = null)
...
namespace Example
{
    public class InitializeSelfServiceLoginFlowForBrowsersExample
    {
        public static void Main()
        {
            ...
            {
                // Initialize Login Flow for Browsers
                ClientSelfServiceLoginFlow result = apiInstance.InitializeSelfServiceLoginFlowForBrowsers(refresh);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> ClientSelfServiceLoginFlow InitializeSelfServiceLoginFlowWithoutBrowser (bool? refresh = null)
...
namespace Example
{
    public class InitializeSelfServiceLoginFlowWithoutBrowserExample
    {
        public static void Main()
        {
            ...
            {
                // Initialize Login Flow for APIs, Services, Apps, ...
                ClientSelfServiceLoginFlow result = apiInstance.InitializeSelfServiceLoginFlowWithoutBrowser(refresh);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
namespace Example
{
    public class InitializeSelfServiceRecoveryFlowForBrowsersExample
    {
        public static void Main()
        {
            ...
            {
                // Initialize Recovery Flow for Browsers
                ClientSelfServiceRecoveryFlow result = apiInstance.InitializeSelfServiceRecoveryFlowForBrowsers();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
namespace Example
{
    public class InitializeSelfServiceRegistrationFlowForBrowsersExample
    {
        public static void Main()
        {
            ...
            {
                // Initialize Registration Flow for Browsers
                ClientSelfServiceRegistrationFlow result = apiInstance.InitializeSelfServiceRegistrationFlowForBrowsers();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> ClientSelfServiceSettingsFlow InitializeSelfServiceSettingsFlowForBrowsers (string cookie = null)
...
namespace Example
{
    public class InitializeSelfServiceSettingsFlowForBrowsersExample
    {
        public static void Main()
        {
            ...
            {
                // Initialize Settings Flow for Browsers
                ClientSelfServiceSettingsFlow result = apiInstance.InitializeSelfServiceSettingsFlowForBrowsers(cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
namespace Example
{
    public class InitializeSelfServiceVerificationFlowForBrowsersExample
    {
        public static void Main()
        {
            ...
            {
                // Initialize Verification Flow for Browser Clients
                ClientSelfServiceVerificationFlow result = apiInstance.InitializeSelfServiceVerificationFlowForBrowsers();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> ClientSuccessfulSelfServiceLoginWithoutBrowser SubmitSelfServiceLoginFlow (string flow, ClientSubmitSelfServiceLoginFlowBody clientSubmitSelfServiceLoginFlowBody = null)
...
namespace Example
{
    public class SubmitSelfServiceLoginFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Submit a Login Flow
                ClientSuccessfulSelfServiceLoginWithoutBrowser result = apiInstance.SubmitSelfServiceLoginFlow(flow, clientSubmitSelfServiceLoginFlowBody);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> ClientSuccessfulSelfServiceSettingsWithoutBrowser SubmitSelfServiceSettingsFlow (string flow, string xSessionToken = null, ClientSubmitSelfServiceSettingsFlowBody clientSubmitSelfServiceSettingsFlowBody = null)
...
namespace Example
{
    public class SubmitSelfServiceSettingsFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Complete Settings Flow
                ClientSuccessfulSelfServiceSettingsWithoutBrowser result = apiInstance.SubmitSelfServiceSettingsFlow(flow, xSessionToken, clientSubmitSelfServiceSettingsFlowBody);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
[**ClientSuccessfulSelfServiceSettingsWithoutBrowser**](ClientSuccessfulSelfServiceSettingsWithoutBrowser.md)
