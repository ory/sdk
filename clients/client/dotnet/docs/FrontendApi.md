...
> ClientRegistrationFlow CreateBrowserRegistrationFlow (string returnTo = null, string loginChallenge = null)
...
namespace Example
{
    public class CreateBrowserRegistrationFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Create Registration Flow for Browsers
                ClientRegistrationFlow result = apiInstance.CreateBrowserRegistrationFlow(returnTo, loginChallenge);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **ListMySessions**
> List&lt;ClientSession&gt; ListMySessions (long? perPage = null, long? page = null, string xSessionToken = null, string cookie = null)
...
namespace Example
{
    public class ListMySessionsExample
    {
        public static void Main()
        {
            ...
            {
                // Get My Active Sessions
                List<ClientSession> result = apiInstance.ListMySessions(perPage, page, xSessionToken, cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
