...
defmodule Ory.Api.V0alpha2 do
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec submit_self_service_login_flow(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Ory.Model.SelfServiceBrowserLocationChangeRequiredError.t} | {:ok, Ory.Model.JsonError.t} | {:ok, Ory.Model.SelfServiceLoginFlow.t} | {:ok, Ory.Model.SuccessfulSelfServiceLoginWithoutBrowser.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec submit_self_service_recovery_flow(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Ory.Model.JsonError.t} | {:ok, Ory.Model.SelfServiceRecoveryFlow.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec submit_self_service_registration_flow(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Ory.Model.SelfServiceBrowserLocationChangeRequiredError.t} | {:ok, Ory.Model.JsonError.t} | {:ok, Ory.Model.SelfServiceRegistrationFlow.t} | {:ok, Ory.Model.SuccessfulSelfServiceRegistrationWithoutBrowser.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec submit_self_service_settings_flow(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Ory.Model.JsonError.t} | {:ok, Ory.Model.SelfServiceBrowserLocationChangeRequiredError.t} | {:ok, Ory.Model.SelfServiceSettingsFlow.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec submit_self_service_verification_flow(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, Ory.Model.JsonError.t} | {:ok, Ory.Model.SelfServiceVerificationFlow.t} | {:error, Tesla.Env.t}
