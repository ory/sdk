...
defmodule Ory.Api.ApiKeys do
  ...
  - `batch_create_imported_api_keys_request` (BatchCreateImportedApiKeysRequest): BatchCreateImportedApiKeysRequest imports multiple external API keys in one request. The maximum batch size is 1000 keys.
  - `opts` (keyword): Optional parameters

  ### Returns

  - `{:ok, Ory.Model.BatchCreateImportedApiKeysResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec admin_batch_create_imported_api_keys(Tesla.Env.client, Ory.Model.BatchCreateImportedApiKeysRequest.t, keyword()) :: {:ok, Ory.Model.BatchCreateImportedApiKeysResponse.t} | {:ok, Ory.Model.Status.t} | {:error, Tesla.Env.t}
  def admin_batch_create_imported_api_keys(connection, batch_create_imported_api_keys_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/v2alpha1/admin/importedApiKeys:batchCreate")
      |> add_param(:body, :body, batch_create_imported_api_keys_request)
      |> Enum.into([])

    connection
    |> Connection.request(request)
    |> evaluate_response([
      {200, Ory.Model.BatchCreateImportedApiKeysResponse},
  ...
  - `connection` (Ory.Connection): Connection to server
  - `key_id` (String.t): SHA-512/256 hash of the imported key (REQUIRED)
  ...
  def admin_revoke_imported_api_key(connection, key_id, admin_revoke_imported_api_key_body, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/v2alpha1/admin/importedApiKeys/#{key_id}:revoke")
      |> add_param(:body, :body, admin_revoke_imported_api_key_body)
      |> Enum.into([])
  ...
  - `connection` (Ory.Connection): Connection to server
  - `key_id` (String.t): UUID of the issued key (REQUIRED)
  ...
  def admin_revoke_issued_api_key(connection, key_id, admin_revoke_issued_api_key_body, _opts \\ []) do
    request =
      ...
      |> add_param(:body, :body, admin_revoke_issued_api_key_body)
      |> Enum.into([])
