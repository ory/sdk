...
defmodule Ory.Api.Admin do
  ...
  - subject (String.t): 
  - opts (KeywordList): [optional] Optional parameters
    - :limit (integer()): The maximum amount of consent sessions to be returned, upper bound is 500 sessions.
    - :offset (integer()): The offset from where to start looking.
  ## Returns
  ...
  def list_subject_consent_sessions(connection, subject, opts \\ []) do
    optional_params = %{
      :limit => :query,
      :offset => :query
    }
