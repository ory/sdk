...
defmodule Ory.Api.V0alpha0 do
  ...
  {:ok, Ory.Model.ActiveProject.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec get_active_project(Tesla.Env.client, keyword()) :: {:ok, Ory.Model.GenericError.t} | {:ok, Ory.Model.ActiveProject.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec list_projects(Tesla.Env.client, keyword()) :: {:ok, Ory.Model.GenericError.t} | {:ok, list(Ory.Model.Project.t)} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec set_active_project(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, Ory.Model.GenericError.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec update_project(Tesla.Env.client, String.t, keyword()) :: {:ok, Ory.Model.Project.t} | {:ok, Ory.Model.GenericError.t} | {:error, Tesla.Env.t}
  ...
  {:ok, Ory.Model.SuccessfulProjectConfigUpdate.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec update_project_config(Tesla.Env.client, String.t, keyword()) :: {:ok, Ory.Model.GenericError.t} | {:ok, Ory.Model.SuccessfulProjectConfigUpdate.t} | {:error, Tesla.Env.t}
  def update_project_config(connection, project_id, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %Ory.Model.SuccessfulProjectConfigUpdate{}},
      { 400, %Ory.Model.GenericError{}},
      { 401, %Ory.Model.GenericError{}},
      { 403, %Ory.Model.GenericError{}},
      { 404, %Ory.Model.GenericError{}},
