...
defmodule Ory.Model.NormalizedProjectRevision do
  ...
  defstruct [
    ...
    :account_experience_hide_ory_branding,
    :account_experience_hide_registration_link,
    ...
    :id,
    :keto_feature_flags_strict_mode,
    :keto_namespace_configuration,
    :keto_namespaces,
    :keto_secrets_pagination,
    :keto_strict_mode_readonly,
    ...
    :kratos_courier_templates_verifiable_address_changed_email_body_html,
    :kratos_courier_templates_verifiable_address_changed_email_body_plaintext,
    :kratos_courier_templates_verifiable_address_changed_email_subject,
    :kratos_courier_templates_verifiable_address_changed_sms_body_plaintext,
    ...
    :kratos_feature_flags_enforce_identity_schema_guards,
    ...
    :kratos_feature_flags_webhook_response_directives,
    ...
    :kratos_selfservice_methods_deviceauthn_config_android_allow_expired_factory_certificates,
    :kratos_selfservice_methods_deviceauthn_config_android_app_ids,
    :kratos_selfservice_methods_deviceauthn_config_first_factor,
    ...
    :kratos_selfservice_methods_deviceauthn_config_ios_biometric_first_factor,
    :kratos_selfservice_methods_deviceauthn_config_pin_max_attempts,
  ...
  @type t :: %__MODULE__{
    :account_experience_contact_url => String.t | nil,
    ...
    :account_experience_hide_ory_branding => boolean() | nil,
    :account_experience_hide_registration_link => boolean() | nil,
    ...
    :account_experience_privacy_policy_url => String.t | nil,
    :account_experience_terms_of_service_url => String.t | nil,
    ...
    :feature_flags => %{optional(String.t) => boolean()} | nil,
    ...
    :hydra_oauth2_device_authorization_token_polling_interval => String.t | nil,
    :hydra_oauth2_device_authorization_user_code_entropy_preset => String.t | nil,
    ...
    :hydra_oauth2_grant_jwt_omit_assertion_audience => boolean() | nil,
    :hydra_oauth2_grant_refresh_token_rotation_grace_period => String.t | nil,
    :hydra_oauth2_grant_refresh_token_rotation_grace_reuse_count => integer() | nil,
    ...
    :hydra_oauth2_preserve_ext_claims => boolean() | nil,
    :hydra_oauth2_refresh_token_hook => String.t | nil,
    :hydra_oauth2_token_hook => String.t | nil,
    :hydra_oauth2_token_prefix => String.t | nil,
    ...
    :hydra_secrets_pagination => [String.t] | nil,
    ...
    :hydra_ttl_device_user_code => String.t | nil,
    ...
    :hydra_urls_device_success => String.t | nil,
    :hydra_urls_device_verification => String.t | nil,
    ...
    :hydra_webfinger_oidc_discovery_device_authorization_url => String.t | nil,
    ...
    :id => String.t | nil,
    :keto_feature_flags_strict_mode => boolean() | nil,
    :keto_namespace_configuration => String.t | nil,
    :keto_namespaces => [Ory.Model.KetoNamespace.t] | nil,
    :keto_secrets_pagination => [String.t] | nil,
    :keto_strict_mode_readonly => boolean() | nil,
    ...
    :kratos_courier_templates_verifiable_address_changed_email_body_html => String.t | nil,
    :kratos_courier_templates_verifiable_address_changed_email_body_plaintext => String.t | nil,
    :kratos_courier_templates_verifiable_address_changed_email_subject => String.t | nil,
    :kratos_courier_templates_verifiable_address_changed_sms_body_plaintext => String.t | nil,
    ...
    :kratos_feature_flags_choose_recovery_address => boolean() | nil,
    :kratos_feature_flags_enforce_identity_schema_guards => boolean() | nil,
    :kratos_feature_flags_faster_session_extend => boolean() | nil,
    :kratos_feature_flags_legacy_continue_with_verification_ui => boolean() | nil,
    :kratos_feature_flags_legacy_oidc_registration_node_group => boolean() | nil,
    :kratos_feature_flags_legacy_require_verified_login_error => boolean() | nil,
    :kratos_feature_flags_password_profile_registration_node_group => boolean() | nil,
    :kratos_feature_flags_refresh_login_choose_address => boolean() | nil,
    :kratos_feature_flags_use_continue_with_transitions => boolean() | nil,
    :kratos_feature_flags_webhook_response_directives => boolean() | nil,
    ...
    :kratos_secrets_pagination => [String.t] | nil,
    :kratos_security_account_enumeration_mitigate => boolean() | nil,
    ...
    :kratos_selfservice_flows_login_style => String.t | nil,
    ...
    :kratos_selfservice_methods_captcha_config_allowed_domains => [String.t] | nil,
    :kratos_selfservice_methods_captcha_config_byo => boolean() | nil,
    :kratos_selfservice_methods_captcha_config_cf_turnstile_byo_secret => String.t | nil,
    :kratos_selfservice_methods_captcha_config_cf_turnstile_byo_sitekey => String.t | nil,
    :kratos_selfservice_methods_captcha_config_cf_turnstile_secret => String.t | nil,
    :kratos_selfservice_methods_captcha_config_cf_turnstile_sitekey => String.t | nil,
    :kratos_selfservice_methods_captcha_config_legacy_inject_node => boolean() | nil,
    :kratos_selfservice_methods_captcha_enabled => boolean() | nil,
    :kratos_selfservice_methods_code_config_lifespan => String.t | nil,
    :kratos_selfservice_methods_code_config_max_submissions => integer() | nil,
    ...
    :kratos_selfservice_methods_deviceauthn_config_android_allow_expired_factory_certificates => boolean() | nil,
    :kratos_selfservice_methods_deviceauthn_config_android_app_ids => [String.t] | nil,
    :kratos_selfservice_methods_deviceauthn_config_first_factor => boolean() | nil,
    :kratos_selfservice_methods_deviceauthn_config_insecure_allow_relaxed_attestation => boolean() | nil,
    :kratos_selfservice_methods_deviceauthn_config_ios_app_ids => [String.t] | nil,
    :kratos_selfservice_methods_deviceauthn_config_ios_biometric_first_factor => boolean() | nil,
    :kratos_selfservice_methods_deviceauthn_config_pin_max_attempts => integer() | nil,
    :kratos_selfservice_methods_deviceauthn_enabled => boolean() | nil,
    ...
    :kratos_selfservice_methods_oidc_enable_auto_link_policy => boolean() | nil,
    ...
    :name => String.t,
    :organizations => [Ory.Model.Organization.t] | nil,
    ...
    :talos_cache_enabled => boolean() | nil,
    :talos_cache_ttl => String.t | nil,
    :talos_credentials_api_keys_default_ttl => String.t | nil,
    :talos_credentials_api_keys_max_ttl => String.t | nil,
    :talos_credentials_api_keys_prefix_current => String.t | nil,
    :talos_credentials_api_keys_prefix_public_current => String.t | nil,
    :talos_credentials_api_keys_prefix_public_retired => [String.t] | nil,
    :talos_credentials_api_keys_prefix_retired => [String.t] | nil,
    :talos_credentials_derived_tokens_default_ttl => String.t | nil,
    :talos_credentials_derived_tokens_jwt_signing_key_id => String.t | nil,
    :talos_credentials_derived_tokens_jwt_signing_keys_urls => [String.t] | nil,
    :talos_credentials_derived_tokens_macaroon_prefix_current => String.t | nil,
