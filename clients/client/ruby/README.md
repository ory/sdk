...
```shell
gem install ./ory-client-v1.1.4.gem
```

(for development, run `gem install --dev ./ory-client-v1.1.4.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ory-client', '~> v1.1.4'
...
*OryClient::FrontendApi* | [**update_recovery_flow**](docs/FrontendApi.md#update_recovery_flow) | **POST** /self-service/recovery | Complete Recovery Flow
...
*OryClient::IdentityApi* | [**get_session**](docs/IdentityApi.md#get_session) | **GET** /admin/sessions/{id} | This endpoint returns the session object with expandables specified.
...
## Documentation for Models
 ...
 - [OryClient::CustomDomainQuota](docs/CustomDomainQuota.md)
 ...
 - [OryClient::InviteQuota](docs/InviteQuota.md)
 ...
 - [OryClient::QuotaBrandingThemes](docs/QuotaBrandingThemes.md)
 ...
 - [OryClient::SessionCachingQuota](docs/SessionCachingQuota.md)
 ...
 - [OryClient::UpdateVerificationFlowWithCodeMethodBody](docs/UpdateVerificationFlowWithCodeMethodBody.md)
