...
```shell
gem install ./ory-client-v1.22.40.gem
```

(for development, run `gem install --dev ./ory-client-v1.22.40.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ory-client', '~> v1.22.40'
...
begin
  ...
  puts "Exception when calling APIKeysApi->admin_batch_import_api_keys: #{e}"
end
...
------------ | ------------- | ------------- | -------------
*OryClient::APIKeysApi* | [**admin_batch_import_api_keys**](docs/APIKeysApi.md#admin_batch_import_api_keys) | **POST** /v2alpha1/admin/importedApiKeys:batchImport | Batch Import API Keys
...
*OryClient::APIKeysApi* | [**admin_get_jwks**](docs/APIKeysApi.md#admin_get_jwks) | **GET** /v2alpha1/admin/derivedKeys/jwks.json | Get JWKS
...
*OryClient::APIKeysApi* | [**admin_revoke_api_key**](docs/APIKeysApi.md#admin_revoke_api_key) | **POST** /v2alpha1/admin/apiKeys/{key_id}:revoke | Revoke API Key
...
## Documentation for Models
 ...
 - [OryClient::AdminRevokeAPIKeyBody](docs/AdminRevokeAPIKeyBody.md)
 ...
 - [OryClient::BatchImportAPIKeysRequest](docs/BatchImportAPIKeysRequest.md)
 - [OryClient::BatchImportAPIKeysResponse](docs/BatchImportAPIKeysResponse.md)
 - [OryClient::BatchImportErrorCode](docs/BatchImportErrorCode.md)
 - [OryClient::BatchImportResult](docs/BatchImportResult.md)
