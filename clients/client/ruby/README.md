...
```shell
gem install ./ory-client-v1.22.79.gem
```

(for development, run `gem install --dev ./ory-client-v1.22.79.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ory-client', '~> v1.22.79'
...
begin
  ...
  puts "Exception when calling ApiKeysApi->admin_batch_create_imported_api_keys: #{e}"
end
...
------------ | ------------- | ------------- | -------------
*OryClient::ApiKeysApi* | [**admin_batch_create_imported_api_keys**](docs/ApiKeysApi.md#admin_batch_create_imported_api_keys) | **POST** /v2alpha1/admin/importedApiKeys:batchCreate | Batch Import API Keys
*OryClient::ApiKeysApi* | [**admin_batch_verify_api_keys**](docs/ApiKeysApi.md#admin_batch_verify_api_keys) | **POST** /v2alpha1/admin/apiKeys:batchVerify | Batch Verify API Keys
*OryClient::ApiKeysApi* | [**admin_delete_imported_api_key**](docs/ApiKeysApi.md#admin_delete_imported_api_key) | **DELETE** /v2alpha1/admin/importedApiKeys/{key_id} | Delete Imported API Key
*OryClient::ApiKeysApi* | [**admin_derive_token**](docs/ApiKeysApi.md#admin_derive_token) | **POST** /v2alpha1/admin/apiKeys:derive | Derive Token
*OryClient::ApiKeysApi* | [**admin_get_imported_api_key**](docs/ApiKeysApi.md#admin_get_imported_api_key) | **GET** /v2alpha1/admin/importedApiKeys/{key_id} | Get Imported API Key
*OryClient::ApiKeysApi* | [**admin_get_issued_api_key**](docs/ApiKeysApi.md#admin_get_issued_api_key) | **GET** /v2alpha1/admin/issuedApiKeys/{key_id} | Get Issued API Key
*OryClient::ApiKeysApi* | [**admin_import_api_key**](docs/ApiKeysApi.md#admin_import_api_key) | **POST** /v2alpha1/admin/importedApiKeys | Import API Key
*OryClient::ApiKeysApi* | [**admin_issue_api_key**](docs/ApiKeysApi.md#admin_issue_api_key) | **POST** /v2alpha1/admin/issuedApiKeys | Issue API Key
*OryClient::ApiKeysApi* | [**admin_list_imported_api_keys**](docs/ApiKeysApi.md#admin_list_imported_api_keys) | **GET** /v2alpha1/admin/importedApiKeys | List Imported API Keys
*OryClient::ApiKeysApi* | [**admin_list_issued_api_keys**](docs/ApiKeysApi.md#admin_list_issued_api_keys) | **GET** /v2alpha1/admin/issuedApiKeys | List Issued API Keys
*OryClient::ApiKeysApi* | [**admin_revoke_imported_api_key**](docs/ApiKeysApi.md#admin_revoke_imported_api_key) | **POST** /v2alpha1/admin/importedApiKeys/{key_id}:revoke | Revoke Imported API Key
*OryClient::ApiKeysApi* | [**admin_revoke_issued_api_key**](docs/ApiKeysApi.md#admin_revoke_issued_api_key) | **POST** /v2alpha1/admin/issuedApiKeys/{key_id}:revoke | Revoke Issued API Key
*OryClient::ApiKeysApi* | [**admin_rotate_issued_api_key**](docs/ApiKeysApi.md#admin_rotate_issued_api_key) | **POST** /v2alpha1/admin/issuedApiKeys/{key_id}:rotate | Rotate Issued API Key
*OryClient::ApiKeysApi* | [**admin_update_imported_api_key**](docs/ApiKeysApi.md#admin_update_imported_api_key) | **PATCH** /v2alpha1/admin/importedApiKeys/{key_id} | Update Imported API Key
*OryClient::ApiKeysApi* | [**admin_update_issued_api_key**](docs/ApiKeysApi.md#admin_update_issued_api_key) | **PATCH** /v2alpha1/admin/issuedApiKeys/{key_id} | Update Issued API Key
*OryClient::ApiKeysApi* | [**admin_verify_api_key**](docs/ApiKeysApi.md#admin_verify_api_key) | **POST** /v2alpha1/admin/apiKeys:verify | Verify API Key
*OryClient::ApiKeysApi* | [**get_jwks**](docs/ApiKeysApi.md#get_jwks) | **GET** /v2alpha1/derivedKeys/jwks.json | Get JWKS
*OryClient::ApiKeysApi* | [**revoke_api_key**](docs/ApiKeysApi.md#revoke_api_key) | **POST** /v2alpha1/apiKeys:selfRevoke | Revoke API Key (self-service)
...
*OryClient::ElementsApi* | [**get_configuration**](docs/ElementsApi.md#get_configuration) | **GET** /elements/configuration | Get Ory Elements configuration
...
*OryClient::FrontendApi* | [**create_fedcm_flow**](docs/FrontendApi.md#create_fedcm_flow) | **GET** /self-service/fed-cm/parameters | Get FedCM Parameters
*OryClient::FrontendApi* | [**create_id_p_initiated_saml_browser_login_flow**](docs/FrontendApi.md#create_id_p_initiated_saml_browser_login_flow) | **GET** /self-service/methods/saml/idp-initiated/{provider} | Complete IdP-Initiated SAML Login for Browsers
...
*OryClient::FrontendApi* | [**get_saml_metadata**](docs/FrontendApi.md#get_saml_metadata) | **GET** /self-service/methods/saml/metadata | Get SAML SP Metadata
*OryClient::FrontendApi* | [**get_saml_provider_metadata**](docs/FrontendApi.md#get_saml_provider_metadata) | **GET** /self-service/methods/saml/metadata/{provider} | Get Per-Connection SAML SP Metadata
...
*OryClient::FrontendApi* | [**get_web_authn_related_origins**](docs/FrontendApi.md#get_web_authn_related_origins) | **GET** /.well-known/webauthn | Get WebAuthn Related Origins
*OryClient::FrontendApi* | [**get_well_known_change_password**](docs/FrontendApi.md#get_well_known_change_password) | **GET** /.well-known/change-password | Change Password URL
*OryClient::FrontendApi* | [**init_saml_login**](docs/FrontendApi.md#init_saml_login) | **GET** /self-service/methods/saml/init/{provider} | Initiate Native SAML Sign-In
*OryClient::FrontendApi* | [**init_saml_login_request**](docs/FrontendApi.md#init_saml_login_request) | **POST** /self-service/methods/saml/init/{provider} | Initiate Native SAML Sign-In (Direct POST)
...
*OryClient::FrontendApi* | [**submit_saml_assertion**](docs/FrontendApi.md#submit_saml_assertion) | **POST** /self-service/methods/saml/acs/{provider} | Native SAML Assertion Consumer Service (ACS)
...
*OryClient::FrontendApi* | [**update_fedcm_flow**](docs/FrontendApi.md#update_fedcm_flow) | **POST** /self-service/fed-cm/token | Submit a FedCM token
...
*OryClient::IdentityApi* | [**get_identity_by_external_id**](docs/IdentityApi.md#get_identity_by_external_id) | **GET** /admin/identities/by/external/{externalID} | Get an Identity by its External ID
...
*OryClient::OAuth2Api* | [**accept_user_code_request**](docs/OAuth2Api.md#accept_user_code_request) | **PUT** /admin/oauth2/auth/requests/device/accept | Accepts a device grant user_code request
...
*OryClient::OAuth2Api* | [**delete_rotated_o_auth2_client_secrets**](docs/OAuth2Api.md#delete_rotated_o_auth2_client_secrets) | **DELETE** /admin/clients/{id}/secrets/rotate | Delete Rotated OAuth 2.0 Client Secrets
...
*OryClient::OAuth2Api* | [**o_auth2_device_flow**](docs/OAuth2Api.md#o_auth2_device_flow) | **POST** /oauth2/device/auth | The OAuth 2.0 Device Authorize Endpoint
...
*OryClient::OAuth2Api* | [**perform_o_auth2_device_verification_flow**](docs/OAuth2Api.md#perform_o_auth2_device_verification_flow) | **GET** /oauth2/device/verify | OAuth 2.0 Device Verification Endpoint
...
*OryClient::OAuth2Api* | [**rotate_o_auth2_client_secret**](docs/OAuth2Api.md#rotate_o_auth2_client_secret) | **POST** /admin/clients/{id}/secrets/rotate | Rotate OAuth 2.0 Client Secret
...
*OryClient::ProjectApi* | [**create_organization_onboarding_portal_link**](docs/ProjectApi.md#create_organization_onboarding_portal_link) | **POST** /projects/{project_id}/organizations/{organization_id}/onboarding-portal-links | Create organization onboarding portal link
...
*OryClient::ProjectApi* | [**delete_organization_onboarding_portal_link**](docs/ProjectApi.md#delete_organization_onboarding_portal_link) | **DELETE** /projects/{project_id}/organizations/{organization_id}/onboarding-portal-links/{onboarding_portal_link_id} | Delete an organization onboarding portal link
...
*OryClient::ProjectApi* | [**get_organization_onboarding_portal_links**](docs/ProjectApi.md#get_organization_onboarding_portal_links) | **GET** /projects/{project_id}/organizations/{organization_id}/onboarding-portal-links | Get the organization onboarding portal links
*OryClient::ProjectApi* | [**get_project**](docs/ProjectApi.md#get_project) | **GET** /projects/{project_id} | Get an Ory Network Project Configuration
...
*OryClient::ProjectApi* | [**update_organization_onboarding_portal_link**](docs/ProjectApi.md#update_organization_onboarding_portal_link) | **POST** /projects/{project_id}/organizations/{organization_id}/onboarding-portal-links/{onboarding_portal_link_id} | Update organization onboarding portal link
*OryClient::ProjectApi* | [**validate_opl**](docs/ProjectApi.md#validate_opl) | **POST** /projects/{project_id}/opl/validate | Validate an Ory Permission Language document
...
## Documentation for Models
 ...
 - [OryClient::AcceptDeviceUserCodeRequest](docs/AcceptDeviceUserCodeRequest.md)
 ...
 - [OryClient::AddWorkspaceOrganizationDomainBody](docs/AddWorkspaceOrganizationDomainBody.md)
 - [OryClient::AdminIdentityImportCredentialsLookupSecret](docs/AdminIdentityImportCredentialsLookupSecret.md)
 - [OryClient::AdminIdentityImportCredentialsLookupSecretConfig](docs/AdminIdentityImportCredentialsLookupSecretConfig.md)
 - [OryClient::AdminRevokeImportedApiKeyBody](docs/AdminRevokeImportedApiKeyBody.md)
 - [OryClient::AdminRevokeIssuedApiKeyBody](docs/AdminRevokeIssuedApiKeyBody.md)
 - [OryClient::AdminRotateIssuedApiKeyBody](docs/AdminRotateIssuedApiKeyBody.md)
 - [OryClient::AdminUpdateImportedApiKeyRequest](docs/AdminUpdateImportedApiKeyRequest.md)
 - [OryClient::AdminUpdateIssuedApiKeyRequest](docs/AdminUpdateIssuedApiKeyRequest.md)
 - [OryClient::AiAssistantSessionToken](docs/AiAssistantSessionToken.md)
 - [OryClient::Any](docs/Any.md)
 ...
 - [OryClient::BasicOrganization](docs/BasicOrganization.md)
 ...
 - [OryClient::BatchCreateImportedApiKeysErrorCode](docs/BatchCreateImportedApiKeysErrorCode.md)
 - [OryClient::BatchCreateImportedApiKeysRequest](docs/BatchCreateImportedApiKeysRequest.md)
 - [OryClient::BatchCreateImportedApiKeysResponse](docs/BatchCreateImportedApiKeysResponse.md)
 - [OryClient::BatchCreateImportedApiKeysResult](docs/BatchCreateImportedApiKeysResult.md)
 - [OryClient::BatchPatchIdentitiesResponse](docs/BatchPatchIdentitiesResponse.md)
 - [OryClient::BatchVerifyApiKeysRequest](docs/BatchVerifyApiKeysRequest.md)
 - [OryClient::BatchVerifyApiKeysResponse](docs/BatchVerifyApiKeysResponse.md)
 ...
 - [OryClient::ContinueWithDeviceAuthnPinEntryUi](docs/ContinueWithDeviceAuthnPinEntryUi.md)
 - [OryClient::ContinueWithDeviceAuthnPinEntryUiData](docs/ContinueWithDeviceAuthnPinEntryUiData.md)
 ...
 - [OryClient::CreateFedcmFlowResponse](docs/CreateFedcmFlowResponse.md)
 ...
 - [OryClient::CreateOnboardingLinkResponse](docs/CreateOnboardingLinkResponse.md)
 - [OryClient::CreateOrganizationOnboardingPortalLinkBody](docs/CreateOrganizationOnboardingPortalLinkBody.md)
 - [OryClient::CreateProjectApiKeyBody](docs/CreateProjectApiKeyBody.md)
 ...
 - [OryClient::CreateTestLoginFlowFromOnboardingPortalLinkBody](docs/CreateTestLoginFlowFromOnboardingPortalLinkBody.md)
 ...
 - [OryClient::CreateWorkspaceContactBody](docs/CreateWorkspaceContactBody.md)
 - [OryClient::CreateWorkspaceMemberInviteBody](docs/CreateWorkspaceMemberInviteBody.md)
 - [OryClient::CreateWorkspaceOrganizationBody](docs/CreateWorkspaceOrganizationBody.md)
 ...
 - [OryClient::DeriveTokenRequest](docs/DeriveTokenRequest.md)
 - [OryClient::DeriveTokenResponse](docs/DeriveTokenResponse.md)
 ...
 - [OryClient::DeviceType](docs/DeviceType.md)
 - [OryClient::DeviceUserAuthRequest](docs/DeviceUserAuthRequest.md)
 - [OryClient::DomainVerificationStatus](docs/DomainVerificationStatus.md)
 - [OryClient::ElementsConfiguration](docs/ElementsConfiguration.md)
 ...
 - [OryClient::FeatureFlagsCatalogEntry](docs/FeatureFlagsCatalogEntry.md)
 ...
 - [OryClient::GenericOIDCProvider](docs/GenericOIDCProvider.md)
 - [OryClient::GenericUsage](docs/GenericUsage.md)
 - [OryClient::GetAttributesCount](docs/GetAttributesCount.md)
 - [OryClient::GetJWKSResponse](docs/GetJWKSResponse.md)
 - [OryClient::GetJWKSResponseJwks](docs/GetJWKSResponseJwks.md)
 - [OryClient::GetJWKSResponseJwksKeysInner](docs/GetJWKSResponseJwksKeysInner.md)
 - [OryClient::GetManagedIdentitySchemaLocation](docs/GetManagedIdentitySchemaLocation.md)
 - [OryClient::GetMetricsCount](docs/GetMetricsCount.md)
 - [OryClient::GetMetricsEventAttributes](docs/GetMetricsEventAttributes.md)
 - [OryClient::GetMetricsEventTypes](docs/GetMetricsEventTypes.md)
 - [OryClient::GetOrganizationResponse](docs/GetOrganizationResponse.md)
 - [OryClient::GetOrganizationsByHostnameResponse](docs/GetOrganizationsByHostnameResponse.md)
 - [OryClient::GetProjectEvents](docs/GetProjectEvents.md)
 - [OryClient::GetProjectEventsBody](docs/GetProjectEventsBody.md)
 - [OryClient::GetProjectMetrics](docs/GetProjectMetrics.md)
 - [OryClient::GetSessionActivity](docs/GetSessionActivity.md)
 ...
 - [OryClient::IPRestriction](docs/IPRestriction.md)
 ...
 - [OryClient::IdentityCredentialsLookupSecretCode](docs/IdentityCredentialsLookupSecretCode.md)
 ...
 - [OryClient::IdentityCredentialsWebAuthn](docs/IdentityCredentialsWebAuthn.md)
 - [OryClient::IdentityCredentialsWebAuthnAttestation](docs/IdentityCredentialsWebAuthnAttestation.md)
 - [OryClient::IdentityCredentialsWebAuthnAuthenticator](docs/IdentityCredentialsWebAuthnAuthenticator.md)
 - [OryClient::IdentityCredentialsWebAuthnFlags](docs/IdentityCredentialsWebAuthnFlags.md)
 ...
 - [OryClient::IdentityWithCredentialsPasskey](docs/IdentityWithCredentialsPasskey.md)
 - [OryClient::IdentityWithCredentialsPasskeyConfig](docs/IdentityWithCredentialsPasskeyConfig.md)
 ...
 - [OryClient::IdentityWithCredentialsSaml](docs/IdentityWithCredentialsSaml.md)
 - [OryClient::IdentityWithCredentialsSamlConfig](docs/IdentityWithCredentialsSamlConfig.md)
 - [OryClient::IdentityWithCredentialsSamlConfigProvider](docs/IdentityWithCredentialsSamlConfigProvider.md)
 - [OryClient::IdentityWithCredentialsTotp](docs/IdentityWithCredentialsTotp.md)
 - [OryClient::IdentityWithCredentialsTotpConfig](docs/IdentityWithCredentialsTotpConfig.md)
 - [OryClient::IdentityWithCredentialsWebAuthn](docs/IdentityWithCredentialsWebAuthn.md)
 - [OryClient::IdentityWithCredentialsWebAuthnConfig](docs/IdentityWithCredentialsWebAuthnConfig.md)
 - [OryClient::ImportApiKeyRequest](docs/ImportApiKeyRequest.md)
 - [OryClient::ImportedApiKey](docs/ImportedApiKey.md)
 ...
 - [OryClient::InternalIsOwnerForProjectBySlug](docs/InternalIsOwnerForProjectBySlug.md)
 ...
 - [OryClient::IssueApiKeyRequest](docs/IssueApiKeyRequest.md)
 - [OryClient::IssueApiKeyResponse](docs/IssueApiKeyResponse.md)
 - [OryClient::IssuedApiKey](docs/IssuedApiKey.md)
 ...
 - [OryClient::KeyState](docs/KeyState.md)
 - [OryClient::KeyStatus](docs/KeyStatus.md)
 - [OryClient::KeyVisibility](docs/KeyVisibility.md)
 - [OryClient::KeysetPaginationRequestParameters](docs/KeysetPaginationRequestParameters.md)
 - [OryClient::KeysetPaginationResponseHeaders](docs/KeysetPaginationResponseHeaders.md)
 - [OryClient::LineItemV1](docs/LineItemV1.md)
 - [OryClient::ListEventStreams](docs/ListEventStreams.md)
 - [OryClient::ListImportedApiKeysResponse](docs/ListImportedApiKeysResponse.md)
 - [OryClient::ListInvoicesResponse](docs/ListInvoicesResponse.md)
 - [OryClient::ListIssuedApiKeysResponse](docs/ListIssuedApiKeysResponse.md)
 - [OryClient::ListOrganizationsResponse](docs/ListOrganizationsResponse.md)
 - [OryClient::ListWorkspaceContacts](docs/ListWorkspaceContacts.md)
 ...
 - [OryClient::NormalizedProjectRevisionScimClient](docs/NormalizedProjectRevisionScimClient.md)
 ...
 - [OryClient::NullValue](docs/NullValue.md)
 ...
 - [OryClient::OnboardingPortalLink](docs/OnboardingPortalLink.md)
 - [OryClient::OnboardingPortalOrganization](docs/OnboardingPortalOrganization.md)
 - [OryClient::OnboardingPortalTestLoginFlow](docs/OnboardingPortalTestLoginFlow.md)
 - [OryClient::OplParseError](docs/OplParseError.md)
 - [OryClient::OplSourcePosition](docs/OplSourcePosition.md)
 - [OryClient::OplValidateResult](docs/OplValidateResult.md)
 - [OryClient::Organization](docs/Organization.md)
 - [OryClient::OrganizationBody](docs/OrganizationBody.md)
 - [OryClient::OrganizationByHostname](docs/OrganizationByHostname.md)
 - [OryClient::OrganizationOnboardingPortalLinksResponse](docs/OrganizationOnboardingPortalLinksResponse.md)
 - [OryClient::PINConfig](docs/PINConfig.md)
 - [OryClient::ParseError](docs/ParseError.md)
 - [OryClient::PatchIdentitiesBody](docs/PatchIdentitiesBody.md)
 - [OryClient::PatchWorkspaceContactBody](docs/PatchWorkspaceContactBody.md)
 - [OryClient::PatchWorkspaceMemberBody](docs/PatchWorkspaceMemberBody.md)
 ...
 - [OryClient::ProjectServiceAccountExperience](docs/ProjectServiceAccountExperience.md)
 ...
 - [OryClient::ProjectServiceTalos](docs/ProjectServiceTalos.md)
 - [OryClient::ProjectServices](docs/ProjectServices.md)
 - [OryClient::Provider](docs/Provider.md)
 - [OryClient::QuotaUsage](docs/QuotaUsage.md)
 - [OryClient::RFC6749ErrorJson](docs/RFC6749ErrorJson.md)
 - [OryClient::RateLimitPolicy](docs/RateLimitPolicy.md)
 ...
 - [OryClient::RevisionAccountExperienceCustomTranslation](docs/RevisionAccountExperienceCustomTranslation.md)
 - [OryClient::RevocationReason](docs/RevocationReason.md)
 - [OryClient::RotateIssuedApiKeyResponse](docs/RotateIssuedApiKeyResponse.md)
 - [OryClient::RotateOAuth2ClientSecretBody](docs/RotateOAuth2ClientSecretBody.md)
 - [OryClient::RotateTalosKeyBody](docs/RotateTalosKeyBody.md)
 - [OryClient::SchemaPatch](docs/SchemaPatch.md)
 - [OryClient::SelfRevokeApiKeyRequest](docs/SelfRevokeApiKeyRequest.md)
 ...
 - [OryClient::SetOrganizationFromOnboardingPortalLinkBody](docs/SetOrganizationFromOnboardingPortalLinkBody.md)
 ...
 - [OryClient::Status](docs/Status.md)
 ...
 - [OryClient::TalosRetiredValue](docs/TalosRetiredValue.md)
 - [OryClient::TaxLineItem](docs/TaxLineItem.md)
 - [OryClient::TimeInterval](docs/TimeInterval.md)
 - [OryClient::Token](docs/Token.md)
 - [OryClient::TokenAlgorithm](docs/TokenAlgorithm.md)
 ...
 - [OryClient::UiNodeDivisionAttributes](docs/UiNodeDivisionAttributes.md)
 ...
 - [OryClient::UiNodeInputAttributesOption](docs/UiNodeInputAttributesOption.md)
 ...
 - [OryClient::UpdateFedcmFlowBody](docs/UpdateFedcmFlowBody.md)
 ...
 - [OryClient::UpdateLoginFlowWithDeviceAuthnMethod](docs/UpdateLoginFlowWithDeviceAuthnMethod.md)
 ...
 - [OryClient::UpdateLoginFlowWithSamlMethod](docs/UpdateLoginFlowWithSamlMethod.md)
 ...
 - [OryClient::UpdateOrganizationOnboardingPortalLinkBody](docs/UpdateOrganizationOnboardingPortalLinkBody.md)
 ...
 - [OryClient::UpdateRegistrationFlowWithSamlMethod](docs/UpdateRegistrationFlowWithSamlMethod.md)
 ...
 - [OryClient::UpdateSettingsFlowWithDeviceAuthnMethod](docs/UpdateSettingsFlowWithDeviceAuthnMethod.md)
 - [OryClient::UpdateSettingsFlowWithDeviceAuthnMethodRegister](docs/UpdateSettingsFlowWithDeviceAuthnMethodRegister.md)
 - [OryClient::UpdateSettingsFlowWithDeviceAuthnMethodRotateSecret](docs/UpdateSettingsFlowWithDeviceAuthnMethodRotateSecret.md)
 ...
 - [OryClient::UpdateSettingsFlowWithSamlMethod](docs/UpdateSettingsFlowWithSamlMethod.md)
 ...
 - [OryClient::UpdateWorkspaceOrganizationBody](docs/UpdateWorkspaceOrganizationBody.md)
 - [OryClient::Usage](docs/Usage.md)
 - [OryClient::UserVerification](docs/UserVerification.md)
 - [OryClient::ValidateBaseURLRewriteRequest](docs/ValidateBaseURLRewriteRequest.md)
 - [OryClient::ValidateBaseURLRewriteResponse](docs/ValidateBaseURLRewriteResponse.md)
 ...
 - [OryClient::VerificationErrorCode](docs/VerificationErrorCode.md)
 - [OryClient::VerificationFlow](docs/VerificationFlow.md)
 - [OryClient::VerificationFlowState](docs/VerificationFlowState.md)
 - [OryClient::VerifyApiKeyRequest](docs/VerifyApiKeyRequest.md)
 - [OryClient::VerifyApiKeyResponse](docs/VerifyApiKeyResponse.md)
 - [OryClient::VerifyUserCodeRequest](docs/VerifyUserCodeRequest.md)
 - [OryClient::Version](docs/Version.md)
 - [OryClient::Warning](docs/Warning.md)
 - [OryClient::WebAuthnRelatedOrigins](docs/WebAuthnRelatedOrigins.md)
 - [OryClient::Workspace](docs/Workspace.md)
 - [OryClient::WorkspaceApiKey](docs/WorkspaceApiKey.md)
 - [OryClient::WorkspaceContact](docs/WorkspaceContact.md)
 - [OryClient::WorkspaceContactRecipient](docs/WorkspaceContactRecipient.md)
 - [OryClient::WorkspaceContactRecipientInput](docs/WorkspaceContactRecipientInput.md)
 - [OryClient::WorkspaceOrganization](docs/WorkspaceOrganization.md)
