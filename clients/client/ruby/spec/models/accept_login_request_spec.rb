...
# Unit tests for OryClient::AcceptLoginRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryClient::AcceptLoginRequest do
  let(:instance) { OryClient::AcceptLoginRequest.new }

  describe 'test an instance of AcceptLoginRequest' do
    it 'should create an instance of AcceptLoginRequest' do
      expect(instance).to be_instance_of(OryClient::AcceptLoginRequest)
    end
  end
