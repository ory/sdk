...
# Unit tests for OryHydraClient::UiNode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryHydraClient::UiNode do
  let(:instance) { OryHydraClient::UiNode.new }

  describe 'test an instance of UiNode' do
    it 'should create an instance of UiNode' do
      expect(instance).to be_instance_of(OryHydraClient::UiNode)
    end
  end
