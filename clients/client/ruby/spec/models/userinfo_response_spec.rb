...
# Unit tests for OryClient::UserinfoResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryClient::UserinfoResponse do
  let(:instance) { OryClient::UserinfoResponse.new }

  describe 'test an instance of UserinfoResponse' do
    it 'should create an instance of UserinfoResponse' do
      expect(instance).to be_instance_of(OryClient::UserinfoResponse)
    end
  end
