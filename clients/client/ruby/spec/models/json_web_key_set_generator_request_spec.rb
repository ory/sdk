...
# Unit tests for OryClient::JsonWebKeySetGeneratorRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryClient::JsonWebKeySetGeneratorRequest do
  let(:instance) { OryClient::JsonWebKeySetGeneratorRequest.new }
  ...
  describe 'test an instance of JsonWebKeySetGeneratorRequest' do
    it 'should create an instance of JsonWebKeySetGeneratorRequest' do
      expect(instance).to be_instance_of(OryClient::JsonWebKeySetGeneratorRequest)
    end
  end
