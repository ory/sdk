...
# Unit tests for OryHydraClient::IdentityCredentials
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryHydraClient::IdentityCredentials do
  let(:instance) { OryHydraClient::IdentityCredentials.new }

  describe 'test an instance of IdentityCredentials' do
    it 'should create an instance of IdentityCredentials' do
      expect(instance).to be_instance_of(OryHydraClient::IdentityCredentials)
    end
  end
