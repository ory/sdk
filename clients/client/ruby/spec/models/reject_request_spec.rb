...
# Unit tests for OryClient::RejectRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryClient::RejectRequest do
  let(:instance) { OryClient::RejectRequest.new }

  describe 'test an instance of RejectRequest' do
    it 'should create an instance of RejectRequest' do
      expect(instance).to be_instance_of(OryClient::RejectRequest)
    end
  end
