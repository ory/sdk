...
module OryClient
  class ApiKeysApi
    ...
    def admin_revoke_imported_api_key(key_id, admin_revoke_imported_api_key_body, opts = {})
      data, _status_code, _headers = admin_revoke_imported_api_key_with_http_info(key_id, admin_revoke_imported_api_key_body, opts)
      data
    end
    ...
    def admin_revoke_issued_api_key(key_id, admin_revoke_issued_api_key_body, opts = {})
      data, _status_code, _headers = admin_revoke_issued_api_key_with_http_info(key_id, admin_revoke_issued_api_key_body, opts)
      data
    end
