...
module OryClient
  class ProjectApi
    ...
    def validate_opl(project_id, opts = {})
      data, _status_code, _headers = validate_opl_with_http_info(project_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :body 
    # @return [Array<(OplValidateResult, Integer, Hash)>] OplValidateResult data, response status code and response headers
    def validate_opl_with_http_info(project_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectApi.validate_opl ...'
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling ProjectApi.validate_opl"
      end
      # resource path
      local_var_path = '/projects/{project_id}/opl/validate'.sub('{' + 'project_id' + '}', CGI.escape(project_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'OplValidateResult'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['oryWorkspaceApiKey']

      new_options = opts.merge(
        :operation => :"ProjectApi.validate_opl",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProjectApi#validate_opl\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
