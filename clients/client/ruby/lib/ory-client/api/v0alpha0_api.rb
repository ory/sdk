...
module OryClient
  class V0alpha0Api
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [UpdateProjectConfigConfig] :update_project_config_config 
    # @return [Array<(SuccessfulUpdateProjectConfig, Integer, Hash)>] SuccessfulUpdateProjectConfig data, response status code and response headers
    def update_project_config_with_http_info(project_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SuccessfulUpdateProjectConfig'
