...
module OryClient
  class IdentityApi
    ...
    def get_identity_with_http_info(id, opts = {})
      ...
      allowable_values = ["password", "totp", "oidc", "webauthn", "lookup_secret", "code"]
    ...
    def list_identities_with_http_info(opts = {})
      ...
      query_params[:'ids_filter'] = @api_client.build_collection_param(opts[:'ids_filter'], :multi) if !opts[:'ids_filter'].nil?
