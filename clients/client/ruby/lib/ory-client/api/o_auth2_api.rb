...
module OryClient
  class OAuth2Api
    ...
    # Accepts a device grant user_code request
    # @param device_challenge [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [AcceptDeviceUserCodeRequest] :accept_device_user_code_request 
    # @return [OAuth2RedirectTo]
    ...
    # @param [Hash] opts the optional parameters
    # @return [OAuth2Client]
    def delete_rotated_o_auth2_client_secrets(id, opts = {})
      data, _status_code, _headers = delete_rotated_o_auth2_client_secrets_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(OAuth2Client, Integer, Hash)>] OAuth2Client data, response status code and response headers
    def delete_rotated_o_auth2_client_secrets_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuth2Api.delete_rotated_o_auth2_client_secrets ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OAuth2Api.delete_rotated_o_auth2_client_secrets"
      end
      # resource path
      local_var_path = '/admin/clients/{id}/secrets/rotate'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"OAuth2Api.delete_rotated_o_auth2_client_secrets",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OAuth2Api#delete_rotated_o_auth2_client_secrets\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :page_size Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). (default to 250)
    # @option opts [String] :page_token Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination).
    ...
    # @param id [String] OAuth 2.0 Client ID
    # @param [Hash] opts the optional parameters
    # @option opts [RotateOAuth2ClientSecretBody] :rotate_o_auth2_client_secret_body 
    # @return [OAuth2Client]
    def rotate_o_auth2_client_secret(id, opts = {})
      data, _status_code, _headers = rotate_o_auth2_client_secret_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [RotateOAuth2ClientSecretBody] :rotate_o_auth2_client_secret_body 
    # @return [Array<(OAuth2Client, Integer, Hash)>] OAuth2Client data, response status code and response headers
    def rotate_o_auth2_client_secret_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuth2Api.rotate_o_auth2_client_secret ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OAuth2Api.rotate_o_auth2_client_secret"
      end
      # resource path
      local_var_path = '/admin/clients/{id}/secrets/rotate'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'rotate_o_auth2_client_secret_body'])
      ...
      new_options = opts.merge(
        :operation => :"OAuth2Api.rotate_o_auth2_client_secret",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OAuth2Api#rotate_o_auth2_client_secret\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
