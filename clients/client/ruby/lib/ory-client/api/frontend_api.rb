...
module OryClient
  class FrontendApi
    ...
    # @param provider [String] The SAML provider ID as configured in the Ory Kratos configuration.
    # @param code [String] The single-use authorization code issued by Ory Polis for the unsolicited SAML response.
    # @param [Hash] opts the optional parameters
    # @return [ErrorGeneric]
    def create_id_p_initiated_saml_browser_login_flow(provider, code, opts = {})
      data, _status_code, _headers = create_id_p_initiated_saml_browser_login_flow_with_http_info(provider, code, opts)
      data
    end
    ...
    def create_id_p_initiated_saml_browser_login_flow_with_http_info(provider, code, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [String]
    def get_saml_metadata(opts = {})
      data, _status_code, _headers = get_saml_metadata_with_http_info(opts)
      data
    end
    ...
    def get_saml_metadata_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @param provider [String] The SAML connection ID to get metadata for.
    # @param [Hash] opts the optional parameters
    # @return [String]
    def get_saml_provider_metadata(provider, opts = {})
      data, _status_code, _headers = get_saml_provider_metadata_with_http_info(provider, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def get_saml_provider_metadata_with_http_info(provider, opts = {})
      if @api_client.config.debugging
    ...
    # This endpoint serves the WebAuthn Related Origin Requests document specified in https://www.w3.org/TR/webauthn-3/#sctn-related-origins. It lists the web origins allowed to use this domain as their WebAuthn relying party ID. Browsers fetch it when a page requests a relying party ID that does not match the page&#39;s own origin.  The document contains the relying party origins configured for the enabled WebAuthn and passkey methods.
    # @param [Hash] opts the optional parameters
    # @return [Array<(WebAuthnRelatedOrigins, Integer, Hash)>] WebAuthnRelatedOrigins data, response status code and response headers
    ...
    # @param provider [String] The SAML connection ID to start a native SP-initiated sign-in for.
    # @param flow [String] The Login, Registration, or Settings Flow ID this SAML sign-in continues.
    # @param purpose [String] The kind of flow &#x60;flow&#x60; names: &#x60;login&#x60;, &#x60;registration&#x60;, or &#x60;settings-link&#x60; (a settings flow linking a new SAML credential). The flow must exist in the named kind, or the request is not found.
    # @param [Hash] opts the optional parameters
    # @return [String]
    def init_saml_login(provider, flow, purpose, opts = {})
      data, _status_code, _headers = init_saml_login_with_http_info(provider, flow, purpose, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def init_saml_login_with_http_info(provider, flow, purpose, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [String]
    def init_saml_login_request(provider, flow, purpose, opts = {})
      data, _status_code, _headers = init_saml_login_request_with_http_info(provider, flow, purpose, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def init_saml_login_request_with_http_info(provider, flow, purpose, opts = {})
      if @api_client.config.debugging
