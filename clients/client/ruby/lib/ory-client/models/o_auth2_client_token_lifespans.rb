...
module OryClient
  ...
  class OAuth2ClientTokenLifespans < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OryClient::OAuth2ClientTokenLifespans`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
    ...
    def valid?
      ...
      return false if !@authorization_code_grant_access_token_lifespan.nil? && @authorization_code_grant_access_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@authorization_code_grant_id_token_lifespan.nil? && @authorization_code_grant_id_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@authorization_code_grant_refresh_token_lifespan.nil? && @authorization_code_grant_refresh_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@client_credentials_grant_access_token_lifespan.nil? && @client_credentials_grant_access_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@device_authorization_grant_access_token_lifespan.nil? && @device_authorization_grant_access_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@device_authorization_grant_id_token_lifespan.nil? && @device_authorization_grant_id_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@device_authorization_grant_refresh_token_lifespan.nil? && @device_authorization_grant_refresh_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@implicit_grant_access_token_lifespan.nil? && @implicit_grant_access_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@implicit_grant_id_token_lifespan.nil? && @implicit_grant_id_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@jwt_bearer_grant_access_token_lifespan.nil? && @jwt_bearer_grant_access_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@refresh_token_grant_access_token_lifespan.nil? && @refresh_token_grant_access_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@refresh_token_grant_id_token_lifespan.nil? && @refresh_token_grant_id_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      return false if !@refresh_token_grant_refresh_token_lifespan.nil? && @refresh_token_grant_refresh_token_lifespan !~ Regexp.new(/^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/)
      true
    end
