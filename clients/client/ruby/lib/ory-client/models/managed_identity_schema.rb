...
module OryClient
  ...
  class ManagedIdentitySchema < ApiModelBase
    ...
    # @param [Object] blob_name Value to be assigned
    def blob_name=(blob_name)
      if blob_name.nil?
        fail ArgumentError, 'blob_name cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] blob_url Value to be assigned
    def blob_url=(blob_url)
      if blob_url.nil?
        fail ArgumentError, 'blob_url cannot be nil'
      end
