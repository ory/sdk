...
module OryClient
  ...
  class ElementsConfiguration < ApiModelBase
    ...
    def hash
      [default_redirect_url, error_ui_url, hide_ory_branding, hide_registration_link, login_ui_url, logo_dark_url, logo_light_url, name, recovery_enabled, recovery_ui_url, registration_enabled, registration_ui_url, settings_ui_url, verification_enabled, verification_ui_url].hash
    end
