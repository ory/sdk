...
module OryClient
  class QuotaUsage
    ...
    def valid?
      ...
      feature_validator = EnumAttributeValidator.new('String', ["region_eu", "region_us", "region_apac", "region_global", "production_projects", "daily_active_users", "custom_domains", "sla", "collaborator_seats", "edge_cache", "branding_themes", "zendesk_support", "rate_limit_tier", "session_rate_limit_tier"])
    ...
    def feature=(feature)
      validator = EnumAttributeValidator.new('String', ["region_eu", "region_us", "region_apac", "region_global", "production_projects", "daily_active_users", "custom_domains", "sla", "collaborator_seats", "edge_cache", "branding_themes", "zendesk_support", "rate_limit_tier", "session_rate_limit_tier"])
