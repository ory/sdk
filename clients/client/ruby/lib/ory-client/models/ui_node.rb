...
module OryClient
  ...
  class UiNode
    ...
    def valid?
      ...
      group_validator = EnumAttributeValidator.new('String', ["default", "password", "oidc", "profile", "link", "code", "totp", "lookup_secret", "webauthn", "passkey", "identifier_first", "captcha"])
    ...
    def group=(group)
      validator = EnumAttributeValidator.new('String', ["default", "password", "oidc", "profile", "link", "code", "totp", "lookup_secret", "webauthn", "passkey", "identifier_first", "captcha"])
