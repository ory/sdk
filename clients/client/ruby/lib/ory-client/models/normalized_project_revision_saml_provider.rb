...
module OryClient
  class NormalizedProjectRevisionSAMLProvider < ApiModelBase
    ...
    def hash
      [audience_override_base_url, created_at, id, idp_initiated_login_enabled, label, mapper_url, organization_id, project_revision_id, provider_id, proxy_acs_url, proxy_saml_audience_override, raw_idp_metadata_xml, state, update_identity_on_login, updated_at, valid_to].hash
    end
