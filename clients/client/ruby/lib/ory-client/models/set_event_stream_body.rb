...
module OryClient
  ...
  class SetEventStreamBody < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'https_endpoint')
        self.https_endpoint = attributes[:'https_endpoint']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["sns", "https"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["sns", "https"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          https_endpoint == o.https_endpoint &&
          role_arn == o.role_arn &&
          status == o.status &&
    ...
    def hash
      [https_endpoint, role_arn, status, topic_arn, type].hash
    end
