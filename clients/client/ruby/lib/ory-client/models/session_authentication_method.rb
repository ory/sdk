...
module OryClient
  ...
  class SessionAuthenticationMethod
    ...
    def valid?
      method_validator = EnumAttributeValidator.new('String', ["link_recovery", "password", "totp", "oidc", "webauthn", "lookup_secret"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["link_recovery", "password", "totp", "oidc", "webauthn", "lookup_secret"])
