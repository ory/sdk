...
module OryClient
  ...
  class SessionAuthenticationMethod
    ...
    def valid?
      method_validator = EnumAttributeValidator.new('String', ["link_recovery", "code_recovery", "password", "totp", "oidc", "webauthn", "lookup_secret", "v0.6_legacy_session"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["link_recovery", "code_recovery", "password", "totp", "oidc", "webauthn", "lookup_secret", "v0.6_legacy_session"])
    ...
    def hash
      [aal, completed_at, method, provider].hash
    end
