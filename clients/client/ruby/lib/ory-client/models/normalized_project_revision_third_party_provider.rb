...
module OryClient
  class NormalizedProjectRevisionThirdPartyProvider < ApiModelBase
    ...
    attr_accessor :front_channel_logout
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'front_channel_logout')
        self.front_channel_logout = attributes[:'front_channel_logout']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          front_channel_logout == o.front_channel_logout &&
          id == o.id &&
