...
module OryClient
  class NormalizedProjectRevisionThirdPartyProvider
    ...
    def hash
      [apple_private_key, apple_private_key_id, apple_team_id, auth_url, azure_tenant, client_id, client_secret, created_at, id, issuer_url, label, mapper_url, project_revision_id, provider, provider_id, requested_claims, scope, subject_source, token_url, updated_at].hash
    end
