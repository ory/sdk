...
module OryClient
  ...
  class LoginFlow
    ...
    def hash
      [active, created_at, expires_at, id, issued_at, oauth2_login_challenge, oauth2_login_request, refresh, request_url, requested_aal, return_to, session_token_exchange_code, state, type, ui, updated_at].hash
    end
