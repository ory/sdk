...
module OryClient
  ...
  class UpdateSettingsFlowWithDeviceAuthnMethodRotateSecret < ApiModelBase
    ...
    # Custom attribute writer method with validation
    # @param [Object] transport_public_key Value to be assigned
    def transport_public_key=(transport_public_key)
      if transport_public_key.nil?
        fail ArgumentError, 'transport_public_key cannot be nil'
      end
