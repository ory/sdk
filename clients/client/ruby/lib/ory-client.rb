...
require 'ory-client/api_model_base'
...
require 'ory-client/models/add_workspace_organization_domain_body'
require 'ory-client/models/admin_identity_import_credentials_lookup_secret'
require 'ory-client/models/admin_identity_import_credentials_lookup_secret_config'
require 'ory-client/models/admin_revoke_imported_api_key_body'
require 'ory-client/models/admin_revoke_issued_api_key_body'
require 'ory-client/models/admin_rotate_issued_api_key_body'
require 'ory-client/models/admin_update_imported_api_key_request'
require 'ory-client/models/admin_update_issued_api_key_request'
require 'ory-client/models/ai_assistant_session_token'
require 'ory-client/models/any'
...
require 'ory-client/models/batch_create_imported_api_keys_error_code'
require 'ory-client/models/batch_create_imported_api_keys_request'
require 'ory-client/models/batch_create_imported_api_keys_response'
require 'ory-client/models/batch_create_imported_api_keys_result'
require 'ory-client/models/batch_patch_identities_response'
require 'ory-client/models/batch_verify_api_keys_request'
require 'ory-client/models/batch_verify_api_keys_response'
...
require 'ory-client/models/continue_with_device_authn_pin_entry_ui'
require 'ory-client/models/continue_with_device_authn_pin_entry_ui_data'
...
require 'ory-client/models/create_onboarding_link_response'
require 'ory-client/models/create_organization_onboarding_portal_link_body'
require 'ory-client/models/create_project_api_key_body'
...
require 'ory-client/models/create_test_login_flow_body'
require 'ory-client/models/create_test_login_flow_from_onboarding_portal_link_body'
...
require 'ory-client/models/create_workspace_contact_body'
require 'ory-client/models/create_workspace_member_invite_body'
require 'ory-client/models/create_workspace_organization_body'
...
require 'ory-client/models/customer_portal_availability'
require 'ory-client/models/delete_my_sessions_count'
require 'ory-client/models/derive_token_request'
require 'ory-client/models/derive_token_response'
require 'ory-client/models/device_authn_android_authorization_list'
require 'ory-client/models/device_authn_android_key_description'
require 'ory-client/models/device_authn_android_root_of_trust'
require 'ory-client/models/device_authn_attestation'
require 'ory-client/models/device_authn_ios_att_stmt'
require 'ory-client/models/device_authn_ios_attestation'
require 'ory-client/models/device_authn_key'
require 'ory-client/models/device_authorization'
require 'ory-client/models/device_type'
require 'ory-client/models/device_user_auth_request'
require 'ory-client/models/domain_verification_status'
require 'ory-client/models/elements_configuration'
...
require 'ory-client/models/feature_flags_catalog_entry'
...
require 'ory-client/models/generic_oidc_provider'
require 'ory-client/models/generic_usage'
require 'ory-client/models/get_attributes_count'
require 'ory-client/models/get_jwks_response'
require 'ory-client/models/get_jwks_response_jwks'
require 'ory-client/models/get_jwks_response_jwks_keys_inner'
require 'ory-client/models/get_managed_identity_schema_location'
require 'ory-client/models/get_metrics_count'
require 'ory-client/models/get_metrics_event_attributes'
require 'ory-client/models/get_metrics_event_types'
require 'ory-client/models/get_organization_response'
require 'ory-client/models/get_organizations_by_hostname_response'
require 'ory-client/models/get_project_events'
require 'ory-client/models/get_project_events_body'
require 'ory-client/models/get_project_metrics'
require 'ory-client/models/get_session_activity'
...
require 'ory-client/models/ip_restriction'
...
require 'ory-client/models/identity_credentials_lookup_secret_code'
...
require 'ory-client/models/identity_credentials_web_authn'
require 'ory-client/models/identity_credentials_web_authn_attestation'
require 'ory-client/models/identity_credentials_web_authn_authenticator'
require 'ory-client/models/identity_credentials_web_authn_flags'
...
require 'ory-client/models/identity_with_credentials_passkey'
require 'ory-client/models/identity_with_credentials_passkey_config'
...
require 'ory-client/models/identity_with_credentials_totp'
require 'ory-client/models/identity_with_credentials_totp_config'
require 'ory-client/models/identity_with_credentials_web_authn'
require 'ory-client/models/identity_with_credentials_web_authn_config'
require 'ory-client/models/import_api_key_request'
require 'ory-client/models/imported_api_key'
...
require 'ory-client/models/internal_is_owner_for_project_by_slug'
...
require 'ory-client/models/issue_api_key_request'
require 'ory-client/models/issue_api_key_response'
require 'ory-client/models/issued_api_key'
...
require 'ory-client/models/key_state'
require 'ory-client/models/key_status'
require 'ory-client/models/key_visibility'
...
require 'ory-client/models/list_imported_api_keys_response'
require 'ory-client/models/list_invoices_response'
require 'ory-client/models/list_issued_api_keys_response'
require 'ory-client/models/list_organizations_response'
require 'ory-client/models/list_workspace_contacts'
...
require 'ory-client/models/login_flow_test_context'
require 'ory-client/models/login_flow_test_debug_payload'
require 'ory-client/models/login_flow_test_schema_validation_error'
require 'ory-client/models/login_flow_test_step_error'
require 'ory-client/models/logout_flow'
require 'ory-client/models/manage_sessions_body'
require 'ory-client/models/manage_sessions_response'
...
require 'ory-client/models/null_value'
...
require 'ory-client/models/onboarding_portal_test_login_flow'
require 'ory-client/models/opl_parse_error'
require 'ory-client/models/opl_source_position'
require 'ory-client/models/opl_validate_result'
require 'ory-client/models/organization'
require 'ory-client/models/organization_body'
require 'ory-client/models/organization_by_hostname'
require 'ory-client/models/organization_onboarding_portal_links_response'
require 'ory-client/models/pin_config'
require 'ory-client/models/parse_error'
require 'ory-client/models/patch_identities_body'
require 'ory-client/models/patch_workspace_contact_body'
require 'ory-client/models/patch_workspace_member_body'
...
require 'ory-client/models/project_service_account_experience'
...
require 'ory-client/models/project_service_talos'
...
require 'ory-client/models/rate_limit_policy'
...
require 'ory-client/models/revision_account_experience_custom_translation'
require 'ory-client/models/revocation_reason'
require 'ory-client/models/rotate_issued_api_key_response'
require 'ory-client/models/rotate_o_auth2_client_secret_body'
require 'ory-client/models/rotate_talos_key_body'
require 'ory-client/models/schema_patch'
require 'ory-client/models/self_revoke_api_key_request'
...
require 'ory-client/models/status'
...
require 'ory-client/models/talos_retired_value'
require 'ory-client/models/tax_line_item'
require 'ory-client/models/time_interval'
require 'ory-client/models/token'
require 'ory-client/models/token_algorithm'
...
require 'ory-client/models/ui_node_input_attributes_option'
...
require 'ory-client/models/update_login_flow_with_device_authn_method'
...
require 'ory-client/models/update_settings_flow_with_device_authn_method'
require 'ory-client/models/update_settings_flow_with_device_authn_method_register'
require 'ory-client/models/update_settings_flow_with_device_authn_method_rotate_secret'
...
require 'ory-client/models/update_workspace_organization_body'
require 'ory-client/models/usage'
require 'ory-client/models/user_verification'
require 'ory-client/models/validate_base_url_rewrite_request'
require 'ory-client/models/validate_base_url_rewrite_response'
...
require 'ory-client/models/verification_error_code'
require 'ory-client/models/verification_flow'
require 'ory-client/models/verification_flow_state'
require 'ory-client/models/verify_api_key_request'
require 'ory-client/models/verify_api_key_response'
require 'ory-client/models/verify_user_code_request'
require 'ory-client/models/version'
require 'ory-client/models/warning'
require 'ory-client/models/web_authn_related_origins'
require 'ory-client/models/workspace'
require 'ory-client/models/workspace_api_key'
require 'ory-client/models/workspace_contact'
require 'ory-client/models/workspace_contact_recipient'
require 'ory-client/models/workspace_contact_recipient_input'
require 'ory-client/models/workspace_organization'

# APIs
require 'ory-client/api/api_keys_api'
require 'ory-client/api/courier_api'
require 'ory-client/api/elements_api'
