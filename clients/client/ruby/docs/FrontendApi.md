...
opts = {
  return_to: 'return_to_example', # String | The URL to return the browser to after the flow was completed.
  skip_settings: 'skip_settings_example' # String | Skip redirection to the settings UI after the recovery flow was completed. Instead, the user will be redirected to the URL specified in `return_to` query parameter or the default return URL if `return_to` is not set.
}
...
| ---- | ---- | ----------- | ----- |
| **return_to** | **String** | The URL to return the browser to after the flow was completed. | [optional] |
| **skip_settings** | **String** | Skip redirection to the settings UI after the recovery flow was completed. Instead, the user will be redirected to the URL specified in &#x60;return_to&#x60; query parameter or the default return URL if &#x60;return_to&#x60; is not set. | [optional] |
...
begin
  # Complete IdP-Initiated SAML Login for Browsers
  result = api_instance.create_id_p_initiated_saml_browser_login_flow(provider, code)
  p result
rescue OryClient::ApiError => e
  puts "Error when calling FrontendApi->create_id_p_initiated_saml_browser_login_flow: #{e}"
end
```

#### Using the create_id_p_initiated_saml_browser_login_flow_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ErrorGeneric>, Integer, Hash)> create_id_p_initiated_saml_browser_login_flow_with_http_info(provider, code)

```ruby
begin
  # Complete IdP-Initiated SAML Login for Browsers
  data, status_code, headers = api_instance.create_id_p_initiated_saml_browser_login_flow_with_http_info(provider, code)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ErrorGeneric>
rescue OryClient::ApiError => e
  puts "Error when calling FrontendApi->create_id_p_initiated_saml_browser_login_flow_with_http_info: #{e}"
end
```
...
begin
  # Get WebAuthn Related Origins
  result = api_instance.get_web_authn_related_origins
  p result
rescue OryClient::ApiError => e
  puts "Error when calling FrontendApi->get_web_authn_related_origins: #{e}"
end
```

#### Using the get_web_authn_related_origins_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<WebAuthnRelatedOrigins>, Integer, Hash)> get_web_authn_related_origins_with_http_info

```ruby
begin
  # Get WebAuthn Related Origins
  data, status_code, headers = api_instance.get_web_authn_related_origins_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <WebAuthnRelatedOrigins>
rescue OryClient::ApiError => e
  puts "Error when calling FrontendApi->get_web_authn_related_origins_with_http_info: #{e}"
end
```
...
begin
  # Change Password URL
  result = api_instance.get_well_known_change_password
  p result
rescue OryClient::ApiError => e
  puts "Error when calling FrontendApi->get_well_known_change_password: #{e}"
end
```

#### Using the get_well_known_change_password_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ErrorGeneric>, Integer, Hash)> get_well_known_change_password_with_http_info

```ruby
begin
  # Change Password URL
  data, status_code, headers = api_instance.get_well_known_change_password_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ErrorGeneric>
rescue OryClient::ApiError => e
  puts "Error when calling FrontendApi->get_well_known_change_password_with_http_info: #{e}"
end
```
...
opts = {
  ...
  page_size: 789, # Integer | Page Size  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination).
...
| **page_size** | **Integer** | Page Size  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). | [optional][default to 250] |
