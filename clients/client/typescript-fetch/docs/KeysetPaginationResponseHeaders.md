...
```typescript
import type { KeysetPaginationResponseHeaders } from '@ory/client-fetch'

// TODO: Update the object below with actual values
const example = {
  "link": null,
} satisfies KeysetPaginationResponseHeaders
...
const exampleParsed = JSON.parse(exampleJSON) as KeysetPaginationResponseHeaders
