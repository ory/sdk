...
```typescript
import type { BatchCreateImportedApiKeysRequest } from '@ory/client-fetch'

// TODO: Update the object below with actual values
const example = {
  "requests": null,
} satisfies BatchCreateImportedApiKeysRequest
...
const exampleParsed = JSON.parse(exampleJSON) as BatchCreateImportedApiKeysRequest
