...
import type { CreateBrowserLoginFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | An optional organization ID that should be used for logging this user in. This parameter is only effective in the Ory Network. (optional)
    organization: organization_example,
    // string | Via should contain the identity\'s credential the code should be sent to. Only relevant in aal2 flows.  DEPRECATED: This field is deprecated. Please remove it from your requests. The user will now see a choice of MFA credentials to choose from to perform the second factor instead. (optional)
    via: via_example,
    // string | An optional identity schema to use for the login flow. (optional)
    identitySchema: identitySchema_example,
  } satisfies CreateBrowserLoginFlowRequest;

  try {
    const data = await api.createBrowserLoginFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateBrowserLogoutFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    returnTo: returnTo_example,
  } satisfies CreateBrowserLogoutFlowRequest;

  try {
    const data = await api.createBrowserLogoutFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateBrowserRecoveryFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    // string | The URL to return the browser to after the flow was completed. (optional)
    returnTo: returnTo_example,
    // string | Skip redirection to the settings UI after the recovery flow was completed. Instead, the user will be redirected to the URL specified in `return_to` query parameter or the default return URL if `return_to` is not set. (optional)
    skipSettings: skipSettings_example,
  } satisfies CreateBrowserRecoveryFlowRequest;

  try {
    const data = await api.createBrowserRecoveryFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **returnTo** | `string` | The URL to return the browser to after the flow was completed. | [Optional] [Defaults to `undefined`] |
| **skipSettings** | `string` | Skip redirection to the settings UI after the recovery flow was completed. Instead, the user will be redirected to the URL specified in &#x60;return_to&#x60; query parameter or the default return URL if &#x60;return_to&#x60; is not set. | [Optional] [Defaults to `undefined`] |
...
import type { CreateBrowserRegistrationFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    afterVerificationReturnTo: afterVerificationReturnTo_example,
    // string | An optional organization ID that should be used to register this user. This parameter is only effective in the Ory Network. (optional)
    organization: organization_example,
    // string | An optional identity schema to use for the registration flow. (optional)
    identitySchema: identitySchema_example,
  } satisfies CreateBrowserRegistrationFlowRequest;

  try {
    const data = await api.createBrowserRegistrationFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateBrowserSettingsFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  try {
    const data = await api.createBrowserSettingsFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateBrowserVerificationFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    // string | The URL to return the browser to after the flow was completed. (optional)
    returnTo: returnTo_example,
  } satisfies CreateBrowserVerificationFlowRequest;

  try {
    const data = await api.createBrowserVerificationFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateFedcmFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  try {
    const data = await api.createFedcmFlow();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateIdPInitiatedSamlBrowserLoginFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    // string | The SAML provider ID as configured in the Ory Kratos configuration.
    provider: provider_example,
    // string | The single-use authorization code issued by Ory Polis for the unsolicited SAML response.
    code: code_example,
  } satisfies CreateIdPInitiatedSamlBrowserLoginFlowRequest;

  try {
    const data = await api.createIdPInitiatedSamlBrowserLoginFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **provider** | `string` | The SAML provider ID as configured in the Ory Kratos configuration. | [Defaults to `undefined`] |
| **code** | `string` | The single-use authorization code issued by Ory Polis for the unsolicited SAML response. | [Defaults to `undefined`] |
...
import type { CreateNativeLoginFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | An optional identity schema to use for the login flow. (optional)
    identitySchema: identitySchema_example,
  } satisfies CreateNativeLoginFlowRequest;

  try {
    const data = await api.createNativeLoginFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateNativeRecoveryFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  try {
    const data = await api.createNativeRecoveryFlow();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateNativeRegistrationFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | An optional identity schema to use for the registration flow. (optional)
    identitySchema: identitySchema_example,
  } satisfies CreateNativeRegistrationFlowRequest;

  try {
    const data = await api.createNativeRegistrationFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateNativeSettingsFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  try {
    const data = await api.createNativeSettingsFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateNativeVerificationFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    // string | A URL contained in the return_to key of the verification flow. This piece of data has no effect on the actual logic of the flow and is purely informational. (optional)
    returnTo: returnTo_example,
  } satisfies CreateNativeVerificationFlowRequest;

  try {
    const data = await api.createNativeVerificationFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DisableMyOtherSessionsRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    cookie: cookie_example,
  } satisfies DisableMyOtherSessionsRequest;

  try {
    const data = await api.disableMyOtherSessions(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DisableMySessionRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: `ory_kratos_session=a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f==`.  It is ok if more than one cookie are included here as all other cookies will be ignored. (optional)
    cookie: cookie_example,
  } satisfies DisableMySessionRequest;

  try {
    const data = await api.disableMySession(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { ExchangeSessionTokenRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    initCode: initCode_example,
    // string | The part of the code returned by the return_to URL.
    returnToCode: returnToCode_example,
  } satisfies ExchangeSessionTokenRequest;

  try {
    const data = await api.exchangeSessionToken(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetFlowErrorRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    id: id_example,
  } satisfies GetFlowErrorRequest;

  try {
    const data = await api.getFlowError(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetLoginFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies GetLoginFlowRequest;

  try {
    const data = await api.getLoginFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetRecoveryFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies GetRecoveryFlowRequest;

  try {
    const data = await api.getRecoveryFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetRegistrationFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies GetRegistrationFlowRequest;

  try {
    const data = await api.getRegistrationFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetSamlMetadataRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  try {
    const data = await api.getSamlMetadata();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetSamlProviderMetadataRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    // string | The SAML connection ID to get metadata for.
    provider: provider_example,
  } satisfies GetSamlProviderMetadataRequest;

  try {
    const data = await api.getSamlProviderMetadata(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetSettingsFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies GetSettingsFlowRequest;

  try {
    const data = await api.getSettingsFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetVerificationFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    cookie: cookie_example,
  } satisfies GetVerificationFlowRequest;

  try {
    const data = await api.getVerificationFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetWebAuthnJavaScriptRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  try {
    const data = await api.getWebAuthnJavaScript();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetWebAuthnRelatedOriginsRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  try {
    const data = await api.getWebAuthnRelatedOrigins();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { InitSamlLoginRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    // string | The SAML connection ID to start a native SP-initiated sign-in for.
    provider: provider_example,
    // string | The Login, Registration, or Settings Flow ID this SAML sign-in continues.
    flow: flow_example,
    // 'login' | 'registration' | 'settings-link' | The kind of flow `flow` names: `login`, `registration`, or `settings-link` (a settings flow linking a new SAML credential). The flow must exist in the named kind, or the request is not found.
    purpose: purpose_example,
  } satisfies InitSamlLoginRequest;

  try {
    const data = await api.initSamlLogin(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **purpose** | `login`, `registration`, `settings-link` | The kind of flow &#x60;flow&#x60; names: &#x60;login&#x60;, &#x60;registration&#x60;, or &#x60;settings-link&#x60; (a settings flow linking a new SAML credential). The flow must exist in the named kind, or the request is not found. | [Defaults to `undefined`] [Enum: login, registration, settings-link] |
...
import type { InitSamlLoginRequestRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // 'login' | 'registration' | 'settings-link' | The kind of flow `flow` names: `login`, `registration`, or `settings-link` (a settings flow linking a new SAML credential). The flow must exist in the named kind, or the request is not found.
    purpose: purpose_example,
  } satisfies InitSamlLoginRequestRequest;

  try {
    const data = await api.initSamlLoginRequest(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Array&lt;Session&gt; listMySessions(perPage, page, pageSize, pageToken, xSessionToken, cookie)
...
import type { ListMySessionsRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: `ory_kratos_session=a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f==`.  It is ok if more than one cookie are included here as all other cookies will be ignored. (optional)
    cookie: cookie_example,
  } satisfies ListMySessionsRequest;

  try {
    const data = await api.listMySessions(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { PerformNativeLogoutRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    performNativeLogoutBody: ...,
  } satisfies PerformNativeLogoutRequest;

  try {
    const data = await api.performNativeLogout(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { SubmitSamlAssertionRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    // string | The SAML connection ID this assertion is delivered for.
    provider: provider_example,
  ...
  } satisfies SubmitSamlAssertionRequest;

  try {
    const data = await api.submitSamlAssertion(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { ToSessionRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | Returns the session additionally as a token (such as a JWT)  The value of this parameter has to be a valid, configured Ory Session token template. For more information head over to [the documentation](http://ory.sh/docs/identities/session-to-jwt-cors). (optional)
    tokenizeAs: tokenizeAs_example,
  } satisfies ToSessionRequest;

  try {
    const data = await api.toSession(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **xSessionToken** | `string` | Set the Session Token when calling from non-browser clients. A session token has a format of &#x60;MP2YWEMeM8MxjkGKpH4dqOQ4Q4DlSPaj&#x60;. | [Optional] [Defaults to `undefined`] |
| **cookie** | `string` | Set the Cookie Header. This is especially useful when calling this endpoint from a server-side application. In that scenario you must include the HTTP Cookie Header which originally was included in the request to your server. An example of a session in the HTTP Cookie Header is: &#x60;ory_kratos_session&#x3D;a19iOVAbdzdgl70Rq1QZmrKmcjDtdsviCTZx7m9a9yHIUS8Wa9T7hvqyGTsLHi6Qifn2WUfpAKx9DWp0SJGleIn9vh2YF4A16id93kXFTgIgmwIOvbVAScyrx7yVl6bPZnCx27ec4WQDtaTewC1CpgudeDV2jQQnSaCP6ny3xa8qLH-QUgYqdQuoA_LF1phxgRCUfIrCLQOkolX5nv3ze_f&#x3D;&#x3D;&#x60;.  It is ok if more than one cookie are included here as all other cookies will be ignored. | [Optional] [Defaults to `undefined`] |
| **tokenizeAs** | `string` | Returns the session additionally as a token (such as a JWT)  The value of this parameter has to be a valid, configured Ory Session token template. For more information head over to [the documentation](http://ory.sh/docs/identities/session-to-jwt-cors). | [Optional] [Defaults to `undefined`] |
...
import type { UpdateFedcmFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    // UpdateFedcmFlowBody
    updateFedcmFlowBody: ...,
  } satisfies UpdateFedcmFlowRequest;

  try {
    const data = await api.updateFedcmFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateLoginFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies UpdateLoginFlowRequest;

  try {
    const data = await api.updateLoginFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateLogoutFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies UpdateLogoutFlowRequest;

  try {
    const data = await api.updateLogoutFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateRecoveryFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies UpdateRecoveryFlowRequest;

  try {
    const data = await api.updateRecoveryFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateRegistrationFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies UpdateRegistrationFlowRequest;

  try {
    const data = await api.updateRegistrationFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateSettingsFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies UpdateSettingsFlowRequest;

  try {
    const data = await api.updateSettingsFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateVerificationFlowRequest } from '@ory/client-fetch';
...
async function example() {
  ...
  const body = {
    ...
    // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
    cookie: cookie_example,
  } satisfies UpdateVerificationFlowRequest;

  try {
    const data = await api.updateVerificationFlow(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
