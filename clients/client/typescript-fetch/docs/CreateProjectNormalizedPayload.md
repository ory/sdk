...
```typescript
import type { CreateProjectNormalizedPayload } from '@ory/client-fetch'
...
const example = {
  ...
  "updated_at": null,
  "workspace_id": null,
} satisfies CreateProjectNormalizedPayload
...
const exampleParsed = JSON.parse(exampleJSON) as CreateProjectNormalizedPayload
