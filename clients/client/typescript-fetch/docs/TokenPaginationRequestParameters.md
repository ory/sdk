...
```typescript
import type { TokenPaginationRequestParameters } from '@ory/client-fetch'

// TODO: Update the object below with actual values
const example = {
  "page_size": null,
  "page_token": null,
} satisfies TokenPaginationRequestParameters
...
const exampleParsed = JSON.parse(exampleJSON) as TokenPaginationRequestParameters
