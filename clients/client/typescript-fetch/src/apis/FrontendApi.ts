...
import {
    ...
    WebAuthnRelatedOriginsFromJSON,
    WebAuthnRelatedOriginsToJSON,
} from '../models/index';
...
export interface CreateIdPInitiatedSamlBrowserLoginFlowRequest {
    provider: string;
    code: string;
}
...
export interface GetSamlProviderMetadataRequest {
    provider: string;
}
...
export interface InitSamlLoginRequest {
    provider: string;
    flow: string;
    purpose: InitSamlLoginPurposeEnum;
}

export interface InitSamlLoginRequestRequest {
    provider: string;
    flow: string;
    purpose: InitSamlLoginRequestPurposeEnum;
}
...
export interface SubmitSamlAssertionRequest {
    provider: string;
    relayState: string;
    sAMLResponse: string;
}
...
export class FrontendApi extends runtime.BaseAPI {
     ...
     */
    async createIdPInitiatedSamlBrowserLoginFlowRaw(requestParameters: CreateIdPInitiatedSamlBrowserLoginFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ErrorGeneric>> {
        if (requestParameters['provider'] == null) {
            throw new runtime.RequiredError(
                'provider',
                'Required parameter "provider" was null or undefined when calling createIdPInitiatedSamlBrowserLoginFlow().'
            );
        }
        ...
        if (requestParameters['code'] == null) {
            throw new runtime.RequiredError(
                'code',
                'Required parameter "code" was null or undefined when calling createIdPInitiatedSamlBrowserLoginFlow().'
            );
        }
        ...
        let urlPath = `/self-service/methods/saml/idp-initiated/{provider}`;
     ...
     * Complete IdP-Initiated SAML Login for Browsers
     */
    async createIdPInitiatedSamlBrowserLoginFlow(requestParameters: CreateIdPInitiatedSamlBrowserLoginFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ErrorGeneric> {
        const response = await this.createIdPInitiatedSamlBrowserLoginFlowRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getSamlMetadataRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};


        let urlPath = `/self-service/methods/saml/metadata`;
     ...
     * Get SAML SP Metadata
     */
    async getSamlMetadata(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.getSamlMetadataRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async getSamlProviderMetadataRaw(requestParameters: GetSamlProviderMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['provider'] == null) {
            throw new runtime.RequiredError(
                'provider',
                'Required parameter "provider" was null or undefined when calling getSamlProviderMetadata().'
            );
        }
        ...
        let urlPath = `/self-service/methods/saml/metadata/{provider}`;
        urlPath = urlPath.replace(`{${"provider"}}`, encodeURIComponent(String(requestParameters['provider'])));
     ...
     * Get Per-Connection SAML SP Metadata
     */
    async getSamlProviderMetadata(requestParameters: GetSamlProviderMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.getSamlProviderMetadataRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getWebAuthnRelatedOriginsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebAuthnRelatedOrigins>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};


        let urlPath = `/.well-known/webauthn`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => WebAuthnRelatedOriginsFromJSON(jsonValue));
    }
     ...
     * Get WebAuthn Related Origins
     */
    async getWebAuthnRelatedOrigins(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WebAuthnRelatedOrigins> {
        const response = await this.getWebAuthnRelatedOriginsRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async initSamlLoginRaw(requestParameters: InitSamlLoginRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['provider'] == null) {
            throw new runtime.RequiredError(
                'provider',
                'Required parameter "provider" was null or undefined when calling initSamlLogin().'
            );
        }
        ...
        if (requestParameters['flow'] == null) {
            throw new runtime.RequiredError(
                'flow',
                'Required parameter "flow" was null or undefined when calling initSamlLogin().'
            );
        }
        ...
        if (requestParameters['purpose'] == null) {
            throw new runtime.RequiredError(
                'purpose',
                'Required parameter "purpose" was null or undefined when calling initSamlLogin().'
            );
        }
        ...
        let urlPath = `/self-service/methods/saml/init/{provider}`;
        urlPath = urlPath.replace(`{${"provider"}}`, encodeURIComponent(String(requestParameters['provider'])));
     ...
     * Initiate Native SAML Sign-In
     */
    async initSamlLogin(requestParameters: InitSamlLoginRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.initSamlLoginRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async initSamlLoginRequestRaw(requestParameters: InitSamlLoginRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters['provider'] == null) {
            throw new runtime.RequiredError(
                'provider',
                'Required parameter "provider" was null or undefined when calling initSamlLoginRequest().'
            );
        }
        ...
        if (requestParameters['flow'] == null) {
            throw new runtime.RequiredError(
                'flow',
                'Required parameter "flow" was null or undefined when calling initSamlLoginRequest().'
            );
        }
        ...
        if (requestParameters['purpose'] == null) {
            throw new runtime.RequiredError(
                'purpose',
                'Required parameter "purpose" was null or undefined when calling initSamlLoginRequest().'
            );
        }
     ...
     * Initiate Native SAML Sign-In (Direct POST)
     */
    async initSamlLoginRequest(requestParameters: InitSamlLoginRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.initSamlLoginRequestRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async submitSamlAssertionRaw(requestParameters: SubmitSamlAssertionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ErrorGeneric>> {
        if (requestParameters['provider'] == null) {
            throw new runtime.RequiredError(
                'provider',
                'Required parameter "provider" was null or undefined when calling submitSamlAssertion().'
            );
        }
        ...
        if (requestParameters['relayState'] == null) {
            throw new runtime.RequiredError(
                'relayState',
                'Required parameter "relayState" was null or undefined when calling submitSamlAssertion().'
            );
        }
        ...
        if (requestParameters['sAMLResponse'] == null) {
            throw new runtime.RequiredError(
                'sAMLResponse',
                'Required parameter "sAMLResponse" was null or undefined when calling submitSamlAssertion().'
            );
        }
        ...
        let urlPath = `/self-service/methods/saml/acs/{provider}`;
        urlPath = urlPath.replace(`{${"provider"}}`, encodeURIComponent(String(requestParameters['provider'])));
     ...
     * Native SAML Assertion Consumer Service (ACS)
     */
    async submitSamlAssertion(requestParameters: SubmitSamlAssertionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ErrorGeneric> {
        const response = await this.submitSamlAssertionRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const InitSamlLoginPurposeEnum = {
    Login: 'login',
    Registration: 'registration',
    SettingsLink: 'settings-link',
    UnknownDefaultOpenApi: '11184809'
} as const;
export type InitSamlLoginPurposeEnum = typeof InitSamlLoginPurposeEnum[keyof typeof InitSamlLoginPurposeEnum];
/**
 * @export
 */
export const InitSamlLoginRequestPurposeEnum = {
    Login: 'login',
    Registration: 'registration',
    SettingsLink: 'settings-link',
    UnknownDefaultOpenApi: '11184809'
} as const;
export type InitSamlLoginRequestPurposeEnum = typeof InitSamlLoginRequestPurposeEnum[keyof typeof InitSamlLoginRequestPurposeEnum];
