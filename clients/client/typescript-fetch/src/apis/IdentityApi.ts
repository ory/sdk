...
import {
    ...
    CreateTestLoginFlowBodyFromJSON,
    CreateTestLoginFlowBodyToJSON,
    ...
    LoginFlowFromJSON,
    LoginFlowToJSON,
    ManageSessionsBodyFromJSON,
    ManageSessionsBodyToJSON,
    ManageSessionsResponseFromJSON,
    ManageSessionsResponseToJSON,
...
export interface CreateTestLoginFlowRequest {
...
export interface GetIdentityByExternalIDRequest {
    externalID: string;
    includeCredential?: Array<GetIdentityByExternalIDIncludeCredentialEnum>;
}
...
export class IdentityApi extends runtime.BaseAPI {
    ...
    async createRecoveryCodeForIdentityRaw(requestParameters: CreateRecoveryCodeForIdentityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecoveryCodeForIdentity>> {
        ...
        let urlPath = `/admin/recovery/code`;
    ...
    async createRecoveryLinkForIdentityRaw(requestParameters: CreateRecoveryLinkForIdentityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecoveryLinkForIdentity>> {
        ...
        let urlPath = `/admin/recovery/link`;
     ...
     */
    async createTestLoginFlowRaw(requestParameters: CreateTestLoginFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LoginFlow>> {
        if (requestParameters['createTestLoginFlowBody'] == null) {
            throw new runtime.RequiredError(
                'createTestLoginFlowBody',
                'Required parameter "createTestLoginFlowBody" was null or undefined when calling createTestLoginFlow().'
            );
        }
        ...
        let urlPath = `/admin/test-login-flows`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateTestLoginFlowBodyToJSON(requestParameters['createTestLoginFlowBody']),
        }, initOverrides);
     ...
     * Create a test OIDC login flow
     */
    async createTestLoginFlow(requestParameters: CreateTestLoginFlowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LoginFlow> {
        const response = await this.createTestLoginFlowRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async deleteIdentityRaw(requestParameters: DeleteIdentityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/admin/identities/{id}`;
    ...
    async deleteIdentityCredentialsRaw(requestParameters: DeleteIdentityCredentialsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/admin/identities/{id}/credentials/{type}`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
    ...
    async deleteIdentitySessionsRaw(requestParameters: DeleteIdentitySessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/admin/identities/{id}/sessions`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
    ...
    async extendSessionRaw(requestParameters: ExtendSessionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Session>> {
        ...
        let urlPath = `/admin/sessions/{id}/extend`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
     ...
     */
    async getIdentityByExternalIDRaw(requestParameters: GetIdentityByExternalIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Identity>> {
        if (requestParameters['externalID'] == null) {
            throw new runtime.RequiredError(
                'externalID',
                'Required parameter "externalID" was null or undefined when calling getIdentityByExternalID().'
            );
        }
        ...
        let urlPath = `/admin/identities/by/external/{externalID}`;
     ...
     * Get an Identity by its External ID
     */
    async getIdentityByExternalID(requestParameters: GetIdentityByExternalIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Identity> {
        const response = await this.getIdentityByExternalIDRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async manageSessionsRaw(requestParameters: ManageSessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ManageSessionsResponse>> {
        if (requestParameters['manageSessionsBody'] == null) {
            throw new runtime.RequiredError(
                'manageSessionsBody',
                'Required parameter "manageSessionsBody" was null or undefined when calling manageSessions().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ManageSessionsBodyToJSON(requestParameters['manageSessionsBody']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ManageSessionsResponseFromJSON(jsonValue));
    }
     ...
     * Manage sessions in bulk
     */
    async manageSessions(requestParameters: ManageSessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ManageSessionsResponse> {
        const response = await this.manageSessionsRaw(requestParameters, initOverrides);
        return await response.value();
    }
