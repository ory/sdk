...
import {
    ...
    CreateProjectApiKeyBodyFromJSON,
    CreateProjectApiKeyBodyToJSON,
    ...
    OplValidateResultFromJSON,
    OplValidateResultToJSON,
...
export interface ValidateOplRequest {
    projectId: string;
    body?: string;
}
...
export class ProjectApi extends runtime.BaseAPI {
     ...
     */
    async createProjectApiKeyRaw(requestParameters: CreateProjectApiKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProjectApiKey>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateProjectApiKeyBodyToJSON(requestParameters['createProjectApiKeyBody']),
        }, initOverrides);
     ...
     * Create project API key
     */
    async createProjectApiKey(requestParameters: CreateProjectApiKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProjectApiKey> {
     ...
     */
    async validateOplRaw(requestParameters: ValidateOplRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OplValidateResult>> {
        if (requestParameters['projectId'] == null) {
            throw new runtime.RequiredError(
                'projectId',
                'Required parameter "projectId" was null or undefined when calling validateOpl().'
            );
        }
        ...
        let urlPath = `/projects/{project_id}/opl/validate`;
        urlPath = urlPath.replace(`{${"project_id"}}`, encodeURIComponent(String(requestParameters['projectId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => OplValidateResultFromJSON(jsonValue));
    }
     ...
     * Validate an Ory Permission Language document
     */
    async validateOpl(requestParameters: ValidateOplRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OplValidateResult> {
        const response = await this.validateOplRaw(requestParameters, initOverrides);
        return await response.value();
    }
