...
export class ProjectApi extends runtime.BaseAPI {
    ...
    async createOrganizationOnboardingPortalLinkRaw(requestParameters: CreateOrganizationOnboardingPortalLinkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OnboardingPortalLink>> {
        ...
        const response = await this.request({
            path: `/projects/{project_id}/organizations/{organization_id}/onboarding-portal-links`.replace(`{${"project_id"}}`, encodeURIComponent(String(requestParameters['projectId']))).replace(`{${"organization_id"}}`, encodeURIComponent(String(requestParameters['organizationId']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async deleteOrganizationOnboardingPortalLinkRaw(requestParameters: DeleteOrganizationOnboardingPortalLinkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/projects/{project_id}/organizations/{organization_id}/onboarding-portal-links/{onboarding_portal_link_id}`.replace(`{${"project_id"}}`, encodeURIComponent(String(requestParameters['projectId']))).replace(`{${"organization_id"}}`, encodeURIComponent(String(requestParameters['organizationId']))).replace(`{${"onboarding_portal_link_id"}}`, encodeURIComponent(String(requestParameters['onboardingPortalLinkId']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
