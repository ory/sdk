...
import {
    AcceptDeviceUserCodeRequestFromJSON,
    AcceptDeviceUserCodeRequestToJSON,
    ...
    RotateOAuth2ClientSecretBodyFromJSON,
    RotateOAuth2ClientSecretBodyToJSON,
...
export interface AcceptUserCodeRequestRequest {
...
export interface DeleteRotatedOAuth2ClientSecretsRequest {
    id: string;
}
...
export class OAuth2Api extends runtime.BaseAPI {
    ...
    async acceptOAuth2ConsentRequestRaw(requestParameters: AcceptOAuth2ConsentRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2RedirectTo>> {
        ...
        let urlPath = `/admin/oauth2/auth/requests/consent/accept`;
    ...
    async acceptOAuth2LoginRequestRaw(requestParameters: AcceptOAuth2LoginRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2RedirectTo>> {
        ...
        let urlPath = `/admin/oauth2/auth/requests/login/accept`;
    ...
    async acceptOAuth2LogoutRequestRaw(requestParameters: AcceptOAuth2LogoutRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2RedirectTo>> {
        ...
        let urlPath = `/admin/oauth2/auth/requests/logout/accept`;
     ...
     * Accepts a device grant user_code request
     */
    async acceptUserCodeRequestRaw(requestParameters: AcceptUserCodeRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2RedirectTo>> {
        if (requestParameters['deviceChallenge'] == null) {
            throw new runtime.RequiredError(
                'deviceChallenge',
                'Required parameter "deviceChallenge" was null or undefined when calling acceptUserCodeRequest().'
            );
        }
        ...
        if (requestParameters['deviceChallenge'] != null) {
            queryParameters['device_challenge'] = requestParameters['deviceChallenge'];
        }
        ...
        let urlPath = `/admin/oauth2/auth/requests/device/accept`;
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: AcceptDeviceUserCodeRequestToJSON(requestParameters['acceptDeviceUserCodeRequest']),
        }, initOverrides);
     ...
     * Accepts a device grant user_code request
     */
    async acceptUserCodeRequest(requestParameters: AcceptUserCodeRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OAuth2RedirectTo> {
        const response = await this.acceptUserCodeRequestRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async deleteOAuth2TokenRaw(requestParameters: DeleteOAuth2TokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/admin/oauth2/tokens`;
     ...
     */
    async deleteRotatedOAuth2ClientSecretsRaw(requestParameters: DeleteRotatedOAuth2ClientSecretsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2Client>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling deleteRotatedOAuth2ClientSecrets().'
            );
        }
        ...
        let urlPath = `/admin/clients/{id}/secrets/rotate`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
     ...
     * Delete Rotated OAuth 2.0 Client Secrets
     */
    async deleteRotatedOAuth2ClientSecrets(requestParameters: DeleteRotatedOAuth2ClientSecretsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OAuth2Client> {
        const response = await this.deleteRotatedOAuth2ClientSecretsRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async deleteTrustedOAuth2JwtGrantIssuerRaw(requestParameters: DeleteTrustedOAuth2JwtGrantIssuerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/admin/trust/grants/jwt-bearer/issuers/{id}`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
    ...
    async getOAuth2ConsentRequestRaw(requestParameters: GetOAuth2ConsentRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2ConsentRequest>> {
        ...
        let urlPath = `/admin/oauth2/auth/requests/consent`;
    ...
    async getOAuth2LoginRequestRaw(requestParameters: GetOAuth2LoginRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2LoginRequest>> {
        ...
        let urlPath = `/admin/oauth2/auth/requests/login`;
    ...
    async getOAuth2LogoutRequestRaw(requestParameters: GetOAuth2LogoutRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2LogoutRequest>> {
        ...
        let urlPath = `/admin/oauth2/auth/requests/logout`;
    ...
    async introspectOAuth2TokenRaw(requestParameters: IntrospectOAuth2TokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IntrospectedOAuth2Token>> {
        ...
        let urlPath = `/admin/oauth2/introspect`;
    ...
    async listOAuth2ConsentSessionsRaw(requestParameters: ListOAuth2ConsentSessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<OAuth2ConsentSession>>> {
        ...
        let urlPath = `/admin/oauth2/auth/sessions/consent`;
    ...
    async listTrustedOAuth2JwtGrantIssuersRaw(requestParameters: ListTrustedOAuth2JwtGrantIssuersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<TrustedOAuth2JwtGrantIssuer>>> {
        ...
        let urlPath = `/admin/trust/grants/jwt-bearer/issuers`;
     ...
     */
    async oAuth2DeviceFlowRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeviceAuthorization>> {
        const queryParameters: any = {};
     ...
     * The OAuth 2.0 Device Authorize Endpoint
     */
    async oAuth2DeviceFlow(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeviceAuthorization> {
        const response = await this.oAuth2DeviceFlowRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async performOAuth2DeviceVerificationFlowRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ErrorOAuth2>> {
        const queryParameters: any = {};
     ...
     * OAuth 2.0 Device Verification Endpoint
     */
    async performOAuth2DeviceVerificationFlow(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ErrorOAuth2> {
        const response = await this.performOAuth2DeviceVerificationFlowRaw(initOverrides);
        return await response.value();
    }
    ...
    async rejectOAuth2ConsentRequestRaw(requestParameters: RejectOAuth2ConsentRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2RedirectTo>> {
        ...
        let urlPath = `/admin/oauth2/auth/requests/consent/reject`;
    ...
    async rejectOAuth2LoginRequestRaw(requestParameters: RejectOAuth2LoginRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2RedirectTo>> {
        ...
        let urlPath = `/admin/oauth2/auth/requests/login/reject`;
    ...
    async rejectOAuth2LogoutRequestRaw(requestParameters: RejectOAuth2LogoutRequestRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/admin/oauth2/auth/requests/logout/reject`;
    ...
    async revokeOAuth2LoginSessionsRaw(requestParameters: RevokeOAuth2LoginSessionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/admin/oauth2/auth/sessions/login`;
     ...
     */
    async rotateOAuth2ClientSecretRaw(requestParameters: RotateOAuth2ClientSecretRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2Client>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: RotateOAuth2ClientSecretBodyToJSON(requestParameters['rotateOAuth2ClientSecretBody']),
        }, initOverrides);
     ...
     * Rotate OAuth 2.0 Client Secret
     */
    async rotateOAuth2ClientSecret(requestParameters: RotateOAuth2ClientSecretRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OAuth2Client> {
    ...
    async setOAuth2ClientLifespansRaw(requestParameters: SetOAuth2ClientLifespansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OAuth2Client>> {
        ...
        let urlPath = `/admin/clients/{id}/lifespans`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
