...
export function PermissionsOnWorkspaceToJSON(json: any): PermissionsOnWorkspace {
    return PermissionsOnWorkspaceToJSONTyped(json, false);
}

export function PermissionsOnWorkspaceToJSONTyped(value?: PermissionsOnWorkspace | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
