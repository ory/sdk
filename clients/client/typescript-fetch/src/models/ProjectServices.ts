...
import {
    ...
    ProjectServiceOAuth2ToJSONTyped,
} from './ProjectServiceOAuth2';
import type { ProjectServiceTalos } from './ProjectServiceTalos';
import {
    ProjectServiceTalosFromJSON,
    ProjectServiceTalosFromJSONTyped,
    ProjectServiceTalosToJSON,
    ProjectServiceTalosToJSONTyped,
} from './ProjectServiceTalos';
...
import {
    ...
    ProjectServicePermissionToJSONTyped,
...
import {
    ...
    ProjectServiceIdentityToJSONTyped,
} from './ProjectServiceIdentity';
import type { ProjectServiceAccountExperience } from './ProjectServiceAccountExperience';
import {
    ProjectServiceAccountExperienceFromJSON,
    ProjectServiceAccountExperienceFromJSONTyped,
    ProjectServiceAccountExperienceToJSON,
    ProjectServiceAccountExperienceToJSONTyped,
} from './ProjectServiceAccountExperience';
...
export interface ProjectServices {
    /**
     * 
     * @type {ProjectServiceAccountExperience}
...
export function ProjectServicesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectServices {
    ...
    return {
        ...
        'account_experience': json['account_experience'] == null ? undefined : ProjectServiceAccountExperienceFromJSON(json['account_experience']),
        ...
        'talos': json['talos'] == null ? undefined : ProjectServiceTalosFromJSON(json['talos']),
    };
}

export function ProjectServicesToJSON(json: any): ProjectServices {
    return ProjectServicesToJSONTyped(json, false);
}

export function ProjectServicesToJSONTyped(value?: ProjectServices | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'account_experience': ProjectServiceAccountExperienceToJSON(value['account_experience']),
        ...
        'talos': ProjectServiceTalosToJSON(value['talos']),
    };
}
