...
import type { RegistrationFlowState } from './RegistrationFlowState';
import {
    RegistrationFlowStateFromJSON,
    RegistrationFlowStateFromJSONTyped,
    RegistrationFlowStateToJSON,
    RegistrationFlowStateToJSONTyped,
} from './RegistrationFlowState';
...
export interface RegistrationFlow {
     ...
     * link_recovery CredentialsTypeRecoveryLink is a special credential type linked to the link strategy (recovery flow).  It is not used within the credentials object itself.
...
export function RegistrationFlowFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegistrationFlow {
    ...
    return {
        ...
        'state': RegistrationFlowStateFromJSON(json['state']),
...
export function RegistrationFlowToJSON(json: any): RegistrationFlow {
    return RegistrationFlowToJSONTyped(json, false);
}

export function RegistrationFlowToJSONTyped(value?: RegistrationFlow | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'state': RegistrationFlowStateToJSON(value['state']),
