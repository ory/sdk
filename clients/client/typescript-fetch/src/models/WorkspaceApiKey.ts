...
export interface WorkspaceApiKey {
    ...
    readonly id: string;
    /**
     * The last characters of the key's value.
     * 
...
export function WorkspaceApiKeyToJSONTyped(value?: Omit<WorkspaceApiKey, 'created_at'|'id'|'last_characters'|'owner_id'|'updated_at'|'value'|'workspace_id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
