...
export function ListWorkspacesToJSON(json: any): ListWorkspaces {
    return ListWorkspacesToJSONTyped(json, false);
}

export function ListWorkspacesToJSONTyped(value?: ListWorkspaces | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
