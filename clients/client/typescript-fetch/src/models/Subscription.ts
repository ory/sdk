...
export function SubscriptionToJSONTyped(value?: Omit<Subscription, 'created_at'|'currency'|'current_interval'|'current_plan'|'customer_id'|'id'|'payed_until'|'updated_at'> | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'plan_changes_at': value['plan_changes_at'] == null ? value['plan_changes_at'] : value['plan_changes_at'].toISOString(),
        'plan_changes_to': value['plan_changes_to'],
        'status': value['status'],
        'stripe_checkout_expires_at': value['stripe_checkout_expires_at'] == null ? value['stripe_checkout_expires_at'] : value['stripe_checkout_expires_at'].toISOString(),
    };
}
