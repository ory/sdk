...
export function instanceOfSubscription(value: object): boolean {
    ...
    if (!('current_interval' in value)) return false;
    if (!('current_plan' in value)) return false;
    if (!('customer_id' in value)) return false;
    if (!('id' in value)) return false;
    if (!('interval_changes_to' in value)) return false;
    if (!('payed_until' in value)) return false;
    if (!('plan_changes_to' in value)) return false;
