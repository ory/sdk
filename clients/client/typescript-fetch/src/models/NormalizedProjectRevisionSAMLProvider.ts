...
export interface NormalizedProjectRevisionSAMLProvider {
     ...
     * 
     * When enabled, users can start a login from their identity provider's app
     * launcher. The Polis connection's default redirect URL then points at the
     * Kratos IdP-initiated login entry point instead of the SAML callback.
     * @type {boolean}
     * @memberof NormalizedProjectRevisionSAMLProvider
     */
    ...
    /**
     * UpdateIdentityOnLogin controls whether the identity is updated from SAML
     ...
     * @memberof NormalizedProjectRevisionSAMLProvider
     */
    update_identity_on_login?: NormalizedProjectRevisionSAMLProviderUpdateIdentityOnLoginEnum;
    /**
     ...
     * @memberof NormalizedProjectRevisionSAMLProvider
     */
    readonly valid_to?: Array<string>;
}
 ...
 * @export
 */
export const NormalizedProjectRevisionSAMLProviderUpdateIdentityOnLoginEnum = {
    Never: 'never',
    Automatic: 'automatic',
    UnknownDefaultOpenApi: '11184809'
} as const;
export type NormalizedProjectRevisionSAMLProviderUpdateIdentityOnLoginEnum = typeof NormalizedProjectRevisionSAMLProviderUpdateIdentityOnLoginEnum[keyof typeof NormalizedProjectRevisionSAMLProviderUpdateIdentityOnLoginEnum];
...
export function NormalizedProjectRevisionSAMLProviderFromJSONTyped(json: any, ignoreDiscriminator: boolean): NormalizedProjectRevisionSAMLProvider {
    ...
    return {
        ...
        'idp_initiated_login_enabled': json['idp_initiated_login_enabled'] == null ? undefined : json['idp_initiated_login_enabled'],
        ...
        'valid_to': json['valid_to'] == null ? undefined : json['valid_to'],
    };
}
...
export function NormalizedProjectRevisionSAMLProviderToJSONTyped(value?: Omit<NormalizedProjectRevisionSAMLProvider, 'created_at'|'updated_at'|'valid_to'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'idp_initiated_login_enabled': value['idp_initiated_login_enabled'],
        'label': value['label'],
