...
export function InternalIsOwnerForProjectBySlugBodyToJSON(json: any): InternalIsOwnerForProjectBySlugBody {
    return InternalIsOwnerForProjectBySlugBodyToJSONTyped(json, false);
}

export function InternalIsOwnerForProjectBySlugBodyToJSONTyped(value?: InternalIsOwnerForProjectBySlugBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
