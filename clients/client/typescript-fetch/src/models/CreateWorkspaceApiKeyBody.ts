...
export function CreateWorkspaceApiKeyBodyToJSON(json: any): CreateWorkspaceApiKeyBody {
    return CreateWorkspaceApiKeyBodyToJSONTyped(json, false);
}

export function CreateWorkspaceApiKeyBodyToJSONTyped(value?: CreateWorkspaceApiKeyBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
