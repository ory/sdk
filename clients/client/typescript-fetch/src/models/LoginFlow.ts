...
import type { LoginFlowTestContext } from './LoginFlowTestContext';
import {
    LoginFlowTestContextFromJSON,
    LoginFlowTestContextFromJSONTyped,
    LoginFlowTestContextToJSON,
    LoginFlowTestContextToJSONTyped,
} from './LoginFlowTestContext';
import type { LoginFlowState } from './LoginFlowState';
import {
    LoginFlowStateFromJSON,
    LoginFlowStateFromJSONTyped,
    LoginFlowStateToJSON,
    LoginFlowStateToJSONTyped,
} from './LoginFlowState';
...
export function LoginFlowFromJSONTyped(json: any, ignoreDiscriminator: boolean): LoginFlow {
    ...
    return {
        ...
        'state': LoginFlowStateFromJSON(json['state']),
        'test_context': json['test_context'] == null ? undefined : LoginFlowTestContextFromJSON(json['test_context']),
...
export function LoginFlowToJSONTyped(value?: LoginFlow | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'state': LoginFlowStateToJSON(value['state']),
        'test_context': LoginFlowTestContextToJSON(value['test_context']),
