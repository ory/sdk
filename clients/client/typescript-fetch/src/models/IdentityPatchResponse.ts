...
export function IdentityPatchResponseToJSON(json: any): IdentityPatchResponse {
    return IdentityPatchResponseToJSONTyped(json, false);
}

export function IdentityPatchResponseToJSONTyped(value?: IdentityPatchResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
