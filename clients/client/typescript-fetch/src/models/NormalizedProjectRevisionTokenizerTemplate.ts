...
export interface NormalizedProjectRevisionTokenizerTemplate {
     ...
     * JSON Web Key URL
     * 
     * The key set signs the tokens this template issues. It is write only and the
     * value will not be returned in response to a read request. An update that
     * leaves this field empty keeps the stored key set; supply a new one to rotate.
     * @type {string}
     * @memberof NormalizedProjectRevisionTokenizerTemplate
     */
    jwks_url?: string;
...
export function NormalizedProjectRevisionTokenizerTemplateToJSON(json: any): NormalizedProjectRevisionTokenizerTemplate {
    return NormalizedProjectRevisionTokenizerTemplateToJSONTyped(json, false);
}

export function NormalizedProjectRevisionTokenizerTemplateToJSONTyped(value?: Omit<NormalizedProjectRevisionTokenizerTemplate, 'created_at'|'id'|'updated_at'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
