...
export function OAuth2ConsentSessionExpiresAtToJSON(json: any): OAuth2ConsentSessionExpiresAt {
    return OAuth2ConsentSessionExpiresAtToJSONTyped(json, false);
}

export function OAuth2ConsentSessionExpiresAtToJSONTyped(value?: OAuth2ConsentSessionExpiresAt | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
