 ...
 * @export
 */
export type Usage = GenericUsage | boolean | number | string;
...
export function UsageFromJSONTyped(json: any, ignoreDiscriminator: boolean): Usage {
    ...
    if (instanceOfGenericUsage(json)) {
        return GenericUsageFromJSONTyped(json, true);
    }
...
export function UsageToJSON(json: any): any {
...
export function UsageToJSONTyped(value?: Usage | null, ignoreDiscriminator: boolean = false): any {
    ...
    if (instanceOfGenericUsage(value)) {
        return GenericUsageToJSON(value as GenericUsage);
    }
