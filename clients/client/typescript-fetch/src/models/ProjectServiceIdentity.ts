...
export function ProjectServiceIdentityToJSON(json: any): ProjectServiceIdentity {
    return ProjectServiceIdentityToJSONTyped(json, false);
}

export function ProjectServiceIdentityToJSONTyped(value?: ProjectServiceIdentity | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
