...
/**
 * Enrolls a new device key from a hardware-backed platform attestation.
 ...
 * the flow's `continue_with` items (action `show_pin_entry_ui`).
 * @export
 * @interface UpdateSettingsFlowWithDeviceAuthnMethodRegister
 */
export interface UpdateSettingsFlowWithDeviceAuthnMethodRegister {
    /**
     * The CBOR-encoded Apple App Attest attestation object for the new key.
     ...
     * certificate_chain_android or attestation_ios.
     * @type {string}
     * @memberof UpdateSettingsFlowWithDeviceAuthnMethodRegister
     */
    attestation_ios?: string;
    /**
     * The Android Key Attestation certificate chain for the new key, one
    ...
    /**
     * A human-readable name for the device, e.g. 'My work phone'. It helps the
     * user tell this key apart from others.
     * @type {string}
     * @memberof UpdateSettingsFlowWithDeviceAuthnMethodRegister
     */
    device_name: string;
    /**
     * Set to true to enroll the key as PIN-protected. The server then mints a
     ...
     * suite is DHKEM(X25519, HKDF-SHA256), HKDF-SHA256, AES-128-GCM.
     * @type {string}
     * @memberof UpdateSettingsFlowWithDeviceAuthnMethodRegister
     */
    transport_public_key?: string;
    /**
     * Declares how the key's holder is verified at use time. One of "pin", "platform", or "none" (or empty, which maps to "none"). "pin" is implied by pin_protected and need not be set explicitly.
     * 
    ...
    /**
     * The cryptography version to enroll the key with. Only `1` is currently
...
/**
 * Check if a given object implements the UpdateSettingsFlowWithDeviceAuthnMethodRegister interface.
 */
export function instanceOfUpdateSettingsFlowWithDeviceAuthnMethodRegister(value: object): value is UpdateSettingsFlowWithDeviceAuthnMethodRegister {
    if (!('device_name' in value) || value['device_name'] === undefined) return false;
    if (!('version' in value) || value['version'] === undefined) return false;
    return true;
}

export function UpdateSettingsFlowWithDeviceAuthnMethodRegisterFromJSON(json: any): UpdateSettingsFlowWithDeviceAuthnMethodRegister {
    return UpdateSettingsFlowWithDeviceAuthnMethodRegisterFromJSONTyped(json, false);
}

export function UpdateSettingsFlowWithDeviceAuthnMethodRegisterFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateSettingsFlowWithDeviceAuthnMethodRegister {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateSettingsFlowWithDeviceAuthnMethodRegisterToJSON(json: any): UpdateSettingsFlowWithDeviceAuthnMethodRegister {
    return UpdateSettingsFlowWithDeviceAuthnMethodRegisterToJSONTyped(json, false);
}

export function UpdateSettingsFlowWithDeviceAuthnMethodRegisterToJSONTyped(value?: UpdateSettingsFlowWithDeviceAuthnMethodRegister | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
