...
export function ErrorAuthenticatorAssuranceLevelNotSatisfiedToJSON(json: any): ErrorAuthenticatorAssuranceLevelNotSatisfied {
    return ErrorAuthenticatorAssuranceLevelNotSatisfiedToJSONTyped(json, false);
}

export function ErrorAuthenticatorAssuranceLevelNotSatisfiedToJSONTyped(value?: ErrorAuthenticatorAssuranceLevelNotSatisfied | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
