...
export function InternalIsAXWelcomeScreenEnabledForProjectBodyToJSON(json: any): InternalIsAXWelcomeScreenEnabledForProjectBody {
    return InternalIsAXWelcomeScreenEnabledForProjectBodyToJSONTyped(json, false);
}

export function InternalIsAXWelcomeScreenEnabledForProjectBodyToJSONTyped(value?: InternalIsAXWelcomeScreenEnabledForProjectBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
