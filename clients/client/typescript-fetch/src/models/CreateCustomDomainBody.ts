 ...
 */
export function instanceOfCreateCustomDomainBody(value: object): value is CreateCustomDomainBody {
    return true;
}
...
export function CreateCustomDomainBodyToJSON(json: any): CreateCustomDomainBody {
    return CreateCustomDomainBodyToJSONTyped(json, false);
}

export function CreateCustomDomainBodyToJSONTyped(value?: CreateCustomDomainBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
