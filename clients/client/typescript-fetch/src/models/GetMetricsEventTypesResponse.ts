...
export function GetMetricsEventTypesResponseToJSON(json: any): GetMetricsEventTypesResponse {
    return GetMetricsEventTypesResponseToJSONTyped(json, false);
}

export function GetMetricsEventTypesResponseToJSONTyped(value?: Omit<GetMetricsEventTypesResponse, 'events'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
