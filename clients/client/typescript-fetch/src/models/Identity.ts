 ...
 * @export
 */
export const IdentityRegionEnum = {
...
export type IdentityRegionEnum = typeof IdentityRegionEnum[keyof typeof IdentityRegionEnum];
...
export function IdentityToJSONTyped(value?: Identity | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'state': value['state'],
        'state_changed_at': value['state_changed_at'] == null ? value['state_changed_at'] : value['state_changed_at'].toISOString(),
        'traits': value['traits'],
