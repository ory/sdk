...
export function PaginationHeadersToJSON(json: any): PaginationHeaders {
    return PaginationHeadersToJSONTyped(json, false);
}

export function PaginationHeadersToJSONTyped(value?: PaginationHeaders | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
