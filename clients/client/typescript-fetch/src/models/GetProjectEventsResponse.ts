 ...
 */
export function instanceOfGetProjectEventsResponse(value: object): boolean {
...
export function GetProjectEventsResponseToJSON(value?: GetProjectEventsResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
