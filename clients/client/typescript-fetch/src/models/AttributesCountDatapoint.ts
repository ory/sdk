...
export function AttributesCountDatapointToJSON(json: any): AttributesCountDatapoint {
    return AttributesCountDatapointToJSONTyped(json, false);
}

export function AttributesCountDatapointToJSONTyped(value?: AttributesCountDatapoint | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
