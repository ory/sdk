...
import type { UpdateSettingsFlowWithDeviceAuthnMethod } from './UpdateSettingsFlowWithDeviceAuthnMethod';
import {
    instanceOfUpdateSettingsFlowWithDeviceAuthnMethod,
    UpdateSettingsFlowWithDeviceAuthnMethodFromJSON,
    UpdateSettingsFlowWithDeviceAuthnMethodFromJSONTyped,
    UpdateSettingsFlowWithDeviceAuthnMethodToJSON,
} from './UpdateSettingsFlowWithDeviceAuthnMethod';
 ...
 * @export
 */
export type UpdateSettingsFlowBody = { method: 'deviceauthn' } & UpdateSettingsFlowWithDeviceAuthnMethod | { method: 'lookup_secret' } & UpdateSettingsFlowWithLookupMethod | { method: 'oidc' } & UpdateSettingsFlowWithOidcMethod | { method: 'passkey' } & UpdateSettingsFlowWithPasskeyMethod | { method: 'password' } & UpdateSettingsFlowWithPasswordMethod | { method: 'profile' } & UpdateSettingsFlowWithProfileMethod | { method: 'saml' } & UpdateSettingsFlowWithSamlMethod | { method: 'totp' } & UpdateSettingsFlowWithTotpMethod | { method: 'webauthn' } & UpdateSettingsFlowWithWebAuthnMethod;
...
export function UpdateSettingsFlowBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateSettingsFlowBody {
    ...
    switch (json['method']) {
        case 'deviceauthn':
            return Object.assign({}, UpdateSettingsFlowWithDeviceAuthnMethodFromJSONTyped(json, true), { method: 'deviceauthn' } as const);
        case 'lookup_secret':
...
export function UpdateSettingsFlowBodyToJSONTyped(value?: UpdateSettingsFlowBody | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['method']) {
        case 'deviceauthn':
            return Object.assign({}, UpdateSettingsFlowWithDeviceAuthnMethodToJSON(value), { method: 'deviceauthn' } as const);
        case 'lookup_secret':
