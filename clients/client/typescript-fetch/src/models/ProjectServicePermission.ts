...
export function ProjectServicePermissionToJSON(json: any): ProjectServicePermission {
    return ProjectServicePermissionToJSONTyped(json, false);
}

export function ProjectServicePermissionToJSONTyped(value?: ProjectServicePermission | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
