...
export function GetManagedIdentitySchemaLocationToJSON(json: any): GetManagedIdentitySchemaLocation {
    return GetManagedIdentitySchemaLocationToJSONTyped(json, false);
}

export function GetManagedIdentitySchemaLocationToJSONTyped(value?: GetManagedIdentitySchemaLocation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
