...
export function instanceOfLoginFlowState(value: any): boolean {
    for (const key in LoginFlowState) {
        if (Object.prototype.hasOwnProperty.call(LoginFlowState, key)) {
            if (LoginFlowState[key as keyof typeof LoginFlowState] === value) {
                return true;
            }
        }
    }
...
export function LoginFlowStateToJSONTyped(value: any, ignoreDiscriminator: boolean): LoginFlowState {
    return value as LoginFlowState;
}
