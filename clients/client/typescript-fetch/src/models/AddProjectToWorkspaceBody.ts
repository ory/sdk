...
export interface AddProjectToWorkspaceBody {
     ...
     * migrate ProjectSubscriptionActionMigrate will migrate the project subscription to the  workspace.
     * ignore ProjectSubscriptionActionIgnore will ignore the project subscription.
     * @type {string}
     * @memberof AddProjectToWorkspaceBody
     */
