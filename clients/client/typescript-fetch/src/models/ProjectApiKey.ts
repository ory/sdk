...
export interface ProjectApiKey {
    ...
    readonly id: string;
    /**
     * The last characters of the token's value.
     * 
     ...
     * @memberof ProjectApiKey
     */
    readonly last_characters?: string;
    /**
     * The Token's Name
     * 
...
export function ProjectApiKeyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectApiKey {
    ...
    return {
        ...
        'id': json['id'],
        'last_characters': json['last_characters'] == null ? undefined : json['last_characters'],
        'name': json['name'],
...
export function ProjectApiKeyToJSONTyped(value?: Omit<ProjectApiKey, 'created_at'|'id'|'last_characters'|'owner_id'|'project_id'|'updated_at'|'value'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
