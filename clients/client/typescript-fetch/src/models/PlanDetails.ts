...
export interface PlanDetails {
     ...
     * @memberof PlanDetails
     */
    development_features: { [key: string]: Usage; };
    /**
     * 
     * @type {{ [key: string]: Usage; }}
     * @memberof PlanDetails
     */
    features: { [key: string]: Usage; };
    /**
     ...
     * @memberof PlanDetails
     */
    production_features: { [key: string]: Usage; };
    /**
     * 
     * @type {{ [key: string]: Usage; }}
     * @memberof PlanDetails
     */
    staging_features: { [key: string]: Usage; };
    /**
...
export function instanceOfPlanDetails(value: object): value is PlanDetails {
    ...
    if (!('development_features' in value) || value['development_features'] === undefined) return false;
    if (!('features' in value) || value['features'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('production_features' in value) || value['production_features'] === undefined) return false;
    if (!('staging_features' in value) || value['staging_features'] === undefined) return false;
    if (!('version' in value) || value['version'] === undefined) return false;
    if (!('yearly_only' in value) || value['yearly_only'] === undefined) return false;
    return true;
}
...
export function PlanDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanDetails {
    ...
    return {
        ...
        'development_features': (mapValues(json['development_features'], UsageFromJSON)),
        'features': (mapValues(json['features'], UsageFromJSON)),
        'latest': json['latest'] == null ? undefined : json['latest'],
        'name': json['name'],
        'production_features': (mapValues(json['production_features'], UsageFromJSON)),
        'staging_features': (mapValues(json['staging_features'], UsageFromJSON)),
        'version': json['version'],
        'yearly_only': json['yearly_only'],
    };
}
...
export function PlanDetailsToJSONTyped(value?: PlanDetails | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'development_features': (mapValues(value['development_features'], UsageToJSON)),
        'features': (mapValues(value['features'], UsageToJSON)),
        'latest': value['latest'],
        'name': value['name'],
        'production_features': (mapValues(value['production_features'], UsageToJSON)),
        'staging_features': (mapValues(value['staging_features'], UsageToJSON)),
        'version': value['version'],
        'yearly_only': value['yearly_only'],
    };
}
