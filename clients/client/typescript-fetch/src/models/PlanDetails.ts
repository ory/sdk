...
export function PlanDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanDetails {
    ...
    return {
        ...
        'development_features': (mapValues(json['development_features'], GenericUsageFromJSON)),
        'features': (mapValues(json['features'], GenericUsageFromJSON)),
        'latest': json['latest'] == null ? undefined : json['latest'],
        'name': json['name'],
        'production_features': (mapValues(json['production_features'], GenericUsageFromJSON)),
        'staging_features': (mapValues(json['staging_features'], GenericUsageFromJSON)),
...
export function PlanDetailsToJSONTyped(value?: PlanDetails | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'development_features': (mapValues(value['development_features'], GenericUsageToJSON)),
        'features': (mapValues(value['features'], GenericUsageToJSON)),
        'latest': value['latest'],
        'name': value['name'],
        'production_features': (mapValues(value['production_features'], GenericUsageToJSON)),
        'staging_features': (mapValues(value['staging_features'], GenericUsageToJSON)),
