...
export interface QuotaUsage {
     ...
     * kratos_oidc_front_channel_logout KratosOIDCFrontChannelLogout
     * deviceauthn Deviceauthn
     * keto_allow_opl_permit_relation_collision KetoAllowOPLPermitRelationCollision exempts a subscription from rejecting OPL  that declares the same name as both a relation and a permit.
     * keto_allow_opl_traverse_subject_set KetoAllowOPLTraverseSubjectSet exempts a subscription from rejecting OPL  that traverses a relation declared as a subject set. Override-only, for  legacy configurations; see the OPL reference for the supported shape.
     * allow_insecure_origins AllowInsecureOrigins grandfathers a project past strict wildcard  enforcement (CORS origins + return URLs). Override-only; never sold.
...
export const QuotaUsageFeatureEnum = {
    ...
    HideOryBranding: 'hide_ory_branding',
    ...
    TalosApiKeys: 'talos_api_keys',
    TalosRateLimit: 'talos_rate_limit',
    TalosCache: 'talos_cache',
    GracefulRefreshTokenCount: 'graceful_refresh_token_count',
    HydraTokenPrefix: 'hydra_token_prefix',
    HydraDeviceAuthorization: 'hydra_device_authorization',
    KratosOidcFrontChannelLogout: 'kratos_oidc_front_channel_logout',
    Deviceauthn: 'deviceauthn',
    KetoAllowOplPermitRelationCollision: 'keto_allow_opl_permit_relation_collision',
    KetoAllowOplTraverseSubjectSet: 'keto_allow_opl_traverse_subject_set',
    AllowInsecureOrigins: 'allow_insecure_origins',
    ...
    TalosAdminHighRateLimitTier: 'talos_admin_high_rate_limit_tier',
    TalosAdminMediumRateLimitTier: 'talos_admin_medium_rate_limit_tier',
    TalosAdminLowRateLimitTier: 'talos_admin_low_rate_limit_tier',
    TalosPublicHighRateLimitTier: 'talos_public_high_rate_limit_tier',
    TalosPublicLowRateLimitTier: 'talos_public_low_rate_limit_tier',
