...
import {
    ...
    ManagedIdentitySchemaToJSONTyped,
...
export function NormalizedProjectRevisionIdentitySchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): NormalizedProjectRevisionIdentitySchema {
    ...
    return {
        ...
        'selfservice_selectable': json['selfservice_selectable'] == null ? undefined : json['selfservice_selectable'],
        'updated_at': json['updated_at'] == null ? undefined : (new Date(json['updated_at'])),
    };
}

export function NormalizedProjectRevisionIdentitySchemaToJSON(json: any): NormalizedProjectRevisionIdentitySchema {
    return NormalizedProjectRevisionIdentitySchemaToJSONTyped(json, false);
}

export function NormalizedProjectRevisionIdentitySchemaToJSONTyped(value?: Omit<NormalizedProjectRevisionIdentitySchema, 'created_at'|'updated_at'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'selfservice_selectable': value['selfservice_selectable'],
    };
}
