...
export function EmailTemplateDataBodyToJSON(json: any): EmailTemplateDataBody {
    return EmailTemplateDataBodyToJSONTyped(json, false);
}

export function EmailTemplateDataBodyToJSONTyped(value?: EmailTemplateDataBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
