 ...
 */
export function instanceOfGetMetricsEventAttributesResponse(value: object): boolean {
...
export function GetMetricsEventAttributesResponseToJSON(value?: GetMetricsEventAttributesResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
