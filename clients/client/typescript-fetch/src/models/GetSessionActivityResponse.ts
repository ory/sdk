...
export function GetSessionActivityResponseToJSON(json: any): GetSessionActivityResponse {
    return GetSessionActivityResponseToJSONTyped(json, false);
}

export function GetSessionActivityResponseToJSONTyped(value?: Omit<GetSessionActivityResponse, 'data'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
