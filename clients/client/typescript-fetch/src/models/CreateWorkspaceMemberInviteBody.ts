...
export interface CreateWorkspaceMemberInviteBody {
     ...
     * viewer WorkspaceMemberRoleViewer
     * @type {string}
     * @memberof CreateWorkspaceMemberInviteBody
     */
...
export function CreateWorkspaceMemberInviteBodyToJSON(json: any): CreateWorkspaceMemberInviteBody {
    return CreateWorkspaceMemberInviteBodyToJSONTyped(json, false);
}

export function CreateWorkspaceMemberInviteBodyToJSONTyped(value?: CreateWorkspaceMemberInviteBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
