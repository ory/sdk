...
export interface NormalizedProjectRevisionThirdPartyProvider {
     ...
     * automatic AccountLinkingModeAutomatic silently links accounts if the provider verifies email ownership.
     * confirm_with_existing_credential AccountLinkingModeConfirmWithExistingCredential requires the user to confirm the account linking by providing an existing credential.
     * @type {string}
     * @memberof NormalizedProjectRevisionThirdPartyProvider
     */
    ...
    /**
     * FrontChannelLogout enables OpenID Connect Front-Channel Logout for this
     * provider: a login issues a companion cookie that lets the provider end
     * the resulting Ory session from its own sign-out page.
     * 
     * Requires the provider to return the `sid` claim in the ID token.
     * @type {boolean}
     * @memberof NormalizedProjectRevisionThirdPartyProvider
     */
    ...
    token_url?: string;
    /**
     * UpdateIdentityOnLogin controls whether the identity is updated from OIDC
     * claims on each login.
     * 
     * Possible values are "never" (default) and "automatic".
     * never UpdateIdentityOnLoginNever disables identity updates on login (default).
     * automatic UpdateIdentityOnLoginAutomatic re-runs the Jsonnet claims mapper on every login and updates the identity's traits and metadata automatically.
     * @type {string}
     * @memberof NormalizedProjectRevisionThirdPartyProvider
     */
...
export function NormalizedProjectRevisionThirdPartyProviderFromJSONTyped(json: any, ignoreDiscriminator: boolean): NormalizedProjectRevisionThirdPartyProvider {
    ...
    return {
        ...
        'aal2_acr_values': json['aal2_acr_values'] == null ? undefined : json['aal2_acr_values'],
        'aal2_amr_values': json['aal2_amr_values'] == null ? undefined : json['aal2_amr_values'],
        'account_linking_mode': json['account_linking_mode'] == null ? undefined : json['account_linking_mode'],
        ...
        'front_channel_logout': json['front_channel_logout'] == null ? undefined : json['front_channel_logout'],
        ...
        'update_identity_on_login': json['update_identity_on_login'] == null ? undefined : json['update_identity_on_login'],
...
export function NormalizedProjectRevisionThirdPartyProviderToJSONTyped(value?: Omit<NormalizedProjectRevisionThirdPartyProvider, 'created_at'|'proxy_oidc_redirect_url'|'updated_at'> | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'aal2_acr_values': value['aal2_acr_values'],
        'aal2_amr_values': value['aal2_amr_values'],
        'account_linking_mode': value['account_linking_mode'],
        ...
        'front_channel_logout': value['front_channel_logout'],
        'id': value['id'],
        ...
        'update_identity_on_login': value['update_identity_on_login'],
    };
}
