...
export function SetActiveProjectInConsoleBodyToJSON(json: any): SetActiveProjectInConsoleBody {
    return SetActiveProjectInConsoleBodyToJSONTyped(json, false);
}

export function SetActiveProjectInConsoleBodyToJSONTyped(value?: SetActiveProjectInConsoleBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
