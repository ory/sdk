...
export function InternalGetProjectBrandingBodyToJSON(json: any): InternalGetProjectBrandingBody {
    return InternalGetProjectBrandingBodyToJSONTyped(json, false);
}

export function InternalGetProjectBrandingBodyToJSONTyped(value?: InternalGetProjectBrandingBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
