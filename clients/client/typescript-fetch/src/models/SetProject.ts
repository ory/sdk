...
export function SetProjectToJSON(json: any): SetProject {
    return SetProjectToJSONTyped(json, false);
}

export function SetProjectToJSONTyped(value?: SetProject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
