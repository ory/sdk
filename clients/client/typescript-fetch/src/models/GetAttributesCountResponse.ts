 ...
 */
export function instanceOfGetAttributesCountResponse(value: object): boolean {
...
export function GetAttributesCountResponseToJSON(value?: GetAttributesCountResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
