...
export function InviteTokenBodyToJSON(json: any): InviteTokenBody {
    return InviteTokenBodyToJSONTyped(json, false);
}

export function InviteTokenBodyToJSONTyped(value?: InviteTokenBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
