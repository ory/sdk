...
export function ActiveProjectInConsoleToJSON(json: any): ActiveProjectInConsole {
    return ActiveProjectInConsoleToJSONTyped(json, false);
}

export function ActiveProjectInConsoleToJSONTyped(value?: ActiveProjectInConsole | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
