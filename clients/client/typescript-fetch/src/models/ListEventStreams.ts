...
export function ListEventStreamsToJSON(json: any): ListEventStreams {
    return ListEventStreamsToJSONTyped(json, false);
}

export function ListEventStreamsToJSONTyped(value?: ListEventStreams | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
