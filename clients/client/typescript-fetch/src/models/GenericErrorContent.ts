...
export function GenericErrorContentToJSON(json: any): GenericErrorContent {
    return GenericErrorContentToJSONTyped(json, false);
}

export function GenericErrorContentToJSONTyped(value?: GenericErrorContent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
