...
export function MetricsDatapointToJSON(json: any): MetricsDatapoint {
    return MetricsDatapointToJSONTyped(json, false);
}

export function MetricsDatapointToJSONTyped(value?: MetricsDatapoint | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
