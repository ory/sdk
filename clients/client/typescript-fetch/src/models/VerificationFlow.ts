...
import type { VerificationFlowState } from './VerificationFlowState';
import {
    VerificationFlowStateFromJSON,
    VerificationFlowStateFromJSONTyped,
    VerificationFlowStateToJSON,
    VerificationFlowStateToJSONTyped,
} from './VerificationFlowState';
...
export function VerificationFlowFromJSONTyped(json: any, ignoreDiscriminator: boolean): VerificationFlow {
    ...
    return {
        ...
        'state': VerificationFlowStateFromJSON(json['state']),
...
export function VerificationFlowToJSONTyped(value?: VerificationFlow | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'state': VerificationFlowStateToJSON(value['state']),
