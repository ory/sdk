...
export function SessionActivityDatapointToJSON(json: any): SessionActivityDatapoint {
    return SessionActivityDatapointToJSONTyped(json, false);
}

export function SessionActivityDatapointToJSONTyped(value?: SessionActivityDatapoint | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
