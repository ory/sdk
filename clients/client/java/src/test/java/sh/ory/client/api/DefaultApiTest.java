...
public class DefaultApiTest {
    ...
    public void getSelfServiceErrorAdminTest() throws ApiException {
        String error = null;
        ErrorContainer response = api.getSelfServiceErrorAdmin(error);
    ...
    public void getSelfServiceSettingsFlowAdminTest() throws ApiException {
        String id = null;
        SettingsFlow response = api.getSelfServiceSettingsFlowAdmin(id);
     ...
     */
    @Test
    public void initializeSelfServiceRegistrationTest() throws ApiException {
        RegistrationFlow response = api.initializeSelfServiceRegistration();
