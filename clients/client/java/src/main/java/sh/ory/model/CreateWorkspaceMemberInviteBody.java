 ...
 */
@ApiModel(description = "Create Workspace Invite Request Body")
...
public class CreateWorkspaceMemberInviteBody {
  ...
  **/
  ...
  @ApiModelProperty(value = "A email to invite")
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateWorkspaceMemberInviteBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateWorkspaceMemberInviteBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
