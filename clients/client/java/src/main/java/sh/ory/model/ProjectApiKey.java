...
public class ProjectApiKey {
  ...
  public static final String SERIALIZED_NAME_LAST_CHARACTERS = "last_characters";
  @SerializedName(SERIALIZED_NAME_LAST_CHARACTERS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, projectApiKey.createdAt) &&
        ...
        Objects.equals(this.lastCharacters, projectApiKey.lastCharacters) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, expiresAt, id, lastCharacters, name, ownerId, projectId, updatedAt, value, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    lastCharacters: ").append(toIndentedString(lastCharacters)).append("\n");
  ...
  static {
    ...
    openapiFields.add("last_characters");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("last_characters") != null && !jsonObj.get("last_characters").isJsonNull()) && !jsonObj.get("last_characters").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `last_characters` to be a primitive type in the JSON string but got `%s`", jsonObj.get("last_characters").toString()));
      }
