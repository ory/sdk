...
public class ProjectCors {
  ...
  **/
  ...
  @ApiModelProperty(value = "Whether CORS is enabled for this endpoint.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The allowed origins. Use `*` to allow all origins. A wildcard can also be used in the subdomain, i.e. `https://_*.example.com` will allow all origins on all subdomains of `example.com`.")
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectCors
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectCors.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
