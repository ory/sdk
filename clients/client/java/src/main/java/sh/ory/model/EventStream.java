 ...
 * Event Stream
 */
@ApiModel(description = "Event Stream")
...
public class EventStream {
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventStream
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventStream.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
