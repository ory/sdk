...
public class CreateWorkspaceSubscriptionBody {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateWorkspaceSubscriptionBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateWorkspaceSubscriptionBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
