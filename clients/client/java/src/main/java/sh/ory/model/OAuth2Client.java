...
public class OAuth2Client {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID is the id for this client.  The ID is autogenerated and immutable.")
  ...
  **/
  ...
  public OAuth2Client passwordGrantAccessTokenLifespan(String passwordGrantAccessTokenLifespan) {
  ...
  **/
  ...
  public OAuth2Client passwordGrantRefreshTokenLifespan(String passwordGrantRefreshTokenLifespan) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "RegistrationAccessToken can be used to update, get, or delete the OAuth2 Client.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "RegistrationClientURI is the URL used to update, get, or delete the OAuth2 Client.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "scope1 scope-2 scope.3 scope:4", value = "Scope is a string containing a space-separated list of scope values (as described in Section 3.3 of OAuth 2.0 [RFC6749]) that the client can use when requesting access tokens.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowedCorsOrigins, oAuth2Client.allowedCorsOrigins) &&
        ...
        Objects.equals(this.passwordGrantAccessTokenLifespan, oAuth2Client.passwordGrantAccessTokenLifespan) &&
        Objects.equals(this.passwordGrantRefreshTokenLifespan, oAuth2Client.passwordGrantRefreshTokenLifespan) &&
