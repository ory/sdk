...
public class ErrorBrowserLocationChangeRequired {
  ...
  public ErrorBrowserLocationChangeRequired error(ErrorGeneric error) {
    this.error = error;
    return this;
  }
  ...
  public void setError(ErrorGeneric error) {
    this.error = error;
  }
   ...
   * @return the ErrorBrowserLocationChangeRequired instance itself
   */
  public ErrorBrowserLocationChangeRequired putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, errorBrowserLocationChangeRequired.error) &&
        Objects.equals(this.redirectBrowserTo, errorBrowserLocationChangeRequired.redirectBrowserTo)&&
        Objects.equals(this.additionalProperties, errorBrowserLocationChangeRequired.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ErrorBrowserLocationChangeRequired
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorBrowserLocationChangeRequired.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        ErrorGeneric.validateJsonElement(jsonObj.get("error"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ErrorBrowserLocationChangeRequired>() {
           ...
           public ErrorBrowserLocationChangeRequired read(JsonReader in) throws IOException {
             ...
             ErrorBrowserLocationChangeRequired instance = thisAdapter.fromJsonTree(jsonObj);
