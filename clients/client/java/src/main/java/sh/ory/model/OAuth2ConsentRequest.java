...
public class OAuth2ConsentRequest {
  ...
  public static final String SERIALIZED_NAME_DEVICE_CHALLENGE_ID = "device_challenge_id";
  @SerializedName(SERIALIZED_NAME_DEVICE_CHALLENGE_ID)
  private String deviceChallengeId;
  ...
  public OAuth2ConsentRequest deviceChallengeId(String deviceChallengeId) {
    this.deviceChallengeId = deviceChallengeId;
    return this;
  }

  /**
   * DeviceChallenge is the device challenge this consent challenge belongs to, if this flow was initiated by a device.
   * @return deviceChallengeId
   */
  @javax.annotation.Nullable
  public String getDeviceChallengeId() {
    return deviceChallengeId;
  }

  public void setDeviceChallengeId(String deviceChallengeId) {
    this.deviceChallengeId = deviceChallengeId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acr, oAuth2ConsentRequest.acr) &&
        ...
        Objects.equals(this.deviceChallengeId, oAuth2ConsentRequest.deviceChallengeId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acr, amr, challenge, client, consentRequestId, context, deviceChallengeId, loginChallenge, loginSessionId, oidcContext, requestUrl, requestedAccessTokenAudience, requestedScope, skip, subject, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    deviceChallengeId: ").append(toIndentedString(deviceChallengeId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("device_challenge_id");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("device_challenge_id") != null && !jsonObj.get("device_challenge_id").isJsonNull()) && !jsonObj.get("device_challenge_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `device_challenge_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("device_challenge_id").toString()));
      }
