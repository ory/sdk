...
public class V0alpha0Api {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> successfulUpdateProjectConfig </td><td>  -  </td></tr>
     ...
     */
    public SuccessfulUpdateProjectConfig updateProjectConfig(String projectId, UpdateProjectConfigConfig updateProjectConfigConfig) throws ApiException {
        ApiResponse<SuccessfulUpdateProjectConfig> localVarResp = updateProjectConfigWithHttpInfo(projectId, updateProjectConfigConfig);
        return localVarResp.getData();
    }
     ...
     * @param projectId Project ID  The project&#39;s ID. (required)
     * @param updateProjectConfigConfig  (optional)
     * @return ApiResponse&lt;SuccessfulUpdateProjectConfig&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SuccessfulUpdateProjectConfig> updateProjectConfigWithHttpInfo(String projectId, UpdateProjectConfigConfig updateProjectConfigConfig) throws ApiException {
        okhttp3.Call localVarCall = updateProjectConfigValidateBeforeCall(projectId, updateProjectConfigConfig, null);
        Type localVarReturnType = new TypeToken<SuccessfulUpdateProjectConfig>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateProjectConfigAsync(String projectId, UpdateProjectConfigConfig updateProjectConfigConfig, final ApiCallback<SuccessfulUpdateProjectConfig> _callback) throws ApiException {
