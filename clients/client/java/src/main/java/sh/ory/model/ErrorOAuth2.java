...
public class ErrorOAuth2 {
  ...
  **/
   ...
   * @return the ErrorOAuth2 instance itself
   */
  public ErrorOAuth2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, errorOAuth2.error) &&
        ...
        Objects.equals(this.additionalProperties, errorOAuth2.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ErrorOAuth2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ErrorOAuth2>() {
           ...
           public ErrorOAuth2 read(JsonReader in) throws IOException {
             ...
             ErrorOAuth2 instance = thisAdapter.fromJsonTree(jsonObj);
