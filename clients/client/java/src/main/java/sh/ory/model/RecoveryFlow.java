...
public class RecoveryFlow {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Contains possible actions that could follow this flow")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "State represents the state of this request:  choose_method: ask the user to choose a method (e.g. recover account via email) sent_email: the email has been sent to the user passed_challenge: the request was successful and the recovery challenge was passed.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, continueWith, expiresAt, id, issuedAt, requestUrl, returnTo, state, type, ui, additionalProperties);
  }
