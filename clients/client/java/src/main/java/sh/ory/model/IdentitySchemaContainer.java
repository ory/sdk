...
public class IdentitySchemaContainer {
   ...
   * @throws IOException if the JSON Element is invalid with respect to IdentitySchemaContainer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdentitySchemaContainer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (String requiredField : IdentitySchemaContainer.openapiRequiredFields) {
