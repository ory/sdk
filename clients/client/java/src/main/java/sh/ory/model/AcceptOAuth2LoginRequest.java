...
public class AcceptOAuth2LoginRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "IdentityProviderSessionID is the session ID of the end-user that authenticated. If specified, we will use this value to propagate the logout.")
