...
public class JSON {
        ...
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                .registerTypeSelector(sh.ory.model.ContinueWith.class, new TypeSelector<sh.ory.model.ContinueWith>() {
                    ...
                    public Class<? extends sh.ory.model.ContinueWith> getClassForElement(JsonElement readElement) {
                        ...
                        classByDiscriminatorValue.put("show_pin_entry_ui", sh.ory.model.ContinueWithDeviceAuthnPinEntryUi.class);
                        ...
                        classByDiscriminatorValue.put("continueWithDeviceAuthnPinEntryUi", sh.ory.model.ContinueWithDeviceAuthnPinEntryUi.class);
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AcceptDeviceUserCodeRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AccountExperienceColors.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AccountExperienceConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AddProjectToWorkspaceBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AddWorkspaceOrganizationDomainBody.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AdminRevokeImportedApiKeyBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AdminRevokeIssuedApiKeyBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AdminRotateIssuedApiKeyBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AdminUpdateImportedApiKeyRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AdminUpdateIssuedApiKeyRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.AiAssistantSessionToken.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.Any.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BasicOrganization.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BatchCheckPermissionBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BatchCheckPermissionResult.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BatchCreateImportedApiKeysRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BatchCreateImportedApiKeysResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BatchCreateImportedApiKeysResult.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BatchPatchIdentitiesResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BatchVerifyApiKeysRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BatchVerifyApiKeysResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.BillingPeriodBucket.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CheckPermissionResultWithError.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ContinueWithDeviceAuthnPinEntryUi.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ContinueWithDeviceAuthnPinEntryUiData.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateOnboardingLinkResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateOrganizationOnboardingPortalLinkBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateProjectApiKeyBody.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateSubscriptionCommon.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateTestLoginFlowBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateTestLoginFlowFromOnboardingPortalLinkBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateVerifiableCredentialRequestBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateWorkspaceApiKeyBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateWorkspaceBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateWorkspaceContactBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateWorkspaceMemberInviteBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateWorkspaceOrganizationBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CreateWorkspaceSubscriptionBody.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.CustomerPortalAvailability.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.DeleteMySessionsCount.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.DeriveTokenRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.DeriveTokenResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.DeviceAuthorization.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.DeviceUserAuthRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.DomainVerificationStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ElementsConfiguration.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.FeatureFlagsCatalogEntry.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GenericOIDCProvider.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GenericUsage.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetAttributesCount.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetJWKSResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetJWKSResponseJwks.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetJWKSResponseJwksKeysInner.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetManagedIdentitySchemaLocation.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetMetricsCount.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetMetricsEventAttributes.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetMetricsEventTypes.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetOrganizationResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetOrganizationsByHostnameResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetProjectEvents.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetProjectEventsBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetProjectMetrics.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.GetSessionActivity.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.IPRestriction.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ImportApiKeyRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ImportedApiKey.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.InternalIsOwnerForProjectBySlug.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.InviteTokenBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.Invoice.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.InvoiceDataV1.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.IsOwnerForProjectBySlug.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.IssueApiKeyRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.IssueApiKeyResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.IssuedApiKey.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.KeysetPaginationRequestParameters.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.KeysetPaginationResponseHeaders.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.LineItemV1.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ListEventStreams.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ListImportedApiKeysResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ListInvoicesResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ListIssuedApiKeysResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ListOrganizationsResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ListWorkspaceContacts.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ListWorkspaceProjects.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ListWorkspaces.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ManageSessionsBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ManageSessionsResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.NormalizedProjectRevisionSAMLProvider.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.NormalizedProjectRevisionScimClient.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.OnboardingPortalLink.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.OnboardingPortalOrganization.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.OnboardingPortalTestLoginFlow.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.OplParseError.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.OplSourcePosition.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.OplValidateResult.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.OrganizationByHostname.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.OrganizationOnboardingPortalLinksResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.PINConfig.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.PatchWorkspaceContactBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.PatchWorkspaceMemberBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.PerformNativeLogoutBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.PermissionsOnWorkspace.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ProjectMember.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ProjectMetadata.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ProjectServiceAccountExperience.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ProjectServiceTalos.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.RateLimitPolicy.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.RevisionAccountExperienceCustomTranslation.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.RotateIssuedApiKeyResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.RotateOAuth2ClientSecretBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.RotateTalosKeyBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.SchemaPatch.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.SelfRevokeApiKeyRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.SetOrganizationFromOnboardingPortalLinkBody.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.Status.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.TalosRetiredValue.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.TaxLineItem.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.TimeInterval.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.Token.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.UpdateOrganizationOnboardingPortalLinkBody.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.UpdateSettingsFlowWithDeviceAuthnMethodRegister.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.UpdateSettingsFlowWithDeviceAuthnMethodRotateSecret.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.UpdateWorkspaceBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.UpdateWorkspaceOrganizationBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.Usage.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ValidateBaseURLRewriteRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.ValidateBaseURLRewriteResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.VerifyApiKeyRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.VerifyApiKeyResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.VerifyUserCodeRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.WebAuthnRelatedOrigins.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.Workspace.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.WorkspaceApiKey.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.WorkspaceContact.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.WorkspaceContactRecipient.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.WorkspaceContactRecipientInput.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sh.ory.model.WorkspaceOrganization.CustomTypeAdapterFactory());
