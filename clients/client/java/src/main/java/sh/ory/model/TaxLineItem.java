...
public class TaxLineItem {
  ...
  public TaxLineItem amountInCent(Long amountInCent) {
  ...
  public TaxLineItem title(String title) {
    this.title = title;
    return this;
  }
   ...
   * @return the TaxLineItem instance itself
   */
  public TaxLineItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amountInCent, taxLineItem.amountInCent) &&
        Objects.equals(this.title, taxLineItem.title)&&
        Objects.equals(this.additionalProperties, taxLineItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amountInCent, title, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TaxLineItem>() {
           ...
           public TaxLineItem read(JsonReader in) throws IOException {
             ...
             TaxLineItem instance = thisAdapter.fromJsonTree(jsonObj);
