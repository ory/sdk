...
public class RegistrationFlow {
  ...
  public RegistrationFlow state(RegistrationFlowState state) {
    this.state = state;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public RegistrationFlowState getState() {
    return state;
  }

  public void setState(RegistrationFlowState state) {
    this.state = state;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      RegistrationFlowState.validateJsonElement(jsonObj.get("state"));
