...
public class RegistrationFlow {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, expiresAt, id, issuedAt, oauth2LoginChallenge, oauth2LoginRequest, requestUrl, returnTo, sessionTokenExchangeCode, state, transientPayload, type, ui, additionalProperties);
  }
