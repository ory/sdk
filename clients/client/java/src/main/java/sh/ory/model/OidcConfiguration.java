...
public class OidcConfiguration {
  ...
  private List<CredentialSupportedDraft00> credentialsSupportedDraft00 = null;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "OpenID Connect Verifiable Credentials Endpoint  Contains the URL of the Verifiable Credentials Endpoint.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "OpenID Connect Verifiable Credentials Supported  JSON array containing a list of the Verifiable Credentials supported by this authorization server.")
      ...
      if (jsonObj.get("credentials_supported_draft_00") != null && !jsonObj.get("credentials_supported_draft_00").isJsonNull()) {
        ...
        if (jsonArraycredentialsSupportedDraft00 != null) {
          ...
          for (int i = 0; i < jsonArraycredentialsSupportedDraft00.size(); i++) {
            CredentialSupportedDraft00.validateJsonObject(jsonArraycredentialsSupportedDraft00.get(i).getAsJsonObject());
          };
        }
      }
