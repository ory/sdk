...
import sh.ory.model.AdminCreateSelfServiceRecoveryCodeBody;
...
import sh.ory.model.SelfServiceRecoveryCode;
...
public class V0alpha2Api {
    ...
    /**
     * Build call for adminCreateSelfServiceRecoveryCode
     * @param adminCreateSelfServiceRecoveryCodeBody  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> selfServiceRecoveryCode </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> jsonError </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> jsonError </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> jsonError </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call adminCreateSelfServiceRecoveryCodeCall(AdminCreateSelfServiceRecoveryCodeBody adminCreateSelfServiceRecoveryCodeBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = adminCreateSelfServiceRecoveryCodeBody;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminCreateSelfServiceRecoveryCodeValidateBeforeCall(AdminCreateSelfServiceRecoveryCodeBody adminCreateSelfServiceRecoveryCodeBody, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = adminCreateSelfServiceRecoveryCodeCall(adminCreateSelfServiceRecoveryCodeBody, _callback);
        return localVarCall;
     ...
     */
    public SelfServiceRecoveryCode adminCreateSelfServiceRecoveryCode(AdminCreateSelfServiceRecoveryCodeBody adminCreateSelfServiceRecoveryCodeBody) throws ApiException {
        ApiResponse<SelfServiceRecoveryCode> localVarResp = adminCreateSelfServiceRecoveryCodeWithHttpInfo(adminCreateSelfServiceRecoveryCodeBody);
        return localVarResp.getData();
    }
     ...
     * This endpoint creates a recovery code which should be given to the user in order for them to recover (or activate) their account.
     * @param adminCreateSelfServiceRecoveryCodeBody  (optional)
     * @return ApiResponse&lt;SelfServiceRecoveryCode&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<SelfServiceRecoveryCode> adminCreateSelfServiceRecoveryCodeWithHttpInfo(AdminCreateSelfServiceRecoveryCodeBody adminCreateSelfServiceRecoveryCodeBody) throws ApiException {
        okhttp3.Call localVarCall = adminCreateSelfServiceRecoveryCodeValidateBeforeCall(adminCreateSelfServiceRecoveryCodeBody, null);
        Type localVarReturnType = new TypeToken<SelfServiceRecoveryCode>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call adminCreateSelfServiceRecoveryCodeAsync(AdminCreateSelfServiceRecoveryCodeBody adminCreateSelfServiceRecoveryCodeBody, final ApiCallback<SelfServiceRecoveryCode> _callback) throws ApiException {

        okhttp3.Call localVarCall = adminCreateSelfServiceRecoveryCodeValidateBeforeCall(adminCreateSelfServiceRecoveryCodeBody, _callback);
        Type localVarReturnType = new TypeToken<SelfServiceRecoveryCode>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for adminListCourierMessages
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> courierMessageList </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> jsonError </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> jsonError </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call adminListCourierMessagesCall(Long perPage, Long page, CourierMessageStatus status, String recipient, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adminListCourierMessagesValidateBeforeCall(Long perPage, Long page, CourierMessageStatus status, String recipient, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = adminListCourierMessagesCall(perPage, page, status, recipient, _callback);
        return localVarCall;
     ...
     */
    public List<Message> adminListCourierMessages(Long perPage, Long page, CourierMessageStatus status, String recipient) throws ApiException {
        ApiResponse<List<Message>> localVarResp = adminListCourierMessagesWithHttpInfo(perPage, page, status, recipient);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Message>> adminListCourierMessagesWithHttpInfo(Long perPage, Long page, CourierMessageStatus status, String recipient) throws ApiException {
        okhttp3.Call localVarCall = adminListCourierMessagesValidateBeforeCall(perPage, page, status, recipient, null);
     ...
     */
    public okhttp3.Call adminListCourierMessagesAsync(Long perPage, Long page, CourierMessageStatus status, String recipient, final ApiCallback<List<Message>> _callback) throws ApiException {

        okhttp3.Call localVarCall = adminListCourierMessagesValidateBeforeCall(perPage, page, status, recipient, _callback);
        Type localVarReturnType = new TypeToken<List<Message>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call createProjectApiKeyValidateBeforeCall(String project, CreateProjectApiKeyRequest createProjectApiKeyRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createProjectApiKeyCall(project, createProjectApiKeyRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteProjectApiKeyValidateBeforeCall(String project, String tokenId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteProjectApiKeyCall(project, tokenId, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call initializeSelfServiceLoginFlowForBrowsersCall(Boolean refresh, String aal, String returnTo, String cookie, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call initializeSelfServiceLoginFlowForBrowsersValidateBeforeCall(Boolean refresh, String aal, String returnTo, String cookie, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = initializeSelfServiceLoginFlowForBrowsersCall(refresh, aal, returnTo, cookie, _callback);
        return localVarCall;
     ...
     */
    public SelfServiceLoginFlow initializeSelfServiceLoginFlowForBrowsers(Boolean refresh, String aal, String returnTo, String cookie) throws ApiException {
        ApiResponse<SelfServiceLoginFlow> localVarResp = initializeSelfServiceLoginFlowForBrowsersWithHttpInfo(refresh, aal, returnTo, cookie);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SelfServiceLoginFlow> initializeSelfServiceLoginFlowForBrowsersWithHttpInfo(Boolean refresh, String aal, String returnTo, String cookie) throws ApiException {
        okhttp3.Call localVarCall = initializeSelfServiceLoginFlowForBrowsersValidateBeforeCall(refresh, aal, returnTo, cookie, null);
        Type localVarReturnType = new TypeToken<SelfServiceLoginFlow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call initializeSelfServiceLoginFlowForBrowsersAsync(Boolean refresh, String aal, String returnTo, String cookie, final ApiCallback<SelfServiceLoginFlow> _callback) throws ApiException {

        okhttp3.Call localVarCall = initializeSelfServiceLoginFlowForBrowsersValidateBeforeCall(refresh, aal, returnTo, cookie, _callback);
        Type localVarReturnType = new TypeToken<SelfServiceLoginFlow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call initializeSelfServiceSettingsFlowForBrowsersCall(String returnTo, String cookie, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call initializeSelfServiceSettingsFlowForBrowsersValidateBeforeCall(String returnTo, String cookie, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = initializeSelfServiceSettingsFlowForBrowsersCall(returnTo, cookie, _callback);
        return localVarCall;
     ...
     */
    public SelfServiceSettingsFlow initializeSelfServiceSettingsFlowForBrowsers(String returnTo, String cookie) throws ApiException {
        ApiResponse<SelfServiceSettingsFlow> localVarResp = initializeSelfServiceSettingsFlowForBrowsersWithHttpInfo(returnTo, cookie);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SelfServiceSettingsFlow> initializeSelfServiceSettingsFlowForBrowsersWithHttpInfo(String returnTo, String cookie) throws ApiException {
        okhttp3.Call localVarCall = initializeSelfServiceSettingsFlowForBrowsersValidateBeforeCall(returnTo, cookie, null);
        Type localVarReturnType = new TypeToken<SelfServiceSettingsFlow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call initializeSelfServiceSettingsFlowForBrowsersAsync(String returnTo, String cookie, final ApiCallback<SelfServiceSettingsFlow> _callback) throws ApiException {

        okhttp3.Call localVarCall = initializeSelfServiceSettingsFlowForBrowsersValidateBeforeCall(returnTo, cookie, _callback);
        Type localVarReturnType = new TypeToken<SelfServiceSettingsFlow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call listProjectApiKeysValidateBeforeCall(String project, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listProjectApiKeysCall(project, _callback);
        return localVarCall;
