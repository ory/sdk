...
public class V0alpha2Api {
     ...
     */
    public IdentitySchema getIdentitySchema(String id) throws ApiException {
        ApiResponse<IdentitySchema> localVarResp = getIdentitySchemaWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Get a JSON Schema
     * @param id ID must be set to the ID of schema you want to get (required)
     * @return ApiResponse&lt;IdentitySchema&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<IdentitySchema> getIdentitySchemaWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getIdentitySchemaValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<IdentitySchema>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getIdentitySchemaAsync(String id, final ApiCallback<IdentitySchema> _callback) throws ApiException {
