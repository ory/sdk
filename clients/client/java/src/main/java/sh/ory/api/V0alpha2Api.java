...
import sh.ory.model.InlineObject3;
...
public class V0alpha2Api {
     ...
     */
    public okhttp3.Call createProjectApiKeyCall(String project, InlineObject3 inlineObject3, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createProjectApiKeyValidateBeforeCall(String project, InlineObject3 inlineObject3, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createProjectApiKeyCall(project, inlineObject3, _callback);
        return localVarCall;
     ...
     */
    public ProjectApiKey createProjectApiKey(String project, InlineObject3 inlineObject3) throws ApiException {
        ApiResponse<ProjectApiKey> localVarResp = createProjectApiKeyWithHttpInfo(project, inlineObject3);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ProjectApiKey> createProjectApiKeyWithHttpInfo(String project, InlineObject3 inlineObject3) throws ApiException {
        okhttp3.Call localVarCall = createProjectApiKeyValidateBeforeCall(project, inlineObject3, null);
     ...
     */
    public okhttp3.Call createProjectApiKeyAsync(String project, InlineObject3 inlineObject3, final ApiCallback<ProjectApiKey> _callback) throws ApiException {

        okhttp3.Call localVarCall = createProjectApiKeyValidateBeforeCall(project, inlineObject3, _callback);
        Type localVarReturnType = new TypeToken<ProjectApiKey>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
