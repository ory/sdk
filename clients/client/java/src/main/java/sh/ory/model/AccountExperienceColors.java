...
public class AccountExperienceColors {
  public static final String SERIALIZED_NAME_AX_BACKGROUND_DEFAULT = "ax-background-default";
  ...
  static {
    ...
    openapiFields.add("ax-background-default");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("ax-background-default") != null && !jsonObj.get("ax-background-default").isJsonNull()) && !jsonObj.get("ax-background-default").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ax-background-default` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ax-background-default").toString()));
      }
