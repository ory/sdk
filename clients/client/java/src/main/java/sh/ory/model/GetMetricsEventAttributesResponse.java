 ...
 */
@ApiModel(description = "Response of the getMetricsEventAttributes endpoint")
...
public class GetMetricsEventAttributesResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetMetricsEventAttributesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetMetricsEventAttributesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
