...
public class DefaultApi {
     ...
     */
    public void initializeSelfServiceLoginForBrowsers(Boolean refresh) throws ApiException {
     ...
     */
    public ApiResponse<Void> initializeSelfServiceLoginForBrowsersWithHttpInfo(Boolean refresh) throws ApiException {
     ...
     */
    public okhttp3.Call initializeSelfServiceLoginForBrowsersAsync(Boolean refresh, final ApiCallback<Void> _callback) throws ApiException {
    ...
    /**
     * Build call for initializeSelfServiceLoginForNativeApps
     * @param refresh Refresh a login session  If set to true, this will refresh an existing login session by asking the user to sign in again. This will reset the authenticated_at time of the session. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call initializeSelfServiceLoginForNativeAppsCall(Boolean refresh, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call initializeSelfServiceLoginForNativeAppsValidateBeforeCall(Boolean refresh, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = initializeSelfServiceLoginForNativeAppsCall(refresh, _callback);
        return localVarCall;
     ...
     */
    public LoginFlow initializeSelfServiceLoginForNativeApps(Boolean refresh) throws ApiException {
        ApiResponse<LoginFlow> localVarResp = initializeSelfServiceLoginForNativeAppsWithHttpInfo(refresh);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<LoginFlow> initializeSelfServiceLoginForNativeAppsWithHttpInfo(Boolean refresh) throws ApiException {
        okhttp3.Call localVarCall = initializeSelfServiceLoginForNativeAppsValidateBeforeCall(refresh, null);
        Type localVarReturnType = new TypeToken<LoginFlow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Initialize Login Flow for Native Apps and API clients (asynchronously)
     * This endpoint initiates a login flow for API clients such as mobile devices, smart TVs, and so on.  If a valid provided session cookie or session token is provided, a 400 Bad Request error will be returned unless the URL query parameter &#x60;?refresh&#x3D;true&#x60; is set.  To fetch an existing login flow call &#x60;/self-service/login/flows?flow&#x3D;&lt;flow_id&gt;&#x60;.  :::warning  You MUST NOT use this endpoint in client-side (Single Page Apps, ReactJS, AngularJS) nor server-side (Java Server Pages, NodeJS, PHP, Golang, ...) browser applications. Using this endpoint in these applications will make you vulnerable to a variety of CSRF attacks, including CSRF login attacks.  This endpoint MUST ONLY be used in scenarios such as native mobile apps (React Native, Objective C, Swift, Java, ...).  :::  More information can be found at [Ory Kratos User Login and User Registration Documentation](https://www.ory.sh/docs/next/kratos/self-service/flows/user-login-user-registration).
     * @param refresh Refresh a login session  If set to true, this will refresh an existing login session by asking the user to sign in again. This will reset the authenticated_at time of the session. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call initializeSelfServiceLoginForNativeAppsAsync(Boolean refresh, final ApiCallback<LoginFlow> _callback) throws ApiException {

        okhttp3.Call localVarCall = initializeSelfServiceLoginForNativeAppsValidateBeforeCall(refresh, _callback);
        Type localVarReturnType = new TypeToken<LoginFlow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
