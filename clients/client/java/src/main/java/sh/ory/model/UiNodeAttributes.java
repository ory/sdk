...
public class UiNodeAttributes {
  ...
  public UiNodeAttributes autocomplete(AutocompleteEnum autocomplete) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autocomplete, uiNodeAttributes.autocomplete) &&
        Objects.equals(this.disabled, uiNodeAttributes.disabled) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autocomplete, disabled, label, name, nodeType, onclick, pattern, required, type, value, id, text, height, src, width, href, title, async, crossorigin, integrity, nonce, referrerpolicy);
  }
