 ...
 * Event Stream List
 */
@ApiModel(description = "Event Stream List")
...
public class ListEventStreams {
  ...
  private List<EventStream> eventStreams = null;
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListEventStreams
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListEventStreams.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("event_streams") != null && !jsonObj.get("event_streams").isJsonNull()) {
        ...
        if (jsonArrayeventStreams != null) {
          ...
          for (int i = 0; i < jsonArrayeventStreams.size(); i++) {
            EventStream.validateJsonObject(jsonArrayeventStreams.get(i).getAsJsonObject());
          };
        }
      }
  }
