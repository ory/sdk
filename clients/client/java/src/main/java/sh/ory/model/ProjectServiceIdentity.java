...
public class ProjectServiceIdentity {
   ...
   * @return the ProjectServiceIdentity instance itself
   */
  public ProjectServiceIdentity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.config, projectServiceIdentity.config)&&
        Objects.equals(this.additionalProperties, projectServiceIdentity.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectServiceIdentity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectServiceIdentity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectServiceIdentity>() {
           ...
           public ProjectServiceIdentity read(JsonReader in) throws IOException {
             ...
             ProjectServiceIdentity instance = thisAdapter.fromJsonTree(jsonObj);
