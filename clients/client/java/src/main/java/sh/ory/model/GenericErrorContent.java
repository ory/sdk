...
public class GenericErrorContent {
  ...
  public GenericErrorContent id(IdEnum id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.debug, genericErrorContent.debug) &&
        ...
        Objects.equals(this.id, genericErrorContent.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(debug, error, errorDescription, id, message, statusCode, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenericErrorContent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenericErrorContent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
