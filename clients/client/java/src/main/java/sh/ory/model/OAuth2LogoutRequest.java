...
public class OAuth2LogoutRequest {
  ...
  public OAuth2LogoutRequest expiresAt(OffsetDateTime expiresAt) {
  ...
  public OAuth2LogoutRequest requestedAt(OffsetDateTime requestedAt) {
   ...
   * @return the OAuth2LogoutRequest instance itself
   */
  public OAuth2LogoutRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.challenge, oAuth2LogoutRequest.challenge) &&
        ...
        Objects.equals(this.expiresAt, oAuth2LogoutRequest.expiresAt) &&
        Objects.equals(this.requestUrl, oAuth2LogoutRequest.requestUrl) &&
        Objects.equals(this.requestedAt, oAuth2LogoutRequest.requestedAt) &&
        ...
        Objects.equals(this.additionalProperties, oAuth2LogoutRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(challenge, client, expiresAt, requestUrl, requestedAt, rpInitiated, sid, subject, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OAuth2LogoutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OAuth2LogoutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OAuth2LogoutRequest>() {
           ...
           public OAuth2LogoutRequest read(JsonReader in) throws IOException {
             ...
             OAuth2LogoutRequest instance = thisAdapter.fromJsonTree(jsonObj);
