...
public class ProjectBranding {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectBranding
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectBranding.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      ProjectBrandingTheme.validateJsonElement(jsonObj.get("default_theme"));
      ...
      for (int i = 0; i < jsonArraythemes.size(); i++) {
        ProjectBrandingTheme.validateJsonElement(jsonArraythemes.get(i));
      };
  }
