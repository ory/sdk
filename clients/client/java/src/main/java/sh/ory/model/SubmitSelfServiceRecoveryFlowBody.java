...
public class SubmitSelfServiceRecoveryFlowBody extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<SubmitSelfServiceRecoveryFlowWithCodeMethodBody> adapterSubmitSelfServiceRecoveryFlowWithCodeMethodBody = gson.getDelegateAdapter(this, TypeToken.get(SubmitSelfServiceRecoveryFlowWithCodeMethodBody.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<SubmitSelfServiceRecoveryFlowBody>() {
                ...
                public void write(JsonWriter out, SubmitSelfServiceRecoveryFlowBody value) throws IOException {
                    ...
                    // check if the actual instance is of the type `SubmitSelfServiceRecoveryFlowWithCodeMethodBody`
                    if (value.getActualInstance() instanceof SubmitSelfServiceRecoveryFlowWithCodeMethodBody) {
                        JsonObject obj = adapterSubmitSelfServiceRecoveryFlowWithCodeMethodBody.toJsonTree((SubmitSelfServiceRecoveryFlowWithCodeMethodBody)value.getActualInstance()).getAsJsonObject();
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: SubmitSelfServiceRecoveryFlowWithCodeMethodBody, SubmitSelfServiceRecoveryFlowWithLinkMethodBody");
                }
                ...
                public SubmitSelfServiceRecoveryFlowBody read(JsonReader in) throws IOException {
                    ...
                    // deserialize SubmitSelfServiceRecoveryFlowWithCodeMethodBody
                    try {
                        // validate the JSON object to see if any exception is thrown
                        SubmitSelfServiceRecoveryFlowWithCodeMethodBody.validateJsonObject(jsonObject);
                        actualAdapter = adapterSubmitSelfServiceRecoveryFlowWithCodeMethodBody;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'SubmitSelfServiceRecoveryFlowWithCodeMethodBody'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for SubmitSelfServiceRecoveryFlowWithCodeMethodBody failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'SubmitSelfServiceRecoveryFlowWithCodeMethodBody'", e);
                    }
    ...
    public SubmitSelfServiceRecoveryFlowBody(SubmitSelfServiceRecoveryFlowWithCodeMethodBody o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        schemas.put("SubmitSelfServiceRecoveryFlowWithCodeMethodBody", new GenericType<SubmitSelfServiceRecoveryFlowWithCodeMethodBody>() {
        });
     ...
     * SubmitSelfServiceRecoveryFlowWithCodeMethodBody, SubmitSelfServiceRecoveryFlowWithLinkMethodBody
     *
    ...
    public void setActualInstance(Object instance) {
        if (instance instanceof SubmitSelfServiceRecoveryFlowWithCodeMethodBody) {
        ...
        throw new RuntimeException("Invalid instance type. Must be SubmitSelfServiceRecoveryFlowWithCodeMethodBody, SubmitSelfServiceRecoveryFlowWithLinkMethodBody");
    }
     ...
     * SubmitSelfServiceRecoveryFlowWithCodeMethodBody, SubmitSelfServiceRecoveryFlowWithLinkMethodBody
     *
     * @return The actual instance (SubmitSelfServiceRecoveryFlowWithCodeMethodBody, SubmitSelfServiceRecoveryFlowWithLinkMethodBody)
     */
    @Override
    ...
    /**
     * Get the actual instance of `SubmitSelfServiceRecoveryFlowWithCodeMethodBody`. If the actual instance is not `SubmitSelfServiceRecoveryFlowWithCodeMethodBody`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `SubmitSelfServiceRecoveryFlowWithCodeMethodBody`
     * @throws ClassCastException if the instance is not `SubmitSelfServiceRecoveryFlowWithCodeMethodBody`
     */
    public SubmitSelfServiceRecoveryFlowWithCodeMethodBody getSubmitSelfServiceRecoveryFlowWithCodeMethodBody() throws ClassCastException {
        return (SubmitSelfServiceRecoveryFlowWithCodeMethodBody)super.getActualInstance();
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    int validCount = 0;
    ArrayList<String> errorMessages = new ArrayList<>();
    // validate the json string with SubmitSelfServiceRecoveryFlowWithCodeMethodBody
    try {
      SubmitSelfServiceRecoveryFlowWithCodeMethodBody.validateJsonObject(jsonObj);
      validCount++;
    } catch (Exception e) {
      errorMessages.add(String.format("Deserialization for SubmitSelfServiceRecoveryFlowWithCodeMethodBody failed with `%s`.", e.getMessage()));
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for SubmitSelfServiceRecoveryFlowBody with oneOf schemas: SubmitSelfServiceRecoveryFlowWithCodeMethodBody, SubmitSelfServiceRecoveryFlowWithLinkMethodBody. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }
