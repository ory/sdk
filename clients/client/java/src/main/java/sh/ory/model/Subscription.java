...
public class Subscription {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, currency, currentInterval, currentPlan, customerId, id, intervalChangesTo, ongoingStripeCheckoutId, payedUntil, planChangesAt, planChangesTo, status, updatedAt);
  }
