...
public class Subscription {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, currentInterval, currentPlan, customerId, id, intervalChangesTo, ongoingStripeCheckoutId, payedUntil, planChangesAt, planChangesTo, status, updatedAt);
  }
