...
public class ProjectServiceOAuth2 {
   ...
   * @return the ProjectServiceOAuth2 instance itself
   */
  public ProjectServiceOAuth2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.config, projectServiceOAuth2.config)&&
        Objects.equals(this.additionalProperties, projectServiceOAuth2.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectServiceOAuth2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectServiceOAuth2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectServiceOAuth2>() {
           ...
           public ProjectServiceOAuth2 read(JsonReader in) throws IOException {
             ...
             ProjectServiceOAuth2 instance = thisAdapter.fromJsonTree(jsonObj);
