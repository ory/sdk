...
public class CreateSubscriptionCommon {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateSubscriptionCommon
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateSubscriptionCommon.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
