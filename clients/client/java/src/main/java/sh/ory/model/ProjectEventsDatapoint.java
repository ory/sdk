...
public class ProjectEventsDatapoint {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectEventsDatapoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectEventsDatapoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
