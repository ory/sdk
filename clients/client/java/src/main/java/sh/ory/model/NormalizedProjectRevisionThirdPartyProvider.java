...
public class NormalizedProjectRevisionThirdPartyProvider {
  ...
  private List<String> additionalIdTokenAudiences = null;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Mapper specifies the JSONNet code snippet which uses the OpenID Connect Provider's data (e.g. GitHub or Google profile information) to hydrate the identity's data.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalIdTokenAudiences, applePrivateKey, applePrivateKeyId, appleTeamId, authUrl, azureTenant, clientId, clientSecret, createdAt, id, issuerUrl, label, mapperUrl, organizationId, projectRevisionId, provider, providerId, requestedClaims, scope, state, subjectSource, tokenUrl, updatedAt, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("additional_id_token_audiences") != null && !jsonObj.get("additional_id_token_audiences").isJsonArray()) {
