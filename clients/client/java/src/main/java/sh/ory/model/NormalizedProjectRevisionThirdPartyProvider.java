...
public class NormalizedProjectRevisionThirdPartyProvider {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applePrivateKey, applePrivateKeyId, appleTeamId, authUrl, azureTenant, clientId, clientSecret, createdAt, id, issuerUrl, label, mapperUrl, projectRevisionId, provider, providerId, requestedClaims, scope, state, subjectSource, tokenUrl, updatedAt);
  }
