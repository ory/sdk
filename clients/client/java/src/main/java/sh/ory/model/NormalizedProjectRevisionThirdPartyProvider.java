...
public class NormalizedProjectRevisionThirdPartyProvider {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountLinkingMode, normalizedProjectRevisionThirdPartyProvider.accountLinkingMode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountLinkingMode, additionalIdTokenAudiences, applePrivateKey, applePrivateKeyId, appleTeamId, authUrl, azureTenant, claimsSource, clientId, clientSecret, createdAt, fedcmConfigUrl, id, issuerUrl, label, mapperUrl, netIdTokenOriginHeader, organizationId, pkce, projectRevisionId, provider, providerId, proxyOidcRedirectUrl, requestedClaims, scope, state, subjectSource, tokenUrl, updateIdentityOnLogin, updatedAt, additionalProperties);
  }
