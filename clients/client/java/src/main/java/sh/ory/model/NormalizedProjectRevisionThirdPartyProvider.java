...
public class NormalizedProjectRevisionThirdPartyProvider {
  public static final String SERIALIZED_NAME_AAL2_ACR_VALUES = "aal2_acr_values";
  @SerializedName(SERIALIZED_NAME_AAL2_ACR_VALUES)
  private List<String> aal2AcrValues = new ArrayList<>();

  public static final String SERIALIZED_NAME_AAL2_AMR_VALUES = "aal2_amr_values";
  @SerializedName(SERIALIZED_NAME_AAL2_AMR_VALUES)
  private List<String> aal2AmrValues = new ArrayList<>();
   ...
   */
  @JsonAdapter(AccountLinkingModeEnum.Adapter.class)
  public enum AccountLinkingModeEnum {
    ...
    AccountLinkingModeEnum(String value) {
      this.value = value;
    }
    ...
    public static AccountLinkingModeEnum fromValue(String value) {
      for (AccountLinkingModeEnum b : AccountLinkingModeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<AccountLinkingModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AccountLinkingModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AccountLinkingModeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AccountLinkingModeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      AccountLinkingModeEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_ACCOUNT_LINKING_MODE = "account_linking_mode";
  @SerializedName(SERIALIZED_NAME_ACCOUNT_LINKING_MODE)
  private AccountLinkingModeEnum accountLinkingMode;
  ...
  public static final String SERIALIZED_NAME_FRONT_CHANNEL_LOGOUT = "front_channel_logout";
  @SerializedName(SERIALIZED_NAME_FRONT_CHANNEL_LOGOUT)
   ...
   */
  @JsonAdapter(UpdateIdentityOnLoginEnum.Adapter.class)
  public enum UpdateIdentityOnLoginEnum {
    ...
    UpdateIdentityOnLoginEnum(String value) {
      this.value = value;
    }
    ...
    public static UpdateIdentityOnLoginEnum fromValue(String value) {
      for (UpdateIdentityOnLoginEnum b : UpdateIdentityOnLoginEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<UpdateIdentityOnLoginEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final UpdateIdentityOnLoginEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public UpdateIdentityOnLoginEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return UpdateIdentityOnLoginEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      UpdateIdentityOnLoginEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_UPDATE_IDENTITY_ON_LOGIN = "update_identity_on_login";
  @SerializedName(SERIALIZED_NAME_UPDATE_IDENTITY_ON_LOGIN)
  private UpdateIdentityOnLoginEnum updateIdentityOnLogin;
  ...
  public NormalizedProjectRevisionThirdPartyProvider aal2AcrValues(List<String> aal2AcrValues) {
    this.aal2AcrValues = aal2AcrValues;
    return this;
  }

  public NormalizedProjectRevisionThirdPartyProvider addAal2AcrValuesItem(String aal2AcrValuesItem) {
    if (this.aal2AcrValues == null) {
      this.aal2AcrValues = new ArrayList<>();
    }
    this.aal2AcrValues.add(aal2AcrValuesItem);
    return this;
  }
   ...
   * @return aal2AcrValues
   */
  @javax.annotation.Nullable
  public List<String> getAal2AcrValues() {
    return aal2AcrValues;
  }

  public void setAal2AcrValues(List<String> aal2AcrValues) {
    this.aal2AcrValues = aal2AcrValues;
  }


  public NormalizedProjectRevisionThirdPartyProvider aal2AmrValues(List<String> aal2AmrValues) {
    this.aal2AmrValues = aal2AmrValues;
    return this;
  }

  public NormalizedProjectRevisionThirdPartyProvider addAal2AmrValuesItem(String aal2AmrValuesItem) {
    if (this.aal2AmrValues == null) {
      this.aal2AmrValues = new ArrayList<>();
    }
    this.aal2AmrValues.add(aal2AmrValuesItem);
    return this;
  }
   ...
   * @return aal2AmrValues
   */
  @javax.annotation.Nullable
  public List<String> getAal2AmrValues() {
    return aal2AmrValues;
  }

  public void setAal2AmrValues(List<String> aal2AmrValues) {
    this.aal2AmrValues = aal2AmrValues;
  }


  public NormalizedProjectRevisionThirdPartyProvider accountLinkingMode(AccountLinkingModeEnum accountLinkingMode) {
    this.accountLinkingMode = accountLinkingMode;
    return this;
  }

  /**
   * AccountLinkingMode controls how account conflicts are resolved for this provider.  Possible values are &#x60;confirm_with_existing_credential&#x60; (default) and &#x60;automatic&#x60;. &#x60;automatic&#x60; silently links accounts when the provider verifies email ownership. Only supported for &#x60;apple&#x60; and &#x60;google&#x60; providers. automatic AccountLinkingModeAutomatic silently links accounts if the provider verifies email ownership. confirm_with_existing_credential AccountLinkingModeConfirmWithExistingCredential requires the user to confirm the account linking by providing an existing credential.
   * @return accountLinkingMode
   */
  @javax.annotation.Nullable
  public AccountLinkingModeEnum getAccountLinkingMode() {
    return accountLinkingMode;
  }

  public void setAccountLinkingMode(AccountLinkingModeEnum accountLinkingMode) {
    this.accountLinkingMode = accountLinkingMode;
  }
  ...
  public NormalizedProjectRevisionThirdPartyProvider frontChannelLogout(Boolean frontChannelLogout) {
  ...
  public NormalizedProjectRevisionThirdPartyProvider updateIdentityOnLogin(UpdateIdentityOnLoginEnum updateIdentityOnLogin) {
    this.updateIdentityOnLogin = updateIdentityOnLogin;
    return this;
  }

  /**
   * UpdateIdentityOnLogin controls whether the identity is updated from OIDC claims on each login.  Possible values are \&quot;never\&quot; (default) and \&quot;automatic\&quot;. never UpdateIdentityOnLoginNever disables identity updates on login (default). automatic UpdateIdentityOnLoginAutomatic re-runs the Jsonnet claims mapper on every login and updates the identity&#39;s traits and metadata automatically.
   * @return updateIdentityOnLogin
   */
  @javax.annotation.Nullable
  public UpdateIdentityOnLoginEnum getUpdateIdentityOnLogin() {
    return updateIdentityOnLogin;
  }

  public void setUpdateIdentityOnLogin(UpdateIdentityOnLoginEnum updateIdentityOnLogin) {
    this.updateIdentityOnLogin = updateIdentityOnLogin;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aal2AcrValues, normalizedProjectRevisionThirdPartyProvider.aal2AcrValues) &&
        Objects.equals(this.aal2AmrValues, normalizedProjectRevisionThirdPartyProvider.aal2AmrValues) &&
        Objects.equals(this.accountLinkingMode, normalizedProjectRevisionThirdPartyProvider.accountLinkingMode) &&
        Objects.equals(this.additionalIdTokenAudiences, normalizedProjectRevisionThirdPartyProvider.additionalIdTokenAudiences) &&
        ...
        Objects.equals(this.frontChannelLogout, normalizedProjectRevisionThirdPartyProvider.frontChannelLogout) &&
        ...
        Objects.equals(this.proxyOidcRedirectUrl, normalizedProjectRevisionThirdPartyProvider.proxyOidcRedirectUrl) &&
        ...
        Objects.equals(this.updateIdentityOnLogin, normalizedProjectRevisionThirdPartyProvider.updateIdentityOnLogin) &&
  ...
  public String toString() {
    ...
    sb.append("    aal2AcrValues: ").append(toIndentedString(aal2AcrValues)).append("\n");
    sb.append("    aal2AmrValues: ").append(toIndentedString(aal2AmrValues)).append("\n");
    sb.append("    accountLinkingMode: ").append(toIndentedString(accountLinkingMode)).append("\n");
    ...
    sb.append("    updateIdentityOnLogin: ").append(toIndentedString(updateIdentityOnLogin)).append("\n");
  ...
  static {
    ...
    openapiFields.add("aal2_acr_values");
    openapiFields.add("aal2_amr_values");
    openapiFields.add("account_linking_mode");
    ...
    openapiFields.add("front_channel_logout");
    ...
    openapiFields.add("update_identity_on_login");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("aal2_acr_values") != null && !jsonObj.get("aal2_acr_values").isJsonNull() && !jsonObj.get("aal2_acr_values").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `aal2_acr_values` to be an array in the JSON string but got `%s`", jsonObj.get("aal2_acr_values").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("aal2_amr_values") != null && !jsonObj.get("aal2_amr_values").isJsonNull() && !jsonObj.get("aal2_amr_values").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `aal2_amr_values` to be an array in the JSON string but got `%s`", jsonObj.get("aal2_amr_values").toString()));
      }
      if ((jsonObj.get("account_linking_mode") != null && !jsonObj.get("account_linking_mode").isJsonNull()) && !jsonObj.get("account_linking_mode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `account_linking_mode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("account_linking_mode").toString()));
      }
      // validate the optional field `account_linking_mode`
      if (jsonObj.get("account_linking_mode") != null && !jsonObj.get("account_linking_mode").isJsonNull()) {
        AccountLinkingModeEnum.validateJsonElement(jsonObj.get("account_linking_mode"));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("update_identity_on_login") != null && !jsonObj.get("update_identity_on_login").isJsonNull()) && !jsonObj.get("update_identity_on_login").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `update_identity_on_login` to be a primitive type in the JSON string but got `%s`", jsonObj.get("update_identity_on_login").toString()));
      }
      // validate the optional field `update_identity_on_login`
      if (jsonObj.get("update_identity_on_login") != null && !jsonObj.get("update_identity_on_login").isJsonNull()) {
        UpdateIdentityOnLoginEnum.validateJsonElement(jsonObj.get("update_identity_on_login"));
      }
  }
