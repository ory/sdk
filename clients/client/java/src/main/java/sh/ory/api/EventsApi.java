...
public class EventsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Event Stream </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> JSON API Error Response </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> JSON API Error Response </td><td>  -  </td></tr>
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Event Stream List </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> JSON API Error Response </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> JSON API Error Response </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> JSON API Error Response </td><td>  -  </td></tr>
     </table>
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Event Stream </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> JSON API Error Response </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> JSON API Error Response </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> JSON API Error Response </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> JSON API Error Response </td><td>  -  </td></tr>
