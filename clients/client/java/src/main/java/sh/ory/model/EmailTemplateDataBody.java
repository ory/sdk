...
public class EmailTemplateDataBody {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailTemplateDataBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmailTemplateDataBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
