...
public class AttributesCountDatapoint {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Count of the attribute value for given key")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Name of the attribute value for given key")
  ...
  * @throws IOException if the JSON Object is invalid with respect to AttributesCountDatapoint
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttributesCountDatapoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
