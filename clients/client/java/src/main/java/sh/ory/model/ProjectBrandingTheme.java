...
public class ProjectBrandingTheme {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Favicon Type The Favicon mime type.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Favicon URL Favicon can be an https:// or base64:// URL. If the URL is not allowed, the favicon will be stored inside the Ory Network storage bucket.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Logo Type The Logo mime type.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Logo URL Logo can be an https:// or base64:// URL. If the URL is not allowed, the logo will be stored inside the Ory Network storage bucket.")
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectBrandingTheme
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectBrandingTheme.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
