...
public class PlanDetails {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseFeeMonthly, baseFeeYearly, custom, description, developmentFeatures, features, latest, name, productionFeatures, stagingFeatures, version, additionalProperties);
  }
