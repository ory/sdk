...
public class OAuth2ConsentSession {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(consentRequest, consentRequestId, context, grantAccessTokenAudience, grantScope, handledAt, remember, rememberFor, session, additionalProperties);
  }
