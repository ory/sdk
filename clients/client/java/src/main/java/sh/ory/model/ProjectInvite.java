...
public class ProjectInvite {
  ...
  **/
   ...
   * @return the ProjectInvite instance itself
   */
  public ProjectInvite putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, projectInvite.createdAt) &&
        ...
        Objects.equals(this.additionalProperties, projectInvite.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectInvite>() {
           ...
           public ProjectInvite read(JsonReader in) throws IOException {
             ...
             ProjectInvite instance = thisAdapter.fromJsonTree(jsonObj);
