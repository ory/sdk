...
public class AccountExperienceConfiguration {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultLocale, defaultRedirectUrl, enabledLocales, errorUiUrl, faviconDarkUrl, faviconLightUrl, hideOryBranding, hideRegistrationLink, localeBehavior, loginUiUrl, logoDarkUrl, logoLightUrl, name, recoveryEnabled, recoveryUiUrl, registrationEnabled, registrationUiUrl, settingsUiUrl, stylesheet, translations, verificationEnabled, verificationUiUrl, additionalProperties);
  }
