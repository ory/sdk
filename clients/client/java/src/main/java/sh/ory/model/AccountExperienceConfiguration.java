...
public class AccountExperienceConfiguration {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountExperienceThemeStylesheet, faviconType, faviconUrl, kratosSelfserviceFlowsRecoveryEnabled, kratosSelfserviceFlowsRegistrationEnabled, kratosSelfserviceFlowsVerificationEnabled, logoUrl, name, organizationMap, additionalProperties);
  }
