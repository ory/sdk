...
public class InvoiceDataV1 {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingPeriod, currency, items, plan, stripeInvoiceItem, stripeInvoiceStatus, stripeLink, subtitle, tax, title, totalInCent, additionalProperties);
  }
