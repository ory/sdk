...
import sh.ory.client.model.CreateIdentity;
import sh.ory.client.model.CreateRecoveryLink;
import sh.ory.client.model.ErrorContainer;
import sh.ory.client.model.GenericError;
import sh.ory.client.model.Identity;
import sh.ory.client.model.InlineResponse200;
import sh.ory.client.model.InlineResponse2001;
import sh.ory.client.model.InlineResponse503;
import sh.ory.client.model.JsonError;
import sh.ory.client.model.LoginFlow;
import sh.ory.client.model.LoginViaApiResponse;
import sh.ory.client.model.RecoveryFlow;
import sh.ory.client.model.RecoveryLink;
import sh.ory.client.model.RegistrationFlow;
import sh.ory.client.model.RegistrationViaApiResponse;
import sh.ory.client.model.RevokeSession;
import sh.ory.client.model.Session;
import sh.ory.client.model.SettingsFlow;
import sh.ory.client.model.SettingsViaApiResponse;
import sh.ory.client.model.SubmitSelfServiceLoginFlow;
import sh.ory.client.model.SubmitSelfServiceRecoveryFlowWithLinkMethod;
import sh.ory.client.model.SubmitSelfServiceRegistrationFlow;
import sh.ory.client.model.SubmitSelfServiceSettingsFlow;
import sh.ory.client.model.UpdateIdentity;
import sh.ory.client.model.VerificationFlow;
...
public class DefaultApi {
     ...
     */
    public ErrorContainer getSelfServiceErrorAdmin(String error) throws ApiException {
        ApiResponse<ErrorContainer> localVarResp = getSelfServiceErrorAdminWithHttpInfo(error);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ErrorContainer> getSelfServiceErrorAdminWithHttpInfo(String error) throws ApiException {
     ...
     */
    public okhttp3.Call getSelfServiceErrorAdminAsync(String error, final ApiCallback<ErrorContainer> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getSelfServiceSettingsFlowAdminCall(String id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSelfServiceSettingsFlowAdminValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getSelfServiceSettingsFlowAdminCall(id, _callback);
        return localVarCall;
     ...
     */
    public SettingsFlow getSelfServiceSettingsFlowAdmin(String id) throws ApiException {
        ApiResponse<SettingsFlow> localVarResp = getSelfServiceSettingsFlowAdminWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SettingsFlow> getSelfServiceSettingsFlowAdminWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getSelfServiceSettingsFlowAdminValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<SettingsFlow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getSelfServiceSettingsFlowAdminAsync(String id, final ApiCallback<SettingsFlow> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSelfServiceSettingsFlowAdminValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<SettingsFlow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for initializeSelfServiceRegistration
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call initializeSelfServiceRegistrationCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call initializeSelfServiceRegistrationValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = initializeSelfServiceRegistrationCall(_callback);
        return localVarCall;
     ...
     */
    public RegistrationFlow initializeSelfServiceRegistration() throws ApiException {
        ApiResponse<RegistrationFlow> localVarResp = initializeSelfServiceRegistrationWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<RegistrationFlow> initializeSelfServiceRegistrationWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = initializeSelfServiceRegistrationValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<RegistrationFlow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call initializeSelfServiceRegistrationAsync(final ApiCallback<RegistrationFlow> _callback) throws ApiException {

        okhttp3.Call localVarCall = initializeSelfServiceRegistrationValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<RegistrationFlow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
