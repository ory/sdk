...
public class InternalGetProjectBrandingBody {
   ...
   * @throws IOException if the JSON Element is invalid with respect to InternalGetProjectBrandingBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InternalGetProjectBrandingBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
