...
public class NormalizedProjectRevisionTokenizerTemplate {
   ...
   */
  @JsonAdapter(SubjectSourceEnum.Adapter.class)
  public enum SubjectSourceEnum {
    ...
    SubjectSourceEnum(String value) {
      this.value = value;
    }
    ...
    public static SubjectSourceEnum fromValue(String value) {
      for (SubjectSourceEnum b : SubjectSourceEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<SubjectSourceEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SubjectSourceEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SubjectSourceEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SubjectSourceEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      SubjectSourceEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_SUBJECT_SOURCE = "subject_source";
  @SerializedName(SERIALIZED_NAME_SUBJECT_SOURCE)
  private SubjectSourceEnum subjectSource = SubjectSourceEnum.ID;
  ...
  public NormalizedProjectRevisionTokenizerTemplate subjectSource(SubjectSourceEnum subjectSource) {
   ...
   */
  @javax.annotation.Nullable
  public SubjectSourceEnum getSubjectSource() {
    return subjectSource;
  }

  public void setSubjectSource(SubjectSourceEnum subjectSource) {
    this.subjectSource = subjectSource;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.claimsMapperUrl, normalizedProjectRevisionTokenizerTemplate.claimsMapperUrl) &&
        ...
        Objects.equals(this.subjectSource, normalizedProjectRevisionTokenizerTemplate.subjectSource) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(claimsMapperUrl, createdAt, id, jwksUrl, key, projectRevisionId, subjectSource, ttl, updatedAt, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `subject_source`
      if (jsonObj.get("subject_source") != null && !jsonObj.get("subject_source").isJsonNull()) {
        SubjectSourceEnum.validateJsonElement(jsonObj.get("subject_source"));
      }
