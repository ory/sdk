...
import sh.ory.model.ContinueWithDeviceAuthnPinEntryUi;
...
public class ContinueWith extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<ContinueWithDeviceAuthnPinEntryUi> adapterContinueWithDeviceAuthnPinEntryUi = gson.getDelegateAdapter(this, TypeToken.get(ContinueWithDeviceAuthnPinEntryUi.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<ContinueWith>() {
                ...
                public void write(JsonWriter out, ContinueWith value) throws IOException {
                    ...
                    // check if the actual instance is of the type `ContinueWithDeviceAuthnPinEntryUi`
                    if (value.getActualInstance() instanceof ContinueWithDeviceAuthnPinEntryUi) {
                        JsonElement element = adapterContinueWithDeviceAuthnPinEntryUi.toJsonTree((ContinueWithDeviceAuthnPinEntryUi)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi");
                }
                ...
                public ContinueWith read(JsonReader in) throws IOException {
                    ...
                    if (jsonObject.get("action") == null) {
                        ...
                        switch (jsonObject.get("action").getAsString()) {
                            ...
                            case "set_ory_session_token":
                                ...
                                newContinueWith.setActualInstance(deserialized);
                                return newContinueWith;
                            case "show_pin_entry_ui":
                                deserialized = adapterContinueWithDeviceAuthnPinEntryUi.fromJsonTree(jsonObject);
                                newContinueWith.setActualInstance(deserialized);
                                return newContinueWith;
                            ...
                            case "show_verification_ui":
                                ...
                                newContinueWith.setActualInstance(deserialized);
                                return newContinueWith;
                            case "continueWithDeviceAuthnPinEntryUi":
                                deserialized = adapterContinueWithDeviceAuthnPinEntryUi.fromJsonTree(jsonObject);
                                newContinueWith.setActualInstance(deserialized);
                                return newContinueWith;
                            ...
                            case "continueWithVerificationUi":
                                ...
                                return newContinueWith;
                            default:
                                log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for ContinueWith. Possible values: redirect_browser_to set_ory_session_token show_pin_entry_ui show_recovery_ui show_settings_ui show_verification_ui continueWithDeviceAuthnPinEntryUi continueWithRecoveryUi continueWithRedirectBrowserTo continueWithSetOrySessionToken continueWithSettingsUi continueWithVerificationUi", jsonObject.get("action").getAsString()));
                        }
                    }
                    ...
                    // deserialize ContinueWithDeviceAuthnPinEntryUi
                    try {
                        // validate the JSON object to see if any exception is thrown
                        ContinueWithDeviceAuthnPinEntryUi.validateJsonElement(jsonElement);
                        actualAdapter = adapterContinueWithDeviceAuthnPinEntryUi;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'ContinueWithDeviceAuthnPinEntryUi'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for ContinueWithDeviceAuthnPinEntryUi failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'ContinueWithDeviceAuthnPinEntryUi'", e);
                    }
    ...
    static {
        ...
        schemas.put("ContinueWithDeviceAuthnPinEntryUi", ContinueWithDeviceAuthnPinEntryUi.class);
    }
     ...
     * ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof ContinueWithDeviceAuthnPinEntryUi) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi");
    }
     ...
     * ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi
     *
     * @return The actual instance (ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `ContinueWithDeviceAuthnPinEntryUi`. If the actual instance is not `ContinueWithDeviceAuthnPinEntryUi`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ContinueWithDeviceAuthnPinEntryUi`
     * @throws ClassCastException if the instance is not `ContinueWithDeviceAuthnPinEntryUi`
     */
    public ContinueWithDeviceAuthnPinEntryUi getContinueWithDeviceAuthnPinEntryUi() throws ClassCastException {
        return (ContinueWithDeviceAuthnPinEntryUi)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with ContinueWithDeviceAuthnPinEntryUi
        try {
            ContinueWithDeviceAuthnPinEntryUi.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
