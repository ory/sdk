...
public class Project {
  ...
  public Project organizations(List<BasicOrganization> organizations) {
    this.organizations = organizations;
    return this;
  }

  public Project addOrganizationsItem(BasicOrganization organizationsItem) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(corsAdmin, corsPublic, environment, homeRegion, id, name, organizations, revisionId, services, slug, state, workspaceId, additionalProperties);
  }
