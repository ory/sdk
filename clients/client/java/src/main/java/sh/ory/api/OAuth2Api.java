...
public class OAuth2Api {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> deviceAuthorization </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> errorOAuth2 </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public okhttp3.Call rotateOAuth2ClientSecretCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call rotateOAuth2ClientSecretValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling rotateOAuth2ClientSecret(Async)");
        }

        return rotateOAuth2ClientSecretCall(id, _callback);
     ...
     */
    public OAuth2Client rotateOAuth2ClientSecret(String id) throws ApiException {
        ApiResponse<OAuth2Client> localVarResp = rotateOAuth2ClientSecretWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OAuth2Client> rotateOAuth2ClientSecretWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = rotateOAuth2ClientSecretValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<OAuth2Client>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call rotateOAuth2ClientSecretAsync(String id, final ApiCallback<OAuth2Client> _callback) throws ApiException {

        okhttp3.Call localVarCall = rotateOAuth2ClientSecretValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<OAuth2Client>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
