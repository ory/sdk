...
public class OAuth2Api {
    ...
    private okhttp3.Call acceptOAuth2ConsentRequestValidateBeforeCall(String consentChallenge, AcceptOAuth2ConsentRequest acceptOAuth2ConsentRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = acceptOAuth2ConsentRequestCall(consentChallenge, acceptOAuth2ConsentRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call acceptOAuth2LoginRequestValidateBeforeCall(String loginChallenge, AcceptOAuth2LoginRequest acceptOAuth2LoginRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = acceptOAuth2LoginRequestCall(loginChallenge, acceptOAuth2LoginRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call acceptOAuth2LogoutRequestValidateBeforeCall(String logoutChallenge, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = acceptOAuth2LogoutRequestCall(logoutChallenge, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteTrustedOAuth2JwtGrantIssuerValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteTrustedOAuth2JwtGrantIssuerCall(id, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getOAuth2ConsentRequestValidateBeforeCall(String consentChallenge, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getOAuth2ConsentRequestCall(consentChallenge, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getOAuth2LoginRequestValidateBeforeCall(String loginChallenge, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getOAuth2LoginRequestCall(loginChallenge, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getOAuth2LogoutRequestValidateBeforeCall(String logoutChallenge, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getOAuth2LogoutRequestCall(logoutChallenge, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getTrustedOAuth2JwtGrantIssuerValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTrustedOAuth2JwtGrantIssuerCall(id, _callback);
        return localVarCall;
    ...
    private okhttp3.Call listOAuth2ClientsValidateBeforeCall(Long pageSize, String pageToken, String clientName, String owner, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listOAuth2ClientsCall(pageSize, pageToken, clientName, owner, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call listOAuth2ConsentSessionsCall(String subject, Long pageSize, String pageToken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listOAuth2ConsentSessionsValidateBeforeCall(String subject, Long pageSize, String pageToken, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listOAuth2ConsentSessionsCall(subject, pageSize, pageToken, _callback);
        return localVarCall;
     ...
     */
    public List<OAuth2ConsentSession> listOAuth2ConsentSessions(String subject, Long pageSize, String pageToken) throws ApiException {
        ApiResponse<List<OAuth2ConsentSession>> localVarResp = listOAuth2ConsentSessionsWithHttpInfo(subject, pageSize, pageToken);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<OAuth2ConsentSession>> listOAuth2ConsentSessionsWithHttpInfo(String subject, Long pageSize, String pageToken) throws ApiException {
        okhttp3.Call localVarCall = listOAuth2ConsentSessionsValidateBeforeCall(subject, pageSize, pageToken, null);
     ...
     */
    public okhttp3.Call listOAuth2ConsentSessionsAsync(String subject, Long pageSize, String pageToken, final ApiCallback<List<OAuth2ConsentSession>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listOAuth2ConsentSessionsValidateBeforeCall(subject, pageSize, pageToken, _callback);
        Type localVarReturnType = new TypeToken<List<OAuth2ConsentSession>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call listTrustedOAuth2JwtGrantIssuersValidateBeforeCall(Long maxItems, Long defaultItems, String issuer, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listTrustedOAuth2JwtGrantIssuersCall(maxItems, defaultItems, issuer, _callback);
        return localVarCall;
    ...
    private okhttp3.Call oAuth2AuthorizeValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = oAuth2AuthorizeCall(_callback);
        return localVarCall;
    ...
    private okhttp3.Call oauth2TokenExchangeValidateBeforeCall(String grantType, String clientId, String code, String redirectUri, String refreshToken, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = oauth2TokenExchangeCall(grantType, clientId, code, redirectUri, refreshToken, _callback);
        return localVarCall;
    ...
    private okhttp3.Call patchOAuth2ClientValidateBeforeCall(String id, List<JsonPatch> jsonPatch, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchOAuth2ClientCall(id, jsonPatch, _callback);
        return localVarCall;
    ...
    private okhttp3.Call rejectOAuth2ConsentRequestValidateBeforeCall(String consentChallenge, RejectOAuth2Request rejectOAuth2Request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = rejectOAuth2ConsentRequestCall(consentChallenge, rejectOAuth2Request, _callback);
        return localVarCall;
    ...
    private okhttp3.Call rejectOAuth2LoginRequestValidateBeforeCall(String loginChallenge, RejectOAuth2Request rejectOAuth2Request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = rejectOAuth2LoginRequestCall(loginChallenge, rejectOAuth2Request, _callback);
        return localVarCall;
    ...
    private okhttp3.Call rejectOAuth2LogoutRequestValidateBeforeCall(String logoutChallenge, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = rejectOAuth2LogoutRequestCall(logoutChallenge, _callback);
        return localVarCall;
    ...
    private okhttp3.Call revokeOAuth2ConsentSessionsValidateBeforeCall(String subject, String client, Boolean all, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = revokeOAuth2ConsentSessionsCall(subject, client, all, _callback);
        return localVarCall;
     ...
     * @param subject OAuth 2.0 Subject  The subject to revoke authentication sessions for. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call revokeOAuth2LoginSessionsCall(String subject, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call revokeOAuth2LoginSessionsValidateBeforeCall(String subject, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'subject' is set
        if (subject == null) {
            throw new ApiException("Missing the required parameter 'subject' when calling revokeOAuth2LoginSessions(Async)");
        }
     ...
     */
    public void revokeOAuth2LoginSessions(String subject) throws ApiException {
        revokeOAuth2LoginSessionsWithHttpInfo(subject);
    }
     ...
     */
    public ApiResponse<Void> revokeOAuth2LoginSessionsWithHttpInfo(String subject) throws ApiException {
        okhttp3.Call localVarCall = revokeOAuth2LoginSessionsValidateBeforeCall(subject, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Revokes All OAuth 2.0 Login Sessions of a Subject (asynchronously)
     * This endpoint invalidates a subject&#39;s authentication session. After revoking the authentication session, the subject has to re-authenticate at the Ory OAuth2 Provider. This endpoint does not invalidate any tokens and does not work with OpenID Connect Front- or Back-channel logout.
     * @param subject OAuth 2.0 Subject  The subject to revoke authentication sessions for. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call revokeOAuth2LoginSessionsAsync(String subject, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = revokeOAuth2LoginSessionsValidateBeforeCall(subject, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    private okhttp3.Call setOAuth2ClientValidateBeforeCall(String id, OAuth2Client oauth2Client, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setOAuth2ClientCall(id, oauth2Client, _callback);
        return localVarCall;
    ...
    private okhttp3.Call setOAuth2ClientLifespansValidateBeforeCall(String id, OAuth2ClientTokenLifespans oauth2ClientTokenLifespans, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setOAuth2ClientLifespansCall(id, oauth2ClientTokenLifespans, _callback);
        return localVarCall;
    ...
    private okhttp3.Call trustOAuth2JwtGrantIssuerValidateBeforeCall(TrustOAuth2JwtGrantIssuer trustOAuth2JwtGrantIssuer, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = trustOAuth2JwtGrantIssuerCall(trustOAuth2JwtGrantIssuer, _callback);
        return localVarCall;
