...
import sh.ory.client.auth.Authentication;
import sh.ory.client.auth.HttpBasicAuth;
import sh.ory.client.auth.HttpBearerAuth;
import sh.ory.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("oryToken", new HttpBearerAuth("bearer"));
        authentications.put("sessionCookie", new ApiKeyAuth("cookie", "ory_kratos_session"));
        authentications.put("sessionToken", new HttpBearerAuth("bearer"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v0.0.1-alpha.1/java");
