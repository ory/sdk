...
public class LoginFlow {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, createdAt, expiresAt, id, issuedAt, oauth2LoginChallenge, oauth2LoginRequest, refresh, requestUrl, requestedAal, returnTo, sessionTokenExchangeCode, state, type, ui, updatedAt, additionalProperties);
  }
