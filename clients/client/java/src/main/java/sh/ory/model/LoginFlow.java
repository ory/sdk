...
public class LoginFlow {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, createdAt, expiresAt, id, identitySchema, issuedAt, oauth2LoginChallenge, oauth2LoginRequest, organizationId, refresh, requestUrl, requestedAal, returnTo, sessionTokenExchangeCode, state, transientPayload, type, ui, updatedAt, additionalProperties);
  }
