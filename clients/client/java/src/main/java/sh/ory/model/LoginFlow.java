...
import sh.ory.model.LoginFlowState;
import sh.ory.model.LoginFlowTestContext;
...
public class LoginFlow {
  ...
  private LoginFlowState state;

  public static final String SERIALIZED_NAME_TEST_CONTEXT = "test_context";
  @SerializedName(SERIALIZED_NAME_TEST_CONTEXT)
  private LoginFlowTestContext testContext;
  ...
  public LoginFlow identitySchema(String identitySchema) {
  ...
  public void setIdentitySchema(String identitySchema) {
    this.identitySchema = identitySchema;
  }
  ...
  public LoginFlow state(LoginFlowState state) {
    this.state = state;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public LoginFlowState getState() {
    return state;
  }

  public void setState(LoginFlowState state) {
    this.state = state;
  }


  public LoginFlow testContext(LoginFlowTestContext testContext) {
   ...
   */
  @javax.annotation.Nullable
  public LoginFlowTestContext getTestContext() {
    return testContext;
  }

  public void setTestContext(LoginFlowTestContext testContext) {
    this.testContext = testContext;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, loginFlow.active) &&
        ...
        Objects.equals(this.identitySchema, loginFlow.identitySchema) &&
        ...
        Objects.equals(this.testContext, loginFlow.testContext) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, createdAt, expiresAt, id, identitySchema, issuedAt, oauth2LoginChallenge, oauth2LoginRequest, organizationId, refresh, requestUrl, requestedAal, returnTo, sessionTokenExchangeCode, state, testContext, transientPayload, type, ui, updatedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    testContext: ").append(toIndentedString(testContext)).append("\n");
  ...
  static {
    ...
    openapiFields.add("test_context");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("identity_schema") != null && !jsonObj.get("identity_schema").isJsonNull()) && !jsonObj.get("identity_schema").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `identity_schema` to be a primitive type in the JSON string but got `%s`", jsonObj.get("identity_schema").toString()));
      }
      ...
      LoginFlowState.validateJsonElement(jsonObj.get("state"));
      // validate the optional field `test_context`
      if (jsonObj.get("test_context") != null && !jsonObj.get("test_context").isJsonNull()) {
        LoginFlowTestContext.validateJsonElement(jsonObj.get("test_context"));
      }
