...
# **listIdentities**
> List&lt;Identity&gt; listIdentities(perPage, page, identifier)
...
public class Example {
  public static void main(String[] args) {
    ...
    String identifier = "identifier_example"; // String | Identifier  This query parameter can be used to lookup an identity using its identifier. For example - an email address
    try {
      List<Identity> result = apiInstance.listIdentities(perPage, page, identifier);
      System.out.println(result);
    } catch (ApiException e) {
