...
|**grantAccessTokenAudience** | **List&lt;String&gt;** | Audience Granted  GrantedAudience sets the audience the user authorized the client to use. Should be a subset of &#x60;requested_access_token_audience&#x60;. |  [optional] |
|**grantScope** | **List&lt;String&gt;** | Scope Granted  GrantScope sets the scope the user authorized the client to use. Should be a subset of &#x60;requested_scope&#x60;. |  [optional] |
