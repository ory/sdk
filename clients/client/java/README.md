...
- API version: v0.0.1-alpha.56
  - Build date: 2022-01-20T21:47:26.946019758Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.56</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.56"
```
...
* `target/client-v0.0.1-alpha.56.jar`
* `target/lib/*.jar`
