...
- API version: v0.0.1-alpha.111
  - Build date: 2022-03-02T18:01:59.986378114Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.111</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.111"
  }
```
...
* `target/client-v0.0.1-alpha.111.jar`
* `target/lib/*.jar`
