...
- API version: v0.0.1-alpha.107
  - Build date: 2022-02-23T10:57:15.303420051Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.107</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.107"
  }
```
...
* `target/client-v0.0.1-alpha.107.jar`
* `target/lib/*.jar`
