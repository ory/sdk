...
- API version: v0.2.0-alpha.43
  - Build date: 2022-09-14T15:03:23.816610581Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.43</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.43"
  }
```
...
* `target/client-v0.2.0-alpha.43.jar`
* `target/lib/*.jar`
