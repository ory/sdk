...
- API version: v0.2.0-alpha.21
  - Build date: 2022-08-26T15:01:38.488459285Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.21</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.21"
  }
```
...
* `target/client-v0.2.0-alpha.21.jar`
* `target/lib/*.jar`
