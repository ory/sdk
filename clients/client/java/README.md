...
- API version: v0.2.0-alpha.18
  - Build date: 2022-08-25T18:35:46.223806189Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.18</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.18"
  }
```
...
* `target/client-v0.2.0-alpha.18.jar`
* `target/lib/*.jar`
