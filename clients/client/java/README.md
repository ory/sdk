...
- API version: v0.0.1-alpha.39
  - Build date: 2022-01-06T18:00:25.869994217Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.39</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.39"
```
...
* `target/client-v0.0.1-alpha.39.jar`
* `target/lib/*.jar`
