...
- API version: v0.0.1-alpha.24
  - Build date: 2021-11-22T15:26:02.363740017Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.24</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.24"
```
...
* `target/client-v0.0.1-alpha.24.jar`
* `target/lib/*.jar`
