...
- API version: v0.0.1-alpha.165
  - Build date: 2022-04-13T15:43:08.424942199Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.165</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.165"
  }
```
...
* `target/client-v0.0.1-alpha.165.jar`
* `target/lib/*.jar`
