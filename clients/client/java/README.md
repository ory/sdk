...
- API version: v0.0.1-alpha.187
  - Build date: 2022-05-27T16:31:36.532527697Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.187</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.187"
  }
```
...
* `target/client-v0.0.1-alpha.187.jar`
* `target/lib/*.jar`
