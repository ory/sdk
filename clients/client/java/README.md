...
- API version: v0.1.0-alpha.10
  - Build date: 2022-07-21T07:57:06.600493853Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.1.0-alpha.10</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.1.0-alpha.10"
  }
```
...
* `target/client-v0.1.0-alpha.10.jar`
* `target/lib/*.jar`
