...
- API version: v0.0.1-alpha.87
  - Build date: 2022-02-10T14:06:29.637217896Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.87</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.87"
  }
```
...
* `target/client-v0.0.1-alpha.87.jar`
* `target/lib/*.jar`
