...
- API version: v0.0.1-alpha.162
  - Build date: 2022-04-12T10:10:33.463464896Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.162</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.162"
  }
```
...
* `target/client-v0.0.1-alpha.162.jar`
* `target/lib/*.jar`
