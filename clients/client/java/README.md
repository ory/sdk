...
- API version: v0.0.1-alpha.30
  - Build date: 2021-11-29T12:53:23.012250882Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.30</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.30"
```
...
* `target/client-v0.0.1-alpha.30.jar`
* `target/lib/*.jar`
