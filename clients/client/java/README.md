...
- API version: v0.0.1-alpha.160
  - Build date: 2022-04-11T08:25:03.096510370Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.160</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.160"
  }
```
...
* `target/client-v0.0.1-alpha.160.jar`
* `target/lib/*.jar`
