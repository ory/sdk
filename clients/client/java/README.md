...
- API version: v0.0.1-alpha.27
  - Build date: 2021-11-22T15:59:26.157719278Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.27</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.27"
```
...
* `target/client-v0.0.1-alpha.27.jar`
* `target/lib/*.jar`
