...
- API version: v0.0.1-alpha.47
  - Build date: 2022-01-17T15:12:24.872115049Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.47</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.47"
```
...
* `target/client-v0.0.1-alpha.47.jar`
* `target/lib/*.jar`
