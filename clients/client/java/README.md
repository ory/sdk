...
- API version: v0.0.1-alpha.109
  - Build date: 2022-02-28T14:20:48.993027473Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.109</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.109"
  }
```
...
* `target/client-v0.0.1-alpha.109.jar`
* `target/lib/*.jar`
