...
- API version: v0.0.1-alpha.89
  - Build date: 2022-02-10T16:46:32.166503838Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.89</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.89"
  }
```
...
* `target/client-v0.0.1-alpha.89.jar`
* `target/lib/*.jar`
