...
- API version: v0.0.1-alpha.94
  - Build date: 2022-02-15T12:40:13.813684093Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.94</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.94"
  }
```
...
* `target/client-v0.0.1-alpha.94.jar`
* `target/lib/*.jar`
