...
- API version: v0.0.1-alpha.184
  - Build date: 2022-05-26T18:14:36.556359704Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.184</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.184"
  }
```
...
* `target/client-v0.0.1-alpha.184.jar`
* `target/lib/*.jar`
