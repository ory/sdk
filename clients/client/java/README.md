...
- API version: v0.2.0-alpha.42
  - Build date: 2022-09-14T14:39:53.752230157Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.42</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.42"
  }
```
...
* `target/client-v0.2.0-alpha.42.jar`
* `target/lib/*.jar`
