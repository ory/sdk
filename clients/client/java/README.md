...
- API version: v0.2.0-alpha.23
  - Build date: 2022-08-30T09:24:27.674927925Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.23</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.23"
  }
```
...
* `target/client-v0.2.0-alpha.23.jar`
* `target/lib/*.jar`
