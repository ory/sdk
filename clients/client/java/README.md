...
- API version: v0.0.1-alpha.175
  - Build date: 2022-05-16T09:29:44.455918950Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.175</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.175"
  }
```
...
* `target/client-v0.0.1-alpha.175.jar`
* `target/lib/*.jar`
