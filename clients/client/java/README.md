...
- API version: v0.2.0-alpha.32
  - Build date: 2022-09-07T12:05:02.327264571Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.32</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.32"
  }
```
...
* `target/client-v0.2.0-alpha.32.jar`
* `target/lib/*.jar`
