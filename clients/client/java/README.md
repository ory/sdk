...
- API version: v0.0.1-alpha.122
  - Build date: 2022-03-09T14:23:17.019308767Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.122</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.122"
  }
```
...
* `target/client-v0.0.1-alpha.122.jar`
* `target/lib/*.jar`
