...
- API version: v0.1.0-alpha.6
  - Build date: 2022-07-19T15:48:58.918553431Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.1.0-alpha.6</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.1.0-alpha.6"
  }
```
...
* `target/client-v0.1.0-alpha.6.jar`
* `target/lib/*.jar`
