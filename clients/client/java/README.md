...
- API version: v0.0.1-alpha.120
  - Build date: 2022-03-09T12:19:06.426987449Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.120</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.120"
  }
```
...
* `target/client-v0.0.1-alpha.120.jar`
* `target/lib/*.jar`
