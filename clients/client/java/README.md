...
- API version: v0.0.1-alpha.166
  - Build date: 2022-04-14T11:24:41.840388707Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.166</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.166"
  }
```
...
* `target/client-v0.0.1-alpha.166.jar`
* `target/lib/*.jar`
