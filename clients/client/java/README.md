...
- API version: v0.2.0-alpha.35
  - Build date: 2022-09-07T16:28:13.432710677Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.35</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.35"
  }
```
...
* `target/client-v0.2.0-alpha.35.jar`
* `target/lib/*.jar`
