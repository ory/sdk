...
- API version: v0.0.1-alpha.105
  - Build date: 2022-02-22T08:11:28.226245712Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.105</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.105"
  }
```
...
* `target/client-v0.0.1-alpha.105.jar`
* `target/lib/*.jar`
