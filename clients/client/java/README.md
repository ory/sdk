...
- API version: v0.0.1-alpha.118
  - Build date: 2022-03-08T19:41:46.895754881Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.118</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.118"
  }
```
...
* `target/client-v0.0.1-alpha.118.jar`
* `target/lib/*.jar`
