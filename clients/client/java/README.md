...
- API version: v0.0.1-alpha.156
  - Build date: 2022-04-06T17:20:21.722982883Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.156</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.156"
  }
```
...
* `target/client-v0.0.1-alpha.156.jar`
* `target/lib/*.jar`
