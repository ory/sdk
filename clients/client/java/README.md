...
- API version: v0.0.1-alpha.186
  - Build date: 2022-05-27T13:56:42.497174435Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.186</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.186"
  }
```
...
* `target/client-v0.0.1-alpha.186.jar`
* `target/lib/*.jar`
