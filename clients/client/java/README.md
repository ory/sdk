...
- API version: v0.0.1-alpha.97
  - Build date: 2022-02-15T21:16:02.106273866Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.97</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.97"
  }
```
...
* `target/client-v0.0.1-alpha.97.jar`
* `target/lib/*.jar`
