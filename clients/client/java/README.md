...
- API version: v0.0.1-alpha.100
  - Build date: 2022-02-16T12:55:05.848958523Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.100</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.100"
  }
```
...
* `target/client-v0.0.1-alpha.100.jar`
* `target/lib/*.jar`
