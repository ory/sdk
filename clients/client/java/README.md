...
- API version: v0.0.1-alpha.159
  - Build date: 2022-04-07T14:03:18.151402068Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.159</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.159"
  }
```
...
* `target/client-v0.0.1-alpha.159.jar`
* `target/lib/*.jar`
