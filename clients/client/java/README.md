...
- API version: v0.0.1-alpha.143
  - Build date: 2022-03-21T14:13:54.308132075Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.143</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.143"
  }
```
...
* `target/client-v0.0.1-alpha.143.jar`
* `target/lib/*.jar`
