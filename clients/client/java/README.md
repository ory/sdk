...
- API version: v0.2.0-alpha.28
  - Build date: 2022-09-06T13:26:20.971525584Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.28</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.28"
  }
```
...
* `target/client-v0.2.0-alpha.28.jar`
* `target/lib/*.jar`
