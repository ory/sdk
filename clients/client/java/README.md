...
- API version: v0.0.1-alpha.51
  - Build date: 2022-01-19T13:19:22.090676685Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.51</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.51"
```
...
* `target/client-v0.0.1-alpha.51.jar`
* `target/lib/*.jar`
