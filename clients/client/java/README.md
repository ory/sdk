...
- API version: v0.0.1-alpha.180
  - Build date: 2022-05-19T22:51:10.989995238Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.180</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.180"
  }
```
...
* `target/client-v0.0.1-alpha.180.jar`
* `target/lib/*.jar`
