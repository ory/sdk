...
- API version: v0.0.1-alpha.88
  - Build date: 2022-02-10T15:58:16.402003277Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.88</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.88"
  }
```
...
* `target/client-v0.0.1-alpha.88.jar`
* `target/lib/*.jar`
