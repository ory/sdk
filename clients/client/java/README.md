...
- API version: v0.0.1-alpha.161
  - Build date: 2022-04-12T09:46:31.378269840Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.161</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.161"
  }
```
...
* `target/client-v0.0.1-alpha.161.jar`
* `target/lib/*.jar`
