...
- API version: v0.0.1-alpha.84
  - Build date: 2022-02-10T11:48:55.748095259Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.84</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.84"
  }
```
...
* `target/client-v0.0.1-alpha.84.jar`
* `target/lib/*.jar`
