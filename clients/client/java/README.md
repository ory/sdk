...
- API version: v0.0.1-alpha.3
  - Build date: 2021-05-18T11:31:18.124668+02:00[Europe/Berlin]
...
<dependency>
  ...
  <version>v0.0.1-alpha.3</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.3"
```
...
* `target/client-v0.0.1-alpha.3.jar`
* `target/lib/*.jar`
