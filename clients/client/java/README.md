...
- API version: v0.0.1-alpha.90
  - Build date: 2022-02-11T08:09:33.314010494Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.90</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.90"
  }
```
...
* `target/client-v0.0.1-alpha.90.jar`
* `target/lib/*.jar`
