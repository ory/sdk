...
- API version: v0.0.1-alpha.70
  - Build date: 2022-02-06T18:10:11.643512936Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.70</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.70"
  }
```
...
* `target/client-v0.0.1-alpha.70.jar`
* `target/lib/*.jar`
