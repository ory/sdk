...
- API version: v0.2.0-alpha.33
  - Build date: 2022-09-07T12:48:32.447981320Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.33</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.33"
  }
```
...
* `target/client-v0.2.0-alpha.33.jar`
* `target/lib/*.jar`
