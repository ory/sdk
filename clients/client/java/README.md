...
- API version: v0.2.0-alpha.31
  - Build date: 2022-09-07T11:00:01.465965011Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.31</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.31"
  }
```
...
* `target/client-v0.2.0-alpha.31.jar`
* `target/lib/*.jar`
