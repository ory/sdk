...
- API version: v0.0.1-alpha.123
  - Build date: 2022-03-09T16:18:14.509857699Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.123</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.123"
  }
```
...
* `target/client-v0.0.1-alpha.123.jar`
* `target/lib/*.jar`
