...
- API version: v0.0.1-alpha.108
  - Build date: 2022-02-28T08:42:31.170056230Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.108</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.108"
  }
```
...
* `target/client-v0.0.1-alpha.108.jar`
* `target/lib/*.jar`
