...
- API version: v0.2.0-alpha.19
  - Build date: 2022-08-26T08:08:53.586776858Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.19</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.19"
  }
```
...
* `target/client-v0.2.0-alpha.19.jar`
* `target/lib/*.jar`
