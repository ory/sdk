...
- API version: v0.0.1-alpha.78
  - Build date: 2022-02-08T21:52:38.396923741Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.78</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.78"
  }
```
...
* `target/client-v0.0.1-alpha.78.jar`
* `target/lib/*.jar`
