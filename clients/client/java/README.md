...
- API version: v0.1.0-alpha.9
  - Build date: 2022-07-20T17:34:30.264632444Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.1.0-alpha.9</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.1.0-alpha.9"
  }
```
...
* `target/client-v0.1.0-alpha.9.jar`
* `target/lib/*.jar`
