...
- API version: v0.0.1-alpha.54
  - Build date: 2022-01-20T17:57:13.738095862Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.54</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.54"
```
...
* `target/client-v0.0.1-alpha.54.jar`
* `target/lib/*.jar`
