...
- API version: v0.0.1-alpha.177
  - Build date: 2022-05-17T09:01:35.464247310Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.177</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.177"
  }
```
...
* `target/client-v0.0.1-alpha.177.jar`
* `target/lib/*.jar`
