...
- API version: v0.1.0-alpha.7
  - Build date: 2022-07-20T14:18:40.929520714Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.1.0-alpha.7</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.1.0-alpha.7"
  }
```
...
* `target/client-v0.1.0-alpha.7.jar`
* `target/lib/*.jar`
