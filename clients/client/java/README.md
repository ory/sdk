...
- API version: v0.0.1-alpha.129
  - Build date: 2022-03-15T10:33:36.747977040Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.129</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.129"
  }
```
...
* `target/client-v0.0.1-alpha.129.jar`
* `target/lib/*.jar`
