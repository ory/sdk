...
- API version: v0.2.0-alpha.29
  - Build date: 2022-09-06T13:55:02.160309229Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.29</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.29"
  }
```
...
* `target/client-v0.2.0-alpha.29.jar`
* `target/lib/*.jar`
