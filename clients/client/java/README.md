...
- API version: v0.1.0-alpha.8
  - Build date: 2022-07-20T15:06:57.423854336Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.1.0-alpha.8</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.1.0-alpha.8"
  }
```
...
* `target/client-v0.1.0-alpha.8.jar`
* `target/lib/*.jar`
