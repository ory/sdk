...
- API version: v0.0.1-alpha.181
  - Build date: 2022-05-24T14:00:22.693216924Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.181</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.181"
  }
```
...
* `target/client-v0.0.1-alpha.181.jar`
* `target/lib/*.jar`
