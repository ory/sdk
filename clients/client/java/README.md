...
- API version: v0.0.1-alpha.110
  - Build date: 2022-03-01T19:33:06.765727606Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.110</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.110"
  }
```
...
* `target/client-v0.0.1-alpha.110.jar`
* `target/lib/*.jar`
