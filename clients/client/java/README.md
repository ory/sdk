...
- API version: v0.0.1-alpha.95
  - Build date: 2022-02-15T16:54:17.249737809Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.95</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.95"
  }
```
...
* `target/client-v0.0.1-alpha.95.jar`
* `target/lib/*.jar`
