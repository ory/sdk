...
- API version: v1.0.0-alpha.0
  - Build date: 2022-11-28T09:00:20.924958308Z[Etc/UTC]
...
<dependency>
  ...
  <version>v1.0.0-alpha.0</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v1.0.0-alpha.0"
  }
```
...
* `target/client-v1.0.0-alpha.0.jar`
* `target/lib/*.jar`
