...
- API version: v0.0.1-alpha.179
  - Build date: 2022-05-19T14:26:01.392920076Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.179</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.179"
  }
```
...
* `target/client-v0.0.1-alpha.179.jar`
* `target/lib/*.jar`
