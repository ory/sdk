...
- API version: v0.0.1-alpha.10
  - Build date: 2021-07-06T16:23:29.702573788Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.10</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.10"
```
...
* `target/client-v0.0.1-alpha.10.jar`
* `target/lib/*.jar`
