...
- API version: v0.0.1-alpha.155
  - Build date: 2022-04-06T15:37:11.935403370Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.155</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.155"
  }
```
...
* `target/client-v0.0.1-alpha.155.jar`
* `target/lib/*.jar`
