...
- API version: v0.0.1-alpha.150
  - Build date: 2022-03-30T14:03:59.681281531Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.150</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.150"
  }
```
...
* `target/client-v0.0.1-alpha.150.jar`
* `target/lib/*.jar`
