...
- API version: v0.0.1-alpha.154
  - Build date: 2022-04-06T14:57:20.152719565Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.154</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.154"
  }
```
...
* `target/client-v0.0.1-alpha.154.jar`
* `target/lib/*.jar`
