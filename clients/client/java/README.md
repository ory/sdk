...
- API version: v0.2.0-alpha.16
  - Build date: 2022-08-23T16:56:02.881567578Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.16</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.16"
  }
```
...
* `target/client-v0.2.0-alpha.16.jar`
* `target/lib/*.jar`
