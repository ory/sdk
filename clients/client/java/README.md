...
- API version: v0.0.1-alpha.37
  - Build date: 2022-01-06T12:29:23.840863408Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.37</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.37"
```
...
* `target/client-v0.0.1-alpha.37.jar`
* `target/lib/*.jar`
