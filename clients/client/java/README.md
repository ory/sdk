...
- API version: v0.0.1-alpha.40
  - Build date: 2022-01-06T18:17:09.059547978Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.40</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.40"
```
...
* `target/client-v0.0.1-alpha.40.jar`
* `target/lib/*.jar`
