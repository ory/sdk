...
- API version: v0.0.1-alpha.145
  - Build date: 2022-03-23T11:30:15.818275846Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.145</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.145"
  }
```
...
* `target/client-v0.0.1-alpha.145.jar`
* `target/lib/*.jar`
