...
- API version: v0.0.1-alpha.28
  - Build date: 2021-11-23T13:06:56.339941300Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.28</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.28"
```
...
* `target/client-v0.0.1-alpha.28.jar`
* `target/lib/*.jar`
