...
- API version: v0.0.1-alpha.79
  - Build date: 2022-02-09T10:19:31.002746651Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.79</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.79"
  }
```
...
* `target/client-v0.0.1-alpha.79.jar`
* `target/lib/*.jar`
