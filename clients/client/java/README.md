...
- API version: v0.2.0-alpha.39
  - Build date: 2022-09-12T14:18:52.808756159Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.39</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.39"
  }
```
...
* `target/client-v0.2.0-alpha.39.jar`
* `target/lib/*.jar`
