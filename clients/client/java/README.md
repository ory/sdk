...
- API version: v0.0.1-alpha.126
  - Build date: 2022-03-15T06:51:20.284199509Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.126</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.126"
  }
```
...
* `target/client-v0.0.1-alpha.126.jar`
* `target/lib/*.jar`
