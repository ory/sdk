...
- API version: v0.0.1-alpha.43
  - Build date: 2022-01-09T18:48:27.949817045Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.43</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.43"
```
...
* `target/client-v0.0.1-alpha.43.jar`
* `target/lib/*.jar`
