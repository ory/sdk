...
- API version: v0.0.1-alpha.99
  - Build date: 2022-02-16T10:52:00.912760073Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.99</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.99"
  }
```
...
* `target/client-v0.0.1-alpha.99.jar`
* `target/lib/*.jar`
