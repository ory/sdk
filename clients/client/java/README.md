...
- API version: v0.0.1-alpha.23
  - Build date: 2021-11-18T10:15:58.140655562Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.23</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.23"
```
...
* `target/client-v0.0.1-alpha.23.jar`
* `target/lib/*.jar`
