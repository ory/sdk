...
- API version: v0.0.1-alpha.182
  - Build date: 2022-05-26T09:21:05.476736265Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.182</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.182"
  }
```
...
* `target/client-v0.0.1-alpha.182.jar`
* `target/lib/*.jar`
