...
- API version: v0.0.1-alpha.128
  - Build date: 2022-03-15T09:27:27.312553394Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.128</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.128"
  }
```
...
* `target/client-v0.0.1-alpha.128.jar`
* `target/lib/*.jar`
