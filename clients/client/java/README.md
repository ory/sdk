...
- API version: v0.0.1-alpha.157
  - Build date: 2022-04-06T19:09:37.881069760Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.157</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.157"
  }
```
...
* `target/client-v0.0.1-alpha.157.jar`
* `target/lib/*.jar`
