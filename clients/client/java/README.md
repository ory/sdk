...
- API version: v0.0.1-alpha.178
  - Build date: 2022-05-18T06:51:35.733264285Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.178</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.178"
  }
```
...
* `target/client-v0.0.1-alpha.178.jar`
* `target/lib/*.jar`
