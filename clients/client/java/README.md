...
- API version: v0.2.0-alpha.15
  - Build date: 2022-08-23T15:57:46.854722145Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.15</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.15"
  }
```
...
* `target/client-v0.2.0-alpha.15.jar`
* `target/lib/*.jar`
