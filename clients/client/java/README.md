...
- API version: v0.0.1-alpha.168
  - Build date: 2022-04-19T08:11:59.903172188Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.168</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.168"
  }
```
...
* `target/client-v0.0.1-alpha.168.jar`
* `target/lib/*.jar`
