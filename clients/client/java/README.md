...
- API version: v0.0.1-alpha.29
  - Build date: 2021-11-24T16:29:33.176156252Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.29</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.29"
```
...
* `target/client-v0.0.1-alpha.29.jar`
* `target/lib/*.jar`
