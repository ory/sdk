...
- API version: v0.0.1-alpha.176
  - Build date: 2022-05-16T18:14:41.361634909Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.176</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.176"
  }
```
...
* `target/client-v0.0.1-alpha.176.jar`
* `target/lib/*.jar`
