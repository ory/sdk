...
- API version: v0.0.1-alpha.163
  - Build date: 2022-04-12T12:33:02.806112914Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.163</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.163"
  }
```
...
* `target/client-v0.0.1-alpha.163.jar`
* `target/lib/*.jar`
