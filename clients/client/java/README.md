...
- API version: v0.0.1-alpha.81
  - Build date: 2022-02-09T22:43:28.154218656Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.81</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.81"
  }
```
...
* `target/client-v0.0.1-alpha.81.jar`
* `target/lib/*.jar`
