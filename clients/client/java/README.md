...
- API version: v0.0.1-alpha.76
  - Build date: 2022-02-08T17:54:00.445693694Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.76</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.76"
  }
```
...
* `target/client-v0.0.1-alpha.76.jar`
* `target/lib/*.jar`
