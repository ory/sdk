...
- API version: v0.2.0-alpha.47
  - Build date: 2022-09-15T10:52:22.064462360Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.47</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.47"
  }
```
...
* `target/client-v0.2.0-alpha.47.jar`
* `target/lib/*.jar`
