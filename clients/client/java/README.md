...
- API version: v0.0.1-alpha.139
  - Build date: 2022-03-20T14:11:28.551680374Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.139</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.139"
  }
```
...
* `target/client-v0.0.1-alpha.139.jar`
* `target/lib/*.jar`
