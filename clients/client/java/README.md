...
- API version: v0.0.1-alpha.112
  - Build date: 2022-03-03T07:33:35.225223276Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.112</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.112"
  }
```
...
* `target/client-v0.0.1-alpha.112.jar`
* `target/lib/*.jar`
