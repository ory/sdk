...
- API version: v0.0.1-alpha.44
  - Build date: 2022-01-11T13:09:13.122587028Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.44</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.44"
```
...
* `target/client-v0.0.1-alpha.44.jar`
* `target/lib/*.jar`
