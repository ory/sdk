...
- API version: v0.2.0-alpha.46
  - Build date: 2022-09-15T08:54:29.213545147Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.46</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.46"
  }
```
...
* `target/client-v0.2.0-alpha.46.jar`
* `target/lib/*.jar`
