...
- API version: v0.0.1-alpha.71
  - Build date: 2022-02-06T18:31:34.031015113Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.71</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.71"
  }
```
...
* `target/client-v0.0.1-alpha.71.jar`
* `target/lib/*.jar`
