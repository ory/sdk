...
- API version: v0.0.1-alpha.127
  - Build date: 2022-03-15T07:44:30.986397481Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.127</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.127"
  }
```
...
* `target/client-v0.0.1-alpha.127.jar`
* `target/lib/*.jar`
