...
- API version: v0.0.1-alpha.98
  - Build date: 2022-02-16T10:32:38.731017650Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.98</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.98"
  }
```
...
* `target/client-v0.0.1-alpha.98.jar`
* `target/lib/*.jar`
