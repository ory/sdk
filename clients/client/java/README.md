...
- API version: v0.0.1-alpha.167
  - Build date: 2022-04-14T12:00:18.510560049Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.167</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.167"
  }
```
...
* `target/client-v0.0.1-alpha.167.jar`
* `target/lib/*.jar`
