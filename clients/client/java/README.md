...
- API version: v0.0.1-alpha.141
  - Build date: 2022-03-21T12:51:14.771464190Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.141</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.141"
  }
```
...
* `target/client-v0.0.1-alpha.141.jar`
* `target/lib/*.jar`
