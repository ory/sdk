...
- API version: v0.0.1-alpha.55
  - Build date: 2022-01-20T18:33:03.018302407Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.55</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.55"
```
...
* `target/client-v0.0.1-alpha.55.jar`
* `target/lib/*.jar`
