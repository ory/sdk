...
- API version: v0.0.1-alpha.149
  - Build date: 2022-03-30T13:47:28.174373706Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.149</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.149"
  }
```
...
* `target/client-v0.0.1-alpha.149.jar`
* `target/lib/*.jar`
