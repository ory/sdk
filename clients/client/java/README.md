...
- API version: v0.0.1-alpha.91
  - Build date: 2022-02-11T09:24:03.703211281Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.91</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.91"
  }
```
...
* `target/client-v0.0.1-alpha.91.jar`
* `target/lib/*.jar`
