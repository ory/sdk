...
- API version: v0.2.0-alpha.24
  - Build date: 2022-08-30T11:32:43.925337871Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.24</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.24"
  }
```
...
* `target/client-v0.2.0-alpha.24.jar`
* `target/lib/*.jar`
