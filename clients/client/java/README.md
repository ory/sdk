...
- API version: v0.0.1-alpha.96
  - Build date: 2022-02-15T19:20:28.174680724Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.96</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.96"
  }
```
...
* `target/client-v0.0.1-alpha.96.jar`
* `target/lib/*.jar`
