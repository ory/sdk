...
- API version: v0.2.0-alpha.27
  - Build date: 2022-09-06T12:49:04.907927480Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.27</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.27"
  }
```
...
* `target/client-v0.2.0-alpha.27.jar`
* `target/lib/*.jar`
