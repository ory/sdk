...
- API version: v0.0.1-alpha.106
  - Build date: 2022-02-23T10:33:21.785882690Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.106</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.106"
  }
```
...
* `target/client-v0.0.1-alpha.106.jar`
* `target/lib/*.jar`
