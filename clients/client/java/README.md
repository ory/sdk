...
- API version: v0.2.0-alpha.41
  - Build date: 2022-09-14T13:42:50.661579478Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.41</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.41"
  }
```
...
* `target/client-v0.2.0-alpha.41.jar`
* `target/lib/*.jar`
