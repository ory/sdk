...
- API version: v1.1.39-alpha.0
  - Build date: 2023-06-28T11:04:15.642376473Z[Etc/UTC]
...
<dependency>
  ...
  <version>v1.1.39-alpha.0</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v1.1.39-alpha.0"
  }
```
...
* `target/client-v1.1.39-alpha.0.jar`
* `target/lib/*.jar`
