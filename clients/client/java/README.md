...
- API version: v0.0.1-alpha.140
  - Build date: 2022-03-21T10:11:15.990610509Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.140</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.140"
  }
```
...
* `target/client-v0.0.1-alpha.140.jar`
* `target/lib/*.jar`
