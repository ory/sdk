...
- API version: v0.0.1-alpha.153
  - Build date: 2022-04-05T07:54:30.704658569Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.153</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.153"
  }
```
...
* `target/client-v0.0.1-alpha.153.jar`
* `target/lib/*.jar`
