...
- API version: v0.2.0-alpha.30
  - Build date: 2022-09-07T07:55:59.032155696Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.30</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.30"
  }
```
...
* `target/client-v0.2.0-alpha.30.jar`
* `target/lib/*.jar`
