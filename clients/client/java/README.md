...
- API version: v0.0.1-alpha.82
  - Build date: 2022-02-10T07:31:26.000888076Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.82</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.82"
  }
```
...
* `target/client-v0.0.1-alpha.82.jar`
* `target/lib/*.jar`
