...
- API version: v0.0.1-alpha.52
  - Build date: 2022-01-20T09:05:55.566864246Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.52</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.52"
```
...
* `target/client-v0.0.1-alpha.52.jar`
* `target/lib/*.jar`
