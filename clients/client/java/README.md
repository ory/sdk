...
- API version: v0.1.0-alpha.5
  - Build date: 2022-07-19T14:43:42.952171105Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.1.0-alpha.5</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.1.0-alpha.5"
  }
```
...
* `target/client-v0.1.0-alpha.5.jar`
* `target/lib/*.jar`
