...
- API version: v0.2.0-alpha.40
  - Build date: 2022-09-13T13:07:22.673267467Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.40</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.40"
  }
```
...
* `target/client-v0.2.0-alpha.40.jar`
* `target/lib/*.jar`
