...
- API version: v0.0.1-alpha.18
  - Build date: 2021-09-01T15:43:49.688214874Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.18</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.18"
```
...
* `target/client-v0.0.1-alpha.18.jar`
* `target/lib/*.jar`
