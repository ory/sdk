...
- API version: v0.2.0-alpha.20
  - Build date: 2022-08-26T08:30:03.017335438Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.20</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.20"
  }
```
...
* `target/client-v0.2.0-alpha.20.jar`
* `target/lib/*.jar`
