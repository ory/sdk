...
- API version: v0.0.1-alpha.142
  - Build date: 2022-03-21T13:27:30.377916963Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.142</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.142"
  }
```
...
* `target/client-v0.0.1-alpha.142.jar`
* `target/lib/*.jar`
