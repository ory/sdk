...
- API version: v0.0.1-alpha.130
  - Build date: 2022-03-16T14:18:24.638830787Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.130</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.130"
  }
```
...
* `target/client-v0.0.1-alpha.130.jar`
* `target/lib/*.jar`
