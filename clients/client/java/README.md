...
- API version: v0.0.1-alpha.121
  - Build date: 2022-03-09T13:25:59.990952832Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.121</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.121"
  }
```
...
* `target/client-v0.0.1-alpha.121.jar`
* `target/lib/*.jar`
