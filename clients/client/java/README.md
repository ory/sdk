...
- API version: v0.0.1-alpha.80
  - Build date: 2022-02-09T11:31:01.638116247Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.80</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.80"
  }
```
...
* `target/client-v0.0.1-alpha.80.jar`
* `target/lib/*.jar`
