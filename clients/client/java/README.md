...
- API version: v0.0.1-alpha.41
  - Build date: 2022-01-06T19:30:43.919512362Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.41</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.41"
```
...
* `target/client-v0.0.1-alpha.41.jar`
* `target/lib/*.jar`
