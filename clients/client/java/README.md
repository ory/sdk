...
- API version: v0.0.1-alpha.188
  - Build date: 2022-06-09T13:48:24.946825497Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.188</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.188"
  }
```
...
* `target/client-v0.0.1-alpha.188.jar`
* `target/lib/*.jar`
