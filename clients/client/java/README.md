...
- API version: v0.0.1-alpha.117
  - Build date: 2022-03-07T16:24:31.700940535Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.117</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.117"
  }
```
...
* `target/client-v0.0.1-alpha.117.jar`
* `target/lib/*.jar`
