...
- API version: v0.2.0-alpha.34
  - Build date: 2022-09-07T14:25:18.032801892Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.34</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.34"
  }
```
...
* `target/client-v0.2.0-alpha.34.jar`
* `target/lib/*.jar`
