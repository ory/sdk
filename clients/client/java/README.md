...
- API version: v0.0.1-alpha.75
  - Build date: 2022-02-08T11:20:59.528804321Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.75</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.75"
  }
```
...
* `target/client-v0.0.1-alpha.75.jar`
* `target/lib/*.jar`
