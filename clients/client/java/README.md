...
- API version: v0.0.1-alpha.42
  - Build date: 2022-01-07T20:26:34.917598036Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.42</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.42"
```
...
* `target/client-v0.0.1-alpha.42.jar`
* `target/lib/*.jar`
