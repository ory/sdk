...
- API version: v0.0.1-alpha.36
  - Build date: 2022-01-04T13:19:02.977104464Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.36</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.36"
```
...
* `target/client-v0.0.1-alpha.36.jar`
* `target/lib/*.jar`
