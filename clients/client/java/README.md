...
- API version: v0.2.0-alpha.36
  - Build date: 2022-09-08T16:09:28.361097504Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.36</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.36"
  }
```
...
* `target/client-v0.2.0-alpha.36.jar`
* `target/lib/*.jar`
