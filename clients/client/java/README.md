...
- API version: v0.2.0-alpha.44
  - Build date: 2022-09-15T06:36:32.008616029Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.2.0-alpha.44</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.2.0-alpha.44"
  }
```
...
* `target/client-v0.2.0-alpha.44.jar`
* `target/lib/*.jar`
