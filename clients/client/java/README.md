...
- API version: v0.0.1-alpha.77
  - Build date: 2022-02-08T19:18:30.233882931Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.77</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.77"
  }
```
...
* `target/client-v0.0.1-alpha.77.jar`
* `target/lib/*.jar`
