...
- API version: v0.0.1-alpha.146
  - Build date: 2022-03-23T13:19:25.192284411Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.146</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.146"
  }
```
...
* `target/client-v0.0.1-alpha.146.jar`
* `target/lib/*.jar`
