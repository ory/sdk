...
- API version: v0.0.1-alpha.72
  - Build date: 2022-02-07T13:34:30.975829096Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.72</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.72"
  }
```
...
* `target/client-v0.0.1-alpha.72.jar`
* `target/lib/*.jar`
