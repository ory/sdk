...
- API version: v0.0.1-alpha.164
  - Build date: 2022-04-12T14:58:28.033474216Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.164</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.164"
  }
```
...
* `target/client-v0.0.1-alpha.164.jar`
* `target/lib/*.jar`
