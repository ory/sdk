...
- API version: v0.0.1-alpha.119
  - Build date: 2022-03-09T11:03:50.782367219Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.119</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.119"
  }
```
...
* `target/client-v0.0.1-alpha.119.jar`
* `target/lib/*.jar`
