...
- API version: v0.0.1-alpha.38
  - Build date: 2022-01-06T13:19:59.615481323Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.38</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory:client:v0.0.1-alpha.38"
```
...
* `target/client-v0.0.1-alpha.38.jar`
* `target/lib/*.jar`
