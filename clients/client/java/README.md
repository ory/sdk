...
- API version: v0.0.1-alpha.169
  - Build date: 2022-04-19T11:31:27.587817519Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.169</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.169"
  }
```
...
* `target/client-v0.0.1-alpha.169.jar`
* `target/lib/*.jar`
