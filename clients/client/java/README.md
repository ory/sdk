...
- API version: v0.0.1-alpha.144
  - Build date: 2022-03-21T14:32:51.020858484Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.1-alpha.144</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory:client:v0.0.1-alpha.144"
  }
```
...
* `target/client-v0.0.1-alpha.144.jar`
* `target/lib/*.jar`
