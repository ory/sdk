...
class VerificationFlowTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of VerificationFlow
        //val modelInstance = VerificationFlow()

        // to test the property `id` - ID represents the request's unique ID. When performing the verification flow, this represents the id in the verify ui's query parameter: http://<selfservice.flows.verification.ui_url>?request=<id>  type: string format: uuid
        should("test id") {
            // uncomment below to test the property
            //modelInstance.id shouldBe ("TODO")
        }

        // to test the property `state` - State represents the state of this request:  choose_method: ask the user to choose a method (e.g. verify your email) sent_email: the email has been sent to the user passed_challenge: the request was successful and the verification challenge was passed.
        should("test state") {
            // uncomment below to test the property
        ...
        // to test the property `expiresAt` - ExpiresAt is the time (UTC) when the request expires. If the user still wishes to verify the address, a new request has to be initiated.
        ...
        // to test the property `transientPayload` - TransientPayload is used to pass data from the verification flow to hooks and email templates
