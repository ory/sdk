...
class UpdateLoginFlowBodyTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UpdateLoginFlowBody
        //val modelInstance = UpdateLoginFlowBody()
        ...
        // to test the property `idTokenNonce` - IDTokenNonce is the nonce, used when generating the IDToken. If the provider supports nonce validation, the nonce will be validated against this value and required.
        should("test idTokenNonce") {
            // uncomment below to test the property
            //modelInstance.idTokenNonce shouldBe ("TODO")
        }

        // to test the property `traits` - The identity traits. This is a placeholder for the registration flow.
        should("test traits") {
            // uncomment below to test the property
