 ...
 */
@Serializable
enum class VerificationFlowState(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is VerificationFlowState) "$data" else null

        /**
         * Returns a valid [VerificationFlowState] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): VerificationFlowState? = data?.let {
