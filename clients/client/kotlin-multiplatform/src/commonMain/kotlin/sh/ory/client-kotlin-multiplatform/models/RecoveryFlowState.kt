 ...
 */
@Serializable
enum class RecoveryFlowState(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is RecoveryFlowState) "$data" else null

        /**
         * Returns a valid [RecoveryFlowState] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): RecoveryFlowState? = data?.let {
