...
import sh.ory.client-kotlin-multiplatform.auth.*
...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                ...
                "oryWorkspaceApiKey" to HttpBearerAuth("bearer"))
    }

    companion object {
        const val BASE_URL: String = "https://playground.projects.oryapis.com"
