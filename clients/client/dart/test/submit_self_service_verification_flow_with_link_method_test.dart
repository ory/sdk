...
// tests for SubmitSelfServiceVerificationFlowWithLinkMethod
void main() {
  final instance = SubmitSelfServiceVerificationFlowWithLinkMethod();

  group('test SubmitSelfServiceVerificationFlowWithLinkMethod', () {
