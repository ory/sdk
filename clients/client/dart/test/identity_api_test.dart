...
void main() {
  ...
  group(IdentityApi, () {
    ...
    //
    //Future<BuiltList<Identity>> listIdentities({ int perPage, int page, int pageSize, String pageToken, String consistency, String credentialsIdentifier, String previewCredentialsIdentifierSimilar }) async
