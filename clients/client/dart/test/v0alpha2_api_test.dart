...
void main() {
  ...
  group(V0alpha2Api, () {
    ...
    //
    //Future<SelfServiceRecoveryFlow> submitSelfServiceRecoveryFlow(String flow, { String token, String cookie, SubmitSelfServiceRecoveryFlowBody submitSelfServiceRecoveryFlowBody }) async
    ...
    //
    //Future<SuccessfulSelfServiceRegistrationWithoutBrowser> submitSelfServiceRegistrationFlow(String flow, { String cookie, SubmitSelfServiceRegistrationFlowBody submitSelfServiceRegistrationFlowBody }) async
    ...
    //
    //Future<SelfServiceSettingsFlow> submitSelfServiceSettingsFlow(String flow, { String xSessionToken, String cookie, SubmitSelfServiceSettingsFlowBody submitSelfServiceSettingsFlowBody }) async
    ...
    //
    //Future<SelfServiceVerificationFlow> submitSelfServiceVerificationFlow(String flow, { String token, String cookie, SubmitSelfServiceVerificationFlowBody submitSelfServiceVerificationFlowBody }) async
