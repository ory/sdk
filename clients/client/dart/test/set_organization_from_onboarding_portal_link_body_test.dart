...
// tests for SetOrganizationFromOnboardingPortalLinkBody
void main() {
  final instance = SetOrganizationFromOnboardingPortalLinkBodyBuilder();
  // TODO add properties to the builder and call build()

  group(SetOrganizationFromOnboardingPortalLinkBody, () {
