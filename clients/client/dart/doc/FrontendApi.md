...
try {
    final response = api.createBrowserRegistrationFlow(returnTo, loginChallenge, afterVerificationReturnTo, organization, identitySchema);
    print(response);
} catch on DioException (e) {
...
try {
    final response = api.createNativeRegistrationFlow(returnSessionTokenExchangeCode, returnTo, organization, identitySchema);
    print(response);
} catch on DioException (e) {
