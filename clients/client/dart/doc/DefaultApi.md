...
> RegistrationFlow initializeSelfServiceRegistrationForBrowsers()
...
try { 
    final result = api_instance.initializeSelfServiceRegistrationForBrowsers();
    print(result);
} catch (e) {
...
> RegistrationFlow initializeSelfServiceRegistrationWithoutBrowser()
...
try { 
    final result = api_instance.initializeSelfServiceRegistrationWithoutBrowser();
    print(result);
} catch (e) {
    print('Exception when calling DefaultApi->initializeSelfServiceRegistrationWithoutBrowser: $e\n');
}
```
