...
# **listIdentities**
> BuiltList<Identity> listIdentities(perPage, page, pageSize, pageToken, credentialsIdentifier)
...
try {
    final response = api.listIdentities(perPage, page, pageSize, pageToken, credentialsIdentifier);
    print(response);
} catch on DioError (e) {
