...
**hydraStrategiesAccessToken** | [**JsonObject**](.md) | Defines access token type. jwt is a bad idea, see https://www.ory.sh/docs/hydra/advanced#json-web-tokens  This governs the \"strategies.access_token\" setting. | [optional] 
**hydraStrategiesScope** | [**JsonObject**](.md) | Defines how scopes are matched. For more details have a look at https://github.com/ory/fosite#scopes  This governs the \"strategies.scope\" setting. | [optional] 
