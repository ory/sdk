...
**hydraOauth2SessionAllowedTopLevelClaims** | **BuiltList&lt;String&gt;** |  | [optional] 
...
**hydraStrategiesAccessToken** | **String** | Defines access token type. jwt is a bad idea, see https://www.ory.sh/docs/hydra/advanced#json-web-tokens  This governs the \"strategies.access_token\" setting. | [optional] [default to 'opaque']
**hydraStrategiesScope** | **String** | Defines how scopes are matched. For more details have a look at https://github.com/ory/fosite#scopes  This governs the \"strategies.scope\" setting. | [optional] [default to 'wildcard']
...
**kratosSelfserviceMethodsCodeEnabled** | **bool** |  | [optional] 
