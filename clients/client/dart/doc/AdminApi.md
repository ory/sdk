...
final acceptLoginRequest = AcceptLoginRequest(); // AcceptLoginRequest | 

try {
    final result = api_instance.acceptLoginRequest(loginChallenge, acceptLoginRequest);
    print(result);
} catch (e) {
...
final jsonWebKeySetGeneratorRequest = JsonWebKeySetGeneratorRequest(); // JsonWebKeySetGeneratorRequest | 

try {
    final result = api_instance.createJsonWebKeySet(set_, jsonWebKeySetGeneratorRequest);
    print(result);
} catch (e) {
...
final api_instance = AdminApi();
final flushInactiveOAuth2TokensRequest = FlushInactiveOAuth2TokensRequest(); // FlushInactiveOAuth2TokensRequest | 
...
try {
    final result = api_instance.getTrustedJwtGrantIssuer(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listOAuth2Clients(limit, offset, clientName, owner);
    print(result);
} catch (e) {
...
final limit = 789; // int | The maximum amount of consent sessions to be returned, upper bound is 500 sessions.
final offset = 789; // int | The offset from where to start looking.

try {
    final result = api_instance.listSubjectConsentSessions(subject, limit, offset);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listTrustedJwtGrantIssuers(issuer, limit, offset);
    print(result);
} catch (e) {
...
final api_instance = AdminApi();
final id = id_example; // String | The id of the OAuth 2.0 Client.
final patchDocument = [List<PatchDocument>()]; // List<PatchDocument> | 

try {
    final result = api_instance.patchOAuth2Client(id, patchDocument);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.rejectConsentRequest(consentChallenge, rejectRequest);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.rejectLoginRequest(loginChallenge, rejectRequest);
    print(result);
} catch (e) {
...
final api_instance = AdminApi();
final trustJwtGrantIssuerBody = TrustJwtGrantIssuerBody(); // TrustJwtGrantIssuerBody | 

try {
    final result = api_instance.trustJwtGrantIssuer(trustJwtGrantIssuerBody);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.updateJsonWebKey(kid, set_, jSONWebKey);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.updateJsonWebKeySet(set_, jSONWebKeySet);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.updateOAuth2Client(id, oAuth2Client);
    print(result);
} catch (e) {
