...
part 'project_revision_hook.g.dart';

abstract class ProjectRevisionHook implements Built<ProjectRevisionHook, ProjectRevisionHookBuilder> {
    ...
    ProjectRevisionHook._();

    static void _initializeBuilder(ProjectRevisionHookBuilder b) => b;

    factory ProjectRevisionHook([void updates(ProjectRevisionHookBuilder b)]) = _$ProjectRevisionHook;

    @BuiltValueSerializer(custom: true)
    static Serializer<ProjectRevisionHook> get serializer => _$ProjectRevisionHookSerializer();
}

class _$ProjectRevisionHookSerializer implements StructuredSerializer<ProjectRevisionHook> {

    @override
    final Iterable<Type> types = const [ProjectRevisionHook, _$ProjectRevisionHook];
    @override
    final String wireName = r'ProjectRevisionHook';

    @override
    Iterable<Object> serialize(Serializers serializers, ProjectRevisionHook object,
    ...
    @override
    ProjectRevisionHook deserialize(Serializers serializers, Iterable<Object> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ProjectRevisionHookBuilder();
