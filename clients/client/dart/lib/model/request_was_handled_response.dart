...
class RequestWasHandledResponse {
  ...
  static RequestWasHandledResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RequestWasHandledResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RequestWasHandledResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<RequestWasHandledResponse>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RequestWasHandledResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RequestWasHandledResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RequestWasHandledResponse> mapFromJson(dynamic json) {
    final map = <String, RequestWasHandledResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RequestWasHandledResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<RequestWasHandledResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RequestWasHandledResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RequestWasHandledResponse.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
