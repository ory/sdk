...
class AcceptConsentRequest {
  ...
  static AcceptConsentRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AcceptConsentRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AcceptConsentRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AcceptConsentRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AcceptConsentRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AcceptConsentRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AcceptConsentRequest> mapFromJson(dynamic json) {
    final map = <String, AcceptConsentRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AcceptConsentRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<AcceptConsentRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AcceptConsentRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AcceptConsentRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
