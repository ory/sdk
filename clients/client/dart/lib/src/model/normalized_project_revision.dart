...
abstract class NormalizedProjectRevision implements Built<NormalizedProjectRevision, NormalizedProjectRevisionBuilder> {
  ...
  NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum? get hydraStrategiesJwtScopeClaim;
  ...
  static void _defaults(NormalizedProjectRevisionBuilder b) => b
      ...
      ..hydraStrategiesJwtScopeClaim = const NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum._('list')
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.hydraStrategiesJwtScopeClaim != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum),
      );
    }
      ...
      switch (key) {
        ...
        case r'hydra_strategies_jwt_scope_claim':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum),
          ) as NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum;
...
class NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum extends EnumClass {

  /// Define the claim to use as the scope in the access token.  This governs the \"strategies.jwt.scope_claim\" setting:  list: The scope claim is an array of strings named `scope`: `{ \"scope\": [\"read\", \"write\"] }` string: The scope claim is a space delimited list of strings named `scp`: `{ \"scp\": \"read write\" }` both: The scope claim is both a space delimited list and an array of strings named `scope` and `scp`: `{ \"scope\": [\"read\", \"write\"], \"scp\": \"read write\" }` list OAuth2JWTScopeClaimList string OAuth2JWTScopeClaimString both OAuth2JWTScopeClaimBoth
  @BuiltValueEnumConst(wireName: r'list')
  static const NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum list = _$normalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum_list;
  /// Define the claim to use as the scope in the access token.  This governs the \"strategies.jwt.scope_claim\" setting:  list: The scope claim is an array of strings named `scope`: `{ \"scope\": [\"read\", \"write\"] }` string: The scope claim is a space delimited list of strings named `scp`: `{ \"scp\": \"read write\" }` both: The scope claim is both a space delimited list and an array of strings named `scope` and `scp`: `{ \"scope\": [\"read\", \"write\"], \"scp\": \"read write\" }` list OAuth2JWTScopeClaimList string OAuth2JWTScopeClaimString both OAuth2JWTScopeClaimBoth
  @BuiltValueEnumConst(wireName: r'string')
  static const NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum string = _$normalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum_string;
  /// Define the claim to use as the scope in the access token.  This governs the \"strategies.jwt.scope_claim\" setting:  list: The scope claim is an array of strings named `scope`: `{ \"scope\": [\"read\", \"write\"] }` string: The scope claim is a space delimited list of strings named `scp`: `{ \"scp\": \"read write\" }` both: The scope claim is both a space delimited list and an array of strings named `scope` and `scp`: `{ \"scope\": [\"read\", \"write\"], \"scp\": \"read write\" }` list OAuth2JWTScopeClaimList string OAuth2JWTScopeClaimString both OAuth2JWTScopeClaimBoth
  @BuiltValueEnumConst(wireName: r'both')
  static const NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum both = _$normalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum_both;

  static Serializer<NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum> get serializer => _$normalizedProjectRevisionHydraStrategiesJwtScopeClaimEnumSerializer;

  const NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum._(String name): super(name);

  static BuiltSet<NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum> get values => _$normalizedProjectRevisionHydraStrategiesJwtScopeClaimEnumValues;
  static NormalizedProjectRevisionHydraStrategiesJwtScopeClaimEnum valueOf(String name) => _$normalizedProjectRevisionHydraStrategiesJwtScopeClaimEnumValueOf(name);
}
