...
class _$SelfServiceRecoveryFlowSerializer implements PrimitiveSerializer<SelfServiceRecoveryFlow> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    SelfServiceRecoveryFlow object, {
  ...
  void _deserializeProperties(
    ...
    required SelfServiceRecoveryFlowBuilder result,
      ...
      switch (key) {
        ...
        case r'state':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(SelfServiceRecoveryFlowState),
          ) as SelfServiceRecoveryFlowState;
  ...
  @override
  SelfServiceRecoveryFlow deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
