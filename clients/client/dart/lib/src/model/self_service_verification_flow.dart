...
class _$SelfServiceVerificationFlowSerializer implements PrimitiveSerializer<SelfServiceVerificationFlow> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    SelfServiceVerificationFlow object, {
  ...
  void _deserializeProperties(
    ...
    required SelfServiceVerificationFlowBuilder result,
      ...
      switch (key) {
        ...
        case r'state':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(SelfServiceVerificationFlowState),
          ) as SelfServiceVerificationFlowState;
  ...
  @override
  SelfServiceVerificationFlow deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
