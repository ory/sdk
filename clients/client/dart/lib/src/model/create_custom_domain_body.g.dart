...
part of 'create_custom_domain_body.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CreateCustomDomainBody extends CreateCustomDomainBody {
  @override
  ...
  factory _$CreateCustomDomainBody(
          [void Function(CreateCustomDomainBodyBuilder)? updates]) =>
      (new CreateCustomDomainBodyBuilder()..update(updates))._build();

  _$CreateCustomDomainBody._(
      {this.cookieDomain,
  ...
  @override
  CreateCustomDomainBody rebuild(
          void Function(CreateCustomDomainBodyBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CreateCustomDomainBodyBuilder toBuilder() =>
      new CreateCustomDomainBodyBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CreateCustomDomainBody &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CreateCustomDomainBody')
...
class CreateCustomDomainBodyBuilder
    implements Builder<CreateCustomDomainBody, CreateCustomDomainBodyBuilder> {
  _$CreateCustomDomainBody? _$v;
  ...
  CreateCustomDomainBodyBuilder() {
    CreateCustomDomainBody._defaults(this);
  }

  CreateCustomDomainBodyBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(CreateCustomDomainBody other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$CreateCustomDomainBody;
  }

  @override
  void update(void Function(CreateCustomDomainBodyBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  CreateCustomDomainBody build() => _build();

  _$CreateCustomDomainBody _build() {
    _$CreateCustomDomainBody _$result;
    try {
      _$result = _$v ??
          new _$CreateCustomDomainBody._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'CreateCustomDomainBody', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
