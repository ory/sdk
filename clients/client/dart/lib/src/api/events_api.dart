...
class EventsApi {
  ...
  Future<Response<EventStream>> createEventStream({ 
    ...
    try {
      const _type = FullType(CreateEventStreamBody);
    ...
    EventStream? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EventStream),
      ) as EventStream;
  ...
  /// Parameters:
  /// * [projectId] - Project ID  The project's ID.
  /// * [eventStreamId] - Event Stream ID  The ID of the event stream to be deleted, as returned when created.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<ListEventStreams>> listEventStreams({ 
    ...
    ListEventStreams? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListEventStreams),
      ) as ListEventStreams;
    ...
    return Response<ListEventStreams>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [projectId] - Project ID  The project's ID.
  /// * [eventStreamId] - Event Stream ID  The event stream's ID.
  /// * [setEventStreamBody] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  Future<Response<EventStream>> setEventStream({ 
    ...
    try {
      const _type = FullType(SetEventStreamBody);
