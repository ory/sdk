...
class WorkspaceApi {
  ...
  Future<Response<Workspace>> createWorkspace({ 
    ...
    try {
      const _type = FullType(CreateWorkspaceBody);
      _bodyData = createWorkspaceBody == null ? null : _serializers.serialize(createWorkspaceBody, specifiedType: _type);
  ...
  Future<Response<Workspace>> getWorkspace({ 
    ...
    final _path = r'/workspaces/{workspace}'.replaceAll('{' r'workspace' '}', encodeQueryParameter(_serializers, workspace, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListWorkspaceProjects] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListWorkspaceProjects>> listWorkspaceProjects({ 
    required String workspace,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/workspaces/{workspace}/projects'.replaceAll('{' r'workspace' '}', encodeQueryParameter(_serializers, workspace, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ListWorkspaceProjects? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListWorkspaceProjects),
      ) as ListWorkspaceProjects;
    ...
    return Response<ListWorkspaceProjects>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListWorkspaces] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListWorkspaces>> listWorkspaces({ 
    int? pageSize = 250,
    String? pageToken,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    ListWorkspaces? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListWorkspaces),
      ) as ListWorkspaces;
    ...
    return Response<ListWorkspaces>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Workspace] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Workspace>> updateWorkspace({ 
    required String workspace,
    ...
    try {
      const _type = FullType(UpdateWorkspaceBody);
      _bodyData = updateWorkspaceBody == null ? null : _serializers.serialize(updateWorkspaceBody, specifiedType: _type);
