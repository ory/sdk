...
class MetadataApi {
  ...
  Future<Response> getVersionWithHttpInfo() async {
    final path = r'/api/kratos/public/version';
  ...
  Future<Response> isAliveWithHttpInfo() async {
    final path = r'/api/kratos/public/health/alive';
  ...
  Future<Response> isReadyWithHttpInfo() async {
    final path = r'/api/kratos/public/health/ready';
  ...
  Future<Response> prometheusWithHttpInfo() async {
    final path = r'/api/kratos/public/metrics/prometheus';
