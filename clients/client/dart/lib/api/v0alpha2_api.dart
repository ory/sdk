...
class V0alpha2Api {
  ...
  Future<Response> createProjectApiKeyWithHttpInfo(String project, { CreateProjectApiKeyRequest? createProjectApiKeyRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/projects/{project}/tokens'
  ...
  Future<ProjectApiKey?> createProjectApiKey(String project, { CreateProjectApiKeyRequest? createProjectApiKeyRequest, }) async {
    final response = await createProjectApiKeyWithHttpInfo(project,  createProjectApiKeyRequest: createProjectApiKeyRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///   The Token ID
  Future<Response> deleteProjectApiKeyWithHttpInfo(String project, String tokenId,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [String] tokenId (required):
  ///   The Token ID
  Future<void> deleteProjectApiKey(String project, String tokenId,) async {
    final response = await deleteProjectApiKeyWithHttpInfo(project, tokenId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// * [String] project (required):
  ///   The Project ID or Project slug
  Future<Response> listProjectApiKeysWithHttpInfo(String project,) async {
    // ignore: prefer_const_declarations
    final path = r'/projects/{project}/tokens'
      .replaceAll('{project}', project);
  ...
  Future<List<ProjectApiKey>?> listProjectApiKeys(String project,) async {
    final response = await listProjectApiKeysWithHttpInfo(project,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<ProjectApiKey>') as List)
        .cast<ProjectApiKey>()
        .toList();
