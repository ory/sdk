...
*DefaultApi* | [**initializeSelfServiceLoginWithoutBrowser**](doc//DefaultApi.md#initializeselfserviceloginwithoutbrowser) | **GET** /api/kratos/public/self-service/login/api | Initialize Login Flow for APIs, Services, Apps, ...
...
*DefaultApi* | [**initializeSelfServiceRegistrationWithoutBrowser**](doc//DefaultApi.md#initializeselfserviceregistrationwithoutbrowser) | **GET** /api/kratos/public/self-service/registration/api | Initialize Registration Flow for APIs, Services, Apps, ...
...
*DefaultApi* | [**submitSelfServiceVerificationFlow**](doc//DefaultApi.md#submitselfserviceverificationflow) | **POST** /api/kratos/public/self-service/verification/flows | Complete Verification Flow
