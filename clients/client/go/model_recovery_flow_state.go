...
const (
	...
	RECOVERYFLOWSTATE_RECOVERY_AWAITING_ADDRESS RecoveryFlowState = "recovery_awaiting_address"
	RECOVERYFLOWSTATE_RECOVERY_AWAITING_ADDRESS_CHOICE RecoveryFlowState = "recovery_awaiting_address_choice"
	RECOVERYFLOWSTATE_RECOVERY_CONFIRMING_ADDRESS RecoveryFlowState = "recovery_confirming_address"
	RECOVERYFLOWSTATE_RECOVERY_AWAITING_CODE RecoveryFlowState = "recovery_awaiting_code"
)
...
var AllowedRecoveryFlowStateEnumValues = []RecoveryFlowState{
	...
	"recovery_awaiting_address_choice",
	"recovery_confirming_address",
	"recovery_awaiting_code",
}
...
func (v *RecoveryFlowState) UnmarshalJSON(src []byte) error {
	...
	if string(src) == "null" {
		return fmt.Errorf("null is not a valid RecoveryFlowState")
	}
	var value string
