...
type LoginFlow struct {
	...
	State LoginFlowState `json:"state"`
...
func NewLoginFlow(expiresAt time.Time, id string, issuedAt time.Time, requestUrl string, state LoginFlowState, type_ string, ui UiContainer) *LoginFlow {
	this := LoginFlow{}
...
func (o *LoginFlow) GetState() LoginFlowState {
	if o == nil {
		var ret LoginFlowState
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LoginFlow) GetStateOk() (*LoginFlowState, bool) {
	if o == nil {
		return nil, false
	}
	return &o.State, true
...
func (o *LoginFlow) SetState(v LoginFlowState) {
	o.State = v
}
