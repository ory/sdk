...
type NamespacesApi interface {
	...
	*/
	GetNamespaces(ctx context.Context) NamespacesApiGetNamespacesRequest

	// GetNamespacesExecute executes the request
	//  @return GetNamespacesResponse
	GetNamespacesExecute(r NamespacesApiGetNamespacesRequest) (*GetNamespacesResponse, *http.Response, error)
}
...
func (r NamespacesApiGetNamespacesRequest) Execute() (*GetNamespacesResponse, *http.Response, error) {
...
//  @return GetNamespacesResponse
func (a *NamespacesApiService) GetNamespacesExecute(r NamespacesApiGetNamespacesRequest) (*GetNamespacesResponse, *http.Response, error) {
	var (
