...
**PasswordGrantAccessTokenLifespan** | Pointer to **NullableString** |  | [optional] 
**PasswordGrantRefreshTokenLifespan** | Pointer to **NullableString** |  | [optional] 
...
### SetPasswordGrantAccessTokenLifespanNil

`func (o *OAuth2Client) SetPasswordGrantAccessTokenLifespanNil(b bool)`

 SetPasswordGrantAccessTokenLifespanNil sets the value for PasswordGrantAccessTokenLifespan to be an explicit nil

### UnsetPasswordGrantAccessTokenLifespan
...
### SetPasswordGrantRefreshTokenLifespanNil

`func (o *OAuth2Client) SetPasswordGrantRefreshTokenLifespanNil(b bool)`

 SetPasswordGrantRefreshTokenLifespanNil sets the value for PasswordGrantRefreshTokenLifespan to be an explicit nil

### UnsetPasswordGrantRefreshTokenLifespan
