...
**PlanChangesAt** | Pointer to **NullableTime** |  | [optional] 
...
**StripeCheckoutExpiresAt** | Pointer to **NullableTime** |  | [optional] 
...
`func (o *Subscription) SetPlanChangesAtNil(b bool)`
...
### SetStripeCheckoutExpiresAtNil

`func (o *Subscription) SetStripeCheckoutExpiresAtNil(b bool)`

 SetStripeCheckoutExpiresAtNil sets the value for StripeCheckoutExpiresAt to be an explicit nil

### UnsetStripeCheckoutExpiresAt
