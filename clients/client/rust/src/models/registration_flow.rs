...
pub struct RegistrationFlow {
    ...
    #[serde(rename = "state")]
    pub state: models::RegistrationFlowState,
...
impl RegistrationFlow {
    pub fn new(expires_at: String, id: String, issued_at: String, request_url: String, state: models::RegistrationFlowState, r#type: String, ui: models::UiContainer) -> RegistrationFlow {
        RegistrationFlow {
            active: None,
            expires_at,
            id,
