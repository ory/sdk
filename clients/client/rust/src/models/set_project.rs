...
pub struct SetProject {
    ...
    pub organizations: Vec<models::BasicOrganization>,
    #[serde(rename = "services")]
    pub services: Box<models::ProjectServices>,
}

impl SetProject {
    pub fn new(cors_admin: models::ProjectCors, cors_public: models::ProjectCors, name: String, organizations: Vec<models::BasicOrganization>, services: models::ProjectServices) -> SetProject {
        SetProject {
