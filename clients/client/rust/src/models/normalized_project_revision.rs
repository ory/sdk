...
pub struct NormalizedProjectRevision {
    ...
    pub kratos_courier_channels: Option<Vec<crate::models::NormalizedProjectRevisionCourierChannel>>,
    ...
    pub kratos_session_whoami_tokenizer_templates: Option<Vec<crate::models::NormalizedProjectRevisionTokenizerTemplate>>,
    /// The project's name.
    #[serde(rename = "name")]
    pub name: String,
    ...
    pub project_revision_hooks: Option<Vec<crate::models::NormalizedProjectRevisionHook>>,
