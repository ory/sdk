...
pub struct NormalizedProjectRevision {
    ...
    #[serde(rename = "account_experience_contact_url", skip_serializing_if = "Option::is_none")]
    pub account_experience_contact_url: Option<String>,
    ...
    #[serde(rename = "account_experience_privacy_policy_url", skip_serializing_if = "Option::is_none")]
    pub account_experience_privacy_policy_url: Option<String>,
    /// Holds the URL to the account experience's Terms of Service page. This governs the \"terms_of_service_url\" setting.
    #[serde(rename = "account_experience_terms_of_service_url", skip_serializing_if = "Option::is_none")]
    pub account_experience_terms_of_service_url: Option<String>,
    ...
    #[serde(rename = "hydra_oauth2_device_authorization_token_polling_interval", skip_serializing_if = "Option::is_none")]
    pub hydra_oauth2_device_authorization_token_polling_interval: Option<String>,
    ...
    #[serde(rename = "hydra_oauth2_device_authorization_user_code_entropy_preset", skip_serializing_if = "Option::is_none")]
    pub hydra_oauth2_device_authorization_user_code_entropy_preset: Option<HydraOauth2DeviceAuthorizationUserCodeEntropyPresetEnum>,
    ...
    #[serde(rename = "hydra_oauth2_grant_jwt_omit_assertion_audience", skip_serializing_if = "Option::is_none")]
    pub hydra_oauth2_grant_jwt_omit_assertion_audience: Option<bool>,
    ...
    #[serde(rename = "hydra_oauth2_grant_refresh_token_rotation_grace_reuse_count", skip_serializing_if = "Option::is_none")]
    pub hydra_oauth2_grant_refresh_token_rotation_grace_reuse_count: Option<i64>,
    ...
    #[serde(rename = "hydra_oauth2_token_prefix", skip_serializing_if = "Option::is_none")]
    pub hydra_oauth2_token_prefix: Option<String>,
    ...
    #[serde(rename = "hydra_ttl_device_user_code", skip_serializing_if = "Option::is_none")]
    pub hydra_ttl_device_user_code: Option<String>,
    ...
    #[serde(rename = "hydra_urls_device_success", skip_serializing_if = "Option::is_none")]
    pub hydra_urls_device_success: Option<String>,
    ...
    #[serde(rename = "hydra_urls_device_verification", skip_serializing_if = "Option::is_none")]
    pub hydra_urls_device_verification: Option<String>,
    ...
    #[serde(rename = "hydra_webfinger_oidc_discovery_device_authorization_url", skip_serializing_if = "Option::is_none")]
    pub hydra_webfinger_oidc_discovery_device_authorization_url: Option<String>,
    ...
    #[serde(rename = "keto_feature_flags_strict_mode", skip_serializing_if = "Option::is_none")]
    pub keto_feature_flags_strict_mode: Option<bool>,
    ...
    #[serde(rename = "keto_strict_mode_readonly", skip_serializing_if = "Option::is_none")]
    pub keto_strict_mode_readonly: Option<bool>,
    ...
    #[serde(rename = "kratos_courier_templates_verifiable_address_changed_email_body_html", skip_serializing_if = "Option::is_none")]
    pub kratos_courier_templates_verifiable_address_changed_email_body_html: Option<String>,
    ...
    #[serde(rename = "kratos_courier_templates_verifiable_address_changed_email_body_plaintext", skip_serializing_if = "Option::is_none")]
    pub kratos_courier_templates_verifiable_address_changed_email_body_plaintext: Option<String>,
    ...
    #[serde(rename = "kratos_courier_templates_verifiable_address_changed_email_subject", skip_serializing_if = "Option::is_none")]
    pub kratos_courier_templates_verifiable_address_changed_email_subject: Option<String>,
    ...
    #[serde(rename = "kratos_courier_templates_verifiable_address_changed_sms_body_plaintext", skip_serializing_if = "Option::is_none")]
    pub kratos_courier_templates_verifiable_address_changed_sms_body_plaintext: Option<String>,
    ...
    #[serde(rename = "kratos_feature_flags_enforce_identity_schema_guards", skip_serializing_if = "Option::is_none")]
    pub kratos_feature_flags_enforce_identity_schema_guards: Option<bool>,
    ...
    #[serde(rename = "kratos_feature_flags_refresh_login_choose_address", skip_serializing_if = "Option::is_none")]
    pub kratos_feature_flags_refresh_login_choose_address: Option<bool>,
    ...
    #[serde(rename = "kratos_feature_flags_webhook_response_directives", skip_serializing_if = "Option::is_none")]
    pub kratos_feature_flags_webhook_response_directives: Option<bool>,
    ...
    #[serde(rename = "kratos_selfservice_methods_deviceauthn_config_android_allow_expired_factory_certificates", skip_serializing_if = "Option::is_none")]
    pub kratos_selfservice_methods_deviceauthn_config_android_allow_expired_factory_certificates: Option<bool>,
    ...
    #[serde(rename = "kratos_selfservice_methods_deviceauthn_config_android_app_ids", skip_serializing_if = "Option::is_none")]
    pub kratos_selfservice_methods_deviceauthn_config_android_app_ids: Option<Vec<String>>,
    ...
    #[serde(rename = "kratos_selfservice_methods_deviceauthn_config_first_factor", skip_serializing_if = "Option::is_none")]
    pub kratos_selfservice_methods_deviceauthn_config_first_factor: Option<bool>,
    ...
    #[serde(rename = "kratos_selfservice_methods_deviceauthn_config_insecure_allow_relaxed_attestation", skip_serializing_if = "Option::is_none")]
    pub kratos_selfservice_methods_deviceauthn_config_insecure_allow_relaxed_attestation: Option<bool>,
    ...
    #[serde(rename = "kratos_selfservice_methods_deviceauthn_config_ios_app_ids", skip_serializing_if = "Option::is_none")]
    pub kratos_selfservice_methods_deviceauthn_config_ios_app_ids: Option<Vec<String>>,
    ...
    #[serde(rename = "kratos_selfservice_methods_deviceauthn_config_ios_biometric_first_factor", skip_serializing_if = "Option::is_none")]
    pub kratos_selfservice_methods_deviceauthn_config_ios_biometric_first_factor: Option<bool>,
    ...
    #[serde(rename = "kratos_selfservice_methods_deviceauthn_config_pin_max_attempts", skip_serializing_if = "Option::is_none")]
    pub kratos_selfservice_methods_deviceauthn_config_pin_max_attempts: Option<i64>,
    ...
    #[serde(rename = "kratos_selfservice_methods_deviceauthn_enabled", skip_serializing_if = "Option::is_none")]
    pub kratos_selfservice_methods_deviceauthn_enabled: Option<bool>,
    ...
    #[serde(rename = "talos_cache_enabled", skip_serializing_if = "Option::is_none")]
    pub talos_cache_enabled: Option<bool>,
    /// Talos cache TTL controls how long API key verification results are cached.
    #[serde(rename = "talos_cache_ttl", skip_serializing_if = "Option::is_none")]
    pub talos_cache_ttl: Option<String>,
    /// Talos API keys default TTL.
    #[serde(rename = "talos_credentials_api_keys_default_ttl", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_api_keys_default_ttl: Option<String>,
    /// Talos API keys max TTL.
    #[serde(rename = "talos_credentials_api_keys_max_ttl", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_api_keys_max_ttl: Option<String>,
    /// Talos API keys prefix (current).
    #[serde(rename = "talos_credentials_api_keys_prefix_current", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_api_keys_prefix_current: Option<String>,
    /// Talos API keys public prefix (current).
    #[serde(rename = "talos_credentials_api_keys_prefix_public_current", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_api_keys_prefix_public_current: Option<String>,
    ...
    #[serde(rename = "talos_credentials_api_keys_prefix_public_retired", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_api_keys_prefix_public_retired: Option<Vec<String>>,
    ...
    #[serde(rename = "talos_credentials_api_keys_prefix_retired", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_api_keys_prefix_retired: Option<Vec<String>>,
    /// Talos derived tokens default TTL (applies to both JWT and macaroon tokens).
    #[serde(rename = "talos_credentials_derived_tokens_default_ttl", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_derived_tokens_default_ttl: Option<String>,
    /// Talos derived tokens JWT signing key ID (kid).
    #[serde(rename = "talos_credentials_derived_tokens_jwt_signing_key_id", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_derived_tokens_jwt_signing_key_id: Option<String>,
    /// Talos derived tokens JWT signing key URLs.
    #[serde(rename = "talos_credentials_derived_tokens_jwt_signing_keys_urls", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_derived_tokens_jwt_signing_keys_urls: Option<Vec<String>>,
    /// Talos derived tokens macaroon prefix (current).
    #[serde(rename = "talos_credentials_derived_tokens_macaroon_prefix_current", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_derived_tokens_macaroon_prefix_current: Option<String>,
    ...
    #[serde(rename = "talos_credentials_derived_tokens_macaroon_prefix_retired", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_derived_tokens_macaroon_prefix_retired: Option<Vec<String>>,
    /// Talos credentials issuer URL.
    #[serde(rename = "talos_credentials_issuer", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_issuer: Option<String>,
    ...
    #[serde(rename = "talos_credentials_issuer_retired", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_issuer_retired: Option<Vec<String>>,
    ...
    #[serde(rename = "talos_credentials_issuer_retired_entries", skip_serializing_if = "Option::is_none")]
    pub talos_credentials_issuer_retired_entries: Option<Vec<models::TalosRetiredValue>>,
    /// Talos rate limit enabled.  When true, server-side rate limiting is enforced for API key verifications.
    #[serde(rename = "talos_rate_limit_enabled", skip_serializing_if = "Option::is_none")]
    pub talos_rate_limit_enabled: Option<bool>,
    /// TalosSecretsHMACCurrent stores the current HMAC symmetric key as a plain secret string.
    #[serde(rename = "talos_secrets_hmac_current", skip_serializing_if = "Option::is_none")]
    pub talos_secrets_hmac_current: Option<String>,
    ...
    #[serde(rename = "talos_secrets_hmac_retired", skip_serializing_if = "Option::is_none")]
    pub talos_secrets_hmac_retired: Option<Vec<String>>,
    /// TalosRetiredValues is the list of retired values — retired HMAC secrets or retired issuer URLs — for a Talos project. A retired value stays valid for verification until its optional expiry passes, so operators can bound how long an old credential keeps working after a rotation instead of keeping it forever. Legacy bare-string entries are accepted on write and normalized to the object form.
    #[serde(rename = "talos_secrets_hmac_retired_entries", skip_serializing_if = "Option::is_none")]
    pub talos_secrets_hmac_retired_entries: Option<Vec<models::TalosRetiredValue>>,
...
impl NormalizedProjectRevision {
    pub fn new(name: String) -> NormalizedProjectRevision {
        NormalizedProjectRevision {
            account_experience_contact_url: None,
            ...
            account_experience_privacy_policy_url: None,
            account_experience_terms_of_service_url: None,
            ...
            hydra_oauth2_device_authorization_token_polling_interval: None,
            hydra_oauth2_device_authorization_user_code_entropy_preset: None,
            ...
            hydra_oauth2_grant_jwt_omit_assertion_audience: None,
            hydra_oauth2_grant_refresh_token_rotation_grace_period: None,
            hydra_oauth2_grant_refresh_token_rotation_grace_reuse_count: None,
            ...
            hydra_oauth2_token_prefix: None,
            ...
            hydra_webfinger_oidc_discovery_device_authorization_url: None,
            ...
            kratos_courier_templates_verifiable_address_changed_email_body_html: None,
            kratos_courier_templates_verifiable_address_changed_email_body_plaintext: None,
            kratos_courier_templates_verifiable_address_changed_email_subject: None,
            kratos_courier_templates_verifiable_address_changed_sms_body_plaintext: None,
            ...
            kratos_feature_flags_enforce_identity_schema_guards: None,
            ...
            kratos_feature_flags_refresh_login_choose_address: None,
            kratos_feature_flags_use_continue_with_transitions: None,
            kratos_feature_flags_webhook_response_directives: None,
            ...
            kratos_selfservice_methods_deviceauthn_config_android_allow_expired_factory_certificates: None,
            kratos_selfservice_methods_deviceauthn_config_android_app_ids: None,
            kratos_selfservice_methods_deviceauthn_config_first_factor: None,
            kratos_selfservice_methods_deviceauthn_config_insecure_allow_relaxed_attestation: None,
            kratos_selfservice_methods_deviceauthn_config_ios_app_ids: None,
            kratos_selfservice_methods_deviceauthn_config_ios_biometric_first_factor: None,
            kratos_selfservice_methods_deviceauthn_config_pin_max_attempts: None,
            kratos_selfservice_methods_deviceauthn_enabled: None,
            ...
            talos_cache_enabled: None,
            talos_cache_ttl: None,
            talos_credentials_api_keys_default_ttl: None,
            talos_credentials_api_keys_max_ttl: None,
            talos_credentials_api_keys_prefix_current: None,
            talos_credentials_api_keys_prefix_public_current: None,
            talos_credentials_api_keys_prefix_public_retired: None,
            talos_credentials_api_keys_prefix_retired: None,
            talos_credentials_derived_tokens_default_ttl: None,
            talos_credentials_derived_tokens_jwt_signing_key_id: None,
            talos_credentials_derived_tokens_jwt_signing_keys_urls: None,
            talos_credentials_derived_tokens_macaroon_prefix_current: None,
            talos_credentials_derived_tokens_macaroon_prefix_retired: None,
            talos_credentials_issuer: None,
            talos_credentials_issuer_retired: None,
            talos_credentials_issuer_retired_entries: None,
            talos_rate_limit_enabled: None,
            talos_secrets_hmac_current: None,
            talos_secrets_hmac_retired: None,
            talos_secrets_hmac_retired_entries: None,
            updated_at: None,
        }
    }
}
...
pub enum HydraOauth2DeviceAuthorizationUserCodeEntropyPresetEnum {
    #[serde(rename = "high")]
    High,
    #[serde(rename = "medium")]
    Medium,
...
impl Default for HydraOauth2DeviceAuthorizationUserCodeEntropyPresetEnum {
    fn default() -> HydraOauth2DeviceAuthorizationUserCodeEntropyPresetEnum {
        Self::High
    }
}
/// Defines access token type  This governs the \"strategies.access_token\" setting. opaque Oauth2AccessTokenStrategyOpaque jwt Oauth2AccessTokenStrategyJwt
