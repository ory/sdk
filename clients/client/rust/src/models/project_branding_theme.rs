...
pub struct ProjectBrandingTheme {
    ...
    #[serde(rename = "account_experience_variables", skip_serializing_if = "Option::is_none")]
    pub account_experience_variables: Option<Vec<models::AccountExperienceThemeVariables>>,
    /// AccountExperienceVariableStylesheet holds a reference to the current stylesheet that can be used in the AX
    #[serde(rename = "account_experience_variables_stylesheet", skip_serializing_if = "Option::is_none")]
    pub account_experience_variables_stylesheet: Option<String>,
...
impl ProjectBrandingTheme {
    pub fn new(created_at: String, id: String, name: String, project_branding_id: String, updated_at: String) -> ProjectBrandingTheme {
        ProjectBrandingTheme {
            ...
            account_experience_variables: None,
            account_experience_variables_stylesheet: None,
