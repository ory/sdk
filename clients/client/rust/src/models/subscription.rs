...
pub struct Subscription {
    ...
    #[serde(rename = "plan_changes_at", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub plan_changes_at: Option<Option<String>>,
    ...
    #[serde(rename = "status")]
    pub status: String,
    #[serde(rename = "stripe_checkout_expires_at", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub stripe_checkout_expires_at: Option<Option<String>>,
