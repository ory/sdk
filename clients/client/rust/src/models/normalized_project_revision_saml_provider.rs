...
pub struct NormalizedProjectRevisionSamlProvider {
    ...
    #[serde(rename = "idp_initiated_login_enabled", skip_serializing_if = "Option::is_none")]
    pub idp_initiated_login_enabled: Option<bool>,
...
impl NormalizedProjectRevisionSamlProvider {
    pub fn new() -> NormalizedProjectRevisionSamlProvider {
        NormalizedProjectRevisionSamlProvider {
            ...
            created_at: None,
            id: None,
            idp_initiated_login_enabled: None,
            label: None,
            mapper_url: None,
