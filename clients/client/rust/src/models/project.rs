...
impl Project {
    pub fn new(cors_admin: crate::models::Cors, cors_public: crate::models::Cors, id: String, name: String, revision_id: String, services: crate::models::ProjectServices, slug: String, state: StateEnum) -> Project {
        Project {
