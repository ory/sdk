...
pub struct UpdateSettingsFlowWithDeviceAuthnMethodDelete {
...
impl UpdateSettingsFlowWithDeviceAuthnMethodDelete {
    pub fn new(client_key_id: String) -> UpdateSettingsFlowWithDeviceAuthnMethodDelete {
