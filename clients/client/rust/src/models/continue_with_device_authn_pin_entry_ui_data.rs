...
pub struct ContinueWithDeviceAuthnPinEntryUiData {
...
impl ContinueWithDeviceAuthnPinEntryUiData {
    ...
    pub fn new(ciphertext: String, enc: String) -> ContinueWithDeviceAuthnPinEntryUiData {
