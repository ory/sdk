...
pub struct OAuth2ClientTokenLifespans {
    ...
    #[serde(rename = "device_authorization_grant_access_token_lifespan", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub device_authorization_grant_access_token_lifespan: Option<Option<String>>,
    #[serde(rename = "device_authorization_grant_id_token_lifespan", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub device_authorization_grant_id_token_lifespan: Option<Option<String>>,
    #[serde(rename = "device_authorization_grant_refresh_token_lifespan", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub device_authorization_grant_refresh_token_lifespan: Option<Option<String>>,
