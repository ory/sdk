...
pub struct CreateSubscriptionBody {
    ...
    #[serde(rename = "plan")]
    pub plan: String,
    #[serde(rename = "provision_first_project", skip_serializing_if = "Option::is_none")]
    pub provision_first_project: Option<String>,
...
impl CreateSubscriptionBody {
    ...
    pub fn new(interval: IntervalEnum, plan: String) -> CreateSubscriptionBody {
        CreateSubscriptionBody {
                currency: None,
                interval,
                plan,
                provision_first_project: None,
                return_to: None,
                workspace: None,
        }
    }
