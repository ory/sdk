...
pub struct PlanDetails {
    ...
    pub development_features: std::collections::HashMap<String, models::GenericUsage>,
    ...
    pub production_features: std::collections::HashMap<String, models::GenericUsage>,
    #[serde(rename = "staging_features")]
    pub staging_features: std::collections::HashMap<String, models::GenericUsage>,
