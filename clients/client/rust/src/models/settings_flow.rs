...
pub struct SettingsFlow {
    ...
    #[serde(rename = "state")]
    pub state: models::SettingsFlowState,
...
impl SettingsFlow {
    ...
    pub fn new(expires_at: String, id: String, identity: models::Identity, issued_at: String, request_url: String, state: models::SettingsFlowState, r#type: String, ui: models::UiContainer) -> SettingsFlow {
        SettingsFlow {
            active: None,
            continue_with: None,
            expires_at,
