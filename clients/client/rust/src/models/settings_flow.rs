...
impl SettingsFlow {
    ...
    pub fn new(expires_at: String, id: String, identity: crate::models::Identity, issued_at: String, request_url: String, state: Option<serde_json::Value>, _type: String, ui: crate::models::UiContainer) -> SettingsFlow {
        SettingsFlow {
                active: None,
                continue_with: None,
                expires_at,
