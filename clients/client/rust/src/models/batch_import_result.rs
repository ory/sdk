...
pub struct BatchImportResult {
    ...
    pub error_code: Option<models::BatchImportErrorCode>,
    #[serde(rename = "error_message", skip_serializing_if = "Option::is_none")]
    pub error_message: Option<String>,
    #[serde(rename = "imported_api_key", skip_serializing_if = "Option::is_none")]
    pub imported_api_key: Option<Box<models::ImportedApiKey>>,
