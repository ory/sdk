...
pub struct LoginFlow {
    ...
    #[serde(rename = "state")]
    pub state: models::LoginFlowState,
...
impl LoginFlow {
    ...
    pub fn new(expires_at: String, id: String, issued_at: String, request_url: String, state: models::LoginFlowState, r#type: String, ui: models::UiContainer) -> LoginFlow {
        LoginFlow {
            active: None,
            created_at: None,
            expires_at,
