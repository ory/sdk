...
pub struct GetOrganizationsByHostnameResponse {
    /// Organizations is the list of organizations for the project.
    #[serde(rename = "organizations")]
    pub organizations: Vec<models::OrganizationByHostname>,
}

impl GetOrganizationsByHostnameResponse {
    /// getOrganizationsByHostnameResponse is the list of B2B SSO organizations for the project resolved from the request host.
    pub fn new(organizations: Vec<models::OrganizationByHostname>) -> GetOrganizationsByHostnameResponse {
