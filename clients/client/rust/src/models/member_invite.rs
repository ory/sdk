...
impl MemberInvite {
    pub fn new(created_at: String, id: String, invitee_email: String, owner_email: String, owner_id: String, project_id: String, status: StatusEnum, updated_at: String) -> MemberInvite {
        MemberInvite {
                created_at,
                id,
                invitee_email,
