...
pub struct EventStream {
    ...
    #[serde(rename = "http_protocol_major_version", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub http_protocol_major_version: Option<Option<i64>>,
...
impl EventStream {
    ...
    pub fn new() -> EventStream {
        EventStream {
            created_at: None,
            http_protocol_major_version: None,
            https_endpoint: None,
            id: None,
            role_arn: None,
            status: None,
