...
pub struct SubmitSelfServiceRecoveryFlowWithCodeMethodBody {
...
impl SubmitSelfServiceRecoveryFlowWithCodeMethodBody {
    pub fn new(method: String) -> SubmitSelfServiceRecoveryFlowWithCodeMethodBody {
