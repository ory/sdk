...
pub enum RecoveryFlowState {
    ...
    PassedChallenge,
    #[serde(rename = "recovery_awaiting_address")]
    RecoveryAwaitingAddress,
    #[serde(rename = "recovery_awaiting_address_choice")]
    RecoveryAwaitingAddressChoice,
    #[serde(rename = "recovery_confirming_address")]
    RecoveryConfirmingAddress,
    #[serde(rename = "recovery_awaiting_code")]
...
impl std::fmt::Display for RecoveryFlowState {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::RecoveryAwaitingAddress => write!(f, "recovery_awaiting_address"),
            Self::RecoveryAwaitingAddressChoice => write!(f, "recovery_awaiting_address_choice"),
            Self::RecoveryConfirmingAddress => write!(f, "recovery_confirming_address"),
            Self::RecoveryAwaitingCode => write!(f, "recovery_awaiting_code"),
        }
    }
}
