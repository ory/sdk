...
pub struct BatchCreateImportedApiKeysRequest {
    #[serde(rename = "requests", skip_serializing_if = "Option::is_none")]
    pub requests: Option<Vec<models::ImportApiKeyRequest>>,
}

impl BatchCreateImportedApiKeysRequest {
    /// BatchCreateImportedApiKeysRequest imports multiple external API keys in one request. The maximum batch size is 1000 keys.
    pub fn new() -> BatchCreateImportedApiKeysRequest {
