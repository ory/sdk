...
pub struct DeviceAuthnAttestation {
    #[serde(rename = "android", skip_serializing_if = "Option::is_none")]
    pub android: Option<Box<models::DeviceAuthnAndroidKeyDescription>>,
    #[serde(rename = "ios", skip_serializing_if = "Option::is_none")]
    pub ios: Option<Box<models::DeviceAuthnIosAttestation>>,
}

impl DeviceAuthnAttestation {
    /// Exactly one of Android / IOS is set, matching the key's DeviceType.
    pub fn new() -> DeviceAuthnAttestation {
