...
pub struct PatchWorkspaceContactBody {
    ...
    pub recipient: Option<Box<models::WorkspaceContactRecipientInput>>,
...
impl PatchWorkspaceContactBody {
    pub fn new() -> PatchWorkspaceContactBody {
