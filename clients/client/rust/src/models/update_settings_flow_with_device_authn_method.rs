...
pub struct UpdateSettingsFlowWithDeviceAuthnMethod {
    ...
    #[serde(rename = "deviceauthn_register", skip_serializing_if = "Option::is_none")]
    pub deviceauthn_register: Option<Box<models::UpdateSettingsFlowWithDeviceAuthnMethodRegister>>,
    ...
    #[serde(rename = "deviceauthn_remove", skip_serializing_if = "Option::is_none")]
    pub deviceauthn_remove: Option<String>,
    ...
    #[serde(rename = "rotate_secret", skip_serializing_if = "Option::is_none")]
    pub rotate_secret: Option<Box<models::UpdateSettingsFlowWithDeviceAuthnMethodRotateSecret>>,
    /// Transient data to pass along to any webhooks
    #[serde(rename = "transient_payload", skip_serializing_if = "Option::is_none")]
    pub transient_payload: Option<serde_json::Value>,
}

impl UpdateSettingsFlowWithDeviceAuthnMethod {
    ...
    pub fn new(method: String) -> UpdateSettingsFlowWithDeviceAuthnMethod {
        UpdateSettingsFlowWithDeviceAuthnMethod {
            csrf_token: None,
            deviceauthn_register: None,
            deviceauthn_remove: None,
            method,
            rotate_secret: None,
