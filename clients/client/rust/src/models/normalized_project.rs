...
impl NormalizedProject {
    pub fn new(created_at: String, current_revision: crate::models::NormalizedProjectRevision, hosts: Vec<String>, id: String, revisions: Vec<crate::models::NormalizedProjectRevision>, slug: String, state: StateEnum, updated_at: String) -> NormalizedProject {
        NormalizedProject {
                created_at,
