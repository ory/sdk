...
impl NormalizedProject {
    pub fn new(created_at: String, current_revision: crate::models::NormalizedProjectRevision, environment: EnvironmentEnum, hosts: Vec<String>, id: String, slug: String, state: StateEnum, updated_at: String) -> NormalizedProject {
        NormalizedProject {
                created_at,
