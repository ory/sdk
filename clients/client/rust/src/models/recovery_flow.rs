...
pub struct RecoveryFlow {
    ...
    #[serde(rename = "state")]
    pub state: models::RecoveryFlowState,
...
impl RecoveryFlow {
    ...
    pub fn new(expires_at: String, id: String, issued_at: String, request_url: String, state: models::RecoveryFlowState, r#type: String, ui: models::UiContainer) -> RecoveryFlow {
        RecoveryFlow {
            active: None,
            continue_with: None,
            expires_at,
