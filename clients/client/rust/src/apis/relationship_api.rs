...
pub async fn create_relationship(configuration: &configuration::Configuration, create_relationship_body: Option<models::CreateRelationshipBody>) -> Result<models::Relationship, Error<CreateRelationshipError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_create_relationship_body = create_relationship_body;
    ...
    req_builder = req_builder.json(&p_body_create_relationship_body);
...
pub async fn delete_relationships(configuration: &configuration::Configuration, namespace: Option<&str>, object: Option<&str>, relation: Option<&str>, subject_id: Option<&str>, subject_set_namespace: Option<&str>, subject_set_object: Option<&str>, subject_set_relation: Option<&str>) -> Result<(), Error<DeleteRelationshipsError>> {
    ...
    let p_query_object = object;
    let p_query_relation = relation;
    let p_query_subject_id = subject_id;
    let p_query_subject_set_namespace = subject_set_namespace;
    let p_query_subject_set_object = subject_set_object;
    let p_query_subject_set_relation = subject_set_relation;
...
pub async fn get_relationships(configuration: &configuration::Configuration, page_size: Option<i64>, page_token: Option<&str>, namespace: Option<&str>, object: Option<&str>, relation: Option<&str>, subject_id: Option<&str>, subject_set_namespace: Option<&str>, subject_set_object: Option<&str>, subject_set_relation: Option<&str>) -> Result<models::Relationships, Error<GetRelationshipsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn patch_relationships(configuration: &configuration::Configuration, relationship_patch: Option<Vec<models::RelationshipPatch>>) -> Result<(), Error<PatchRelationshipsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_relationship_patch = relationship_patch;
    ...
    req_builder = req_builder.json(&p_body_relationship_patch);
