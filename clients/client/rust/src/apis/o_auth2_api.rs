...
pub async fn rotate_o_auth2_client_secret(configuration: &configuration::Configuration, id: &str) -> Result<models::OAuth2Client, Error<RotateOAuth2ClientSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
