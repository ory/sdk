...
pub async fn list_o_auth2_consent_sessions(configuration: &configuration::Configuration, subject: &str, page_size: Option<i64>, page_token: Option<&str>) -> Result<Vec<crate::models::OAuth2ConsentSession>, Error<ListOAuth2ConsentSessionsError>> {
