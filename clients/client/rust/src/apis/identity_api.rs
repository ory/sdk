...
pub async fn list_identities(configuration: &configuration::Configuration, per_page: Option<i64>, page: Option<i64>, page_size: Option<i64>, page_token: Option<&str>, credentials_identifier: Option<&str>) -> Result<Vec<crate::models::Identity>, Error<ListIdentitiesError>> {
