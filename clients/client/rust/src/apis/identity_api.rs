...
pub async fn batch_patch_identities(configuration: &configuration::Configuration, patch_identities_body: Option<&crate::models::PatchIdentitiesBody>) -> Result<crate::models::BatchPatchIdentitiesResponse, Error<BatchPatchIdentitiesError>> {
...
pub async fn create_recovery_link_for_identity(configuration: &configuration::Configuration, return_to: Option<&str>, create_recovery_link_for_identity_body: Option<&crate::models::CreateRecoveryLinkForIdentityBody>) -> Result<crate::models::RecoveryLinkForIdentity, Error<CreateRecoveryLinkForIdentityError>> {
...
pub async fn delete_identity_credentials(configuration: &configuration::Configuration, id: &str, _type: &str) -> Result<(), Error<DeleteIdentityCredentialsError>> {
...
pub async fn list_identities(configuration: &configuration::Configuration, per_page: Option<i64>, page: Option<i64>, page_size: Option<i64>, page_token: Option<&str>, consistency: Option<&str>, ids: Option<Vec<String>>, credentials_identifier: Option<&str>, preview_credentials_identifier_similar: Option<&str>, include_credential: Option<Vec<String>>) -> Result<Vec<crate::models::Identity>, Error<ListIdentitiesError>> {
    ...
    if let Some(ref local_var_str) = ids {
        local_var_req_builder = local_var_req_builder.query(&[("ids", local_var_str.iter().map(|p| p.to_string()).collect::<Vec<String>>().join(","))]);
    }
...
pub async fn list_identity_schemas(configuration: &configuration::Configuration, per_page: Option<i64>, page: Option<i64>, page_size: Option<i64>, page_token: Option<&str>) -> Result<Vec<crate::models::IdentitySchemaContainer>, Error<ListIdentitySchemasError>> {
...
pub async fn list_identity_sessions(configuration: &configuration::Configuration, id: &str, per_page: Option<i64>, page: Option<i64>, page_size: Option<i64>, page_token: Option<&str>, active: Option<bool>) -> Result<Vec<crate::models::Session>, Error<ListIdentitySessionsError>> {
