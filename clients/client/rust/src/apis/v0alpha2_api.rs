...
pub async fn submit_self_service_login_flow(configuration: &configuration::Configuration, flow: &str, x_session_token: Option<&str>, cookie: Option<&str>, submit_self_service_login_flow_body: Option<crate::models::SubmitSelfServiceLoginFlowBody>) -> Result<crate::models::SuccessfulSelfServiceLoginWithoutBrowser, Error<SubmitSelfServiceLoginFlowError>> {
...
pub async fn submit_self_service_recovery_flow(configuration: &configuration::Configuration, flow: &str, token: Option<&str>, cookie: Option<&str>, submit_self_service_recovery_flow_body: Option<crate::models::SubmitSelfServiceRecoveryFlowBody>) -> Result<crate::models::SelfServiceRecoveryFlow, Error<SubmitSelfServiceRecoveryFlowError>> {
...
pub async fn submit_self_service_settings_flow(configuration: &configuration::Configuration, flow: &str, x_session_token: Option<&str>, cookie: Option<&str>, submit_self_service_settings_flow_body: Option<crate::models::SubmitSelfServiceSettingsFlowBody>) -> Result<crate::models::SelfServiceSettingsFlow, Error<SubmitSelfServiceSettingsFlowError>> {
...
pub async fn submit_self_service_verification_flow(configuration: &configuration::Configuration, flow: &str, token: Option<&str>, cookie: Option<&str>, submit_self_service_verification_flow_body: Option<crate::models::SubmitSelfServiceVerificationFlowBody>) -> Result<crate::models::SelfServiceVerificationFlow, Error<SubmitSelfServiceVerificationFlowError>> {
