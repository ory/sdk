...
pub async fn create_organization(configuration: &configuration::Configuration, project_id: &str, organization_body: Option<&crate::models::OrganizationBody>) -> Result<crate::models::Organization, Error<CreateOrganizationError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project_id}/organizations", configuration.base_path, project_id=crate::apis::urlencode(project_id));
...
pub async fn delete_organization(configuration: &configuration::Configuration, project_id: &str, organization_id: &str) -> Result<(), Error<DeleteOrganizationError>> {
    ...
    let local_var_uri_str = format!("{}/projects/{project_id}/organizations/{organization_id}", configuration.base_path, project_id=crate::apis::urlencode(project_id), organization_id=crate::apis::urlencode(organization_id));
...
pub async fn get_organization(configuration: &configuration::Configuration, project_id: &str, organization_id: &str) -> Result<crate::models::GetOrganizationResponse, Error<GetOrganizationError>> {
...
pub async fn get_project_members(configuration: &configuration::Configuration, project: &str) -> Result<Vec<crate::models::ProjectMember>, Error<GetProjectMembersError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/projects/{project}/members", configuration.base_path, project=crate::apis::urlencode(project));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_organizations(configuration: &configuration::Configuration, project_id: &str) -> Result<crate::models::ListOrganizationsResponse, Error<ListOrganizationsError>> {
...
pub async fn remove_project_member(configuration: &configuration::Configuration, project: &str, member: &str) -> Result<(), Error<RemoveProjectMemberError>> {
    ...
    let local_var_uri_str = format!("{}/projects/{project}/members/{member}", configuration.base_path, project=crate::apis::urlencode(project), member=crate::apis::urlencode(member));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn update_organization(configuration: &configuration::Configuration, project_id: &str, organization_id: &str, organization_body: Option<&crate::models::OrganizationBody>) -> Result<crate::models::Organization, Error<UpdateOrganizationError>> {
