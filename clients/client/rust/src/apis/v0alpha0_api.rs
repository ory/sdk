...
pub async fn update_project_config(configuration: &configuration::Configuration, project_id: &str, update_project_config_config: Option<crate::models::UpdateProjectConfigConfig>) -> Result<crate::models::SuccessfulUpdateProjectConfig, Error<UpdateProjectConfigError>> {
