...
> models::BatchImportApiKeysResponse admin_batch_import_api_keys(batch_import_api_keys_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**batch_import_api_keys_request** | [**BatchImportApiKeysRequest**](BatchImportApiKeysRequest.md) | BatchImportAPIKeysRequest imports multiple external API keys in one request. The maximum batch size is 1000 keys. | [required] |

### Return type

[**models::BatchImportApiKeysResponse**](BatchImportAPIKeysResponse.md)
...
> serde_json::Value admin_revoke_api_key(key_id, admin_revoke_api_key_body)
Revoke API Key
...
------------- | ------------- | ------------- | ------------- | -------------
**key_id** | **String** | Identifier of the API key resource. | [required] |
**admin_revoke_api_key_body** | [**AdminRevokeApiKeyBody**](AdminRevokeApiKeyBody.md) |  | [required] |
