...
> crate::models::ErrorContainer get_self_service_error_admin(error)
Get User-Facing Self-Service Errors
...
> crate::models::SettingsFlow get_self_service_settings_flow_admin(id)
Get Settings Flow
...
> crate::models::RegistrationFlow initialize_self_service_registration()
