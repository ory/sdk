...
------------ | ------------- | ------------- | -------------
**challenge** | Option<**String**> | Challenge is used to retrieve/accept/deny the logout request. | [optional]
...
**subject** | Option<**String**> | Subject is the user for whom the logout was requested. | [optional]
