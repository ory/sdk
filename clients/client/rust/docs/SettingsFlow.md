...
**continue_with** | Option<[**Vec<models::ContinueWith>**](continueWith.md)> | Contains a list of actions, that could follow this flow  It can, for example, contain a reference to the verification flow, created as part of the user's registration. | [optional]
...
**state** | [**models::SettingsFlowState**](settingsFlowState.md) |  | 
