...
**hydra_strategies_access_token** | Option<**String**> | Defines access token type. jwt is a bad idea, see https://www.ory.sh/docs/hydra/advanced#json-web-tokens  This governs the \"strategies.access_token\" setting. | [optional][default to HydraStrategiesAccessTokenEnum_Opaque]
**hydra_strategies_scope** | Option<**String**> | Defines how scopes are matched. For more details have a look at https://github.com/ory/fosite#scopes  This governs the \"strategies.scope\" setting. | [optional][default to HydraStrategiesScopeEnum_Wildcard]
...
**kratos_selfservice_methods_code_enabled** | Option<**bool**> |  | [optional]
