...
**details** | Option<[**Vec<::std::collections::HashMap<String, serde_json::Value>>**](map.md)> | Further error details | [optional]
**error** | Option<[**crate::models::GenericErrorContent**](genericErrorContent.md)> |  | [optional]
