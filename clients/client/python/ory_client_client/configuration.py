...
conf = ory_client_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ory_client_client")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: v0.0.1-alpha.1\n"\
               "SDK Package Version: v0.0.1-alpha.1".\
