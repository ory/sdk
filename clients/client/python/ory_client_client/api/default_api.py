...
from ory_client_client.api_client import ApiClient, Endpoint as _Endpoint
...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __initialize_self_service_registration(
            self,
            **kwargs
        ):
            ...
            >>> thread = api.initialize_self_service_registration(async_req=True)
            >>> result = thread.get()
        ...
        self.initialize_self_service_registration = _Endpoint(
            settings={
                'response_type': (RegistrationFlow,),
                'auth': [],
                'endpoint_path': '/api/kratos/public/self-service/registration/api',
                'operation_id': 'initialize_self_service_registration',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__initialize_self_service_registration
        )
