...
class TestProjectServiceIdentity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectServiceIdentity:
        """Test ProjectServiceIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectServiceIdentity`
        """
        model = ProjectServiceIdentity()
        if include_optional:
