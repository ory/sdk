...
class TestV0alpha2Api(unittest.TestCase):
    ...
    def test_admin_create_self_service_recovery_code(self):
        """Test case for admin_create_self_service_recovery_code
    ...
    def test_admin_list_courier_messages(self):
        """Test case for admin_list_courier_messages
