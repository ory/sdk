        ...
        if include_optional:
            return CreateProjectNormalizedPayload(
                ...
                account_experience_custom_translations = [
                    ory_client.models.revision_account_experience_custom_translation.RevisionAccountExperienceCustomTranslation(
                        locale = '', 
                        translations = '', )
                    ],
                ...
                account_experience_hide_ory_branding = True,
                account_experience_hide_registration_link = True,
                ...
                hydra_oauth2_device_authorization_user_code_entropy_preset = 'high',
                ...
                hydra_oauth2_grant_jwt_omit_assertion_audience = True,
                hydra_oauth2_grant_refresh_token_rotation_grace_period = '',
                hydra_oauth2_grant_refresh_token_rotation_grace_reuse_count = 56,
                ...
                hydra_oauth2_preserve_ext_claims = True,
                ...
                id = '',
                keto_feature_flags_strict_mode = True,
                ...
                kratos_feature_flags_choose_recovery_address = True,
                kratos_feature_flags_enforce_identity_schema_guards = True,
                kratos_feature_flags_faster_session_extend = True,
                kratos_feature_flags_legacy_continue_with_verification_ui = True,
                kratos_feature_flags_legacy_oidc_registration_node_group = True,
                kratos_feature_flags_legacy_require_verified_login_error = True,
                kratos_feature_flags_password_profile_registration_node_group = True,
                kratos_feature_flags_refresh_login_choose_address = True,
                kratos_feature_flags_use_continue_with_transitions = True,
                kratos_feature_flags_webhook_response_directives = True,
                ...
                kratos_security_account_enumeration_mitigate = True,
                ...
                kratos_selfservice_methods_captcha_config_byo = True,
                ...
                kratos_selfservice_methods_captcha_config_legacy_inject_node = True,
                kratos_selfservice_methods_captcha_enabled = True,
                kratos_selfservice_methods_code_config_lifespan = '',
                kratos_selfservice_methods_code_config_max_submissions = 56,
                ...
                kratos_selfservice_methods_deviceauthn_config_android_allow_expired_factory_certificates = True,
                kratos_selfservice_methods_deviceauthn_config_android_app_ids = [
                    ''
                    ],
                kratos_selfservice_methods_deviceauthn_config_first_factor = True,
                kratos_selfservice_methods_deviceauthn_config_insecure_allow_relaxed_attestation = True,
                kratos_selfservice_methods_deviceauthn_config_ios_app_ids = [
                    ''
                    ],
                kratos_selfservice_methods_deviceauthn_config_ios_biometric_first_factor = True,
                kratos_selfservice_methods_deviceauthn_config_pin_max_attempts = 56,
                kratos_selfservice_methods_deviceauthn_enabled = True,
                ...
                talos_credentials_issuer_retired_entries = [
                    ory_client.models.talos_retired_value.talosRetiredValue(
                        expires_at = '2026-08-01T00:00Z', 
                        value = '', )
                    ],
                talos_rate_limit_enabled = True,
