...
class TestProjectServices(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectServices:
        ...
        if include_optional:
            return ProjectServices(
                account_experience = ory_client.models.project_service_account_experience.projectServiceAccountExperience(
                ...
                permission = ory_client.models.project_service_permission.projectServicePermission(
                    config = ory_client.models.config.config(), ),
                talos = ory_client.models.project_service_talos.projectServiceTalos(
                    config = ory_client.models.config.config(), )
            )
        else:
            return ProjectServices(
