...
class TestDeviceUserAuthRequest(unittest.TestCase):
    """DeviceUserAuthRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceUserAuthRequest:
        """Test DeviceUserAuthRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceUserAuthRequest`
        """
        model = DeviceUserAuthRequest()
        if include_optional:
    ...
    def testDeviceUserAuthRequest(self):
        """Test DeviceUserAuthRequest"""
