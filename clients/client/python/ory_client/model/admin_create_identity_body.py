...
class AdminCreateIdentityBody(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'credentials': (AdminIdentityImportCredentials,),  # noqa: E501
            ...
            'recovery_addresses': ([RecoveryIdentityAddress],),  # noqa: E501
            'state': (IdentityState,),  # noqa: E501
            'verifiable_addresses': ([VerifiableIdentityAddress],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'metadata_admin': 'metadata_admin',  # noqa: E501
        'metadata_public': 'metadata_public',  # noqa: E501
        'recovery_addresses': 'recovery_addresses',  # noqa: E501
        'state': 'state',  # noqa: E501
        'verifiable_addresses': 'verifiable_addresses',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, schema_id, traits, *args, **kwargs):  # noqa: E501
        """AdminCreateIdentityBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            credentials (AdminIdentityImportCredentials): [optional]  # noqa: E501
            metadata_admin (bool, date, datetime, dict, float, int, list, str, none_type): Store metadata about the user which is only accessible through admin APIs such as `GET /admin/identities/<id>`.. [optional]  # noqa: E501
            metadata_public (bool, date, datetime, dict, float, int, list, str, none_type): Store metadata about the identity which the identity itself can see when calling for example the session endpoint. Do not store sensitive information (e.g. credit score) about the identity in this field.. [optional]  # noqa: E501
            recovery_addresses ([RecoveryIdentityAddress]): RecoveryAddresses contains all the addresses that can be used to recover an identity.  Use this structure to import recovery addresses for an identity. Please keep in mind that the address needs to be represented in the Identity Schema or this field will be overwritten on the next identity update.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, schema_id, traits, *args, **kwargs):  # noqa: E501
        """AdminCreateIdentityBody - a model defined in OpenAPI
