...
class GetAttributesCountResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([AttributesCountDatapoint],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """GetAttributesCountResponse - a model defined in OpenAPI

        Args:
            data ([AttributesCountDatapoint]): The list of data points.
