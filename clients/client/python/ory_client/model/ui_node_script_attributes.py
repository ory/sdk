...
class UiNodeScriptAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, _async, crossorigin, id, integrity, node_type, referrerpolicy, src, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, _async, crossorigin, id, integrity, node_type, referrerpolicy, src, type, *args, **kwargs):  # noqa: E501
        """UiNodeScriptAttributes - a model defined in OpenAPI
