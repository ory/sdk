...
class Project(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'hosts': (StringSliceJSONFormat,),  # noqa: E501
            'id': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, current_revision, hosts, id, revisions, slug, state, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, current_revision, hosts, id, revisions, *args, **kwargs):  # noqa: E501
        """Project - a model defined in OpenAPI
