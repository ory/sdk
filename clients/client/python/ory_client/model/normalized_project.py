...
class NormalizedProject(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, current_revision, environment, hosts, id, slug, state, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, current_revision, environment, hosts, *args, **kwargs):  # noqa: E501
        """NormalizedProject - a model defined in OpenAPI
