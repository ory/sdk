...
class MetricsDatapoint(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, count, time, *args, **kwargs):  # noqa: E501
        """MetricsDatapoint - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, count, time, *args, **kwargs):  # noqa: E501
        """MetricsDatapoint - a model defined in OpenAPI
