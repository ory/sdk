...
class IdentitySchemaPresets(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IdentitySchemaPresets - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([IdentitySchemaPreset]):  # noqa: E501

        Keyword Args:
            value ([IdentitySchemaPreset]):  # noqa: E501
