...
class ListCustomDomains(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ListCustomDomains - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([CustomDomain]): Custom Hostname List.  # noqa: E501

        Keyword Args:
            value ([CustomDomain]): Custom Hostname List.  # noqa: E501
