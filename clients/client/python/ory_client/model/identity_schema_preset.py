...
class IdentitySchemaPreset(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, schema, url, *args, **kwargs):  # noqa: E501
        """IdentitySchemaPreset - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, schema, url, *args, **kwargs):  # noqa: E501
        """IdentitySchemaPreset - a model defined in OpenAPI
