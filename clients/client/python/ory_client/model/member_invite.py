...
class MemberInvite(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, id, invitee_email, owner_email, owner_id, status, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, invitee_email, owner_email, owner_id, status, *args, **kwargs):  # noqa: E501
        """MemberInvite - a model defined in OpenAPI
