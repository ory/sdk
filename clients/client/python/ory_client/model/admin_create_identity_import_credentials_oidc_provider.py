...
class AdminCreateIdentityImportCredentialsOidcProvider(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, provider, subject, *args, **kwargs):  # noqa: E501
        """AdminCreateIdentityImportCredentialsOidcProvider - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, provider, subject, *args, **kwargs):  # noqa: E501
        """AdminCreateIdentityImportCredentialsOidcProvider - a model defined in OpenAPI
