...
class TrustedJwtGrantIssuers(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TrustedJwtGrantIssuers - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([TrustedJwtGrantIssuer]):  # noqa: E501

        Keyword Args:
            value ([TrustedJwtGrantIssuer]):  # noqa: E501
