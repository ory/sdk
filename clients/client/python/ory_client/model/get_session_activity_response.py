...
class GetSessionActivityResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([SessionActivityDatapoint],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """GetSessionActivityResponse - a model defined in OpenAPI

        Args:
            data ([SessionActivityDatapoint]): The list of data points.
