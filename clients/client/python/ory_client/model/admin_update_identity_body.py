...
class AdminUpdateIdentityBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, schema_id, state, traits, *args, **kwargs):  # noqa: E501
        """AdminUpdateIdentityBody - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, schema_id, state, traits, *args, **kwargs):  # noqa: E501
        """AdminUpdateIdentityBody - a model defined in OpenAPI
