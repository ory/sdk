...
class AdminUpdateIdentityBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, state, traits, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            schema_id (str): SchemaID is the ID of the JSON Schema to be used for validating the identity's traits. If set will update the Identity's SchemaID.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, state, traits, *args, **kwargs):  # noqa: E501
        """AdminUpdateIdentityBody - a model defined in OpenAPI
