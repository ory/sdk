...
class ManagedIdentitySchemas(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ManagedIdentitySchemas - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ManagedIdentitySchema]):  # noqa: E501

        Keyword Args:
            value ([ManagedIdentitySchema]):  # noqa: E501
