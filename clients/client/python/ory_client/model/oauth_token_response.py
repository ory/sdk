...
class OauthTokenResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            expires_in (int): The lifetime in seconds of the access token.  For example, the value \"3600\" denotes that the access token will expire in one hour from the time the response was generated.. [optional]  # noqa: E501
            id_token (int): To retrieve a refresh token request the id_token scope.. [optional]  # noqa: E501
            refresh_token (str): The refresh token, which can be used to obtain new access tokens. To retrieve it add the scope \"offline\" to your access token request.. [optional]  # noqa: E501
            scope (int): The scope of the access token. [optional]  # noqa: E501
