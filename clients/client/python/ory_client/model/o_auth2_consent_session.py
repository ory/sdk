...
class OAuth2ConsentSession(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'consent_request': (OAuth2ConsentRequest,),  # noqa: E501
            'expires_at': (OAuth2ConsentSessionExpiresAt,),  # noqa: E501
    ...
    attribute_map = {
        'consent_request': 'consent_request',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OAuth2ConsentSession - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            consent_request (OAuth2ConsentRequest): [optional]  # noqa: E501
            expires_at (OAuth2ConsentSessionExpiresAt): [optional]  # noqa: E501
            ...
            remember (bool): Remember Consent  Remember, if set to true, tells ORY Hydra to remember this consent authorization and reuse it if the same client asks the same user for the same, or a subset of, scope.. [optional]  # noqa: E501
            remember_for (int): Remember Consent For  RememberFor sets how long the consent authorization should be remembered for in seconds. If set to `0`, the authorization will be remembered indefinitely.. [optional]  # noqa: E501
