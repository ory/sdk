...
class IdentityCredentials(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IdentityCredentials - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Type discriminates between different types of credentials. password CredentialsTypePassword oidc CredentialsTypeOIDC totp CredentialsTypeTOTP lookup_secret CredentialsTypeLookup webauthn CredentialsTypeWebAuthn code CredentialsTypeCodeAuth link_recovery CredentialsTypeRecoveryLink  CredentialsTypeRecoveryLink is a special credential type linked to the link strategy (recovery flow).  It is not used within the credentials object itself. code_recovery CredentialsTypeRecoveryCode. [optional]  # noqa: E501
            updated_at (datetime): UpdatedAt is a helper struct field for gobuffalo.pop.. [optional]  # noqa: E501
            version (int): Version refers to the version of the credential. Useful when changing the config schema.. [optional]  # noqa: E501
        """
