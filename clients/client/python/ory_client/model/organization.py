...
class Organization(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'domains': (StringSliceJSONFormat,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'label': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, domains, id, label, project_id, updated_at, *args, **kwargs):  # noqa: E501
        """Organization - a model defined in OpenAPI

        Args:
            created_at (datetime): The organization's creation date.
            ...
            updated_at (datetime): The last time the organization was updated.
    ...
    @convert_js_args_to_python_args
    def __init__(self, domains, id, label, project_id, *args, **kwargs):  # noqa: E501
        """Organization - a model defined in OpenAPI
