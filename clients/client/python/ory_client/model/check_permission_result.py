...
class CheckPermissionResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, allowed, *args, **kwargs):  # noqa: E501
        """CheckPermissionResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, allowed, *args, **kwargs):  # noqa: E501
        """CheckPermissionResult - a model defined in OpenAPI
