...
class ListOrganizationsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'organizations': ([Organization],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, organizations, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, organizations, *args, **kwargs):  # noqa: E501
        """ListOrganizationsResponse - a model defined in OpenAPI
