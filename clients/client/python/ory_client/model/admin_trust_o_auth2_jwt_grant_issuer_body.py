...
class AdminTrustOAuth2JwtGrantIssuerBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, expires_at, issuer, jwk, scope, *args, **kwargs):  # noqa: E501
        """AdminTrustOAuth2JwtGrantIssuerBody - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, expires_at, issuer, jwk, scope, *args, **kwargs):  # noqa: E501
        """AdminTrustOAuth2JwtGrantIssuerBody - a model defined in OpenAPI
