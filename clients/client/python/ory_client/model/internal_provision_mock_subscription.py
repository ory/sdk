...
class InternalProvisionMockSubscription(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency, identity_id, interval, plan, *args, **kwargs):  # noqa: E501
        """InternalProvisionMockSubscription - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency, identity_id, interval, plan, *args, **kwargs):  # noqa: E501
        """InternalProvisionMockSubscription - a model defined in OpenAPI
