...
class SettingsFlow(ModelNormal):
    ...
    def _from_openapi_data(cls, expires_at, id, identity, issued_at, request_url, state, type, ui, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            transient_payload ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): TransientPayload is used to pass data from the settings flow to hooks and email templates. [optional]  # noqa: E501
        """
