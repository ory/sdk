...
class ContinueWithSetOrySessionToken(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action, ory_session_token, *args, **kwargs):  # noqa: E501
        """ContinueWithSetOrySessionToken - a model defined in OpenAPI
        ...
        self.action = action
        self.ory_session_token = ory_session_token
    ...
    @convert_js_args_to_python_args
    def __init__(self, action, ory_session_token, *args, **kwargs):  # noqa: E501
        """ContinueWithSetOrySessionToken - a model defined in OpenAPI
