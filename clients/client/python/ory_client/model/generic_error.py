...
class GenericError(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'code': (int,),  # noqa: E501
            'debug': (str,),  # noqa: E501
            'details': (bool, date, datetime, dict, float, int, list, str,),  # noqa: E501
    ...
    def __init__(self, message, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            details (bool, date, datetime, dict, float, int, list, str): Further error details. [optional]  # noqa: E501
