...
class GetProjectMetricsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([MetricsDatapoint],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """GetProjectMetricsResponse - a model defined in OpenAPI

        Args:
            data ([MetricsDatapoint]): The list of data points.
