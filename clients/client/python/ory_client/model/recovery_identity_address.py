...
class RecoveryIdentityAddress(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, value, via, *args, **kwargs):  # noqa: E501
        """RecoveryIdentityAddress - a model defined in OpenAPI
