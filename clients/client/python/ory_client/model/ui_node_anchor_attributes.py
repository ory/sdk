...
class UiNodeAnchorAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, href, id, node_type, title, *args, **kwargs):  # noqa: E501
        """UiNodeAnchorAttributes - a model defined in OpenAPI

        Args:
            href (str): The link's href (destination) URL.  format: uri
            id (str): A unique identifier
            node_type (str): NodeType represents this node's types. It is a mirror of `node.type` and is primarily used to allow compatibility with OpenAPI 3.0.  In this struct it technically always is \"a\".
            title (UiText):
    ...
    @convert_js_args_to_python_args
    def __init__(self, href, id, node_type, title, *args, **kwargs):  # noqa: E501
        """UiNodeAnchorAttributes - a model defined in OpenAPI
