...
class GetSessionActivityResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[SessionActivityDatapoint] = Field(description="The list of data points.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SessionActivityDatapoint.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
