...
class ListWorkspaceContacts(BaseModel):
    """
    ListWorkspaceContacts
    """ # noqa: E501
    contacts: List[WorkspaceContact]
    has_next_page: StrictBool
    next_page_token: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["contacts", "has_next_page", "next_page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contacts": [WorkspaceContact.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None,
