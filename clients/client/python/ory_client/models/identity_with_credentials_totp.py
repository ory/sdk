...
class IdentityWithCredentialsTotp(BaseModel):
    """
    Create Identity and Import TOTP 2FA Credentials
    """ # noqa: E501
    config: Optional[IdentityWithCredentialsTotpConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": IdentityWithCredentialsTotpConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
