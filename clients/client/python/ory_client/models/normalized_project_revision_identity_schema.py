...
class NormalizedProjectRevisionIdentitySchema(BaseModel):
    ...
    id: Optional[UUID] = Field(default=None, description="The unique ID of this entry.")
    ...
    selfservice_selectable: Optional[StrictBool] = None
    updated_at: Optional[datetime] = Field(default=None, description="Last Time Project's Revision was Updated")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["created_at", "id", "identity_schema", "identity_schema_id", "import_id", "import_url", "is_default", "preset", "project_revision_id", "selfservice_selectable", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selfservice_selectable": obj.get("selfservice_selectable"),
