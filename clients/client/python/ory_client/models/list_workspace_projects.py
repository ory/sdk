...
class ListWorkspaceProjects(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["has_next_page", "next_page", "projects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "projects": [ProjectMetadata.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None
        })
