...
class NormalizedProject(BaseModel):
    ...
    home_region: StrictStr = Field(description="The project's data home region. eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest eu EU asia Asia us US global Global")
    hosts: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="The FQDN hostnames this project listens on")
