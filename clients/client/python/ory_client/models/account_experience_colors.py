...
class AccountExperienceColors(BaseModel):
    ...
    """ # noqa: E501
    ax_background_default: Optional[StrictStr] = Field(default=None, alias="ax-background-default")
    ...
    __properties: ClassVar[List[str]] = ["ax-background-default", "brand-100", "brand-200", "brand-300", "brand-400", "brand-50", "brand-500", "brand-600", "brand-700", "brand-800", "brand-900", "brand-950", "button-identifier-background-default", "button-identifier-background-hover", "button-identifier-border-border-default", "button-identifier-border-border-hover", "button-identifier-foreground-default", "button-identifier-foreground-hover", "button-link-brand-brand", "button-link-brand-brand-hover", "button-link-default-primary", "button-link-default-primary-hover", "button-link-default-secondary", "button-link-default-secondary-hover", "button-link-disabled-disabled", "button-primary-background-default", "button-primary-background-disabled", "button-primary-background-hover", "button-primary-border-default", "button-primary-border-disabled", "button-primary-border-hover", "button-primary-foreground-default", "button-primary-foreground-disabled", "button-primary-foreground-hover", "button-secondary-background-default", "button-secondary-background-disabled", "button-secondary-background-hover", "button-secondary-border-default", "button-secondary-border-disabled", "button-secondary-border-hover", "button-secondary-foreground-default", "button-secondary-foreground-disabled", "button-secondary-foreground-hover", "button-social-background-default", "button-social-background-disabled", "button-social-background-generic-provider", "button-social-background-hover", "button-social-border-default", "button-social-border-disabled", "button-social-border-generic-provider", "button-social-border-hover", "button-social-foreground-default", "button-social-foreground-disabled", "button-social-foreground-generic-provider", "button-social-foreground-hover", "checkbox-background-checked", "checkbox-background-default", "checkbox-border-checkbox-border-checked", "checkbox-border-checkbox-border-default", "checkbox-foreground-checked", "checkbox-foreground-default", "form-background-default", "form-border-default", "input-background-default", "input-background-disabled", "input-background-hover", "input-border-default", "input-border-disabled", "input-border-focus", "input-border-hover", "input-foreground-disabled", "input-foreground-primary", "input-foreground-secondary", "input-foreground-tertiary", "interface-background-brand-primary", "interface-background-brand-primary-hover", "interface-background-brand-secondary", "interface-background-brand-secondary-hover", "interface-background-default-inverted", "interface-background-default-inverted-hover", "interface-background-default-none", "interface-background-default-primary", "interface-background-default-primary-hover", "interface-background-default-secondary", "interface-background-default-secondary-hover", "interface-background-default-tertiary", "interface-background-default-tertiary-hover", "interface-background-disabled-disabled", "interface-background-validation-danger", "interface-background-validation-success", "interface-background-validation-warning", "interface-border-brand-brand", "interface-border-default-inverted", "interface-border-default-none", "interface-border-default-primary", "interface-border-disabled-disabled", "interface-border-validation-danger", "interface-border-validation-success", "interface-border-validation-warning", "interface-foreground-brand-on-primary", "interface-foreground-brand-on-secondary", "interface-foreground-brand-primary", "interface-foreground-brand-secondary", "interface-foreground-default-inverted", "interface-foreground-default-primary", "interface-foreground-default-secondary", "interface-foreground-default-tertiary", "interface-foreground-disabled-disabled", "interface-foreground-disabled-on-disabled", "interface-foreground-validation-danger", "interface-foreground-validation-success", "interface-foreground-validation-warning", "ory-background-default", "ory-border-default", "ory-foreground-default", "radio-background-checked", "radio-background-default", "radio-border-checked", "radio-border-default", "radio-foreground-checked", "radio-foreground-default", "toggle-background-checked", "toggle-background-default", "toggle-border-checked", "toggle-border-default", "toggle-foreground-checked", "toggle-foreground-default", "ui-100", "ui-200", "ui-300", "ui-400", "ui-50", "ui-500", "ui-600", "ui-700", "ui-800", "ui-900", "ui-950", "ui-black", "ui-danger", "ui-success", "ui-transparent", "ui-warning", "ui-white"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ax-background-default": obj.get("ax-background-default"),
