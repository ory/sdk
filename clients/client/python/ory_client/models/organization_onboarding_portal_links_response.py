...
class OrganizationOnboardingPortalLinksResponse(BaseModel):
    """
    OrganizationOnboardingPortalLinksResponse
    """ # noqa: E501
    links: List[OnboardingPortalLink]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": [OnboardingPortalLink.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None
        })
