...
class ContinueWithDeviceAuthnPinEntryUiData(BaseModel):
    ...
    """ # noqa: E501
    ciphertext: StrictStr = Field(description="Ciphertext is the base64-encoded HPKE-sealed pin_secret.")
    enc: StrictStr = Field(description="Enc is the base64-encoded HPKE encapsulated key.")
