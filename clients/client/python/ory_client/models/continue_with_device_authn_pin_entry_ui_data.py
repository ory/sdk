...
class ContinueWithDeviceAuthnPinEntryUiData(BaseModel):
    """
    ...
    """ # noqa: E501
    ciphertext: StrictStr = Field(description="The base64-encoded HPKE ciphertext of the sealed pin_secret.")
    enc: StrictStr = Field(description="The base64-encoded HPKE encapsulated key (the `enc` output of the seal operation).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ciphertext", "enc"]
