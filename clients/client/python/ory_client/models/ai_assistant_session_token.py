...
class AiAssistantSessionToken(BaseModel):
    """
    ...
    """ # noqa: E501
    expires_at: datetime = Field(description="Expiry of the token (RFC 3339). Refresh before this moment; assistant session tokens are valid for one hour after minting.")
    token: StrictStr = Field(description="Bearer token to pass to the assistant SDK.")
