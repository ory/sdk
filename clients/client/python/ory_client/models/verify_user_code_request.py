...
class VerifyUserCodeRequest(BaseModel):
    ...
    requested_access_token_audience: Optional[List[StrictStr]] = Field(default=None, description="RequestedAudience contains the access token audience as requested by the OAuth 2.0 Client.")
    requested_scope: Optional[List[StrictStr]] = Field(default=None, description="RequestedScope contains the OAuth 2.0 Scope requested by the OAuth 2.0 Client.")
