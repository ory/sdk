...
class CreateIdentityBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["credentials", "external_id", "metadata_admin", "metadata_public", "organization_id", "recovery_addresses", "schema_id", "state", "traits", "verifiable_addresses"]
