...
class CreateIdentityBody(BaseModel):
    ...
    region: Optional[StrictStr] = Field(default=None, description="Region is the Ory Network region this identity will be created in. Optional; defaults to the project home region if omitted. Only effective on the Ory Network. eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest eu EU asia Asia us US global Global")
    ...
    __properties: ClassVar[List[str]] = ["credentials", "external_id", "metadata_admin", "metadata_public", "organization_id", "recovery_addresses", "region", "schema_id", "state", "traits", "verifiable_addresses"]
