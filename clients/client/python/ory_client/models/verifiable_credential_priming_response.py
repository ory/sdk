...
class VerifiableCredentialPrimingResponse(BaseModel):
    ...
    c_nonce_expires_in: Optional[StrictInt] = None
    error: Optional[StrictStr] = None
    error_debug: Optional[StrictStr] = None
    error_description: Optional[StrictStr] = None
    error_hint: Optional[StrictStr] = None
    format: Optional[StrictStr] = None
    status_code: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["c_nonce", "c_nonce_expires_in", "error", "error_debug", "error_description", "error_hint", "format", "status_code"]
