...
class IdentityWithCredentialsPasskey(BaseModel):
    """
    Create Identity and Import Passkey Credentials
    """ # noqa: E501
    config: Optional[IdentityWithCredentialsPasskeyConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": IdentityWithCredentialsPasskeyConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
