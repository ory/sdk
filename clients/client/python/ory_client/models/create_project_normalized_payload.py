...
class CreateProjectNormalizedPayload(BaseModel):
    ...
    """ # noqa: E501
    account_experience_contact_url: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's Contact page. This governs the \"contact_url\" setting.")
    account_experience_custom_translations: Optional[List[RevisionAccountExperienceCustomTranslation]] = Field(default=None, description="The Account Experience's Custom Translations  Contains all Custom Translations for this project.")
    account_experience_default_locale: Optional[StrictStr] = Field(default=None, description="Holds the default locale for the account experience. This governs the \"default_locale\" setting.")
    account_experience_enabled_locales: Optional[List[StrictStr]] = Field(default=None, description="The Account Experience's Enabled Locales  This governs the locales that are available in the account experience. This governs the \"enabled_locales\" setting.")
    account_experience_favicon_dark: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's dark theme favicon (currently unused). This governs the \"favicon_dark\" setting.")
    account_experience_favicon_light: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's favicon. This governs the \"favicon_light\" setting.")
    account_experience_hide_ory_branding: Optional[StrictBool] = Field(default=None, description="Whether to hide the Ory branding badge on the account experience. This governs the \"hide_ory_branding\" setting.")
    account_experience_hide_registration_link: Optional[StrictBool] = Field(default=None, description="Whether to hide the registration link on the account experience login card. This governs the \"hide_registration_link\" setting.")
    account_experience_locale_behavior: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's language behavior.  Can be one of: - `respect_accept_language`: Respect the `Accept-Language` header. - `force_default`: Force the default language. This governs the \"locale_behavior\" setting.")
    account_experience_logo_dark: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's dark theme logo (currently unused). This governs the \"logo_dark\" setting.")
    account_experience_logo_light: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's logo. This governs the \"logo_light\" setting.")
    account_experience_privacy_policy_url: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's Privacy Policy page. This governs the \"privacy_policy_url\" setting.")
    account_experience_terms_of_service_url: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's Terms of Service page. This governs the \"terms_of_service_url\" setting.")
    account_experience_theme_variables_dark: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's dark theme variables. This governs the \"theme_variables_dark\" setting.")
    account_experience_theme_variables_light: Optional[StrictStr] = Field(default=None, description="Holds the URL to the account experience's light theme variables. This governs the \"theme_variables_light\" setting.")
    created_at: Optional[datetime] = Field(default=None, description="The Project's Revision Creation Date")
    disable_account_experience_welcome_screen: Optional[StrictBool] = Field(default=None, description="Whether to disable the account experience welcome screen, which is hosted under `/ui/welcome`. This governs the \"disable_welcome_screen\" setting.")
    enable_ax_v2: Optional[StrictBool] = Field(default=None, description="Whether the new account experience is enabled and reachable. This governs the \"enable_ax_v2\" setting.")
    environment: StrictStr = Field(description="prod Production stage Staging dev Development")
    feature_flags: Optional[Dict[str, StrictBool]] = Field(default=None, description="The project's feature flags. Keys are catalog flag keys such as `kratos.choose_recovery_address`. Responses contain every flag with its effective value; requests may set any subset.")
    home_region: Optional[StrictStr] = Field(default=None, description="eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest eu EU asia Asia us US global Global")
    hydra_oauth2_allowed_top_level_claims: Optional[List[StrictStr]] = Field(default=None, description="A list of custom claims which are allowed to be added top level to the Access Token. They cannot override reserved claims.  This governs the \"oauth2.allowed_top_level_claims\" setting.")
    ...
    hydra_oauth2_preserve_ext_claims: Optional[StrictBool] = Field(default=None, description="Set to true to keep custom claims that are not promoted to the top level in the 'ext' claim. Only applies when mirror_top_level_claims is false.  This governs the \"oauth2.preserve_ext_claims\" setting.")
    ...
    hydra_oauth2_token_prefix: Optional[StrictStr] = Field(default=None, description="Sets a per-project Access Token, Refresh Token, and Authorization Code prefix. The literal \"%s\" is replaced at issuance time with the token kind: \"at\" (access token), \"rt\" (refresh token), or \"ac\" (authorization code). For example, \"acme_%s_\" yields \"acme_at_…\", \"acme_rt_…\", and \"acme_ac_…\".  Must be a fmt.Sprintf template with exactly one \"%s\" substitution. The rendered prefix may contain only ASCII letters, digits, and underscores — no other \"%\" directives (\"%d\", \"%%\", positional or width-flagged verbs), no hyphens, dots, slashes, whitespace, quotes, or non-ASCII characters. Leave empty to keep the default \"ory_%s_\" prefix.  This is an Enterprise feature.  This governs the \"oauth2.token_prefix\" setting.")
    hydra_oidc_dynamic_client_registration_default_scope: Optional[List[StrictStr]] = Field(default=None, description="The OpenID Connect Dynamic Client Registration specification has no concept of whitelisting OAuth 2.0 Scope. If you want to expose Dynamic Client Registration, you should set the default scope enabled for newly registered clients. Keep in mind that users can overwrite this default by setting the \"scope\" key in the registration payload, effectively disabling the concept of whitelisted scopes.  This governs the \"oidc.dynamic_client_registration.default_scope\" setting.")
    ...
    hydra_oidc_subject_identifiers_supported_types: Optional[List[StrictStr]] = Field(default=None, description="Configures OpenID Connect Discovery and overwrites the list of Subject Identifier Algorithms to enable.  This governs the \"oidc.subject_identifiers.supported_types\" setting.")
    hydra_secrets_cookie: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Hydra Cookie Secret  This governs the \"secrets.cookie\" setting.")
    hydra_secrets_pagination: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Hydra Pagination Secret  This governs the \"secrets.pagination\" setting.")
    hydra_secrets_system: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Hydra System Secret  This governs the \"secrets.system\" setting.")
    ...
    hydra_webfinger_jwks_broadcast_keys: Optional[List[StrictStr]] = Field(default=None, description="A list of JSON Web Keys that should be exposed at that endpoint. This is usually the public key for verifying OpenID Connect ID Tokens. However, you might want to add additional keys here as well.  This governs the \"webfinger.jwks.broadcast_keys\" setting.")
    hydra_webfinger_oidc_discovery_auth_url: Optional[StrictStr] = Field(default=None, description="Configures OpenID Connect Discovery and overwrites the OAuth2 Authorization URL.  This governs the \"webfinger.oidc_discovery.auth_url\" setting.")
    hydra_webfinger_oidc_discovery_client_registration_url: Optional[StrictStr] = Field(default=None, description="Configures OpenID Connect Discovery and overwrites the OpenID Connect Dynamic Client Registration Endpoint.  This governs the \"webfinger.oidc_discovery.client_registration_url\" setting.")
    hydra_webfinger_oidc_discovery_device_authorization_url: Optional[StrictStr] = Field(default=None, description="Override the OAuth 2.0 Device Authorization Endpoint URL that is advertised in the OpenID Connect discovery document (/.well-known/openid-configuration). Defaults to the project's public base URL + /oauth2/device/auth.  This is an Enterprise feature.  This governs the \"webfinger.oidc_discovery.device_authorization_url\" setting.")
    hydra_webfinger_oidc_discovery_jwks_url: Optional[StrictStr] = Field(default=None, description="Configures OpenID Connect Discovery and overwrites the JWKS URL.  This governs the \"webfinger.oidc_discovery.jwks_url\" setting.")
    hydra_webfinger_oidc_discovery_supported_claims: Optional[List[StrictStr]] = Field(default=None, description="Configures OpenID Connect Discovery and overwrites a list of supported claims to be broadcasted. Claim \"sub\" is always included.  This governs the \"webfinger.oidc_discovery.supported_claims\" setting.")
    hydra_webfinger_oidc_discovery_supported_scope: Optional[List[StrictStr]] = Field(default=None, description="Configures OpenID Connect Discovery and overwrites the scope OAuth 2.0 Clients may request. Scope `offline`, `offline_access`, and `openid` are always included.  This governs the \"webfinger.oidc_discovery.supported_scope\" setting.")
    hydra_webfinger_oidc_discovery_token_url: Optional[StrictStr] = Field(default=None, description="Configures OpenID Connect Discovery and overwrites the OAuth2 Token URL.  This governs the \"webfinger.oidc_discovery.token_url\" setting.")
    ...
    id: Optional[UUID] = Field(default=None, description="The revision ID.")
    keto_feature_flags_strict_mode: Optional[StrictBool] = Field(default=None, description="Configures Keto's strict mode.  This governs the \"feature_flags.strict_mode\" setting.")
    keto_namespace_configuration: Optional[StrictStr] = Field(default=None, description="The Revisions' Keto Namespace Configuration  The string is a URL pointing to an OPL file with the configuration.  This governs the \"namespaces.location\" setting.")
    keto_namespaces: Optional[List[KetoNamespace]] = None
    keto_secrets_pagination: Optional[List[StrictStr]] = Field(default=None, description="Configures Keto's pagination secrets.  This governs the \"secrets.pagination\" setting.")
    keto_strict_mode_readonly: Optional[StrictBool] = Field(default=None, description="When true, strict mode is locked: changes to it are rejected from any client (API, Console, config import), and the Console hides the toggle. NULL and false mean strict mode can be changed (existing projects during migration). New projects are created with this set to true, permanently enabling strict mode. This flag is backoffice metadata and is not part of the rendered Keto configuration.")
    ...
    kratos_courier_delivery_strategy: Optional[StrictStr] = Field(default='smtp', description="The delivery strategy to use when sending emails  This governs the \"courier.delivery_strategy\" setting.  - `smtp`: Use SMTP server - `http`: Use the built in HTTP client to send the email to some remote service")
    kratos_courier_http_request_config_auth_api_key_in: Optional[StrictStr] = Field(default=None, description="The location of the API key to use in the HTTP email sending service's authentication  - `header`: Send the key value pair as a header - `cookie`: Send the key value pair as a cookie This governs the \"courier.http.request_config.auth.config.in\" setting.")
    kratos_courier_http_request_config_auth_api_key_name: Optional[StrictStr] = Field(default=None, description="The name of the API key to use in the HTTP email sending service's authentication  This governs the \"courier.http.request_config.auth.config.name\" setting.")
    kratos_courier_http_request_config_auth_api_key_value: Optional[StrictStr] = Field(default=None, description="The value of the API key to use in the HTTP email sending service's authentication  This governs the \"courier.http.request_config.auth.config.value\" setting.")
    kratos_courier_http_request_config_auth_basic_auth_password: Optional[StrictStr] = Field(default=None, description="The password to use for basic auth in the HTTP email sending service's authentication  This governs the \"courier.http.request_config.auth.config.password\" setting.")
    kratos_courier_http_request_config_auth_basic_auth_user: Optional[StrictStr] = Field(default=None, description="The user to use for basic auth in the HTTP email sending service's authentication  This governs the \"courier.http.request_config.auth.config.user\" setting.")
    kratos_courier_http_request_config_auth_type: Optional[StrictStr] = Field(default='empty (no authentication)', description="The authentication type to use while contacting the remote HTTP email sending service  This governs the \"courier.http.request_config.auth.type\" setting.  - `basic_auth`: Use Basic Authentication - `api_key`: Use API Key Authentication in a header or cookie")
    kratos_courier_http_request_config_body: Optional[StrictStr] = Field(default=None, description="The Jsonnet template to generate the body to send to the remote HTTP email sending service  Should be valid Jsonnet and base64 encoded  This governs the \"courier.http.request_config.body\" setting.")
    kratos_courier_http_request_config_headers: Optional[Dict[str, Any]] = Field(default=None, description="Any additional headers to send to the remote HTTP email sending service  This governs the \"courier.http.request_config.headers\" setting.")
    kratos_courier_http_request_config_method: Optional[StrictStr] = Field(default='POST', description="The http METHOD to use when calling the remote HTTP email sending service  This governs the \"courier.http.request_config.method\" setting.")
    kratos_courier_http_request_config_url: Optional[StrictStr] = Field(default=None, description="The URL of the remote HTTP email sending service  This governs the \"courier.http.request_config.url\" setting.")
    ...
    kratos_courier_smtp_headers: Optional[Dict[str, Any]] = Field(default=None, description="Configures the Ory Kratos SMTP Connection Headers  This governs the \"courier.smtp.headers\" setting.")
    ...
    kratos_courier_templates_login_code_valid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Login via Code Email Body HTML Template  This governs the \"courier.templates.login_code.valid.email.body.html\" setting.")
    kratos_courier_templates_login_code_valid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Login via Code Email Body Plaintext Template  This governs the \"courier.templates.login_code.valid.email.body.plaintext\" setting.")
    kratos_courier_templates_login_code_valid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Login via Code Email Subject Template  This governs the \"courier.templates.login_code.valid.email.subject\" setting.")
    kratos_courier_templates_login_code_valid_sms_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Login via Code SMS plain text body  This governs the \"courier.templates.login_code.valid.sms.body.plaintext\" setting.")
    kratos_courier_templates_recovery_code_invalid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Recovery via Code Email Body HTML Template  This governs the \"courier.templates.recovery_code.invalid.email.body.html\" setting.")
    kratos_courier_templates_recovery_code_invalid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Recovery via Code Email Body Plaintext Template  This governs the \"courier.templates.recovery_code.invalid.email.body.plaintext\" setting.")
    kratos_courier_templates_recovery_code_invalid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Recovery via Code Email Subject Template  This governs the \"courier.templates.recovery_code.invalid.email.subject\" setting.")
    kratos_courier_templates_recovery_code_valid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Recovery via Code Email Body HTML Template  This governs the \"courier.templates.recovery_code.valid.email.body.html\" setting.")
    kratos_courier_templates_recovery_code_valid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Recovery via Code Email Body Plaintext Template  This governs the \"courier.templates.recovery_code.valid.email.body.plaintext\" setting.")
    kratos_courier_templates_recovery_code_valid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Recovery via Code Email Subject Template  This governs the \"courier.templates.recovery_code.valid.email.subject\" setting.")
    kratos_courier_templates_recovery_invalid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Recovery Email Body HTML Template  This governs the \"courier.templates.recovery.invalid.email.body.html\" setting.")
    kratos_courier_templates_recovery_invalid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Recovery Email Body Plaintext Template  This governs the \"courier.templates.recovery.invalid.email.body.plaintext\" setting.")
    kratos_courier_templates_recovery_invalid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Recovery Email Subject Template  This governs the \"courier.templates.recovery.invalid.email.subject\" setting.")
    kratos_courier_templates_recovery_valid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Recovery Email Body HTML Template  This governs the \"courier.templates.recovery.valid.email.body.html\" setting.")
    kratos_courier_templates_recovery_valid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Recovery Email Body Plaintext Template  This governs the \"courier.templates.recovery.valid.email.body.plaintext\" setting.")
    kratos_courier_templates_recovery_valid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Recovery Email Subject Template  This governs the \"courier.templates.recovery.valid.email.subject\" setting.")
    kratos_courier_templates_registration_code_valid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Registration via Code Email Body HTML Template  This governs the \"courier.templates.registration_code.valid.email.body.html\" setting.")
    kratos_courier_templates_registration_code_valid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Registration via Code Email Body Plaintext Template  This governs the \"courier.templates.registration_code.valid.email.body.plaintext\" setting.")
    kratos_courier_templates_registration_code_valid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Registration via Code Email Subject Template  This governs the \"courier.templates.registration_code.valid.email.subject\" setting.")
    kratos_courier_templates_registration_code_valid_sms_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Registration via Code SMS Body Plaintext Template  This governs the \"courier.templates.registration_code.valid.sms.body.plaintext\" setting.")
    kratos_courier_templates_verifiable_address_changed_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Verifiable Address Changed Email Body HTML Template  This governs the \"courier.templates.verifiable_address_changed.email.body.html\" setting.")
    kratos_courier_templates_verifiable_address_changed_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Verifiable Address Changed Email Body Plaintext Template  This governs the \"courier.templates.verifiable_address_changed.email.body.plaintext\" setting.")
    kratos_courier_templates_verifiable_address_changed_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Verifiable Address Changed Email Subject Template  This governs the \"courier.templates.verifiable_address_changed.email.subject\" setting.")
    kratos_courier_templates_verifiable_address_changed_sms_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Verifiable Address Changed SMS Body Plaintext Template  This governs the \"courier.templates.verifiable_address_changed.sms.body.plaintext\" setting.")
    kratos_courier_templates_verification_code_invalid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Verification via Code Email Body HTML Template  This governs the \"courier.templates.verification_code.invalid.email.body.html\" setting.")
    kratos_courier_templates_verification_code_invalid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Verification via Code Email Body Plaintext Template  This governs the \"courier.templates.verification_code.invalid.email.body.plaintext\" setting.")
    kratos_courier_templates_verification_code_invalid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Verification via Code Email Subject Template  This governs the \"courier.templates.verification_code.invalid.email.subject\" setting.")
    kratos_courier_templates_verification_code_valid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Verification via Code Email Body HTML Template  This governs the \"courier.templates.verification_code.valid.email.body.html\" setting.")
    kratos_courier_templates_verification_code_valid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Verification via Code Email Body Plaintext Template  This governs the \"courier.templates.verification_code.valid.email.body.plaintext\" setting.")
    kratos_courier_templates_verification_code_valid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Verification via Code Email Subject Template  This governs the \"courier.templates.verification_code.valid.email.subject\" setting.")
    kratos_courier_templates_verification_code_valid_sms_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Verification via Code SMS Body Plaintext  This governs the \"courier.templates.verification_code.valid.sms.body.plaintext\" setting.")
    kratos_courier_templates_verification_invalid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Verification Email Body HTML Template  This governs the \"courier.templates.verification.invalid.email.body.html\" setting.")
    kratos_courier_templates_verification_invalid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Verification Email Body Plaintext Template  This governs the \"courier.templates.verification.invalid.email.body.plaintext\" setting.")
    kratos_courier_templates_verification_invalid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Invalid Verification Email Subject Template  This governs the \"courier.templates.verification.invalid.email.subject\" setting.")
    kratos_courier_templates_verification_valid_email_body_html: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Verification Email Body HTML Template  This governs the \"courier.templates.verification.valid.email.body.html\" setting.")
    kratos_courier_templates_verification_valid_email_body_plaintext: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Verification Email Body Plaintext Template  This governs the \"courier.templates.verification.valid.email.body.plaintext\" setting.")
    kratos_courier_templates_verification_valid_email_subject: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Valid Verification Email Subject Template  This governs the \"courier.templates.verification.valid.email.subject\" setting.")
    ...
    kratos_feature_flags_webhook_response_directives: Optional[StrictBool] = Field(default=None, description="Honor flow directives in web hook responses  If true, a login `after` web hook whose `response.parse` is enabled may return `{\"required_aal\":\"aal2\"}` to require step-up for that login. Identities without a second factor are routed to enrollment. Off by default, because a web hook that already returns a `required_aal` field has it ignored today and enabling that silently would change how existing logins end.  This governs the \"feature_flags.webhook_response_directives\" setting.")
    kratos_identity_schemas: Optional[List[NormalizedProjectRevisionIdentitySchema]] = None
    kratos_oauth2_provider_headers: Optional[Dict[str, Any]] = Field(default=None, description="Configures the OAuth2 Provider Integration HTTP Headers  This governs the \"oauth2_provider.headers\" setting.")
    ...
    kratos_secrets_cipher: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Kratos Cipher Secret  This governs the \"secrets.cipher\" setting.")
    kratos_secrets_cookie: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Kratos Cookie Secret  This governs the \"secrets.cookie\" setting.")
    kratos_secrets_default: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Kratos Default Secret  This governs the \"secrets.default\" setting.")
    kratos_secrets_pagination: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Kratos Pagination Secret  This governs the \"secrets.pagination\" setting.")
    kratos_security_account_enumeration_mitigate: Optional[StrictBool] = Field(default=None, description="Configures if account enumeration should be mitigated when using identifier first login.  This governs the \"security.account_enumeration.mitigate\" setting.")
    kratos_selfservice_allowed_return_urls: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Kratos Allowed Return URLs  This governs the \"selfservice.allowed_return_urls\" setting.")
    kratos_selfservice_default_browser_return_url: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Default Return URL  This governs the \"selfservice.default_browser_return_url\" setting.")
    ...
    kratos_selfservice_flows_login_after_code_default_browser_return_url: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Login After Code Default Return URL  This governs the \"selfservice.flows.login.after.code.default_browser_return_url\" setting.")
    ...
    kratos_selfservice_flows_login_after_lookup_secret_default_browser_return_url: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Login After Lookup Secret Default Return URL  This governs the \"selfservice.flows.login.after.lookup_secret.default_browser_return_url\" setting.")
    ...
    kratos_selfservice_flows_login_after_totp_default_browser_return_url: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Login After TOTP Default Return URL  This governs the \"selfservice.flows.login.after.totp.default_browser_return_url\" setting.")
    ...
    kratos_selfservice_flows_login_style: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Login Flow Style  This governs the \"selfservice.flows.login.style\" setting. Possible values are \"unified\" and \"identifier_first\".")
    ...
    kratos_selfservice_flows_registration_after_passkey_default_browser_return_url: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos Registration After Passkey Default Return URL  This governs the \"selfservice.flows.registration.after.passkey.default_browser_return_url\" setting.")
    ...
    kratos_selfservice_methods_captcha_config_allowed_domains: Optional[List[StrictStr]] = Field(default=None, description="Configures the CAPTCHA allowed domains list  This governs the \"selfservice.methods.captcha.config.allowed_domains\" setting.")
    kratos_selfservice_methods_captcha_config_byo: Optional[StrictBool] = Field(default=None, description="Configures whether to use BYO or managed widget  Reach out to your account manager to enable this feature.  This governs the \"selfservice.methods.captcha.config.byo\" setting.")
    kratos_selfservice_methods_captcha_config_cf_turnstile_byo_secret: Optional[StrictStr] = Field(default=None, description="Configures the Cloudflare Turnstile site secret for Ory BYO CAPTCHA protection  The site secret is private and will be never be shared with the client. This key is write only and the value will not be returned in response to a read request.  Reach out to your account manager to enable this feature.  This governs the \"selfservice.methods.captcha.config.cf_turnstile.secret\" setting.")
    kratos_selfservice_methods_captcha_config_cf_turnstile_byo_sitekey: Optional[StrictStr] = Field(default=None, description="Configures the Cloudflare Turnstile site key for Ory BYO CAPTCHA protection  The site key is public and will be shared with the client.  Reach out to your account manager to enable this feature.  This governs the \"selfservice.methods.captcha.config.cf_turnstile.sitekey\" setting.")
    kratos_selfservice_methods_captcha_config_cf_turnstile_secret: Optional[StrictStr] = Field(default=None, description="Configures the Cloudflare Turnstile site secret for managed CAPTCHA protection  The site secret is private and will be never be shared with the client. This key is write only and the value will not be returned in response to a read request.  Reach out to your account manager to enable this feature.  This governs the \"selfservice.methods.captcha.config.cf_turnstile.secret\" setting.")
    kratos_selfservice_methods_captcha_config_cf_turnstile_sitekey: Optional[StrictStr] = Field(default=None, description="Configures the Cloudflare Turnstile site key for managed CAPTCHA protection  The site key is public and will be shared with the client.  Reach out to your account manager to enable this feature.  This governs the \"selfservice.methods.captcha.config.cf_turnstile.sitekey\" setting.")
    kratos_selfservice_methods_captcha_config_legacy_inject_node: Optional[StrictBool] = Field(default=None, description="Configures legacy CAPTCHA node injection behavior  Reach out to your account manager to enable this feature.  This governs the \"selfservice.methods.captcha.config.legacy_inject_node\" setting.")
    kratos_selfservice_methods_captcha_enabled: Optional[StrictBool] = Field(default=None, description="Configures the Ory Kratos Self-Service Methods' Captcha Enabled Setting  Reach out to your account manager to enable this feature.  This governs the \"selfservice.methods.captcha.enabled\" setting.")
    ...
    kratos_selfservice_methods_code_config_max_submissions: Optional[StrictInt] = Field(default=None, description="Configures the maximum number of attempts to submit a one-time code in kratos.  This governs the \"selfservice.methods.code.max_submissions\" setting.")
    ...
    kratos_selfservice_methods_deviceauthn_config_android_app_ids: Optional[List[StrictStr]] = Field(default=None, description="Configures the allow-list of Android app signing-certificate digests that a device key may be bound to.  This governs the \"selfservice.methods.deviceauthn.config.android_app_ids\" setting.")
    kratos_selfservice_methods_deviceauthn_config_first_factor: Optional[StrictBool] = Field(default=None, description="Configures whether device authentication may be used as the sole first factor.  When enabled, a confirmed device key with PIN or platform user verification can complete an AAL2 login in a single submission, without a password or code. Defaults to false, which keeps device keys usable only as a second factor (step-up).  This governs the \"selfservice.methods.deviceauthn.config.first_factor\" setting.")
    ...
    kratos_selfservice_methods_deviceauthn_config_ios_app_ids: Optional[List[StrictStr]] = Field(default=None, description="Configures the allow-list of Apple App IDs that a device key may be bound to.  This governs the \"selfservice.methods.deviceauthn.config.ios_app_ids\" setting.")
    ...
    kratos_selfservice_methods_deviceauthn_config_pin_max_attempts: Optional[StrictInt] = Field(default=None, description="Configures the number of consecutive wrong-PIN attempts before a device key is locked.  Defaults to 5; must be between 1 and 10. Once locked, the key's pin_secret is invalidated and the key can no longer be used to log in until the user rotates its secret through the fallback login.  This governs the \"selfservice.methods.deviceauthn.config.pin_max_attempts\" setting.")
    kratos_selfservice_methods_deviceauthn_enabled: Optional[StrictBool] = Field(default=None, description="Configures whether Ory Kratos Device authentication is enabled  This governs the \"selfservice.methods.deviceauthn.enabled\" setting.")
    ...
    kratos_selfservice_methods_passkey_config_rp_origins: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Kratos Passkey RP Origins  This governs the \"selfservice.methods.passkey.config.rp.origins\" setting.")
    ...
    kratos_selfservice_methods_webauthn_config_rp_origins: Optional[List[StrictStr]] = Field(default=None, description="Configures the Ory Kratos Webauthn RP Origins  This governs the \"selfservice.methods.webauthn.config.rp.origins\" setting.")
    ...
    project_id: Optional[UUID] = Field(default=None, description="The Revision's Project ID")
    ...
    serve_admin_cors_allowed_origins: Optional[List[StrictStr]] = Field(default=None, description="Configures the CORS Allowed Origins on admin APIs  This governs the \"serve.admin.cors.allowed_origins\" setting.")
    ...
    serve_public_cors_allowed_origins: Optional[List[StrictStr]] = Field(default=None, description="Configures the CORS Allowed Origins on public APIs  This governs the \"serve.public.cors.allowed_origins\" setting.")
    ...
    def home_region_validate_enum(cls, value):
        ...
        if value not in set(['eu-central', 'asia-northeast', 'us-east', 'us-west', 'eu', 'asia', 'us', 'global']):
            raise ValueError("must be one of enum values ('eu-central', 'asia-northeast', 'us-east', 'us-west', 'eu', 'asia', 'us', 'global')")
        return value

    @field_validator('hydra_oauth2_device_authorization_token_polling_interval')
    def hydra_oauth2_device_authorization_token_polling_interval_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value

        if not re.match(r"^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$", value):
            raise ValueError(r"must validate the regular expression /^([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+$/")
        return value

    @field_validator('hydra_oauth2_device_authorization_user_code_entropy_preset')
    def hydra_oauth2_device_authorization_user_code_entropy_preset_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('hydra_ttl_device_user_code')
    def hydra_ttl_device_user_code_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def hydra_ttl_refresh_token_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+|-1)$", value):
            raise ValueError(r"must validate the regular expression /^(([0-9]+([.][0-9]+)?(ns|us|µs|ms|s|m|h))+|-1)$/")
        return value
    ...
    @field_validator('talos_cache_ttl')
    def talos_cache_ttl_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('talos_credentials_api_keys_default_ttl')
    def talos_credentials_api_keys_default_ttl_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('talos_credentials_api_keys_max_ttl')
    def talos_credentials_api_keys_max_ttl_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('talos_credentials_derived_tokens_default_ttl')
    def talos_credentials_derived_tokens_default_ttl_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in account_experience_custom_translations (list)
        _items = []
        if self.account_experience_custom_translations:
            for _item_account_experience_custom_translations in self.account_experience_custom_translations:
                if _item_account_experience_custom_translations:
                    _items.append(_item_account_experience_custom_translations.to_dict())
            _dict['account_experience_custom_translations'] = _items
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in talos_credentials_issuer_retired_entries (list)
        _items = []
        if self.talos_credentials_issuer_retired_entries:
            for _item_talos_credentials_issuer_retired_entries in self.talos_credentials_issuer_retired_entries:
                if _item_talos_credentials_issuer_retired_entries:
                    _items.append(_item_talos_credentials_issuer_retired_entries.to_dict())
            _dict['talos_credentials_issuer_retired_entries'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in talos_secrets_hmac_retired_entries (list)
        _items = []
        if self.talos_secrets_hmac_retired_entries:
            for _item_talos_secrets_hmac_retired_entries in self.talos_secrets_hmac_retired_entries:
                if _item_talos_secrets_hmac_retired_entries:
                    _items.append(_item_talos_secrets_hmac_retired_entries.to_dict())
            _dict['talos_secrets_hmac_retired_entries'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account_experience_contact_url": obj.get("account_experience_contact_url"),
            "account_experience_custom_translations": [RevisionAccountExperienceCustomTranslation.from_dict(_item) for _item in obj["account_experience_custom_translations"]] if obj.get("account_experience_custom_translations") is not None else None,
            "account_experience_default_locale": obj.get("account_experience_default_locale"),
            "account_experience_enabled_locales": obj.get("account_experience_enabled_locales"),
            ...
            "account_experience_hide_ory_branding": obj.get("account_experience_hide_ory_branding"),
            "account_experience_hide_registration_link": obj.get("account_experience_hide_registration_link"),
            ...
            "account_experience_privacy_policy_url": obj.get("account_experience_privacy_policy_url"),
            "account_experience_terms_of_service_url": obj.get("account_experience_terms_of_service_url"),
            ...
            "hydra_oauth2_device_authorization_token_polling_interval": obj.get("hydra_oauth2_device_authorization_token_polling_interval"),
            "hydra_oauth2_device_authorization_user_code_entropy_preset": obj.get("hydra_oauth2_device_authorization_user_code_entropy_preset"),
            ...
            "hydra_oauth2_grant_jwt_omit_assertion_audience": obj.get("hydra_oauth2_grant_jwt_omit_assertion_audience"),
            "hydra_oauth2_grant_refresh_token_rotation_grace_period": obj.get("hydra_oauth2_grant_refresh_token_rotation_grace_period"),
            "hydra_oauth2_grant_refresh_token_rotation_grace_reuse_count": obj.get("hydra_oauth2_grant_refresh_token_rotation_grace_reuse_count"),
            ...
            "hydra_oauth2_preserve_ext_claims": obj.get("hydra_oauth2_preserve_ext_claims"),
            ...
            "hydra_oauth2_token_prefix": obj.get("hydra_oauth2_token_prefix"),
            ...
            "hydra_ttl_device_user_code": obj.get("hydra_ttl_device_user_code"),
            ...
            "hydra_urls_device_success": obj.get("hydra_urls_device_success"),
            "hydra_urls_device_verification": obj.get("hydra_urls_device_verification"),
            ...
            "hydra_webfinger_oidc_discovery_device_authorization_url": obj.get("hydra_webfinger_oidc_discovery_device_authorization_url"),
            ...
            "id": obj.get("id"),
            "keto_feature_flags_strict_mode": obj.get("keto_feature_flags_strict_mode"),
            ...
            "keto_strict_mode_readonly": obj.get("keto_strict_mode_readonly"),
            ...
            "kratos_courier_templates_verifiable_address_changed_email_body_html": obj.get("kratos_courier_templates_verifiable_address_changed_email_body_html"),
            "kratos_courier_templates_verifiable_address_changed_email_body_plaintext": obj.get("kratos_courier_templates_verifiable_address_changed_email_body_plaintext"),
            "kratos_courier_templates_verifiable_address_changed_email_subject": obj.get("kratos_courier_templates_verifiable_address_changed_email_subject"),
            "kratos_courier_templates_verifiable_address_changed_sms_body_plaintext": obj.get("kratos_courier_templates_verifiable_address_changed_sms_body_plaintext"),
            ...
            "kratos_feature_flags_enforce_identity_schema_guards": obj.get("kratos_feature_flags_enforce_identity_schema_guards"),
            ...
            "kratos_feature_flags_refresh_login_choose_address": obj.get("kratos_feature_flags_refresh_login_choose_address"),
            "kratos_feature_flags_use_continue_with_transitions": obj.get("kratos_feature_flags_use_continue_with_transitions"),
            "kratos_feature_flags_webhook_response_directives": obj.get("kratos_feature_flags_webhook_response_directives"),
            ...
            "kratos_secrets_pagination": obj.get("kratos_secrets_pagination"),
            ...
            "kratos_selfservice_flows_login_style": obj.get("kratos_selfservice_flows_login_style"),
            ...
            "kratos_selfservice_methods_captcha_config_allowed_domains": obj.get("kratos_selfservice_methods_captcha_config_allowed_domains"),
            "kratos_selfservice_methods_captcha_config_byo": obj.get("kratos_selfservice_methods_captcha_config_byo"),
            "kratos_selfservice_methods_captcha_config_cf_turnstile_byo_secret": obj.get("kratos_selfservice_methods_captcha_config_cf_turnstile_byo_secret"),
            "kratos_selfservice_methods_captcha_config_cf_turnstile_byo_sitekey": obj.get("kratos_selfservice_methods_captcha_config_cf_turnstile_byo_sitekey"),
            ...
            "kratos_selfservice_methods_deviceauthn_config_android_allow_expired_factory_certificates": obj.get("kratos_selfservice_methods_deviceauthn_config_android_allow_expired_factory_certificates"),
            "kratos_selfservice_methods_deviceauthn_config_android_app_ids": obj.get("kratos_selfservice_methods_deviceauthn_config_android_app_ids"),
            "kratos_selfservice_methods_deviceauthn_config_first_factor": obj.get("kratos_selfservice_methods_deviceauthn_config_first_factor"),
            "kratos_selfservice_methods_deviceauthn_config_insecure_allow_relaxed_attestation": obj.get("kratos_selfservice_methods_deviceauthn_config_insecure_allow_relaxed_attestation"),
            "kratos_selfservice_methods_deviceauthn_config_ios_app_ids": obj.get("kratos_selfservice_methods_deviceauthn_config_ios_app_ids"),
            "kratos_selfservice_methods_deviceauthn_config_ios_biometric_first_factor": obj.get("kratos_selfservice_methods_deviceauthn_config_ios_biometric_first_factor"),
            "kratos_selfservice_methods_deviceauthn_config_pin_max_attempts": obj.get("kratos_selfservice_methods_deviceauthn_config_pin_max_attempts"),
            "kratos_selfservice_methods_deviceauthn_enabled": obj.get("kratos_selfservice_methods_deviceauthn_enabled"),
            ...
            "talos_cache_enabled": obj.get("talos_cache_enabled"),
            "talos_cache_ttl": obj.get("talos_cache_ttl"),
            "talos_credentials_api_keys_default_ttl": obj.get("talos_credentials_api_keys_default_ttl"),
            "talos_credentials_api_keys_max_ttl": obj.get("talos_credentials_api_keys_max_ttl"),
            "talos_credentials_api_keys_prefix_current": obj.get("talos_credentials_api_keys_prefix_current"),
            "talos_credentials_api_keys_prefix_public_current": obj.get("talos_credentials_api_keys_prefix_public_current"),
            "talos_credentials_api_keys_prefix_public_retired": obj.get("talos_credentials_api_keys_prefix_public_retired"),
            "talos_credentials_api_keys_prefix_retired": obj.get("talos_credentials_api_keys_prefix_retired"),
            "talos_credentials_derived_tokens_default_ttl": obj.get("talos_credentials_derived_tokens_default_ttl"),
            "talos_credentials_derived_tokens_jwt_signing_key_id": obj.get("talos_credentials_derived_tokens_jwt_signing_key_id"),
            "talos_credentials_derived_tokens_jwt_signing_keys_urls": obj.get("talos_credentials_derived_tokens_jwt_signing_keys_urls"),
            "talos_credentials_derived_tokens_macaroon_prefix_current": obj.get("talos_credentials_derived_tokens_macaroon_prefix_current"),
            "talos_credentials_derived_tokens_macaroon_prefix_retired": obj.get("talos_credentials_derived_tokens_macaroon_prefix_retired"),
            "talos_credentials_issuer": obj.get("talos_credentials_issuer"),
            "talos_credentials_issuer_retired": obj.get("talos_credentials_issuer_retired"),
            "talos_credentials_issuer_retired_entries": [TalosRetiredValue.from_dict(_item) for _item in obj["talos_credentials_issuer_retired_entries"]] if obj.get("talos_credentials_issuer_retired_entries") is not None else None,
            "talos_rate_limit_enabled": obj.get("talos_rate_limit_enabled"),
            "talos_secrets_hmac_current": obj.get("talos_secrets_hmac_current"),
            "talos_secrets_hmac_retired": obj.get("talos_secrets_hmac_retired"),
            "talos_secrets_hmac_retired_entries": [TalosRetiredValue.from_dict(_item) for _item in obj["talos_secrets_hmac_retired_entries"]] if obj.get("talos_secrets_hmac_retired_entries") is not None else None,
