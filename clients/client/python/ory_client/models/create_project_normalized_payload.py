...
class CreateProjectNormalizedPayload(BaseModel):
    ...
    kratos_selfservice_methods_saml_config_base_redirect_uri: Optional[StrictStr] = Field(default=None, description="Configures the Ory Kratos SAML base redirect URI  This governs the \"selfservice.methods.saml.config.base_redirect_uri\" setting.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.kratos_selfservice_methods_saml_config_providers:
            for _item in self.kratos_selfservice_methods_saml_config_providers:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kratos_selfservice_methods_saml_config_base_redirect_uri": obj.get("kratos_selfservice_methods_saml_config_base_redirect_uri"),
