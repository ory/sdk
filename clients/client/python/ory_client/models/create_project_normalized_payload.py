...
class CreateProjectNormalizedPayload(BaseModel):
    ...
    account_experience_enabled_locales: Optional[List[StrictStr]] = None
    ...
    kratos_secrets_pagination: Optional[List[StrictStr]] = None
    ...
    kratos_selfservice_methods_captcha_config_allowed_domains: Optional[List[StrictStr]] = None
    kratos_selfservice_methods_captcha_config_byo: Optional[StrictBool] = Field(default=None, description="Configures whether to use BYO or managed widget  Reach out to your account manager to enable this feature.")
    kratos_selfservice_methods_captcha_config_cf_turnstile_byo_secret: Optional[StrictStr] = Field(default=None, description="Configures the Cloudflare Turnstile site secret for Ory BYO CAPTCHA protection  The site secret is private and will be never be shared with the client. This key is write only and the value will not be returned in response to a read request.  Reach out to your account manager to enable this feature.")
    kratos_selfservice_methods_captcha_config_cf_turnstile_byo_sitekey: Optional[StrictStr] = Field(default=None, description="Configures the Cloudflare Turnstile site key for Ory BYO CAPTCHA protection  The site key is public and will be shared with the client.  Reach out to your account manager to enable this feature.")
    kratos_selfservice_methods_captcha_config_cf_turnstile_secret: Optional[StrictStr] = Field(default=None, description="Configures the Cloudflare Turnstile site secret for managed CAPTCHA protection  The site secret is private and will be never be shared with the client. This key is write only and the value will not be returned in response to a read request.  Reach out to your account manager to enable this feature.")
    kratos_selfservice_methods_captcha_config_cf_turnstile_sitekey: Optional[StrictStr] = Field(default=None, description="Configures the Cloudflare Turnstile site key for managed CAPTCHA protection  The site key is public and will be shared with the client.  Reach out to your account manager to enable this feature.")
