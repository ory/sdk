...
class CreateProjectNormalizedPayload(BaseModel):
    ...
    kratos_selfservice_methods_deviceauthn_config_first_factor: Optional[StrictBool] = Field(default=None, description="Configures whether device authentication may be used as the sole first factor.  This governs the \"selfservice.methods.deviceauthn.config.first_factor\" setting.")
    ...
    kratos_selfservice_methods_deviceauthn_config_ios_biometric_first_factor: Optional[StrictBool] = Field(default=None, description="Configures whether an iOS biometric device key may be used as the sole first factor.  This governs the \"selfservice.methods.deviceauthn.config.ios_biometric_first_factor\" setting.")
    kratos_selfservice_methods_deviceauthn_config_pin_max_attempts: Optional[StrictInt] = Field(default=None, description="Configures the consecutive wrong-PIN limit before a device key is locked.  This governs the \"selfservice.methods.deviceauthn.config.pin_max_attempts\" setting.")
    ...
    talos_credentials_issuer_retired: Optional[List[StrictStr]] = Field(default=None, description="Talos credentials retired issuer URLs.  Previously active issuer URLs kept for verification of outstanding tokens. Tokens signed with these issuers remain valid; new tokens use the current issuer.")
