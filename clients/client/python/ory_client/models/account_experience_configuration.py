...
class AccountExperienceConfiguration(BaseModel):
    ...
    kratos_selfservice_default_browser_return_url: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["account_experience_theme_stylesheet", "favicon_type", "favicon_url", "kratos_selfservice_default_browser_return_url", "kratos_selfservice_flows_recovery_enabled", "kratos_selfservice_flows_registration_enabled", "kratos_selfservice_flows_verification_enabled", "logo_url", "name", "organization_map"]
