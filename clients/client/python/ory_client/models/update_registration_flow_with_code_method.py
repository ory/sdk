...
class UpdateRegistrationFlowWithCodeMethod(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The OTP Code sent to the user")
    csrf_token: Optional[StrictStr] = Field(default=None, description="The CSRF Token")
    method: StrictStr = Field(description="Method to use  This field must be set to `code` when using the code method.")
    resend: Optional[StrictStr] = Field(default=None, description="Resend restarts the flow with a new code")
    ...
    __properties: ClassVar[List[str]] = ["code", "csrf_token", "method", "resend", "traits", "transient_payload"]
