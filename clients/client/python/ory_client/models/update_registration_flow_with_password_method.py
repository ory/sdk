...
class UpdateRegistrationFlowWithPasswordMethod(BaseModel):
    ...
    method: StrictStr = Field(description="Method to use  This field must be set to `password` when using the password method.")
    password: StrictStr = Field(description="Password to sign the user up with")
    ...
    __properties: ClassVar[List[str]] = ["csrf_token", "method", "password", "traits", "transient_payload"]
