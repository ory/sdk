...
class AdminIdentityImportCredentialsLookupSecretConfig(BaseModel):
    """
    Create Identity and Import Lookup Secret Credentials Configuration
    """ # noqa: E501
    codes: Optional[List[IdentityCredentialsLookupSecretCode]] = Field(default=None, description="Codes is a list of \"lookup secret\" codes configured for the user.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "codes": [IdentityCredentialsLookupSecretCode.from_dict(_item) for _item in obj["codes"]] if obj.get("codes") is not None else None
        })
