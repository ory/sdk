...
class UpdateWorkspaceBody(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "access_policy": obj.get("access_policy"),
            "name": obj.get("name")
        })
