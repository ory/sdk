...
class ParseError(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "end": SourcePosition.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "message": obj.get("message"),
            "start": SourcePosition.from_dict(obj["start"]) if obj.get("start") is not None else None
        })
