...
class UpdateRegistrationFlowWithSamlMethod(BaseModel):
    """
    Update registration flow using SAML
    """ # noqa: E501
    csrf_token: Optional[StrictStr] = Field(default=None, description="The CSRF Token")
    method: StrictStr = Field(description="Method to use  This field must be set to `saml` when using the saml method.")
    ...
    __properties: ClassVar[List[str]] = ["csrf_token", "method", "provider", "traits", "transient_payload"]
