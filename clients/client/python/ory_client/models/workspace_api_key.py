...
class WorkspaceApiKey(BaseModel):
    ...
    last_characters: Optional[StrictStr] = Field(default=None, description="The last characters of the key's value.  Lets you tell API keys apart in the UI without revealing the full value. Empty for keys created before this was introduced.")
    ...
    workspace_id: Optional[UUID] = Field(default=None, description="The API key's workspace ID")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["created_at", "expires_at", "id", "last_characters", "name", "owner_id", "updated_at", "value", "workspace_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "last_characters": obj.get("last_characters"),
            "name": obj.get("name"),
