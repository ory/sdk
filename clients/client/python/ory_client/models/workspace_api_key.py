...
class WorkspaceApiKey(BaseModel):
    ...
    workspace_id: Optional[StrictStr] = Field(default=None, description="The API key's workspace ID")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["created_at", "expires_at", "id", "name", "owner_id", "updated_at", "value", "workspace_id"]
