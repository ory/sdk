...
class SetProjectBrandingThemeBody(BaseModel):
    ...
    """ # noqa: E501
    favicon_type: Optional[StrictStr] = Field(default=None, description="Favicon Type")
    favicon_url: Optional[StrictStr] = Field(default=None, description="Favicon URL")
    logo_type: Optional[StrictStr] = Field(default=None, description="Logo type")
    logo_url: Optional[StrictStr] = Field(default=None, description="Logo URL")
    name: Optional[StrictStr] = Field(default=None, description="Branding name")
    theme: Optional[ProjectBrandingColors] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["favicon_type", "favicon_url", "logo_type", "logo_url", "name", "theme"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "theme": ProjectBrandingColors.from_dict(obj["theme"]) if obj.get("theme") is not None else None
        })
