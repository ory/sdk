...
class ProjectApiKey(BaseModel):
    ...
    last_characters: Optional[StrictStr] = Field(default=None, description="The last characters of the token's value.  Lets you tell API keys apart in the UI without revealing the full value. Empty for keys created before this was introduced.")
    ...
    project_id: Optional[UUID] = Field(default=None, description="The Token's Project ID")
    ...
    __properties: ClassVar[List[str]] = ["created_at", "expires_at", "id", "last_characters", "name", "owner_id", "project_id", "updated_at", "value"]
