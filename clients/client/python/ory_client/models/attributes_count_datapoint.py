...
class AttributesCountDatapoint(BaseModel):
    ...
    """ # noqa: E501
    count: StrictInt = Field(description="Count of the attribute value for given key")
    name: StrictStr = Field(description="Name of the attribute value for given key")
