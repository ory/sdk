...
class GetOrganizationsByHostnameResponse(BaseModel):
    """
    getOrganizationsByHostnameResponse is the list of B2B SSO organizations for the project resolved from the request host.
    """ # noqa: E501
    organizations: List[OrganizationByHostname] = Field(description="Organizations is the list of organizations for the project.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organizations": [OrganizationByHostname.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None
        })
