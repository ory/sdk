...
class UiNodeTextAttributes(BaseModel):
    ...
    node_type: StrictStr = Field(description="NodeType represents this node's types. It is a mirror of `node.type` and is primarily used to allow compatibility with OpenAPI 3.0.  In this struct it technically always is \"text\". text Text input Input img Image a Anchor script Script div Division")
    text: UiText
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "node_type", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": UiText.from_dict(obj["text"]) if obj.get("text") is not None else None
        })
