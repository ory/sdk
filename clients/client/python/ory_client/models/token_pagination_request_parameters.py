...
class TokenPaginationRequestParameters(BaseModel):
    ...
    """ # noqa: E501
    page_size: Optional[Annotated[int, Field(le=500, strict=True, ge=1)]] = Field(default=250, description="Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination).")
