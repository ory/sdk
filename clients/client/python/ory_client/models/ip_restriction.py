...
class IPRestriction(BaseModel):
    ...
    """ # noqa: E501
    allowed_cidrs: Optional[List[StrictStr]] = Field(default=None, description="allowed_cidrs is a list of CIDR ranges that are allowed to use this key. Supports both IPv4 (e.g., \"10.0.0.0/8\") and IPv6 (e.g., \"2001:db8::/32\"). If empty, all IPs are allowed (no restriction).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["allowed_cidrs"]
