...
class IdentityCredentialsCode(BaseModel):
    ...
    """ # noqa: E501
    address_type: Optional[StrictStr] = Field(default=None, description="The type of the address for this code")
    used_at: Optional[datetime] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address_type", "used_at"]
