...
class IdentityWithCredentialsPasskeyConfig(BaseModel):
    """
    Create Identity and Import Passkey Credentials Configuration
    """ # noqa: E501
    credentials: Optional[List[IdentityCredentialsWebAuthn]] = None
    user_handle: Optional[List[StrictInt]] = Field(default=None, description="UserHandle is the user handle of the webauthn credential.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["credentials", "user_handle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credentials": [IdentityCredentialsWebAuthn.from_dict(_item) for _item in obj["credentials"]] if obj.get("credentials") is not None else None,
            "user_handle": obj.get("user_handle")
        })
