...
class InternalIsAXWelcomeScreenEnabledForProjectBody(BaseModel):
    ...
    """ # noqa: E501
    path: StrictStr = Field(description="Path is the path of the request.")
    project_slug: StrictStr = Field(description="ProjectSlug is the project's slug.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["path", "project_slug"]
