...
class NormalizedProjectRevisionCourierChannel(BaseModel):
    ...
    request_config_auth_config_api_key_in: Optional[StrictStr] = Field(default=None, description="API key location  Can either be \"header\" or \"query\"  Only used if the auth type is api_key")
