...
class OplParseError(BaseModel):
    """
    OplParseError
    """ # noqa: E501
    end: Optional[OplSourcePosition] = None
    message: Optional[StrictStr] = None
    start: Optional[OplSourcePosition] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["end", "message", "start"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "end": OplSourcePosition.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "message": obj.get("message"),
            "start": OplSourcePosition.from_dict(obj["start"]) if obj.get("start") is not None else None
        })
