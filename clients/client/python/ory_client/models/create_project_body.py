...
class CreateProjectBody(BaseModel):
    ...
    home_region: Optional[StrictStr] = Field(default=None, description="Home Region  The home region of the project. This is the region where the project will be created. eu-central EUCentral us-east USEast us-west USWest us US global Global")
    ...
    def home_region_validate_enum(cls, value):
        ...
        if value not in set(['eu-central', 'us-east', 'us-west', 'us', 'global']):
            raise ValueError("must be one of enum values ('eu-central', 'us-east', 'us-west', 'us', 'global')")
        return value
