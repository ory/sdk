...
class CreateProjectBody(BaseModel):
    ...
    home_region: Optional[StrictStr] = Field(default=None, description="Home Region  The home region of the project. This is the region where the project will be created. eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest us US global Global")
