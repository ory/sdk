...
class Subscription(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if plan_changes_at (nullable) is None
        # and model_fields_set contains the field
        if self.plan_changes_at is None and "plan_changes_at" in self.model_fields_set:
            _dict['plan_changes_at'] = None
        ...
        # set to None if stripe_checkout_expires_at (nullable) is None
        # and model_fields_set contains the field
        if self.stripe_checkout_expires_at is None and "stripe_checkout_expires_at" in self.model_fields_set:
            _dict['stripe_checkout_expires_at'] = None
