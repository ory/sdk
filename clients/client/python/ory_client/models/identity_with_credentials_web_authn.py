...
class IdentityWithCredentialsWebAuthn(BaseModel):
    """
    Create Identity and Import WebAuthn Credentials
    """ # noqa: E501
    config: Optional[IdentityWithCredentialsWebAuthnConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": IdentityWithCredentialsWebAuthnConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
