...
class BatchCheckPermissionResult(BaseModel):
    ...
    """ # noqa: E501
    results: List[CheckPermissionResultWithError] = Field(description="An array of check results. The order aligns with the input order.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [CheckPermissionResultWithError.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
