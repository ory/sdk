...
class UpdateIdentityBody(BaseModel):
    ...
    external_id: Optional[StrictStr] = Field(default=None, description="ExternalID is an optional external ID of the identity. This is used to link the identity to an external system. If set, the external ID must be unique across all identities.")
    ...
    region: Optional[StrictStr] = Field(default=None, description="Region is the Ory Network region this identity is homed in. Optional; omit to leave the current region unchanged. eu-central EUCentral asia-northeast AsiaNorthEast us-east USEast us-west USWest eu EU asia Asia us US global Global")
    ...
    __properties: ClassVar[List[str]] = ["credentials", "external_id", "metadata_admin", "metadata_public", "region", "schema_id", "state", "traits"]
