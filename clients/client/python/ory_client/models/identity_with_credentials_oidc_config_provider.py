...
class IdentityWithCredentialsOidcConfigProvider(BaseModel):
    ...
    use_auto_link: Optional[StrictBool] = Field(default=None, description="If set, this credential allows the user to sign in using the OpenID Connect provider without setting the subject first.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["organization", "provider", "subject", "use_auto_link"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "use_auto_link": obj.get("use_auto_link")
        })
