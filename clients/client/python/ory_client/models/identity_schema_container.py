...
class IdentitySchemaContainer(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the Identity JSON Schema")
    var_schema: Optional[Dict[str, Any]] = Field(default=None, description="The actual Identity JSON Schema", alias="schema")
