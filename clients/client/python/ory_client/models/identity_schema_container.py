...
class IdentitySchemaContainer(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the Identity JSON Schema")
    var_schema: Dict[str, Any] = Field(description="The actual Identity JSON Schema", alias="schema")
