...
class DeviceAuthnIOSAttStmt(BaseModel):
    """
    ...
    """ # noqa: E501
    x5c: Optional[List[List[StrictInt]]] = Field(default=None, description="X5c is the leaf-first certificate chain encoded as base64(DER), per the JOSE convention defined in RFC 7515 §4.1.6.")
