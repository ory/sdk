...
CONTINUEWITH_ONE_OF_SCHEMAS = ["ContinueWithDeviceAuthnPinEntryUi", "ContinueWithRecoveryUi", "ContinueWithRedirectBrowserTo", "ContinueWithSetOrySessionToken", "ContinueWithSettingsUi", "ContinueWithVerificationUi"]
...
class ContinueWith(BaseModel):
    ...
    # data type: ContinueWithDeviceAuthnPinEntryUi
    oneof_schema_6_validator: Optional[ContinueWithDeviceAuthnPinEntryUi] = None
    actual_instance: Optional[Union[ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi]] = None
    one_of_schemas: Set[str] = { "ContinueWithDeviceAuthnPinEntryUi", "ContinueWithRecoveryUi", "ContinueWithRedirectBrowserTo", "ContinueWithSetOrySessionToken", "ContinueWithSettingsUi", "ContinueWithVerificationUi" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, ContinueWithRedirectBrowserTo):
            ...
            match += 1
        # validate data type: ContinueWithDeviceAuthnPinEntryUi
        if not isinstance(v, ContinueWithDeviceAuthnPinEntryUi):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ContinueWithDeviceAuthnPinEntryUi`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ContinueWith with oneOf schemas: ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ContinueWith with oneOf schemas: ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # check if data type is `ContinueWithDeviceAuthnPinEntryUi`
        if _data_type == "show_pin_entry_ui":
            instance.actual_instance = ContinueWithDeviceAuthnPinEntryUi.from_json(json_str)
            return instance
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into ContinueWithDeviceAuthnPinEntryUi
        try:
            instance.actual_instance = ContinueWithDeviceAuthnPinEntryUi.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ContinueWith with oneOf schemas: ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ContinueWith with oneOf schemas: ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ContinueWithDeviceAuthnPinEntryUi, ContinueWithRecoveryUi, ContinueWithRedirectBrowserTo, ContinueWithSetOrySessionToken, ContinueWithSettingsUi, ContinueWithVerificationUi]]:
