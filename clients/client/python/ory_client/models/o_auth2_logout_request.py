...
class OAuth2LogoutRequest(BaseModel):
    ...
    OAuth2LogoutRequest
    """ # noqa: E501
    challenge: Optional[StrictStr] = Field(default=None, description="Challenge is used to retrieve/accept/deny the logout request.")
    ...
    subject: Optional[StrictStr] = Field(default=None, description="Subject is the user for whom the logout was requested.")
