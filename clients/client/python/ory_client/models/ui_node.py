...
class UiNode(BaseModel):
    ...
    def group_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['default', 'password', 'oidc', 'profile', 'link', 'code', 'totp', 'lookup_secret', 'webauthn', 'passkey', 'identifier_first', 'captcha']):
            raise ValueError("must be one of enum values ('default', 'password', 'oidc', 'profile', 'link', 'code', 'totp', 'lookup_secret', 'webauthn', 'passkey', 'identifier_first', 'captcha')")
        return value
