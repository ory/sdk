...
class UpdateLoginFlowWithTotpMethod(BaseModel):
    ...
    method: StrictStr = Field(description="Method should be set to \"totp\" when logging in using the TOTP strategy.")
    totp_code: StrictStr = Field(description="The TOTP code.")
    ...
    __properties: ClassVar[List[str]] = ["csrf_token", "method", "totp_code", "transient_payload"]
