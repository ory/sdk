...
class Message(BaseModel):
    ...
    def template_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['recovery_invalid', 'recovery_valid', 'recovery_code_invalid', 'recovery_code_valid', 'verification_invalid', 'verification_valid', 'verification_code_invalid', 'verification_code_valid', 'stub', 'login_code_valid', 'registration_code_valid', 'verifiable_address_changed']):
            raise ValueError("must be one of enum values ('recovery_invalid', 'recovery_valid', 'recovery_code_invalid', 'recovery_code_valid', 'verification_invalid', 'verification_valid', 'verification_code_invalid', 'verification_code_valid', 'stub', 'login_code_valid', 'registration_code_valid', 'verifiable_address_changed')")
        return value
