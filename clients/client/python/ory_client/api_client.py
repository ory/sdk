...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/v1.0.0-alpha.0/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.list_courier_messages  # this is an instance of the class Endpoint
        api_instance.list_courier_messages()  # this invokes api_instance.list_courier_messages.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.list_courier_messages.callable or self.callable in this class
