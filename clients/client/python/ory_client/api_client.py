...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/v0.0.1-alpha.15/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_identity_admin  # this is an instance of the class Endpoint
        api_instance.create_identity_admin()  # this invokes api_instance.create_identity_admin.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_identity_admin.callable or self.callable in this class
