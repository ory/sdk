...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/v0.2.0-alpha.37/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.accept_consent_request  # this is an instance of the class Endpoint
        api_instance.accept_consent_request()  # this invokes api_instance.accept_consent_request.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.accept_consent_request.callable or self.callable in this class
