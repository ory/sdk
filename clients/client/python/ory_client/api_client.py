...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/v0.0.1-alpha.101/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = MetadataApi()
        api_instance.get_version  # this is an instance of the class Endpoint
        api_instance.get_version()  # this invokes api_instance.get_version.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_version.callable or self.callable in this class
