...
class V0alpha2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __admin_list_identity_sessions(
            self,
            id,
            **kwargs
        ):
        ...
        self.admin_list_identity_sessions = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__admin_list_identity_sessions
        )
        ...
        self.revoke_session = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/api/kratos/public/sessions/{id}',
        ...
        self.revoke_sessions = _Endpoint(
            settings={
