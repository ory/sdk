...
class OAuth2Api:
    ...
    @validate_call
    def delete_rotated_o_auth2_client_secrets(
        self,
        ...
        _param = self._delete_rotated_o_auth2_client_secrets_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_rotated_o_auth2_client_secrets_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="OAuth 2.0 Client ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_rotated_o_auth2_client_secrets_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="OAuth 2.0 Client ID")],
        _request_timeout: Union[
            None,
    ...
    def _delete_rotated_o_auth2_client_secrets_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/admin/clients/{id}/secrets/rotate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_o_auth2_consent_sessions(
        ...
        page_size: Annotated[Optional[Annotated[int, Field(le=500, strict=True, ge=1)]], Field(description="Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination).")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination).")] = None,
    ...
    @validate_call
    def rotate_o_auth2_client_secret(
        self,
        id: Annotated[StrictStr, Field(description="OAuth 2.0 Client ID")],
        rotate_o_auth2_client_secret_body: Optional[RotateOAuth2ClientSecretBody] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: OAuth 2.0 Client ID (required)
        :type id: str
        :param rotate_o_auth2_client_secret_body:
        :type rotate_o_auth2_client_secret_body: RotateOAuth2ClientSecretBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rotate_o_auth2_client_secret_serialize(
            id=id,
            rotate_o_auth2_client_secret_body=rotate_o_auth2_client_secret_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rotate_o_auth2_client_secret_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="OAuth 2.0 Client ID")],
        rotate_o_auth2_client_secret_body: Optional[RotateOAuth2ClientSecretBody] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def rotate_o_auth2_client_secret_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="OAuth 2.0 Client ID")],
        rotate_o_auth2_client_secret_body: Optional[RotateOAuth2ClientSecretBody] = None,
        _request_timeout: Union[
    ...
    def _rotate_o_auth2_client_secret_serialize(
        self,
        id,
        rotate_o_auth2_client_secret_body,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if rotate_o_auth2_client_secret_body is not None:
            _body_params = rotate_o_auth2_client_secret_body
