...
class ProjectApi:
    ...
    def create_project_api_key(
        ...
        create_project_api_key_body: Optional[CreateProjectApiKeyBody] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type project: str
        :param create_project_api_key_body:
        :type create_project_api_key_body: CreateProjectApiKeyBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_project_api_key_serialize(
            project=project,
            create_project_api_key_body=create_project_api_key_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_project_api_key_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if create_project_api_key_body is not None:
            _body_params = create_project_api_key_body
    ...
    def validate_opl(
        self,
        project_id: Annotated[StrictStr, Field(description="The project's ID.")],
        ...
        :param project_id: The project's ID. (required)
        :type project_id: str
        :param body:
        :type body: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._validate_opl_serialize(
            project_id=project_id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def validate_opl_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The project's ID.")],
        body: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def validate_opl_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The project's ID.")],
        body: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _validate_opl_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{project_id}/opl/validate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
