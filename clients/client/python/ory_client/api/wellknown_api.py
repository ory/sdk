...
class WellknownApi:
    ...
    def discover_json_web_keys(
        ...
        _param = self._discover_json_web_keys_serialize(
    ...
    @validate_call
    def discover_json_web_keys_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def discover_json_web_keys_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _discover_json_web_keys_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
