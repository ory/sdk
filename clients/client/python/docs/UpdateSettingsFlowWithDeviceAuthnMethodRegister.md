...
update_settings_flow_with_device_authn_method_register_instance = UpdateSettingsFlowWithDeviceAuthnMethodRegister.from_json(json)
# print the JSON string representation of the object
print(UpdateSettingsFlowWithDeviceAuthnMethodRegister.to_json())

# convert the object into a dict
update_settings_flow_with_device_authn_method_register_dict = update_settings_flow_with_device_authn_method_register_instance.to_dict()
# create an instance of UpdateSettingsFlowWithDeviceAuthnMethodRegister from a dict
update_settings_flow_with_device_authn_method_register_from_dict = UpdateSettingsFlowWithDeviceAuthnMethodRegister.from_dict(update_settings_flow_with_device_authn_method_register_dict)
```
