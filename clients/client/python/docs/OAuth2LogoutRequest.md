...
------------ | ------------- | ------------- | -------------
**challenge** | **str** | Challenge is used to retrieve/accept/deny the logout request. | [optional] 
...
**subject** | **str** | Subject is the user for whom the logout was requested. | [optional] 
