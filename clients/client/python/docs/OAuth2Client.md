...
**client_id** | **str** | ID is the id for this client.  The ID is autogenerated and immutable. | [optional] 
...
**password_grant_access_token_lifespan** | [**NullDuration**](NullDuration.md) |  | [optional] 
**password_grant_refresh_token_lifespan** | [**NullDuration**](NullDuration.md) |  | [optional] 
