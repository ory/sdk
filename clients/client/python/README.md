...
- Package version: v0.2.0-alpha.60
...
*V0alpha2Api* | [**admin_create_self_service_recovery_code**](docs/V0alpha2Api.md#admin_create_self_service_recovery_code) | **POST** /admin/recovery/code | Create a Recovery Link
