...
------------ | ------------- | ------------- | -------------
*APIKeysApi* | [**admin_batch_import_api_keys**](docs/APIKeysApi.md#admin_batch_import_api_keys) | **POST** /v2alpha1/admin/importedApiKeys:batchImport | Batch Import API Keys
...
*APIKeysApi* | [**admin_revoke_api_key**](docs/APIKeysApi.md#admin_revoke_api_key) | **POST** /v2alpha1/admin/apiKeys/{key_id}:revoke | Revoke API Key
