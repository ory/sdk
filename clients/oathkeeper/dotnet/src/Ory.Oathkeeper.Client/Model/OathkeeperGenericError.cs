...
namespace Ory.Oathkeeper.Client.Model
{
    ...
    public partial class OathkeeperGenericError : IEquatable<OathkeeperGenericError>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OathkeeperGenericError);
        }

        /// <summary>
        /// Returns true if OathkeeperGenericError instances are equal
        /// </summary>
        /// <param name="input">Instance of OathkeeperGenericError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OathkeeperGenericError input)
        {
            if (input == null)
            {
                return false;
