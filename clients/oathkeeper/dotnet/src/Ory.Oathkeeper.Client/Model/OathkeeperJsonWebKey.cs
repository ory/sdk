...
namespace Ory.Oathkeeper.Client.Model
{
    ...
    public partial class OathkeeperJsonWebKey : IEquatable<OathkeeperJsonWebKey>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OathkeeperJsonWebKey);
        }

        /// <summary>
        /// Returns true if OathkeeperJsonWebKey instances are equal
        /// </summary>
        /// <param name="input">Instance of OathkeeperJsonWebKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OathkeeperJsonWebKey input)
        {
            if (input == null)
            {
                return false;
