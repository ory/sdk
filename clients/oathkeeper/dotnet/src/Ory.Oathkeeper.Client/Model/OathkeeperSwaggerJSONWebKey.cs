...
namespace Ory.Oathkeeper.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "swaggerJSONWebKey")]
    public partial class OathkeeperSwaggerJSONWebKey : IEquatable<OathkeeperSwaggerJSONWebKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OathkeeperSwaggerJSONWebKey" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OathkeeperSwaggerJSONWebKey {\n");
        ...
        {
            return this.Equals(input as OathkeeperSwaggerJSONWebKey);
        }

        /// <summary>
        /// Returns true if OathkeeperSwaggerJSONWebKey instances are equal
        /// </summary>
        /// <param name="input">Instance of OathkeeperSwaggerJSONWebKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OathkeeperSwaggerJSONWebKey input)
        {
            if (input == null)
                return false;
