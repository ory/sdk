...
namespace Ory.Oathkeeper.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "swaggerJSONWebKeySet")]
    public partial class OathkeeperSwaggerJSONWebKeySet : IEquatable<OathkeeperSwaggerJSONWebKeySet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OathkeeperSwaggerJSONWebKeySet" /> class.
        /// </summary>
        ...
        public OathkeeperSwaggerJSONWebKeySet(List<OathkeeperSwaggerJSONWebKey> keys = default(List<OathkeeperSwaggerJSONWebKey>))
        {
            this.Keys = keys;
        ...
        public List<OathkeeperSwaggerJSONWebKey> Keys { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OathkeeperSwaggerJSONWebKeySet {\n");
        ...
        {
            return this.Equals(input as OathkeeperSwaggerJSONWebKeySet);
        }

        /// <summary>
        /// Returns true if OathkeeperSwaggerJSONWebKeySet instances are equal
        /// </summary>
        /// <param name="input">Instance of OathkeeperSwaggerJSONWebKeySet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OathkeeperSwaggerJSONWebKeySet input)
        {
            if (input == null)
                return false;
