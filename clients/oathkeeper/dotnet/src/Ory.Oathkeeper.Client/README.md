...
inputSpec: spec/oathkeeper/v26.2.0.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{0286FCF6-4C98-4E0D-9A3F-45D39BA737E6}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IApiApi>();
            IDecisionsApiResponse apiResponse = await api.DecisionsAsync("todo");
...
## Api Information
- appName: Ory Oathkeeper API
- appVersion: v26.2.0
- appDescription: Documentation for all of Ory Oathkeeper&#39;s APIs. 
