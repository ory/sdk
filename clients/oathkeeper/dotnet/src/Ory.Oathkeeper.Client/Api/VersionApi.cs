...
namespace Ory.Oathkeeper.Client.Api
{
    ...
    public interface IVersionApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<OathkeeperVersion> GetVersionAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<OathkeeperVersion>> GetVersionAsyncWithHttpInfo ();
    ...
    public partial class VersionApi : IVersionApi
    {
        ...
        /// <exception cref="Ory.Oathkeeper.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (OathkeeperVersion)</returns>
        public async System.Threading.Tasks.Task<Ory.Oathkeeper.Client.Client.ApiResponse<OathkeeperVersion>> GetVersionAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<OathkeeperVersion>("/version", localVarRequestOptions, this.Configuration);
