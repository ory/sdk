...
ORY Oathkeeper
- API version: v0.40.5
  - Build date: 2023-07-17T14:18:22.463112971Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "sh.ory.oathkeeper:oathkeeper-client:v0.40.5"
  }
```
...
* `target/oathkeeper-client-v0.40.5.jar`
* `target/lib/*.jar`
