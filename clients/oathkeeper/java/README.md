...
- API version: v0.0.0-alpha.46
  - Build date: 2021-08-24T07:01:14.730353007Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.46</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.46"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.46.jar`
* `target/lib/*.jar`
