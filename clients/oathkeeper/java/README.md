...
- API version: v0.0.0-alpha.42
  - Build date: 2021-08-23T19:47:41.269506447Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.42</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.42"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.42.jar`
* `target/lib/*.jar`
