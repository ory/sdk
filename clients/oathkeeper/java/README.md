...
ORY Oathkeeper
- API version: v0.40.6
  - Build date: 2023-07-18T10:27:23.143049421Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "sh.ory.oathkeeper:oathkeeper-client:v0.40.6"
  }
```
...
* `target/oathkeeper-client-v0.40.6.jar`
* `target/lib/*.jar`
