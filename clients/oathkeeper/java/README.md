...
- API version: v0.0.0-alpha.45
  - Build date: 2021-08-24T06:51:42.254040038Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.45</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.45"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.45.jar`
* `target/lib/*.jar`
