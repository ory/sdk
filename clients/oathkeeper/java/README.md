...
- API version: v0.38.25-beta.1
  - Build date: 2022-04-13T14:34:58.048125920Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.38.25-beta.1</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory.oathkeeper:oathkeeper-client:v0.38.25-beta.1"
  }
```
...
* `target/oathkeeper-client-v0.38.25-beta.1.jar`
* `target/lib/*.jar`
