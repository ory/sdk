...
- API version: v0.0.0-alpha.40
  - Build date: 2021-08-23T19:30:07.174342538Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.40</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.40"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.40.jar`
* `target/lib/*.jar`
