...
- API version: v0.0.0-alpha.44
  - Build date: 2021-08-23T20:04:36.649358713Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.44</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.44"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.44.jar`
* `target/lib/*.jar`
