...
- API version: v0.0.0-alpha.47
  - Build date: 2021-08-24T07:09:19.622095060Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.47</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.47"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.47.jar`
* `target/lib/*.jar`
