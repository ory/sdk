...
- API version: v0.0.0-alpha.55
  - Build date: 2021-08-24T11:28:44.213218031Z[Etc/UTC]
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.55"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.55.jar`
* `target/lib/*.jar`
