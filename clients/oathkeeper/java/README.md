...
- API version: v0.0.0-alpha.57
  - Build date: 2021-08-24T12:39:49.448987137Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.0-alpha.57</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.57"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.57.jar`
* `target/lib/*.jar`
