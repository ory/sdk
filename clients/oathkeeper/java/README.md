...
- API version: v0.0.0-alpha.43
  - Build date: 2021-08-23T19:49:34.862742882Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.43</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.43"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.43.jar`
* `target/lib/*.jar`
