...
- API version: v0.0.0-alpha.54
  - Build date: 2021-08-24T10:15:05.919453168Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.54</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.54"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.54.jar`
* `target/lib/*.jar`
