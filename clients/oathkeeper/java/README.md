...
ORY Oathkeeper
- API version: v0.40.4
  - Build date: 2023-07-13T09:49:01.522740587Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "sh.ory.oathkeeper:oathkeeper-client:v0.40.4"
  }
```
...
* `target/oathkeeper-client-v0.40.4.jar`
* `target/lib/*.jar`
