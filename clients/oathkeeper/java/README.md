...
- API version: v0.38.18-beta.1
  - Build date: 2022-02-03T09:31:09.121879663Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.38.18-beta.1</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.38.18-beta.1"
```
...
* `target/oathkeeper-client-v0.38.18-beta.1.jar`
* `target/lib/*.jar`
