...
- API version: v0.38.19-beta.1
  - Build date: 2022-02-04T19:13:45.364824864Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.38.19-beta.1</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.38.19-beta.1"
```
...
* `target/oathkeeper-client-v0.38.19-beta.1.jar`
* `target/lib/*.jar`
