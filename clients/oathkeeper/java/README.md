...
- API version: v0.0.0-alpha.41
  - Build date: 2021-08-23T19:42:44.018727686Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.41</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.41"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.41.jar`
* `target/lib/*.jar`
