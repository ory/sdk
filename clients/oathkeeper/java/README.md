...
- API version: v0.0.0-alpha.51
  - Build date: 2021-08-24T09:10:02.074721254Z[GMT]
...
<dependency>
  ...
  <version>v0.0.0-alpha.51</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.51"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.51.jar`
* `target/lib/*.jar`
