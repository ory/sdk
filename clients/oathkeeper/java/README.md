...
- API version: v0.38.10-beta.4
  - Build date: 2021-05-10T19:50:09.905536+02:00[Europe/Berlin]
...
<dependency>
  ...
  <version>v0.38.10-beta.4</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.38.10-beta.4"
```
...
* `target/oathkeeper-client-v0.38.10-beta.4.jar`
* `target/lib/*.jar`
