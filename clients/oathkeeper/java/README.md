...
- API version: v0.0.0-alpha.56
  - Build date: 2021-08-24T12:20:49.148495420Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.0.0-alpha.56</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.oathkeeper:oathkeeper-client:v0.0.0-alpha.56"
```
...
* `target/oathkeeper-client-v0.0.0-alpha.56.jar`
* `target/lib/*.jar`
