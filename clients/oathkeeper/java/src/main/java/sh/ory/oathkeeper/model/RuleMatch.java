...
public class RuleMatch {
   ...
   * @throws IOException if the JSON Element is invalid with respect to RuleMatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuleMatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
