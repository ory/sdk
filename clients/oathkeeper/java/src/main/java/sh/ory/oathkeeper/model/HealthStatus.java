...
public class HealthStatus {
  ...
  **/
   ...
   * @return the HealthStatus instance itself
   */
  public HealthStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, healthStatus.status)&&
        Objects.equals(this.additionalProperties, healthStatus.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HealthStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HealthStatus>() {
           ...
           public HealthStatus read(JsonReader in) throws IOException {
             ...
             HealthStatus instance = thisAdapter.fromJsonTree(jsonObj);
