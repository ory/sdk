...
# Unit tests for OryHydraClient::SwaggerJSONWebKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SwaggerJSONWebKey' do
  before do
  ...
  describe 'test an instance of SwaggerJSONWebKey' do
    it 'should create an instance of SwaggerJSONWebKey' do
      expect(@instance).to be_instance_of(OryHydraClient::SwaggerJSONWebKey)
    end
  end
