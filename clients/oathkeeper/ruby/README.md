...
```shell
gem install ./ory-oathkeeper-client-v0.0.0-alpha.45.gem
```

(for development, run `gem install --dev ./ory-oathkeeper-client-v0.0.0-alpha.45.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ory-oathkeeper-client', '~> v0.0.0-alpha.45'
