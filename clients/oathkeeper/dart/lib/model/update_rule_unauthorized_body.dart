...
class UpdateRuleUnauthorizedBody {
  /// Returns a new [UpdateRuleUnauthorizedBody] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdateRuleUnauthorizedBody &&
     other.code == code &&
  ...
  @override
  String toString() => 'UpdateRuleUnauthorizedBody[code=$code, details=$details, message=$message, reason=$reason, request=$request, status=$status]';
  ...
  /// Returns a new [UpdateRuleUnauthorizedBody] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static UpdateRuleUnauthorizedBody fromJson(Map<String, dynamic> json) => json == null
    ? null
    : UpdateRuleUnauthorizedBody(
        code: json[r'code'],
