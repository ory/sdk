...
class SwaggerJSONWebKey {
  /// Returns a new [SwaggerJSONWebKey] instance.
  SwaggerJSONWebKey({
    this.alg,
    this.crv,
    this.d,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SwaggerJSONWebKey &&
     other.alg == alg &&
     other.crv == crv &&
     other.d == d &&
     other.dp == dp &&
  ...
  @override
  String toString() => 'SwaggerJSONWebKey[alg=$alg, crv=$crv, d=$d, dp=$dp, dq=$dq, e=$e, k=$k, kid=$kid, kty=$kty, n=$n, p=$p, q=$q, qi=$qi, use=$use, x=$x, x5c=$x5c, y=$y]';
  ...
  /// Returns a new [SwaggerJSONWebKey] instance and imports its values from
  /// [json] if it's non-null, null if [json] is null.
  static SwaggerJSONWebKey fromJson(Map<String, dynamic> json) => json == null
    ? null
    : SwaggerJSONWebKey(
        alg: json[r'alg'],
        crv: json[r'crv'],
