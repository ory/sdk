...
from ory_oathkeeper_client import rest
from ory_oathkeeper_client.configuration import Configuration
from ory_oathkeeper_client.exceptions import ApiTypeError, ApiValueError, ApiException
from ory_oathkeeper_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/v0.0.0-alpha.38/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ApiApi()
        api_instance.decisions  # this is an instance of the class Endpoint
        api_instance.decisions()  # this invokes api_instance.decisions.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.decisions.callable or self.callable in this class
