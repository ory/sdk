...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of ory_oathkeeper_client.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = ory_oathkeeper_client.Configuration(
    ...
    Note you can use the constants defined in the ory_oathkeeper_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = ory_oathkeeper_client.Configuration(
        signing_info = ory_oathkeeper_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: v0.38.1-beta.1".\
