...
class UpdateRuleNotFound(object):
    ...
    @property
    def payload(self):
        """Gets the payload of this UpdateRuleNotFound.  # noqa: E501


        :return: The payload of this UpdateRuleNotFound.  # noqa: E501
        :rtype: UpdateRuleNotFoundBody
        """
        return self._payload

    @payload.setter
    def payload(self, payload):
        """Sets the payload of this UpdateRuleNotFound.


        :param payload: The payload of this UpdateRuleNotFound.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRuleNotFound):
            return False
