...
class SwaggerGetRuleParameters(object):
    ...
    @property
    def id(self):
        """Gets the id of this SwaggerGetRuleParameters.  # noqa: E501

        in: path  # noqa: E501

        :return: The id of this SwaggerGetRuleParameters.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SwaggerGetRuleParameters.

        in: path  # noqa: E501

        :param id: The id of this SwaggerGetRuleParameters.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SwaggerGetRuleParameters):
            return False
