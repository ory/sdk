...
class ListRulesInternalServerError(object):
    ...
    @property
    def payload(self):
        """Gets the payload of this ListRulesInternalServerError.  # noqa: E501


        :return: The payload of this ListRulesInternalServerError.  # noqa: E501
        :rtype: ListRulesInternalServerErrorBody
        """
        return self._payload

    @payload.setter
    def payload(self, payload):
        """Sets the payload of this ListRulesInternalServerError.


        :param payload: The payload of this ListRulesInternalServerError.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRulesInternalServerError):
            return False
