...
class DecisionsUnauthorized(object):
    ...
    @property
    def payload(self):
        """Gets the payload of this DecisionsUnauthorized.  # noqa: E501


        :return: The payload of this DecisionsUnauthorized.  # noqa: E501
        :rtype: DecisionsUnauthorizedBody
        """
        return self._payload

    @payload.setter
    def payload(self, payload):
        """Sets the payload of this DecisionsUnauthorized.


        :param payload: The payload of this DecisionsUnauthorized.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DecisionsUnauthorized):
            return False
