...
class SwaggerHealthStatus(object):
    ...
    def __init__(self, status=None, local_vars_configuration=None):  # noqa: E501
        """SwaggerHealthStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this SwaggerHealthStatus.  # noqa: E501

        Status always contains \"ok\".  # noqa: E501

        :return: The status of this SwaggerHealthStatus.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this SwaggerHealthStatus.

        Status always contains \"ok\".  # noqa: E501

        :param status: The status of this SwaggerHealthStatus.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SwaggerHealthStatus):
            return False
