...
from ory_oathkeeper_client.models.health_not_ready_status import HealthNotReadyStatus  # noqa: E501
...
class TestHealthNotReadyStatus(unittest.TestCase):
    ...
    def testHealthNotReadyStatus(self):
        ...
        # model = ory_oathkeeper_client.models.health_not_ready_status.HealthNotReadyStatus()  # noqa: E501
        pass
