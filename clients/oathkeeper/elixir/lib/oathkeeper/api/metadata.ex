...
defmodule Oathkeeper.Api.Metadata do
  @moduledoc """
  ...
  {:ok, Oathkeeper.Model.InlineResponse2001.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec get_version(Tesla.Env.client, keyword()) :: {:ok, Oathkeeper.Model.InlineResponse2001.t} | {:error, Tesla.Env.t}
  def get_version(connection, _opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %Oathkeeper.Model.InlineResponse2001{}}
    ])
  end
  ...
  {:ok, Oathkeeper.Model.InlineResponse200.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec is_alive(Tesla.Env.client, keyword()) :: {:ok, Oathkeeper.Model.InlineResponse200.t} | {:ok, Oathkeeper.Model.GenericError.t} | {:error, Tesla.Env.t}
  def is_alive(connection, _opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %Oathkeeper.Model.InlineResponse200{}},
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec is_ready(Tesla.Env.client, keyword()) :: {:ok, Oathkeeper.Model.InlineResponse200.t} | {:ok, Oathkeeper.Model.InlineResponse503.t} | {:error, Tesla.Env.t}
  def is_ready(connection, _opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %Oathkeeper.Model.InlineResponse200{}},
      { 503, %Oathkeeper.Model.InlineResponse503{}}
    ])
  end
end
