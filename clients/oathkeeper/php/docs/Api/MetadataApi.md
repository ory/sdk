...
```php
getVersion(): \Ory\Oathkeeper\Client\Model\InlineResponse2001
```
...
[**\Ory\Oathkeeper\Client\Model\InlineResponse2001**](../Model/InlineResponse2001.md)
...
```php
isAlive(): \Ory\Oathkeeper\Client\Model\InlineResponse200
```
...
[**\Ory\Oathkeeper\Client\Model\InlineResponse200**](../Model/InlineResponse200.md)
...
```php
isReady(): \Ory\Oathkeeper\Client\Model\InlineResponse200
```
