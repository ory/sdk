# Ory\Oathkeeper\Client\MetadataApi
...
```php
getVersion(): \Ory\Oathkeeper\Client\Model\GetVersion200Response
```
...
$apiInstance = new Ory\Oathkeeper\Client\Api\MetadataApi(
...
[**\Ory\Oathkeeper\Client\Model\GetVersion200Response**](../Model/GetVersion200Response.md)
...
```php
isAlive(): \Ory\Oathkeeper\Client\Model\IsAlive200Response
```
...
[**\Ory\Oathkeeper\Client\Model\IsAlive200Response**](../Model/IsAlive200Response.md)
...
```php
isReady(): \Ory\Oathkeeper\Client\Model\IsAlive200Response
```
