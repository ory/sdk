...
// ContextValidate validate this create rule unauthorized based on the context it is used
func (m *CreateRuleUnauthorized) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CreateRuleUnauthorized) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
