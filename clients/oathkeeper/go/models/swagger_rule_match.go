...
// ContextValidate validates this swagger rule match based on context it is used
func (m *SwaggerRuleMatch) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
