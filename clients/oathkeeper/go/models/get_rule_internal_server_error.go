...
//
// swagger:model GetRuleInternalServerError
...
func (m *GetRuleInternalServerError) validatePayload(formats strfmt.Registry) error {
...
// ContextValidate validate this get rule internal server error based on the context it is used
func (m *GetRuleInternalServerError) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetRuleInternalServerError) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetRuleInternalServerError) UnmarshalBinary(b []byte) error {
	var res GetRuleInternalServerError
