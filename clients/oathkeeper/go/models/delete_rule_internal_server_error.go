...
// ContextValidate validate this delete rule internal server error based on the context it is used
func (m *DeleteRuleInternalServerError) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteRuleInternalServerError) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
