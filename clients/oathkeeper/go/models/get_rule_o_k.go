...
// ContextValidate validate this get rule o k based on the context it is used
func (m *GetRuleOK) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetRuleOK) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
