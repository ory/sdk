...
// ContextValidate validates this judge not found body based on context it is used
func (m *JudgeNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
