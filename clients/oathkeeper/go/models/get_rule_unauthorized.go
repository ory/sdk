...
// ContextValidate validate this get rule unauthorized based on the context it is used
func (m *GetRuleUnauthorized) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetRuleUnauthorized) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
