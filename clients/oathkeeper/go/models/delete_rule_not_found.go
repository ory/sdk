...
// ContextValidate validate this delete rule not found based on the context it is used
func (m *DeleteRuleNotFound) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteRuleNotFound) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
