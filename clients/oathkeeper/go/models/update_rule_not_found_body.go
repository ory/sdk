...
// ContextValidate validates this update rule not found body based on context it is used
func (m *UpdateRuleNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
