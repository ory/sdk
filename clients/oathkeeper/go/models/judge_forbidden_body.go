...
// ContextValidate validates this judge forbidden body based on context it is used
func (m *JudgeForbiddenBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
