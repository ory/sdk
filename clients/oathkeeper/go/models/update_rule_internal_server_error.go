...
//
// swagger:model UpdateRuleInternalServerError
...
func (m *UpdateRuleInternalServerError) validatePayload(formats strfmt.Registry) error {
...
// ContextValidate validate this update rule internal server error based on the context it is used
func (m *UpdateRuleInternalServerError) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateRuleInternalServerError) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateRuleInternalServerError) UnmarshalBinary(b []byte) error {
	var res UpdateRuleInternalServerError
