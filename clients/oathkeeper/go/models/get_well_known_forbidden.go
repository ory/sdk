...
// ContextValidate validate this get well known forbidden based on the context it is used
func (m *GetWellKnownForbidden) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetWellKnownForbidden) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
