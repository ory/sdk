...
// ContextValidate validate this list rules internal server error based on the context it is used
func (m *ListRulesInternalServerError) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ListRulesInternalServerError) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
