...
//
// swagger:model JudgeInternalServerError
...
func (m *JudgeInternalServerError) validatePayload(formats strfmt.Registry) error {
...
// ContextValidate validate this judge internal server error based on the context it is used
func (m *JudgeInternalServerError) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *JudgeInternalServerError) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JudgeInternalServerError) UnmarshalBinary(b []byte) error {
	var res JudgeInternalServerError
