...
// ContextValidate validates this get well known forbidden body based on context it is used
func (m *GetWellKnownForbiddenBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
