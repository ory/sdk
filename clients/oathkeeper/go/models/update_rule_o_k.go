...
// ContextValidate validate this update rule o k based on the context it is used
func (m *UpdateRuleOK) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateRuleOK) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
