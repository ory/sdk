...
// ContextValidate validate this create rule internal server error based on the context it is used
func (m *CreateRuleInternalServerError) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CreateRuleInternalServerError) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
