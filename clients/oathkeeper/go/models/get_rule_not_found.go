...
// ContextValidate validate this get rule not found based on the context it is used
func (m *GetRuleNotFound) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetRuleNotFound) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
