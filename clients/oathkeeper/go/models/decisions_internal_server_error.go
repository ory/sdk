...
// ContextValidate validate this decisions internal server error based on the context it is used
func (m *DecisionsInternalServerError) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DecisionsInternalServerError) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
