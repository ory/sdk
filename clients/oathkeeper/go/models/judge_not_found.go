...
// ContextValidate validate this judge not found based on the context it is used
func (m *JudgeNotFound) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *JudgeNotFound) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
