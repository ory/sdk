...
// ContextValidate validate this update rule forbidden based on the context it is used
func (m *UpdateRuleForbidden) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateRuleForbidden) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
