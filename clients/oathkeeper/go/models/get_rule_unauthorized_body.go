...
// ContextValidate validates this get rule unauthorized body based on context it is used
func (m *GetRuleUnauthorizedBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
