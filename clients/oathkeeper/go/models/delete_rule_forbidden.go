...
// ContextValidate validate this delete rule forbidden based on the context it is used
func (m *DeleteRuleForbidden) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteRuleForbidden) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
