...
// ContextValidate validates this update rule unauthorized body based on context it is used
func (m *UpdateRuleUnauthorizedBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
