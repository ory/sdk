...
// ContextValidate validate this decisions forbidden based on the context it is used
func (m *DecisionsForbidden) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DecisionsForbidden) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
