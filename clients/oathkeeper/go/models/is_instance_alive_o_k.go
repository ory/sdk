...
// ContextValidate validate this is instance alive o k based on the context it is used
func (m *IsInstanceAliveOK) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IsInstanceAliveOK) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
