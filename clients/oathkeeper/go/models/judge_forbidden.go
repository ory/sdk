...
// ContextValidate validate this judge forbidden based on the context it is used
func (m *JudgeForbidden) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *JudgeForbidden) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
