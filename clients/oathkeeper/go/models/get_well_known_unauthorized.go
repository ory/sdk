...
// ContextValidate validate this get well known unauthorized based on the context it is used
func (m *GetWellKnownUnauthorized) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetWellKnownUnauthorized) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
