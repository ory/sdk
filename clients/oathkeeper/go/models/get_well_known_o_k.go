...
// ContextValidate validate this get well known o k based on the context it is used
func (m *GetWellKnownOK) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetWellKnownOK) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
