...
// ContextValidate validate this list rules forbidden based on the context it is used
func (m *ListRulesForbidden) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ListRulesForbidden) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
