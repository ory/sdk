...
// ContextValidate validates this judge internal server error body based on context it is used
func (m *JudgeInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
