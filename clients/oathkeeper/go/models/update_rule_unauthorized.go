...
// ContextValidate validate this update rule unauthorized based on the context it is used
func (m *UpdateRuleUnauthorized) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateRuleUnauthorized) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
