...
// ContextValidate validate this is instance alive internal server error based on the context it is used
func (m *IsInstanceAliveInternalServerError) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IsInstanceAliveInternalServerError) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
