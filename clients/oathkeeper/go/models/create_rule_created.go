...
// ContextValidate validate this create rule created based on the context it is used
func (m *CreateRuleCreated) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CreateRuleCreated) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
