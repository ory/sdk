...
//
// swagger:model ListRulesUnauthorized
...
func (m *ListRulesUnauthorized) validatePayload(formats strfmt.Registry) error {
...
// ContextValidate validate this list rules unauthorized based on the context it is used
func (m *ListRulesUnauthorized) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ListRulesUnauthorized) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
