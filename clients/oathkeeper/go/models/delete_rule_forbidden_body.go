...
// ContextValidate validates this delete rule forbidden body based on context it is used
func (m *DeleteRuleForbiddenBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
