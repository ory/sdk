...
// ContextValidate validate this update rule not found based on the context it is used
func (m *UpdateRuleNotFound) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateRuleNotFound) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
