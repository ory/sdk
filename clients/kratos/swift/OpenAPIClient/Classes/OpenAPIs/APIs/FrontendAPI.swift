...
open class FrontendAPI {
    ...
    open class func createBrowserLoginFlow(refresh: Bool? = nil, aal: String? = nil, returnTo: String? = nil, cookie: String? = nil, loginChallenge: String? = nil, organization: String? = nil, via: String? = nil, identitySchema: String? = nil) async throws -> LoginFlow {
        return try await createBrowserLoginFlowWithRequestBuilder(refresh: refresh, aal: aal, returnTo: returnTo, cookie: cookie, loginChallenge: loginChallenge, organization: organization, via: via, identitySchema: identitySchema).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createBrowserLogoutFlow(cookie: String? = nil, returnTo: String? = nil) async throws -> LogoutFlow {
        return try await createBrowserLogoutFlowWithRequestBuilder(cookie: cookie, returnTo: returnTo).execute().body
    }
    ...
    /**
     ...
     - parameter returnTo: (query) The URL to return the browser to after the flow was completed. (optional)
     - parameter skipSettings: (query) Skip redirection to the settings UI after the recovery flow was completed. Instead, the user will be redirected to the URL specified in &#x60;return_to&#x60; query parameter or the default return URL if &#x60;return_to&#x60; is not set. (optional)
     - returns: RecoveryFlow
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createBrowserRecoveryFlow(returnTo: String? = nil, skipSettings: String? = nil) async throws -> RecoveryFlow {
        return try await createBrowserRecoveryFlowWithRequestBuilder(returnTo: returnTo, skipSettings: skipSettings).execute().body
    }
     ...
     */
    open class func createBrowserRecoveryFlowWithRequestBuilder(returnTo: String? = nil, skipSettings: String? = nil) -> RequestBuilder<RecoveryFlow> {
        ...
        localVariableUrlComponents?.queryItems = APIHelper.mapValuesToQueryItems([
            "return_to": (wrappedValue: returnTo?.encodeToJSON(), isExplode: true),
            "skip_settings": (wrappedValue: skipSettings?.encodeToJSON(), isExplode: true),
        ])
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createBrowserRegistrationFlow(returnTo: String? = nil, loginChallenge: String? = nil, afterVerificationReturnTo: String? = nil, organization: String? = nil, identitySchema: String? = nil) async throws -> RegistrationFlow {
        return try await createBrowserRegistrationFlowWithRequestBuilder(returnTo: returnTo, loginChallenge: loginChallenge, afterVerificationReturnTo: afterVerificationReturnTo, organization: organization, identitySchema: identitySchema).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createFedcmFlow() async throws -> CreateFedcmFlowResponse {
        return try await createFedcmFlowWithRequestBuilder().execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createNativeLoginFlow(refresh: Bool? = nil, aal: String? = nil, xSessionToken: String? = nil, returnSessionTokenExchangeCode: Bool? = nil, returnTo: String? = nil, organization: String? = nil, via: String? = nil, identitySchema: String? = nil) async throws -> LoginFlow {
        return try await createNativeLoginFlowWithRequestBuilder(refresh: refresh, aal: aal, xSessionToken: xSessionToken, returnSessionTokenExchangeCode: returnSessionTokenExchangeCode, returnTo: returnTo, organization: organization, via: via, identitySchema: identitySchema).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createNativeRegistrationFlow(returnSessionTokenExchangeCode: Bool? = nil, returnTo: String? = nil, organization: String? = nil, identitySchema: String? = nil) async throws -> RegistrationFlow {
        return try await createNativeRegistrationFlowWithRequestBuilder(returnSessionTokenExchangeCode: returnSessionTokenExchangeCode, returnTo: returnTo, organization: organization, identitySchema: identitySchema).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createNativeVerificationFlow(returnTo: String? = nil) async throws -> VerificationFlow {
        return try await createNativeVerificationFlowWithRequestBuilder(returnTo: returnTo).execute().body
    }
    ...
    /**
     ...
     - parameter id: (query) ID of the test login flow to delete. 
     - parameter cookie: (header) HTTP Cookies. A captured test flow requires the ory_kratos_test_flow cookie set by the OIDC callback; a flow still in the initial choose-method state does not. (optional)
     - returns: Void
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func deleteTestLoginFlow(id: String, cookie: String? = nil) async throws {
        return try await deleteTestLoginFlowWithRequestBuilder(id: id, cookie: cookie).execute().body
    }
     ...
     */
    open class func deleteTestLoginFlowWithRequestBuilder(id: String, cookie: String? = nil) -> RequestBuilder<Void> {
        let localVariablePath = "/self-service/login/test"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func exchangeSessionToken(initCode: String, returnToCode: String) async throws -> SuccessfulNativeLogin {
        return try await exchangeSessionTokenWithRequestBuilder(initCode: initCode, returnToCode: returnToCode).execute().body
    }
    ...
    /**
     ...
     - parameter pageSize: (query) Page Size  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). (optional, default to 250)
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func listMySessions(perPage: Int64? = nil, page: Int64? = nil, pageSize: Int64? = nil, pageToken: String? = nil, xSessionToken: String? = nil, cookie: String? = nil) async throws -> [Session] {
        return try await listMySessionsWithRequestBuilder(perPage: perPage, page: page, pageSize: pageSize, pageToken: pageToken, xSessionToken: xSessionToken, cookie: cookie).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func toSession(xSessionToken: String? = nil, cookie: String? = nil, tokenizeAs: String? = nil) async throws -> Session {
        return try await toSessionWithRequestBuilder(xSessionToken: xSessionToken, cookie: cookie, tokenizeAs: tokenizeAs).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func updateFedcmFlow(updateFedcmFlowBody: UpdateFedcmFlowBody) async throws -> SuccessfulNativeLogin {
        return try await updateFedcmFlowWithRequestBuilder(updateFedcmFlowBody: updateFedcmFlowBody).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func updateLogoutFlow(token: String? = nil, returnTo: String? = nil, cookie: String? = nil) async throws {
        return try await updateLogoutFlowWithRequestBuilder(token: token, returnTo: returnTo, cookie: cookie).execute().body
    }
