...
open class IdentityAPI {
    ...
    /**
     ...
     - parameter createTestLoginFlowBody: (body)  
     - returns: LoginFlow
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func createTestLoginFlow(createTestLoginFlowBody: CreateTestLoginFlowBody) async throws -> LoginFlow {
        return try await createTestLoginFlowWithRequestBuilder(createTestLoginFlowBody: createTestLoginFlowBody).execute().body
    }
     ...
     */
    open class func createTestLoginFlowWithRequestBuilder(createTestLoginFlowBody: CreateTestLoginFlowBody) -> RequestBuilder<LoginFlow> {
        let localVariablePath = "/admin/test-login-flows"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: createTestLoginFlowBody)
    ...
    /**
     ...
     - parameter manageSessionsBody: (body)  
     - returns: ManageSessionsResponse
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func manageSessions(manageSessionsBody: ManageSessionsBody) async throws -> ManageSessionsResponse {
        return try await manageSessionsWithRequestBuilder(manageSessionsBody: manageSessionsBody).execute().body
    }
    ...
    /**
     ...
     - API Key:
       ...
       - name: oryAccessToken
     - parameter manageSessionsBody: (body)  
     - returns: RequestBuilder<ManageSessionsResponse> 
     */
    open class func manageSessionsWithRequestBuilder(manageSessionsBody: ManageSessionsBody) -> RequestBuilder<ManageSessionsResponse> {
        let localVariablePath = "/admin/sessions"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: manageSessionsBody)
        ...
        let localVariableRequestBuilder: RequestBuilder<ManageSessionsResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
