...
public struct CreateIdentityBody: Codable, JSONEncodable, Hashable {
    ...
    public init(credentials: IdentityWithCredentials? = nil, externalId: String? = nil, metadataAdmin: AnyCodable? = nil, metadataPublic: AnyCodable? = nil, organizationId: String? = nil, recoveryAddresses: [RecoveryIdentityAddress]? = nil, region: Region? = nil, schemaId: String, state: State? = nil, traits: AnyCodable, verifiableAddresses: [VerifiableIdentityAddress]? = nil) {
