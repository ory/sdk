...
public struct Identity: Codable, JSONEncodable, Hashable {
    ...
    public init(createdAt: Date? = nil, credentials: [String: IdentityCredentials]? = nil, externalId: String? = nil, id: String, metadataAdmin: AnyCodable? = nil, metadataPublic: AnyCodable? = nil, organizationId: String? = nil, recoveryAddresses: [RecoveryIdentityAddress]? = nil, region: Region? = nil, schemaId: String, schemaUrl: String, state: State? = nil, stateChangedAt: Date? = nil, traits: AnyCodable?, updatedAt: Date? = nil, verifiableAddresses: [VerifiableIdentityAddress]? = nil) {
