...
public struct LoginFlow: Codable, JSONEncodable, Hashable {
    ...
    public var testContext: LoginFlowTestContext?
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(testContext, forKey: .testContext)
