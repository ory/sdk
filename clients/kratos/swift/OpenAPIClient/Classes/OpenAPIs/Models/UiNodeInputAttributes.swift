...
public struct UiNodeInputAttributes: Codable, JSONEncodable, Hashable {
    ...
    public var options: [UiNodeInputAttributesOption]?
    /** The input's pattern. */
    ...
    public init(autocomplete: Autocomplete? = nil, disabled: Bool, label: UiText? = nil, maxlength: Int64? = nil, name: String, nodeType: NodeType, onclick: String? = nil, onclickTrigger: OnclickTrigger? = nil, onload: String? = nil, onloadTrigger: OnloadTrigger? = nil, options: [UiNodeInputAttributesOption]? = nil, pattern: String? = nil, _required: Bool? = nil, type: ModelType, value: AnyCodable? = nil) {
