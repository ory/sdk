...
public struct UpdateRegistrationFlowWithSamlMethod: Codable, JSONEncodable, Hashable {
    ...
    public init(csrfToken: String? = nil, method: String, provider: String, traits: AnyCodable? = nil, transientPayload: AnyCodable? = nil) {
