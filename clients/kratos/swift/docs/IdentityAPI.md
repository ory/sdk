...
let patchIdentitiesBody = patchIdentitiesBody(identities: [identityPatch(create: createIdentityBody(credentials: identityWithCredentials(lookupSecret: AdminIdentityImportCredentialsLookupSecret(config: AdminIdentityImportCredentialsLookupSecretConfig(codes: [identityCredentialsLookupSecretCode(code: "code_example", usedAt: Date())])), oidc: identityWithCredentialsOidc(config: identityWithCredentialsOidcConfig(providers: [identityWithCredentialsOidcConfigProvider(organization: "organization_example", provider: "provider_example", subject: "subject_example", useAutoLink: false)])), passkey: identityWithCredentialsPasskey(config: identityWithCredentialsPasskeyConfig(credentials: [identityCredentialsWebAuthn(addedAt: Date(), attestation: identityCredentialsWebAuthnAttestation(authenticatorData: [123], clientDataJSON: [123], clientDataHash: [123], object: [123], publicKeyAlgorithm: 123), attestationType: "attestationType_example", authenticator: identityCredentialsWebAuthnAuthenticator(aaguid: [123], cloneWarning: false, signCount: 123), displayName: "displayName_example", flags: identityCredentialsWebAuthnFlags(backupEligible: false, backupState: false, userPresent: false, userVerified: false), id: [123], isPasswordless: false, publicKey: [123], transport: ["transport_example"])], userHandle: [123])), password: identityWithCredentialsPassword(config: identityWithCredentialsPasswordConfig(hashedPassword: "hashedPassword_example", password: "password_example", usePasswordMigrationHook: false)), saml: identityWithCredentialsSaml(config: identityWithCredentialsSamlConfig(providers: [identityWithCredentialsSamlConfigProvider(organization: "organization_example", provider: "provider_example", subject: "subject_example")])), totp: identityWithCredentialsTotp(config: identityWithCredentialsTotpConfig(totpUrl: "totpUrl_example")), webauthn: identityWithCredentialsWebAuthn(config: identityWithCredentialsWebAuthnConfig(credentials: [nil], userHandle: [123]))), externalId: "externalId_example", metadataAdmin: 123, metadataPublic: 123, organizationId: "organizationId_example", recoveryAddresses: [recoveryIdentityAddress(breakGlassForOrganization: "breakGlassForOrganization_example", createdAt: Date(), id: "id_example", updatedAt: Date(), value: "value_example", via: "via_example")], region: "region_example", schemaId: "schemaId_example", state: "state_example", traits: 123, verifiableAddresses: [verifiableIdentityAddress(createdAt: Date(), id: "id_example", status: "status_example", updatedAt: Date(), value: "value_example", verified: true, verifiedAt: Date(), via: "via_example")]), patchId: "patchId_example")]) // PatchIdentitiesBody |  (optional)
...
# **createTestLoginFlow**
```swift
    open class func createTestLoginFlow(createTestLoginFlowBody: CreateTestLoginFlowBody, completion: @escaping (_ data: LoginFlow?, _ error: Error?) -> Void)
```
...
let createTestLoginFlowBody = createTestLoginFlowBody(providerId: "providerId_example") // CreateTestLoginFlowBody | 

// Create a test OIDC login flow
IdentityAPI.createTestLoginFlow(createTestLoginFlowBody: createTestLoginFlowBody) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
let pageSize = 987 // Int64 | Page Size  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). (optional) (default to 250)
let pageToken = "pageToken_example" // String | Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). (optional)
 ...
 **pageSize** | **Int64** | Page Size  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). | [optional] [default to 250]
...
let pageSize = 987 // Int64 | Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). (optional) (default to 250)
let pageToken = "pageToken_example" // String | Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). (optional)
let active = true // Bool | Active is a boolean flag that filters out sessions based on the state. If no value is provided, all sessions are returned. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pageSize** | **Int64** | Items per Page  This is the number of items per page to return. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). | [optional] [default to 250]
 **pageToken** | **String** | Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.com/docs/ecosystem/api-design#pagination). | [optional] 
 **active** | **Bool** | Active is a boolean flag that filters out sessions based on the state. If no value is provided, all sessions are returned. | [optional] 
...
# **manageSessions**
```swift
    open class func manageSessions(manageSessionsBody: ManageSessionsBody, completion: @escaping (_ data: ManageSessionsResponse?, _ error: Error?) -> Void)
```
...
let manageSessionsBody = manageSessionsBody(action: "action_example", identities: ["identities_example"], sessions: ["sessions_example"]) // ManageSessionsBody | 

// Manage sessions in bulk
IdentityAPI.manageSessions(manageSessionsBody: manageSessionsBody) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
let id = "id_example" // String | ID must be set to the ID of identity you want to update
let updateIdentityBody = updateIdentityBody(credentials: identityWithCredentials(lookupSecret: AdminIdentityImportCredentialsLookupSecret(config: AdminIdentityImportCredentialsLookupSecretConfig(codes: [identityCredentialsLookupSecretCode(code: "code_example", usedAt: Date())])), oidc: identityWithCredentialsOidc(config: identityWithCredentialsOidcConfig(providers: [identityWithCredentialsOidcConfigProvider(organization: "organization_example", provider: "provider_example", subject: "subject_example", useAutoLink: false)])), passkey: identityWithCredentialsPasskey(config: identityWithCredentialsPasskeyConfig(credentials: [identityCredentialsWebAuthn(addedAt: Date(), attestation: identityCredentialsWebAuthnAttestation(authenticatorData: [123], clientDataJSON: [123], clientDataHash: [123], object: [123], publicKeyAlgorithm: 123), attestationType: "attestationType_example", authenticator: identityCredentialsWebAuthnAuthenticator(aaguid: [123], cloneWarning: false, signCount: 123), displayName: "displayName_example", flags: identityCredentialsWebAuthnFlags(backupEligible: false, backupState: false, userPresent: false, userVerified: false), id: [123], isPasswordless: false, publicKey: [123], transport: ["transport_example"])], userHandle: [123])), password: identityWithCredentialsPassword(config: identityWithCredentialsPasswordConfig(hashedPassword: "hashedPassword_example", password: "password_example", usePasswordMigrationHook: false)), saml: identityWithCredentialsSaml(config: identityWithCredentialsSamlConfig(providers: [identityWithCredentialsSamlConfigProvider(organization: "organization_example", provider: "provider_example", subject: "subject_example")])), totp: identityWithCredentialsTotp(config: identityWithCredentialsTotpConfig(totpUrl: "totpUrl_example")), webauthn: identityWithCredentialsWebAuthn(config: identityWithCredentialsWebAuthnConfig(credentials: [nil], userHandle: [123]))), externalId: "externalId_example", metadataAdmin: 123, metadataPublic: 123, region: "region_example", schemaId: "schemaId_example", state: "state_example", traits: 123) // UpdateIdentityBody |  (optional)
