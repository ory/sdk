 ...
 * @export
 */
export type UpdateVerificationFlowBody = UpdateVerificationFlowWithLinkMethod;
...
export const CourierApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        listCourierMessages: async (perPage?: number, page?: number, status?: CourierMessageStatus, recipient?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CourierApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listCourierMessages(perPage?: number, page?: number, status?: CourierMessageStatus, recipient?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Message>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listCourierMessages(perPage, page, status, recipient, options);
...
export const CourierApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listCourierMessages(perPage?: number, page?: number, status?: CourierMessageStatus, recipient?: string, options?: any): AxiosPromise<Array<Message>> {
...
export class CourierApi extends BaseAPI {
    ...
    public listCourierMessages(requestParameters: CourierApiListCourierMessagesRequest = {}, options?: AxiosRequestConfig) {
        return CourierApiFp(this.configuration).listCourierMessages(requestParameters.perPage, requestParameters.page, requestParameters.status, requestParameters.recipient, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const FrontendApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createBrowserRegistrationFlow: async (returnTo?: string, loginChallenge?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FrontendApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createBrowserRegistrationFlow(returnTo?: string, loginChallenge?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegistrationFlow>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createBrowserRegistrationFlow(returnTo, loginChallenge, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * This endpoint initializes a browser-based user settings flow. Once initialized, the browser will be redirected to `selfservice.flows.settings.ui_url` with the flow ID set as the query parameter `?flow=`. If no valid Ory Kratos Session Cookie is included in the request, a login flow will be initialized.  If this endpoint is opened as a link in the browser, it will be redirected to `selfservice.flows.settings.ui_url` with the flow ID set as the query parameter `?flow=`. If no valid user session was set, the browser will be redirected to the login endpoint.  If this endpoint is called via an AJAX request, the response contains the settings flow without any redirects or a 401 forbidden error if no valid session was set.  Depending on your configuration this endpoint might return a 403 error if the session has a lower Authenticator Assurance Level (AAL) than is possible for the identity. This can happen if the identity has password + webauthn credentials (which would result in AAL2) but the session has only AAL1. If this error occurs, ask the user to sign in with the second factor (happens automatically for server-side browser flows) or change the configuration.  If this endpoint is called via an AJAX request, the response contains the flow without a redirect. In the case of an error, the `error.id` of the JSON response body can be one of:  `security_csrf_violation`: Unable to fetch the flow because a CSRF violation occurred. `session_inactive`: No Ory Session was found - sign in a user first. `security_identity_mismatch`: The requested `?return_to` address is not allowed to be used. Adjust this in the configuration!  This endpoint is NOT INTENDED for clients that do not have a browser (Chrome, Firefox, ...) as cookies are needed.  More information can be found at [Ory Kratos User Settings & Profile Management Documentation](../self-service/flows/user-settings).
...
export const FrontendApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createBrowserRegistrationFlow(returnTo?: string, loginChallenge?: string, options?: any): AxiosPromise<RegistrationFlow> {
...
export class FrontendApi extends BaseAPI {
    ...
    public createBrowserRegistrationFlow(requestParameters: FrontendApiCreateBrowserRegistrationFlowRequest = {}, options?: AxiosRequestConfig) {
        return FrontendApiFp(this.configuration).createBrowserRegistrationFlow(requestParameters.returnTo, requestParameters.loginChallenge, options).then((request) => request(this.axios, this.basePath));
    }
...
export const IdentityApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSession: async (id: string, expand?: Array<'Devices' | 'Identity'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listIdentities: async (perPage?: number, page?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/admin/identities`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        listSessions: async (pageSize?: number, pageToken?: string, active?: boolean, expand?: Array<'Devices' | 'Identity'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const IdentityApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getSession(id: string, expand?: Array<'Devices' | 'Identity'>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Session>> {
         ...
         * @throws {RequiredError}
         */
        async listIdentities(perPage?: number, page?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Identity>>> {
         ...
         * @throws {RequiredError}
         */
        async listSessions(pageSize?: number, pageToken?: string, active?: boolean, expand?: Array<'Devices' | 'Identity'>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Session>>> {
...
export const IdentityApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getSession(id: string, expand?: Array<'Devices' | 'Identity'>, options?: any): AxiosPromise<Session> {
         ...
         * @throws {RequiredError}
         */
        listSessions(pageSize?: number, pageToken?: string, active?: boolean, expand?: Array<'Devices' | 'Identity'>, options?: any): AxiosPromise<Array<Session>> {
...
export interface IdentityApiGetSessionRequest {
     ...
     * @type {Array<'Devices' | 'Identity'>}
     * @memberof IdentityApiGetSession
     */
    readonly expand?: Array<'Devices' | 'Identity'>
}
...
export class IdentityApi extends BaseAPI {
    ...
    public listIdentities(requestParameters: IdentityApiListIdentitiesRequest = {}, options?: AxiosRequestConfig) {
        return IdentityApiFp(this.configuration).listIdentities(requestParameters.perPage, requestParameters.page, options).then((request) => request(this.axios, this.basePath));
    }
