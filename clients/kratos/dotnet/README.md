...
- API version: v0.7.6-alpha.3
- SDK version: 0.7.6-alpha.3
...
## Documentation for Models
 ...
 - [Model.KratosSuccessfulSelfServiceSettingsWithoutBrowser](docs/KratosSuccessfulSelfServiceSettingsWithoutBrowser.md)
