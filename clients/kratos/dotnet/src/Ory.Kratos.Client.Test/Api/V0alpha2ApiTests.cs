...
namespace Ory.Kratos.Client.Test.Api
{
    ...
    public class V0alpha2ApiTests : IDisposable
    {
        ...
        public void ListIdentitySchemasTest()
        {
            ...
            //Assert.IsType<List<KratosIdentitySchema>>(response);
        }
        ...
        public void RevokeSessionsTest()
        {
            ...
            //Assert.IsType<KratosRevokedSessions>(response);
        }
        ...
        public void SubmitSelfServiceLoginFlowTest()
        {
            ...
            //string xSessionToken = null;
            //string cookie = null;
            //var response = instance.SubmitSelfServiceLoginFlow(flow, kratosSubmitSelfServiceLoginFlowBody, xSessionToken, cookie);
        ...
        public void SubmitSelfServiceRecoveryFlowTest()
        {
            ...
            //string token = null;
            //string cookie = null;
            //var response = instance.SubmitSelfServiceRecoveryFlow(flow, kratosSubmitSelfServiceRecoveryFlowBody, token, cookie);
            //Assert.IsType<KratosSelfServiceRecoveryFlow>(response);
        }
        ...
        public void SubmitSelfServiceRegistrationFlowTest()
        {
            ...
            //string cookie = null;
            //var response = instance.SubmitSelfServiceRegistrationFlow(flow, kratosSubmitSelfServiceRegistrationFlowBody, cookie);
        ...
        public void SubmitSelfServiceSettingsFlowTest()
        {
            ...
            //string xSessionToken = null;
            //string cookie = null;
            //var response = instance.SubmitSelfServiceSettingsFlow(flow, kratosSubmitSelfServiceSettingsFlowBody, xSessionToken, cookie);
            //Assert.IsType<KratosSelfServiceSettingsFlow>(response);
        }
        ...
        public void SubmitSelfServiceVerificationFlowTest()
        {
            ...
            //string token = null;
            //string cookie = null;
            //var response = instance.SubmitSelfServiceVerificationFlow(flow, kratosSubmitSelfServiceVerificationFlowBody, token, cookie);
            //Assert.IsType<KratosSelfServiceVerificationFlow>(response);
        }
