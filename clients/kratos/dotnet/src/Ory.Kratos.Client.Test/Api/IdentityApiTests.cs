...
namespace Ory.Kratos.Client.Test.Api
{
    ...
    public class IdentityApiTests : IDisposable
    {
        ...
        public void ListIdentitiesTest()
        {
            ...
            //List<string>? includeCredential = null;
            //var response = instance.ListIdentities(perPage, page, pageSize, pageToken, consistency, ids, credentialsIdentifier, previewCredentialsIdentifierSimilar, includeCredential);
