...
namespace Ory.Kratos.Client.Api
{
    ...
    public interface IVersionApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<KratosVersion> GetVersionAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<KratosVersion>> GetVersionAsyncWithHttpInfo ();
    ...
    public partial class VersionApi : IVersionApi
    {
        ...
        /// <exception cref="Ory.Kratos.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (KratosVersion)</returns>
        public async System.Threading.Tasks.Task<Ory.Kratos.Client.Client.ApiResponse<KratosVersion>> GetVersionAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<KratosVersion>("/version", localVarRequestOptions, this.Configuration);
