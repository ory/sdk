...
namespace Ory.Kratos.Client.Api
{
    ...
    public interface IIdentityApiSync : IApiAccessor
    {
        ...
        /// <param name="type">Type is the credential&#39;s Type. One of totp, webauthn, lookup</param>
        /// <returns>ApiResponse of KratosIdentity</returns>
        ApiResponse<KratosIdentity> DeleteIdentityCredentialsWithHttpInfo(string id, string type);
        /// <summary>
    ...
    public interface IIdentityApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of KratosIdentity</returns>
        System.Threading.Tasks.Task<KratosIdentity> DeleteIdentityCredentialsAsync(string id, string type, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (KratosIdentity)</returns>
        System.Threading.Tasks.Task<ApiResponse<KratosIdentity>> DeleteIdentityCredentialsWithHttpInfoAsync(string id, string type, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Delete &amp; Invalidate an Identity&#39;s Sessions
        /// </summary>
        /// <remarks>
    ...
    public partial class IdentityApi : IIdentityApi
    {
        ...
        /// <param name="type">Type is the credential&#39;s Type. One of totp, webauthn, lookup</param>
        /// <returns>KratosIdentity</returns>
        public KratosIdentity DeleteIdentityCredentials(string id, string type)
        {
            Ory.Kratos.Client.Client.ApiResponse<KratosIdentity> localVarResponse = DeleteIdentityCredentialsWithHttpInfo(id, type);
            return localVarResponse.Data;
        }
        ...
        /// <param name="type">Type is the credential&#39;s Type. One of totp, webauthn, lookup</param>
        /// <returns>ApiResponse of KratosIdentity</returns>
        public Ory.Kratos.Client.Client.ApiResponse<KratosIdentity> DeleteIdentityCredentialsWithHttpInfo(string id, string type)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<KratosIdentity>("/admin/identities/{id}/credentials/{type}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of KratosIdentity</returns>
        public async System.Threading.Tasks.Task<KratosIdentity> DeleteIdentityCredentialsAsync(string id, string type, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Ory.Kratos.Client.Client.ApiResponse<KratosIdentity> localVarResponse = await DeleteIdentityCredentialsWithHttpInfoAsync(id, type, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (KratosIdentity)</returns>
        public async System.Threading.Tasks.Task<Ory.Kratos.Client.Client.ApiResponse<KratosIdentity>> DeleteIdentityCredentialsWithHttpInfoAsync(string id, string type, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<KratosIdentity>("/admin/identities/{id}/credentials/{type}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
