...
namespace Ory.Kratos.Client.Api
{
    ...
    /// </summary>
    public interface IGetIdentityByExternalIDApiResponse : Ory.Kratos.Client.Client.IApiResponse, IOk<Ory.Kratos.Client.Model.KratosIdentity?>, INotFound<Ory.Kratos.Client.Model.KratosErrorGeneric?>, IDefault<Ory.Kratos.Client.Model.KratosErrorGeneric?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class IdentityApi : IIdentityApi
    {
        ...
        /// </summary>
        public partial class GetIdentityByExternalIDApiResponse : Ory.Kratos.Client.Client.ApiResponse, IGetIdentityByExternalIDApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
