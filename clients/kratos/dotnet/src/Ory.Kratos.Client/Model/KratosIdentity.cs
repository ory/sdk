...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosIdentity : IEquatable<KratosIdentity>, IValidatableObject
    {
        ...
        public KratosIdentity(DateTime createdAt = default(DateTime), string id = default(string), List<KratosRecoveryAddress> recoveryAddresses = default(List<KratosRecoveryAddress>), string schemaId = default(string), string schemaUrl = default(string), Object traits = default(Object), DateTime updatedAt = default(DateTime), List<KratosVerifiableIdentityAddress> verifiableAddresses = default(List<KratosVerifiableIdentityAddress>))
        {
