...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosIdentity : IEquatable<KratosIdentity>, IValidatableObject
    {
        ...
        public KratosIdentity(DateTime createdAt = default(DateTime), Dictionary<string, KratosIdentityCredentials> credentials = default(Dictionary<string, KratosIdentityCredentials>), string id = default(string), Object metadataAdmin = default(Object), Object metadataPublic = default(Object), List<KratosRecoveryIdentityAddress> recoveryAddresses = default(List<KratosRecoveryIdentityAddress>), string schemaId = default(string), string schemaUrl = default(string), KratosIdentityState state = default(KratosIdentityState), DateTime stateChangedAt = default(DateTime), Object traits = default(Object), DateTime updatedAt = default(DateTime), List<KratosVerifiableIdentityAddress> verifiableAddresses = default(List<KratosVerifiableIdentityAddress>))
        {
