...
{
    /// <summary>
    /// KratosRegistrationRequest
    /// </summary>
    [DataContract(Name = "registrationRequest")]
    public partial class KratosRegistrationRequest : IEquatable<KratosRegistrationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosRegistrationRequest" /> class.
        /// </summary>
        ...
        /// <param name="methods">Methods contains context for all enabled registration methods. If a registration request has been processed, but for example the password is incorrect, this will contain error messages..</param>
        ...
        public KratosRegistrationRequest(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), Dictionary<string, KratosRegistrationRequestMethod> methods = default(Dictionary<string, KratosRegistrationRequestMethod>), string requestUrl = default(string))
        {
            this.Active = active;
        ...
        /// </summary>
        /// <value>Methods contains context for all enabled registration methods. If a registration request has been processed, but for example the password is incorrect, this will contain error messages.</value>
        [DataMember(Name = "methods", EmitDefaultValue = false)]
        public Dictionary<string, KratosRegistrationRequestMethod> Methods { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosRegistrationRequest {\n");
        ...
        {
            return this.Equals(input as KratosRegistrationRequest);
        }

        /// <summary>
        /// Returns true if KratosRegistrationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosRegistrationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosRegistrationRequest input)
        {
            if (input == null)
                return false;
