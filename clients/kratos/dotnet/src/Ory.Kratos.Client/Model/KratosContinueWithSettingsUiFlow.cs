...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosContinueWithSettingsUiFlow : IEquatable<KratosContinueWithSettingsUiFlow>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as KratosContinueWithSettingsUiFlow);
        }

        /// <summary>
        /// Returns true if KratosContinueWithSettingsUiFlow instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosContinueWithSettingsUiFlow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosContinueWithSettingsUiFlow input)
        {
            if (input == null)
            {
                return false;
