...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosMessage : IEquatable<KratosMessage>, IValidatableObject
    {
        ...
        public KratosMessage(string body = default(string), DateTime createdAt = default(DateTime), string id = default(string), string recipient = default(string), long sendCount = default(long), KratosCourierMessageStatus status = default(KratosCourierMessageStatus), string subject = default(string), TemplateTypeEnum? templateType = default(TemplateTypeEnum?), KratosCourierMessageType type = default(KratosCourierMessageType), DateTime updatedAt = default(DateTime))
        {
            this.Body = body;
