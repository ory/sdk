...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSettingsFlow : IEquatable<KratosSettingsFlow>, IValidatableObject
    {
        ...
        public KratosSettingsFlowState State { get; set; }
