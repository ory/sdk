...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosOAuth2ConsentRequestOpenIDConnectContext : IEquatable<KratosOAuth2ConsentRequestOpenIDConnectContext>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosOAuth2ConsentRequestOpenIDConnectContext(List<string> acrValues = default(List<string>), string display = default(string), Dictionary<string, Object> idTokenHintClaims = default(Dictionary<string, Object>), string loginHint = default(string), List<string> uiLocales = default(List<string>))
        {
        ...
        {
            return this.Equals(input as KratosOAuth2ConsentRequestOpenIDConnectContext);
        }

        /// <summary>
        /// Returns true if KratosOAuth2ConsentRequestOpenIDConnectContext instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosOAuth2ConsentRequestOpenIDConnectContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosOAuth2ConsentRequestOpenIDConnectContext input)
        {
            if (input == null)
            {
                return false;
