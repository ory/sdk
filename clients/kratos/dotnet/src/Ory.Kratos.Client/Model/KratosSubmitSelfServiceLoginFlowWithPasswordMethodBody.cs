    ...
    public partial class KratosSubmitSelfServiceLoginFlowWithPasswordMethodBody : IEquatable<KratosSubmitSelfServiceLoginFlowWithPasswordMethodBody>, IValidatableObject
    {
        ...
        public KratosSubmitSelfServiceLoginFlowWithPasswordMethodBody(string csrfToken = default(string), string identifier = default(string), string method = default(string), string password = default(string), string passwordIdentifier = default(string))
        {
            ...
            if (passwordIdentifier == null) {
                throw new ArgumentNullException("passwordIdentifier is a required property for KratosSubmitSelfServiceLoginFlowWithPasswordMethodBody and cannot be null");
            }
