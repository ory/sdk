...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateLoginFlowWithCodeMethod : IValidatableObject
    {
        ...
        public KratosUpdateLoginFlowWithCodeMethod(string code = default(string), string csrfToken = default(string), string identifier = default(string), string method = default(string), string resend = default(string), Object transientPayload = default(Object))
        {
