...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSuccessfulNativeRegistration : IEquatable<KratosSuccessfulNativeRegistration>, IValidatableObject
    {
        ...
        public KratosSuccessfulNativeRegistration(KratosIdentity identity = default(KratosIdentity), KratosSession session = default(KratosSession), string sessionToken = default(string))
        {
