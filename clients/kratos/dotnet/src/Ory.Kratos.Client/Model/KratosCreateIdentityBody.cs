...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosCreateIdentityBody : IValidatableObject
    {
        ...
        public KratosCreateIdentityBody(KratosIdentityWithCredentials credentials = default(KratosIdentityWithCredentials), Object metadataAdmin = default(Object), Object metadataPublic = default(Object), string organizationId = default(string), List<KratosRecoveryIdentityAddress> recoveryAddresses = default(List<KratosRecoveryIdentityAddress>), string schemaId = default(string), StateEnum? state = default(StateEnum?), Object traits = default(Object), List<KratosVerifiableIdentityAddress> verifiableAddresses = default(List<KratosVerifiableIdentityAddress>))
        {
