...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosCreateIdentityBody : IEquatable<KratosCreateIdentityBody>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as KratosCreateIdentityBody);
        }

        /// <summary>
        /// Returns true if KratosCreateIdentityBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosCreateIdentityBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosCreateIdentityBody input)
        {
            if (input == null)
            {
                return false;
