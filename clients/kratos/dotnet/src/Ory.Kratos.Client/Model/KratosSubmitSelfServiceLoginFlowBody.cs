...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSubmitSelfServiceLoginFlowBody : AbstractOpenAPISchema, IEquatable<KratosSubmitSelfServiceLoginFlowBody>, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(KratosSubmitSelfServiceLoginFlowWithOidcMethodBody))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: KratosSubmitSelfServiceLoginFlowWithOidcMethodBody, KratosSubmitSelfServiceLoginFlowWithPasswordMethodBody, KratosSubmitSelfServiceLoginFlowWithTotpMethodBody");
                }
            }
        }
