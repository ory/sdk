...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosContinueWithRecoveryUi : IEquatable<KratosContinueWithRecoveryUi>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as KratosContinueWithRecoveryUi);
        }

        /// <summary>
        /// Returns true if KratosContinueWithRecoveryUi instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosContinueWithRecoveryUi to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosContinueWithRecoveryUi input)
        {
            if (input == null)
            {
                return false;
