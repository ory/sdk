...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateLoginFlowWithOidcMethod : IEquatable<KratosUpdateLoginFlowWithOidcMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosUpdateLoginFlowWithOidcMethod(string csrfToken = default(string), string idToken = default(string), string idTokenNonce = default(string), string method = default(string), string provider = default(string), Object traits = default(Object), Object upstreamParameters = default(Object))
        {
        ...
        {
            return this.Equals(input as KratosUpdateLoginFlowWithOidcMethod);
        }

        /// <summary>
        /// Returns true if KratosUpdateLoginFlowWithOidcMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosUpdateLoginFlowWithOidcMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosUpdateLoginFlowWithOidcMethod input)
        {
            if (input == null)
            {
                return false;
