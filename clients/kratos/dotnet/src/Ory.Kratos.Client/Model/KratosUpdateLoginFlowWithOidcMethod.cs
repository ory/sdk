...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateLoginFlowWithOidcMethod : IEquatable<KratosUpdateLoginFlowWithOidcMethod>, IValidatableObject
    {
        ...
        public KratosUpdateLoginFlowWithOidcMethod(string csrfToken = default(string), string method = default(string), string provider = default(string), Object traits = default(Object), Object upstreamParameters = default(Object))
        {
