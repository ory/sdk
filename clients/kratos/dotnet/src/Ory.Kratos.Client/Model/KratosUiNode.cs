...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUiNode : IEquatable<KratosUiNode>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Group specifies which group (e.g. password authenticator) this node belongs to.</value>
        ...
        /// <param name="group">Group specifies which group (e.g. password authenticator) this node belongs to. (required).</param>
        /// <param name="messages">messages (required).</param>
        /// <param name="meta">meta (required).</param>
        /// <param name="type">The node&#39;s type (required).</param>
