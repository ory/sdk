...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosRecoveryFlow : IEquatable<KratosRecoveryFlow>, IValidatableObject
    {
        ...
        public KratosRecoveryFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), string state = default(string), string type = default(string), KratosUiContainer ui = default(KratosUiContainer))
        {
            ...
            this.Ui = ui ?? throw new ArgumentNullException("ui is a required property for KratosRecoveryFlow and cannot be null");
            this.Active = active;
            this.Type = type;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
