...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosRecoveryFlow :  IEquatable<KratosRecoveryFlow>, IValidatableObject
    {
        ...
        /// <param name="methods">Methods contains context for all account recovery methods. If a registration request has been processed, but for example the password is incorrect, this will contain error messages. (required).</param>
        ...
        public KratosRecoveryFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), List<KratosMessage> messages = default(List<KratosMessage>), Dictionary<string, KratosRecoveryFlowMethod> methods = default(Dictionary<string, KratosRecoveryFlowMethod>), string requestUrl = default(string), string state = default(string), string type = default(string))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for KratosRecoveryFlow and cannot be null");
            this.IssuedAt = issuedAt;
            // to ensure "methods" is required (not null)
            this.Methods = methods ?? throw new ArgumentNullException("methods is a required property for KratosRecoveryFlow and cannot be null");
            // to ensure "requestUrl" is required (not null)
            this.RequestUrl = requestUrl ?? throw new ArgumentNullException("requestUrl is a required property for KratosRecoveryFlow and cannot be null");
            // to ensure "state" is required (not null)
            this.State = state ?? throw new ArgumentNullException("state is a required property for KratosRecoveryFlow and cannot be null");
            this.Active = active;
        ...
        /// </summary>
        /// <value>Methods contains context for all account recovery methods. If a registration request has been processed, but for example the password is incorrect, this will contain error messages.</value>
        [DataMember(Name="methods", EmitDefaultValue=false)]
        public Dictionary<string, KratosRecoveryFlowMethod> Methods { get; set; }
