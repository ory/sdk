...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateRegistrationFlowWithOidcMethod : IEquatable<KratosUpdateRegistrationFlowWithOidcMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosUpdateRegistrationFlowWithOidcMethod(string csrfToken = default(string), string method = default(string), string provider = default(string), Object traits = default(Object), Object transientPayload = default(Object), Object upstreamParameters = default(Object))
        {
        ...
        {
            return this.Equals(input as KratosUpdateRegistrationFlowWithOidcMethod);
        }

        /// <summary>
        /// Returns true if KratosUpdateRegistrationFlowWithOidcMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosUpdateRegistrationFlowWithOidcMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosUpdateRegistrationFlowWithOidcMethod input)
        {
            if (input == null)
            {
                return false;
