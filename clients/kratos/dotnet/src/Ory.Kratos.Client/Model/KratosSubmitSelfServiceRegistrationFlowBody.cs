...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSubmitSelfServiceRegistrationFlowBody : AbstractOpenAPISchema, IEquatable<KratosSubmitSelfServiceRegistrationFlowBody>, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(KratosSubmitSelfServiceRegistrationFlowWithPasswordMethodBody))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: KratosSubmitSelfServiceRegistrationFlowWithPasswordMethodBody");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `KratosSubmitSelfServiceRegistrationFlowWithPasswordMethodBody`. If the actual instanct is not `KratosSubmitSelfServiceRegistrationFlowWithPasswordMethodBody`,
