...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateRegistrationFlowWithWebAuthnMethod : IEquatable<KratosUpdateRegistrationFlowWithWebAuthnMethod>, IValidatableObject
    {
        ...
        public KratosUpdateRegistrationFlowWithWebAuthnMethod(string csrfToken = default(string), string method = default(string), Object traits = default(Object), string webauthnRegister = default(string), string webauthnRegisterDisplayname = default(string))
        {
