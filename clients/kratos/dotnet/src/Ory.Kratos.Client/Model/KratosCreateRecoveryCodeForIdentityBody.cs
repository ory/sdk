...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosCreateRecoveryCodeForIdentityBody : IEquatable<KratosCreateRecoveryCodeForIdentityBody>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosCreateRecoveryCodeForIdentityBody(string expiresIn = default(string), string identityId = default(string))
        {
        ...
        {
            return this.Equals(input as KratosCreateRecoveryCodeForIdentityBody);
        }

        /// <summary>
        /// Returns true if KratosCreateRecoveryCodeForIdentityBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosCreateRecoveryCodeForIdentityBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosCreateRecoveryCodeForIdentityBody input)
        {
            if (input == null)
            {
                return false;
