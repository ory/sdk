...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateRegistrationFlowWithPasswordMethod : IEquatable<KratosUpdateRegistrationFlowWithPasswordMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosUpdateRegistrationFlowWithPasswordMethod(string csrfToken = default(string), string method = default(string), string password = default(string), Object traits = default(Object))
        {
        ...
        {
            return this.Equals(input as KratosUpdateRegistrationFlowWithPasswordMethod);
        }

        /// <summary>
        /// Returns true if KratosUpdateRegistrationFlowWithPasswordMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosUpdateRegistrationFlowWithPasswordMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosUpdateRegistrationFlowWithPasswordMethod input)
        {
            if (input == null)
            {
                return false;
