...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUiNodeScriptAttributes : IEquatable<KratosUiNodeScriptAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosUiNodeScriptAttributes(bool async = default(bool), string crossorigin = default(string), string id = default(string), string integrity = default(string), string nodeType = default(string), string referrerpolicy = default(string), string src = default(string), string type = default(string))
        {
            this.Async = async;
        ...
        {
            return this.Equals(input as KratosUiNodeScriptAttributes);
        }

        /// <summary>
        /// Returns true if KratosUiNodeScriptAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosUiNodeScriptAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosUiNodeScriptAttributes input)
        {
            if (input == null)
                return false;
