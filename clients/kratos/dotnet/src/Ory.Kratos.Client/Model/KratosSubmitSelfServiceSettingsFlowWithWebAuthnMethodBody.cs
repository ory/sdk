...
{
    /// <summary>
    /// KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody
    /// </summary>
    [DataContract(Name = "submitSelfServiceSettingsFlowWithWebAuthnMethodBody")]
    public partial class KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody : IEquatable<KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody()
        {
        ...
        public KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody(string csrfToken = default(string), string method = default(string), string webauthnRegister = default(string), string webauthnRegisterDisplayname = default(string), string webauthnRemove = default(string))
        {
            // to ensure "method" is required (not null)
            if (method == null) {
                throw new ArgumentNullException("method is a required property for KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody and cannot be null");
            }
            this.Method = method;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody {\n");
        ...
        {
            return this.Equals(input as KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody);
        }

        /// <summary>
        /// Returns true if KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosSubmitSelfServiceSettingsFlowWithWebAuthnMethodBody input)
        {
            if (input == null)
            {
                return false;
