...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosVerificationFlow : IEquatable<KratosVerificationFlow>, IValidatableObject
    {
        ...
        public KratosVerificationFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), string state = default(string), string type = default(string), KratosUiContainer ui = default(KratosUiContainer))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for KratosVerificationFlow and cannot be null");
            ...
            this.Type = type ?? throw new ArgumentNullException("type is a required property for KratosVerificationFlow and cannot be null");
            // to ensure "ui" is required (not null)
            this.Ui = ui ?? throw new ArgumentNullException("ui is a required property for KratosVerificationFlow and cannot be null");
            this.Active = active;
