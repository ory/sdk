...
{
    /// <summary>
    /// KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody
    /// </summary>
    [DataContract(Name = "submitSelfServiceSettingsFlowWithTotpMethodBody")]
    public partial class KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody : IEquatable<KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody()
        {
        ...
        public KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody(string csrfToken = default(string), string method = default(string), string totpCode = default(string), bool totpUnlink = default(bool))
        {
            // to ensure "method" is required (not null)
            if (method == null) {
                throw new ArgumentNullException("method is a required property for KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody and cannot be null");
            }
            this.Method = method;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody {\n");
        ...
        {
            return this.Equals(input as KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody);
        }

        /// <summary>
        /// Returns true if KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosSubmitSelfServiceSettingsFlowWithTotpMethodBody input)
        {
            if (input == null)
                return false;
