...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateIdentityBody : IEquatable<KratosUpdateIdentityBody>, IValidatableObject
    {
        ...
        public KratosUpdateIdentityBody(KratosIdentityWithCredentials credentials = default(KratosIdentityWithCredentials), Object metadataAdmin = default(Object), Object metadataPublic = default(Object), string schemaId = default(string), KratosIdentityState state = default(KratosIdentityState), Object traits = default(Object))
        {
            ...
            if (state == null) {
                throw new ArgumentNullException("state is a required property for KratosUpdateIdentityBody and cannot be null");
            }
            this.State = state;
