...
{
    /// <summary>
    /// KratosSubmitSelfServiceLoginFlowWithPasswordMethod
    /// </summary>
    [DataContract(Name = "submitSelfServiceLoginFlowWithPasswordMethod")]
    public partial class KratosSubmitSelfServiceLoginFlowWithPasswordMethod : IEquatable<KratosSubmitSelfServiceLoginFlowWithPasswordMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosSubmitSelfServiceLoginFlowWithPasswordMethod" /> class.
        /// </summary>
        ...
        public KratosSubmitSelfServiceLoginFlowWithPasswordMethod(string csrfToken = default(string), string method = default(string), string password = default(string), string passwordIdentifier = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosSubmitSelfServiceLoginFlowWithPasswordMethod {\n");
        ...
        {
            return this.Equals(input as KratosSubmitSelfServiceLoginFlowWithPasswordMethod);
        }

        /// <summary>
        /// Returns true if KratosSubmitSelfServiceLoginFlowWithPasswordMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosSubmitSelfServiceLoginFlowWithPasswordMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosSubmitSelfServiceLoginFlowWithPasswordMethod input)
        {
            if (input == null)
                return false;
