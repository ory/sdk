...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosLoginFlow : IEquatable<KratosLoginFlow>, IValidatableObject
    {
        ...
        /// <param name="methods">List of login methods  This is the list of available login methods with their required form fields, such as &#x60;identifier&#x60; and &#x60;password&#x60; for the password login method. This will also contain error messages such as \&quot;password can not be empty\&quot;. (required).</param>
        ...
        public KratosLoginFlow(string active = default(string), DateTime expiresAt = default(DateTime), bool forced = default(bool), string id = default(string), DateTime issuedAt = default(DateTime), List<KratosMessage> messages = default(List<KratosMessage>), Dictionary<string, KratosLoginFlowMethod> methods = default(Dictionary<string, KratosLoginFlowMethod>), string requestUrl = default(string), string type = default(string))
        {
            ...
            this.Methods = methods ?? throw new ArgumentNullException("methods is a required property for KratosLoginFlow and cannot be null");
        ...
        /// </summary>
        /// <value>List of login methods  This is the list of available login methods with their required form fields, such as &#x60;identifier&#x60; and &#x60;password&#x60; for the password login method. This will also contain error messages such as \&quot;password can not be empty\&quot;.</value>
        [DataMember(Name = "methods", IsRequired = true, EmitDefaultValue = false)]
        public Dictionary<string, KratosLoginFlowMethod> Methods { get; set; }
