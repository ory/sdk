...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosAdminCreateIdentityBody : IEquatable<KratosAdminCreateIdentityBody>, IValidatableObject
    {
        ...
        public KratosAdminCreateIdentityBody(string schemaId = default(string), KratosIdentityState state = default(KratosIdentityState), Object traits = default(Object))
        {
