...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateSettingsFlowWithOidcMethod : IEquatable<KratosUpdateSettingsFlowWithOidcMethod>, IValidatableObject
    {
        ...
        public KratosUpdateSettingsFlowWithOidcMethod(string flow = default(string), string link = default(string), string method = default(string), Object traits = default(Object), string unlink = default(string))
        {
