...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosContinueWith : AbstractOpenAPISchema, IEquatable<KratosContinueWith>, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(KratosContinueWithSetOrySessionToken))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: KratosContinueWithSetOrySessionToken, KratosContinueWithVerificationUi");
                }
            }
        }
