...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUiNodeAttributes : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(KratosUiNodeAnchorAttributes) || value is KratosUiNodeAnchorAttributes)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(KratosUiNodeImageAttributes) || value is KratosUiNodeImageAttributes)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(KratosUiNodeInputAttributes) || value is KratosUiNodeInputAttributes)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(KratosUiNodeScriptAttributes) || value is KratosUiNodeScriptAttributes)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(KratosUiNodeTextAttributes) || value is KratosUiNodeTextAttributes)
                {
                    this._actualInstance = value;
                }
                else
