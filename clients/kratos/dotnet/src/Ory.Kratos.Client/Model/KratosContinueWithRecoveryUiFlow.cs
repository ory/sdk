...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosContinueWithRecoveryUiFlow : IEquatable<KratosContinueWithRecoveryUiFlow>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as KratosContinueWithRecoveryUiFlow);
        }

        /// <summary>
        /// Returns true if KratosContinueWithRecoveryUiFlow instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosContinueWithRecoveryUiFlow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosContinueWithRecoveryUiFlow input)
        {
            if (input == null)
            {
                return false;
