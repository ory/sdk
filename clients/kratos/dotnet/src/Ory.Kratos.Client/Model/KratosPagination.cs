...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosPagination : IEquatable<KratosPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosPagination" /> class.
        /// </summary>
        ...
        public KratosPagination(long page = 1, long perPage = 250)
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosPagination {\n");
        ...
        {
            return this.Equals(input as KratosPagination);
        }

        /// <summary>
        /// Returns true if KratosPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosPagination input)
        {
            if (input == null)
            {
                return false;
