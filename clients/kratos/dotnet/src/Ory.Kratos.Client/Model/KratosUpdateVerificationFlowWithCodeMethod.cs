...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateVerificationFlowWithCodeMethod : IEquatable<KratosUpdateVerificationFlowWithCodeMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosUpdateVerificationFlowWithCodeMethod(string code = default(string), string csrfToken = default(string), string email = default(string), MethodEnum method = default(MethodEnum))
        {
            this.Method = method;
            this.Code = code;
        ...
        {
            return this.Equals(input as KratosUpdateVerificationFlowWithCodeMethod);
        }

        /// <summary>
        /// Returns true if KratosUpdateVerificationFlowWithCodeMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosUpdateVerificationFlowWithCodeMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosUpdateVerificationFlowWithCodeMethod input)
        {
            if (input == null)
            {
                return false;
