...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUiNodeTextAttributes : IEquatable<KratosUiNodeTextAttributes>, IValidatableObject
    {
        ...
        public KratosUiNodeTextAttributes(string id = default(string), string nodeType = default(string), KratosUiText text = default(KratosUiText))
        {
            ...
            if (nodeType == null) {
                throw new ArgumentNullException("nodeType is a required property for KratosUiNodeTextAttributes and cannot be null");
            }
