...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosIdentitySchemaContainer : IValidatableObject
    {
        ...
        [JsonConstructor]
        public KratosIdentitySchemaContainer(string id, Object schema)
        {
            Id = id;
            Schema = schema;
            OnCreated();
    ...
    public class KratosIdentitySchemaContainerJsonConverter : JsonConverter<KratosIdentitySchemaContainer>
    {
        ...
        public override KratosIdentitySchemaContainer Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class KratosIdentitySchemaContainer.", nameof(id));

            if (!schema.IsSet)
                throw new ArgumentException("Property is required for class KratosIdentitySchemaContainer.", nameof(schema));
            ...
            return new KratosIdentitySchemaContainer(id.Value!, schema.Value!);
        }
        ...
        {
            if (kratosIdentitySchemaContainer.Id == null)
            ...
            if (kratosIdentitySchemaContainer.Schema == null)
