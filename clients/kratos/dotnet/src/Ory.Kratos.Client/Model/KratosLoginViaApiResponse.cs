...
namespace Ory.Kratos.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KratosLoginViaApiResponse :  IEquatable<KratosLoginViaApiResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosLoginViaApiResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KratosLoginViaApiResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosLoginViaApiResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosLoginViaApiResponse {\n");
        ...
        {
            return this.Equals(input as KratosLoginViaApiResponse);
        }

        /// <summary>
        /// Returns true if KratosLoginViaApiResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosLoginViaApiResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosLoginViaApiResponse input)
        {
            if (input == null)
                return false;
