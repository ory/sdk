...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateRegistrationFlowWithPasskeyMethod : IValidatableObject
    {
        ...
        protected KratosUpdateRegistrationFlowWithPasskeyMethod()
        {
        ...
        public KratosUpdateRegistrationFlowWithPasskeyMethod(string csrfToken = default(string), string method = default(string), string passkeyRegister = default(string), Object traits = default(Object), Object transientPayload = default(Object))
        {
            // to ensure "method" is required (not null)
            if (method == null)
            {
                throw new ArgumentNullException("method is a required property for KratosUpdateRegistrationFlowWithPasskeyMethod and cannot be null");
            }
            this.Method = method;
            // to ensure "traits" is required (not null)
            if (traits == null)
            {
                throw new ArgumentNullException("traits is a required property for KratosUpdateRegistrationFlowWithPasskeyMethod and cannot be null");
            }
            this.Traits = traits;
