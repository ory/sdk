...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUiNodeInputAttributes : IEquatable<KratosUiNodeInputAttributes>, IValidatableObject
    {
        ...
        public KratosUiNodeInputAttributes(bool disabled = default(bool), KratosUiText label = default(KratosUiText), string name = default(string), string nodeType = default(string), string onclick = default(string), string pattern = default(string), bool required = default(bool), string type = default(string), Object value = default(Object))
        {
