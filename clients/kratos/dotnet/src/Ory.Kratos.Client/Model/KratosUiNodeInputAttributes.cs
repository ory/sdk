...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUiNodeInputAttributes : IValidatableObject
    {
        ...
        public KratosUiNodeInputAttributes(AutocompleteEnum? autocomplete = default(AutocompleteEnum?), bool disabled = default(bool), KratosUiText label = default(KratosUiText), long maxlength = default(long), string name = default(string), NodeTypeEnum nodeType = default(NodeTypeEnum), string onclick = default(string), OnclickTriggerEnum? onclickTrigger = default(OnclickTriggerEnum?), string onload = default(string), OnloadTriggerEnum? onloadTrigger = default(OnloadTriggerEnum?), string pattern = default(string), bool required = default(bool), TypeEnum type = default(TypeEnum), Object value = default(Object))
        {
