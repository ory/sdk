...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosBatchPatchIdentitiesResponse : IEquatable<KratosBatchPatchIdentitiesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as KratosBatchPatchIdentitiesResponse);
        }

        /// <summary>
        /// Returns true if KratosBatchPatchIdentitiesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosBatchPatchIdentitiesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosBatchPatchIdentitiesResponse input)
        {
            if (input == null)
            {
                return false;
