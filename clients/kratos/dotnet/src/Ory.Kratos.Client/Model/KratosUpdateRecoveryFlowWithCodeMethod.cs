...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateRecoveryFlowWithCodeMethod : IEquatable<KratosUpdateRecoveryFlowWithCodeMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosUpdateRecoveryFlowWithCodeMethod(string code = default(string), string csrfToken = default(string), string email = default(string), string method = default(string))
        {
            // to ensure "method" is required (not null)
            if (method == null) {
                throw new ArgumentNullException("method is a required property for KratosUpdateRecoveryFlowWithCodeMethod and cannot be null");
            }
            this.Method = method;
            this.Code = code;
        ...
        {
            return this.Equals(input as KratosUpdateRecoveryFlowWithCodeMethod);
        }

        /// <summary>
        /// Returns true if KratosUpdateRecoveryFlowWithCodeMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosUpdateRecoveryFlowWithCodeMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosUpdateRecoveryFlowWithCodeMethod input)
        {
            if (input == null)
            {
                return false;
