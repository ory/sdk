...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateRecoveryFlowWithCodeMethod : IEquatable<KratosUpdateRecoveryFlowWithCodeMethod>, IValidatableObject
    {
        ...
        public KratosUpdateRecoveryFlowWithCodeMethod(string code = default(string), string csrfToken = default(string), string email = default(string), MethodEnum method = default(MethodEnum))
        {
            this.Method = method;
            this.Code = code;
