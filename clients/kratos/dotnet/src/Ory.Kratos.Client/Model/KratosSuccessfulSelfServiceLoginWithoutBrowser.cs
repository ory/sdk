...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSuccessfulSelfServiceLoginWithoutBrowser : IEquatable<KratosSuccessfulSelfServiceLoginWithoutBrowser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosSuccessfulSelfServiceLoginWithoutBrowser" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KratosSuccessfulSelfServiceLoginWithoutBrowser()
        {
        ...
        public KratosSuccessfulSelfServiceLoginWithoutBrowser(KratosSession session = default(KratosSession), string sessionToken = default(string))
        {
            ...
            if (session == null) {
                throw new ArgumentNullException("session is a required property for KratosSuccessfulSelfServiceLoginWithoutBrowser and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosSuccessfulSelfServiceLoginWithoutBrowser {\n");
        ...
        {
            return this.Equals(input as KratosSuccessfulSelfServiceLoginWithoutBrowser);
        }

        /// <summary>
        /// Returns true if KratosSuccessfulSelfServiceLoginWithoutBrowser instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosSuccessfulSelfServiceLoginWithoutBrowser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosSuccessfulSelfServiceLoginWithoutBrowser input)
        {
            if (input == null)
                return false;
