...
namespace Ory.Kratos.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "selfServiceRecoveryFlow")]
    public partial class KratosSelfServiceRecoveryFlow : IEquatable<KratosSelfServiceRecoveryFlow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosSelfServiceRecoveryFlow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KratosSelfServiceRecoveryFlow()
        {
        ...
        public KratosSelfServiceRecoveryFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), string returnTo = default(string), KratosSelfServiceRecoveryFlowState state = default(KratosSelfServiceRecoveryFlowState), string type = default(string), KratosUiContainer ui = default(KratosUiContainer))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for KratosSelfServiceRecoveryFlow and cannot be null");
            }
            this.Id = id;
            this.IssuedAt = issuedAt;
            // to ensure "requestUrl" is required (not null)
            if (requestUrl == null) {
                throw new ArgumentNullException("requestUrl is a required property for KratosSelfServiceRecoveryFlow and cannot be null");
            }
            this.RequestUrl = requestUrl;
            // to ensure "state" is required (not null)
            if (state == null) {
                throw new ArgumentNullException("state is a required property for KratosSelfServiceRecoveryFlow and cannot be null");
            }
            this.State = state;
            // to ensure "type" is required (not null)
            if (type == null) {
                throw new ArgumentNullException("type is a required property for KratosSelfServiceRecoveryFlow and cannot be null");
            }
            this.Type = type;
            // to ensure "ui" is required (not null)
            if (ui == null) {
                throw new ArgumentNullException("ui is a required property for KratosSelfServiceRecoveryFlow and cannot be null");
            }
            this.Ui = ui;
            this.Active = active;
        ...
        public KratosSelfServiceRecoveryFlowState State { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosSelfServiceRecoveryFlow {\n");
        ...
        {
            return this.Equals(input as KratosSelfServiceRecoveryFlow);
        }

        /// <summary>
        /// Returns true if KratosSelfServiceRecoveryFlow instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosSelfServiceRecoveryFlow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosSelfServiceRecoveryFlow input)
        {
            if (input == null)
            {
                return false;
