...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateSettingsFlowWithWebAuthnMethod : IEquatable<KratosUpdateSettingsFlowWithWebAuthnMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosUpdateSettingsFlowWithWebAuthnMethod(string csrfToken = default(string), string method = default(string), string webauthnRegister = default(string), string webauthnRegisterDisplayname = default(string), string webauthnRemove = default(string))
        {
        ...
        {
            return this.Equals(input as KratosUpdateSettingsFlowWithWebAuthnMethod);
        }

        /// <summary>
        /// Returns true if KratosUpdateSettingsFlowWithWebAuthnMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosUpdateSettingsFlowWithWebAuthnMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosUpdateSettingsFlowWithWebAuthnMethod input)
        {
            if (input == null)
            {
                return false;
