...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSessionAuthenticationMethod : IEquatable<KratosSessionAuthenticationMethod>, IValidatableObject
    {
        ...
        public KratosSessionAuthenticationMethod(KratosAuthenticatorAssuranceLevel aal = default(KratosAuthenticatorAssuranceLevel), DateTime completedAt = default(DateTime), MethodEnum? method = default(MethodEnum?), string provider = default(string))
        {
            this.Aal = aal;
