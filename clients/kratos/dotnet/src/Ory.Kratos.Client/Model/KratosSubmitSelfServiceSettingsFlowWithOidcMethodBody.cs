...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSubmitSelfServiceSettingsFlowWithOidcMethodBody : IEquatable<KratosSubmitSelfServiceSettingsFlowWithOidcMethodBody>, IValidatableObject
    {
        ...
        public KratosSubmitSelfServiceSettingsFlowWithOidcMethodBody(string flow = default(string), string link = default(string), string method = default(string), Object traits = default(Object), string unlink = default(string))
        {
            // to ensure "method" is required (not null)
            if (method == null) {
                throw new ArgumentNullException("method is a required property for KratosSubmitSelfServiceSettingsFlowWithOidcMethodBody and cannot be null");
            }
            this.Method = method;
            this.Flow = flow;
            this.Link = link;
