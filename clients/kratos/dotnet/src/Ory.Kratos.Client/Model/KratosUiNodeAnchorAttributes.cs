...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUiNodeAnchorAttributes : IEquatable<KratosUiNodeAnchorAttributes>, IValidatableObject
    {
        ...
        public KratosUiNodeAnchorAttributes(string href = default(string), KratosUiText title = default(KratosUiText))
        {
            ...
            this.Href = href ?? throw new ArgumentNullException("href is a required property for KratosUiNodeAnchorAttributes and cannot be null");
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for KratosUiNodeAnchorAttributes and cannot be null");
            this.AdditionalProperties = new Dictionary<string, object>();
        }
