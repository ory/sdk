...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSelfServiceVerificationFlow : IEquatable<KratosSelfServiceVerificationFlow>, IValidatableObject
    {
        ...
        public KratosSelfServiceVerificationFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), string returnTo = default(string), KratosSelfServiceVerificationFlowState state = default(KratosSelfServiceVerificationFlowState), string type = default(string), KratosUiContainer ui = default(KratosUiContainer))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for KratosSelfServiceVerificationFlow and cannot be null");
            }
            this.Id = id;
            // to ensure "state" is required (not null)
            if (state == null) {
                throw new ArgumentNullException("state is a required property for KratosSelfServiceVerificationFlow and cannot be null");
            }
            this.State = state;
            // to ensure "type" is required (not null)
            if (type == null) {
                throw new ArgumentNullException("type is a required property for KratosSelfServiceVerificationFlow and cannot be null");
            }
            this.Type = type;
            // to ensure "ui" is required (not null)
            if (ui == null) {
                throw new ArgumentNullException("ui is a required property for KratosSelfServiceVerificationFlow and cannot be null");
            }
            this.Ui = ui;
            this.Active = active;
