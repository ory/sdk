...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosRecoveryAddress : IEquatable<KratosRecoveryAddress>, IValidatableObject
    {
        ...
        public KratosRecoveryAddress(DateTime createdAt = default(DateTime), string id = default(string), DateTime updatedAt = default(DateTime), string value = default(string), string via = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for KratosRecoveryAddress and cannot be null");
            }
            this.Id = id;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for KratosRecoveryAddress and cannot be null");
            }
            this.Value = value;
            // to ensure "via" is required (not null)
            if (via == null) {
                throw new ArgumentNullException("via is a required property for KratosRecoveryAddress and cannot be null");
            }
            this.Via = via;
