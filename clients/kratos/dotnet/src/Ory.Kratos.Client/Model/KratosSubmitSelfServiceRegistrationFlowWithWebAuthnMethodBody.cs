...
{
    /// <summary>
    /// KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody
    /// </summary>
    [DataContract(Name = "submitSelfServiceRegistrationFlowWithWebAuthnMethodBody")]
    public partial class KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody : IEquatable<KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody()
        {
        ...
        public KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody(string csrfToken = default(string), string method = default(string), Object traits = default(Object), string webauthnRegister = default(string), string webauthnRegisterDisplayname = default(string))
        {
            // to ensure "method" is required (not null)
            if (method == null) {
                throw new ArgumentNullException("method is a required property for KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody and cannot be null");
            }
            this.Method = method;
            // to ensure "traits" is required (not null)
            if (traits == null) {
                throw new ArgumentNullException("traits is a required property for KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody and cannot be null");
            }
            this.Traits = traits;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody {\n");
        ...
        {
            return this.Equals(input as KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody);
        }

        /// <summary>
        /// Returns true if KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosSubmitSelfServiceRegistrationFlowWithWebAuthnMethodBody input)
        {
            if (input == null)
            {
                return false;
