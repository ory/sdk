...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateRecoveryFlowWithLinkMethod : IEquatable<KratosUpdateRecoveryFlowWithLinkMethod>, IValidatableObject
    {
        ...
        public KratosUpdateRecoveryFlowWithLinkMethod(string csrfToken = default(string), string email = default(string), string method = default(string))
        {
            ...
            if (method == null) {
                throw new ArgumentNullException("method is a required property for KratosUpdateRecoveryFlowWithLinkMethod and cannot be null");
            }
            this.Method = method;
