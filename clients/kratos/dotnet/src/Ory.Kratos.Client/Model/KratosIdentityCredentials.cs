...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosIdentityCredentials : IEquatable<KratosIdentityCredentials>, IValidatableObject
    {
        ...
        public KratosIdentityCredentials(Object config = default(Object), DateTime createdAt = default(DateTime), List<string> identifiers = default(List<string>), KratosIdentityCredentialsType type = default(KratosIdentityCredentialsType), DateTime updatedAt = default(DateTime))
        {
            this.Config = config;
