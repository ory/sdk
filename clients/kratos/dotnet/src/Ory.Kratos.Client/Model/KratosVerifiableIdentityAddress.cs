...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosVerifiableIdentityAddress : IEquatable<KratosVerifiableIdentityAddress>, IValidatableObject
    {
        ...
        public KratosVerifiableIdentityAddress(DateTime createdAt = default(DateTime), string id = default(string), string status = default(string), DateTime updatedAt = default(DateTime), string value = default(string), bool verified = default(bool), DateTime verifiedAt = default(DateTime), string via = default(string))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for KratosVerifiableIdentityAddress and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for KratosVerifiableIdentityAddress and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for KratosVerifiableIdentityAddress and cannot be null");
            this.Verified = verified;
            // to ensure "via" is required (not null)
            this.Via = via ?? throw new ArgumentNullException("via is a required property for KratosVerifiableIdentityAddress and cannot be null");
