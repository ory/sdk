...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosIdentityWithCredentials : IEquatable<KratosIdentityWithCredentials>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as KratosIdentityWithCredentials);
        }

        /// <summary>
        /// Returns true if KratosIdentityWithCredentials instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosIdentityWithCredentials to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosIdentityWithCredentials input)
        {
            if (input == null)
            {
                return false;
