...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSuccessfulNativeLogin : IEquatable<KratosSuccessfulNativeLogin>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosSuccessfulNativeLogin(KratosSession session = default(KratosSession), string sessionToken = default(string))
        {
        ...
        {
            return this.Equals(input as KratosSuccessfulNativeLogin);
        }

        /// <summary>
        /// Returns true if KratosSuccessfulNativeLogin instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosSuccessfulNativeLogin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosSuccessfulNativeLogin input)
        {
            if (input == null)
            {
                return false;
