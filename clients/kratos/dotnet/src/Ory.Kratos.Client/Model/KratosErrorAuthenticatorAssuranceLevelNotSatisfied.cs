...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosErrorAuthenticatorAssuranceLevelNotSatisfied : IEquatable<KratosErrorAuthenticatorAssuranceLevelNotSatisfied>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosErrorAuthenticatorAssuranceLevelNotSatisfied" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KratosErrorAuthenticatorAssuranceLevelNotSatisfied()
        {
        ...
        public KratosErrorAuthenticatorAssuranceLevelNotSatisfied(long code = default(long), string debug = default(string), Dictionary<string, Object> details = default(Dictionary<string, Object>), string id = default(string), string message = default(string), string reason = default(string), string redirectBrowserTo = default(string), string request = default(string), string status = default(string))
        {
            // to ensure "message" is required (not null)
            if (message == null) {
                throw new ArgumentNullException("message is a required property for KratosErrorAuthenticatorAssuranceLevelNotSatisfied and cannot be null");
            }
        ...
        {
            return this.Equals(input as KratosErrorAuthenticatorAssuranceLevelNotSatisfied);
        }

        /// <summary>
        /// Returns true if KratosErrorAuthenticatorAssuranceLevelNotSatisfied instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosErrorAuthenticatorAssuranceLevelNotSatisfied to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosErrorAuthenticatorAssuranceLevelNotSatisfied input)
        {
            if (input == null)
            {
                return false;
