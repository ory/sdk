...
namespace Ory.Kratos.Client.Model
{
    ...
    /// </summary>
    public partial class KratosIdentityWithCredentialsOidcConfig : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public KratosIdentityWithCredentialsOidcConfig(Option<List<KratosIdentityWithCredentialsOidcConfigProvider>?> providers = default)
        {
    ...
    public class KratosIdentityWithCredentialsOidcConfigJsonConverter : JsonConverter<KratosIdentityWithCredentialsOidcConfig>
    {
        ...
        public override KratosIdentityWithCredentialsOidcConfig Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new KratosIdentityWithCredentialsOidcConfig(providers);
        }
