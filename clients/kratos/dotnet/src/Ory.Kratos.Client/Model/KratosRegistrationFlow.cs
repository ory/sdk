...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosRegistrationFlow : IEquatable<KratosRegistrationFlow>, IValidatableObject
    {
        ...
        /// <param name="methods">Methods contains context for all enabled registration methods. If a registration flow has been processed, but for example the password is incorrect, this will contain error messages. (required).</param>
        ...
        public KratosRegistrationFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), List<KratosMessage> messages = default(List<KratosMessage>), Dictionary<string, KratosRegistrationFlowMethod> methods = default(Dictionary<string, KratosRegistrationFlowMethod>), string requestUrl = default(string), string type = default(string))
        {
            ...
            this.Methods = methods ?? throw new ArgumentNullException("methods is a required property for KratosRegistrationFlow and cannot be null");
        ...
        /// </summary>
        /// <value>Methods contains context for all enabled registration methods. If a registration flow has been processed, but for example the password is incorrect, this will contain error messages.</value>
        [DataMember(Name = "methods", IsRequired = true, EmitDefaultValue = false)]
        public Dictionary<string, KratosRegistrationFlowMethod> Methods { get; set; }
