...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSelfServiceRegistrationFlow : IEquatable<KratosSelfServiceRegistrationFlow>, IValidatableObject
    {
        ...
        public KratosSelfServiceRegistrationFlow(string active = default(string), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), string type = default(string), KratosUiContainer ui = default(KratosUiContainer))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for KratosSelfServiceRegistrationFlow and cannot be null");
            this.IssuedAt = issuedAt;
            // to ensure "requestUrl" is required (not null)
            this.RequestUrl = requestUrl ?? throw new ArgumentNullException("requestUrl is a required property for KratosSelfServiceRegistrationFlow and cannot be null");
            // to ensure "ui" is required (not null)
            this.Ui = ui ?? throw new ArgumentNullException("ui is a required property for KratosSelfServiceRegistrationFlow and cannot be null");
            this.Active = active;
            this.Type = type;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
