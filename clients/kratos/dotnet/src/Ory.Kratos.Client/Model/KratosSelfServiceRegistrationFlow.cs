...
{
    /// <summary>
    /// KratosSelfServiceRegistrationFlow
    /// </summary>
    [DataContract(Name = "selfServiceRegistrationFlow")]
    public partial class KratosSelfServiceRegistrationFlow : IEquatable<KratosSelfServiceRegistrationFlow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosSelfServiceRegistrationFlow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KratosSelfServiceRegistrationFlow()
        {
        ...
        public KratosSelfServiceRegistrationFlow(KratosIdentityCredentialsType active = default(KratosIdentityCredentialsType), DateTime expiresAt = default(DateTime), string id = default(string), DateTime issuedAt = default(DateTime), string requestUrl = default(string), string returnTo = default(string), string type = default(string), KratosUiContainer ui = default(KratosUiContainer))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for KratosSelfServiceRegistrationFlow and cannot be null");
            }
            this.Id = id;
            this.IssuedAt = issuedAt;
            // to ensure "requestUrl" is required (not null)
            if (requestUrl == null) {
                throw new ArgumentNullException("requestUrl is a required property for KratosSelfServiceRegistrationFlow and cannot be null");
            }
            this.RequestUrl = requestUrl;
            // to ensure "type" is required (not null)
            if (type == null) {
                throw new ArgumentNullException("type is a required property for KratosSelfServiceRegistrationFlow and cannot be null");
            }
            this.Type = type;
            // to ensure "ui" is required (not null)
            if (ui == null) {
                throw new ArgumentNullException("ui is a required property for KratosSelfServiceRegistrationFlow and cannot be null");
            }
            this.Ui = ui;
            this.Active = active;
        ...
        public KratosIdentityCredentialsType Active { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosSelfServiceRegistrationFlow {\n");
        ...
        {
            return this.Equals(input as KratosSelfServiceRegistrationFlow);
        }

        /// <summary>
        /// Returns true if KratosSelfServiceRegistrationFlow instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosSelfServiceRegistrationFlow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosSelfServiceRegistrationFlow input)
        {
            if (input == null)
            {
                return false;
