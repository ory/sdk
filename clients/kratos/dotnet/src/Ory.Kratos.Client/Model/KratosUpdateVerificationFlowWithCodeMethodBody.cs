...
{
    /// <summary>
    /// KratosUpdateVerificationFlowWithCodeMethodBody
    /// </summary>
    [DataContract(Name = "updateVerificationFlowWithCodeMethodBody")]
    public partial class KratosUpdateVerificationFlowWithCodeMethodBody : IEquatable<KratosUpdateVerificationFlowWithCodeMethodBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosUpdateVerificationFlowWithCodeMethodBody" /> class.
        /// </summary>
        ...
        public KratosUpdateVerificationFlowWithCodeMethodBody(string code = default(string), string csrfToken = default(string), string email = default(string), string flow = default(string), string method = default(string))
        {
            this.Code = code;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosUpdateVerificationFlowWithCodeMethodBody {\n");
        ...
        {
            return this.Equals(input as KratosUpdateVerificationFlowWithCodeMethodBody);
        }

        /// <summary>
        /// Returns true if KratosUpdateVerificationFlowWithCodeMethodBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosUpdateVerificationFlowWithCodeMethodBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosUpdateVerificationFlowWithCodeMethodBody input)
        {
            if (input == null)
            {
                return false;
