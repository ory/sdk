...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateSettingsFlowWithTotpMethod : IEquatable<KratosUpdateSettingsFlowWithTotpMethod>, IValidatableObject
    {
        /// <summary>
        ...
        public KratosUpdateSettingsFlowWithTotpMethod(string csrfToken = default(string), string method = default(string), string totpCode = default(string), bool totpUnlink = default(bool))
        {
        ...
        {
            return this.Equals(input as KratosUpdateSettingsFlowWithTotpMethod);
        }

        /// <summary>
        /// Returns true if KratosUpdateSettingsFlowWithTotpMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosUpdateSettingsFlowWithTotpMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosUpdateSettingsFlowWithTotpMethod input)
        {
            if (input == null)
            {
                return false;
