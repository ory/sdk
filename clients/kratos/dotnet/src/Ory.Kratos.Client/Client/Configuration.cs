...
namespace Ory.Kratos.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.7.6-alpha.5";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.7.6-alpha.5/csharp";
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v0.7.6-alpha.5\n";
            report += "    SDK Package Version: 0.7.6-alpha.5\n";
