...
namespace Ory.Kratos.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.5.1-alpha.1";
        ...
        {
            UserAgent = "OpenAPI-Generator/0.5.1-alpha.1/csharp";
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: v0.5.1-alpha.1\n";
            report += "    SDK Package Version: 0.5.1-alpha.1\n";
