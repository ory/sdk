...
namespace Ory.Kratos.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.0.4-alpha.1";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.0.4-alpha.1/csharp";
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: v0.0.4-alpha.1\n";
            report += "    SDK Package Version: 0.0.4-alpha.1\n";
