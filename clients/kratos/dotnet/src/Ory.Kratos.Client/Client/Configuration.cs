...
namespace Ory.Kratos.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.3.6-alpha.1";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.3.6-alpha.1/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: v1.3.6-alpha.1\n";
            report += "    SDK Package Version: 1.3.6-alpha.1\n";
