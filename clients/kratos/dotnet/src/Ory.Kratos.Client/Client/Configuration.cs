...
namespace Ory.Kratos.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.6.0-alpha.15";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.6.0-alpha.15/csharp";
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: v0.6.0-alpha.15\n";
            report += "    SDK Package Version: 0.6.0-alpha.15\n";
