# Ory.Kratos.Client.Api.HealthApi
...
namespace Example
{
    public class IsInstanceAliveExample
    {
        public static void Main()
        {
            ...
            {
                // Check alive status
                KratosHealthStatus result = apiInstance.IsInstanceAlive();
...
[**KratosHealthStatus**](KratosHealthStatus.md)
...
namespace Example
{
    public class IsInstanceReadyExample
    {
        public static void Main()
        {
            ...
            {
                // Check readiness status
                KratosHealthStatus result = apiInstance.IsInstanceReady();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
