...
> KratosRegistrationFlow CreateBrowserRegistrationFlow (string returnTo = null, string loginChallenge = null)
...
namespace Example
{
    public class CreateBrowserRegistrationFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Create Registration Flow for Browsers
                KratosRegistrationFlow result = apiInstance.CreateBrowserRegistrationFlow(returnTo, loginChallenge);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
