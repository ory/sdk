...
> KratosLoginFlow CreateBrowserLoginFlow (bool? refresh = null, string aal = null, string returnTo = null, string cookie = null, string loginChallenge = null)
...
namespace Example
{
    public class CreateBrowserLoginFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Create Login Flow for Browsers
                KratosLoginFlow result = apiInstance.CreateBrowserLoginFlow(refresh, aal, returnTo, cookie, loginChallenge);
...
> KratosLogoutFlow CreateBrowserLogoutFlow (string cookie = null)
...
namespace Example
{
    public class CreateBrowserLogoutFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Create a Logout URL for Browsers
                KratosLogoutFlow result = apiInstance.CreateBrowserLogoutFlow(cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> KratosRegistrationFlow CreateBrowserRegistrationFlow (string returnTo = null, string loginChallenge = null, string afterVerificationReturnTo = null)
...
namespace Example
{
    public class CreateBrowserRegistrationFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Create Registration Flow for Browsers
                KratosRegistrationFlow result = apiInstance.CreateBrowserRegistrationFlow(returnTo, loginChallenge, afterVerificationReturnTo);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> KratosLoginFlow CreateNativeLoginFlow (bool? refresh = null, string aal = null, string xSessionToken = null)
...
namespace Example
{
    public class CreateNativeLoginFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Create Login Flow for Native Apps
                KratosLoginFlow result = apiInstance.CreateNativeLoginFlow(refresh, aal, xSessionToken);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
namespace Example
{
    public class CreateNativeRegistrationFlowExample
    {
        public static void Main()
        {
            ...
            {
                // Create Registration Flow for Native Apps
                KratosRegistrationFlow result = apiInstance.CreateNativeRegistrationFlow();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **ListMySessions**
> List&lt;KratosSession&gt; ListMySessions (long? perPage = null, long? page = null, string xSessionToken = null, string cookie = null)
...
namespace Example
{
    public class ListMySessionsExample
    {
        public static void Main()
        {
            ...
            {
                // Get My Active Sessions
                List<KratosSession> result = apiInstance.ListMySessions(perPage, page, xSessionToken, cookie);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
