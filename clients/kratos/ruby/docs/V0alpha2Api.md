...
opts = {
  admin_update_identity_body: OryKratosClient::AdminUpdateIdentityBody.new({schema_id: 'schema_id_example', state: OryKratosClient::IdentityState::ACTIVE, traits: 3.56}) # AdminUpdateIdentityBody | 
}
