...
OryKratosClient::UpdateSettingsFlowBody.openapi_one_of
# =>
# [
...
OryKratosClient::UpdateSettingsFlowBody.openapi_discriminator_name
# => :'method'
```
...
OryKratosClient::UpdateSettingsFlowBody.openapi_discriminator_mapping
# =>
# {
...
OryKratosClient::UpdateSettingsFlowBody.build(data)
# => #<UpdateSettingsFlowWithLookupMethod:0x00007fdd4aab02a0>

OryKratosClient::UpdateSettingsFlowBody.build(data_that_doesnt_match)
# => nil
```
