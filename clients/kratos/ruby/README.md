...
```shell
gem install ./ory-kratos-client-v0.0.0-alpha.35.gem
```

(for development, run `gem install --dev ./ory-kratos-client-v0.0.0-alpha.35.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ory-kratos-client', '~> v0.0.0-alpha.35'
