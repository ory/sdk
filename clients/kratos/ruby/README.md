...
```shell
gem install ./ory-kratos-client-v25.4.0.gem
```

(for development, run `gem install --dev ./ory-kratos-client-v25.4.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ory-kratos-client', '~> v25.4.0'
...
*OryKratosClient::IdentityApi* | [**get_identity_by_external_id**](docs/IdentityApi.md#get_identity_by_external_id) | **GET** /admin/identities/by/external/{externalID} | Get an Identity by its External ID
...
## Documentation for Models
 ...
 - [OryKratosClient::IdentityWithCredentialsSaml](docs/IdentityWithCredentialsSaml.md)
 - [OryKratosClient::IdentityWithCredentialsSamlConfig](docs/IdentityWithCredentialsSamlConfig.md)
 - [OryKratosClient::IdentityWithCredentialsSamlConfigProvider](docs/IdentityWithCredentialsSamlConfigProvider.md)
 ...
 - [OryKratosClient::UpdateLoginFlowWithSamlMethod](docs/UpdateLoginFlowWithSamlMethod.md)
 ...
 - [OryKratosClient::UpdateRegistrationFlowWithSamlMethod](docs/UpdateRegistrationFlowWithSamlMethod.md)
 ...
 - [OryKratosClient::UpdateSettingsFlowWithSamlMethod](docs/UpdateSettingsFlowWithSamlMethod.md)
