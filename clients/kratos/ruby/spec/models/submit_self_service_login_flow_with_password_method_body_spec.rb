...
# Unit tests for OryHydraClient::SubmitSelfServiceLoginFlowWithPasswordMethodBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryHydraClient::SubmitSelfServiceLoginFlowWithPasswordMethodBody do
  let(:instance) { OryHydraClient::SubmitSelfServiceLoginFlowWithPasswordMethodBody.new }
  ...
  describe 'test an instance of SubmitSelfServiceLoginFlowWithPasswordMethodBody' do
    it 'should create an instance of SubmitSelfServiceLoginFlowWithPasswordMethodBody' do
      expect(instance).to be_instance_of(OryHydraClient::SubmitSelfServiceLoginFlowWithPasswordMethodBody)
    end
  end
