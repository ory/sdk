...
# Unit tests for OryKratosClient::SelfServiceLogoutUrl
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryKratosClient::SelfServiceLogoutUrl do
  let(:instance) { OryKratosClient::SelfServiceLogoutUrl.new }

  describe 'test an instance of SelfServiceLogoutUrl' do
    it 'should create an instance of SelfServiceLogoutUrl' do
      expect(instance).to be_instance_of(OryKratosClient::SelfServiceLogoutUrl)
    end
  end
