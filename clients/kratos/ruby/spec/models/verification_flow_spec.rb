...
# Unit tests for OryKratosClient::VerificationFlow
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryKratosClient::VerificationFlow do
  let(:instance) { OryKratosClient::VerificationFlow.new }

  describe 'test an instance of VerificationFlow' do
    it 'should create an instance of VerificationFlow' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OryKratosClient::VerificationFlow)
    end
  end
