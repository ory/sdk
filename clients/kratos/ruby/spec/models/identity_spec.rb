...
# Unit tests for OryHydraClient::Identity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryHydraClient::Identity do
  let(:instance) { OryHydraClient::Identity.new }

  describe 'test an instance of Identity' do
    it 'should create an instance of Identity' do
      expect(instance).to be_instance_of(OryHydraClient::Identity)
    end
  end
