...
export function SelfServiceFlowExpiredErrorToJSON(json: any): SelfServiceFlowExpiredError {
    return SelfServiceFlowExpiredErrorToJSONTyped(json, false);
}

export function SelfServiceFlowExpiredErrorToJSONTyped(value?: SelfServiceFlowExpiredError | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'expired_at': value['expired_at'] == null ? value['expired_at'] : value['expired_at'].toISOString(),
        'since': value['since'],
