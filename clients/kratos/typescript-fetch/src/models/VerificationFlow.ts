...
export function VerificationFlowToJSON(json: any): VerificationFlow {
    return VerificationFlowToJSONTyped(json, false);
}

export function VerificationFlowToJSONTyped(value?: VerificationFlow | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
