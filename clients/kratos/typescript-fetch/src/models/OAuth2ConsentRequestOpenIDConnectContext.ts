...
export function OAuth2ConsentRequestOpenIDConnectContextToJSON(json: any): OAuth2ConsentRequestOpenIDConnectContext {
    return OAuth2ConsentRequestOpenIDConnectContextToJSONTyped(json, false);
}

export function OAuth2ConsentRequestOpenIDConnectContextToJSONTyped(value?: OAuth2ConsentRequestOpenIDConnectContext | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
