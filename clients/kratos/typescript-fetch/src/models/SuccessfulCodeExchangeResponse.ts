...
export function SuccessfulCodeExchangeResponseToJSON(json: any): SuccessfulCodeExchangeResponse {
    return SuccessfulCodeExchangeResponseToJSONTyped(json, false);
}

export function SuccessfulCodeExchangeResponseToJSONTyped(value?: SuccessfulCodeExchangeResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
