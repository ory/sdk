...
export function SessionToJSONTyped(value?: Session | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'active': value['active'],
        'authenticated_at': value['authenticated_at'] == null ? value['authenticated_at'] : value['authenticated_at'].toISOString(),
        ...
        'issued_at': value['issued_at'] == null ? value['issued_at'] : value['issued_at'].toISOString(),
