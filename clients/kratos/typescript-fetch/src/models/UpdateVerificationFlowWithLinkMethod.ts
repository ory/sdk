...
export function UpdateVerificationFlowWithLinkMethodToJSON(json: any): UpdateVerificationFlowWithLinkMethod {
    return UpdateVerificationFlowWithLinkMethodToJSONTyped(json, false);
}

export function UpdateVerificationFlowWithLinkMethodToJSONTyped(value?: UpdateVerificationFlowWithLinkMethod | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
