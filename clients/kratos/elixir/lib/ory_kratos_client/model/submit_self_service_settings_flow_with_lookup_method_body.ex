...
defmodule OryKratosClient.Model.SubmitSelfServiceSettingsFlowWithLookupMethodBody do
  @moduledoc """
...
defimpl Poison.Decoder, for: OryKratosClient.Model.SubmitSelfServiceSettingsFlowWithLookupMethodBody do
