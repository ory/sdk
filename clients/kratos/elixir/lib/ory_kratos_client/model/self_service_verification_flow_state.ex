...
defmodule OryKratosClient.Model.SelfServiceVerificationFlowState do
  @moduledoc """
...
defimpl Poison.Decoder, for: OryKratosClient.Model.SelfServiceVerificationFlowState do
