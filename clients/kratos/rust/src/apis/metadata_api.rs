...
pub async fn is_alive(configuration: &configuration::Configuration, ) -> Result<crate::models::IsAlive200Response, Error<IsAliveError>> {
...
pub async fn is_ready(configuration: &configuration::Configuration, ) -> Result<crate::models::IsAlive200Response, Error<IsReadyError>> {
