...
> crate::models::RegistrationFlow create_browser_registration_flow(return_to, login_challenge, after_verification_return_to, organization)
...
> crate::models::LoginFlow create_native_login_flow(refresh, aal, x_session_token, return_session_token_exchange_code, return_to, via)
...
> Vec<crate::models::Session> list_my_sessions(per_page, page, page_size, page_token, x_session_token, cookie)
...
> crate::models::Session to_session(x_session_token, cookie, tokenize_as)
...
> crate::models::SettingsFlow update_settings_flow(flow, update_settings_flow_body, x_session_token, cookie)
