...
> crate::models::LoginViaApiResponse complete_self_service_login_flow_with_password_method(flow, body)
...
------------- | ------------- | ------------- | ------------- | -------------
**flow** | **String** | The Flow ID | [required] |
**body** | Option<[**CompleteSelfServiceLoginFlowWithPasswordMethod**](CompleteSelfServiceLoginFlowWithPasswordMethod.md)> |  |  |
...
> complete_self_service_recovery_flow_with_link_method(token, flow, body)
...
**body** | Option<[**CompleteSelfServiceRecoveryFlowWithLinkMethod**](CompleteSelfServiceRecoveryFlowWithLinkMethod.md)> |  |  |
...
> crate::models::RegistrationViaApiResponse complete_self_service_registration_flow_with_password_method(flow, payload)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**flow** | Option<**String**> | Flow is flow ID. |  |
...
> crate::models::SettingsViaApiResponse complete_self_service_settings_flow_with_password_method(flow, body)
...
------------- | ------------- | ------------- | ------------- | -------------
**flow** | Option<**String**> | Flow is flow ID. |  |
**body** | Option<[**CompleteSelfServiceSettingsFlowWithPasswordMethod**](CompleteSelfServiceSettingsFlowWithPasswordMethod.md)> |  |  |
...
> crate::models::SettingsFlow complete_self_service_settings_flow_with_profile_method(flow, payload)
...
> complete_self_service_verification_flow_with_link_method(token, flow, body)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**token** | Option<**String**> | Verification Token  The verification token which completes the verification request. If the token is invalid (e.g. expired) an error will be shown to the end-user. |  |
**flow** | Option<**String**> | The Flow ID  format: uuid |  |
**body** | Option<[**CompleteSelfServiceVerificationFlowWithLinkMethod**](CompleteSelfServiceVerificationFlowWithLinkMethod.md)> |  |  |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**body** | [**RevokeSession**](RevokeSession.md) |  | [required] |
