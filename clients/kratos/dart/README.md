...
try {
    final response = await api.listCourierMessages(perPage, page, status, recipient);
    print(response);
} catch on DioError (e) {
...
[*IdentityApi*](doc/IdentityApi.md) | [**getSession**](doc/IdentityApi.md#getsession) | **GET** /admin/sessions/{id} | This endpoint returns the session object with expandables specified.
