...
class SubmitSelfServiceVerificationFlowWithLinkMethodBody {
  ...
  static List<SubmitSelfServiceVerificationFlowWithLinkMethodBody> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ...
      : json.map((v) => SubmitSelfServiceVerificationFlowWithLinkMethodBody.fromJson(v)).toList(growable: true == growable);
  ...
  static Map<String, SubmitSelfServiceVerificationFlowWithLinkMethodBody> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = SubmitSelfServiceVerificationFlowWithLinkMethodBody.fromJson(v));
    }
    return map;
  }
  ...
  static Map<String, List<SubmitSelfServiceVerificationFlowWithLinkMethodBody>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = SubmitSelfServiceVerificationFlowWithLinkMethodBody.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
...
class SubmitSelfServiceVerificationFlowWithLinkMethodBodyMethodEnum {
  ...
  static const password = SubmitSelfServiceVerificationFlowWithLinkMethodBodyMethodEnum._(r'password');
  static const oidc = SubmitSelfServiceVerificationFlowWithLinkMethodBodyMethodEnum._(r'oidc');
...
class SubmitSelfServiceVerificationFlowWithLinkMethodBodyMethodEnumTypeTransformer {
  ...
  SubmitSelfServiceVerificationFlowWithLinkMethodBodyMethodEnum decode(dynamic data, {bool allowNull}) {
    switch (data) {
      case r'password': return SubmitSelfServiceVerificationFlowWithLinkMethodBodyMethodEnum.password;
      case r'oidc': return SubmitSelfServiceVerificationFlowWithLinkMethodBodyMethodEnum.oidc;
      default:
        if (allowNull == false) {
