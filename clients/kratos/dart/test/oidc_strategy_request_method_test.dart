...
// tests for OidcStrategyRequestMethod
void main() {
  final instance = OidcStrategyRequestMethod();

  group('test OidcStrategyRequestMethod', () {
    ...
    // List<FormField> providers (default value: const [])
