...
// tests for SubmitSelfServiceRecoveryFlowWithLinkMethod
void main() {
  final instance = SubmitSelfServiceRecoveryFlowWithLinkMethod();

  group('test SubmitSelfServiceRecoveryFlowWithLinkMethod', () {
