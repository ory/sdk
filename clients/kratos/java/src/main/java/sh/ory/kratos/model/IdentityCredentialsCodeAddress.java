...
public class IdentityCredentialsCodeAddress {
  ...
  public IdentityCredentialsCodeAddress address(@javax.annotation.Nullable String address) {
  ...
  public IdentityCredentialsCodeAddress channel(@javax.annotation.Nullable String channel) {
