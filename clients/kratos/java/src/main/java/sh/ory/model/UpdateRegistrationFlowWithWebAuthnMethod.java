...
public class UpdateRegistrationFlowWithWebAuthnMethod {
  ...
  public UpdateRegistrationFlowWithWebAuthnMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateRegistrationFlowWithWebAuthnMethod method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateRegistrationFlowWithWebAuthnMethod traits(@javax.annotation.Nonnull Object traits) {
    this.traits = traits;
    return this;
  }
  ...
  public UpdateRegistrationFlowWithWebAuthnMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
  ...
  public UpdateRegistrationFlowWithWebAuthnMethod webauthnRegister(@javax.annotation.Nullable String webauthnRegister) {
  ...
  public UpdateRegistrationFlowWithWebAuthnMethod webauthnRegisterDisplayname(@javax.annotation.Nullable String webauthnRegisterDisplayname) {
