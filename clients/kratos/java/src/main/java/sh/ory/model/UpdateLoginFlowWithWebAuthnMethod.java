...
public class UpdateLoginFlowWithWebAuthnMethod {
  ...
  public UpdateLoginFlowWithWebAuthnMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateLoginFlowWithWebAuthnMethod identifier(@javax.annotation.Nonnull String identifier) {
  ...
  public UpdateLoginFlowWithWebAuthnMethod method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateLoginFlowWithWebAuthnMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
  ...
  public UpdateLoginFlowWithWebAuthnMethod webauthnLogin(@javax.annotation.Nullable String webauthnLogin) {
  ...
  public void setWebauthnLogin(@javax.annotation.Nullable String webauthnLogin) {
    this.webauthnLogin = webauthnLogin;
  }
