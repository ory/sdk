...
public class IdentityCredentials {
  ...
  public IdentityCredentials config(@javax.annotation.Nullable Object config) {
    this.config = config;
    return this;
  }
  ...
  public IdentityCredentials createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public IdentityCredentials identifiers(@javax.annotation.Nullable List<String> identifiers) {
  ...
  public IdentityCredentials type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public IdentityCredentials updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  public IdentityCredentials version(@javax.annotation.Nullable Long version) {
