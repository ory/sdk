...
public class ErrorAuthenticatorAssuranceLevelNotSatisfied {
  ...
  public ErrorAuthenticatorAssuranceLevelNotSatisfied error(@javax.annotation.Nullable GenericError error) {
    this.error = error;
    return this;
  }
  ...
  public ErrorAuthenticatorAssuranceLevelNotSatisfied redirectBrowserTo(@javax.annotation.Nullable String redirectBrowserTo) {
  ...
  public void setRedirectBrowserTo(@javax.annotation.Nullable String redirectBrowserTo) {
    this.redirectBrowserTo = redirectBrowserTo;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ErrorAuthenticatorAssuranceLevelNotSatisfied
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorAuthenticatorAssuranceLevelNotSatisfied.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
