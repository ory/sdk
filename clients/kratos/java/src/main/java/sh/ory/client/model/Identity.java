...
import sh.ory.client.model.IdentityCredentials;
...
public class Identity {
  ...
  public Identity credentials(@javax.annotation.Nullable Map<String, IdentityCredentials> credentials) {
  ...
  public void setCredentials(@javax.annotation.Nullable Map<String, IdentityCredentials> credentials) {
    this.credentials = credentials;
  }


  public Identity externalId(@javax.annotation.Nullable String externalId) {
  ...
  public Identity id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public Identity metadataAdmin(@javax.annotation.Nullable Object metadataAdmin) {
  ...
  public Identity metadataPublic(@javax.annotation.Nullable Object metadataPublic) {
  ...
  public Identity organizationId(@javax.annotation.Nullable String organizationId) {
  ...
  public Identity recoveryAddresses(@javax.annotation.Nullable List<RecoveryIdentityAddress> recoveryAddresses) {
  ...
  public Identity region(@javax.annotation.Nullable RegionEnum region) {
    this.region = region;
    return this;
  }
  ...
  public Identity schemaId(@javax.annotation.Nonnull String schemaId) {
  ...
  public Identity schemaUrl(@javax.annotation.Nonnull String schemaUrl) {
  ...
  public void setSchemaUrl(@javax.annotation.Nonnull String schemaUrl) {
    this.schemaUrl = schemaUrl;
  }


  public Identity state(@javax.annotation.Nullable StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public Identity stateChangedAt(@javax.annotation.Nullable OffsetDateTime stateChangedAt) {
  ...
  public void setStateChangedAt(@javax.annotation.Nullable OffsetDateTime stateChangedAt) {
    this.stateChangedAt = stateChangedAt;
  }


  public Identity traits(@javax.annotation.Nullable Object traits) {
    this.traits = traits;
    return this;
  }
  ...
  public Identity verifiableAddresses(@javax.annotation.Nullable List<VerifiableIdentityAddress> verifiableAddresses) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, identity.createdAt) &&
        ...
        Objects.equals(this.externalId, identity.externalId) &&
        ...
        Objects.equals(this.region, identity.region) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, credentials, externalId, id, metadataAdmin, metadataPublic, organizationId, recoveryAddresses, region, schemaId, schemaUrl, state, stateChangedAt, traits, updatedAt, verifiableAddresses, additionalProperties);
  }
