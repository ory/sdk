...
public class SuccessfulNativeLogin {
  ...
  public SuccessfulNativeLogin continueWith(@javax.annotation.Nullable List<ContinueWith> continueWith) {
  ...
  public SuccessfulNativeLogin session(@javax.annotation.Nonnull Session session) {
  ...
  public SuccessfulNativeLogin sessionToken(@javax.annotation.Nullable String sessionToken) {
