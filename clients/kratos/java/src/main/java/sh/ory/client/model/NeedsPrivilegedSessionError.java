...
public class NeedsPrivilegedSessionError {
  ...
  public NeedsPrivilegedSessionError error(@javax.annotation.Nullable GenericError error) {
    this.error = error;
    return this;
  }
  ...
  public void setError(@javax.annotation.Nullable GenericError error) {
    this.error = error;
  }


  public NeedsPrivilegedSessionError redirectBrowserTo(@javax.annotation.Nonnull String redirectBrowserTo) {
   ...
   * @return the NeedsPrivilegedSessionError instance itself
   */
  public NeedsPrivilegedSessionError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, needsPrivilegedSessionError.error) &&
        ...
        Objects.equals(this.additionalProperties, needsPrivilegedSessionError.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NeedsPrivilegedSessionError
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NeedsPrivilegedSessionError.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NeedsPrivilegedSessionError>() {
           ...
           public NeedsPrivilegedSessionError read(JsonReader in) throws IOException {
             ...
             NeedsPrivilegedSessionError instance = thisAdapter.fromJsonTree(jsonObj);
