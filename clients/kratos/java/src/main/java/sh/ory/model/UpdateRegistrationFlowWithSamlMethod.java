...
public class UpdateRegistrationFlowWithSamlMethod {
  ...
  public UpdateRegistrationFlowWithSamlMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateRegistrationFlowWithSamlMethod method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateRegistrationFlowWithSamlMethod provider(@javax.annotation.Nonnull String provider) {
  ...
  public UpdateRegistrationFlowWithSamlMethod traits(@javax.annotation.Nullable Object traits) {
    this.traits = traits;
    return this;
  }
  ...
  public UpdateRegistrationFlowWithSamlMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
