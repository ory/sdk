...
import sh.ory.client.model.ContinueWith;
...
public class SuccessfulNativeRegistration {
  ...
  public SuccessfulNativeRegistration continueWith(@javax.annotation.Nullable List<ContinueWith> continueWith) {
  ...
  public SuccessfulNativeRegistration identity(@javax.annotation.Nonnull Identity identity) {
  ...
  public SuccessfulNativeRegistration session(@javax.annotation.Nullable Session session) {
  ...
  public SuccessfulNativeRegistration sessionToken(@javax.annotation.Nullable String sessionToken) {
