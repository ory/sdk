...
import sh.ory.client.model.UpdateSettingsFlowWithDeviceAuthnMethod;
import sh.ory.client.model.UpdateSettingsFlowWithDeviceAuthnMethodAdd;
import sh.ory.client.model.UpdateSettingsFlowWithDeviceAuthnMethodDelete;
import sh.ory.client.model.UpdateSettingsFlowWithLookupMethod;
import sh.ory.client.model.UpdateSettingsFlowWithOidcMethod;
import sh.ory.client.model.UpdateSettingsFlowWithPasskeyMethod;
import sh.ory.client.model.UpdateSettingsFlowWithPasswordMethod;
import sh.ory.client.model.UpdateSettingsFlowWithProfileMethod;
import sh.ory.client.model.UpdateSettingsFlowWithSamlMethod;
import sh.ory.client.model.UpdateSettingsFlowWithTotpMethod;
import sh.ory.client.model.UpdateSettingsFlowWithWebAuthnMethod;
...
public class UpdateSettingsFlowBody extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<UpdateSettingsFlowWithSamlMethod> adapterUpdateSettingsFlowWithSamlMethod = gson.getDelegateAdapter(this, TypeToken.get(UpdateSettingsFlowWithSamlMethod.class));
            ...
            final TypeAdapter<UpdateSettingsFlowWithDeviceAuthnMethod> adapterUpdateSettingsFlowWithDeviceAuthnMethod = gson.getDelegateAdapter(this, TypeToken.get(UpdateSettingsFlowWithDeviceAuthnMethod.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateSettingsFlowBody>() {
                ...
                public void write(JsonWriter out, UpdateSettingsFlowBody value) throws IOException {
                    ...
                    // check if the actual instance is of the type `UpdateSettingsFlowWithSamlMethod`
                    if (value.getActualInstance() instanceof UpdateSettingsFlowWithSamlMethod) {
                        JsonElement element = adapterUpdateSettingsFlowWithSamlMethod.toJsonTree((UpdateSettingsFlowWithSamlMethod)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    ...
                    // check if the actual instance is of the type `UpdateSettingsFlowWithDeviceAuthnMethod`
                    if (value.getActualInstance() instanceof UpdateSettingsFlowWithDeviceAuthnMethod) {
                        JsonElement element = adapterUpdateSettingsFlowWithDeviceAuthnMethod.toJsonTree((UpdateSettingsFlowWithDeviceAuthnMethod)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: UpdateSettingsFlowWithDeviceAuthnMethod, UpdateSettingsFlowWithLookupMethod, UpdateSettingsFlowWithOidcMethod, UpdateSettingsFlowWithPasskeyMethod, UpdateSettingsFlowWithPasswordMethod, UpdateSettingsFlowWithProfileMethod, UpdateSettingsFlowWithSamlMethod, UpdateSettingsFlowWithTotpMethod, UpdateSettingsFlowWithWebAuthnMethod");
                }
                ...
                public UpdateSettingsFlowBody read(JsonReader in) throws IOException {
                    ...
                    if (jsonObject.get("method") == null) {
                        ...
                        switch (jsonObject.get("method").getAsString()) {
                            case "deviceauthn":
                                deserialized = adapterUpdateSettingsFlowWithDeviceAuthnMethod.fromJsonTree(jsonObject);
                            ...
                            case "profile":
                                ...
                                return newUpdateSettingsFlowBody;
                            case "saml":
                                deserialized = adapterUpdateSettingsFlowWithSamlMethod.fromJsonTree(jsonObject);
                                newUpdateSettingsFlowBody.setActualInstance(deserialized);
                                return newUpdateSettingsFlowBody;
                            case "totp":
                            ...
                            case "webauthn":
                                ...
                                newUpdateSettingsFlowBody.setActualInstance(deserialized);
                                return newUpdateSettingsFlowBody;
                            case "updateSettingsFlowWithDeviceAuthnMethod":
                                deserialized = adapterUpdateSettingsFlowWithDeviceAuthnMethod.fromJsonTree(jsonObject);
                                newUpdateSettingsFlowBody.setActualInstance(deserialized);
                                return newUpdateSettingsFlowBody;
                            ...
                            case "updateSettingsFlowWithProfileMethod":
                                ...
                                newUpdateSettingsFlowBody.setActualInstance(deserialized);
                                return newUpdateSettingsFlowBody;
                            case "updateSettingsFlowWithSamlMethod":
                                deserialized = adapterUpdateSettingsFlowWithSamlMethod.fromJsonTree(jsonObject);
                                newUpdateSettingsFlowBody.setActualInstance(deserialized);
                                return newUpdateSettingsFlowBody;
                            ...
                            case "updateSettingsFlowWithWebAuthnMethod":
                                ...
                                return newUpdateSettingsFlowBody;
                            default:
                                log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for UpdateSettingsFlowBody. Possible values: deviceauthn lookup_secret oidc passkey password profile saml totp webauthn updateSettingsFlowWithDeviceAuthnMethod updateSettingsFlowWithLookupMethod updateSettingsFlowWithOidcMethod updateSettingsFlowWithPasskeyMethod updateSettingsFlowWithPasswordMethod updateSettingsFlowWithProfileMethod updateSettingsFlowWithSamlMethod updateSettingsFlowWithTotpMethod updateSettingsFlowWithWebAuthnMethod", jsonObject.get("method").getAsString()));
                        }
                    }
                    ...
                    // deserialize UpdateSettingsFlowWithSamlMethod
                    try {
                        // validate the JSON object to see if any exception is thrown
                        UpdateSettingsFlowWithSamlMethod.validateJsonElement(jsonElement);
                        actualAdapter = adapterUpdateSettingsFlowWithSamlMethod;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'UpdateSettingsFlowWithSamlMethod'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for UpdateSettingsFlowWithSamlMethod failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'UpdateSettingsFlowWithSamlMethod'", e);
                    }
                    ...
                    // deserialize UpdateSettingsFlowWithDeviceAuthnMethod
                    try {
                        // validate the JSON object to see if any exception is thrown
                        UpdateSettingsFlowWithDeviceAuthnMethod.validateJsonElement(jsonElement);
                        actualAdapter = adapterUpdateSettingsFlowWithDeviceAuthnMethod;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'UpdateSettingsFlowWithDeviceAuthnMethod'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for UpdateSettingsFlowWithDeviceAuthnMethod failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'UpdateSettingsFlowWithDeviceAuthnMethod'", e);
                    }
    ...
    static {
        ...
        schemas.put("UpdateSettingsFlowWithSamlMethod", UpdateSettingsFlowWithSamlMethod.class);
        ...
        schemas.put("UpdateSettingsFlowWithDeviceAuthnMethod", UpdateSettingsFlowWithDeviceAuthnMethod.class);
    }
     ...
     * UpdateSettingsFlowWithDeviceAuthnMethod, UpdateSettingsFlowWithLookupMethod, UpdateSettingsFlowWithOidcMethod, UpdateSettingsFlowWithPasskeyMethod, UpdateSettingsFlowWithPasswordMethod, UpdateSettingsFlowWithProfileMethod, UpdateSettingsFlowWithSamlMethod, UpdateSettingsFlowWithTotpMethod, UpdateSettingsFlowWithWebAuthnMethod
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof UpdateSettingsFlowWithSamlMethod) {
            super.setActualInstance(instance);
            return;
        }
        ...
        if (instance instanceof UpdateSettingsFlowWithDeviceAuthnMethod) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be UpdateSettingsFlowWithDeviceAuthnMethod, UpdateSettingsFlowWithLookupMethod, UpdateSettingsFlowWithOidcMethod, UpdateSettingsFlowWithPasskeyMethod, UpdateSettingsFlowWithPasswordMethod, UpdateSettingsFlowWithProfileMethod, UpdateSettingsFlowWithSamlMethod, UpdateSettingsFlowWithTotpMethod, UpdateSettingsFlowWithWebAuthnMethod");
    }
     ...
     * UpdateSettingsFlowWithDeviceAuthnMethod, UpdateSettingsFlowWithLookupMethod, UpdateSettingsFlowWithOidcMethod, UpdateSettingsFlowWithPasskeyMethod, UpdateSettingsFlowWithPasswordMethod, UpdateSettingsFlowWithProfileMethod, UpdateSettingsFlowWithSamlMethod, UpdateSettingsFlowWithTotpMethod, UpdateSettingsFlowWithWebAuthnMethod
     *
     * @return The actual instance (UpdateSettingsFlowWithDeviceAuthnMethod, UpdateSettingsFlowWithLookupMethod, UpdateSettingsFlowWithOidcMethod, UpdateSettingsFlowWithPasskeyMethod, UpdateSettingsFlowWithPasswordMethod, UpdateSettingsFlowWithProfileMethod, UpdateSettingsFlowWithSamlMethod, UpdateSettingsFlowWithTotpMethod, UpdateSettingsFlowWithWebAuthnMethod)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `UpdateSettingsFlowWithSamlMethod`. If the actual instance is not `UpdateSettingsFlowWithSamlMethod`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `UpdateSettingsFlowWithSamlMethod`
     * @throws ClassCastException if the instance is not `UpdateSettingsFlowWithSamlMethod`
     */
    public UpdateSettingsFlowWithSamlMethod getUpdateSettingsFlowWithSamlMethod() throws ClassCastException {
        return (UpdateSettingsFlowWithSamlMethod)super.getActualInstance();
    }
    ...
    /**
     * Get the actual instance of `UpdateSettingsFlowWithDeviceAuthnMethod`. If the actual instance is not `UpdateSettingsFlowWithDeviceAuthnMethod`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `UpdateSettingsFlowWithDeviceAuthnMethod`
     * @throws ClassCastException if the instance is not `UpdateSettingsFlowWithDeviceAuthnMethod`
     */
    public UpdateSettingsFlowWithDeviceAuthnMethod getUpdateSettingsFlowWithDeviceAuthnMethod() throws ClassCastException {
        return (UpdateSettingsFlowWithDeviceAuthnMethod)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with UpdateSettingsFlowWithSamlMethod
        try {
            UpdateSettingsFlowWithSamlMethod.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        // validate the json string with UpdateSettingsFlowWithDeviceAuthnMethod
        try {
            UpdateSettingsFlowWithDeviceAuthnMethod.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UpdateSettingsFlowBody with oneOf schemas: UpdateSettingsFlowWithDeviceAuthnMethod, UpdateSettingsFlowWithLookupMethod, UpdateSettingsFlowWithOidcMethod, UpdateSettingsFlowWithPasskeyMethod, UpdateSettingsFlowWithPasswordMethod, UpdateSettingsFlowWithProfileMethod, UpdateSettingsFlowWithSamlMethod, UpdateSettingsFlowWithTotpMethod, UpdateSettingsFlowWithWebAuthnMethod. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
