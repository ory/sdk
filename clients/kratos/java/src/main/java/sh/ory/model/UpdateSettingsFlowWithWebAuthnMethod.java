...
public class UpdateSettingsFlowWithWebAuthnMethod {
  ...
  public UpdateSettingsFlowWithWebAuthnMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateSettingsFlowWithWebAuthnMethod method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateSettingsFlowWithWebAuthnMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
  ...
  public UpdateSettingsFlowWithWebAuthnMethod webauthnRegister(@javax.annotation.Nullable String webauthnRegister) {
  ...
  public void setWebauthnRegister(@javax.annotation.Nullable String webauthnRegister) {
    this.webauthnRegister = webauthnRegister;
  }


  public UpdateSettingsFlowWithWebAuthnMethod webauthnRegisterDisplayname(@javax.annotation.Nullable String webauthnRegisterDisplayname) {
  ...
  public void setWebauthnRegisterDisplayname(@javax.annotation.Nullable String webauthnRegisterDisplayname) {
    this.webauthnRegisterDisplayname = webauthnRegisterDisplayname;
  }


  public UpdateSettingsFlowWithWebAuthnMethod webauthnRemove(@javax.annotation.Nullable String webauthnRemove) {
  ...
  public void setWebauthnRemove(@javax.annotation.Nullable String webauthnRemove) {
    this.webauthnRemove = webauthnRemove;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.csrfToken, updateSettingsFlowWithWebAuthnMethod.csrfToken) &&
        ...
        Objects.equals(this.transientPayload, updateSettingsFlowWithWebAuthnMethod.transientPayload) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(csrfToken, method, transientPayload, webauthnRegister, webauthnRegisterDisplayname, webauthnRemove, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSettingsFlowWithWebAuthnMethod
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSettingsFlowWithWebAuthnMethod.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
