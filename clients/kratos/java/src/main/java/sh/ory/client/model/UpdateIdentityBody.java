...
public class UpdateIdentityBody {
  ...
  public UpdateIdentityBody credentials(@javax.annotation.Nullable IdentityWithCredentials credentials) {
  ...
  public UpdateIdentityBody externalId(@javax.annotation.Nullable String externalId) {
  ...
  public UpdateIdentityBody metadataAdmin(@javax.annotation.Nullable Object metadataAdmin) {
  ...
  public UpdateIdentityBody metadataPublic(@javax.annotation.Nullable Object metadataPublic) {
  ...
  public UpdateIdentityBody region(@javax.annotation.Nullable RegionEnum region) {
    this.region = region;
    return this;
  }
  ...
  public UpdateIdentityBody schemaId(@javax.annotation.Nonnull String schemaId) {
  ...
  public UpdateIdentityBody state(@javax.annotation.Nonnull StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public UpdateIdentityBody traits(@javax.annotation.Nonnull Object traits) {
    this.traits = traits;
    return this;
  }
