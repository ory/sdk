...
public class UpdateLoginFlowWithLookupSecretMethod {
  ...
  public UpdateLoginFlowWithLookupSecretMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateLoginFlowWithLookupSecretMethod lookupSecret(@javax.annotation.Nonnull String lookupSecret) {
  ...
  public void setLookupSecret(@javax.annotation.Nonnull String lookupSecret) {
    this.lookupSecret = lookupSecret;
  }


  public UpdateLoginFlowWithLookupSecretMethod method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
   ...
   * @return the UpdateLoginFlowWithLookupSecretMethod instance itself
   */
  public UpdateLoginFlowWithLookupSecretMethod putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.csrfToken, updateLoginFlowWithLookupSecretMethod.csrfToken) &&
        ...
        Objects.equals(this.additionalProperties, updateLoginFlowWithLookupSecretMethod.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(csrfToken, lookupSecret, method, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateLoginFlowWithLookupSecretMethod
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateLoginFlowWithLookupSecretMethod.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateLoginFlowWithLookupSecretMethod>() {
           ...
           public UpdateLoginFlowWithLookupSecretMethod read(JsonReader in) throws IOException {
             ...
             UpdateLoginFlowWithLookupSecretMethod instance = thisAdapter.fromJsonTree(jsonObj);
