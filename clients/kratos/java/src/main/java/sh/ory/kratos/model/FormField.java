...
public class FormField {
  ...
  **/
  ...
  @ApiModelProperty(value = "Disabled is the equivalent of `<input {{if .Disabled}}disabled{{end}}\">`")
  ...
  public FormField messages(List<Message> messages) {
    
    this.messages = messages;
    return this;
  }

  public FormField addMessagesItem(Message messagesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.disabled, formField.disabled) &&
        Objects.equals(this.messages, formField.messages) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(disabled, messages, name, pattern, required, type, value);
  }
