...
public class IdentityCredentialsOidcProvider {
  ...
  public IdentityCredentialsOidcProvider initialAccessToken(@javax.annotation.Nullable String initialAccessToken) {
  ...
  public void setInitialAccessToken(@javax.annotation.Nullable String initialAccessToken) {
    this.initialAccessToken = initialAccessToken;
  }


  public IdentityCredentialsOidcProvider initialIdToken(@javax.annotation.Nullable String initialIdToken) {
  ...
  public void setInitialIdToken(@javax.annotation.Nullable String initialIdToken) {
    this.initialIdToken = initialIdToken;
  }


  public IdentityCredentialsOidcProvider initialRefreshToken(@javax.annotation.Nullable String initialRefreshToken) {
  ...
  public void setInitialRefreshToken(@javax.annotation.Nullable String initialRefreshToken) {
    this.initialRefreshToken = initialRefreshToken;
  }


  public IdentityCredentialsOidcProvider organization(@javax.annotation.Nullable String organization) {
  ...
  public IdentityCredentialsOidcProvider provider(@javax.annotation.Nullable String provider) {
  ...
  public IdentityCredentialsOidcProvider subject(@javax.annotation.Nullable String subject) {
  ...
  public IdentityCredentialsOidcProvider useAutoLink(@javax.annotation.Nullable Boolean useAutoLink) {
  ...
  public void setUseAutoLink(@javax.annotation.Nullable Boolean useAutoLink) {
    this.useAutoLink = useAutoLink;
  }
