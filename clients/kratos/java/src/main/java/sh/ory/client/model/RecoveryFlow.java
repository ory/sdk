...
public class RecoveryFlow {
  ...
  public RecoveryFlow active(@javax.annotation.Nullable String active) {
    this.active = active;
    return this;
  }
  ...
  public RecoveryFlow continueWith(@javax.annotation.Nullable List<ContinueWith> continueWith) {
  ...
  public RecoveryFlow expiresAt(@javax.annotation.Nonnull OffsetDateTime expiresAt) {
  ...
  public RecoveryFlow id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public RecoveryFlow issuedAt(@javax.annotation.Nonnull OffsetDateTime issuedAt) {
  ...
  public RecoveryFlow requestUrl(@javax.annotation.Nonnull String requestUrl) {
  ...
  public RecoveryFlow returnTo(@javax.annotation.Nullable String returnTo) {
  ...
  public RecoveryFlow state(@javax.annotation.Nullable Object state) {
    this.state = state;
    return this;
  }
  ...
  public RecoveryFlow transientPayload(@javax.annotation.Nullable Object transientPayload) {
  ...
  public RecoveryFlow type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public RecoveryFlow ui(@javax.annotation.Nonnull UiContainer ui) {
    this.ui = ui;
    return this;
  }
