...
import sh.ory.client.model.IdentityPatch;
...
public class PatchIdentitiesBody {
  ...
  public PatchIdentitiesBody identities(@javax.annotation.Nullable List<IdentityPatch> identities) {
  ...
  public void setIdentities(@javax.annotation.Nullable List<IdentityPatch> identities) {
    this.identities = identities;
  }
