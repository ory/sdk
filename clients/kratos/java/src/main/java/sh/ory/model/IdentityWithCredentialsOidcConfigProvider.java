...
public class IdentityWithCredentialsOidcConfigProvider {
  ...
  public IdentityWithCredentialsOidcConfigProvider organization(@javax.annotation.Nullable String organization) {
  ...
  public IdentityWithCredentialsOidcConfigProvider provider(@javax.annotation.Nonnull String provider) {
  ...
  public IdentityWithCredentialsOidcConfigProvider subject(@javax.annotation.Nonnull String subject) {
  ...
  public IdentityWithCredentialsOidcConfigProvider useAutoLink(@javax.annotation.Nullable Boolean useAutoLink) {
