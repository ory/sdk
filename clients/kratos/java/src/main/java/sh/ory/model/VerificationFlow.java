...
public class VerificationFlow {
  ...
  public VerificationFlow active(@javax.annotation.Nullable String active) {
    this.active = active;
    return this;
  }
  ...
  public VerificationFlow expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public VerificationFlow id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public VerificationFlow issuedAt(@javax.annotation.Nullable OffsetDateTime issuedAt) {
  ...
  public VerificationFlow requestUrl(@javax.annotation.Nullable String requestUrl) {
  ...
  public VerificationFlow returnTo(@javax.annotation.Nullable String returnTo) {
  ...
  public VerificationFlow state(@javax.annotation.Nullable Object state) {
    this.state = state;
    return this;
  }
  ...
  public VerificationFlow transientPayload(@javax.annotation.Nullable Object transientPayload) {
  ...
  public VerificationFlow type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public VerificationFlow ui(@javax.annotation.Nonnull UiContainer ui) {
    this.ui = ui;
    return this;
  }
