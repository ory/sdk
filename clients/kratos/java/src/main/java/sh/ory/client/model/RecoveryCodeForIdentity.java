...
public class RecoveryCodeForIdentity {
  ...
  public RecoveryCodeForIdentity expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public RecoveryCodeForIdentity recoveryCode(@javax.annotation.Nonnull String recoveryCode) {
  ...
  public void setRecoveryCode(@javax.annotation.Nonnull String recoveryCode) {
    this.recoveryCode = recoveryCode;
  }


  public RecoveryCodeForIdentity recoveryLink(@javax.annotation.Nonnull String recoveryLink) {
  ...
  public void setRecoveryLink(@javax.annotation.Nonnull String recoveryLink) {
    this.recoveryLink = recoveryLink;
  }
