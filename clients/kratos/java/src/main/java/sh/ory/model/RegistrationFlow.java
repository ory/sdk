...
public class RegistrationFlow {
  ...
  public RegistrationFlow active(@javax.annotation.Nullable ActiveEnum active) {
    this.active = active;
    return this;
  }
  ...
  public RegistrationFlow expiresAt(@javax.annotation.Nonnull OffsetDateTime expiresAt) {
  ...
  public RegistrationFlow id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public RegistrationFlow identitySchema(@javax.annotation.Nullable String identitySchema) {
  ...
  public RegistrationFlow issuedAt(@javax.annotation.Nonnull OffsetDateTime issuedAt) {
  ...
  public RegistrationFlow oauth2LoginChallenge(@javax.annotation.Nullable String oauth2LoginChallenge) {
  ...
  public RegistrationFlow oauth2LoginRequest(@javax.annotation.Nullable OAuth2LoginRequest oauth2LoginRequest) {
  ...
  public RegistrationFlow organizationId(@javax.annotation.Nullable String organizationId) {
  ...
  public RegistrationFlow requestUrl(@javax.annotation.Nonnull String requestUrl) {
  ...
  public RegistrationFlow returnTo(@javax.annotation.Nullable String returnTo) {
  ...
  public RegistrationFlow sessionTokenExchangeCode(@javax.annotation.Nullable String sessionTokenExchangeCode) {
  ...
  public RegistrationFlow state(@javax.annotation.Nullable Object state) {
    this.state = state;
    return this;
  }
  ...
  public RegistrationFlow transientPayload(@javax.annotation.Nullable Object transientPayload) {
  ...
  public RegistrationFlow type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public RegistrationFlow ui(@javax.annotation.Nonnull UiContainer ui) {
    this.ui = ui;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, registrationFlow.active) &&
        ...
        Objects.equals(this.identitySchema, registrationFlow.identitySchema) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, expiresAt, id, identitySchema, issuedAt, oauth2LoginChallenge, oauth2LoginRequest, organizationId, requestUrl, returnTo, sessionTokenExchangeCode, state, transientPayload, type, ui, additionalProperties);
  }
