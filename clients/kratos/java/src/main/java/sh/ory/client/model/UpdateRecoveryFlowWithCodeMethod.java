...
public class UpdateRecoveryFlowWithCodeMethod {
  ...
  public UpdateRecoveryFlowWithCodeMethod code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public UpdateRecoveryFlowWithCodeMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateRecoveryFlowWithCodeMethod email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public UpdateRecoveryFlowWithCodeMethod method(@javax.annotation.Nonnull MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateRecoveryFlowWithCodeMethod recoveryAddress(@javax.annotation.Nullable String recoveryAddress) {
  ...
  public void setRecoveryAddress(@javax.annotation.Nullable String recoveryAddress) {
    this.recoveryAddress = recoveryAddress;
  }


  public UpdateRecoveryFlowWithCodeMethod recoveryConfirmAddress(@javax.annotation.Nullable String recoveryConfirmAddress) {
  ...
  public void setRecoveryConfirmAddress(@javax.annotation.Nullable String recoveryConfirmAddress) {
    this.recoveryConfirmAddress = recoveryConfirmAddress;
  }


  public UpdateRecoveryFlowWithCodeMethod recoverySelectAddress(@javax.annotation.Nullable String recoverySelectAddress) {
  ...
  public void setRecoverySelectAddress(@javax.annotation.Nullable String recoverySelectAddress) {
    this.recoverySelectAddress = recoverySelectAddress;
  }


  public UpdateRecoveryFlowWithCodeMethod screen(@javax.annotation.Nullable String screen) {
    this.screen = screen;
    return this;
  }
  ...
  public UpdateRecoveryFlowWithCodeMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
