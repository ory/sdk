...
import sh.ory.client.model.UpdateLoginFlowWithCodeMethod;
import sh.ory.client.model.UpdateLoginFlowWithDeviceAuthnMethod;
import sh.ory.client.model.UpdateLoginFlowWithIdentifierFirstMethod;
import sh.ory.client.model.UpdateLoginFlowWithLookupSecretMethod;
import sh.ory.client.model.UpdateLoginFlowWithOidcMethod;
import sh.ory.client.model.UpdateLoginFlowWithPasskeyMethod;
import sh.ory.client.model.UpdateLoginFlowWithPasswordMethod;
import sh.ory.client.model.UpdateLoginFlowWithSamlMethod;
import sh.ory.client.model.UpdateLoginFlowWithTotpMethod;
import sh.ory.client.model.UpdateLoginFlowWithWebAuthnMethod;
...
public class UpdateLoginFlowBody extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<UpdateLoginFlowWithDeviceAuthnMethod> adapterUpdateLoginFlowWithDeviceAuthnMethod = gson.getDelegateAdapter(this, TypeToken.get(UpdateLoginFlowWithDeviceAuthnMethod.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateLoginFlowBody>() {
                ...
                public void write(JsonWriter out, UpdateLoginFlowBody value) throws IOException {
                    ...
                    // check if the actual instance is of the type `UpdateLoginFlowWithDeviceAuthnMethod`
                    if (value.getActualInstance() instanceof UpdateLoginFlowWithDeviceAuthnMethod) {
                        JsonElement element = adapterUpdateLoginFlowWithDeviceAuthnMethod.toJsonTree((UpdateLoginFlowWithDeviceAuthnMethod)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: UpdateLoginFlowWithCodeMethod, UpdateLoginFlowWithDeviceAuthnMethod, UpdateLoginFlowWithIdentifierFirstMethod, UpdateLoginFlowWithLookupSecretMethod, UpdateLoginFlowWithOidcMethod, UpdateLoginFlowWithPasskeyMethod, UpdateLoginFlowWithPasswordMethod, UpdateLoginFlowWithSamlMethod, UpdateLoginFlowWithTotpMethod, UpdateLoginFlowWithWebAuthnMethod");
                }
                ...
                public UpdateLoginFlowBody read(JsonReader in) throws IOException {
                    ...
                    if (jsonObject.get("method") == null) {
                        ...
                        switch (jsonObject.get("method").getAsString()) {
                            ...
                            case "deviceauthn":
                                deserialized = adapterUpdateLoginFlowWithDeviceAuthnMethod.fromJsonTree(jsonObject);
                                newUpdateLoginFlowBody.setActualInstance(deserialized);
                                return newUpdateLoginFlowBody;
                            ...
                            case "updateLoginFlowWithCodeMethod":
                                ...
                                newUpdateLoginFlowBody.setActualInstance(deserialized);
                                return newUpdateLoginFlowBody;
                            case "updateLoginFlowWithDeviceAuthnMethod":
                                deserialized = adapterUpdateLoginFlowWithDeviceAuthnMethod.fromJsonTree(jsonObject);
                                newUpdateLoginFlowBody.setActualInstance(deserialized);
                                return newUpdateLoginFlowBody;
                            ...
                            case "updateLoginFlowWithWebAuthnMethod":
                                ...
                                return newUpdateLoginFlowBody;
                            default:
                                log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for UpdateLoginFlowBody. Possible values: code deviceauthn identifier_first lookup_secret oidc passkey password saml totp webauthn updateLoginFlowWithCodeMethod updateLoginFlowWithDeviceAuthnMethod updateLoginFlowWithIdentifierFirstMethod updateLoginFlowWithLookupSecretMethod updateLoginFlowWithOidcMethod updateLoginFlowWithPasskeyMethod updateLoginFlowWithPasswordMethod updateLoginFlowWithSamlMethod updateLoginFlowWithTotpMethod updateLoginFlowWithWebAuthnMethod", jsonObject.get("method").getAsString()));
                        }
                    }
                    ...
                    // deserialize UpdateLoginFlowWithDeviceAuthnMethod
                    try {
                        // validate the JSON object to see if any exception is thrown
                        UpdateLoginFlowWithDeviceAuthnMethod.validateJsonElement(jsonElement);
                        actualAdapter = adapterUpdateLoginFlowWithDeviceAuthnMethod;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'UpdateLoginFlowWithDeviceAuthnMethod'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for UpdateLoginFlowWithDeviceAuthnMethod failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'UpdateLoginFlowWithDeviceAuthnMethod'", e);
                    }
    ...
    static {
        ...
        schemas.put("UpdateLoginFlowWithDeviceAuthnMethod", UpdateLoginFlowWithDeviceAuthnMethod.class);
     ...
     * UpdateLoginFlowWithCodeMethod, UpdateLoginFlowWithDeviceAuthnMethod, UpdateLoginFlowWithIdentifierFirstMethod, UpdateLoginFlowWithLookupSecretMethod, UpdateLoginFlowWithOidcMethod, UpdateLoginFlowWithPasskeyMethod, UpdateLoginFlowWithPasswordMethod, UpdateLoginFlowWithSamlMethod, UpdateLoginFlowWithTotpMethod, UpdateLoginFlowWithWebAuthnMethod
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof UpdateLoginFlowWithDeviceAuthnMethod) {
            super.setActualInstance(instance);
            return;
        }
        ...
        throw new RuntimeException("Invalid instance type. Must be UpdateLoginFlowWithCodeMethod, UpdateLoginFlowWithDeviceAuthnMethod, UpdateLoginFlowWithIdentifierFirstMethod, UpdateLoginFlowWithLookupSecretMethod, UpdateLoginFlowWithOidcMethod, UpdateLoginFlowWithPasskeyMethod, UpdateLoginFlowWithPasswordMethod, UpdateLoginFlowWithSamlMethod, UpdateLoginFlowWithTotpMethod, UpdateLoginFlowWithWebAuthnMethod");
    }
     ...
     * UpdateLoginFlowWithCodeMethod, UpdateLoginFlowWithDeviceAuthnMethod, UpdateLoginFlowWithIdentifierFirstMethod, UpdateLoginFlowWithLookupSecretMethod, UpdateLoginFlowWithOidcMethod, UpdateLoginFlowWithPasskeyMethod, UpdateLoginFlowWithPasswordMethod, UpdateLoginFlowWithSamlMethod, UpdateLoginFlowWithTotpMethod, UpdateLoginFlowWithWebAuthnMethod
     *
     * @return The actual instance (UpdateLoginFlowWithCodeMethod, UpdateLoginFlowWithDeviceAuthnMethod, UpdateLoginFlowWithIdentifierFirstMethod, UpdateLoginFlowWithLookupSecretMethod, UpdateLoginFlowWithOidcMethod, UpdateLoginFlowWithPasskeyMethod, UpdateLoginFlowWithPasswordMethod, UpdateLoginFlowWithSamlMethod, UpdateLoginFlowWithTotpMethod, UpdateLoginFlowWithWebAuthnMethod)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `UpdateLoginFlowWithDeviceAuthnMethod`. If the actual instance is not `UpdateLoginFlowWithDeviceAuthnMethod`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `UpdateLoginFlowWithDeviceAuthnMethod`
     * @throws ClassCastException if the instance is not `UpdateLoginFlowWithDeviceAuthnMethod`
     */
    public UpdateLoginFlowWithDeviceAuthnMethod getUpdateLoginFlowWithDeviceAuthnMethod() throws ClassCastException {
        return (UpdateLoginFlowWithDeviceAuthnMethod)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with UpdateLoginFlowWithDeviceAuthnMethod
        try {
            UpdateLoginFlowWithDeviceAuthnMethod.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UpdateLoginFlowBody with oneOf schemas: UpdateLoginFlowWithCodeMethod, UpdateLoginFlowWithDeviceAuthnMethod, UpdateLoginFlowWithIdentifierFirstMethod, UpdateLoginFlowWithLookupSecretMethod, UpdateLoginFlowWithOidcMethod, UpdateLoginFlowWithPasskeyMethod, UpdateLoginFlowWithPasswordMethod, UpdateLoginFlowWithSamlMethod, UpdateLoginFlowWithTotpMethod, UpdateLoginFlowWithWebAuthnMethod. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
