...
public class UpdateRegistrationFlowWithPasskeyMethod {
  ...
  public UpdateRegistrationFlowWithPasskeyMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateRegistrationFlowWithPasskeyMethod method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateRegistrationFlowWithPasskeyMethod passkeyRegister(@javax.annotation.Nullable String passkeyRegister) {
  ...
  public void setPasskeyRegister(@javax.annotation.Nullable String passkeyRegister) {
    this.passkeyRegister = passkeyRegister;
  }


  public UpdateRegistrationFlowWithPasskeyMethod traits(@javax.annotation.Nonnull Object traits) {
    this.traits = traits;
    return this;
  }
  ...
  public UpdateRegistrationFlowWithPasskeyMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
