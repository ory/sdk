...
public class OAuth2ConsentRequestOpenIDConnectContext {
  ...
  public OAuth2ConsentRequestOpenIDConnectContext acrValues(@javax.annotation.Nullable List<String> acrValues) {
  ...
  public void setAcrValues(@javax.annotation.Nullable List<String> acrValues) {
    this.acrValues = acrValues;
  }


  public OAuth2ConsentRequestOpenIDConnectContext display(@javax.annotation.Nullable String display) {
  ...
  public OAuth2ConsentRequestOpenIDConnectContext idTokenHintClaims(@javax.annotation.Nullable Map<String, Object> idTokenHintClaims) {
  ...
  public void setIdTokenHintClaims(@javax.annotation.Nullable Map<String, Object> idTokenHintClaims) {
    this.idTokenHintClaims = idTokenHintClaims;
  }


  public OAuth2ConsentRequestOpenIDConnectContext loginHint(@javax.annotation.Nullable String loginHint) {
  ...
  public OAuth2ConsentRequestOpenIDConnectContext uiLocales(@javax.annotation.Nullable List<String> uiLocales) {
