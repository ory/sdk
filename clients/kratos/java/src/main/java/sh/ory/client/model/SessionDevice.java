...
public class SessionDevice {
  ...
  public SessionDevice id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public SessionDevice ipAddress(@javax.annotation.Nullable String ipAddress) {
  ...
  public SessionDevice location(@javax.annotation.Nullable String location) {
  ...
  public SessionDevice userAgent(@javax.annotation.Nullable String userAgent) {
