...
public class UiNodeScriptAttributes {
  ...
  public UiNodeScriptAttributes async(@javax.annotation.Nonnull Boolean async) {
    this.async = async;
    return this;
  }
  ...
  public void setAsync(@javax.annotation.Nonnull Boolean async) {
    this.async = async;
  }


  public UiNodeScriptAttributes crossorigin(@javax.annotation.Nonnull String crossorigin) {
  ...
  public void setCrossorigin(@javax.annotation.Nonnull String crossorigin) {
    this.crossorigin = crossorigin;
  }


  public UiNodeScriptAttributes id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public UiNodeScriptAttributes integrity(@javax.annotation.Nonnull String integrity) {
  ...
  public void setIntegrity(@javax.annotation.Nonnull String integrity) {
    this.integrity = integrity;
  }


  public UiNodeScriptAttributes nodeType(@javax.annotation.Nonnull NodeTypeEnum nodeType) {
  ...
  public UiNodeScriptAttributes nonce(@javax.annotation.Nonnull String nonce) {
    this.nonce = nonce;
    return this;
  }
  ...
  public UiNodeScriptAttributes referrerpolicy(@javax.annotation.Nonnull String referrerpolicy) {
  ...
  public void setReferrerpolicy(@javax.annotation.Nonnull String referrerpolicy) {
    this.referrerpolicy = referrerpolicy;
  }


  public UiNodeScriptAttributes src(@javax.annotation.Nonnull String src) {
    this.src = src;
    return this;
  }
  ...
  public UiNodeScriptAttributes type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UiNodeScriptAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UiNodeScriptAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
