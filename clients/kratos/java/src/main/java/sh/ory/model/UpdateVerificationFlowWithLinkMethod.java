...
public class UpdateVerificationFlowWithLinkMethod {
  ...
  public UpdateVerificationFlowWithLinkMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateVerificationFlowWithLinkMethod email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public UpdateVerificationFlowWithLinkMethod method(@javax.annotation.Nonnull MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateVerificationFlowWithLinkMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
