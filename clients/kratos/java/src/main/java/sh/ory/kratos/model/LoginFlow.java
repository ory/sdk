...
import sh.ory.kratos.model.LoginFlowTestContext;
...
public class LoginFlow {
  ...
  public LoginFlow active(@javax.annotation.Nullable ActiveEnum active) {
    this.active = active;
    return this;
  }
  ...
  public void setActive(@javax.annotation.Nullable ActiveEnum active) {
    this.active = active;
  }


  public LoginFlow createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public LoginFlow expiresAt(@javax.annotation.Nonnull OffsetDateTime expiresAt) {
  ...
  public LoginFlow id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public LoginFlow identitySchema(@javax.annotation.Nullable String identitySchema) {
  ...
  public void setIdentitySchema(@javax.annotation.Nullable String identitySchema) {
    this.identitySchema = identitySchema;
  }


  public LoginFlow issuedAt(@javax.annotation.Nonnull OffsetDateTime issuedAt) {
  ...
  public LoginFlow oauth2LoginChallenge(@javax.annotation.Nullable String oauth2LoginChallenge) {
  ...
  public void setOauth2LoginChallenge(@javax.annotation.Nullable String oauth2LoginChallenge) {
    this.oauth2LoginChallenge = oauth2LoginChallenge;
  }


  public LoginFlow oauth2LoginRequest(@javax.annotation.Nullable OAuth2LoginRequest oauth2LoginRequest) {
  ...
  public void setOauth2LoginRequest(@javax.annotation.Nullable OAuth2LoginRequest oauth2LoginRequest) {
    this.oauth2LoginRequest = oauth2LoginRequest;
  }


  public LoginFlow organizationId(@javax.annotation.Nullable String organizationId) {
  ...
  public LoginFlow refresh(@javax.annotation.Nullable Boolean refresh) {
  ...
  public LoginFlow requestUrl(@javax.annotation.Nonnull String requestUrl) {
  ...
  public LoginFlow requestedAal(@javax.annotation.Nullable AuthenticatorAssuranceLevel requestedAal) {
  ...
  public void setRequestedAal(@javax.annotation.Nullable AuthenticatorAssuranceLevel requestedAal) {
    this.requestedAal = requestedAal;
  }


  public LoginFlow returnTo(@javax.annotation.Nullable String returnTo) {
  ...
  public LoginFlow sessionTokenExchangeCode(@javax.annotation.Nullable String sessionTokenExchangeCode) {
  ...
  public void setSessionTokenExchangeCode(@javax.annotation.Nullable String sessionTokenExchangeCode) {
    this.sessionTokenExchangeCode = sessionTokenExchangeCode;
  }


  public LoginFlow state(@javax.annotation.Nullable Object state) {
    this.state = state;
    return this;
  }
  ...
  public LoginFlow testContext(@javax.annotation.Nullable LoginFlowTestContext testContext) {
  ...
  public void setTestContext(@javax.annotation.Nullable LoginFlowTestContext testContext) {
    this.testContext = testContext;
  }


  public LoginFlow transientPayload(@javax.annotation.Nullable Object transientPayload) {
  ...
  public LoginFlow type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public LoginFlow ui(@javax.annotation.Nonnull UiContainer ui) {
    this.ui = ui;
    return this;
  }
  ...
  public LoginFlow updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
