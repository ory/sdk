...
public class BatchPatchIdentitiesResponse {
  ...
  public BatchPatchIdentitiesResponse identities(@javax.annotation.Nullable List<IdentityPatchResponse> identities) {
  ...
  public void setIdentities(@javax.annotation.Nullable List<IdentityPatchResponse> identities) {
    this.identities = identities;
  }
