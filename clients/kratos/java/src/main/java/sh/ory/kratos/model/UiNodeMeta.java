...
public class UiNodeMeta {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UiNodeMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UiNodeMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
