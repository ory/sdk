...
import sh.ory.client.model.UiNodeAnchorAttributes;
import sh.ory.client.model.UiNodeDivisionAttributes;
import sh.ory.client.model.UiNodeImageAttributes;
import sh.ory.client.model.UiNodeInputAttributes;
import sh.ory.client.model.UiNodeInputAttributesOption;
import sh.ory.client.model.UiNodeScriptAttributes;
import sh.ory.client.model.UiNodeTextAttributes;
...
public class UiNodeAttributes extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<UiNodeDivisionAttributes> adapterUiNodeDivisionAttributes = gson.getDelegateAdapter(this, TypeToken.get(UiNodeDivisionAttributes.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<UiNodeAttributes>() {
                ...
                public void write(JsonWriter out, UiNodeAttributes value) throws IOException {
                    ...
                    // check if the actual instance is of the type `UiNodeDivisionAttributes`
                    if (value.getActualInstance() instanceof UiNodeDivisionAttributes) {
                        JsonElement element = adapterUiNodeDivisionAttributes.toJsonTree((UiNodeDivisionAttributes)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: UiNodeAnchorAttributes, UiNodeDivisionAttributes, UiNodeImageAttributes, UiNodeInputAttributes, UiNodeScriptAttributes, UiNodeTextAttributes");
                }
                ...
                public UiNodeAttributes read(JsonReader in) throws IOException {
                    ...
                    if (jsonObject.get("node_type") == null) {
                        ...
                        switch (jsonObject.get("node_type").getAsString()) {
                            ...
                            case "div":
                                deserialized = adapterUiNodeDivisionAttributes.fromJsonTree(jsonObject);
                                newUiNodeAttributes.setActualInstance(deserialized);
                                return newUiNodeAttributes;
                            case "img":
                            ...
                            case "uiNodeTextAttributes":
                                ...
                                return newUiNodeAttributes;
                            default:
                                log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for UiNodeAttributes. Possible values: a div img input script text uiNodeAnchorAttributes uiNodeDivisionAttributes uiNodeImageAttributes uiNodeInputAttributes uiNodeScriptAttributes uiNodeTextAttributes", jsonObject.get("node_type").getAsString()));
                        }
                    }
                    ...
                    // deserialize UiNodeDivisionAttributes
                    try {
                        // validate the JSON object to see if any exception is thrown
                        UiNodeDivisionAttributes.validateJsonElement(jsonElement);
                        actualAdapter = adapterUiNodeDivisionAttributes;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'UiNodeDivisionAttributes'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for UiNodeDivisionAttributes failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'UiNodeDivisionAttributes'", e);
                    }
    ...
    static {
        ...
        schemas.put("UiNodeDivisionAttributes", UiNodeDivisionAttributes.class);
    }
     ...
     * UiNodeAnchorAttributes, UiNodeDivisionAttributes, UiNodeImageAttributes, UiNodeInputAttributes, UiNodeScriptAttributes, UiNodeTextAttributes
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof UiNodeDivisionAttributes) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be UiNodeAnchorAttributes, UiNodeDivisionAttributes, UiNodeImageAttributes, UiNodeInputAttributes, UiNodeScriptAttributes, UiNodeTextAttributes");
    }
     ...
     * UiNodeAnchorAttributes, UiNodeDivisionAttributes, UiNodeImageAttributes, UiNodeInputAttributes, UiNodeScriptAttributes, UiNodeTextAttributes
     *
     * @return The actual instance (UiNodeAnchorAttributes, UiNodeDivisionAttributes, UiNodeImageAttributes, UiNodeInputAttributes, UiNodeScriptAttributes, UiNodeTextAttributes)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `UiNodeDivisionAttributes`. If the actual instance is not `UiNodeDivisionAttributes`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `UiNodeDivisionAttributes`
     * @throws ClassCastException if the instance is not `UiNodeDivisionAttributes`
     */
    public UiNodeDivisionAttributes getUiNodeDivisionAttributes() throws ClassCastException {
        return (UiNodeDivisionAttributes)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with UiNodeDivisionAttributes
        try {
            UiNodeDivisionAttributes.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UiNodeAttributes with oneOf schemas: UiNodeAnchorAttributes, UiNodeDivisionAttributes, UiNodeImageAttributes, UiNodeInputAttributes, UiNodeScriptAttributes, UiNodeTextAttributes. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
