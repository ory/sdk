...
public class ContinueWithSetOrySessionToken {
  ...
  public ContinueWithSetOrySessionToken action(@javax.annotation.Nonnull ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public ContinueWithSetOrySessionToken orySessionToken(@javax.annotation.Nonnull String orySessionToken) {
  ...
  public void setOrySessionToken(@javax.annotation.Nonnull String orySessionToken) {
    this.orySessionToken = orySessionToken;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContinueWithSetOrySessionToken
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContinueWithSetOrySessionToken.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
