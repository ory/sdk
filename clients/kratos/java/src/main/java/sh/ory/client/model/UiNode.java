...
import sh.ory.client.model.UiNodeAttributes;
import sh.ory.client.model.UiNodeMeta;
...
public class UiNode {
  ...
  public UiNode attributes(@javax.annotation.Nonnull UiNodeAttributes attributes) {
  ...
  public void setAttributes(@javax.annotation.Nonnull UiNodeAttributes attributes) {
    this.attributes = attributes;
  }


  public UiNode group(@javax.annotation.Nonnull GroupEnum group) {
    this.group = group;
    return this;
  }
  ...
  public UiNode messages(@javax.annotation.Nonnull List<UiText> messages) {
  ...
  public void setMessages(@javax.annotation.Nonnull List<UiText> messages) {
    this.messages = messages;
  }


  public UiNode meta(@javax.annotation.Nonnull UiNodeMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public void setMeta(@javax.annotation.Nonnull UiNodeMeta meta) {
    this.meta = meta;
  }


  public UiNode type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
