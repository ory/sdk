...
public class UpdateLoginFlowWithIdentifierFirstMethod {
  ...
  public UpdateLoginFlowWithIdentifierFirstMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateLoginFlowWithIdentifierFirstMethod identifier(@javax.annotation.Nonnull String identifier) {
  ...
  public UpdateLoginFlowWithIdentifierFirstMethod method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateLoginFlowWithIdentifierFirstMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
