...
public class IdentityPatchResponse {
  ...
  public IdentityPatchResponse action(@javax.annotation.Nullable ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public IdentityPatchResponse error(@javax.annotation.Nullable Object error) {
    this.error = error;
    return this;
  }
  ...
  public IdentityPatchResponse identity(@javax.annotation.Nullable String identity) {
  ...
  public IdentityPatchResponse patchId(@javax.annotation.Nullable String patchId) {
