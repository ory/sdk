...
public class RecoveryLinkForIdentity {
  ...
  public RecoveryLinkForIdentity expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public RecoveryLinkForIdentity recoveryLink(@javax.annotation.Nonnull String recoveryLink) {
