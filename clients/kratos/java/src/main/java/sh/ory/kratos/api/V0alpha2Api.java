...
import sh.ory.kratos.model.IdentitySchema;
import sh.ory.kratos.model.JsonError;
import sh.ory.kratos.model.SelfServiceBrowserLocationChangeRequiredError;
...
public class V0alpha2Api {
    ...
    public okhttp3.Call adminDeleteIdentitySessionsCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/identities/{id}/sessions"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
