...
public class IdentityCredentialsPassword {
  ...
  public IdentityCredentialsPassword hashedPassword(@javax.annotation.Nullable String hashedPassword) {
  ...
  public IdentityCredentialsPassword usePasswordMigrationHook(@javax.annotation.Nullable Boolean usePasswordMigrationHook) {
