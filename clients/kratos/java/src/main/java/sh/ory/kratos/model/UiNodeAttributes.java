...
public class UiNodeAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(disabled, label, name, nodeType, onclick, pattern, required, type, value, id, text, height, src, width, href, title, async, crossorigin, integrity, referrerpolicy);
  }
