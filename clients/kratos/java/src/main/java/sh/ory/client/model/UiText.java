...
public class UiText {
  ...
  public UiText context(@javax.annotation.Nullable Object context) {
  ...
  public UiText id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public UiText text(@javax.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
  ...
  public UiText type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UiText
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UiText.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
