...
public class UpdateRecoveryFlowWithLinkMethod {
  ...
  public UpdateRecoveryFlowWithLinkMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateRecoveryFlowWithLinkMethod email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public UpdateRecoveryFlowWithLinkMethod method(@javax.annotation.Nonnull MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateRecoveryFlowWithLinkMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
