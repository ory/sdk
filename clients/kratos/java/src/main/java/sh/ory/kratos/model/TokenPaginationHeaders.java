...
public class TokenPaginationHeaders {
  ...
  public TokenPaginationHeaders link(@javax.annotation.Nullable String link) {
    this.link = link;
    return this;
  }
  ...
  public TokenPaginationHeaders xTotalCount(@javax.annotation.Nullable String xTotalCount) {
  ...
  public void setxTotalCount(@javax.annotation.Nullable String xTotalCount) {
    this.xTotalCount = xTotalCount;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TokenPaginationHeaders
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenPaginationHeaders.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
