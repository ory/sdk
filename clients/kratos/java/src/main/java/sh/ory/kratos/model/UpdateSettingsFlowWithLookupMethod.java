...
public class UpdateSettingsFlowWithLookupMethod {
  ...
  public UpdateSettingsFlowWithLookupMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateSettingsFlowWithLookupMethod lookupSecretConfirm(@javax.annotation.Nullable Boolean lookupSecretConfirm) {
  ...
  public void setLookupSecretConfirm(@javax.annotation.Nullable Boolean lookupSecretConfirm) {
    this.lookupSecretConfirm = lookupSecretConfirm;
  }


  public UpdateSettingsFlowWithLookupMethod lookupSecretDisable(@javax.annotation.Nullable Boolean lookupSecretDisable) {
  ...
  public void setLookupSecretDisable(@javax.annotation.Nullable Boolean lookupSecretDisable) {
    this.lookupSecretDisable = lookupSecretDisable;
  }


  public UpdateSettingsFlowWithLookupMethod lookupSecretRegenerate(@javax.annotation.Nullable Boolean lookupSecretRegenerate) {
  ...
  public void setLookupSecretRegenerate(@javax.annotation.Nullable Boolean lookupSecretRegenerate) {
    this.lookupSecretRegenerate = lookupSecretRegenerate;
  }


  public UpdateSettingsFlowWithLookupMethod lookupSecretReveal(@javax.annotation.Nullable Boolean lookupSecretReveal) {
  ...
  public void setLookupSecretReveal(@javax.annotation.Nullable Boolean lookupSecretReveal) {
    this.lookupSecretReveal = lookupSecretReveal;
  }


  public UpdateSettingsFlowWithLookupMethod method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateSettingsFlowWithLookupMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
