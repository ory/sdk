...
public class CreateIdentityBody {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(credentials, metadataAdmin, metadataPublic, organizationId, recoveryAddresses, schemaId, state, traits, verifiableAddresses, additionalProperties);
  }
