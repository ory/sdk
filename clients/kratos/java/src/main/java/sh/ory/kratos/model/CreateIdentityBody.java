...
public class CreateIdentityBody {
  ...
  public CreateIdentityBody externalId(String externalId) {
  ...
  public CreateIdentityBody organizationId(String organizationId) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(credentials, externalId, metadataAdmin, metadataPublic, organizationId, recoveryAddresses, schemaId, state, traits, verifiableAddresses, additionalProperties);
  }
