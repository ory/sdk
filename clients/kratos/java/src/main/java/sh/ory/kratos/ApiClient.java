...
public class ApiClient {
    ...
    private String basePath = "https://demo.tenants.oryapis.com/api/kratos/public";
    ...
    public ApiClient() {
        ...
        authentications.put("sessionToken", new ApiKeyAuth("header", "X-Session-Token"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v0.6.0-alpha.17/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://demo.tenants.oryapis.com/api/kratos/public
