...
public class IdentityPatch {
  ...
  public IdentityPatch create(@javax.annotation.Nullable CreateIdentityBody create) {
    this.create = create;
    return this;
  }
  ...
  public void setCreate(@javax.annotation.Nullable CreateIdentityBody create) {
    this.create = create;
  }


  public IdentityPatch patchId(@javax.annotation.Nullable String patchId) {
  ...
  public void setPatchId(@javax.annotation.Nullable String patchId) {
    this.patchId = patchId;
  }
