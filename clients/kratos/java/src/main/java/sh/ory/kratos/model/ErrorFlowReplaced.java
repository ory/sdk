...
public class ErrorFlowReplaced {
  ...
  public ErrorFlowReplaced error(@javax.annotation.Nullable GenericError error) {
    this.error = error;
    return this;
  }
  ...
  public ErrorFlowReplaced useFlowId(@javax.annotation.Nullable String useFlowId) {
