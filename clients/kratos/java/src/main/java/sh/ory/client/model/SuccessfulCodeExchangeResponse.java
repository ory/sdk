...
public class SuccessfulCodeExchangeResponse {
  ...
  public SuccessfulCodeExchangeResponse session(@javax.annotation.Nonnull Session session) {
  ...
  public SuccessfulCodeExchangeResponse sessionToken(@javax.annotation.Nullable String sessionToken) {
