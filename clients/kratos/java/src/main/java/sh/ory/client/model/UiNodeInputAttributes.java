...
public class UiNodeInputAttributes {
  ...
  @javax.annotation.Nullable
  private List<UiNodeInputAttributesOption> options = new ArrayList<>();
  ...
  public UiNodeInputAttributes autocomplete(@javax.annotation.Nullable AutocompleteEnum autocomplete) {
  ...
  public void setAutocomplete(@javax.annotation.Nullable AutocompleteEnum autocomplete) {
    this.autocomplete = autocomplete;
  }


  public UiNodeInputAttributes disabled(@javax.annotation.Nonnull Boolean disabled) {
  ...
  public UiNodeInputAttributes label(@javax.annotation.Nullable UiText label) {
    this.label = label;
    return this;
  }
  ...
  public UiNodeInputAttributes maxlength(@javax.annotation.Nullable Long maxlength) {
  ...
  public UiNodeInputAttributes name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UiNodeInputAttributes nodeType(@javax.annotation.Nonnull NodeTypeEnum nodeType) {
  ...
  public UiNodeInputAttributes onclick(@javax.annotation.Nullable String onclick) {
  ...
  public void setOnclick(@javax.annotation.Nullable String onclick) {
    this.onclick = onclick;
  }


  public UiNodeInputAttributes onclickTrigger(@javax.annotation.Nullable OnclickTriggerEnum onclickTrigger) {
  ...
  public void setOnclickTrigger(@javax.annotation.Nullable OnclickTriggerEnum onclickTrigger) {
    this.onclickTrigger = onclickTrigger;
  }


  public UiNodeInputAttributes onload(@javax.annotation.Nullable String onload) {
    this.onload = onload;
    return this;
  }
  ...
  public void setOnload(@javax.annotation.Nullable String onload) {
    this.onload = onload;
  }


  public UiNodeInputAttributes onloadTrigger(@javax.annotation.Nullable OnloadTriggerEnum onloadTrigger) {
  ...
  public void setOnloadTrigger(@javax.annotation.Nullable OnloadTriggerEnum onloadTrigger) {
    this.onloadTrigger = onloadTrigger;
  }


  public UiNodeInputAttributes options(@javax.annotation.Nullable List<UiNodeInputAttributesOption> options) {
    this.options = options;
    return this;
  }

  public UiNodeInputAttributes addOptionsItem(UiNodeInputAttributesOption optionsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<UiNodeInputAttributesOption> getOptions() {
    return options;
  }

  public void setOptions(@javax.annotation.Nullable List<UiNodeInputAttributesOption> options) {
    this.options = options;
  }


  public UiNodeInputAttributes pattern(@javax.annotation.Nullable String pattern) {
  ...
  public UiNodeInputAttributes required(@javax.annotation.Nullable Boolean required) {
  ...
  public UiNodeInputAttributes type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public UiNodeInputAttributes value(@javax.annotation.Nullable Object value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autocomplete, uiNodeInputAttributes.autocomplete) &&
        ...
        Objects.equals(this.options, uiNodeInputAttributes.options) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autocomplete, disabled, label, maxlength, name, nodeType, onclick, onclickTrigger, onload, onloadTrigger, options, pattern, required, type, value, additionalProperties);
  }
      ...
      if (jsonObj.get("options") != null && !jsonObj.get("options").isJsonNull()) {
        ...
        if (jsonArrayoptions != null) {
          ...
          for (int i = 0; i < jsonArrayoptions.size(); i++) {
            UiNodeInputAttributesOption.validateJsonElement(jsonArrayoptions.get(i));
          };
        }
      }
