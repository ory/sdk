...
public class UiNodeTextAttributes {
  ...
  public UiNodeTextAttributes id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public UiNodeTextAttributes nodeType(@javax.annotation.Nonnull NodeTypeEnum nodeType) {
  ...
  public UiNodeTextAttributes text(@javax.annotation.Nonnull UiText text) {
    this.text = text;
    return this;
  }
  ...
  public void setText(@javax.annotation.Nonnull UiText text) {
    this.text = text;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UiNodeTextAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UiNodeTextAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      UiText.validateJsonElement(jsonObj.get("text"));
  }
