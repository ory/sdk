...
public class VerifiableIdentityAddress {
  ...
  public VerifiableIdentityAddress createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public VerifiableIdentityAddress id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public VerifiableIdentityAddress status(@javax.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public VerifiableIdentityAddress updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  public VerifiableIdentityAddress value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  public VerifiableIdentityAddress verified(@javax.annotation.Nonnull Boolean verified) {
  ...
  public VerifiableIdentityAddress verifiedAt(@javax.annotation.Nullable OffsetDateTime verifiedAt) {
  ...
  public VerifiableIdentityAddress via(@javax.annotation.Nonnull ViaEnum via) {
    this.via = via;
    return this;
  }
  ...
  public void setVia(@javax.annotation.Nonnull ViaEnum via) {
    this.via = via;
  }
