...
public class CreateRecoveryLinkForIdentityBody {
  ...
  public CreateRecoveryLinkForIdentityBody expiresIn(@javax.annotation.Nullable String expiresIn) {
  ...
  public CreateRecoveryLinkForIdentityBody identityId(@javax.annotation.Nonnull String identityId) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRecoveryLinkForIdentityBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRecoveryLinkForIdentityBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
