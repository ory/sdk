...
public class UpdateLoginFlowWithOidcMethod {
  ...
  public UpdateLoginFlowWithOidcMethod csrfToken(@javax.annotation.Nullable String csrfToken) {
  ...
  public UpdateLoginFlowWithOidcMethod idToken(@javax.annotation.Nullable String idToken) {
  ...
  public UpdateLoginFlowWithOidcMethod idTokenNonce(@javax.annotation.Nullable String idTokenNonce) {
  ...
  public void setIdTokenNonce(@javax.annotation.Nullable String idTokenNonce) {
    this.idTokenNonce = idTokenNonce;
  }


  public UpdateLoginFlowWithOidcMethod method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public UpdateLoginFlowWithOidcMethod provider(@javax.annotation.Nonnull String provider) {
  ...
  public UpdateLoginFlowWithOidcMethod traits(@javax.annotation.Nullable Object traits) {
    this.traits = traits;
    return this;
  }
  ...
  public UpdateLoginFlowWithOidcMethod transientPayload(@javax.annotation.Nullable Object transientPayload) {
  ...
  public UpdateLoginFlowWithOidcMethod upstreamParameters(@javax.annotation.Nullable Object upstreamParameters) {
  ...
  public void setUpstreamParameters(@javax.annotation.Nullable Object upstreamParameters) {
    this.upstreamParameters = upstreamParameters;
  }
