...
public class ErrorBrowserLocationChangeRequired {
  ...
  public ErrorBrowserLocationChangeRequired error(@javax.annotation.Nullable ErrorGeneric error) {
    this.error = error;
    return this;
  }
  ...
  public void setError(@javax.annotation.Nullable ErrorGeneric error) {
    this.error = error;
  }


  public ErrorBrowserLocationChangeRequired redirectBrowserTo(@javax.annotation.Nullable String redirectBrowserTo) {
