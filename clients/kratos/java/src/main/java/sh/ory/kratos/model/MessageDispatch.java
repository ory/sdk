...
public class MessageDispatch {
  ...
  public MessageDispatch createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public MessageDispatch error(@javax.annotation.Nullable Object error) {
    this.error = error;
    return this;
  }
  ...
  public MessageDispatch id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public MessageDispatch messageId(@javax.annotation.Nonnull String messageId) {
  ...
  public MessageDispatch status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public MessageDispatch updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
