...
public class ContinueWithVerificationUiFlow {
  ...
  public ContinueWithVerificationUiFlow id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public ContinueWithVerificationUiFlow url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public ContinueWithVerificationUiFlow verifiableAddress(@javax.annotation.Nonnull String verifiableAddress) {
  ...
  public void setVerifiableAddress(@javax.annotation.Nonnull String verifiableAddress) {
    this.verifiableAddress = verifiableAddress;
  }
