...
public class OAuth2Client {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "OAuth 2.0 Client ID  The ID is immutable. If no ID is provided, a UUID4 will be generated.")
  ...
  **/
  ...
  public OAuth2Client skipLogoutConsent(Boolean skipLogoutConsent) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "SkipLogoutConsent skips the logout consent screen for this client. This field can only be set from the admin API.")
