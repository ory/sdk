...
public class SelfServiceFlowExpiredError {
  ...
  public SelfServiceFlowExpiredError error(@javax.annotation.Nullable GenericError error) {
    this.error = error;
    return this;
  }
  ...
  public SelfServiceFlowExpiredError expiredAt(@javax.annotation.Nullable OffsetDateTime expiredAt) {
  ...
  public SelfServiceFlowExpiredError since(@javax.annotation.Nullable Long since) {
    this.since = since;
    return this;
  }
  ...
  public SelfServiceFlowExpiredError useFlowId(@javax.annotation.Nullable String useFlowId) {
  ...
  public void setUseFlowId(@javax.annotation.Nullable String useFlowId) {
    this.useFlowId = useFlowId;
  }
