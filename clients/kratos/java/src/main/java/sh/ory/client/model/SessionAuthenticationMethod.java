...
public class SessionAuthenticationMethod {
  ...
  public SessionAuthenticationMethod aal(@javax.annotation.Nullable AuthenticatorAssuranceLevel aal) {
    this.aal = aal;
    return this;
  }
  ...
  public void setAal(@javax.annotation.Nullable AuthenticatorAssuranceLevel aal) {
    this.aal = aal;
  }


  public SessionAuthenticationMethod completedAt(@javax.annotation.Nullable OffsetDateTime completedAt) {
  ...
  public SessionAuthenticationMethod method(@javax.annotation.Nullable MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public SessionAuthenticationMethod organization(@javax.annotation.Nullable String organization) {
  ...
  public SessionAuthenticationMethod provider(@javax.annotation.Nullable String provider) {
  ...
  public SessionAuthenticationMethod upstreamAcr(@javax.annotation.Nullable String upstreamAcr) {
  ...
  public void setUpstreamAcr(@javax.annotation.Nullable String upstreamAcr) {
    this.upstreamAcr = upstreamAcr;
  }


  public SessionAuthenticationMethod upstreamAmr(@javax.annotation.Nullable List<String> upstreamAmr) {
  ...
  public void setUpstreamAmr(@javax.annotation.Nullable List<String> upstreamAmr) {
    this.upstreamAmr = upstreamAmr;
  }
