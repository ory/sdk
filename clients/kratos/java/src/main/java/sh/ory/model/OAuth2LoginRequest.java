...
public class OAuth2LoginRequest {
  ...
  public OAuth2LoginRequest challenge(@javax.annotation.Nullable String challenge) {
  ...
  public OAuth2LoginRequest client(@javax.annotation.Nullable OAuth2Client client) {
    this.client = client;
    return this;
  }
  ...
  public void setClient(@javax.annotation.Nullable OAuth2Client client) {
    this.client = client;
  }


  public OAuth2LoginRequest oidcContext(@javax.annotation.Nullable OAuth2ConsentRequestOpenIDConnectContext oidcContext) {
  ...
  public void setOidcContext(@javax.annotation.Nullable OAuth2ConsentRequestOpenIDConnectContext oidcContext) {
    this.oidcContext = oidcContext;
  }


  public OAuth2LoginRequest requestUrl(@javax.annotation.Nullable String requestUrl) {
  ...
  public OAuth2LoginRequest requestedAccessTokenAudience(@javax.annotation.Nullable List<String> requestedAccessTokenAudience) {
  ...
  public void setRequestedAccessTokenAudience(@javax.annotation.Nullable List<String> requestedAccessTokenAudience) {
    this.requestedAccessTokenAudience = requestedAccessTokenAudience;
  }


  public OAuth2LoginRequest requestedScope(@javax.annotation.Nullable List<String> requestedScope) {
  ...
  public void setRequestedScope(@javax.annotation.Nullable List<String> requestedScope) {
    this.requestedScope = requestedScope;
  }


  public OAuth2LoginRequest sessionId(@javax.annotation.Nullable String sessionId) {
  ...
  public OAuth2LoginRequest skip(@javax.annotation.Nullable Boolean skip) {
    this.skip = skip;
    return this;
  }
  ...
  public OAuth2LoginRequest subject(@javax.annotation.Nullable String subject) {
