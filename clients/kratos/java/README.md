...
- API version: v1.3.6-alpha.2
  - Build date: 2025-02-25T13:44:30.369152764Z[Etc/UTC]
...
<dependency>
  ...
  <version>v1.3.6-alpha.2</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory.kratos:kratos-client:v1.3.6-alpha.2"
  }
```
...
* `target/kratos-client-v1.3.6-alpha.2.jar`
* `target/lib/*.jar`
