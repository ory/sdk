...
- API version: v0.7.6-alpha.5
  - Build date: 2021-09-21T07:48:04.557034317Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.7.6-alpha.5</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.7.6-alpha.5"
```
...
* `target/kratos-client-v0.7.6-alpha.5.jar`
* `target/lib/*.jar`
