...
- API version: v1.3.6-alpha.1
  - Build date: 2025-02-25T11:25:59.353849095Z[Etc/UTC]
...
<dependency>
  ...
  <version>v1.3.6-alpha.1</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "sh.ory.kratos:kratos-client:v1.3.6-alpha.1"
  }
```
...
* `target/kratos-client-v1.3.6-alpha.1.jar`
* `target/lib/*.jar`
