...
- API version: v0.6.0-alpha.2
  - Build date: 2021-05-07T15:36:20.562654577Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.6.0-alpha.2</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.6.0-alpha.2"
```
...
* `target/kratos-client-v0.6.0-alpha.2.jar`
* `target/lib/*.jar`
