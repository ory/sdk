...
- API version: v0.6.1-alpha.1
  - Build date: 2021-05-11T21:11:52.074256933Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.6.1-alpha.1</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.6.1-alpha.1"
```
...
* `target/kratos-client-v0.6.1-alpha.1.jar`
* `target/lib/*.jar`
