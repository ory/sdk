...
- API version: v0.7.6-alpha.7
  - Build date: 2021-09-21T08:24:33.953303119Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.7.6-alpha.7</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.7.6-alpha.7"
```
...
* `target/kratos-client-v0.7.6-alpha.7.jar`
* `target/lib/*.jar`
