...
- API version: v0.7.3-alpha.1
  - Build date: 2021-08-28T09:00:14.128093528Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.7.3-alpha.1</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.7.3-alpha.1"
```
...
* `target/kratos-client-v0.7.3-alpha.1.jar`
* `target/lib/*.jar`
