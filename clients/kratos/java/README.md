...
- API version: v0.7.3-alpha.2
  - Build date: 2021-08-31T13:45:14.536241677Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.7.3-alpha.2</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.7.3-alpha.2"
```
...
* `target/kratos-client-v0.7.3-alpha.2.jar`
* `target/lib/*.jar`
