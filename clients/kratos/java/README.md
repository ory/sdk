...
- API version: v0.7.3-alpha.6
  - Build date: 2021-09-01T06:05:11.974241344Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.7.3-alpha.6</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.7.3-alpha.6"
```
...
* `target/kratos-client-v0.7.3-alpha.6.jar`
* `target/lib/*.jar`
