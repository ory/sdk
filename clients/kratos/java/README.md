...
- API version: v0.7.6-alpha.4
  - Build date: 2021-09-20T06:00:32.547769134Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.7.6-alpha.4</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.7.6-alpha.4"
```
...
* `target/kratos-client-v0.7.6-alpha.4.jar`
* `target/lib/*.jar`
