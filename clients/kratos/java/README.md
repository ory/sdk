...
- API version: v0.6.0-alpha.4
  - Build date: 2021-05-10T10:42:51.879955097Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.6.0-alpha.4</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.6.0-alpha.4"
```
...
* `target/kratos-client-v0.6.0-alpha.4.jar`
* `target/lib/*.jar`
