...
def lazy_import():
    ...
    globals()['UpdateVerificationFlowWithCodeMethod'] = UpdateVerificationFlowWithCodeMethod
    globals()['UpdateVerificationFlowWithLinkMethod'] = UpdateVerificationFlowWithLinkMethod


class UpdateVerificationFlowBody(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateVerificationFlowBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            code (str): Code from the recovery email  If you want to submit a code, use this field, but make sure to _not_ include the email field, as well.. [optional]  # noqa: E501
            email (str): The email address to verify  If the email belongs to a valid account, a verifiation email will be sent.  If you want to notify the email address if the account does not exist, see the [notify_unknown_recipients flag](https://www.ory.sh/docs/kratos/self-service/flows/verify-email-account-activation#attempted-verification-notifications)  If a code was already sent, including this field in the payload will invalidate the sent code and re-send a new code.  format: email. [optional]  # noqa: E501
        """
