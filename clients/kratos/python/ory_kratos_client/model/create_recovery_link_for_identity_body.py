...
class CreateRecoveryLinkForIdentityBody(ModelNormal):
    ...
    def _from_openapi_data(cls, identity_id, *args, **kwargs):  # noqa: E501
        """CreateRecoveryLinkForIdentityBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            expires_in (str): Link Expires In  The recovery link will expire after that amount of time has passed. Defaults to the configuration value of `selfservice.methods.code.config.lifespan`.. [optional]  # noqa: E501
        """
