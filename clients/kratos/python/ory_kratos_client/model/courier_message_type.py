...
class CourierMessageType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """CourierMessageType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): It can either be `email` or `phone`., must be one of ["email", "phone", ]  # noqa: E501

        Keyword Args:
            value (str): It can either be `email` or `phone`., must be one of ["email", "phone", ]  # noqa: E501
