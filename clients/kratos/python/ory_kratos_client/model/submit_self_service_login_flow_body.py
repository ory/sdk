...
class SubmitSelfServiceLoginFlowBody(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SubmitSelfServiceLoginFlowBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            identifier (str): Identifier is the email or username of the user trying to log in. This field is only required when using WebAuthn for passwordless login. When using WebAuthn for multi-factor authentication, it is not needed.. [optional]  # noqa: E501
