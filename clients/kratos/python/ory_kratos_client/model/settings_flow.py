...
def lazy_import():
    ...
    globals()['SettingsFlowMethod'] = SettingsFlowMethod
...
class SettingsFlow(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'methods': ({str: (SettingsFlowMethod,)},),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, expires_at, id, identity, issued_at, methods, request_url, state, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            methods ({str: (SettingsFlowMethod,)}): Methods contains context for all enabled registration methods. If a settings flow has been processed, but for example the first name is empty, this will contain error messages.
