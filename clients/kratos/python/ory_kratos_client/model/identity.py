...
class Identity(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'credentials': ({str: (IdentityCredentials,)},),  # noqa: E501
            ...
            'state': (str,),  # noqa: E501
            'state_changed_at': (datetime,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'state_changed_at': 'state_changed_at',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, schema_id, schema_url, traits, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metadata_admin (bool, date, datetime, dict, float, int, list, str, none_type): NullJSONRawMessage represents a json.RawMessage that works well with JSON, SQL, and Swagger and is NULLable-. [optional]  # noqa: E501
            metadata_public (bool, date, datetime, dict, float, int, list, str, none_type): NullJSONRawMessage represents a json.RawMessage that works well with JSON, SQL, and Swagger and is NULLable-. [optional]  # noqa: E501
            organization_id (str, none_type): [optional]  # noqa: E501
            recovery_addresses ([RecoveryIdentityAddress]): RecoveryAddresses contains all the addresses that can be used to recover an identity.. [optional]  # noqa: E501
            state (str): State is the identity's state.  This value has currently no effect. active StateActive inactive StateInactive. [optional]  # noqa: E501
