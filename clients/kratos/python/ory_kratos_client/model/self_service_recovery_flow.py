...
class SelfServiceRecoveryFlow(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, expires_at, id, issued_at, request_url, state, ui, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, expires_at, id, issued_at, request_url, state, ui, *args, **kwargs):  # noqa: E501
        """SelfServiceRecoveryFlow - a model defined in OpenAPI
