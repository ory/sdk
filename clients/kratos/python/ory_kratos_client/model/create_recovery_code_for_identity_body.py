...
class CreateRecoveryCodeForIdentityBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, identity_id, *args, **kwargs):  # noqa: E501
        """CreateRecoveryCodeForIdentityBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            expires_in (str): Code Expires In  The recovery code will expire after that amount of time has passed. Defaults to the configuration value of `selfservice.methods.code.config.lifespan`.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, identity_id, *args, **kwargs):  # noqa: E501
        """CreateRecoveryCodeForIdentityBody - a model defined in OpenAPI
