...
def lazy_import():
    ...
    globals()['FormFields'] = FormFields
    globals()['Messages'] = Messages


class RecoveryFlowMethodConfig(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, action, fields, method, *args, **kwargs):  # noqa: E501
        """RecoveryFlowMethodConfig - a model defined in OpenAPI
