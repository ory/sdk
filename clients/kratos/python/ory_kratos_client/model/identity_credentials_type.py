...
class IdentityCredentialsType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IdentityCredentialsType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): and so on.., must be one of ["password", "totp", "oidc", "webauthn", "lookup_secret", ]  # noqa: E501

        Keyword Args:
            value (str): and so on.., must be one of ["password", "totp", "oidc", "webauthn", "lookup_secret", ]  # noqa: E501
