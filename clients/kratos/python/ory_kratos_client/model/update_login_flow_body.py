...
def lazy_import():
    from ory_kratos_client.model.update_login_flow_with_code_method import UpdateLoginFlowWithCodeMethod
    ...
    globals()['UpdateLoginFlowWithCodeMethod'] = UpdateLoginFlowWithCodeMethod
...
class UpdateLoginFlowBody(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'password_identifier': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'password_identifier': 'password_identifier',  # noqa: E501
        ...
        'webauthn_login': 'webauthn_login',  # noqa: E501
        'code': 'code',  # noqa: E501
        'resend': 'resend',  # noqa: E501
        ...
        'lookup_secret': 'lookup_secret',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateLoginFlowBody - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            password_identifier (str): Identifier is the email or username of the user trying to log in. This field is deprecated!. [optional]  # noqa: E501
            ...
            id_token_nonce (str): IDTokenNonce is the nonce, used when generating the IDToken. If the provider supports nonce validation, the nonce will be validated against this value and required.. [optional]  # noqa: E501
            traits ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The identity traits. This is a placeholder for the registration flow.. [optional]  # noqa: E501
            ...
            code (str): Code is the 6 digits code sent to the user. [optional]  # noqa: E501
            resend (str): Resend is set when the user wants to resend the code. [optional]  # noqa: E501
            csrf_token (str): CSRFToken is the anti-CSRF token. [optional]  # noqa: E501
            identifier (str): Identifier is the code identifier The identifier requires that the user has already completed the registration or settings with code flow.. [optional]  # noqa: E501
            password (str): The user's password.. [optional]  # noqa: E501
            provider (str): The provider to register with. [optional]  # noqa: E501
            totp_code (str): The TOTP code.. [optional]  # noqa: E501
            lookup_secret (str): The lookup secret.. [optional]  # noqa: E501
        """
