...
class RecoveryFlow(ModelNormal):
    ...
    def _from_openapi_data(cls, expires_at, id, issued_at, request_url, state, type, ui, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            active (str): Active, if set, contains the recovery method that is being used. It is initially not set.. [optional]  # noqa: E501
            continue_with ([ContinueWith]): Contains possible actions that could follow this flow. [optional]  # noqa: E501
