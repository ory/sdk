...
class SuccessfulNativeRegistration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, identity, *args, **kwargs):  # noqa: E501
        """SuccessfulNativeRegistration - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            continue_with ([ContinueWith]): Contains a list of actions, that could follow this flow  It can, for example, this will contain a reference to the verification flow, created as part of the user's registration or the token of the session.. [optional]  # noqa: E501
