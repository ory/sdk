...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of ory_kratos_client.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the ory_kratos_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = ory_kratos_client.Configuration(
        signing_info = ory_kratos_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: v0.2.1-alpha.1".\
