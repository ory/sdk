...
class PublicApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.initialize_self_service_login_via_api_flow = _Endpoint(
            settings={
                'response_type': (LoginFlow,),
                'auth': [],
        ...
        self.initialize_self_service_login_via_browser_flow = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
        ...
        self.initialize_self_service_recovery_via_api_flow = _Endpoint(
            settings={
                'response_type': (RecoveryFlow,),
                'auth': [],
        ...
        self.initialize_self_service_recovery_via_browser_flow = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
        ...
        self.initialize_self_service_registration_via_api_flow = _Endpoint(
            settings={
                'response_type': (RegistrationFlow,),
                'auth': [],
        ...
        self.initialize_self_service_registration_via_browser_flow = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
        ...
        self.initialize_self_service_settings_via_api_flow = _Endpoint(
            settings={
                'response_type': (SettingsFlow,),
                'auth': [
                    'sessionToken'
        ...
        self.initialize_self_service_settings_via_browser_flow = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'sessionToken'
        ...
        self.initialize_self_service_verification_via_api_flow = _Endpoint(
            settings={
                'response_type': (VerificationFlow,),
                'auth': [],
        ...
        self.initialize_self_service_verification_via_browser_flow = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
