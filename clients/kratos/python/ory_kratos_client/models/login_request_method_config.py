...
class LoginRequestMethodConfig(object):
    ...
    @property
    def errors(self):
        """Gets the errors of this LoginRequestMethodConfig.  # noqa: E501

        Errors contains all form errors. These will be duplicates of the individual field errors.  # noqa: E501

        :return: The errors of this LoginRequestMethodConfig.  # noqa: E501
        :rtype: list[Error]
        """
        return self._errors
    ...
    def errors(self, errors):
        """Sets the errors of this LoginRequestMethodConfig.

        Errors contains all form errors. These will be duplicates of the individual field errors.  # noqa: E501

        :param errors: The errors of this LoginRequestMethodConfig.  # noqa: E501
        :type: list[Error]
        """
