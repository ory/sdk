...
class ContinueWithRecoveryUiFlow(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the recovery flow")
    url: Optional[StrictStr] = Field(default=None, description="The URL of the recovery flow  If this value is set, redirect the user's browser to this URL. This value is typically unset for native clients / API flows.")
