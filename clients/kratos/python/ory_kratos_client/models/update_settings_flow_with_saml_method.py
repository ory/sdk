...
class UpdateSettingsFlowWithSamlMethod(BaseModel):
    """
    ...
    method: StrictStr = Field(description="Method  Should be set to saml when trying to update a profile.")
    ...
    __properties: ClassVar[List[str]] = ["csrf_token", "flow", "link", "method", "traits", "transient_payload", "unlink"]
