...
class UpdateLoginFlowWithLookupSecretMethod(BaseModel):
    ...
    lookup_secret: StrictStr = Field(description="The lookup secret.")
    method: StrictStr = Field(description="Method should be set to \"lookup_secret\" when logging in using the lookup_secret strategy.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["csrf_token", "lookup_secret", "method"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lookup_secret": obj.get("lookup_secret"),
