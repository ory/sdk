...
class Form(object):
    ...
    def errors(self, errors):
        """Sets the errors of this Form.

        Errors contains all form errors. These will be duplicates of the individual field errors.  # noqa: E501

        :param errors: The errors of this Form.  # noqa: E501
        :type: list[Error]
        """
