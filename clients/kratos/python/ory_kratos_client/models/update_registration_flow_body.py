...
class UpdateRegistrationFlowBody(BaseModel):
    ...
    one_of_schemas: Set[str] = { "UpdateRegistrationFlowWithCodeMethod", "UpdateRegistrationFlowWithOidcMethod", "UpdateRegistrationFlowWithPasskeyMethod", "UpdateRegistrationFlowWithPasswordMethod", "UpdateRegistrationFlowWithWebAuthnMethod" }
