...
class Identity(object):
    ...
    def __init__(self, id=None, traits=None, traits_schema_id=None, traits_schema_url=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.id = id
        self.traits = traits
        if traits_schema_id is not None:
