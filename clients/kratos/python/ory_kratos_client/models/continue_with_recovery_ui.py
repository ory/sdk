...
class ContinueWithRecoveryUi(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr = Field(description="Action will always be `show_recovery_ui` show_recovery_ui ContinueWithActionShowRecoveryUIString")
    flow: ContinueWithRecoveryUiFlow
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["action", "flow"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['show_recovery_ui']):
            raise ValueError("must be one of enum values ('show_recovery_ui')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flow": ContinueWithRecoveryUiFlow.from_dict(obj["flow"]) if obj.get("flow") is not None else None
        })
