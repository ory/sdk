...
class LoginRequestMethod(object):
    ...
    @property
    def config(self):
        """Gets the config of this LoginRequestMethod.  # noqa: E501


        :return: The config of this LoginRequestMethod.  # noqa: E501
        :rtype: LoginRequestMethodConfig
        """
        return self._config

    @config.setter
    def config(self, config):
        """Sets the config of this LoginRequestMethod.
    ...
    @property
    def method(self):
        """Gets the method of this LoginRequestMethod.  # noqa: E501

        and so on.  # noqa: E501

        :return: The method of this LoginRequestMethod.  # noqa: E501
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this LoginRequestMethod.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LoginRequestMethod):
            return False
