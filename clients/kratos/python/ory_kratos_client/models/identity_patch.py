...
class IdentityPatch(BaseModel):
    ...
    patch_id: Optional[UUID] = Field(default=None, description="The ID of this patch.  The patch ID is optional. If specified, the ID will be returned in the response, so consumers of this API can correlate the response with the patch.")
