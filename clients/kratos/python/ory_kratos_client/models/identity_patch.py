...
class IdentityPatch(BaseModel):
    ...
    patch_id: Optional[StrictStr] = Field(default=None, description="The ID of this patch.  The patch ID is optional. If specified, the ID will be returned in the response, so consumers of this API can correlate the response with the patch.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["create", "patch_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "create": CreateIdentityBody.from_dict(obj["create"]) if obj.get("create") is not None else None,
