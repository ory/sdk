...
class BatchPatchIdentitiesResponse(BaseModel):
    ...
    """ # noqa: E501
    identities: Optional[List[IdentityPatchResponse]] = Field(default=None, description="The patch responses for the individual identities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identities": [IdentityPatchResponse.from_dict(_item) for _item in obj["identities"]] if obj.get("identities") is not None else None
        })
