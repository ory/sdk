...
class Identity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'createdAt' => '\DateTime',
        'credentials' => 'array<string,\Ory\Kratos\Client\Model\IdentityCredentials>',
        'externalId' => 'string',
        'id' => 'string',
        'metadataAdmin' => 'mixed',
        'metadataPublic' => 'mixed',
        'organizationId' => 'string',
        'recoveryAddresses' => '\Ory\Kratos\Client\Model\RecoveryIdentityAddress[]',
        'schemaId' => 'string',
        'schemaUrl' => 'string',
        'state' => 'string',
        ...
        'traits' => 'mixed',
        'updatedAt' => '\DateTime',
        'verifiableAddresses' => '\Ory\Kratos\Client\Model\VerifiableIdentityAddress[]'
    ];
    ...
    */
     ...
     * Gets credentials
     *
     * @return array<string,\Ory\Kratos\Client\Model\IdentityCredentials>|null
     */
     ...
     * Sets credentials
     *
     * @param array<string,\Ory\Kratos\Client\Model\IdentityCredentials>|null $credentials Credentials represents all credentials that can be used for authenticating this identity.
     *
     * @return self
     */
     ...
     * Sets externalId
     *
     * @param string|null $externalId ExternalID is an optional external ID of the identity. This is used to link the identity to an external system. If set, the external ID must be unique across all identities.
     *
     * @return self
     */
     ...
     * Sets metadataAdmin
     *
     * @param mixed|null $metadataAdmin NullJSONRawMessage represents a json.RawMessage that works well with JSON, SQL, and Swagger and is NULLable-
     *
     * @return self
     */
     ...
     * Sets metadataPublic
     *
     * @param mixed|null $metadataPublic NullJSONRawMessage represents a json.RawMessage that works well with JSON, SQL, and Swagger and is NULLable-
     *
     * @return self
     */
     ...
     *
     * @return \Ory\Kratos\Client\Model\RecoveryIdentityAddress[]|null
     */
     ...
     *
     * @param \Ory\Kratos\Client\Model\RecoveryIdentityAddress[]|null $recoveryAddresses RecoveryAddresses contains all the addresses that can be used to recover an identity.
     *
     * @return self
     */
     ...
     *
     * @return \Ory\Kratos\Client\Model\VerifiableIdentityAddress[]|null
     */
     ...
     *
     * @param \Ory\Kratos\Client\Model\VerifiableIdentityAddress[]|null $verifiableAddresses VerifiableAddresses contains all the addresses that can be verified by the user.
     *
     * @return self
     */
