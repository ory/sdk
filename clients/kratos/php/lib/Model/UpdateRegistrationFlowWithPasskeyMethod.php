...
/**
 * UpdateRegistrationFlowWithPasskeyMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateRegistrationFlowWithPasskeyMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateRegistrationFlowWithPasskeyMethod';
    ...
    */
     ...
     * Sets method
     *
     * @param string $method Method  Should be set to \"passkey\" when trying to add, update, or remove a Passkey.
     *
     * @return self
     */
