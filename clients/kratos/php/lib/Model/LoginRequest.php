...
class LoginRequest implements ModelInterface, ArrayAccess
{
     ...
     * Gets methods
     *
     * @return map[string,\Ory\Kratos\Client\Model\LoginRequestMethod]
     */
     ...
     * Sets methods
     *
     * @param map[string,\Ory\Kratos\Client\Model\LoginRequestMethod] $methods Methods contains context for all enabled login methods. If a login request has been processed, but for example the password is incorrect, this will contain error messages.
     *
     * @return $this
     */
