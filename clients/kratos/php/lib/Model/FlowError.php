 ...
 */
class FlowError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'flowError';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of the error container.
     *
     * @return self
     */
