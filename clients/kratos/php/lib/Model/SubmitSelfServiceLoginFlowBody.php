...
class SubmitSelfServiceLoginFlowBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets identifier
     *
     * @param string $identifier Identifier is the email or username of the user trying to log in. This field is only required when using WebAuthn for passwordless login. When using WebAuthn for multi-factor authentication, it is not needed.
     *
     * @return self
     */
