...
/**
 * UpdateRegistrationFlowWithCodeMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateRegistrationFlowWithCodeMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateRegistrationFlowWithCodeMethod';
    ...
    */
     ...
     * Sets method
     *
     * @param string $method Method to use  This field must be set to `code` when using the code method.
     *
     * @return self
     */
