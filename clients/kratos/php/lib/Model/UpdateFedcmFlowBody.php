...
/**
 * UpdateFedcmFlowBody Class Doc Comment
 *
 * @category Class
 * @package  Ory\Kratos\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateFedcmFlowBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateFedcmFlowBody';
    ...
    */
     ...
     * Sets nonce
     *
     * @param string|null $nonce Nonce is the nonce that was used in the `navigator.credentials.get` call. If specified, it must match the `nonce` claim in the token.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string $token Token contains the result of `navigator.credentials.get`.
     *
     * @return self
     */
