...
class FormField implements ModelInterface, ArrayAccess
{
     ...
     * Sets required
     *
     * @param bool|null $required Name is the equivalent of <input required=\"{{.Required}}\">
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string|null $type Name is the equivalent of <input type=\"{{.Type}}\">
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param object|null $value Name is the equivalent of <input value=\"{{.Value}}\">
     *
     * @return $this
     */
