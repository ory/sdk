...
/**
 * UpdateLoginFlowWithSamlMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateLoginFlowWithSamlMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateLoginFlowWithSamlMethod';
    ...
    */
     ...
     * Sets method
     *
     * @param string $method Method to use  This field must be set to `saml` when using the saml method.
     *
     * @return self
     */
