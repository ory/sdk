...
class RecoveryFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'requestUrl' => 'string',
        'returnTo' => 'string',
        'state' => '\Ory\Kratos\Client\Model\RecoveryFlowState',
        'type' => 'string',
     ...
     * Gets state
     *
     * @return \Ory\Kratos\Client\Model\RecoveryFlowState
     */
     ...
     * Sets state
     *
     * @param \Ory\Kratos\Client\Model\RecoveryFlowState $state state
     *
     * @return self
     */
