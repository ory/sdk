...
class RegistrationRequest implements ModelInterface, ArrayAccess
{
     ...
     * Gets methods
     *
     * @return map[string,\Ory\Kratos\Client\Model\RegistrationRequestMethod]|null
     */
     ...
     * Sets methods
     *
     * @param map[string,\Ory\Kratos\Client\Model\RegistrationRequestMethod]|null $methods Methods contains context for all enabled registration methods. If a registration request has been processed, but for example the password is incorrect, this will contain error messages.
     *
     * @return $this
     */
