...
/**
 * SubmitSelfServiceSettingsFlowWithProfileMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class SubmitSelfServiceSettingsFlowWithProfileMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'submitSelfServiceSettingsFlowWithProfileMethod';
     ...
     * Sets method
     *
     * @param string|null $method Method  Should be set to profile when trying to update a profile.  type: string
     *
     * @return self
     */
