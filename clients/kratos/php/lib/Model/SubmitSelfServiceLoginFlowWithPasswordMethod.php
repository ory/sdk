...
/**
 * SubmitSelfServiceLoginFlowWithPasswordMethod Class Doc Comment
 *
 * @category Class
 * @package  Ory\Kratos\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubmitSelfServiceLoginFlowWithPasswordMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'submitSelfServiceLoginFlowWithPasswordMethod';
     ...
     * Sets method
     *
     * @param string|null $method Method should be set to \"password\" when logging in using the identifier and password strategy.
     *
     * @return self
     */
     ...
     *
     * @param string|null $passwordIdentifier Identifier is the email or username of the user trying to log in.
     *
     * @return self
     */
