...
class SelfServiceLoginFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'refresh' => 'bool',
        'requestUrl' => 'string',
        'requestedAal' => '\Ory\Kratos\Client\Model\AuthenticatorAssuranceLevel',
        'returnTo' => 'string',
        'type' => 'string',
     ...
     * Sets requestedAal
     *
     * @param \Ory\Kratos\Client\Model\AuthenticatorAssuranceLevel|null $requestedAal requestedAal
     *
     * @return self
     */
