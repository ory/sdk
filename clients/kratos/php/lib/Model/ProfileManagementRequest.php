...
/**
 * ProfileManagementRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ProfileManagementRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'profileManagementRequest';
     ...
     * Sets expiresAt
     *
     * @param \DateTime $expiresAt ExpiresAt is the time (UTC) when the request expires. If the user still wishes to update the profile, a new request has to be initiated.
     *
     * @return $this
     */
     ...
     * Gets form
     *
     * @return \Ory\Kratos\Client\Model\Form
     */
     ...
     * Sets form
     *
     * @param \Ory\Kratos\Client\Model\Form $form form
     *
     * @return $this
     */
     ...
     *
     * @param bool $updateSuccessful UpdateSuccessful, if true, indicates that the profile has been updated successfully with the provided data. Done will stay true when repeatedly checking. If set to true, done will revert back to false only when a request with invalid (e.g. \"please use a valid phone number\") data was sent.
     *
     * @return $this
     */
