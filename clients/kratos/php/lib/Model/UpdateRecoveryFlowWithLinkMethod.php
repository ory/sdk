...
/**
 * UpdateRecoveryFlowWithLinkMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateRecoveryFlowWithLinkMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateRecoveryFlowWithLinkMethod';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email Email to Recover  Needs to be set when initiating the flow. If the email is a registered recovery email, a recovery link will be sent. If the email is not known, an email with details on what happened will be sent instead.  format: email
     *
     * @return self
     */
