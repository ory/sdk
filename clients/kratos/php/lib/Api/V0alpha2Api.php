...
class V0alpha2Api
{
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\Session[]|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\Session[]|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\RevokedSessions|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\RevokedSessions|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function revokeSessionsWithHttpInfo($xSessionToken = null, $cookie = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Kratos\Client\Model\RevokedSessions' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Kratos\Client\Model\RevokedSessions', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Ory\Kratos\Client\Model\RevokedSessions';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ory\Kratos\Client\Model\RevokedSessions',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Ory\Kratos\Client\Model\SubmitSelfServiceLoginFlowBody $submitSelfServiceLoginFlowBody submitSelfServiceLoginFlowBody (required)
     * @param  string $xSessionToken The Session Token of the Identity performing the settings flow. (optional)
     * @param  string $cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SuccessfulSelfServiceLoginWithoutBrowser|\Ory\Kratos\Client\Model\SelfServiceLoginFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     * @param  \Ory\Kratos\Client\Model\SubmitSelfServiceRecoveryFlowBody $submitSelfServiceRecoveryFlowBody submitSelfServiceRecoveryFlowBody (required)
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SelfServiceRecoveryFlow|\Ory\Kratos\Client\Model\SelfServiceRecoveryFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     *
     * @param  string $flow The Recovery Flow ID  The value for this parameter comes from &#x60;flow&#x60; URL Query parameter sent to your application (e.g. &#x60;/recovery?flow&#x3D;abcde&#x60;). (required)
     * @param  \Ory\Kratos\Client\Model\SubmitSelfServiceRecoveryFlowBody $submitSelfServiceRecoveryFlowBody (required)
     * @param  string $token Recovery Token  The recovery token which completes the recovery request. If the token is invalid (e.g. expired) an error will be shown to the end-user.  This parameter is usually set in a link and not used by any direct API call. (optional)
     * @param  string $cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\SelfServiceRecoveryFlow|\Ory\Kratos\Client\Model\SelfServiceRecoveryFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \Ory\Kratos\Client\Model\SubmitSelfServiceRegistrationFlowBody $submitSelfServiceRegistrationFlowBody submitSelfServiceRegistrationFlowBody (required)
     * @param  string $cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SuccessfulSelfServiceRegistrationWithoutBrowser|\Ory\Kratos\Client\Model\SelfServiceRegistrationFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     *
     * @param  string $flow The Registration Flow ID  The value for this parameter comes from &#x60;flow&#x60; URL Query parameter sent to your application (e.g. &#x60;/registration?flow&#x3D;abcde&#x60;). (required)
     * @param  \Ory\Kratos\Client\Model\SubmitSelfServiceRegistrationFlowBody $submitSelfServiceRegistrationFlowBody (required)
     * @param  string $cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\SuccessfulSelfServiceRegistrationWithoutBrowser|\Ory\Kratos\Client\Model\SelfServiceRegistrationFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \Ory\Kratos\Client\Model\SubmitSelfServiceSettingsFlowBody $submitSelfServiceSettingsFlowBody submitSelfServiceSettingsFlowBody (required)
     * @param  string $xSessionToken The Session Token of the Identity performing the settings flow. (optional)
     * @param  string $cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SelfServiceSettingsFlow|\Ory\Kratos\Client\Model\SelfServiceSettingsFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\SelfServiceBrowserLocationChangeRequiredError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     *
     * @param  string $flow The Settings Flow ID  The value for this parameter comes from &#x60;flow&#x60; URL Query parameter sent to your application (e.g. &#x60;/settings?flow&#x3D;abcde&#x60;). (required)
     * @param  \Ory\Kratos\Client\Model\SubmitSelfServiceSettingsFlowBody $submitSelfServiceSettingsFlowBody (required)
     * @param  string $xSessionToken The Session Token of the Identity performing the settings flow. (optional)
     * @param  string $cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     ...
     * @param  \Ory\Kratos\Client\Model\SubmitSelfServiceVerificationFlowBody $submitSelfServiceVerificationFlowBody submitSelfServiceVerificationFlowBody (required)
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SelfServiceVerificationFlow|\Ory\Kratos\Client\Model\SelfServiceVerificationFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError
     */
     ...
     *
     * @param  string $flow The Verification Flow ID  The value for this parameter comes from &#x60;flow&#x60; URL Query parameter sent to your application (e.g. &#x60;/verification?flow&#x3D;abcde&#x60;). (required)
     * @param  \Ory\Kratos\Client\Model\SubmitSelfServiceVerificationFlowBody $submitSelfServiceVerificationFlowBody (required)
     * @param  string $token Verification Token  The verification token which completes the verification request. If the token is invalid (e.g. expired) an error will be shown to the end-user.  This parameter is usually set in a link and not used by any direct API call. (optional)
     * @param  string $cookie HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. (optional)
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\SelfServiceVerificationFlow|\Ory\Kratos\Client\Model\SelfServiceVerificationFlow|\Ory\Kratos\Client\Model\JsonError|\Ory\Kratos\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
