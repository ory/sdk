...
class AdminApi
{
     ...
     */
    protected function createIdentityRequest($body = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createRecoveryLinkRequest($body = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSelfServiceErrorRequest($error)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSelfServiceLoginFlowRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSelfServiceRecoveryFlowRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSelfServiceRegistrationFlowRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSelfServiceSettingsFlowRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSelfServiceVerificationFlowRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listIdentitiesRequest($perPage = 100, $page = 0)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateIdentityRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
