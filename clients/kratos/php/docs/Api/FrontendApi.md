...
```php
createBrowserLoginFlow($refresh, $aal, $returnTo, $cookie, $loginChallenge, $organization, $via, $identitySchema): \Ory\Kratos\Client\Model\LoginFlow
```
...
[**\Ory\Kratos\Client\Model\LogoutFlow**](../Model/LogoutFlow.md)
...
```php
createBrowserRecoveryFlow($returnTo): \Ory\Kratos\Client\Model\RecoveryFlow
```
...
```php
createBrowserRegistrationFlow($returnTo, $loginChallenge, $afterVerificationReturnTo, $organization, $identitySchema): \Ory\Kratos\Client\Model\RegistrationFlow
```
...
```php
createBrowserSettingsFlow($returnTo, $cookie): \Ory\Kratos\Client\Model\SettingsFlow
```
...
```php
createBrowserVerificationFlow($returnTo): \Ory\Kratos\Client\Model\VerificationFlow
```
...
```php
createFedcmFlow(): \Ory\Kratos\Client\Model\CreateFedcmFlowResponse
```
...
[**\Ory\Kratos\Client\Model\CreateFedcmFlowResponse**](../Model/CreateFedcmFlowResponse.md)
...
```php
createNativeLoginFlow($refresh, $aal, $xSessionToken, $returnSessionTokenExchangeCode, $returnTo, $organization, $via, $identitySchema): \Ory\Kratos\Client\Model\LoginFlow
```
...
```php
createNativeRecoveryFlow(): \Ory\Kratos\Client\Model\RecoveryFlow
```
...
```php
createNativeRegistrationFlow($returnSessionTokenExchangeCode, $returnTo, $organization, $identitySchema): \Ory\Kratos\Client\Model\RegistrationFlow
```
...
```php
createNativeSettingsFlow($xSessionToken): \Ory\Kratos\Client\Model\SettingsFlow
```
...
```php
createNativeVerificationFlow($returnTo): \Ory\Kratos\Client\Model\VerificationFlow
```
...
```php
disableMyOtherSessions($xSessionToken, $cookie): \Ory\Kratos\Client\Model\DeleteMySessionsCount
```
...
[**\Ory\Kratos\Client\Model\DeleteMySessionsCount**](../Model/DeleteMySessionsCount.md)
...
```php
getFlowError($id): \Ory\Kratos\Client\Model\FlowError
```
...
[**\Ory\Kratos\Client\Model\FlowError**](../Model/FlowError.md)
...
```php
getLoginFlow($id, $cookie): \Ory\Kratos\Client\Model\LoginFlow
```
...
```php
getRecoveryFlow($id, $cookie): \Ory\Kratos\Client\Model\RecoveryFlow
```
...
```php
getRegistrationFlow($id, $cookie): \Ory\Kratos\Client\Model\RegistrationFlow
```
...
```php
getSettingsFlow($id, $xSessionToken, $cookie): \Ory\Kratos\Client\Model\SettingsFlow
```
...
```php
getVerificationFlow($id, $cookie): \Ory\Kratos\Client\Model\VerificationFlow
```
...
```php
listMySessions($perPage, $page, $pageSize, $pageToken, $xSessionToken, $cookie): \Ory\Kratos\Client\Model\Session[]
```
...
$performNativeLogoutBody = new \Ory\Kratos\Client\Model\PerformNativeLogoutBody(); // \Ory\Kratos\Client\Model\PerformNativeLogoutBody
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **performNativeLogoutBody** | [**\Ory\Kratos\Client\Model\PerformNativeLogoutBody**](../Model/PerformNativeLogoutBody.md)|  | |
...
```php
toSession($xSessionToken, $cookie, $tokenizeAs): \Ory\Kratos\Client\Model\Session
```
...
```php
updateFedcmFlow($updateFedcmFlowBody): \Ory\Kratos\Client\Model\SuccessfulNativeLogin
```
...
$updateFedcmFlowBody = new \Ory\Kratos\Client\Model\UpdateFedcmFlowBody(); // \Ory\Kratos\Client\Model\UpdateFedcmFlowBody
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **updateFedcmFlowBody** | [**\Ory\Kratos\Client\Model\UpdateFedcmFlowBody**](../Model/UpdateFedcmFlowBody.md)|  | |
...
```php
updateLoginFlow($flow, $updateLoginFlowBody, $xSessionToken, $cookie): \Ory\Kratos\Client\Model\SuccessfulNativeLogin
```
...
$updateLoginFlowBody = new \Ory\Kratos\Client\Model\UpdateLoginFlowBody(); // \Ory\Kratos\Client\Model\UpdateLoginFlowBody
$xSessionToken = 'xSessionToken_example'; // string | The Session Token of the Identity performing the settings flow.
$cookie = 'cookie_example'; // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
...
| **updateLoginFlowBody** | [**\Ory\Kratos\Client\Model\UpdateLoginFlowBody**](../Model/UpdateLoginFlowBody.md)|  | |
| **xSessionToken** | **string**| The Session Token of the Identity performing the settings flow. | [optional] |
| **cookie** | **string**| HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. | [optional] |
...
```php
updateRecoveryFlow($flow, $updateRecoveryFlowBody, $token, $cookie): \Ory\Kratos\Client\Model\RecoveryFlow
```
...
$updateRecoveryFlowBody = new \Ory\Kratos\Client\Model\UpdateRecoveryFlowBody(); // \Ory\Kratos\Client\Model\UpdateRecoveryFlowBody
...
| **updateRecoveryFlowBody** | [**\Ory\Kratos\Client\Model\UpdateRecoveryFlowBody**](../Model/UpdateRecoveryFlowBody.md)|  | |
...
```php
updateRegistrationFlow($flow, $updateRegistrationFlowBody, $cookie): \Ory\Kratos\Client\Model\SuccessfulNativeRegistration
```
...
$updateRegistrationFlowBody = new \Ory\Kratos\Client\Model\UpdateRegistrationFlowBody(); // \Ory\Kratos\Client\Model\UpdateRegistrationFlowBody
$cookie = 'cookie_example'; // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
...
| **updateRegistrationFlowBody** | [**\Ory\Kratos\Client\Model\UpdateRegistrationFlowBody**](../Model/UpdateRegistrationFlowBody.md)|  | |
| **cookie** | **string**| HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. | [optional] |

### Return type

[**\Ory\Kratos\Client\Model\SuccessfulNativeRegistration**](../Model/SuccessfulNativeRegistration.md)
...
```php
updateSettingsFlow($flow, $updateSettingsFlowBody, $xSessionToken, $cookie): \Ory\Kratos\Client\Model\SettingsFlow
```
...
$updateSettingsFlowBody = new \Ory\Kratos\Client\Model\UpdateSettingsFlowBody(); // \Ory\Kratos\Client\Model\UpdateSettingsFlowBody
$xSessionToken = 'xSessionToken_example'; // string | The Session Token of the Identity performing the settings flow.
$cookie = 'cookie_example'; // string | HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected.
...
| **updateSettingsFlowBody** | [**\Ory\Kratos\Client\Model\UpdateSettingsFlowBody**](../Model/UpdateSettingsFlowBody.md)|  | |
| **xSessionToken** | **string**| The Session Token of the Identity performing the settings flow. | [optional] |
| **cookie** | **string**| HTTP Cookies  When using the SDK in a browser app, on the server side you must include the HTTP Cookie Header sent by the client to your server here. This ensures that CSRF and session cookies are respected. | [optional] |
...
```php
updateVerificationFlow($flow, $updateVerificationFlowBody, $token, $cookie): \Ory\Kratos\Client\Model\VerificationFlow
```
...
$updateVerificationFlowBody = new \Ory\Kratos\Client\Model\UpdateVerificationFlowBody(); // \Ory\Kratos\Client\Model\UpdateVerificationFlowBody
...
| **updateVerificationFlowBody** | [**\Ory\Kratos\Client\Model\UpdateVerificationFlowBody**](../Model/UpdateVerificationFlowBody.md)|  | |
