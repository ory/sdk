...
```php
adminListIdentitySessions($id, $perPage, $page, $active): \Ory\Kratos\Client\Model\Session[]
```
...
```php
listSessions($xSessionToken, $cookie, $perPage, $page): \Ory\Kratos\Client\Model\Session[]
```
...
```php
revokeSessions($xSessionToken, $cookie): \Ory\Kratos\Client\Model\RevokedSessions
```
...
[**\Ory\Kratos\Client\Model\RevokedSessions**](../Model/RevokedSessions.md)
