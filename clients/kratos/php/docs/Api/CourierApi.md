...
$status = new \Ory\Kratos\Client\Model\CourierMessageStatus(); // CourierMessageStatus | Status filters out messages based on status. If no value is provided, it doesn't take effect on filter.
