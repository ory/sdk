...
*AdminApi* | [**getSelfServiceBrowserRecoveryRequest**](docs/Api/AdminApi.md#getselfservicebrowserrecoveryrequest) | **GET** /self-service/browser/flows/requests/recovery | Get the request context of browser-based recovery flows
...
*CommonApi* | [**getSelfServiceBrowserRecoveryRequest**](docs/Api/CommonApi.md#getselfservicebrowserrecoveryrequest) | **GET** /self-service/browser/flows/requests/recovery | Get the request context of browser-based recovery flows
...
*PublicApi* | [**completeSelfServiceBrowserRecoveryLinkStrategyFlow**](docs/Api/PublicApi.md#completeselfservicebrowserrecoverylinkstrategyflow) | **POST** /self-service/browser/flows/recovery/link | Complete the browser-based recovery flow using a recovery link
...
*PublicApi* | [**getSelfServiceBrowserRecoveryRequest**](docs/Api/PublicApi.md#getselfservicebrowserrecoveryrequest) | **GET** /self-service/browser/flows/requests/recovery | Get the request context of browser-based recovery flows
...
*PublicApi* | [**initializeSelfServiceRecoveryFlow**](docs/Api/PublicApi.md#initializeselfservicerecoveryflow) | **GET** /self-service/browser/flows/recovery | Initialize browser-based account recovery flow
...
## Documentation For Models
 ...
 - [RecoveryRequest](docs/Model/RecoveryRequest.md)
 - [RecoveryRequestMethod](docs/Model/RecoveryRequestMethod.md)
