...
```php
checkPermission($namespace, $object, $relation, $subjectId, $subjectSetNamespace, $subjectSetObject, $subjectSetRelation, $maxDepth): \Ory\Keto\Client\Model\CheckPermissionResult
```
...
[**\Ory\Keto\Client\Model\CheckPermissionResult**](../Model/CheckPermissionResult.md)
...
```php
checkPermissionOrError($namespace, $object, $relation, $subjectId, $subjectSetNamespace, $subjectSetObject, $subjectSetRelation, $maxDepth): \Ory\Keto\Client\Model\CheckPermissionResult
```
...
```php
expandPermissions($namespace, $object, $relation, $maxDepth): \Ory\Keto\Client\Model\ExpandedPermissionTree
```
...
[**\Ory\Keto\Client\Model\ExpandedPermissionTree**](../Model/ExpandedPermissionTree.md)
...
```php
postCheckPermission($maxDepth, $postCheckPermissionBody): \Ory\Keto\Client\Model\CheckPermissionResult
```
...
$maxDepth = 56; // int
$postCheckPermissionBody = new \Ory\Keto\Client\Model\PostCheckPermissionBody(); // \Ory\Keto\Client\Model\PostCheckPermissionBody
...
```php
postCheckPermissionOrError($maxDepth, $postCheckPermissionOrErrorBody): \Ory\Keto\Client\Model\CheckPermissionResult
```
