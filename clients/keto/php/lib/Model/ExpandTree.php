...
class ExpandTree implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets children
     *
     * @param \Ory\Keto\Client\Model\ExpandTree[]|null $children The children of the node, possibly none.
     *
     * @return self
     */
     ...
     * Sets subjectId
     *
     * @param string|null $subjectId The subject ID the node represents. Either this field, or SubjectSet are set.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the node. union ExpandNodeUnion exclusion ExpandNodeExclusion intersection ExpandNodeIntersection leaf ExpandNodeLeaf unspecified ExpandNodeUnspecified
     *
     * @return self
     */
