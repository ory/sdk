 ...
 *
 * @category Class
 * @description ExpandTree ExpandTree ExpandTree expand tree
 * @package  Ory\Keto\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ExpandTree implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const TYPE___UNION_EXCLUSION_INTERSECTION_LEAF = '[[[union exclusion intersection leaf]]]';
    ...
    {
        return [
            self::TYPE___UNION_EXCLUSION_INTERSECTION_LEAF,
        ];
    }
