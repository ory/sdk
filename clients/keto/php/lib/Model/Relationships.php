...
/**
 * Relationships Class Doc Comment
 *
 * @category Class
 ...
 */
class Relationships implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'relationships';
    ...
    protected static $openAPITypes = [
        ...
        'relationTuples' => '\Ory\Keto\Client\Model\Relationship[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('relationTuples', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets relationTuples
     *
     * @return \Ory\Keto\Client\Model\Relationship[]|null
     */
     ...
     * Sets relationTuples
     *
     * @param \Ory\Keto\Client\Model\Relationship[]|null $relationTuples relationTuples
     *
     * @return self
     */
    public function setRelationTuples($relationTuples)
    {
        if (is_null($relationTuples)) {
            throw new \InvalidArgumentException('non-nullable relationTuples cannot be null');
        }
