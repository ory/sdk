 ...
 * @link     https://openapi-generator.tech
 */
class OryAccessControlPolicies implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'oryAccessControlPolicies';
     ...
     * Sets body
     *
     * @param \Ory\Keto\Client\Model\OryAccessControlPolicy[]|null $body The request body.  in: body type: array
     *
     * @return $this
     */
