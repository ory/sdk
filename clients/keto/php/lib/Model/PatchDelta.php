 ...
 *
 * @category Class
 * @description PatchDelta PatchDelta PatchDelta PatchDelta PatchDelta PatchDelta PatchDelta PatchDelta PatchDelta PatchDelta patch delta
 * @package  Ory\Keto\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class PatchDelta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const ACTION__________INSERT_DELETE = '[[[[[[[[[[insert delete]]]]]]]]]]';
    ...
    {
        return [
            self::ACTION__________INSERT_DELETE,
        ];
    }
