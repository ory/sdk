...
export function ExpandedPermissionTreeToJSON(json: any): ExpandedPermissionTree {
    return ExpandedPermissionTreeToJSONTyped(json, false);
}

export function ExpandedPermissionTreeToJSONTyped(value?: ExpandedPermissionTree | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
