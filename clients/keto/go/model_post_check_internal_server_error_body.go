...
func NewPostCheckInternalServerErrorBody() *PostCheckInternalServerErrorBody {
	this := PostCheckInternalServerErrorBody{}
	return &this
}
...
func (o PostCheckInternalServerErrorBody) MarshalJSON() ([]byte, error) {
...
type NullablePostCheckInternalServerErrorBody struct {
	value *PostCheckInternalServerErrorBody
	isSet bool
}

func (v NullablePostCheckInternalServerErrorBody) Get() *PostCheckInternalServerErrorBody {
	return v.value
}

func (v *NullablePostCheckInternalServerErrorBody) Set(val *PostCheckInternalServerErrorBody) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCheckInternalServerErrorBody) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCheckInternalServerErrorBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCheckInternalServerErrorBody(val *PostCheckInternalServerErrorBody) *NullablePostCheckInternalServerErrorBody {
	return &NullablePostCheckInternalServerErrorBody{value: val, isSet: true}
}

func (v NullablePostCheckInternalServerErrorBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCheckInternalServerErrorBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
