...
func NewDeleteRelationTuplesInternalServerErrorBody() *DeleteRelationTuplesInternalServerErrorBody {
	this := DeleteRelationTuplesInternalServerErrorBody{}
	return &this
}
...
func (o DeleteRelationTuplesInternalServerErrorBody) MarshalJSON() ([]byte, error) {
...
type NullableDeleteRelationTuplesInternalServerErrorBody struct {
	value *DeleteRelationTuplesInternalServerErrorBody
	isSet bool
}

func (v NullableDeleteRelationTuplesInternalServerErrorBody) Get() *DeleteRelationTuplesInternalServerErrorBody {
	return v.value
}

func (v *NullableDeleteRelationTuplesInternalServerErrorBody) Set(val *DeleteRelationTuplesInternalServerErrorBody) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteRelationTuplesInternalServerErrorBody) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteRelationTuplesInternalServerErrorBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteRelationTuplesInternalServerErrorBody(val *DeleteRelationTuplesInternalServerErrorBody) *NullableDeleteRelationTuplesInternalServerErrorBody {
	return &NullableDeleteRelationTuplesInternalServerErrorBody{value: val, isSet: true}
}

func (v NullableDeleteRelationTuplesInternalServerErrorBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteRelationTuplesInternalServerErrorBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
