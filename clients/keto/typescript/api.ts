...
export const ReadApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [subject] Subject of the Relation Tuple  The subject follows the subject string encoding format.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getCheck: async (namespace: string, object: string, relation: string, subject?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'namespace' is not null or undefined
            if (namespace === null || namespace === undefined) {
                throw new RequiredError('namespace','Required parameter namespace was null or undefined when calling getCheck.');
            }
            // verify required parameter 'object' is not null or undefined
            if (object === null || object === undefined) {
                throw new RequiredError('object','Required parameter object was null or undefined when calling getCheck.');
            }
            // verify required parameter 'relation' is not null or undefined
            if (relation === null || relation === undefined) {
                throw new RequiredError('relation','Required parameter relation was null or undefined when calling getCheck.');
            }
        ...
        getExpand: async (namespace: string, object: string, relation: string, maxDepth?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'namespace' is not null or undefined
            if (namespace === null || namespace === undefined) {
                throw new RequiredError('namespace','Required parameter namespace was null or undefined when calling getExpand.');
            }
            // verify required parameter 'object' is not null or undefined
            if (object === null || object === undefined) {
                throw new RequiredError('object','Required parameter object was null or undefined when calling getExpand.');
            }
            // verify required parameter 'relation' is not null or undefined
            if (relation === null || relation === undefined) {
                throw new RequiredError('relation','Required parameter relation was null or undefined when calling getExpand.');
            }
         ...
         * @throws {RequiredError}
         */
        getRelationTuples: async (namespace: string, object?: string, relation?: string, subject?: string, pageToken?: string, pageSize?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'namespace' is not null or undefined
            if (namespace === null || namespace === undefined) {
                throw new RequiredError('namespace','Required parameter namespace was null or undefined when calling getRelationTuples.');
            }
         ...
         * To learn how relation tuples and the check works, head over to [the documentation](../concepts/relation-tuples.mdx).
         * @summary Check a relation tuple
         * @param {InternalRelationTuple} [payload] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        postCheck: async (payload?: InternalRelationTuple, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/check`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const ReadApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getCheck(namespace: string, object: string, relation: string, subject?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetCheckResponse>> {
            const localVarAxiosArgs = await ReadApiAxiosParamCreator(configuration).getCheck(namespace, object, relation, subject, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async getExpand(namespace: string, object: string, relation: string, maxDepth?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExpandTree>> {
            const localVarAxiosArgs = await ReadApiAxiosParamCreator(configuration).getExpand(namespace, object, relation, maxDepth, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getRelationTuples(namespace: string, object?: string, relation?: string, subject?: string, pageToken?: string, pageSize?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetRelationTuplesResponse>> {
            const localVarAxiosArgs = await ReadApiAxiosParamCreator(configuration).getRelationTuples(namespace, object, relation, subject, pageToken, pageSize, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async postCheck(payload?: InternalRelationTuple, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetCheckResponse>> {
            const localVarAxiosArgs = await ReadApiAxiosParamCreator(configuration).postCheck(payload, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ReadApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCheck(namespace: string, object: string, relation: string, subject?: string, options?: any): AxiosPromise<GetCheckResponse> {
            return ReadApiFp(configuration).getCheck(namespace, object, relation, subject, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to expand a relation tuple.
         * @summary Expand a Relation Tuple
        ...
        getExpand(namespace: string, object: string, relation: string, maxDepth?: number, options?: any): AxiosPromise<ExpandTree> {
            return ReadApiFp(configuration).getExpand(namespace, object, relation, maxDepth, options).then((request) => request(axios, basePath));
        },
        /**
         * Get all relation tuples that match the query. Only the namespace field is required.
         * @summary Query relation tuples
         ...
         * @throws {RequiredError}
         */
        getRelationTuples(namespace: string, object?: string, relation?: string, subject?: string, pageToken?: string, pageSize?: number, options?: any): AxiosPromise<GetRelationTuplesResponse> {
            return ReadApiFp(configuration).getRelationTuples(namespace, object, relation, subject, pageToken, pageSize, options).then((request) => request(axios, basePath));
        },
        /**
         * To learn how relation tuples and the check works, head over to [the documentation](../concepts/relation-tuples.mdx).
         * @summary Check a relation tuple
         ...
         * @throws {RequiredError}
         */
        postCheck(payload?: InternalRelationTuple, options?: any): AxiosPromise<GetCheckResponse> {
            return ReadApiFp(configuration).postCheck(payload, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ReadApi extends BaseAPI {
     ...
     * @memberof ReadApi
     */
    public getCheck(namespace: string, object: string, relation: string, subject?: string, options?: any) {
        return ReadApiFp(this.configuration).getCheck(namespace, object, relation, subject, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ReadApi
     */
    public getRelationTuples(namespace: string, object?: string, relation?: string, subject?: string, pageToken?: string, pageSize?: number, options?: any) {
        return ReadApiFp(this.configuration).getRelationTuples(namespace, object, relation, subject, pageToken, pageSize, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ReadApi
     */
    public postCheck(payload?: InternalRelationTuple, options?: any) {
...
export const WriteApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createRelationTuple: async (payload?: InternalRelationTuple, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/relation-tuples`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        deleteRelationTuple: async (namespace: string, object: string, relation: string, subject?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'namespace' is not null or undefined
            if (namespace === null || namespace === undefined) {
                throw new RequiredError('namespace','Required parameter namespace was null or undefined when calling deleteRelationTuple.');
            }
            // verify required parameter 'object' is not null or undefined
            if (object === null || object === undefined) {
                throw new RequiredError('object','Required parameter object was null or undefined when calling deleteRelationTuple.');
            }
            // verify required parameter 'relation' is not null or undefined
            if (relation === null || relation === undefined) {
                throw new RequiredError('relation','Required parameter relation was null or undefined when calling deleteRelationTuple.');
            }
            const localVarPath = `/relation-tuples`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
...
export const WriteApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createRelationTuple(payload?: InternalRelationTuple, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InternalRelationTuple>> {
            const localVarAxiosArgs = await WriteApiAxiosParamCreator(configuration).createRelationTuple(payload, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async deleteRelationTuple(namespace: string, object: string, relation: string, subject?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await WriteApiAxiosParamCreator(configuration).deleteRelationTuple(namespace, object, relation, subject, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        ...
        async patchRelationTuples(payload?: Array<PatchDelta>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await WriteApiAxiosParamCreator(configuration).patchRelationTuples(payload, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const WriteApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createRelationTuple(payload?: InternalRelationTuple, options?: any): AxiosPromise<InternalRelationTuple> {
            return WriteApiFp(configuration).createRelationTuple(payload, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to delete a relation tuple.
         * @summary Delete a Relation Tuple
         ...
         * @throws {RequiredError}
         */
        deleteRelationTuple(namespace: string, object: string, relation: string, subject?: string, options?: any): AxiosPromise<void> {
            return WriteApiFp(configuration).deleteRelationTuple(namespace, object, relation, subject, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to patch one or more relation tuples.
         * @summary Patch Multiple Relation Tuples
        ...
        patchRelationTuples(payload?: Array<PatchDelta>, options?: any): AxiosPromise<void> {
            return WriteApiFp(configuration).patchRelationTuples(payload, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class WriteApi extends BaseAPI {
     ...
     * @memberof WriteApi
     */
    public createRelationTuple(payload?: InternalRelationTuple, options?: any) {
     ...
     * @memberof WriteApi
     */
    public deleteRelationTuple(namespace: string, object: string, relation: string, subject?: string, options?: any) {
        return WriteApiFp(this.configuration).deleteRelationTuple(namespace, object, relation, subject, options).then((request) => request(this.axios, this.basePath));
    }
