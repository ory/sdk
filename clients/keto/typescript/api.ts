...
export const ReadApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getExpand: async (namespace: string, object: string, relation: string, maxDepth: number, options: any = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('getExpand', 'maxDepth', maxDepth)
         ...
         * @throws {RequiredError}
         */
        getRelationTuples: async (namespace: string, pageToken?: string, pageSize?: number, object?: string, relation?: string, subjectId?: string, subjectSetNamespace?: string, subjectSetObject?: string, subjectSetRelation?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'namespace' is not null or undefined
...
export const ReadApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRelationTuples(namespace: string, pageToken?: string, pageSize?: number, object?: string, relation?: string, subjectId?: string, subjectSetNamespace?: string, subjectSetObject?: string, subjectSetRelation?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetRelationTuplesResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRelationTuples(namespace, pageToken, pageSize, object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * To learn how relation tuples and the check works, head over to [the documentation](../concepts/relation-tuples.mdx).
...
export const ReadApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRelationTuples(namespace: string, pageToken?: string, pageSize?: number, object?: string, relation?: string, subjectId?: string, subjectSetNamespace?: string, subjectSetObject?: string, subjectSetRelation?: string, options?: any): AxiosPromise<GetRelationTuplesResponse> {
            return localVarFp.getRelationTuples(namespace, pageToken, pageSize, object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, options).then((request) => request(axios, basePath));
        },
        /**
         * To learn how relation tuples and the check works, head over to [the documentation](../concepts/relation-tuples.mdx).
         * @summary Check a relation tuple
...
export class ReadApi extends BaseAPI implements ReadApiInterface {
     ...
     * @memberof ReadApi
     */
    public getRelationTuples(namespace: string, pageToken?: string, pageSize?: number, object?: string, relation?: string, subjectId?: string, subjectSetNamespace?: string, subjectSetObject?: string, subjectSetRelation?: string, options?: any) {
        return ReadApiFp(this.configuration).getRelationTuples(namespace, pageToken, pageSize, object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, options).then((request) => request(this.axios, this.basePath));
    }
