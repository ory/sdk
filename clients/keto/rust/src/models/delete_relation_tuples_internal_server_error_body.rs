...
pub struct DeleteRelationTuplesInternalServerErrorBody {
    /// code
...
impl DeleteRelationTuplesInternalServerErrorBody {
    ...
    pub fn new() -> DeleteRelationTuplesInternalServerErrorBody {
