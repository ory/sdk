...
pub async fn get_expand(configuration: &configuration::Configuration, namespace: &str, object: &str, relation: &str, max_depth: i64) -> Result<crate::models::ExpandTree, Error<GetExpandError>> {
    ...
    local_var_req_builder = local_var_req_builder.query(&[("object", &object.to_string())]);
    local_var_req_builder = local_var_req_builder.query(&[("relation", &relation.to_string())]);
    local_var_req_builder = local_var_req_builder.query(&[("max-depth", &max_depth.to_string())]);
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn get_relation_tuples(configuration: &configuration::Configuration, namespace: &str, page_token: Option<&str>, page_size: Option<i64>, object: Option<&str>, relation: Option<&str>, subject_id: Option<&str>, subject_set_namespace: Option<&str>, subject_set_object: Option<&str>, subject_set_relation: Option<&str>) -> Result<crate::models::GetRelationTuplesResponse, Error<GetRelationTuplesError>> {
