...
pub async fn create_relation_tuple(configuration: &configuration::Configuration, payload: Option<crate::models::InternalRelationTuple>) -> Result<crate::models::InternalRelationTuple, Error<CreateRelationTupleError>> {
...
pub async fn delete_relation_tuple(configuration: &configuration::Configuration, namespace: &str, object: &str, relation: &str, subject: Option<&str>) -> Result<(), Error<DeleteRelationTupleError>> {
