...
[assembly: InternalsVisibleTo("Ory.Keto.Client.Test")]
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is KetoExpandedPermissionTree.TypeEnum ketoExpandedPermissionTreeTypeEnum)
                return KetoExpandedPermissionTree.TypeEnumToJsonValue(ketoExpandedPermissionTreeTypeEnum);
            if (obj is KetoRelationshipPatch.ActionEnum ketoRelationshipPatchActionEnum)
                return KetoRelationshipPatch.ActionEnumToJsonValue(ketoRelationshipPatchActionEnum);
