...
namespace Ory.Keto.Client.Model
{
    ...
    public partial class KetoPatchDelta : IEquatable<KetoPatchDelta>, IValidatableObject
    {
        ...
        public KetoPatchDelta(ActionEnum? action = default(ActionEnum?), KetoRelationTuple relationTuple = default(KetoRelationTuple))
        {
            this.Action = action;
        ...
        public KetoRelationTuple RelationTuple { get; set; }
