...
namespace Ory.Keto.Client.Model
{
    ...
    public partial class KetoRelationship : IEquatable<KetoRelationship>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KetoRelationship" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KetoRelationship()
        {
        ...
        public KetoRelationship(string _namespace = default(string), string _object = default(string), string relation = default(string), string subjectId = default(string), KetoSubjectSet subjectSet = default(KetoSubjectSet))
        {
            // to ensure "_namespace" is required (not null)
            if (_namespace == null) {
                throw new ArgumentNullException("_namespace is a required property for KetoRelationship and cannot be null");
            }
            this.Namespace = _namespace;
            // to ensure "_object" is required (not null)
            if (_object == null) {
                throw new ArgumentNullException("_object is a required property for KetoRelationship and cannot be null");
            }
            this.Object = _object;
            // to ensure "relation" is required (not null)
            if (relation == null) {
                throw new ArgumentNullException("relation is a required property for KetoRelationship and cannot be null");
            }
        ...
        {
            return this.Equals(input as KetoRelationship);
        }

        /// <summary>
        /// Returns true if KetoRelationship instances are equal
        /// </summary>
        /// <param name="input">Instance of KetoRelationship to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KetoRelationship input)
        {
            if (input == null)
            {
                return false;
