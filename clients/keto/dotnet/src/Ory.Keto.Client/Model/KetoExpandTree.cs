...
namespace Ory.Keto.Client.Model
{
    ...
    public partial class KetoExpandTree : IEquatable<KetoExpandTree>, IValidatableObject
    {
        ...
        public KetoExpandTree(List<KetoExpandTree> children = default(List<KetoExpandTree>), KetoRelationTuple tuple = default(KetoRelationTuple), TypeEnum type = default(TypeEnum))
        {
            this.Type = type;
        ...
        public KetoRelationTuple Tuple { get; set; }
