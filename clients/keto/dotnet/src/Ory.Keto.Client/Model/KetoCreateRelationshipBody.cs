...
namespace Ory.Keto.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createRelationshipBody")]
    public partial class KetoCreateRelationshipBody : IEquatable<KetoCreateRelationshipBody>, IValidatableObject
    {
        /// <summary>
        ...
        public KetoCreateRelationshipBody(string _namespace = default(string), string _object = default(string), string relation = default(string), string subjectId = default(string), KetoSubjectSet subjectSet = default(KetoSubjectSet))
        {
        ...
        {
            return this.Equals(input as KetoCreateRelationshipBody);
        }

        /// <summary>
        /// Returns true if KetoCreateRelationshipBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KetoCreateRelationshipBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KetoCreateRelationshipBody input)
        {
            if (input == null)
            {
                return false;
