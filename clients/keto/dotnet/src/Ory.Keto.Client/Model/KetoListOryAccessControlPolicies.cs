...
namespace Ory.Keto.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listOryAccessControlPolicies")]
    public partial class KetoListOryAccessControlPolicies : IEquatable<KetoListOryAccessControlPolicies>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KetoListOryAccessControlPolicies" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KetoListOryAccessControlPolicies() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KetoListOryAccessControlPolicies" /> class.
        /// </summary>
        ...
        public KetoListOryAccessControlPolicies(string flavor = default(string), long limit = default(long), long offset = default(long))
        {
            // to ensure "flavor" is required (not null)
            this.Flavor = flavor ?? throw new ArgumentNullException("flavor is a required property for KetoListOryAccessControlPolicies and cannot be null");
            this.Limit = limit;
            this.Offset = offset;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KetoListOryAccessControlPolicies {\n");
        ...
        {
            return this.Equals(input as KetoListOryAccessControlPolicies);
        }

        /// <summary>
        /// Returns true if KetoListOryAccessControlPolicies instances are equal
        /// </summary>
        /// <param name="input">Instance of KetoListOryAccessControlPolicies to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KetoListOryAccessControlPolicies input)
        {
            if (input == null)
                return false;
