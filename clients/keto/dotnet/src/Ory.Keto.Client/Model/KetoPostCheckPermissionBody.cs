...
namespace Ory.Keto.Client.Model
{
    ...
    public partial class KetoPostCheckPermissionBody : IEquatable<KetoPostCheckPermissionBody>, IValidatableObject
    {
        /// <summary>
        ...
        public KetoPostCheckPermissionBody(string _namespace = default(string), string _object = default(string), string relation = default(string), string subjectId = default(string), KetoSubjectSet subjectSet = default(KetoSubjectSet))
        {
        ...
        {
            return this.Equals(input as KetoPostCheckPermissionBody);
        }

        /// <summary>
        /// Returns true if KetoPostCheckPermissionBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KetoPostCheckPermissionBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KetoPostCheckPermissionBody input)
        {
            if (input == null)
            {
                return false;
