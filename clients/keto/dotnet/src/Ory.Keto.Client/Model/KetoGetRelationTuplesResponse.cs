...
namespace Ory.Keto.Client.Model
{
    ...
    public partial class KetoGetRelationTuplesResponse : IEquatable<KetoGetRelationTuplesResponse>, IValidatableObject
    {
        ...
        public KetoGetRelationTuplesResponse(string nextPageToken = default(string), List<KetoRelationTuple> relationTuples = default(List<KetoRelationTuple>))
        {
        ...
        public List<KetoRelationTuple> RelationTuples { get; set; }
