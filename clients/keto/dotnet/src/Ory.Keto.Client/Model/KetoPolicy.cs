...
namespace Ory.Keto.Client.Model
{
    ...
    public partial class KetoPolicy : IEquatable<KetoPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KetoPolicy" /> class.
        /// </summary>
        ...
        public KetoPolicy(List<string> actions = default(List<string>), Object conditions = default(Object), string description = default(string), string effect = default(string), string id = default(string), List<string> resources = default(List<string>), List<string> subjects = default(List<string>))
        {
        ...
        {
            return this.Equals(input as KetoPolicy);
        }

        /// <summary>
        /// Returns true if KetoPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of KetoPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KetoPolicy input)
        {
            if (input == null)
                return false;
