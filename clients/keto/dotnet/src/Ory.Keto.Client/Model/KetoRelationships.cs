...
namespace Ory.Keto.Client.Model
{
    ...
    public partial class KetoRelationships : IEquatable<KetoRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        public KetoRelationships(string nextPageToken = default(string), List<KetoRelationship> relationTuples = default(List<KetoRelationship>))
        {
        ...
        public List<KetoRelationship> RelationTuples { get; set; }
        ...
        {
            return this.Equals(input as KetoRelationships);
        }

        /// <summary>
        /// Returns true if KetoRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of KetoRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KetoRelationships input)
        {
            if (input == null)
            {
                return false;
