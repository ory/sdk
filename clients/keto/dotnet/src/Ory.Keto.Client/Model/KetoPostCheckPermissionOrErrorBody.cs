...
namespace Ory.Keto.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postCheckPermissionOrErrorBody")]
    public partial class KetoPostCheckPermissionOrErrorBody : IEquatable<KetoPostCheckPermissionOrErrorBody>, IValidatableObject
    {
        /// <summary>
        ...
        public KetoPostCheckPermissionOrErrorBody(string _namespace = default(string), string _object = default(string), string relation = default(string), string subjectId = default(string), KetoSubjectSet subjectSet = default(KetoSubjectSet))
        {
        ...
        {
            return this.Equals(input as KetoPostCheckPermissionOrErrorBody);
        }

        /// <summary>
        /// Returns true if KetoPostCheckPermissionOrErrorBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KetoPostCheckPermissionOrErrorBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KetoPostCheckPermissionOrErrorBody input)
        {
            if (input == null)
            {
                return false;
