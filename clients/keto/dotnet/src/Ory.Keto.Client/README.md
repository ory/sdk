...
inputSpec: spec/keto/v26.2.0.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{258B8228-30FE-41BF-B005-D2B423AC9DAF}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetVersionApiResponse apiResponse = await api.GetVersionAsync("todo");
            KetoGetVersion200Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Ory Keto API
- appVersion: v26.2.0
- appDescription: Documentation for all of Ory Keto&#39;s REST APIs. gRPC is documented separately. 
