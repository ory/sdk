...
namespace Ory.Keto.Client.Api
{
    ...
    public interface IVersionApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<KetoVersion> GetVersionAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<KetoVersion>> GetVersionAsyncWithHttpInfo ();
    ...
    public partial class VersionApi : IVersionApi
    {
        ...
        /// <exception cref="Ory.Keto.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (KetoVersion)</returns>
        public async System.Threading.Tasks.Task<Ory.Keto.Client.Client.ApiResponse<KetoVersion>> GetVersionAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<KetoVersion>("/version", localVarRequestOptions, this.Configuration);
