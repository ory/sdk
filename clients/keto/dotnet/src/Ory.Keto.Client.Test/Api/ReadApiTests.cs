...
namespace Ory.Keto.Client.Test.Api
{
    ...
    public class ReadApiTests : IDisposable
    {
        ...
        public void GetRelationTuplesTest()
        {
            ...
            //long? pageSize = null;
            //var response = instance.GetRelationTuples(_namespace, _object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, pageToken, pageSize);
