...
// tests for DeleteRelationTuplesInternalServerErrorBody
void main() {
  final instance = DeleteRelationTuplesInternalServerErrorBodyBuilder();
  // TODO add properties to the builder and call build()

  group(DeleteRelationTuplesInternalServerErrorBody, () {
    // code
    // int code
