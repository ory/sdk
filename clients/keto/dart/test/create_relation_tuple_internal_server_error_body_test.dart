...
// tests for CreateRelationTupleInternalServerErrorBody
void main() {
  final instance = CreateRelationTupleInternalServerErrorBodyBuilder();
  // TODO add properties to the builder and call build()

  group(CreateRelationTupleInternalServerErrorBody, () {
    // code
    // int code
