...
// tests for PatchRelationTuplesInternalServerErrorBody
void main() {
  final instance = PatchRelationTuplesInternalServerErrorBodyBuilder();
  // TODO add properties to the builder and call build()

  group(PatchRelationTuplesInternalServerErrorBody, () {
    // code
    // int code
