...
class GenericError(BaseModel):
    ...
    details: Optional[Dict[str, Any]] = Field(default=None, description="Further error details")
    ...
    __properties: ClassVar[List[str]] = ["code", "debug", "details", "id", "message", "reason", "request", "status"]
