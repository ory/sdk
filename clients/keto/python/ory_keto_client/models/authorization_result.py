...
class AuthorizationResult(object):
    ...
    @property
    def allowed(self):
        """Gets the allowed of this AuthorizationResult.  # noqa: E501

        Allowed is true if the request should be allowed and false otherwise.  # noqa: E501

        :return: The allowed of this AuthorizationResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def allowed(self, allowed):
        """Sets the allowed of this AuthorizationResult.

        Allowed is true if the request should be allowed and false otherwise.  # noqa: E501

        :param allowed: The allowed of this AuthorizationResult.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthorizationResult):
            return False
