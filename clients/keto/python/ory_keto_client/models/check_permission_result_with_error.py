...
class CheckPermissionResultWithError(BaseModel):
    ...
    """ # noqa: E501
    allowed: StrictBool = Field(description="whether the relation tuple is allowed")
    error: Optional[StrictStr] = Field(default=None, description="any error generated while checking the relation tuple")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["allowed", "error"]
