...
class IsInstanceAliveOK(object):
    ...
    @property
    def payload(self):
        """Gets the payload of this IsInstanceAliveOK.  # noqa: E501


        :return: The payload of this IsInstanceAliveOK.  # noqa: E501
        :rtype: SwaggerHealthStatus
        """
        return self._payload

    @payload.setter
    def payload(self, payload):
        """Sets the payload of this IsInstanceAliveOK.


        :param payload: The payload of this IsInstanceAliveOK.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IsInstanceAliveOK):
            return False
