...
class GetOryAccessControlPolicyRole(object):
    ...
    @property
    def flavor(self):
        """Gets the flavor of this GetOryAccessControlPolicyRole.  # noqa: E501

        The ORY Access Control Policy flavor. Can be \"regex\", \"glob\", and \"exact\".  in: path  # noqa: E501

        :return: The flavor of this GetOryAccessControlPolicyRole.  # noqa: E501
        :rtype: str
        """
        return self._flavor
    ...
    def flavor(self, flavor):
        """Sets the flavor of this GetOryAccessControlPolicyRole.

        The ORY Access Control Policy flavor. Can be \"regex\", \"glob\", and \"exact\".  in: path  # noqa: E501

        :param flavor: The flavor of this GetOryAccessControlPolicyRole.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this GetOryAccessControlPolicyRole.  # noqa: E501

        The ID of the ORY Access Control Policy Role.  in: path  # noqa: E501

        :return: The id of this GetOryAccessControlPolicyRole.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GetOryAccessControlPolicyRole.

        The ID of the ORY Access Control Policy Role.  in: path  # noqa: E501

        :param id: The id of this GetOryAccessControlPolicyRole.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetOryAccessControlPolicyRole):
            return False
