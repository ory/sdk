...
class DoOryAccessControlPoliciesAllowInternalServerErrorBody(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """DoOryAccessControlPoliciesAllowInternalServerErrorBody - a model defined in OpenAPI
