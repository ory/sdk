...
class UpsertOryAccessControlPolicyRoleInternalServerErrorBody(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """UpsertOryAccessControlPolicyRoleInternalServerErrorBody - a model defined in OpenAPI
