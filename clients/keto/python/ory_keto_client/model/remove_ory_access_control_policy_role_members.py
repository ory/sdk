...
class RemoveOryAccessControlPolicyRoleMembers(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, flavor, id, member, *args, **kwargs):  # noqa: E501
        """RemoveOryAccessControlPolicyRoleMembers - a model defined in OpenAPI
