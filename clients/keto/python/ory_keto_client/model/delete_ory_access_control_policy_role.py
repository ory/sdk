...
class DeleteOryAccessControlPolicyRole(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, flavor, id, *args, **kwargs):  # noqa: E501
        """DeleteOryAccessControlPolicyRole - a model defined in OpenAPI
