...
class DeleteOryAccessControlPolicyRoleInternalServerErrorBody(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """DeleteOryAccessControlPolicyRoleInternalServerErrorBody - a model defined in OpenAPI
