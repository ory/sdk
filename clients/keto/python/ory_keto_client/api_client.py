...
from ory_keto_client import rest
from ory_keto_client.configuration import Configuration
from ory_keto_client.exceptions import ApiTypeError, ApiValueError, ApiException
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EnginesApi()
        api_instance.add_ory_access_control_policy_role_members  # this is an instance of the class Endpoint
        api_instance.add_ory_access_control_policy_role_members()  # this invokes api_instance.add_ory_access_control_policy_role_members.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_ory_access_control_policy_role_members.callable or self.callable in this class
