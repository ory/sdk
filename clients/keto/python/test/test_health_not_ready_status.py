...
from ory_keto_client.models.health_not_ready_status import HealthNotReadyStatus  # noqa: E501
...
class TestHealthNotReadyStatus(unittest.TestCase):
    ...
    def testHealthNotReadyStatus(self):
        ...
        # model = ory_keto_client.models.health_not_ready_status.HealthNotReadyStatus()  # noqa: E501
        pass
