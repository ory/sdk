...
```shell
gem install ./ory-keto-client-v25.4.0.gem
```

(for development, run `gem install --dev ./ory-keto-client-v25.4.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ory-keto-client', '~> v25.4.0'
...
*OryKetoClient::PermissionApi* | [**batch_check_permission**](docs/PermissionApi.md#batch_check_permission) | **POST** /relation-tuples/batch/check | Batch check permissions
...
## Documentation for Models
 ...
 - [OryKetoClient::BatchCheckPermissionBody](docs/BatchCheckPermissionBody.md)
 - [OryKetoClient::BatchCheckPermissionResult](docs/BatchCheckPermissionResult.md)
 ...
 - [OryKetoClient::CheckPermissionResultWithError](docs/CheckPermissionResultWithError.md)
