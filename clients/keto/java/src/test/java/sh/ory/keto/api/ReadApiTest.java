...
public class ReadApiTest {
    ...
    public void getRelationTuplesTest() throws ApiException {
        ...
        Long pageSize = null;
        GetRelationTuplesResponse response = api.getRelationTuples(namespace, _object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, pageToken, pageSize);
