...
public class ReadApiTest {
    ...
    public void getCheckTest() throws ApiException {
        ...
        GetCheckResponse response = api.getCheck(namespace, _object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation);
    ...
    public void getRelationTuplesTest() throws ApiException {
        ...
        String subjectSetObject = null;
        String subjectSetRelation = null;
        GetRelationTuplesResponse response = api.getRelationTuples(namespace, pageToken, pageSize, _object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation);
