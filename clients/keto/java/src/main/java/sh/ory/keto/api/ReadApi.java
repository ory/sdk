...
public class ReadApi {
    ...
    private okhttp3.Call getExpandValidateBeforeCall(String namespace, String _object, String relation, Long maxDepth, final ApiCallback _callback) throws ApiException {
        ...
        if (maxDepth == null) {
            throw new ApiException("Missing the required parameter 'maxDepth' when calling getExpand(Async)");
        }
     ...
     */
    public okhttp3.Call getRelationTuplesCall(String namespace, String pageToken, Long pageSize, String _object, String relation, String subjectId, String subjectSetNamespace, String subjectSetObject, String subjectSetRelation, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRelationTuplesValidateBeforeCall(String namespace, String pageToken, Long pageSize, String _object, String relation, String subjectId, String subjectSetNamespace, String subjectSetObject, String subjectSetRelation, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getRelationTuplesCall(namespace, pageToken, pageSize, _object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, _callback);
        return localVarCall;
     ...
     */
    public GetRelationTuplesResponse getRelationTuples(String namespace, String pageToken, Long pageSize, String _object, String relation, String subjectId, String subjectSetNamespace, String subjectSetObject, String subjectSetRelation) throws ApiException {
        ApiResponse<GetRelationTuplesResponse> localVarResp = getRelationTuplesWithHttpInfo(namespace, pageToken, pageSize, _object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetRelationTuplesResponse> getRelationTuplesWithHttpInfo(String namespace, String pageToken, Long pageSize, String _object, String relation, String subjectId, String subjectSetNamespace, String subjectSetObject, String subjectSetRelation) throws ApiException {
        okhttp3.Call localVarCall = getRelationTuplesValidateBeforeCall(namespace, pageToken, pageSize, _object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, null);
     ...
     */
    public okhttp3.Call getRelationTuplesAsync(String namespace, String pageToken, Long pageSize, String _object, String relation, String subjectId, String subjectSetNamespace, String subjectSetObject, String subjectSetRelation, final ApiCallback<GetRelationTuplesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRelationTuplesValidateBeforeCall(namespace, pageToken, pageSize, _object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, _callback);
        Type localVarReturnType = new TypeToken<GetRelationTuplesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
