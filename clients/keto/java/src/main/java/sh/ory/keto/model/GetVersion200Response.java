...
public class GetVersion200Response {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The version of Ory Keto.")
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetVersion200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetVersion200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetVersion200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetVersion200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
