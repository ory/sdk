...
import sh.ory.keto.model.BatchCheckPermissionBody;
import sh.ory.keto.model.BatchCheckPermissionResult;
...
public class PermissionApi {
    ...
    /**
     * Build call for batchCheckPermission
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> batchCheckPermissionResult </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> errorGeneric </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> errorGeneric </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call batchCheckPermissionCall(Long maxDepth, BatchCheckPermissionBody batchCheckPermissionBody, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = batchCheckPermissionBody;

        // create path and map variables
        String localVarPath = "/relation-tuples/batch/check";
    ...
    private okhttp3.Call batchCheckPermissionValidateBeforeCall(Long maxDepth, BatchCheckPermissionBody batchCheckPermissionBody, final ApiCallback _callback) throws ApiException {
        return batchCheckPermissionCall(maxDepth, batchCheckPermissionBody, _callback);
     ...
     */
    public BatchCheckPermissionResult batchCheckPermission(Long maxDepth, BatchCheckPermissionBody batchCheckPermissionBody) throws ApiException {
        ApiResponse<BatchCheckPermissionResult> localVarResp = batchCheckPermissionWithHttpInfo(maxDepth, batchCheckPermissionBody);
     ...
     * @param maxDepth  (optional)
     * @param batchCheckPermissionBody  (optional)
     * @return ApiResponse&lt;BatchCheckPermissionResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BatchCheckPermissionResult> batchCheckPermissionWithHttpInfo(Long maxDepth, BatchCheckPermissionBody batchCheckPermissionBody) throws ApiException {
        okhttp3.Call localVarCall = batchCheckPermissionValidateBeforeCall(maxDepth, batchCheckPermissionBody, null);
        Type localVarReturnType = new TypeToken<BatchCheckPermissionResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Batch check permissions (asynchronously)
     * To learn how relationship tuples and the check works, head over to [the documentation](https://www.ory.sh/docs/keto/concepts/api-overview).
     * @param maxDepth  (optional)
     * @param batchCheckPermissionBody  (optional)
     ...
     */
    public okhttp3.Call batchCheckPermissionAsync(Long maxDepth, BatchCheckPermissionBody batchCheckPermissionBody, final ApiCallback<BatchCheckPermissionResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = batchCheckPermissionValidateBeforeCall(maxDepth, batchCheckPermissionBody, _callback);
        Type localVarReturnType = new TypeToken<BatchCheckPermissionResult>(){}.getType();
