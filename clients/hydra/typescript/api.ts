...
export interface JwkApiInterface {
     ...
     */
    createJsonWebKeySet(set: string, createJsonWebKeySet: CreateJsonWebKeySet, options?: AxiosRequestConfig): AxiosPromise<JsonWebKeySet>;
     ...
     * @memberof JwkApiInterface
     */
    deleteJsonWebKey(set: string, kid: string, options?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof JwkApiInterface
     */
    getJsonWebKey(set: string, kid: string, options?: AxiosRequestConfig): AxiosPromise<JsonWebKeySet>;
     ...
     * @memberof JwkApiInterface
     */
    setJsonWebKey(set: string, kid: string, jsonWebKey?: JsonWebKey, options?: AxiosRequestConfig): AxiosPromise<JsonWebKey>;
     ...
     * @memberof JwkApiInterface
     */
    setJsonWebKeySet(set: string, jsonWebKeySet?: JsonWebKeySet, options?: AxiosRequestConfig): AxiosPromise<JsonWebKeySet>;
 ...
 * @extends {BaseAPI}
 */
export class JwkApi extends BaseAPI implements JwkApiInterface {
    /**
     * This endpoint is capable of generating JSON Web Key Sets for you. There a different strategies available, such as symmetric cryptographic keys (HS256, HS512) and asymetric cryptographic keys (RS256, ECDSA). If the specified JSON Web Key Set does not exist, it will be created.  A JSON Web Key (JWK) is a JavaScript Object Notation (JSON) data structure that represents a cryptographic key. A JWK Set is a JSON data structure that represents a set of JWKs. A JSON Web Key is identified by its set and key id. ORY Hydra uses this functionality to store cryptographic keys used for TLS and JSON Web Tokens (such as OpenID Connect ID tokens), and allows storing user-defined keys as well.
     * @summary Create JSON Web Key
     * @param {string} set The JSON Web Key Set ID
     ...
     * @memberof JwkApi
     */
    public createJsonWebKeySet(set: string, createJsonWebKeySet: CreateJsonWebKeySet, options?: AxiosRequestConfig) {
        return JwkApiFp(this.configuration).createJsonWebKeySet(set, createJsonWebKeySet, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof JwkApi
     */
    public deleteJsonWebKey(set: string, kid: string, options?: AxiosRequestConfig) {
        return JwkApiFp(this.configuration).deleteJsonWebKey(set, kid, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteJsonWebKeySet(set: string, options?: AxiosRequestConfig) {
        return JwkApiFp(this.configuration).deleteJsonWebKeySet(set, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof JwkApi
     */
    public getJsonWebKey(set: string, kid: string, options?: AxiosRequestConfig) {
        return JwkApiFp(this.configuration).getJsonWebKey(set, kid, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getJsonWebKeySet(set: string, options?: AxiosRequestConfig) {
        return JwkApiFp(this.configuration).getJsonWebKeySet(set, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof JwkApi
     */
    public setJsonWebKey(set: string, kid: string, jsonWebKey?: JsonWebKey, options?: AxiosRequestConfig) {
        return JwkApiFp(this.configuration).setJsonWebKey(set, kid, jsonWebKey, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof JwkApi
     */
    public setJsonWebKeySet(set: string, jsonWebKeySet?: JsonWebKeySet, options?: AxiosRequestConfig) {
        return JwkApiFp(this.configuration).setJsonWebKeySet(set, jsonWebKeySet, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const OAuth2ApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listOAuth2ConsentSessions: async (subject: string, pageSize?: number, pageToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        revokeOAuth2LoginSessions: async (subject: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'subject' is not null or undefined
            assertParamExists('revokeOAuth2LoginSessions', 'subject', subject)
...
export const OAuth2ApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listOAuth2ConsentSessions(subject: string, pageSize?: number, pageToken?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OAuth2ConsentSession>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listOAuth2ConsentSessions(subject, pageSize, pageToken, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Use this endpoint to list all trusted JWT Bearer Grant Type Issuers.
         ...
         * @throws {RequiredError}
         */
        async revokeOAuth2LoginSessions(subject: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.revokeOAuth2LoginSessions(subject, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Revoking a token (both access and refresh) means that the tokens will be invalid. A revoked access token can no longer be used to make access requests, and a revoked refresh token can no longer be used to refresh an access token. Revoking a refresh token also invalidates the access token that was created with it. A token may only be revoked by the client the token was generated for.
...
export const OAuth2ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listOAuth2ConsentSessions(subject: string, pageSize?: number, pageToken?: string, options?: any): AxiosPromise<Array<OAuth2ConsentSession>> {
            return localVarFp.listOAuth2ConsentSessions(subject, pageSize, pageToken, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to list all trusted JWT Bearer Grant Type Issuers.
         * @summary List Trusted OAuth2 JWT Bearer Grant Type Issuers
         ...
         * @throws {RequiredError}
         */
        revokeOAuth2LoginSessions(subject: string, options?: any): AxiosPromise<void> {
            return localVarFp.revokeOAuth2LoginSessions(subject, options).then((request) => request(axios, basePath));
        },
        /**
         * Revoking a token (both access and refresh) means that the tokens will be invalid. A revoked access token can no longer be used to make access requests, and a revoked refresh token can no longer be used to refresh an access token. Revoking a refresh token also invalidates the access token that was created with it. A token may only be revoked by the client the token was generated for.
         * @summary Revoke OAuth 2.0 Access or Refresh Token
...
export interface OAuth2ApiInterface {
     ...
     */
    acceptOAuth2ConsentRequest(consentChallenge: string, acceptOAuth2ConsentRequest?: AcceptOAuth2ConsentRequest, options?: AxiosRequestConfig): AxiosPromise<OAuth2RedirectTo>;
     ...
     * @memberof OAuth2ApiInterface
     */
    acceptOAuth2LoginRequest(loginChallenge: string, acceptOAuth2LoginRequest?: AcceptOAuth2LoginRequest, options?: AxiosRequestConfig): AxiosPromise<OAuth2RedirectTo>;
     ...
     * @memberof OAuth2ApiInterface
     */
    acceptOAuth2LogoutRequest(logoutChallenge: string, options?: AxiosRequestConfig): AxiosPromise<OAuth2RedirectTo>;
     ...
     * @memberof OAuth2ApiInterface
     */
    deleteTrustedOAuth2JwtGrantIssuer(id: string, options?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof OAuth2ApiInterface
     */
    getOAuth2ConsentRequest(consentChallenge: string, options?: AxiosRequestConfig): AxiosPromise<OAuth2ConsentRequest>;
     ...
     * @memberof OAuth2ApiInterface
     */
    getOAuth2LoginRequest(loginChallenge: string, options?: AxiosRequestConfig): AxiosPromise<OAuth2LoginRequest>;
     ...
     * @memberof OAuth2ApiInterface
     */
    getOAuth2LogoutRequest(logoutChallenge: string, options?: AxiosRequestConfig): AxiosPromise<OAuth2LogoutRequest>;
     ...
     * @memberof OAuth2ApiInterface
     */
    getTrustedOAuth2JwtGrantIssuer(id: string, options?: AxiosRequestConfig): AxiosPromise<TrustedOAuth2JwtGrantIssuer>;
     ...
     * @memberof OAuth2ApiInterface
     */
    introspectOAuth2Token(token: string, scope?: string, options?: AxiosRequestConfig): AxiosPromise<IntrospectedOAuth2Token>;
     ...
     * @memberof OAuth2ApiInterface
     */
    listOAuth2Clients(pageSize?: number, pageToken?: string, clientName?: string, owner?: string, options?: AxiosRequestConfig): AxiosPromise<Array<OAuth2Client>>;
     ...
     * @memberof OAuth2ApiInterface
     */
    listOAuth2ConsentSessions(subject: string, pageSize?: number, pageToken?: string, options?: AxiosRequestConfig): AxiosPromise<Array<OAuth2ConsentSession>>;
     ...
     * @memberof OAuth2ApiInterface
     */
    listTrustedOAuth2JwtGrantIssuers(maxItems?: number, defaultItems?: number, issuer?: string, options?: AxiosRequestConfig): AxiosPromise<Array<TrustedOAuth2JwtGrantIssuer>>;
     ...
     * @memberof OAuth2ApiInterface
     */
    oauth2TokenExchange(grantType: string, clientId?: string, code?: string, redirectUri?: string, refreshToken?: string, options?: AxiosRequestConfig): AxiosPromise<OAuth2TokenExchange>;
     ...
     * @memberof OAuth2ApiInterface
     */
    patchOAuth2Client(id: string, jsonPatch: Array<JsonPatch>, options?: AxiosRequestConfig): AxiosPromise<OAuth2Client>;
     ...
     * @memberof OAuth2ApiInterface
     */
    rejectOAuth2ConsentRequest(consentChallenge: string, rejectOAuth2Request?: RejectOAuth2Request, options?: AxiosRequestConfig): AxiosPromise<OAuth2RedirectTo>;
     ...
     * @memberof OAuth2ApiInterface
     */
    rejectOAuth2LoginRequest(loginChallenge: string, rejectOAuth2Request?: RejectOAuth2Request, options?: AxiosRequestConfig): AxiosPromise<OAuth2RedirectTo>;
     ...
     * @memberof OAuth2ApiInterface
     */
    rejectOAuth2LogoutRequest(logoutChallenge: string, options?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof OAuth2ApiInterface
     */
    revokeOAuth2ConsentSessions(subject: string, client?: string, all?: boolean, options?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof OAuth2ApiInterface
     */
    revokeOAuth2LoginSessions(subject: string, options?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof OAuth2ApiInterface
     */
    setOAuth2Client(id: string, oAuth2Client: OAuth2Client, options?: AxiosRequestConfig): AxiosPromise<OAuth2Client>;
     ...
     * @memberof OAuth2ApiInterface
     */
    setOAuth2ClientLifespans(id: string, oAuth2ClientTokenLifespans?: OAuth2ClientTokenLifespans, options?: AxiosRequestConfig): AxiosPromise<OAuth2Client>;
     ...
     * @memberof OAuth2ApiInterface
     */
    trustOAuth2JwtGrantIssuer(trustOAuth2JwtGrantIssuer?: TrustOAuth2JwtGrantIssuer, options?: AxiosRequestConfig): AxiosPromise<TrustedOAuth2JwtGrantIssuer>;
...
export class OAuth2Api extends BaseAPI implements OAuth2ApiInterface {
     ...
     * @memberof OAuth2Api
     */
    public acceptOAuth2ConsentRequest(consentChallenge: string, acceptOAuth2ConsentRequest?: AcceptOAuth2ConsentRequest, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).acceptOAuth2ConsentRequest(consentChallenge, acceptOAuth2ConsentRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public acceptOAuth2LoginRequest(loginChallenge: string, acceptOAuth2LoginRequest?: AcceptOAuth2LoginRequest, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).acceptOAuth2LoginRequest(loginChallenge, acceptOAuth2LoginRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public acceptOAuth2LogoutRequest(logoutChallenge: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).acceptOAuth2LogoutRequest(logoutChallenge, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public createOAuth2Client(oAuth2Client: OAuth2Client, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).createOAuth2Client(oAuth2Client, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteOAuth2Token(clientId: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).deleteOAuth2Token(clientId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public deleteTrustedOAuth2JwtGrantIssuer(id: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).deleteTrustedOAuth2JwtGrantIssuer(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public getOAuth2ConsentRequest(consentChallenge: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).getOAuth2ConsentRequest(consentChallenge, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public getOAuth2LoginRequest(loginChallenge: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).getOAuth2LoginRequest(loginChallenge, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public getOAuth2LogoutRequest(logoutChallenge: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).getOAuth2LogoutRequest(logoutChallenge, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public getTrustedOAuth2JwtGrantIssuer(id: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).getTrustedOAuth2JwtGrantIssuer(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public introspectOAuth2Token(token: string, scope?: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).introspectOAuth2Token(token, scope, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public listOAuth2Clients(pageSize?: number, pageToken?: string, clientName?: string, owner?: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).listOAuth2Clients(pageSize, pageToken, clientName, owner, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public listOAuth2ConsentSessions(subject: string, pageSize?: number, pageToken?: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).listOAuth2ConsentSessions(subject, pageSize, pageToken, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public listTrustedOAuth2JwtGrantIssuers(maxItems?: number, defaultItems?: number, issuer?: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).listTrustedOAuth2JwtGrantIssuers(maxItems, defaultItems, issuer, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public oauth2TokenExchange(grantType: string, clientId?: string, code?: string, redirectUri?: string, refreshToken?: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).oauth2TokenExchange(grantType, clientId, code, redirectUri, refreshToken, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public patchOAuth2Client(id: string, jsonPatch: Array<JsonPatch>, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).patchOAuth2Client(id, jsonPatch, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public rejectOAuth2ConsentRequest(consentChallenge: string, rejectOAuth2Request?: RejectOAuth2Request, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).rejectOAuth2ConsentRequest(consentChallenge, rejectOAuth2Request, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public rejectOAuth2LoginRequest(loginChallenge: string, rejectOAuth2Request?: RejectOAuth2Request, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).rejectOAuth2LoginRequest(loginChallenge, rejectOAuth2Request, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public rejectOAuth2LogoutRequest(logoutChallenge: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).rejectOAuth2LogoutRequest(logoutChallenge, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public revokeOAuth2ConsentSessions(subject: string, client?: string, all?: boolean, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).revokeOAuth2ConsentSessions(subject, client, all, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public revokeOAuth2LoginSessions(subject: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).revokeOAuth2LoginSessions(subject, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public revokeOAuth2Token(token: string, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).revokeOAuth2Token(token, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public setOAuth2Client(id: string, oAuth2Client: OAuth2Client, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).setOAuth2Client(id, oAuth2Client, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public setOAuth2ClientLifespans(id: string, oAuth2ClientTokenLifespans?: OAuth2ClientTokenLifespans, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).setOAuth2ClientLifespans(id, oAuth2ClientTokenLifespans, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OAuth2Api
     */
    public trustOAuth2JwtGrantIssuer(trustOAuth2JwtGrantIssuer?: TrustOAuth2JwtGrantIssuer, options?: AxiosRequestConfig) {
        return OAuth2ApiFp(this.configuration).trustOAuth2JwtGrantIssuer(trustOAuth2JwtGrantIssuer, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export interface OidcApiInterface {
     ...
     */
    createOidcDynamicClient(oAuth2Client: OAuth2Client, options?: AxiosRequestConfig): AxiosPromise<OAuth2Client>;
     ...
     * @memberof OidcApiInterface
     */
    deleteOidcDynamicClient(id: string, options?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof OidcApiInterface
     */
    getOidcDynamicClient(id: string, options?: AxiosRequestConfig): AxiosPromise<OAuth2Client>;
     ...
     * @memberof OidcApiInterface
     */
    setOidcDynamicClient(id: string, oAuth2Client: OAuth2Client, options?: AxiosRequestConfig): AxiosPromise<OAuth2Client>;
...
export class OidcApi extends BaseAPI implements OidcApiInterface {
     ...
     * @memberof OidcApi
     */
    public createOidcDynamicClient(oAuth2Client: OAuth2Client, options?: AxiosRequestConfig) {
        return OidcApiFp(this.configuration).createOidcDynamicClient(oAuth2Client, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OidcApi
     */
    public deleteOidcDynamicClient(id: string, options?: AxiosRequestConfig) {
        return OidcApiFp(this.configuration).deleteOidcDynamicClient(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OidcApi
     */
    public getOidcDynamicClient(id: string, options?: AxiosRequestConfig) {
        return OidcApiFp(this.configuration).getOidcDynamicClient(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OidcApi
     */
    public setOidcDynamicClient(id: string, oAuth2Client: OAuth2Client, options?: AxiosRequestConfig) {
        return OidcApiFp(this.configuration).setOidcDynamicClient(id, oAuth2Client, options).then((request) => request(this.axios, this.basePath));
    }
}
