...
defmodule OryHydraClient.Model.PreviousConsentSession do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"consent_request" => OryHydraClient.Model.ConsentRequest.t | nil,
...
defimpl Poison.Decoder, for: OryHydraClient.Model.PreviousConsentSession do
  import OryHydraClient.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"consent_request", :struct, OryHydraClient.Model.ConsentRequest, options)
