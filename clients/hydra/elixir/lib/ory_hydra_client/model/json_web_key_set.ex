...
defmodule OryHydraClient.Model.JsonWebKeySet do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"keys" => [OryHydraClient.Model.JsonWebKey.t] | nil
  }
end

defimpl Poison.Decoder, for: OryHydraClient.Model.JsonWebKeySet do
  import OryHydraClient.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"keys", :list, OryHydraClient.Model.JsonWebKey, options)
  end
end
