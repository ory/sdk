...
refer to the cluster state, only to a single instance.
	 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	 * @return PublicApiApiIsInstanceReadyRequest
	 */
	IsInstanceReady(ctx context.Context) PublicApiApiIsInstanceReadyRequest

	/*
	 * IsInstanceReadyExecute executes the request
	 * @return HealthStatus
	 */
	IsInstanceReadyExecute(r PublicApiApiIsInstanceReadyRequest) (*HealthStatus, *http.Response, error)
...
func (r PublicApiApiDynamicClientRegistrationCreateOAuth2ClientRequest) Body(body OAuth2Client) PublicApiApiDynamicClientRegistrationCreateOAuth2ClientRequest {
	r.body = &body
	return r
}
...
func (r PublicApiApiDynamicClientRegistrationUpdateOAuth2ClientRequest) Body(body OAuth2Client) PublicApiApiDynamicClientRegistrationUpdateOAuth2ClientRequest {
	r.body = &body
	return r
}
...
type PublicApiApiIsInstanceReadyRequest struct {
	ctx context.Context
	ApiService PublicApi
}


func (r PublicApiApiIsInstanceReadyRequest) Execute() (*HealthStatus, *http.Response, error) {
 ...
 * @return PublicApiApiIsInstanceReadyRequest
 */
func (a *PublicApiService) IsInstanceReady(ctx context.Context) PublicApiApiIsInstanceReadyRequest {
	return PublicApiApiIsInstanceReadyRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return HealthStatus
 */
func (a *PublicApiService) IsInstanceReadyExecute(r PublicApiApiIsInstanceReadyRequest) (*HealthStatus, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PublicApiService.IsInstanceReady")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
