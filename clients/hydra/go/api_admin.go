...
`X-Forwarded-Proto` header to be set.
	 ...
	 * @return Version
	 */
	GetVersionExecute(r AdminApiApiGetVersionRequest) (*Version, *http.Response, error)
...
refer to the cluster state, only to a single instance.
	 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	 * @return AdminApiApiIsInstanceAliveRequest
	 */
	IsInstanceAlive(ctx context.Context) AdminApiApiIsInstanceAliveRequest

	/*
	 * IsInstanceAliveExecute executes the request
	 * @return HealthStatus
	 */
	IsInstanceAliveExecute(r AdminApiApiIsInstanceAliveRequest) (*HealthStatus, *http.Response, error)
...
func (r AdminApiApiAcceptConsentRequestRequest) Body(body AcceptConsentRequest) AdminApiApiAcceptConsentRequestRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiAcceptLoginRequestRequest) Body(body AcceptLoginRequest) AdminApiApiAcceptLoginRequestRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiCreateJsonWebKeySetRequest) Body(body JsonWebKeySetGeneratorRequest) AdminApiApiCreateJsonWebKeySetRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiCreateOAuth2ClientRequest) Body(body OAuth2Client) AdminApiApiCreateOAuth2ClientRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiFlushInactiveOAuth2TokensRequest) Body(body FlushInactiveOAuth2TokensRequest) AdminApiApiFlushInactiveOAuth2TokensRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiGetVersionRequest) Execute() (*Version, *http.Response, error) {
 ...
 * @return Version
 */
func (a *AdminApiService) GetVersionExecute(r AdminApiApiGetVersionRequest) (*Version, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
type AdminApiApiIsInstanceAliveRequest struct {
	ctx context.Context
	ApiService AdminApi
}


func (r AdminApiApiIsInstanceAliveRequest) Execute() (*HealthStatus, *http.Response, error) {
 ...
 * @return AdminApiApiIsInstanceAliveRequest
 */
func (a *AdminApiService) IsInstanceAlive(ctx context.Context) AdminApiApiIsInstanceAliveRequest {
	return AdminApiApiIsInstanceAliveRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return HealthStatus
 */
func (a *AdminApiService) IsInstanceAliveExecute(r AdminApiApiIsInstanceAliveRequest) (*HealthStatus, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminApiService.IsInstanceAlive")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r AdminApiApiPatchOAuth2ClientRequest) Body(body []PatchDocument) AdminApiApiPatchOAuth2ClientRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiRejectConsentRequestRequest) Body(body RejectRequest) AdminApiApiRejectConsentRequestRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiRejectLoginRequestRequest) Body(body RejectRequest) AdminApiApiRejectLoginRequestRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiRejectLogoutRequestRequest) Body(body RejectRequest) AdminApiApiRejectLogoutRequestRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiTrustJwtGrantIssuerRequest) Body(body TrustJwtGrantIssuerBody) AdminApiApiTrustJwtGrantIssuerRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiUpdateJsonWebKeyRequest) Body(body JSONWebKey) AdminApiApiUpdateJsonWebKeyRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiUpdateJsonWebKeySetRequest) Body(body JSONWebKeySet) AdminApiApiUpdateJsonWebKeySetRequest {
	r.body = &body
	return r
}
...
func (r AdminApiApiUpdateOAuth2ClientRequest) Body(body OAuth2Client) AdminApiApiUpdateOAuth2ClientRequest {
	r.body = &body
	return r
}
