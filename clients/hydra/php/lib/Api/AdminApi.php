...
class AdminApi
{
    ...
    public function listOAuth2ClientsRequest($limit = null, $offset = null, $clientName = null, $owner = null)
    {
        ...
        if (is_array($clientName)) {
            $clientName = ObjectSerializer::serializeCollection($clientName, '', true);
        }
        if ($clientName !== null) {
     ...
     *
     * @param  \Ory\Hydra\Client\Model\TrustJwtGrantIssuerBody $body body (optional)
     *
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Trust an OAuth2 JWT Bearer Grant Type Issuer
     *
     * @param  \Ory\Hydra\Client\Model\TrustJwtGrantIssuerBody $body (optional)
     *
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
