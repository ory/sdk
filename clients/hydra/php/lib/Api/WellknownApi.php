...
class WellknownApi
{
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['discoverJsonWebKeys'] to see the possible values for this operation
     *
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Hydra\Client\Model\JsonWebKeySet|\Ory\Hydra\Client\Model\ErrorOAuth2
     */
    public function discoverJsonWebKeys(string $contentType = self::contentTypes['discoverJsonWebKeys'][0])
    {
        list($response) = $this->discoverJsonWebKeysWithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function discoverJsonWebKeysWithHttpInfo(string $contentType = self::contentTypes['discoverJsonWebKeys'][0])
    {
        $request = $this->discoverJsonWebKeysRequest($contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Hydra\Client\Model\JsonWebKeySet' === '\SplFileObject') {
                        ...
                        if ('\Ory\Hydra\Client\Model\JsonWebKeySet' !== 'string') {
                            try {
                ...
                default:
                    if ('\Ory\Hydra\Client\Model\ErrorOAuth2' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Ory\Hydra\Client\Model\ErrorOAuth2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
     ...
     */
    public function discoverJsonWebKeysAsync(string $contentType = self::contentTypes['discoverJsonWebKeys'][0])
    {
        return $this->discoverJsonWebKeysAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function discoverJsonWebKeysAsyncWithHttpInfo(string $contentType = self::contentTypes['discoverJsonWebKeys'][0])
    {
        $returnType = '\Ory\Hydra\Client\Model\JsonWebKeySet';
        $request = $this->discoverJsonWebKeysRequest($contentType);
     ...
     */
    public function discoverJsonWebKeysRequest(string $contentType = self::contentTypes['discoverJsonWebKeys'][0])
    {
