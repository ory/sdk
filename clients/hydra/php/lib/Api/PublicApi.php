...
class PublicApi
{
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WellKnown|\OpenAPI\Client\Model\JsonError|\OpenAPI\Client\Model\JsonError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\WellKnown|\OpenAPI\Client\Model\JsonError|\OpenAPI\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function discoverOpenIDConfigurationWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 401:
                    if ('\OpenAPI\Client\Model\JsonError' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\JsonError', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            switch ($e->getCode()) {
                ...
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\JsonError',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\OAuth2Client|\OpenAPI\Client\Model\JsonError
     */
    public function dynamicClientRegistrationCreateOAuth2Client($body)
    {
        list($response) = $this->dynamicClientRegistrationCreateOAuth2ClientWithHttpInfo($body);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\OAuth2Client|\OpenAPI\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function dynamicClientRegistrationCreateOAuth2ClientWithHttpInfo($body)
    {
        $request = $this->dynamicClientRegistrationCreateOAuth2ClientRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dynamicClientRegistrationCreateOAuth2ClientAsync($body)
    {
        return $this->dynamicClientRegistrationCreateOAuth2ClientAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dynamicClientRegistrationCreateOAuth2ClientAsyncWithHttpInfo($body)
    {
        $returnType = '\OpenAPI\Client\Model\OAuth2Client';
        $request = $this->dynamicClientRegistrationCreateOAuth2ClientRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function dynamicClientRegistrationCreateOAuth2ClientRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling dynamicClientRegistrationCreateOAuth2Client'
            );
        }
     ...
     * @return \OpenAPI\Client\Model\OAuth2Client|\OpenAPI\Client\Model\JsonError
     */
    public function dynamicClientRegistrationUpdateOAuth2Client($id, $body)
    {
        list($response) = $this->dynamicClientRegistrationUpdateOAuth2ClientWithHttpInfo($id, $body);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\OAuth2Client|\OpenAPI\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function dynamicClientRegistrationUpdateOAuth2ClientWithHttpInfo($id, $body)
    {
        $request = $this->dynamicClientRegistrationUpdateOAuth2ClientRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dynamicClientRegistrationUpdateOAuth2ClientAsync($id, $body)
    {
        return $this->dynamicClientRegistrationUpdateOAuth2ClientAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dynamicClientRegistrationUpdateOAuth2ClientAsyncWithHttpInfo($id, $body)
    {
        $returnType = '\OpenAPI\Client\Model\OAuth2Client';
        $request = $this->dynamicClientRegistrationUpdateOAuth2ClientRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function dynamicClientRegistrationUpdateOAuth2ClientRequest($id, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling dynamicClientRegistrationUpdateOAuth2Client'
            );
        }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Oauth2TokenResponse|\OpenAPI\Client\Model\JsonError|\OpenAPI\Client\Model\JsonError|\OpenAPI\Client\Model\JsonError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Oauth2TokenResponse|\OpenAPI\Client\Model\JsonError|\OpenAPI\Client\Model\JsonError|\OpenAPI\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
    public function oauth2TokenWithHttpInfo($grant_type, $code = null, $refresh_token = null, $redirect_uri = null, $client_id = null)
    {
        $request = $this->oauth2TokenRequest($grant_type, $code, $refresh_token, $redirect_uri, $client_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function oauth2TokenAsync($grant_type, $code = null, $refresh_token = null, $redirect_uri = null, $client_id = null)
    {
        return $this->oauth2TokenAsyncWithHttpInfo($grant_type, $code, $refresh_token, $redirect_uri, $client_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function oauth2TokenAsyncWithHttpInfo($grant_type, $code = null, $refresh_token = null, $redirect_uri = null, $client_id = null)
    {
        $returnType = '\OpenAPI\Client\Model\Oauth2TokenResponse';
        $request = $this->oauth2TokenRequest($grant_type, $code, $refresh_token, $redirect_uri, $client_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function oauth2TokenRequest($grant_type, $code = null, $refresh_token = null, $redirect_uri = null, $client_id = null)
    {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\UserinfoResponse|\OpenAPI\Client\Model\JsonError|\OpenAPI\Client\Model\JsonError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\UserinfoResponse|\OpenAPI\Client\Model\JsonError|\OpenAPI\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\JSONWebKeySet|\OpenAPI\Client\Model\JsonError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\JSONWebKeySet|\OpenAPI\Client\Model\JsonError, HTTP status code, HTTP response headers (array of strings)
     */
