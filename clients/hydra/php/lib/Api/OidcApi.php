...
class OidcApi
{
     ...
     *
     * @param  \Ory\Hydra\Client\Model\CreateVerifiableCredentialRequestBody $createVerifiableCredentialRequestBody createVerifiableCredentialRequestBody (optional)
     ...
     * Issues a Verifiable Credential
     *
     * @param  \Ory\Hydra\Client\Model\CreateVerifiableCredentialRequestBody $createVerifiableCredentialRequestBody (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createVerifiableCredential'] to see the possible values for this operation
     *
     * @throws \Ory\Hydra\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function createVerifiableCredentialWithHttpInfo($createVerifiableCredentialRequestBody = null, string $contentType = self::contentTypes['createVerifiableCredential'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Hydra\Client\Model\VerifiableCredentialResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ory\Hydra\Client\Model\VerifiableCredentialResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Hydra\Client\Model\VerifiableCredentialResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Ory\Hydra\Client\Model\VerifiableCredentialPrimingResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ory\Hydra\Client\Model\VerifiableCredentialPrimingResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Hydra\Client\Model\VerifiableCredentialPrimingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
    ...
    public function discoverOidcConfigurationWithHttpInfo(string $contentType = self::contentTypes['discoverOidcConfiguration'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Hydra\Client\Model\OidcConfiguration' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ory\Hydra\Client\Model\OidcConfiguration' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Hydra\Client\Model\OidcConfiguration', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
    ...
    public function getOidcUserInfoWithHttpInfo(string $contentType = self::contentTypes['getOidcUserInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Hydra\Client\Model\OidcUserInfo' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ory\Hydra\Client\Model\OidcUserInfo' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Hydra\Client\Model\OidcUserInfo', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
