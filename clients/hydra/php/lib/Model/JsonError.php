...
class JsonError implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $error_description Description contains further information on the nature of the error.
     *
     * @return self
     */
     ...
     * Sets status_code
     *
     * @param int|null $status_code Code represents the error status code (404, 403, 401, ...).
     *
     * @return self
     */
