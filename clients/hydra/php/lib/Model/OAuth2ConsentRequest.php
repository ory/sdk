...
class OAuth2ConsentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'oidcContext' => '\Ory\Hydra\Client\Model\OAuth2ConsentRequestOpenIDConnectContext',
        'requestUrl' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'client' => 'client',
        'context' => 'context',
        'deviceChallengeId' => 'device_challenge_id',
    ...
    protected static $setters = [
        ...
        'client' => 'setClient',
        'context' => 'setContext',
        'deviceChallengeId' => 'setDeviceChallengeId',
    ...
    protected static $getters = [
        ...
        'client' => 'getClient',
        'context' => 'getContext',
        'deviceChallengeId' => 'getDeviceChallengeId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('deviceChallengeId', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets deviceChallengeId
     *
     * @return string|null
     */
    public function getDeviceChallengeId()
    {
        return $this->container['deviceChallengeId'];
    }

    /**
     * Sets deviceChallengeId
     *
     * @param string|null $deviceChallengeId DeviceChallenge is the device challenge this consent challenge belongs to, if this flow was initiated by a device.
     *
     * @return self
     */
    public function setDeviceChallengeId($deviceChallengeId)
    {
        if (is_null($deviceChallengeId)) {
            throw new \InvalidArgumentException('non-nullable deviceChallengeId cannot be null');
        }
        $this->container['deviceChallengeId'] = $deviceChallengeId;
     ...
     * Gets oidcContext
     *
     * @return \Ory\Hydra\Client\Model\OAuth2ConsentRequestOpenIDConnectContext|null
     */
     ...
     * Sets oidcContext
     *
     * @param \Ory\Hydra\Client\Model\OAuth2ConsentRequestOpenIDConnectContext|null $oidcContext oidcContext
     *
     * @return self
     */
