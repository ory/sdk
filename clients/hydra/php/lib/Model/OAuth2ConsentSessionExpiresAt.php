...
class OAuth2ConsentSessionExpiresAt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('authorizeCode', $data ?? [], null);
        $this->setIfExists('idToken', $data ?? [], null);
        $this->setIfExists('parContext', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($authorizeCode)) {
            throw new \InvalidArgumentException('non-nullable authorizeCode cannot be null');
        }
    ...
    {
        if (is_null($parContext)) {
            throw new \InvalidArgumentException('non-nullable parContext cannot be null');
        }
