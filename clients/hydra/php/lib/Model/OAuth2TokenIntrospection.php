 ...
 * @link     https://openapi-generator.tech
 */
class OAuth2TokenIntrospection implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['obfuscatedSubject'] = isset($data['obfuscatedSubject']) ? $data['obfuscatedSubject'] : null;
     ...
     * Sets clientId
     *
     * @param string|null $clientId ClientID is aclient identifier for the OAuth 2.0 client that requested this token.
     *
     * @return $this
     */
     ...
     * Sets tokenType
     *
     * @param string|null $tokenType TokenType is the introspected token's type, for example `access_token` or `refresh_token`.
     *
     * @return $this
     */
