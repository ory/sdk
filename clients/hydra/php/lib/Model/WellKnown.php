...
class WellKnown implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['backchannel_logout_session_supported'] = $data['backchannel_logout_session_supported'] ?? null;
        $this->container['backchannel_logout_supported'] = $data['backchannel_logout_supported'] ?? null;
        $this->container['claims_parameter_supported'] = $data['claims_parameter_supported'] ?? null;
        $this->container['claims_supported'] = $data['claims_supported'] ?? null;
        $this->container['code_challenge_methods_supported'] = $data['code_challenge_methods_supported'] ?? null;
        $this->container['end_session_endpoint'] = $data['end_session_endpoint'] ?? null;
        $this->container['frontchannel_logout_session_supported'] = $data['frontchannel_logout_session_supported'] ?? null;
        $this->container['frontchannel_logout_supported'] = $data['frontchannel_logout_supported'] ?? null;
        $this->container['grant_types_supported'] = $data['grant_types_supported'] ?? null;
        $this->container['id_token_signing_alg_values_supported'] = $data['id_token_signing_alg_values_supported'] ?? null;
        $this->container['issuer'] = $data['issuer'] ?? null;
        $this->container['jwks_uri'] = $data['jwks_uri'] ?? null;
        $this->container['registration_endpoint'] = $data['registration_endpoint'] ?? null;
        $this->container['request_object_signing_alg_values_supported'] = $data['request_object_signing_alg_values_supported'] ?? null;
        $this->container['request_parameter_supported'] = $data['request_parameter_supported'] ?? null;
        $this->container['request_uri_parameter_supported'] = $data['request_uri_parameter_supported'] ?? null;
        $this->container['require_request_uri_registration'] = $data['require_request_uri_registration'] ?? null;
        $this->container['response_modes_supported'] = $data['response_modes_supported'] ?? null;
        $this->container['response_types_supported'] = $data['response_types_supported'] ?? null;
        $this->container['revocation_endpoint'] = $data['revocation_endpoint'] ?? null;
        $this->container['scopes_supported'] = $data['scopes_supported'] ?? null;
        $this->container['subject_types_supported'] = $data['subject_types_supported'] ?? null;
        $this->container['token_endpoint'] = $data['token_endpoint'] ?? null;
        $this->container['token_endpoint_auth_methods_supported'] = $data['token_endpoint_auth_methods_supported'] ?? null;
        $this->container['userinfo_endpoint'] = $data['userinfo_endpoint'] ?? null;
        $this->container['userinfo_signing_alg_values_supported'] = $data['userinfo_signing_alg_values_supported'] ?? null;
    }
     ...
     *
     * @param string[]|null $code_challenge_methods_supported JSON array containing a list of Proof Key for Code Exchange (PKCE) [RFC7636] code challenge methods supported by this authorization server.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $request_object_signing_alg_values_supported JSON array containing a list of the JWS signing algorithms (alg values) supported by the OP for Request Objects, which are described in Section 6.1 of OpenID Connect Core 1.0 [OpenID.Core]. These algorithms are used both when the Request Object is passed by value (using the request parameter) and when it is passed by reference (using the request_uri parameter).
     *
     * @return self
     */
