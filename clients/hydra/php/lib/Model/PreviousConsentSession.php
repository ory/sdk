...
class PreviousConsentSession implements ModelInterface, ArrayAccess
{
     ...
     * Sets handledAt
     *
     * @param \DateTime|null $handledAt handled at Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time
     *
     * @return $this
     */
