...
class OpenIDConnectContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['acr_values'] = $data['acr_values'] ?? null;
        $this->container['display'] = $data['display'] ?? null;
        $this->container['id_token_hint_claims'] = $data['id_token_hint_claims'] ?? null;
        $this->container['login_hint'] = $data['login_hint'] ?? null;
        $this->container['ui_locales'] = $data['ui_locales'] ?? null;
    }
     ...
     *
     * @param object|null $id_token_hint_claims IDTokenHintClaims are the claims of the ID Token previously issued by the Authorization Server being passed as a hint about the End-User's current or past authenticated session with the Client.
     *
     * @return self
     */
