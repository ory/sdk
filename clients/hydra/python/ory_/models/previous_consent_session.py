...
class PreviousConsentSession(object):
    ...
    def __init__(self, consent_request=None, grant_access_token_audience=None, grant_scope=None, remember=None, remember_for=None, session=None, local_vars_configuration=None):  # noqa: E501
