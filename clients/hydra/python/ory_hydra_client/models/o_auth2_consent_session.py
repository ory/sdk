...
class OAuth2ConsentSession(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["consent_request", "consent_request_id", "context", "grant_access_token_audience", "grant_scope", "handled_at", "remember", "remember_for", "session"]
