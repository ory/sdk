...
class AcceptConsentRequest(object):
    ...
    def __init__(self, grant_access_token_audience=None, grant_scope=None, handled_at=None, remember=None, remember_for=None, session=None, local_vars_configuration=None):  # noqa: E501
