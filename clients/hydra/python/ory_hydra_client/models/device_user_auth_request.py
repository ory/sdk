...
class DeviceUserAuthRequest(BaseModel):
    """
    DeviceUserAuthRequest
    """ # noqa: E501
    challenge: StrictStr = Field(description="ID is the identifier (\"device challenge\") of the device grant request. It is used to identify the session.")
    ...
    __properties: ClassVar[List[str]] = ["challenge", "client", "handled_at", "request_url", "requested_access_token_audience", "requested_scope"]
