...
class OAuth2ConsentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["acr", "amr", "challenge", "client", "context", "device_challenge_id", "login_challenge", "login_session_id", "oidc_context", "request_url", "requested_access_token_audience", "requested_scope", "skip", "subject"]
