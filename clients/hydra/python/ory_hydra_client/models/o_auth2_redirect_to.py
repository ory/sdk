...
class OAuth2RedirectTo(BaseModel):
    ...
    """ # noqa: E501
    redirect_to: StrictStr = Field(description="RedirectURL is the URL which you should redirect the user's browser to once the authentication process is completed.")
