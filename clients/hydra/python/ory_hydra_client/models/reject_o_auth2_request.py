...
class RejectOAuth2Request(BaseModel):
    ...
    error_debug: Optional[StrictStr] = Field(default=None, description="Debug contains information to help resolve the problem as a developer. Usually not exposed to the public but only in the server logs.")
    error_description: Optional[StrictStr] = Field(default=None, description="Description of the error in a human readable format.")
    error_hint: Optional[StrictStr] = Field(default=None, description="Hint to help resolve the error.")
    status_code: Optional[StrictInt] = Field(default=None, description="Represents the HTTP status code of the error (e.g. 401 or 403)  Defaults to 400")
