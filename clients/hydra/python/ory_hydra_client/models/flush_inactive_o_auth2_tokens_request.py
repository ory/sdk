...
class FlushInactiveOAuth2TokensRequest(object):
    ...
    def not_after(self):
        ...
        NotAfter sets after which point tokens should not be flushed. This is useful when you want to keep a history of recently issued tokens for auditing. Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time  # noqa: E501
