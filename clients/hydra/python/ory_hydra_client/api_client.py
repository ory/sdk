...
from ory_hydra_client.exceptions import ApiTypeError, ApiValueError, ApiException
from ory_hydra_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/v2.2.0-rc.3/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = JwkApi()
        api_instance.create_json_web_key_set  # this is an instance of the class Endpoint
        api_instance.create_json_web_key_set()  # this invokes api_instance.create_json_web_key_set.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_json_web_key_set.callable or self.callable in this class
