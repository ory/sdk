...
from ory_hydra_client.api_client import ApiClient, RequestSerialized
from ory_hydra_client.api_response import ApiResponse
from ory_hydra_client.rest import RESTResponseType
...
class MetadataApi:
    ...
    def is_ready(
        ...
        _param = self._is_ready_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IsReady200Response",
            '503': "IsReady503Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def is_ready_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IsReady200Response]:
        """Check HTTP Server and Database Status
    ...
    @validate_call
    def is_ready_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
