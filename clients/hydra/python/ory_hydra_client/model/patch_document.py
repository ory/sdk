...
class PatchDocument(ModelNormal):
    ...
    def _from_openapi_data(cls, op, path, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            _from (str): A JSON-pointer. [optional]  # noqa: E501
            value (bool, date, datetime, dict, float, int, list, str, none_type): The value to be used within the operations. [optional]  # noqa: E501
        """
