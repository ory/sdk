...
class AcceptOAuth2LoginRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'identity_provider_session_id': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'identity_provider_session_id': 'identity_provider_session_id',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, subject, *args, **kwargs):  # noqa: E501
        """AcceptOAuth2LoginRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            identity_provider_session_id (str): IdentityProviderSessionID is the session ID of the end-user that authenticated. If specified, we will use this value to propagate the logout.. [optional]  # noqa: E501
