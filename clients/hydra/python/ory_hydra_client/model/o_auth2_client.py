...
def lazy_import():
    ...
    globals()['JSONWebKeySet'] = JSONWebKeySet
...
class OAuth2Client(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            allowed_cors_origins ([str]): AllowedCORSOrigins are one or more URLs (scheme://host[:port]) which are allowed to make CORS requests to the /oauth/token endpoint. If this array is empty, the sever's CORS origin configuration (`CORS_ALLOWED_ORIGINS`) will be used instead. If this array is set, the allowed origins are appended to the server's CORS origin configuration. Be aware that environment variable `CORS_ENABLED` MUST be set to `true` for this to work.. [optional]  # noqa: E501
            audience ([str]): Audience is a whitelist defining the audiences this client is allowed to request tokens for. An audience limits the applicability of an OAuth 2.0 Access Token to, for example, certain API endpoints. The value is a list of URLs. URLs MUST NOT contain whitespaces.. [optional]  # noqa: E501
            ...
            client_id (str): ClientID  is the id for this client.. [optional]  # noqa: E501
            ...
            contacts ([str]): Contacts is a array of strings representing ways to contact people responsible for this client, typically email addresses.. [optional]  # noqa: E501
            ...
            grant_types ([str]): GrantTypes is an array of grant types the client is allowed to use.. [optional]  # noqa: E501
            jwks (JSONWebKeySet): [optional]  # noqa: E501
            ...
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Metadata is arbitrary data.. [optional]  # noqa: E501
            ...
            post_logout_redirect_uris ([str]): Array of URLs supplied by the RP to which it MAY request that the End-User's User Agent be redirected using the post_logout_redirect_uri parameter after a logout has been performed.. [optional]  # noqa: E501
            redirect_uris ([str]): RedirectURIs is an array of allowed redirect urls for the client, for example http://mydomain/oauth/callback .. [optional]  # noqa: E501
            ...
            request_uris ([str]): Array of request_uri values that are pre-registered by the RP for use at the OP. Servers MAY cache the contents of the files referenced by these URIs and not retrieve them at the time they are used in a request. OPs can require that request_uri values used be pre-registered with the require_request_uri_registration discovery parameter.. [optional]  # noqa: E501
            response_types ([str]): ResponseTypes is an array of the OAuth 2.0 response type strings that the client can use at the authorization endpoint.. [optional]  # noqa: E501
