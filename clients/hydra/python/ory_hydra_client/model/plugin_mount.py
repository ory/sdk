...
class PluginMount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, destination, name, options, settable, source, type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, destination, name, options, settable, source, type, *args, **kwargs):  # noqa: E501
        """PluginMount - a model defined in OpenAPI
