...
class TrustJwtGrantIssuerBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, expires_at, issuer, jwk, scope, subject, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, expires_at, issuer, jwk, scope, subject, *args, **kwargs):  # noqa: E501
        """TrustJwtGrantIssuerBody - a model defined in OpenAPI
