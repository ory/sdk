...
class AcceptConsentRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'grant_access_token_audience': ([str],),  # noqa: E501
            'grant_scope': ([str],),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            grant_access_token_audience ([str]): GrantedAudience sets the audience the user authorized the client to use. Should be a subset of `requested_access_token_audience`.. [optional]  # noqa: E501
            grant_scope ([str]): GrantScope sets the scope the user authorized the client to use. Should be a subset of `requested_scope`.. [optional]  # noqa: E501
