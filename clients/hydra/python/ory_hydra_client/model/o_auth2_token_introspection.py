...
class OAuth2TokenIntrospection(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'exp': (int,),  # noqa: E501
            'ext': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'iat': (int,),  # noqa: E501
            'iss': (str,),  # noqa: E501
            'nbf': (int,),  # noqa: E501
    ...
    def _from_openapi_data(cls, active, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            ext (bool, date, datetime, dict, float, int, list, str, none_type): Extra is arbitrary data set by the session.. [optional]  # noqa: E501
