...
class OAuth2TokenIntrospection(ModelNormal):
    ...
    def __init__(self, active, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            client_id (str): ClientID is aclient identifier for the OAuth 2.0 client that requested this token.. [optional]  # noqa: E501
            ...
            token_type (str): TokenType is the introspected token's type, for example `access_token` or `refresh_token`.. [optional]  # noqa: E501
