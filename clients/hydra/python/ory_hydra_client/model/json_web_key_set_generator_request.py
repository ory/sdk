...
class JsonWebKeySetGeneratorRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, alg, kid, use, *args, **kwargs):  # noqa: E501
        """JsonWebKeySetGeneratorRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, alg, kid, use, *args, **kwargs):  # noqa: E501
        """JsonWebKeySetGeneratorRequest - a model defined in OpenAPI
