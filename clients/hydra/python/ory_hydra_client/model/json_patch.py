...
class JsonPatch(ModelNormal):
    ...
    def _from_openapi_data(cls, op, path, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            _from (str): This field is used together with operation \"move\" and uses JSON Pointer notation.  Learn more [about JSON Pointers](https://datatracker.ietf.org/doc/html/rfc6901#section-5).. [optional]  # noqa: E501
            value (bool, date, datetime, dict, float, int, list, str, none_type): The value to be used within the operations.  Learn more [about JSON Pointers](https://datatracker.ietf.org/doc/html/rfc6901#section-5).. [optional]  # noqa: E501
        """
