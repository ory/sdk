...
class OAuth2ConsentSessions(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """OAuth2ConsentSessions - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([OAuth2ConsentSession]): List of OAuth 2.0 Consent Sessions.  # noqa: E501

        Keyword Args:
            value ([OAuth2ConsentSession]): List of OAuth 2.0 Consent Sessions.  # noqa: E501
