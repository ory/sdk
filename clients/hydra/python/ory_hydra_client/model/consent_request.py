...
class ConsentRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'requested_access_token_audience': ([str],),  # noqa: E501
            'requested_scope': ([str],),  # noqa: E501
            'skip': (bool,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            challenge (str): Challenge is the identifier (\"authorization challenge\") of the consent authorization request. It is used to identify the session.. [optional]  # noqa: E501
            client (OAuth2Client): [optional]  # noqa: E501
            context ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Context contains arbitrary information set by the login endpoint or is empty if not set.. [optional]  # noqa: E501
            ...
            requested_access_token_audience ([str]): RequestedScope contains the access token audience as requested by the OAuth 2.0 Client.. [optional]  # noqa: E501
            requested_scope ([str]): RequestedScope contains the OAuth 2.0 Scope requested by the OAuth 2.0 Client.. [optional]  # noqa: E501
