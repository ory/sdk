...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of ory_hydra_client.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the ory_hydra_client.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = ory_hydra_client.Configuration(
        signing_info = ory_hydra_client.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: v1.5.0-beta.5".\
