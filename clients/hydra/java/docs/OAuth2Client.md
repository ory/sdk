...
**createdAt** | [**OffsetDateTime**](OffsetDateTime.md) | CreatedAt returns the timestamp of the client&#39;s creation. Format: date-time |  [optional]
...
**updatedAt** | [**OffsetDateTime**](OffsetDateTime.md) | UpdatedAt returns the timestamp of the last update. Format: date-time |  [optional]
