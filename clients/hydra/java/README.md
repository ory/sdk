...
Ory Hydra API
- API version: v1.11.8
  - Build date: 2022-05-04T11:09:50.946388738Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "sh.ory.hydra:hydra-client:v1.11.8"
  }
```
...
* `target/hydra-client-v1.11.8.jar`
* `target/lib/*.jar`
