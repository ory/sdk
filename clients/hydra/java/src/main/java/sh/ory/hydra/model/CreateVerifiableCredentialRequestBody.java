...
public class CreateVerifiableCredentialRequestBody {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateVerifiableCredentialRequestBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateVerifiableCredentialRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("proof") != null && !jsonObj.get("proof").isJsonNull()) {
        VerifiableCredentialProof.validateJsonObject(jsonObj.getAsJsonObject("proof"));
      }
