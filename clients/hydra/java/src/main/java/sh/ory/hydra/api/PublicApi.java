...
public class PublicApi {
     ...
     */
    public okhttp3.Call dynamicClientRegistrationCreateOAuth2ClientCall(OAuth2Client body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dynamicClientRegistrationCreateOAuth2ClientValidateBeforeCall(OAuth2Client body, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling dynamicClientRegistrationCreateOAuth2Client(Async)");
        }
        

        okhttp3.Call localVarCall = dynamicClientRegistrationCreateOAuth2ClientCall(body, _callback);
        return localVarCall;
     ...
     */
    public OAuth2Client dynamicClientRegistrationCreateOAuth2Client(OAuth2Client body) throws ApiException {
        ApiResponse<OAuth2Client> localVarResp = dynamicClientRegistrationCreateOAuth2ClientWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OAuth2Client> dynamicClientRegistrationCreateOAuth2ClientWithHttpInfo(OAuth2Client body) throws ApiException {
        okhttp3.Call localVarCall = dynamicClientRegistrationCreateOAuth2ClientValidateBeforeCall(body, null);
     ...
     */
    public okhttp3.Call dynamicClientRegistrationCreateOAuth2ClientAsync(OAuth2Client body, final ApiCallback<OAuth2Client> _callback) throws ApiException {

        okhttp3.Call localVarCall = dynamicClientRegistrationCreateOAuth2ClientValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<OAuth2Client>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call dynamicClientRegistrationUpdateOAuth2ClientCall(String id, OAuth2Client body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dynamicClientRegistrationUpdateOAuth2ClientValidateBeforeCall(String id, OAuth2Client body, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling dynamicClientRegistrationUpdateOAuth2Client(Async)");
        }
        

        okhttp3.Call localVarCall = dynamicClientRegistrationUpdateOAuth2ClientCall(id, body, _callback);
        return localVarCall;
     ...
     */
    public OAuth2Client dynamicClientRegistrationUpdateOAuth2Client(String id, OAuth2Client body) throws ApiException {
        ApiResponse<OAuth2Client> localVarResp = dynamicClientRegistrationUpdateOAuth2ClientWithHttpInfo(id, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OAuth2Client> dynamicClientRegistrationUpdateOAuth2ClientWithHttpInfo(String id, OAuth2Client body) throws ApiException {
        okhttp3.Call localVarCall = dynamicClientRegistrationUpdateOAuth2ClientValidateBeforeCall(id, body, null);
        Type localVarReturnType = new TypeToken<OAuth2Client>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call dynamicClientRegistrationUpdateOAuth2ClientAsync(String id, OAuth2Client body, final ApiCallback<OAuth2Client> _callback) throws ApiException {

        okhttp3.Call localVarCall = dynamicClientRegistrationUpdateOAuth2ClientValidateBeforeCall(id, body, _callback);
        Type localVarReturnType = new TypeToken<OAuth2Client>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
