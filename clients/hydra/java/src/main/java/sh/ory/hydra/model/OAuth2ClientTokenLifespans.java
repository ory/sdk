 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-11-11T13:05:12.451901555Z[Etc/UTC]", comments = "Generator version: 7.7.0")
public class OAuth2ClientTokenLifespans {
  ...
  public static final String SERIALIZED_NAME_DEVICE_AUTHORIZATION_GRANT_ACCESS_TOKEN_LIFESPAN = "device_authorization_grant_access_token_lifespan";
  @SerializedName(SERIALIZED_NAME_DEVICE_AUTHORIZATION_GRANT_ACCESS_TOKEN_LIFESPAN)
  private String deviceAuthorizationGrantAccessTokenLifespan;

  public static final String SERIALIZED_NAME_DEVICE_AUTHORIZATION_GRANT_ID_TOKEN_LIFESPAN = "device_authorization_grant_id_token_lifespan";
  @SerializedName(SERIALIZED_NAME_DEVICE_AUTHORIZATION_GRANT_ID_TOKEN_LIFESPAN)
  private String deviceAuthorizationGrantIdTokenLifespan;

  public static final String SERIALIZED_NAME_DEVICE_AUTHORIZATION_GRANT_REFRESH_TOKEN_LIFESPAN = "device_authorization_grant_refresh_token_lifespan";
  @SerializedName(SERIALIZED_NAME_DEVICE_AUTHORIZATION_GRANT_REFRESH_TOKEN_LIFESPAN)
  private String deviceAuthorizationGrantRefreshTokenLifespan;
  ...
  public OAuth2ClientTokenLifespans deviceAuthorizationGrantAccessTokenLifespan(String deviceAuthorizationGrantAccessTokenLifespan) {
  ...
  /**
   * Specify a time duration in milliseconds, seconds, minutes, hours.
   * @return deviceAuthorizationGrantAccessTokenLifespan
   */
  @javax.annotation.Nullable
  public String getDeviceAuthorizationGrantAccessTokenLifespan() {
    return deviceAuthorizationGrantAccessTokenLifespan;
  }

  public void setDeviceAuthorizationGrantAccessTokenLifespan(String deviceAuthorizationGrantAccessTokenLifespan) {
    this.deviceAuthorizationGrantAccessTokenLifespan = deviceAuthorizationGrantAccessTokenLifespan;
  }


  public OAuth2ClientTokenLifespans deviceAuthorizationGrantIdTokenLifespan(String deviceAuthorizationGrantIdTokenLifespan) {
  ...
  /**
   * Specify a time duration in milliseconds, seconds, minutes, hours.
   * @return deviceAuthorizationGrantIdTokenLifespan
   */
  @javax.annotation.Nullable
  public String getDeviceAuthorizationGrantIdTokenLifespan() {
    return deviceAuthorizationGrantIdTokenLifespan;
  }

  public void setDeviceAuthorizationGrantIdTokenLifespan(String deviceAuthorizationGrantIdTokenLifespan) {
    this.deviceAuthorizationGrantIdTokenLifespan = deviceAuthorizationGrantIdTokenLifespan;
  }


  public OAuth2ClientTokenLifespans deviceAuthorizationGrantRefreshTokenLifespan(String deviceAuthorizationGrantRefreshTokenLifespan) {
  ...
  /**
   * Specify a time duration in milliseconds, seconds, minutes, hours.
   * @return deviceAuthorizationGrantRefreshTokenLifespan
   */
  @javax.annotation.Nullable
  public String getDeviceAuthorizationGrantRefreshTokenLifespan() {
    return deviceAuthorizationGrantRefreshTokenLifespan;
  }

  public void setDeviceAuthorizationGrantRefreshTokenLifespan(String deviceAuthorizationGrantRefreshTokenLifespan) {
    this.deviceAuthorizationGrantRefreshTokenLifespan = deviceAuthorizationGrantRefreshTokenLifespan;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizationCodeGrantAccessTokenLifespan, oAuth2ClientTokenLifespans.authorizationCodeGrantAccessTokenLifespan) &&
        ...
        Objects.equals(this.deviceAuthorizationGrantAccessTokenLifespan, oAuth2ClientTokenLifespans.deviceAuthorizationGrantAccessTokenLifespan) &&
        Objects.equals(this.deviceAuthorizationGrantIdTokenLifespan, oAuth2ClientTokenLifespans.deviceAuthorizationGrantIdTokenLifespan) &&
        Objects.equals(this.deviceAuthorizationGrantRefreshTokenLifespan, oAuth2ClientTokenLifespans.deviceAuthorizationGrantRefreshTokenLifespan) &&
  ...
  public String toString() {
    ...
    sb.append("    deviceAuthorizationGrantAccessTokenLifespan: ").append(toIndentedString(deviceAuthorizationGrantAccessTokenLifespan)).append("\n");
    sb.append("    deviceAuthorizationGrantIdTokenLifespan: ").append(toIndentedString(deviceAuthorizationGrantIdTokenLifespan)).append("\n");
    sb.append("    deviceAuthorizationGrantRefreshTokenLifespan: ").append(toIndentedString(deviceAuthorizationGrantRefreshTokenLifespan)).append("\n");
  ...
  static {
    ...
    openapiFields.add("device_authorization_grant_access_token_lifespan");
    openapiFields.add("device_authorization_grant_id_token_lifespan");
    openapiFields.add("device_authorization_grant_refresh_token_lifespan");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("device_authorization_grant_access_token_lifespan") != null && !jsonObj.get("device_authorization_grant_access_token_lifespan").isJsonNull()) && !jsonObj.get("device_authorization_grant_access_token_lifespan").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `device_authorization_grant_access_token_lifespan` to be a primitive type in the JSON string but got `%s`", jsonObj.get("device_authorization_grant_access_token_lifespan").toString()));
      }
      if ((jsonObj.get("device_authorization_grant_id_token_lifespan") != null && !jsonObj.get("device_authorization_grant_id_token_lifespan").isJsonNull()) && !jsonObj.get("device_authorization_grant_id_token_lifespan").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `device_authorization_grant_id_token_lifespan` to be a primitive type in the JSON string but got `%s`", jsonObj.get("device_authorization_grant_id_token_lifespan").toString()));
      }
      if ((jsonObj.get("device_authorization_grant_refresh_token_lifespan") != null && !jsonObj.get("device_authorization_grant_refresh_token_lifespan").isJsonNull()) && !jsonObj.get("device_authorization_grant_refresh_token_lifespan").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `device_authorization_grant_refresh_token_lifespan` to be a primitive type in the JSON string but got `%s`", jsonObj.get("device_authorization_grant_refresh_token_lifespan").toString()));
      }
