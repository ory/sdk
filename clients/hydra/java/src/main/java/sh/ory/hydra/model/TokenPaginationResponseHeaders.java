...
public class TokenPaginationResponseHeaders {
   ...
   * @throws IOException if the JSON Element is invalid with respect to TokenPaginationResponseHeaders
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenPaginationResponseHeaders.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
