...
public class ConsentRequest {
  ...
  **/
   ...
   * @return challenge
  **/
  @ApiModelProperty(required = true, value = "Challenge is the identifier (\"authorization challenge\") of the consent authorization request. It is used to identify the session.")
