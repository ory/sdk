...
public class PaginationHeaders {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaginationHeaders
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaginationHeaders.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
