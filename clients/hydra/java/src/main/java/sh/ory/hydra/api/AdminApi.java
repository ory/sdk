...
public class AdminApi {
     ...
     */
    public okhttp3.Call trustJwtGrantIssuerCall(TrustJwtGrantIssuerBody body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call trustJwtGrantIssuerValidateBeforeCall(TrustJwtGrantIssuerBody body, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = trustJwtGrantIssuerCall(body, _callback);
        return localVarCall;
     ...
     */
    public TrustedJwtGrantIssuer trustJwtGrantIssuer(TrustJwtGrantIssuerBody body) throws ApiException {
        ApiResponse<TrustedJwtGrantIssuer> localVarResp = trustJwtGrantIssuerWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TrustedJwtGrantIssuer> trustJwtGrantIssuerWithHttpInfo(TrustJwtGrantIssuerBody body) throws ApiException {
        okhttp3.Call localVarCall = trustJwtGrantIssuerValidateBeforeCall(body, null);
        Type localVarReturnType = new TypeToken<TrustedJwtGrantIssuer>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call trustJwtGrantIssuerAsync(TrustJwtGrantIssuerBody body, final ApiCallback<TrustedJwtGrantIssuer> _callback) throws ApiException {

        okhttp3.Call localVarCall = trustJwtGrantIssuerValidateBeforeCall(body, _callback);
        Type localVarReturnType = new TypeToken<TrustedJwtGrantIssuer>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
