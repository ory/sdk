...
public class ApiClient {
    ...
    public ApiClient(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth retryingOAuth = new RetryingOAuth("/oauth2/token", clientId, OAuthFlow.accessCode, clientSecret, parameters);
        authentications.put(
                "oauth2",
                retryingOAuth
        );
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v0.0.0-alpha.18/java");
