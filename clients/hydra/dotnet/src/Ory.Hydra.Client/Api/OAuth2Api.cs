...
namespace Ory.Hydra.Client.Api
{
    ...
    public interface IOAuth2ApiSync : IApiAccessor
    {
        ...
        List<HydraOAuth2ConsentSession> ListOAuth2ConsentSessions(string subject, long? pageSize = default(long?), string pageToken = default(string));
        ...
        ApiResponse<List<HydraOAuth2ConsentSession>> ListOAuth2ConsentSessionsWithHttpInfo(string subject, long? pageSize = default(long?), string pageToken = default(string));
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Ory.Hydra.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="subject">OAuth 2.0 Subject  The subject to revoke authentication sessions for.</param>
        /// <returns></returns>
        ...
        /// <param name="subject">OAuth 2.0 Subject  The subject to revoke authentication sessions for.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> RevokeOAuth2LoginSessionsWithHttpInfo(string subject);
        /// <summary>
    ...
    public interface IOAuth2ApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<HydraOAuth2ConsentSession>> ListOAuth2ConsentSessionsAsync(string subject, long? pageSize = default(long?), string pageToken = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<HydraOAuth2ConsentSession>>> ListOAuth2ConsentSessionsWithHttpInfoAsync(string subject, long? pageSize = default(long?), string pageToken = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List Trusted OAuth2 JWT Bearer Grant Type Issuers
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task RevokeOAuth2LoginSessionsAsync(string subject, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> RevokeOAuth2LoginSessionsWithHttpInfoAsync(string subject, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Revoke OAuth 2.0 Access or Refresh Token
        /// </summary>
        /// <remarks>
    ...
    public partial class OAuth2Api : IOAuth2Api
    {
        ...
        /// <param name="pageToken">Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination). (optional, default to &quot;1&quot;)</param>
        /// <returns>List&lt;HydraOAuth2ConsentSession&gt;</returns>
        public List<HydraOAuth2ConsentSession> ListOAuth2ConsentSessions(string subject, long? pageSize = default(long?), string pageToken = default(string))
        {
            Ory.Hydra.Client.Client.ApiResponse<List<HydraOAuth2ConsentSession>> localVarResponse = ListOAuth2ConsentSessionsWithHttpInfo(subject, pageSize, pageToken);
            return localVarResponse.Data;
        }
        ...
        /// <param name="pageToken">Next Page Token  The next page token. For details on pagination please head over to the [pagination documentation](https://www.ory.sh/docs/ecosystem/api-design#pagination). (optional, default to &quot;1&quot;)</param>
        /// <returns>ApiResponse of List&lt;HydraOAuth2ConsentSession&gt;</returns>
        public Ory.Hydra.Client.Client.ApiResponse<List<HydraOAuth2ConsentSession>> ListOAuth2ConsentSessionsWithHttpInfo(string subject, long? pageSize = default(long?), string pageToken = default(string))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;HydraOAuth2ConsentSession&gt;</returns>
        public async System.Threading.Tasks.Task<List<HydraOAuth2ConsentSession>> ListOAuth2ConsentSessionsAsync(string subject, long? pageSize = default(long?), string pageToken = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Ory.Hydra.Client.Client.ApiResponse<List<HydraOAuth2ConsentSession>> localVarResponse = await ListOAuth2ConsentSessionsWithHttpInfoAsync(subject, pageSize, pageToken, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;HydraOAuth2ConsentSession&gt;)</returns>
        public async System.Threading.Tasks.Task<Ory.Hydra.Client.Client.ApiResponse<List<HydraOAuth2ConsentSession>>> ListOAuth2ConsentSessionsWithHttpInfoAsync(string subject, long? pageSize = default(long?), string pageToken = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'subject' is set
            if (subject == null)
            {
        ...
        /// <summary>
        /// Revokes All OAuth 2.0 Login Sessions of a Subject This endpoint invalidates a subject&#39;s authentication session. After revoking the authentication session, the subject has to re-authenticate at the Ory OAuth2 Provider. This endpoint does not invalidate any tokens and does not work with OpenID Connect Front- or Back-channel logout.
        /// </summary>
        /// <exception cref="Ory.Hydra.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="subject">OAuth 2.0 Subject  The subject to revoke authentication sessions for.</param>
        /// <returns></returns>
        public void RevokeOAuth2LoginSessions(string subject)
        {
        ...
        /// <param name="subject">OAuth 2.0 Subject  The subject to revoke authentication sessions for.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Ory.Hydra.Client.Client.ApiResponse<Object> RevokeOAuth2LoginSessionsWithHttpInfo(string subject)
        {
            // verify the required parameter 'subject' is set
            if (subject == null)
            {
                throw new Ory.Hydra.Client.Client.ApiException(400, "Missing required parameter 'subject' when calling OAuth2Api->RevokeOAuth2LoginSessions");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task RevokeOAuth2LoginSessionsAsync(string subject, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await RevokeOAuth2LoginSessionsWithHttpInfoAsync(subject, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Ory.Hydra.Client.Client.ApiResponse<Object>> RevokeOAuth2LoginSessionsWithHttpInfoAsync(string subject, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'subject' is set
            if (subject == null)
            {
