...
namespace Ory.Hydra.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "2.4.0-alpha.1";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/2.4.0-alpha.1/csharp");
        ...
        {
            string report = "C# SDK (Ory.Hydra.Client) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: v2.4.0-alpha.1\n";
            report += "    SDK Package Version: 2.4.0-alpha.1\n";
