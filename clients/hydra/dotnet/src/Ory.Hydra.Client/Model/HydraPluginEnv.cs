...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraPluginEnv : IEquatable<HydraPluginEnv>, IValidatableObject
    {
        ...
        public HydraPluginEnv(string description = default(string), string name = default(string), List<string> settable = default(List<string>), string value = default(string))
        {
            ...
            this.Description = description ?? throw new ArgumentNullException("description is a required property for HydraPluginEnv and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for HydraPluginEnv and cannot be null");
            // to ensure "settable" is required (not null)
            this.Settable = settable ?? throw new ArgumentNullException("settable is a required property for HydraPluginEnv and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for HydraPluginEnv and cannot be null");
            this.AdditionalProperties = new Dictionary<string, object>();
        }
