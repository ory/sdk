...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraLoginRequest : IEquatable<HydraLoginRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraLoginRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HydraLoginRequest()
        {
        ...
        public HydraLoginRequest(string challenge = default(string), HydraOAuth2Client _client = default(HydraOAuth2Client), HydraOpenIDConnectContext oidcContext = default(HydraOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), string sessionId = default(string), bool skip = default(bool), string subject = default(string))
        {
            ...
            if (challenge == null) {
                throw new ArgumentNullException("challenge is a required property for HydraLoginRequest and cannot be null");
            }
            this.Challenge = challenge;
            // to ensure "_client" is required (not null)
            if (_client == null) {
                throw new ArgumentNullException("_client is a required property for HydraLoginRequest and cannot be null");
            }
            this._Client = _client;
            // to ensure "requestUrl" is required (not null)
            if (requestUrl == null) {
                throw new ArgumentNullException("requestUrl is a required property for HydraLoginRequest and cannot be null");
            }
            this.RequestUrl = requestUrl;
            // to ensure "requestedAccessTokenAudience" is required (not null)
            if (requestedAccessTokenAudience == null) {
                throw new ArgumentNullException("requestedAccessTokenAudience is a required property for HydraLoginRequest and cannot be null");
            }
            this.RequestedAccessTokenAudience = requestedAccessTokenAudience;
            // to ensure "requestedScope" is required (not null)
            if (requestedScope == null) {
                throw new ArgumentNullException("requestedScope is a required property for HydraLoginRequest and cannot be null");
            }
            this.RequestedScope = requestedScope;
            this.Skip = skip;
            // to ensure "subject" is required (not null)
            if (subject == null) {
                throw new ArgumentNullException("subject is a required property for HydraLoginRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraLoginRequest {\n");
        ...
        {
            return this.Equals(input as HydraLoginRequest);
        }

        /// <summary>
        /// Returns true if HydraLoginRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraLoginRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraLoginRequest input)
        {
            if (input == null)
            {
                return false;
