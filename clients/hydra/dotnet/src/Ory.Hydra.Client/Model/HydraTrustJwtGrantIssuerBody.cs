...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraTrustJwtGrantIssuerBody : IEquatable<HydraTrustJwtGrantIssuerBody>, IValidatableObject
    {
        ...
        public HydraTrustJwtGrantIssuerBody(bool allowAnySubject = default(bool), DateTime expiresAt = default(DateTime), string issuer = default(string), HydraJSONWebKey jwk = default(HydraJSONWebKey), List<string> scope = default(List<string>), string subject = default(string))
        {
