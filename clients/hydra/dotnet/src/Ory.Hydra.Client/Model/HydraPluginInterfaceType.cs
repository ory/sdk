...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraPluginInterfaceType : IEquatable<HydraPluginInterfaceType>, IValidatableObject
    {
        ...
        public HydraPluginInterfaceType(string capability = default(string), string prefix = default(string), string version = default(string))
        {
            ...
            if (capability == null) {
                throw new ArgumentNullException("capability is a required property for HydraPluginInterfaceType and cannot be null");
            }
            this.Capability = capability;
            // to ensure "prefix" is required (not null)
            if (prefix == null) {
                throw new ArgumentNullException("prefix is a required property for HydraPluginInterfaceType and cannot be null");
            }
            this.Prefix = prefix;
            // to ensure "version" is required (not null)
            if (version == null) {
                throw new ArgumentNullException("version is a required property for HydraPluginInterfaceType and cannot be null");
            }
