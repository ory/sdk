...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOidcConfiguration : IValidatableObject
    {
        ...
        /// <param name="deviceAuthorizationEndpoint">OAuth 2.0 Device Authorization Endpoint URL (required).</param>
        ...
        public HydraOidcConfiguration(string authorizationEndpoint = default(string), bool backchannelLogoutSessionSupported = default(bool), bool backchannelLogoutSupported = default(bool), bool claimsParameterSupported = default(bool), List<string> claimsSupported = default(List<string>), List<string> codeChallengeMethodsSupported = default(List<string>), string credentialsEndpointDraft00 = default(string), List<HydraCredentialSupportedDraft00> credentialsSupportedDraft00 = default(List<HydraCredentialSupportedDraft00>), string deviceAuthorizationEndpoint = default(string), string endSessionEndpoint = default(string), bool frontchannelLogoutSessionSupported = default(bool), bool frontchannelLogoutSupported = default(bool), List<string> grantTypesSupported = default(List<string>), List<string> idTokenSignedResponseAlg = default(List<string>), List<string> idTokenSigningAlgValuesSupported = default(List<string>), string issuer = default(string), string jwksUri = default(string), string registrationEndpoint = default(string), List<string> requestObjectSigningAlgValuesSupported = default(List<string>), bool requestParameterSupported = default(bool), bool requestUriParameterSupported = default(bool), bool requireRequestUriRegistration = default(bool), List<string> responseModesSupported = default(List<string>), List<string> responseTypesSupported = default(List<string>), string revocationEndpoint = default(string), List<string> scopesSupported = default(List<string>), List<string> subjectTypesSupported = default(List<string>), string tokenEndpoint = default(string), List<string> tokenEndpointAuthMethodsSupported = default(List<string>), string userinfoEndpoint = default(string), List<string> userinfoSignedResponseAlg = default(List<string>), List<string> userinfoSigningAlgValuesSupported = default(List<string>))
        {
            ...
            // to ensure "deviceAuthorizationEndpoint" is required (not null)
            if (deviceAuthorizationEndpoint == null)
            {
                throw new ArgumentNullException("deviceAuthorizationEndpoint is a required property for HydraOidcConfiguration and cannot be null");
            }
        ...
        [DataMember(Name = "device_authorization_endpoint", IsRequired = true, EmitDefaultValue = true)]
