...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOidcConfiguration : IEquatable<HydraOidcConfiguration>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraOidcConfiguration);
        }

        /// <summary>
        /// Returns true if HydraOidcConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOidcConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOidcConfiguration input)
        {
            if (input == null)
            {
                return false;
