...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraTrustOAuth2JwtGrantIssuer : IEquatable<HydraTrustOAuth2JwtGrantIssuer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraTrustOAuth2JwtGrantIssuer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HydraTrustOAuth2JwtGrantIssuer()
        {
        ...
        public HydraTrustOAuth2JwtGrantIssuer(bool allowAnySubject = default(bool), DateTime expiresAt = default(DateTime), string issuer = default(string), HydraJsonWebKey jwk = default(HydraJsonWebKey), List<string> scope = default(List<string>), string subject = default(string))
        {
            this.ExpiresAt = expiresAt;
            // to ensure "issuer" is required (not null)
            if (issuer == null) {
                throw new ArgumentNullException("issuer is a required property for HydraTrustOAuth2JwtGrantIssuer and cannot be null");
            }
            this.Issuer = issuer;
            // to ensure "jwk" is required (not null)
            if (jwk == null) {
                throw new ArgumentNullException("jwk is a required property for HydraTrustOAuth2JwtGrantIssuer and cannot be null");
            }
            this.Jwk = jwk;
            // to ensure "scope" is required (not null)
            if (scope == null) {
                throw new ArgumentNullException("scope is a required property for HydraTrustOAuth2JwtGrantIssuer and cannot be null");
            }
            this.Scope = scope;
        ...
        {
            return this.Equals(input as HydraTrustOAuth2JwtGrantIssuer);
        }

        /// <summary>
        /// Returns true if HydraTrustOAuth2JwtGrantIssuer instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraTrustOAuth2JwtGrantIssuer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraTrustOAuth2JwtGrantIssuer input)
        {
            if (input == null)
            {
                return false;
