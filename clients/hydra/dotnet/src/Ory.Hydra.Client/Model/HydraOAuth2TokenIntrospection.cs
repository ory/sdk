...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2TokenIntrospection :  IEquatable<HydraOAuth2TokenIntrospection>, IValidatableObject
    {
        ...
        /// <param name="tokenType">TokenType is the introspected token&#39;s type, for example &#x60;access_token&#x60; or &#x60;refresh_token&#x60;..</param>
        /// <param name="username">Username is a human-readable identifier for the resource owner who authorized this token..</param>
        public HydraOAuth2TokenIntrospection(bool active = default(bool), List<string> aud = default(List<string>), string clientId = default(string), long exp = default(long), Object ext = default(Object), long iat = default(long), string iss = default(string), long nbf = default(long), string obfuscatedSubject = default(string), string scope = default(string), string sub = default(string), string tokenType = default(string), string username = default(string))
        {
            this.Active = active;
            this.Aud = aud;
        ...
        /// </summary>
        /// <value>TokenType is the introspected token&#39;s type, for example &#x60;access_token&#x60; or &#x60;refresh_token&#x60;.</value>
