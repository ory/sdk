...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraPagination : IEquatable<HydraPagination>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraPagination" /> class.
        /// </summary>
        ...
        public HydraPagination(long pageSize = 250, string pageToken = "1")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraPagination {\n");
        ...
        {
            return this.Equals(input as HydraPagination);
        }

        /// <summary>
        /// Returns true if HydraPagination instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraPagination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraPagination input)
        {
            if (input == null)
            {
                return false;
