...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraAcceptOAuth2LoginRequest : IEquatable<HydraAcceptOAuth2LoginRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraAcceptOAuth2LoginRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HydraAcceptOAuth2LoginRequest()
        {
        ...
        public HydraAcceptOAuth2LoginRequest(string acr = default(string), List<string> amr = default(List<string>), Object context = default(Object), bool extendSessionLifespan = default(bool), string forceSubjectIdentifier = default(string), bool remember = default(bool), long rememberFor = default(long), string subject = default(string))
        {
            // to ensure "subject" is required (not null)
            if (subject == null) {
                throw new ArgumentNullException("subject is a required property for HydraAcceptOAuth2LoginRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as HydraAcceptOAuth2LoginRequest);
        }

        /// <summary>
        /// Returns true if HydraAcceptOAuth2LoginRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraAcceptOAuth2LoginRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraAcceptOAuth2LoginRequest input)
        {
            if (input == null)
            {
                return false;
