...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraAcceptOAuth2LoginRequest : IEquatable<HydraAcceptOAuth2LoginRequest>, IValidatableObject
    {
        ...
        public HydraAcceptOAuth2LoginRequest(string acr = default(string), List<string> amr = default(List<string>), Object context = default(Object), string forceSubjectIdentifier = default(string), bool remember = default(bool), long rememberFor = default(long), string subject = default(string))
        {
