...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraVerifiableCredentialPrimingResponse : IEquatable<HydraVerifiableCredentialPrimingResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraVerifiableCredentialPrimingResponse);
        }

        /// <summary>
        /// Returns true if HydraVerifiableCredentialPrimingResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraVerifiableCredentialPrimingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraVerifiableCredentialPrimingResponse input)
        {
            if (input == null)
            {
                return false;
