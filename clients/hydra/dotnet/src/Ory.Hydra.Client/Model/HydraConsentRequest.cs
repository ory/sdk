...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraConsentRequest : IEquatable<HydraConsentRequest>, IValidatableObject
    {
        ...
        public HydraConsentRequest(string acr = default(string), List<string> amr = default(List<string>), string challenge = default(string), HydraOAuth2Client _client = default(HydraOAuth2Client), Object context = default(Object), string loginChallenge = default(string), string loginSessionId = default(string), HydraOpenIDConnectContext oidcContext = default(HydraOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), bool skip = default(bool), string subject = default(string))
        {
            // to ensure "challenge" is required (not null)
            if (challenge == null) {
                throw new ArgumentNullException("challenge is a required property for HydraConsentRequest and cannot be null");
            }
