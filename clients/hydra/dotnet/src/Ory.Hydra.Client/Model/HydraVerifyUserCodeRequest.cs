...
{
    /// <summary>
    /// HydraVerifyUserCodeRequest
    /// </summary>
    [DataContract(Name = "verifyUserCodeRequest")]
    public partial class HydraVerifyUserCodeRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraVerifyUserCodeRequest" /> class.
        /// </summary>
        /// <param name="challenge">ID is the identifier (\&quot;device challenge\&quot;) of the device request. It is used to identify the session..</param>
        ...
        public HydraVerifyUserCodeRequest(string challenge = default(string), HydraOAuth2Client varClient = default(HydraOAuth2Client), string deviceCodeRequestId = default(string), DateTime handledAt = default(DateTime), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>ID is the identifier (\&quot;device challenge\&quot;) of the device request. It is used to identify the session.</value>
        ...
        /// </summary>
        [DataMember(Name = "device_code_request_id", EmitDefaultValue = false)]
        public string DeviceCodeRequestId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraVerifyUserCodeRequest {\n");
