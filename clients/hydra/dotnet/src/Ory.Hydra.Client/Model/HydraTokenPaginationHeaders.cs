...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraTokenPaginationHeaders : IEquatable<HydraTokenPaginationHeaders>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraTokenPaginationHeaders);
        }

        /// <summary>
        /// Returns true if HydraTokenPaginationHeaders instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraTokenPaginationHeaders to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraTokenPaginationHeaders input)
        {
            if (input == null)
            {
                return false;
