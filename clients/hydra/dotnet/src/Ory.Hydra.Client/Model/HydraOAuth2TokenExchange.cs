...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2TokenExchange : IEquatable<HydraOAuth2TokenExchange>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraOAuth2TokenExchange);
        }

        /// <summary>
        /// Returns true if HydraOAuth2TokenExchange instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOAuth2TokenExchange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOAuth2TokenExchange input)
        {
            if (input == null)
            {
                return false;
