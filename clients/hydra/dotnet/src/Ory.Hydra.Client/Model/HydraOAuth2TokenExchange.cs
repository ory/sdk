...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2TokenExchange : IEquatable<HydraOAuth2TokenExchange>, IValidatableObject
    {
        ...
        public HydraOAuth2TokenExchange(string accessToken = default(string), long expiresIn = default(long), long idToken = default(long), string refreshToken = default(string), long scope = default(long), string tokenType = default(string))
        {
