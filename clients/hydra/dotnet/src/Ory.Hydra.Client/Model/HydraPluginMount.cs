...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraPluginMount : IEquatable<HydraPluginMount>, IValidatableObject
    {
        ...
        public HydraPluginMount(string description = default(string), string destination = default(string), string name = default(string), List<string> options = default(List<string>), List<string> settable = default(List<string>), string source = default(string), string type = default(string))
        {
            ...
            if (description == null) {
                throw new ArgumentNullException("description is a required property for HydraPluginMount and cannot be null");
            }
            this.Description = description;
            // to ensure "destination" is required (not null)
            if (destination == null) {
                throw new ArgumentNullException("destination is a required property for HydraPluginMount and cannot be null");
            }
            this.Destination = destination;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for HydraPluginMount and cannot be null");
            }
            this.Name = name;
            // to ensure "options" is required (not null)
            if (options == null) {
                throw new ArgumentNullException("options is a required property for HydraPluginMount and cannot be null");
            }
            this.Options = options;
            // to ensure "settable" is required (not null)
            if (settable == null) {
                throw new ArgumentNullException("settable is a required property for HydraPluginMount and cannot be null");
            }
            this.Settable = settable;
            // to ensure "source" is required (not null)
            if (source == null) {
                throw new ArgumentNullException("source is a required property for HydraPluginMount and cannot be null");
            }
            this.Source = source;
            // to ensure "type" is required (not null)
            if (type == null) {
                throw new ArgumentNullException("type is a required property for HydraPluginMount and cannot be null");
            }
            this.Type = type;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
