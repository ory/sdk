...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraTrustedOAuth2JwtGrantIssuer : IEquatable<HydraTrustedOAuth2JwtGrantIssuer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraTrustedOAuth2JwtGrantIssuer" /> class.
        /// </summary>
        ...
        public HydraTrustedOAuth2JwtGrantJsonWebKey PublicKey { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraTrustedOAuth2JwtGrantIssuer {\n");
        ...
        {
            return this.Equals(input as HydraTrustedOAuth2JwtGrantIssuer);
        }

        /// <summary>
        /// Returns true if HydraTrustedOAuth2JwtGrantIssuer instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraTrustedOAuth2JwtGrantIssuer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraTrustedOAuth2JwtGrantIssuer input)
        {
            if (input == null)
            {
                return false;
