...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraGenericError : IEquatable<HydraGenericError>, IValidatableObject
    {
        ...
        public HydraGenericError(long code = default(long), string debug = default(string), Dictionary<string, Object> details = default(Dictionary<string, Object>), string id = default(string), string message = default(string), string reason = default(string), string request = default(string), string status = default(string))
        {
