...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraAcceptOAuth2ConsentRequest : IEquatable<HydraAcceptOAuth2ConsentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraAcceptOAuth2ConsentRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraAcceptOAuth2ConsentRequest {\n");
        ...
        {
            return this.Equals(input as HydraAcceptOAuth2ConsentRequest);
        }

        /// <summary>
        /// Returns true if HydraAcceptOAuth2ConsentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraAcceptOAuth2ConsentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraAcceptOAuth2ConsentRequest input)
        {
            if (input == null)
            {
                return false;
