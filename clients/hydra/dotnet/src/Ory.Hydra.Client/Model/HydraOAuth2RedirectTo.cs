...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2RedirectTo : IEquatable<HydraOAuth2RedirectTo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraOAuth2RedirectTo);
        }

        /// <summary>
        /// Returns true if HydraOAuth2RedirectTo instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOAuth2RedirectTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOAuth2RedirectTo input)
        {
            if (input == null)
            {
                return false;
