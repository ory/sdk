...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraPatchDocument : IEquatable<HydraPatchDocument>, IValidatableObject
    {
        ...
        public HydraPatchDocument(string from = default(string), string op = default(string), string path = default(string), Object value = default(Object))
        {
            ...
            this.Op = op ?? throw new ArgumentNullException("op is a required property for HydraPatchDocument and cannot be null");
            // to ensure "path" is required (not null)
            this.Path = path ?? throw new ArgumentNullException("path is a required property for HydraPatchDocument and cannot be null");
            this.From = from;
            this.Value = value;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
