...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraAcceptOAuth2ConsentRequestSession : IEquatable<HydraAcceptOAuth2ConsentRequestSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraAcceptOAuth2ConsentRequestSession" /> class.
        /// </summary>
        ...
        public HydraAcceptOAuth2ConsentRequestSession(Object accessToken = default(Object), Object idToken = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraAcceptOAuth2ConsentRequestSession {\n");
        ...
        {
            return this.Equals(input as HydraAcceptOAuth2ConsentRequestSession);
        }

        /// <summary>
        /// Returns true if HydraAcceptOAuth2ConsentRequestSession instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraAcceptOAuth2ConsentRequestSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraAcceptOAuth2ConsentRequestSession input)
        {
            if (input == null)
            {
                return false;
