...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraTrustedOAuth2JwtGrantJsonWebKey : IEquatable<HydraTrustedOAuth2JwtGrantJsonWebKey>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraTrustedOAuth2JwtGrantJsonWebKey);
        }

        /// <summary>
        /// Returns true if HydraTrustedOAuth2JwtGrantJsonWebKey instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraTrustedOAuth2JwtGrantJsonWebKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraTrustedOAuth2JwtGrantJsonWebKey input)
        {
            if (input == null)
            {
                return false;
