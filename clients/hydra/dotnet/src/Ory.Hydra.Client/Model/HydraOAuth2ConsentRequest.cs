...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2ConsentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraOAuth2ConsentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HydraOAuth2ConsentRequest()
        {
        ...
        /// <param name="deviceChallengeId">DeviceChallenge is the device challenge this consent challenge belongs to, if this flow was initiated by a device..</param>
        ...
        public HydraOAuth2ConsentRequest(string acr = default(string), List<string> amr = default(List<string>), string challenge = default(string), HydraOAuth2Client varClient = default(HydraOAuth2Client), Object context = default(Object), string deviceChallengeId = default(string), string loginChallenge = default(string), string loginSessionId = default(string), HydraOAuth2ConsentRequestOpenIDConnectContext oidcContext = default(HydraOAuth2ConsentRequestOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), bool skip = default(bool), string subject = default(string))
        {
            // to ensure "challenge" is required (not null)
            if (challenge == null)
            {
                throw new ArgumentNullException("challenge is a required property for HydraOAuth2ConsentRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>DeviceChallenge is the device challenge this consent challenge belongs to, if this flow was initiated by a device.</value>
        [DataMember(Name = "device_challenge_id", EmitDefaultValue = false)]
        ...
        public HydraOAuth2ConsentRequestOpenIDConnectContext OidcContext { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeviceChallengeId: ").Append(DeviceChallengeId).Append("\n");
