...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2ConsentRequest : IEquatable<HydraOAuth2ConsentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public HydraOAuth2ConsentRequest(string acr = default(string), List<string> amr = default(List<string>), string challenge = default(string), HydraOAuth2Client _client = default(HydraOAuth2Client), Object context = default(Object), string loginChallenge = default(string), string loginSessionId = default(string), HydraOAuth2ConsentRequestOpenIDConnectContext oidcContext = default(HydraOAuth2ConsentRequestOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), bool skip = default(bool), string subject = default(string))
        {
        ...
        {
            return this.Equals(input as HydraOAuth2ConsentRequest);
        }

        /// <summary>
        /// Returns true if HydraOAuth2ConsentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOAuth2ConsentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOAuth2ConsentRequest input)
        {
            if (input == null)
            {
                return false;
