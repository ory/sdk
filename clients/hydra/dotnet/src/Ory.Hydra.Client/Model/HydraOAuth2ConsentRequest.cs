...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2ConsentRequest : IValidatableObject
    {
        ...
        public HydraOAuth2ConsentRequest(string acr = default(string), List<string> amr = default(List<string>), string challenge = default(string), HydraOAuth2Client varClient = default(HydraOAuth2Client), Object context = default(Object), string loginChallenge = default(string), string loginSessionId = default(string), HydraOAuth2ConsentRequestOpenIDConnectContext oidcContext = default(HydraOAuth2ConsentRequestOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), bool skip = default(bool), string subject = default(string))
        {
