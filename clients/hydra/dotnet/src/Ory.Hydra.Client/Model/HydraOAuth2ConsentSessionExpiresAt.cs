...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2ConsentSessionExpiresAt : IEquatable<HydraOAuth2ConsentSessionExpiresAt>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraOAuth2ConsentSessionExpiresAt);
        }

        /// <summary>
        /// Returns true if HydraOAuth2ConsentSessionExpiresAt instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOAuth2ConsentSessionExpiresAt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOAuth2ConsentSessionExpiresAt input)
        {
            if (input == null)
            {
                return false;
