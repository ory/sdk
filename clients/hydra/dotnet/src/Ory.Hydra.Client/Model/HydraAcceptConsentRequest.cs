...
namespace Ory.Hydra.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "acceptConsentRequest")]
    public partial class HydraAcceptConsentRequest : IEquatable<HydraAcceptConsentRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraAcceptConsentRequest {\n");
        ...
        {
            return this.Equals(input as HydraAcceptConsentRequest);
        }

        /// <summary>
        /// Returns true if HydraAcceptConsentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraAcceptConsentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraAcceptConsentRequest input)
        {
            if (input == null)
                return false;
