...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraCreateJsonWebKeySet : IEquatable<HydraCreateJsonWebKeySet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraCreateJsonWebKeySet" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HydraCreateJsonWebKeySet()
        {
        ...
        public HydraCreateJsonWebKeySet(string alg = default(string), string kid = default(string), string use = default(string))
        {
            // to ensure "alg" is required (not null)
            if (alg == null) {
                throw new ArgumentNullException("alg is a required property for HydraCreateJsonWebKeySet and cannot be null");
            }
            this.Alg = alg;
            // to ensure "kid" is required (not null)
            if (kid == null) {
                throw new ArgumentNullException("kid is a required property for HydraCreateJsonWebKeySet and cannot be null");
            }
            this.Kid = kid;
            // to ensure "use" is required (not null)
            if (use == null) {
                throw new ArgumentNullException("use is a required property for HydraCreateJsonWebKeySet and cannot be null");
            }
            this.Use = use;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
        ...
        {
            return this.Equals(input as HydraCreateJsonWebKeySet);
        }

        /// <summary>
        /// Returns true if HydraCreateJsonWebKeySet instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraCreateJsonWebKeySet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraCreateJsonWebKeySet input)
        {
            if (input == null)
            {
                return false;
