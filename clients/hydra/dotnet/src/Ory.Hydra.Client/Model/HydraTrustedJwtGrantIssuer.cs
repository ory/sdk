...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraTrustedJwtGrantIssuer : IEquatable<HydraTrustedJwtGrantIssuer>, IValidatableObject
    {
        ...
        public HydraTrustedJwtGrantIssuer(bool allowAnySubject = default(bool), DateTime createdAt = default(DateTime), DateTime expiresAt = default(DateTime), string id = default(string), string issuer = default(string), HydraTrustedJsonWebKey publicKey = default(HydraTrustedJsonWebKey), List<string> scope = default(List<string>), string subject = default(string))
        {
