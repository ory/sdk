...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOauthTokenResponse : IEquatable<HydraOauthTokenResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraOauthTokenResponse" /> class.
        /// </summary>
        ...
        public HydraOauthTokenResponse(string accessToken = default(string), long expiresIn = default(long), long idToken = default(long), string refreshToken = default(string), long scope = default(long), string tokenType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraOauthTokenResponse {\n");
        ...
        {
            return this.Equals(input as HydraOauthTokenResponse);
        }

        /// <summary>
        /// Returns true if HydraOauthTokenResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOauthTokenResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOauthTokenResponse input)
        {
            if (input == null)
            {
                return false;
