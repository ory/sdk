...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraVerifiableCredentialResponse : IEquatable<HydraVerifiableCredentialResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraVerifiableCredentialResponse);
        }

        /// <summary>
        /// Returns true if HydraVerifiableCredentialResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraVerifiableCredentialResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraVerifiableCredentialResponse input)
        {
            if (input == null)
            {
                return false;
