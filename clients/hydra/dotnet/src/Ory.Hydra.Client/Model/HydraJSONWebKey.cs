...
namespace Ory.Hydra.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HydraJSONWebKey :  IEquatable<HydraJSONWebKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraJSONWebKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HydraJSONWebKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraJSONWebKey" /> class.
        /// </summary>
        ...
        public HydraJSONWebKey(string alg = default(string), string crv = default(string), string d = default(string), string dp = default(string), string dq = default(string), string e = default(string), string k = default(string), string kid = default(string), string kty = default(string), string n = default(string), string p = default(string), string q = default(string), string qi = default(string), string use = default(string), string x = default(string), List<string> x5c = default(List<string>), string y = default(string))
        {
            // to ensure "alg" is required (not null)
            this.Alg = alg ?? throw new ArgumentNullException("alg is a required property for HydraJSONWebKey and cannot be null");
            // to ensure "kid" is required (not null)
            this.Kid = kid ?? throw new ArgumentNullException("kid is a required property for HydraJSONWebKey and cannot be null");
            // to ensure "kty" is required (not null)
            this.Kty = kty ?? throw new ArgumentNullException("kty is a required property for HydraJSONWebKey and cannot be null");
            // to ensure "use" is required (not null)
            this.Use = use ?? throw new ArgumentNullException("use is a required property for HydraJSONWebKey and cannot be null");
            this.Crv = crv;
            this.D = d;
            this.Dp = dp;
            this.Dq = dq;
        ...
        {
            return this.Equals(input as HydraJSONWebKey);
        }

        /// <summary>
        /// Returns true if HydraJSONWebKey instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraJSONWebKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraJSONWebKey input)
        {
            if (input == null)
                return false;
