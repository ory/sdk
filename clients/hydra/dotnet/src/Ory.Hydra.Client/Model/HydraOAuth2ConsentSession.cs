...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2ConsentSession : IEquatable<HydraOAuth2ConsentSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraOAuth2ConsentSession" /> class.
        /// </summary>
        ...
        public HydraOAuth2ConsentSession(HydraOAuth2ConsentRequest consentRequest = default(HydraOAuth2ConsentRequest), HydraOAuth2ConsentSessionExpiresAt expiresAt = default(HydraOAuth2ConsentSessionExpiresAt), List<string> grantAccessTokenAudience = default(List<string>), List<string> grantScope = default(List<string>), DateTime handledAt = default(DateTime), bool remember = default(bool), long rememberFor = default(long), HydraAcceptOAuth2ConsentRequestSession session = default(HydraAcceptOAuth2ConsentRequestSession))
        {
        ...
        public HydraOAuth2ConsentRequest ConsentRequest { get; set; }

        /// <summary>
        /// Gets or Sets ExpiresAt
        /// </summary>
        [DataMember(Name = "expires_at", EmitDefaultValue = false)]
        public HydraOAuth2ConsentSessionExpiresAt ExpiresAt { get; set; }
        ...
        public HydraAcceptOAuth2ConsentRequestSession Session { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraOAuth2ConsentSession {\n");
        ...
        {
            return this.Equals(input as HydraOAuth2ConsentSession);
        }

        /// <summary>
        /// Returns true if HydraOAuth2ConsentSession instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOAuth2ConsentSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOAuth2ConsentSession input)
        {
            if (input == null)
            {
                return false;
