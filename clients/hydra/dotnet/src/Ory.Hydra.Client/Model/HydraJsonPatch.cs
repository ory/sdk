...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraJsonPatch : IEquatable<HydraJsonPatch>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraJsonPatch);
        }

        /// <summary>
        /// Returns true if HydraJsonPatch instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraJsonPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraJsonPatch input)
        {
            if (input == null)
            {
                return false;
