...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraWellKnown :  IEquatable<HydraWellKnown>, IValidatableObject
    {
        ...
        public HydraWellKnown(string authorizationEndpoint = default(string), bool backchannelLogoutSessionSupported = default(bool), bool backchannelLogoutSupported = default(bool), bool claimsParameterSupported = default(bool), List<string> claimsSupported = default(List<string>), string endSessionEndpoint = default(string), bool frontchannelLogoutSessionSupported = default(bool), bool frontchannelLogoutSupported = default(bool), List<string> grantTypesSupported = default(List<string>), List<string> idTokenSigningAlgValuesSupported = default(List<string>), string issuer = default(string), string jwksUri = default(string), string registrationEndpoint = default(string), List<string> requestObjectSigningAlgValuesSupported = default(List<string>), bool requestParameterSupported = default(bool), bool requestUriParameterSupported = default(bool), bool requireRequestUriRegistration = default(bool), List<string> responseModesSupported = default(List<string>), List<string> responseTypesSupported = default(List<string>), string revocationEndpoint = default(string), List<string> scopesSupported = default(List<string>), List<string> subjectTypesSupported = default(List<string>), string tokenEndpoint = default(string), List<string> tokenEndpointAuthMethodsSupported = default(List<string>), string userinfoEndpoint = default(string), List<string> userinfoSigningAlgValuesSupported = default(List<string>))
        {
            // to ensure "authorizationEndpoint" is required (not null)
            this.AuthorizationEndpoint = authorizationEndpoint ?? throw new ArgumentNullException("authorizationEndpoint is a required property for HydraWellKnown and cannot be null");
            // to ensure "idTokenSigningAlgValuesSupported" is required (not null)
            this.IdTokenSigningAlgValuesSupported = idTokenSigningAlgValuesSupported ?? throw new ArgumentNullException("idTokenSigningAlgValuesSupported is a required property for HydraWellKnown and cannot be null");
            // to ensure "issuer" is required (not null)
            this.Issuer = issuer ?? throw new ArgumentNullException("issuer is a required property for HydraWellKnown and cannot be null");
            // to ensure "jwksUri" is required (not null)
            this.JwksUri = jwksUri ?? throw new ArgumentNullException("jwksUri is a required property for HydraWellKnown and cannot be null");
            // to ensure "responseTypesSupported" is required (not null)
            this.ResponseTypesSupported = responseTypesSupported ?? throw new ArgumentNullException("responseTypesSupported is a required property for HydraWellKnown and cannot be null");
            // to ensure "subjectTypesSupported" is required (not null)
            this.SubjectTypesSupported = subjectTypesSupported ?? throw new ArgumentNullException("subjectTypesSupported is a required property for HydraWellKnown and cannot be null");
            // to ensure "tokenEndpoint" is required (not null)
            this.TokenEndpoint = tokenEndpoint ?? throw new ArgumentNullException("tokenEndpoint is a required property for HydraWellKnown and cannot be null");
        ...
        [DataMember(Name="backchannel_logout_session_supported", EmitDefaultValue=false)]
        ...
        [DataMember(Name="backchannel_logout_supported", EmitDefaultValue=false)]
        ...
        [DataMember(Name="claims_parameter_supported", EmitDefaultValue=false)]
        ...
        [DataMember(Name="frontchannel_logout_session_supported", EmitDefaultValue=false)]
        ...
        [DataMember(Name="request_parameter_supported", EmitDefaultValue=false)]
        ...
        [DataMember(Name="require_request_uri_registration", EmitDefaultValue=false)]
