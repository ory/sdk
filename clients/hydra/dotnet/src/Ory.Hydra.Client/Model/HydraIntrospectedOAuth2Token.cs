...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraIntrospectedOAuth2Token : IEquatable<HydraIntrospectedOAuth2Token>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraIntrospectedOAuth2Token" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HydraIntrospectedOAuth2Token()
        {
        ...
        {
            return this.Equals(input as HydraIntrospectedOAuth2Token);
        }

        /// <summary>
        /// Returns true if HydraIntrospectedOAuth2Token instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraIntrospectedOAuth2Token to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraIntrospectedOAuth2Token input)
        {
            if (input == null)
            {
                return false;
