...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2ConsentRequestOpenIDConnectContext : IEquatable<HydraOAuth2ConsentRequestOpenIDConnectContext>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraOAuth2ConsentRequestOpenIDConnectContext" /> class.
        /// </summary>
        ...
        public HydraOAuth2ConsentRequestOpenIDConnectContext(List<string> acrValues = default(List<string>), string display = default(string), Dictionary<string, Object> idTokenHintClaims = default(Dictionary<string, Object>), string loginHint = default(string), List<string> uiLocales = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraOAuth2ConsentRequestOpenIDConnectContext {\n");
        ...
        {
            return this.Equals(input as HydraOAuth2ConsentRequestOpenIDConnectContext);
        }

        /// <summary>
        /// Returns true if HydraOAuth2ConsentRequestOpenIDConnectContext instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOAuth2ConsentRequestOpenIDConnectContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOAuth2ConsentRequestOpenIDConnectContext input)
        {
            if (input == null)
            {
                return false;
