...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraPluginConfigArgs : IEquatable<HydraPluginConfigArgs>, IValidatableObject
    {
        ...
        public HydraPluginConfigArgs(string description = default(string), string name = default(string), List<string> settable = default(List<string>), List<string> value = default(List<string>))
        {
            ...
            if (description == null) {
                throw new ArgumentNullException("description is a required property for HydraPluginConfigArgs and cannot be null");
            }
            this.Description = description;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for HydraPluginConfigArgs and cannot be null");
            }
            this.Name = name;
            // to ensure "settable" is required (not null)
            if (settable == null) {
                throw new ArgumentNullException("settable is a required property for HydraPluginConfigArgs and cannot be null");
            }
            this.Settable = settable;
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for HydraPluginConfigArgs and cannot be null");
            }
            this.Value = value;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
