...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraLogoutRequest : IEquatable<HydraLogoutRequest>, IValidatableObject
    {
        ...
        public HydraLogoutRequest(string challenge = default(string), string requestUrl = default(string), bool rpInitiated = default(bool), string sid = default(string), string subject = default(string))
        {
