...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2LoginRequest : IValidatableObject
    {
        /// <summary>
        ...
        public HydraOAuth2LoginRequest(string challenge = default(string), HydraOAuth2Client varClient = default(HydraOAuth2Client), HydraOAuth2ConsentRequestOpenIDConnectContext oidcContext = default(HydraOAuth2ConsentRequestOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), string sessionId = default(string), bool skip = default(bool), string subject = default(string))
        {
            ...
            if (varClient == null)
            {
                throw new ArgumentNullException("varClient is a required property for HydraOAuth2LoginRequest and cannot be null");
            }
