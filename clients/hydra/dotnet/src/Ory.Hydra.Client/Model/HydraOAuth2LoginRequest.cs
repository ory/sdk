...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraOAuth2LoginRequest : IEquatable<HydraOAuth2LoginRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraOAuth2LoginRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HydraOAuth2LoginRequest()
        {
        ...
        public HydraOAuth2LoginRequest(string challenge = default(string), HydraOAuth2Client _client = default(HydraOAuth2Client), HydraOAuth2ConsentRequestOpenIDConnectContext oidcContext = default(HydraOAuth2ConsentRequestOpenIDConnectContext), string requestUrl = default(string), List<string> requestedAccessTokenAudience = default(List<string>), List<string> requestedScope = default(List<string>), string sessionId = default(string), bool skip = default(bool), string subject = default(string))
        {
            // to ensure "challenge" is required (not null)
            if (challenge == null) {
                throw new ArgumentNullException("challenge is a required property for HydraOAuth2LoginRequest and cannot be null");
            }
            this.Challenge = challenge;
            // to ensure "_client" is required (not null)
            if (_client == null) {
                throw new ArgumentNullException("_client is a required property for HydraOAuth2LoginRequest and cannot be null");
            }
            this._Client = _client;
            // to ensure "requestUrl" is required (not null)
            if (requestUrl == null) {
                throw new ArgumentNullException("requestUrl is a required property for HydraOAuth2LoginRequest and cannot be null");
            }
            this.RequestUrl = requestUrl;
            // to ensure "requestedAccessTokenAudience" is required (not null)
            if (requestedAccessTokenAudience == null) {
                throw new ArgumentNullException("requestedAccessTokenAudience is a required property for HydraOAuth2LoginRequest and cannot be null");
            }
            this.RequestedAccessTokenAudience = requestedAccessTokenAudience;
            // to ensure "requestedScope" is required (not null)
            if (requestedScope == null) {
                throw new ArgumentNullException("requestedScope is a required property for HydraOAuth2LoginRequest and cannot be null");
            }
            this.RequestedScope = requestedScope;
            this.Skip = skip;
            // to ensure "subject" is required (not null)
            if (subject == null) {
                throw new ArgumentNullException("subject is a required property for HydraOAuth2LoginRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as HydraOAuth2LoginRequest);
        }

        /// <summary>
        /// Returns true if HydraOAuth2LoginRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOAuth2LoginRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOAuth2LoginRequest input)
        {
            if (input == null)
            {
                return false;
