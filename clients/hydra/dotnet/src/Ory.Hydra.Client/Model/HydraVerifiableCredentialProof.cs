...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraVerifiableCredentialProof : IEquatable<HydraVerifiableCredentialProof>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraVerifiableCredentialProof);
        }

        /// <summary>
        /// Returns true if HydraVerifiableCredentialProof instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraVerifiableCredentialProof to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraVerifiableCredentialProof input)
        {
            if (input == null)
            {
                return false;
