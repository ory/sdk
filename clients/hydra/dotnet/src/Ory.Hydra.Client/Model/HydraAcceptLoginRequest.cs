...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraAcceptLoginRequest :  IEquatable<HydraAcceptLoginRequest>, IValidatableObject
    {
        ...
        public HydraAcceptLoginRequest(string acr = default(string), Object context = default(Object), string forceSubjectIdentifier = default(string), bool remember = default(bool), long rememberFor = default(long), string subject = default(string))
        {
            // to ensure "subject" is required (not null)
            this.Subject = subject ?? throw new ArgumentNullException("subject is a required property for HydraAcceptLoginRequest and cannot be null");
            this.Acr = acr;
