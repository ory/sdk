...
namespace Ory.Hydra.Client.Model
{
    ...
    public partial class HydraRejectOAuth2Request : IEquatable<HydraRejectOAuth2Request>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as HydraRejectOAuth2Request);
        }

        /// <summary>
        /// Returns true if HydraRejectOAuth2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraRejectOAuth2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraRejectOAuth2Request input)
        {
            if (input == null)
            {
                return false;
