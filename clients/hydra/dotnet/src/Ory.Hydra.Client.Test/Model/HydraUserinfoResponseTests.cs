...
namespace Ory.Hydra.Client.Test
{
    ...
    public class HydraUserinfoResponseTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" HydraUserinfoResponse
            //Assert.IsInstanceOfType<HydraUserinfoResponse> (instance, "variable 'instance' is a HydraUserinfoResponse");
        }
