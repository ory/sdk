...
namespace Ory.Hydra.Client.Test
{
    ...
    public class HydraPluginConfigTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" HydraPluginConfig
            //Assert.IsInstanceOfType<HydraPluginConfig> (instance, "variable 'instance' is a HydraPluginConfig");
        }
