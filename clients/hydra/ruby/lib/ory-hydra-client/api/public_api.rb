...
module OryHydraClient
  class PublicApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [OAuth2Client]
    def dynamic_client_registration_create_o_auth2_client(body, opts = {})
      data, _status_code, _headers = dynamic_client_registration_create_o_auth2_client_with_http_info(body, opts)
      data
    end
    ...
    def dynamic_client_registration_create_o_auth2_client_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PublicApi.dynamic_client_registration_create_o_auth2_client ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PublicApi.dynamic_client_registration_create_o_auth2_client"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [OAuth2Client]
    def dynamic_client_registration_update_o_auth2_client(id, body, opts = {})
      data, _status_code, _headers = dynamic_client_registration_update_o_auth2_client_with_http_info(id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(OAuth2Client, Integer, Hash)>] OAuth2Client data, response status code and response headers
    def dynamic_client_registration_update_o_auth2_client_with_http_info(id, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PublicApi.dynamic_client_registration_update_o_auth2_client"
      end
      # resource path
      local_var_path = '/connect/register/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
