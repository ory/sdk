...
module OryHydraClient
  class OAuth2ConsentRequest
    ...
    def hash
      [acr, amr, challenge, client, context, device_challenge_id, login_challenge, login_session_id, oidc_context, request_url, requested_access_token_audience, requested_scope, skip, subject].hash
    end
