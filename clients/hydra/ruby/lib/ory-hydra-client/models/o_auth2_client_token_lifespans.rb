...
module OryHydraClient
  ...
  class OAuth2ClientTokenLifespans
    ...
    # Specify a time duration in milliseconds, seconds, minutes, hours.
    attr_accessor :device_authorization_grant_access_token_lifespan

    # Specify a time duration in milliseconds, seconds, minutes, hours.
    attr_accessor :device_authorization_grant_id_token_lifespan

    # Specify a time duration in milliseconds, seconds, minutes, hours.
    attr_accessor :device_authorization_grant_refresh_token_lifespan
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OryHydraClient::OAuth2ClientTokenLifespans`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def authorization_code_grant_id_token_lifespan=(authorization_code_grant_id_token_lifespan)
      if authorization_code_grant_id_token_lifespan.nil?
        fail ArgumentError, 'authorization_code_grant_id_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if authorization_code_grant_id_token_lifespan !~ pattern
    ...
    def authorization_code_grant_refresh_token_lifespan=(authorization_code_grant_refresh_token_lifespan)
      if authorization_code_grant_refresh_token_lifespan.nil?
        fail ArgumentError, 'authorization_code_grant_refresh_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if authorization_code_grant_refresh_token_lifespan !~ pattern
    ...
    def client_credentials_grant_access_token_lifespan=(client_credentials_grant_access_token_lifespan)
      if client_credentials_grant_access_token_lifespan.nil?
        fail ArgumentError, 'client_credentials_grant_access_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if client_credentials_grant_access_token_lifespan !~ pattern
    ...
    # Custom attribute writer method with validation
    # @param [Object] device_authorization_grant_access_token_lifespan Value to be assigned
    def device_authorization_grant_access_token_lifespan=(device_authorization_grant_access_token_lifespan)
      if device_authorization_grant_access_token_lifespan.nil?
        fail ArgumentError, 'device_authorization_grant_access_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if device_authorization_grant_access_token_lifespan !~ pattern
        fail ArgumentError, "invalid value for \"device_authorization_grant_access_token_lifespan\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] device_authorization_grant_id_token_lifespan Value to be assigned
    def device_authorization_grant_id_token_lifespan=(device_authorization_grant_id_token_lifespan)
      if device_authorization_grant_id_token_lifespan.nil?
        fail ArgumentError, 'device_authorization_grant_id_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if device_authorization_grant_id_token_lifespan !~ pattern
        fail ArgumentError, "invalid value for \"device_authorization_grant_id_token_lifespan\", must conform to the pattern #{pattern}."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] device_authorization_grant_refresh_token_lifespan Value to be assigned
    def device_authorization_grant_refresh_token_lifespan=(device_authorization_grant_refresh_token_lifespan)
      if device_authorization_grant_refresh_token_lifespan.nil?
        fail ArgumentError, 'device_authorization_grant_refresh_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if device_authorization_grant_refresh_token_lifespan !~ pattern
        fail ArgumentError, "invalid value for \"device_authorization_grant_refresh_token_lifespan\", must conform to the pattern #{pattern}."
      end
    ...
    def implicit_grant_access_token_lifespan=(implicit_grant_access_token_lifespan)
      if implicit_grant_access_token_lifespan.nil?
        fail ArgumentError, 'implicit_grant_access_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if implicit_grant_access_token_lifespan !~ pattern
    ...
    def implicit_grant_id_token_lifespan=(implicit_grant_id_token_lifespan)
      if implicit_grant_id_token_lifespan.nil?
        fail ArgumentError, 'implicit_grant_id_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if implicit_grant_id_token_lifespan !~ pattern
    ...
    def jwt_bearer_grant_access_token_lifespan=(jwt_bearer_grant_access_token_lifespan)
      if jwt_bearer_grant_access_token_lifespan.nil?
        fail ArgumentError, 'jwt_bearer_grant_access_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if jwt_bearer_grant_access_token_lifespan !~ pattern
    ...
    def refresh_token_grant_access_token_lifespan=(refresh_token_grant_access_token_lifespan)
      if refresh_token_grant_access_token_lifespan.nil?
        fail ArgumentError, 'refresh_token_grant_access_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if refresh_token_grant_access_token_lifespan !~ pattern
    ...
    def refresh_token_grant_id_token_lifespan=(refresh_token_grant_id_token_lifespan)
      if refresh_token_grant_id_token_lifespan.nil?
        fail ArgumentError, 'refresh_token_grant_id_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if refresh_token_grant_id_token_lifespan !~ pattern
    ...
    def refresh_token_grant_refresh_token_lifespan=(refresh_token_grant_refresh_token_lifespan)
      if refresh_token_grant_refresh_token_lifespan.nil?
        fail ArgumentError, 'refresh_token_grant_refresh_token_lifespan cannot be nil'
      end

      pattern = Regexp.new(/^([0-9]+(ns|us|ms|s|m|h))*$/)
      if refresh_token_grant_refresh_token_lifespan !~ pattern
    ...
    def hash
      [authorization_code_grant_access_token_lifespan, authorization_code_grant_id_token_lifespan, authorization_code_grant_refresh_token_lifespan, client_credentials_grant_access_token_lifespan, device_authorization_grant_access_token_lifespan, device_authorization_grant_id_token_lifespan, device_authorization_grant_refresh_token_lifespan, implicit_grant_access_token_lifespan, implicit_grant_id_token_lifespan, jwt_bearer_grant_access_token_lifespan, refresh_token_grant_access_token_lifespan, refresh_token_grant_id_token_lifespan, refresh_token_grant_refresh_token_lifespan].hash
    end
