...
module OryHydraClient
  ...
  class PluginConfigInterface
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'protocol_scheme')
        self.protocol_scheme = attributes[:'protocol_scheme']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          protocol_scheme == o.protocol_scheme &&
          socket == o.socket &&
          types == o.types
    end
    ...
    def hash
      [protocol_scheme, socket, types].hash
    end
