...
export function AcceptOAuth2LoginRequestToJSON(json: any): AcceptOAuth2LoginRequest {
    return AcceptOAuth2LoginRequestToJSONTyped(json, false);
}

export function AcceptOAuth2LoginRequestToJSONTyped(value?: AcceptOAuth2LoginRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
