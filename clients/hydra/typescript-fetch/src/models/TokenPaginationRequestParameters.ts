...
export function TokenPaginationRequestParametersToJSON(json: any): TokenPaginationRequestParameters {
    return TokenPaginationRequestParametersToJSONTyped(json, false);
}

export function TokenPaginationRequestParametersToJSONTyped(value?: TokenPaginationRequestParameters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
