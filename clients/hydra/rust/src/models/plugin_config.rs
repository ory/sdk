...
pub struct PluginConfig {
    #[serde(rename = "Args")]
    pub args: crate::models::PluginConfigArgs,
    /// description
    ...
    pub interface: crate::models::PluginConfigInterface,
    /// ipc host
    #[serde(rename = "IpcHost")]
    pub ipc_host: bool,
    #[serde(rename = "Linux")]
    pub linux: crate::models::PluginConfigLinux,
    /// mounts
    #[serde(rename = "Mounts")]
    pub mounts: Vec<crate::models::PluginMount>,
    #[serde(rename = "Network")]
    pub network: crate::models::PluginConfigNetwork,
    /// pid host
    ...
    pub user: Option<crate::models::PluginConfigUser>,
    /// work dir
    #[serde(rename = "WorkDir")]
    pub work_dir: String,
    #[serde(rename = "rootfs", skip_serializing_if = "Option::is_none")]
    pub rootfs: Option<crate::models::PluginConfigRootfs>,
}
