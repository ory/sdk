# ory_hydra_client.model.LoginRequest
...
**requestedAccessTokenAudience** | **List<String>** | RequestedScope contains the access token audience as requested by the OAuth 2.0 Client. | [optional] [default to const []]
**requestedScope** | **List<String>** | RequestedScope contains the OAuth 2.0 Scope requested by the OAuth 2.0 Client. | [optional] [default to const []]
