...
class PublicApi {
  ...
  Future<Response<WellKnown>> discoverOpenIDConfiguration({ 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ValidateStatus validateStatus,
    ...
    final _request = RequestOptions(
      path: r'/.well-known/openid-configuration',
      method: 'GET',
      headers: <String, dynamic>{
        ...?headers,
      },
    ...
    const _responseType = FullType(WellKnown);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as WellKnown;

    return Response<WellKnown>(
      data: _responseData,
  ...
  Future<Response<void>> dynamicClientRegistrationDeleteOAuth2Client(
    String id, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ...
    final _request = RequestOptions(
      path: r'/connect/register/{id}'.replaceAll('{' r'id' '}', id.toString()),
      method: 'DELETE',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<OAuth2Client>> dynamicClientRegistrationGetOAuth2Client(
    String id, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
  ...
  Future<Response<Oauth2TokenResponse>> oauth2Token(
    ...
    const _responseType = FullType(Oauth2TokenResponse);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
  ...
  Future<Response<void>> oauthAuth({ 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ValidateStatus validateStatus,
  ...
  Future<Response<UserinfoResponse>> userinfo({ 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ValidateStatus validateStatus,
    ...
    const _responseType = FullType(UserinfoResponse);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as UserinfoResponse;
  ...
  Future<Response<JSONWebKeySet>> wellKnown({ 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ValidateStatus validateStatus,
