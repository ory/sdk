...
class AdminApi {
  ...
  Future<Response<CompletedRequest>> acceptConsentRequest(
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/requests/consent/accept',
      method: 'PUT',
      headers: <String, dynamic>{
        ...?headers,
      },
      queryParameters: <String, dynamic>{
        r'consent_challenge': consentChallenge,
      },
    ...
    const _responseType = FullType(CompletedRequest);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as CompletedRequest;

    return Response<CompletedRequest>(
      data: _responseData,
  ...
  Future<Response<CompletedRequest>> acceptLoginRequest(
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/requests/login/accept',
      method: 'PUT',
      headers: <String, dynamic>{
        ...?headers,
      },
      queryParameters: <String, dynamic>{
        r'login_challenge': loginChallenge,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[],
        ...?extra,
  ...
  Future<Response<CompletedRequest>> acceptLogoutRequest(
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/requests/logout/accept',
      method: 'PUT',
      headers: <String, dynamic>{
        ...?headers,
      },
      queryParameters: <String, dynamic>{
        r'logout_challenge': logoutChallenge,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[],
        ...?extra,
  ...
  Future<Response<JSONWebKeySet>> createJsonWebKeySet(
    ...
    final _request = RequestOptions(
      path: r'/keys/{set}'.replaceAll('{' r'set' '}', set_.toString()),
      method: 'POST',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<void>> deleteJsonWebKey(
    ...
    final _request = RequestOptions(
      path: r'/keys/{set}/{kid}'.replaceAll('{' r'kid' '}', kid.toString()).replaceAll('{' r'set' '}', set_.toString()),
      method: 'DELETE',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<void>> deleteOAuth2Client(
    ...
    final _request = RequestOptions(
      path: r'/clients/{id}'.replaceAll('{' r'id' '}', id.toString()),
      method: 'DELETE',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<void>> deleteTrustedJwtGrantIssuer(
    String id, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ...
    final _request = RequestOptions(
      path: r'/trust/grants/jwt-bearer/issuers/{id}'.replaceAll('{' r'id' '}', id.toString()),
      method: 'DELETE',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  ///
  /// When an authorization code, hybrid, or implicit OAuth 2.0 Flow is initiated, ORY Hydra asks the login provider to authenticate the subject and then tell ORY Hydra now about it. If the subject authenticated, he/she must now be asked if the OAuth 2.0 Client which initiated the flow should be allowed to access the resources on the subject's behalf.  The consent provider which handles this request and is a web app implemented and hosted by you. It shows a subject interface which asks the subject to grant or deny the client access to the requested scope (\"Application my-dropbox-app wants write access to all your private files\").  The consent challenge is appended to the consent provider's URL to which the subject's user-agent (browser) is redirected to. The consent provider uses that challenge to fetch information on the OAuth2 request and then tells ORY Hydra if the subject accepted or rejected the request.
  Future<Response<ConsentRequest>> getConsentRequest(
    String consentChallenge, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/requests/consent',
      method: 'GET',
      headers: <String, dynamic>{
        ...?headers,
      },
    ...
    const _responseType = FullType(ConsentRequest);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as ConsentRequest;
  ...
  Future<Response<LoginRequest>> getLoginRequest(
    String loginChallenge, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/requests/login',
      method: 'GET',
      headers: <String, dynamic>{
        ...?headers,
      },
    ...
    const _responseType = FullType(LoginRequest);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as LoginRequest;
  ...
  Future<Response<LogoutRequest>> getLogoutRequest(
    String logoutChallenge, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/requests/logout',
      method: 'GET',
      headers: <String, dynamic>{
        ...?headers,
      },
    ...
    const _responseType = FullType(LogoutRequest);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as LogoutRequest;

    return Response<LogoutRequest>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      request: _response.request,
  ...
  Future<Response<TrustedJwtGrantIssuer>> getTrustedJwtGrantIssuer(
    String id, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ...
    const _responseType = FullType(TrustedJwtGrantIssuer);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as TrustedJwtGrantIssuer;

    return Response<TrustedJwtGrantIssuer>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      request: _response.request,
  ...
  Future<Response<OAuth2TokenIntrospection>> introspectOAuth2Token(
    String token, { 
    String scope,
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    ...
    const _responseType = FullType(OAuth2TokenIntrospection);
    final _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
  ...
  Future<Response<BuiltList<OAuth2Client>>> listOAuth2Clients({ 
    ...
    final BuiltList<OAuth2Client> _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
  ...
  Future<Response<BuiltList<PreviousConsentSession>>> listSubjectConsentSessions(
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/sessions/consent',
      method: 'GET',
      headers: <String, dynamic>{
        ...?headers,
      },
    ...
    const _responseType = FullType(BuiltList, [FullType(PreviousConsentSession)]);
    final BuiltList<PreviousConsentSession> _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as BuiltList<PreviousConsentSession>;

    return Response<BuiltList<PreviousConsentSession>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      request: _response.request,
  ...
  Future<Response<BuiltList<TrustedJwtGrantIssuer>>> listTrustedJwtGrantIssuers({ 
    String issuer,
    int limit,
    int offset,
    CancelToken cancelToken,
    ...
    final _request = RequestOptions(
      path: r'/trust/grants/jwt-bearer/issuers',
      method: 'GET',
      headers: <String, dynamic>{
        ...?headers,
      },
    ...
    const _responseType = FullType(BuiltList, [FullType(TrustedJwtGrantIssuer)]);
    final BuiltList<TrustedJwtGrantIssuer> _responseData = _serializers.deserialize(
      _response.data,
      specifiedType: _responseType,
    ) as BuiltList<TrustedJwtGrantIssuer>;

    return Response<BuiltList<TrustedJwtGrantIssuer>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      request: _response.request,
  ...
  Future<Response<CompletedRequest>> rejectConsentRequest(
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/requests/consent/reject',
      method: 'PUT',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<CompletedRequest>> rejectLoginRequest(
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/requests/login/reject',
      method: 'PUT',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<void>> rejectLogoutRequest(
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/requests/logout/reject',
      method: 'PUT',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<void>> revokeAuthenticationSession(
    String subject, { 
    CancelToken cancelToken,
    Map<String, dynamic> headers,
    Map<String, dynamic> extra,
    ...
    final _request = RequestOptions(
      path: r'/oauth2/auth/sessions/login',
      method: 'DELETE',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<void>> revokeConsentSessions(
    String subject, { 
    String client,
    bool all,
    CancelToken cancelToken,
